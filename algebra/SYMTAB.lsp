...
(SDEFUN |SYMTAB;typeList;Fst$L;10|
        ...
        (SPROG
         ((|arrayList|
          ...
          (#1=#:G146 NIL) (|v| NIL) (#2=#:G145 NIL)
          (|sType|
           (|Union| (|:| |fst| (|FortranScalarType|)) (|:| |void| "void")))
          (|uType| (|FortranType|)) (#3=#:G144 NIL) (|u| NIL))
        ...
        (SPROG
         ((|tl|
          ...
          (|uDim|
           (|List|
            (|Union| (|:| S (|Symbol|)) (|:| P (|Polynomial| (|Integer|))))))
          (#1=#:G163 NIL) (|v| NIL) (#2=#:G162 NIL)
          (|sType|
           (|Union| (|:| |fst| (|FortranScalarType|)) (|:| |void| "void")))
          (|uType| (|FortranType|)) (#3=#:G161 NIL) (|u| NIL)
          (|symbolType| (|Symbol|)))
...
(SDEFUN |SYMTAB;newTypeLists;$Se;13| ((|tab| $) ($ |SExpression|))
        (SPROG
         ((|tl| (|SExpression|)) (|lType| (|SExpression|))
          (|lDims| (|List| (|SExpression|))) (#1=#:G177 NIL) (|v| NIL)
          (#2=#:G176 NIL) (|dims| (|List| (|Polynomial| (|Integer|))))
          (|sType|
           (|Union| (|:| |fst| (|FortranScalarType|)) (|:| |void| "void")))
          (|uType| (|FortranType|)) (#3=#:G175 NIL) (|u| NIL))
...
(SDEFUN |SYMTAB;oForm|
        ((|v| |Union| (|:| |name| (|Symbol|))
         ...
         ($ |OutputForm|))
        (SPROG
         ((|ll| (|List| (|OutputForm|))) (#1=#:G190 NIL) (#2=#:G150 NIL)
          (|uu| NIL) (#3=#:G189 NIL))
         (SEQ
                   ...
                   (|:| |bounds|
                        (|List|
                         (|Union| (|:| S (|Symbol|))
                                  (|:| P (|Polynomial| (|Integer|))))))))
         ($ |List| (|OutputForm|)))
        (SPROG ((#1=#:G194 NIL) (|u| NIL) (#2=#:G193 NIL))
               (SEQ
                (PROGN
...
(SDEFUN |SYMTAB;printTypes;$V;18| ((|tab| $) ($ |Void|))
        (SPROG
         ((|el| (|List| (|OutputForm|))) (#1=#:G202 NIL) (|u| NIL)
          (#2=#:G201 NIL) (|otl| (|List| (|OutputForm|)))
          (|tl|
           (|List|
            (|Union| (|:| |name| (|Symbol|))
                     (|:| |bounds|
                          (|List|
                           (|Union| (|:| S (|Symbol|))
                                    (|:| P (|Polynomial| (|Integer|)))))))))
          (#3=#:G200 NIL) (|ty| NIL) (|ft| (|List| (|FortranScalarType|))))
         (SEQ
          (LETT |ft|
