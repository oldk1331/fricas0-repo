...
(SDEFUN |SYMTAB;typeList;Fst$L;10|
        ...
        (SPROG
         ((|arrayList|
          ...
          (|uType| (|FortranType|)) (#3=#:G159 NIL) (|u| NIL))
        ...
        (SPROG
         ((|tl|
          ...
          (|uDim|
           (|List|
            (|Union| (|:| S (|Symbol|)) (|:| P (|Polynomial| (|Integer|))))))
          (#1=#:G178 NIL) (|v| NIL) (#2=#:G177 NIL)
          (|sType|
           (|Union| (|:| |fst| (|FortranScalarType|)) (|:| |void| "void")))
          (|uType| (|FortranType|)) (#3=#:G176 NIL) (|u| NIL)
          (|symbolType| (|Symbol|)))
         (SEQ (LETT |tl| NIL)
...
(SDEFUN |SYMTAB;newTypeLists;$Se;13| ((|tab| $) ($ |SExpression|))
        (SPROG
         ((|tl| (|SExpression|)) (|lType| (|SExpression|))
          (|lDims| (|List| (|SExpression|))) (#1=#:G192 NIL) (|v| NIL)
          (#2=#:G191 NIL) (|dims| (|List| (|Polynomial| (|Integer|))))
          (|sType|
           (|Union| (|:| |fst| (|FortranScalarType|)) (|:| |void| "void")))
          (|uType| (|FortranType|)) (#3=#:G190 NIL) (|u| NIL))
...
(SDEFUN |SYMTAB;oForm|
        ((|v| |Union| (|:| |name| (|Symbol|))
         ...
         ($ |OutputForm|))
        (SPROG
         ((|ll| (|List| (|OutputForm|))) (#1=#:G205 NIL) (#2=#:G165 NIL)
          (|uu| NIL) (#3=#:G204 NIL))
         (SEQ
                   ...
                   (|:| |bounds|
                        (|List|
                         (|Union| (|:| S (|Symbol|))
                                  (|:| P (|Polynomial| (|Integer|))))))))
         ($ |List| (|OutputForm|)))
        (SPROG ((#1=#:G209 NIL) (|u| NIL) (#2=#:G208 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SYMTAB;printTypes;$V;18| ((|tab| $) ($ |Void|))
        (SPROG
         ((|el| (|List| (|OutputForm|))) (#1=#:G217 NIL) (|u| NIL)
          (#2=#:G216 NIL) (|otl| (|List| (|OutputForm|)))
          (|tl|
           (|List|
            (|Union| (|:| |name| (|Symbol|))
                     (|:| |bounds|
                          (|List|
                           (|Union| (|:| S (|Symbol|))
                                    (|:| P (|Polynomial| (|Integer|)))))))))
          (#3=#:G215 NIL) (|ty| NIL) (|ft| (|List| (|FortranScalarType|))))
         (SEQ
          (LETT |ft|
