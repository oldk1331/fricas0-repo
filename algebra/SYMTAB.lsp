...
(SDEFUN |SYMTAB;externalList;$L;9| ((|tab| ($)) ($ (|List| (|Symbol|))))
        (SPROG ((#1=#:G145 NIL) (|u| NIL) (#2=#:G144 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SYMTAB;newTypeLists;$Se;13| ((|tab| ($)) ($ (|SExpression|)))
        (SPROG
         ((|tl| (|SExpression|)) (|lType| (|SExpression|))
          (|lDims| (|List| (|SExpression|))) (#1=#:G200 NIL) (|v| NIL)
          (#2=#:G199 NIL) (|dims| (|List| (|Polynomial| (|Integer|))))
          (|sType|
           (|Union| (|:| |fst| (|FortranScalarType|)) (|:| |void| "void")))
          (|uType| (|FortranType|)) (#3=#:G198 NIL) (|u| NIL))
...
(SDEFUN |SYMTAB;oForm|
        ((|v|
         ...
         ($ (|OutputForm|)))
        (SPROG
         ((|ll| (|List| (|OutputForm|))) (#1=#:G215 NIL) (#2=#:G169 NIL)
          (|uu| NIL) (#3=#:G214 NIL))
         (SEQ
...
(SDEFUN |SYMTAB;printTypes;$V;18| ((|tab| ($)) ($ (|Void|)))
        (SPROG
         ((|el| (|List| (|OutputForm|))) (#1=#:G230 NIL) (|u| NIL)
          (#2=#:G229 NIL) (|otl| (|List| (|OutputForm|)))
          (|tl|
           (|List|
            (|Union| (|:| |name| (|Symbol|))
                     (|:| |bounds|
                          (|List|
                           (|Union| (|:| S (|Symbol|))
                                    (|:| P (|Polynomial| (|Integer|)))))))))
          (#3=#:G228 NIL) (|ty| NIL) (|ft| (|List| (|FortranScalarType|))))
         (SEQ
          (LETT |ft|
