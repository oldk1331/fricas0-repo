...
(SDEFUN |LISTPKG;splitList;MLR;1|
        ...
        (SPROG
         ((|resno| #1=(|List| T$)) (|resyes| #1#) (#2=#:G141 NIL) (|t| NIL))
         (SEQ
...
(SDEFUN |LISTPKG;topologicalSort;L2L;4|
        ...
        (SPROG
         ((#1=#:G174 NIL) (|p| NIL) (#2=#:G173 NIL)
          ...
          (#4=#:G172 NIL) (|x| NIL) (|x0| (|NonNegativeInteger|))
          (#5=#:G171 NIL) (|n| NIL) (#6=#:G170 NIL))
         (SEQ
          (LETT |xi|
                (PROGN
                 (LETT #6# NIL)
...
(SDEFUN |LISTPKG;shiftLeft;2L;5| ((|xx| (|List| T$)) ($ (|List| T$)))
        (SPROG ((#1=#:G177 NIL))
               (SEQ
                (EXIT
                 (COND ((NULL |xx|) (PROGN (LETT #1# |xx|) (GO #2=#:G176)))
                       ('T
...
(SDEFUN |LISTPKG;minShift;2L;6| ((|xx| #1=(|List| T$)) ($ (|List| T$)))
        (SPROG
         ((|res| #1#) (|xx1| #1#) (#2=#:G186 NIL) (|k| NIL) (#3=#:G185 NIL))
         (SEQ
          (EXIT
           (COND
            ((OR (NULL |xx|) (NULL (CDR |xx|)))
             (PROGN (LETT #3# |xx|) (GO #4=#:G184)))
            ('T
...
(SDEFUN |LISTPKG;cartesian;2L;7|
        ...
        (SPROG
         ((|res| (|List| (|List| T$))) (#1=#:G200 NIL) (|s| NIL)
          (#2=#:G199 NIL) (|x| NIL) (#3=#:G196 NIL) (#4=#:G198 NIL)
          (#5=#:G197 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |LISTPKG;cartesianPower;LNniL;8|
        ...
        (SPROG
         ((|res| (|List| (|List| T$))) (#1=#:G216 NIL) (|s| NIL)
          (#2=#:G215 NIL) (|x| NIL) (#3=#:G212 NIL) (#4=#:G214 NIL)
          (#5=#:G213 NIL))
         (SEQ
          (EXIT
           (COND
            ((OR (NULL S) (ZEROP |n|)) (PROGN (LETT #3# NIL) (GO #6=#:G211)))
            ('T
             (COND
              ((EQL |n| 1)
               (PROGN
