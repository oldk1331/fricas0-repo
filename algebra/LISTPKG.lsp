...
(SDEFUN |LISTPKG;topologicalSort;L2L;4|
        ...
        (SPROG
         ((#1=#:G167 NIL) (|p| NIL) (#2=#:G166 NIL)
          ...
          (#4=#:G165 NIL) (|x| NIL) (|x0| (|NonNegativeInteger|))
          (#5=#:G164 NIL) (|n| NIL) (#6=#:G163 NIL))
         (SEQ
          (LETT |xi|
                (PROGN
                 (LETT #6# NIL)
...
(SDEFUN |LISTPKG;shiftLeft;2L;5| ((|xx| |List| T$) ($ |List| T$))
        (SPROG ((#1=#:G170 NIL))
               (SEQ
                (EXIT
                 (COND ((NULL |xx|) (PROGN (LETT #1# |xx|) (GO #2=#:G169)))
                       ('T
...
(SDEFUN |LISTPKG;cartesianPower;LNniL;8|
        ...
        (SPROG
         ...
         (SEQ
          (EXIT
           (COND
            ((OR (NULL S) (ZEROP |n|)) (PROGN (LETT #3# NIL) (GO #6=#:G197)))
            ('T
             (COND
              ((EQL |n| 1)
               (PROGN
