...
(SDEFUN |SUTS;univariatePolynomial;$NniUp;14|
        ...
        (SPROG
         ((|st| (|Stream| (|Record| (|:| |k| (|Integer|)) (|:| |c| |Coef|))))
          ...
          (|oldDeg| (|Integer|)) (|pow| (|NonNegativeInteger|)) (#1=#:G185 NIL)
          (#2=#:G191 NIL) (|xExpon| (|Integer|))
...
(SDEFUN |SUTS;polynomial;$NniP;15|
        ...
        (SPROG
         ((|st| (|Stream| (|Record| (|:| |k| (|Integer|)) (|:| |c| |Coef|))))
          ...
          (|oldDeg| (|Integer|)) (|pow| (|NonNegativeInteger|)) (#1=#:G193 NIL)
          (#2=#:G199 NIL) (|xExpon| (|Integer|))
          (|xTerm| (|Record| (|:| |k| (|Integer|)) (|:| |c| |Coef|)))
          (|mon| (|Polynomial| |Coef|)))
         (SEQ
          (EXIT
...
(DEFUN |SparseUnivariateTaylorSeries| (&REST #1=#:G360)
  (SPROG NIL
         (PROG (#2=#:G361)
           (RETURN
            (COND
...
(DEFUN |SparseUnivariateTaylorSeries;| (|#1| |#2| |#3|)
  (SPROG
   ((|pv$| NIL) (#1=#:G354 NIL) (#2=#:G355 NIL) (#3=#:G356 NIL) (#4=#:G359 NIL)
             ...
             (CONS
              ...
              (|makeByteWordVec2| 200
                                  '(2 9 0 6 10 11 2 9 0 0 10 14 0 6 0 16 0 6 0
                                    ...
                                    2 25 0 0 65 1 2 1 0 0 28 121 1 1 0 0 120 2
                                    ...
                                    125 2 24 0 0 6 186 2 0 0 0 196 1 0 31 0 17
                                    0 29 0 19 2 8 0 0 192 1 2 8 0 0 65 1 3 8 0
                                    0 192 193 1 3 8 0 0 65 12 1 1 7 0 0 1 2 7 0
                                    0 12 1 2 0 21 0 0 1 2 24 0 0 6 1 1 33 0 0 1
