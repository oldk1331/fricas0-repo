...
(SDEFUN |FLASORT;siftUp|
        ((|l| (|Mapping| (|Boolean|) S S)) (|r| (V)) (|i| (|Integer|))
         (|n| (|Integer|)) (% (|Void|)))
        (SPROG ((#1=#:G121 NIL) (|j| #2=(|Integer|)) (|k| #2#) (|t| (S)))
...
(SDEFUN |FLASORT;QuickSort|
        ((|l| (|Mapping| (|Boolean|) S S)) (|r| (V)) (|i| (|Integer|))
         (|j| (|Integer|)) (% (V)))
        (SPROG ((|k| (|Integer|)) (#1=#:G160 NIL) (|n| (|Integer|)))
               (SEQ
                (EXIT
                 (SEQ G190 NIL
                      (SEQ (LETT |n| (- |j| |i|))
...
(SDEFUN |FLASORT;shellSort;M2V;6|
        ((|l| (|Mapping| (|Boolean|) S S)) (|r| (V)) (% (V)))
        (SPROG
         ((|g| (|Integer|)) (|j| (|Integer|)) (#1=#:G174 NIL) (|i| NIL)
          (|n| (|Integer|)) (|m| (|Integer|)))
