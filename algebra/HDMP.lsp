...
(DEFUN |HomogeneousDistributedMultivariatePolynomial| (&REST #1=#:G149)
  (SPROG NIL
         (PROG (#2=#:G150)
           (RETURN
            (COND
...
(DEFUN |HomogeneousDistributedMultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G148 NIL) (|pv$| NIL) (#2=#:G141 NIL) (#3=#:G142 NIL) (#4=#:G143 NIL)
    (#5=#:G144 NIL) (#6=#:G145 NIL) (#7=#:G146 NIL) (#8=#:G147 NIL) ($ NIL)
