...
(DEFUN |HomogeneousDistributedMultivariatePolynomial| (&REST #1=#:G147)
  (SPROG NIL
         (PROG (#2=#:G148)
           (RETURN
            (COND
...
(DEFUN |HomogeneousDistributedMultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G146 NIL) (|pv$| NIL) (#2=#:G138 NIL) (#3=#:G139 NIL) (#4=#:G140 NIL)
    (#5=#:G141 NIL) (#6=#:G142 NIL) (#7=#:G143 NIL) (#8=#:G144 NIL)
    (#9=#:G145 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 7
                 ...
                 (|CoercibleFrom| 7) (|BasicType|) (|CoercibleTo| 56)
