...
(SDEFUN |ULSCONS;rationalFunction;$2IF;41|
        ...
        (SPROG
         ((#2=#:G373 NIL) (#3=#:G372 NIL)
          (|c| (|Fraction| (|Polynomial| |Coef|)))
          (|v| (|Fraction| (|Polynomial| |Coef|)))
          (|poly| (|Fraction| (|Polynomial| |Coef|))) (#4=#:G369 NIL)
          (#5=#:G368 NIL) (|m1| (|Integer|)) (|e| (|Integer|)) (|#G68| #1#)
          (|#G67| #1#))
         (SEQ
          (COND
           ((< |n2| |n1|)
...
(SDEFUN |ULSCONS;approximate;$ICoef;43| ((|x| $) (|n| |Integer|) ($ |Coef|))
        (SPROG
         ((|app| (|Coef|)) (#1=#:G389 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
         (SEQ (LETT |m| (- |n| (LETT |e| (|ULSCONS;getExpon| |x| $))))
              (EXIT
...
(SDEFUN |ULSCONS;extend;$I$;45| ((|x| $) (|n| |Integer|) ($ $))
        (SPROG ((#1=#:G395 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
...
(SDEFUN |ULSCONS;^;$I$;54| ((|x| $) (|n| |Integer|) ($ $))
        (SPROG
         ((|minusN| (|NonNegativeInteger|)) (#1=#:G426 NIL) (|xInv| ($))
          (#2=#:G425 NIL))
         (SEQ
          (COND ((ZEROP |n|) (|spadConstant| $ 16))
                ((> |n| 0)
...
(SDEFUN |ULSCONS;termsToOutputForm|
        ...
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|uu1| (|Stream| |Coef|)) (|n| NIL)
          (#1=#:G532 NIL) (|count| (|NonNegativeInteger|)))
         (SEQ (LETT |l| NIL)
              (EXIT
               (COND
...
(DEFUN |UnivariateLaurentSeriesConstructor| (&REST #1=#:G579)
  (SPROG NIL
         (PROG (#2=#:G580)
           (RETURN
            (COND
...
(DEFUN |UnivariateLaurentSeriesConstructor;| (|#1| |#2|)
  (SPROG
   ((#1=#:G578 NIL) (|pv$| NIL) (#2=#:G567 NIL) (#3=#:G568 NIL) (#4=#:G570 NIL)
    (#5=#:G571 NIL) (#6=#:G572 NIL) (#7=#:G573 NIL) (#8=#:G574 NIL)
    (#9=#:G576 NIL) (#10=#:G577 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|UnivariateLaurentSeriesConstructor| '|infovec|
          (LIST
           ...
           (CONS
            (|makeByteWordVec2| 53
                                '(0 0 2 2 0 2 34 0 2 2 0 2 6 25 2 2 24 6 2 2 20
                                  24 25 38 32 7 2 43 44 2 13 47 42 47 0 20 24
                                  38 2 0 0 0 46 38 6 2 0 0 0 0 0 38 38 6 2 2 47
                                  53 6 52 42 42 6 0 0 51 42 28 2 0 0 29 9 2 16
                                  17 0 0 24 38 3 5 8 8 11 2 0 0 0 0 1 24 25 2 2
                                  38 38 38 38 38 38 46 3 4 5 5 28 8 8 10 11 12
                                  14 15 2))
            (CONS
             ...
             (CONS
              ...
              (|makeByteWordVec2| 277
                                  '(0 6 0 14 0 7 0 15 0 7 0 17 1 7 0 6 18 1 6 0
                                    ...
                                    108 2 2 0 0 0 1 1 2 269 230 1 1 2 32 0 1 1
                                    ...
                                    253 253 253 1 1 2 0 230 1 2 2 0 0 0 1 1 36
                                    0 0 1 1 35 7 0 1 1 34 252 253 1 1 34 252
                                    253 1 1 2 274 0 1 3 2 272 0 0 0 1 2 2 273 0
                                    0 1 2 0 0 0 9 122 2 57 72 0 0 112 2 2 268
