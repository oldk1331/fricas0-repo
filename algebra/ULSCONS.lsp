...
(SDEFUN |ULSCONS;=;2$B;23| ((|x| ($)) (|y| ($)) ($ (|Boolean|)))
        (SPROG ((#1=#:G250 NIL) (#2=#:G241 NIL) (|expDiff| (|Integer|)))
               (SEQ
                (COND ((EQ |x| |y|) 'T)
                      (#3='T
                       (SEQ
...
(SDEFUN |ULSCONS;+;3$;25| ((|x| ($)) (|y| ($)) ($ ($)))
        (SPROG ((#1=#:G267 NIL) (#2=#:G263 NIL) (|n| (|Integer|)))
               (SEQ
                (LETT |n|
                      (- (|ULSCONS;getExpon| |x| $)
                         (|ULSCONS;getExpon| |y| $)))
...
(SDEFUN |ULSCONS;elt;3$;30| ((|uls1| ($)) (|uls2| ($)) ($ ($)))
        (SPROG
         ((#1=#:G308 NIL) (|uts1| (UTS)) (|recipr| (|Union| $ "failed"))
...
(SDEFUN |ULSCONS;eval;$CoefS;31|
        ...
        (SPROG
         ((#1=#:G327 NIL) (#2=#:G320 NIL) (|recipr| (|Union| |Coef| "failed"))
          (|n| (|Integer|)) (|uts| (UTS)))
         (SEQ
          (SEQ (LETT |n| (|ULSCONS;getExpon| |uls| $))
               (EXIT
...
(SDEFUN |ULSCONS;order;$2I;37| ((|x| ($)) (|n| #1=(|Integer|)) ($ #1#))
        (SPROG ((#2=#:G343 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
...
(SDEFUN |ULSCONS;truncate;$I$;38| ((|x| ($)) (|n| (|Integer|)) ($ ($)))
        (SPROG ((#1=#:G347 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
               (SEQ (LETT |m| (- |n| (LETT |e| (|ULSCONS;getExpon| |x| $))))
                    (EXIT
...
(SDEFUN |ULSCONS;truncate;$2I$;39|
        ((|x| ($)) (|n1| #1=(|Integer|)) (|n2| #1#) ($ ($)))
        (SPROG
         ((#2=#:G353 NIL) (#3=#:G352 NIL) (|m1| (|Integer|)) (|e| (|Integer|))
          (|#G61| #1#) (|#G60| #1#))
         (SEQ
          (COND
           ((< |n2| |n1|)
...
(SDEFUN |ULSCONS;rationalFunction;$IF;40|
        ...
        (SPROG
         ((#1=#:G362 NIL) (#2=#:G361 NIL)
          (|c| (|Fraction| (|Polynomial| |Coef|)))
          (|v| (|Fraction| (|Polynomial| |Coef|)))
          (|poly| (|Fraction| (|Polynomial| |Coef|))) (#3=#:G357 NIL)
          (|m| (|Integer|)) (|e| (|Integer|)))
         (SEQ (LETT |m| (- |n| (LETT |e| (|ULSCONS;getExpon| |x| $))))
              (EXIT
...
(SDEFUN |ULSCONS;rationalFunction;$2IF;41|
        ...
        (SPROG
         ((#2=#:G375 NIL) (#3=#:G374 NIL)
          (|c| (|Fraction| (|Polynomial| |Coef|)))
          (|v| (|Fraction| (|Polynomial| |Coef|)))
          (|poly| (|Fraction| (|Polynomial| |Coef|))) (#4=#:G370 NIL)
          (#5=#:G369 NIL) (|m1| (|Integer|)) (|e| (|Integer|)) (|#G68| #1#)
          (|#G67| #1#))
         (SEQ
          (COND
           ((< |n2| |n1|)
...
(SDEFUN |ULSCONS;approximate;$ICoef;43|
        ((|x| ($)) (|n| (|Integer|)) ($ (|Coef|)))
        (SPROG
         ((|app| (|Coef|)) (#1=#:G391 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
         (SEQ (LETT |m| (- |n| (LETT |e| (|ULSCONS;getExpon| |x| $))))
              (EXIT
...
(SDEFUN |ULSCONS;extend;$I$;45| ((|x| ($)) (|n| (|Integer|)) ($ ($)))
        (SPROG ((#1=#:G397 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
...
(SDEFUN |ULSCONS;^;$I$;54| ((|x| ($)) (|n| (|Integer|)) ($ ($)))
        (SPROG
         ((|minusN| (|NonNegativeInteger|)) (#1=#:G428 NIL) (|xInv| ($))
          (#2=#:G427 NIL))
         (SEQ
          (COND ((ZEROP |n|) (|spadConstant| $ 16))
                ((> |n| 0)
...
(SDEFUN |ULSCONS;termsToOutputForm|
        ...
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|uu1| (|Stream| |Coef|)) (|n| NIL)
          (#1=#:G536 NIL) (|count| (|NonNegativeInteger|)))
         (SEQ (LETT |l| NIL)
              (EXIT
               (COND
...
(DEFUN |UnivariateLaurentSeriesConstructor| (&REST #1=#:G583)
  (SPROG NIL
         (PROG (#2=#:G584)
           (RETURN
            (COND
...
(DEFUN |UnivariateLaurentSeriesConstructor;| (|#1| |#2|)
  (SPROG
   ((#1=#:G582 NIL) (|pv$| NIL) (#2=#:G571 NIL) (#3=#:G572 NIL) (#4=#:G574 NIL)
    (#5=#:G575 NIL) (#6=#:G576 NIL) (#7=#:G577 NIL) (#8=#:G578 NIL)
    (#9=#:G580 NIL) (#10=#:G581 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|UnivariateLaurentSeriesConstructor| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) '|Rep|
              ...
              (|SparseUnivariatePolynomial| $) (|Factored| 254) (|Float|)
              (|DoubleFloat|) (|Union| 148 '#2="failed") (|Union| 9 '#2#)
              (|Union| 83 '#2#)
             ...
             (CONS
              ...
              (|makeByteWordVec2| 277
                                  '(0 6 0 14 0 7 0 15 0 7 0 17 1 7 0 6 18 1 6 0
                                    ...
                                    254 254 254 1 2 2 0 0 0 1 1 2 0 230 1 1 36
                                    0 0 1 1 35 7 0 1 1 34 255 254 1 1 34 255
                                    254 1 1 2 274 0 1 2 2 271 0 0 1 3 2 273 0 0
                                    ...
                                    0 67 2 0 0 0 0 65 2 13 0 0 9 1 2 63 0 9 0 1
                                    2 61 0 26 0 1 2 37 0 148 0 1 2 37 0 0 148 1
                                    2 2 0 0 7 143 2 2 0 7 0 142 2 0 0 6 0 134 2
                                    0 0 0 6 1 2 0 0 0 0 68 2 0 0 129 0 1)))))
           '|lookupComplete|)) 
