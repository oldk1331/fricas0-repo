...
(SDEFUN |INCALG;*;P2$;7| ((|p| (|Permutation| (|Integer|))) (A ($)) ($ ($)))
        (SPROG
         ((|newA| (|Matrix| R)) (|indic| (|List| (|Integer|))) (#1=#:G138 NIL)
          (|i| NIL) (#2=#:G137 NIL) (|newindices| (|OneDimensionalArray| S))
          (#3=#:G136 NIL) (#4=#:G135 NIL) (|n| (|Integer|))
          (|mp| (|Set| (|Integer|))))
...
(DEFUN |IncidenceAlgebra| (&REST #1=#:G155)
  (SPROG NIL
         (PROG (#2=#:G156)
           (RETURN
            (COND
