          ...
          (|s1|
           (|Union|
            ...
            (|Record| (|:| |ans| #14#) (|:| |acoeff| #15#) (|:| |eegen| #17#)
                      ...
                      (|:| |lcpar| (|List| (|SparseUnivariatePolynomial| F)))
                      (|:| |dpar| (|Integer|)))))
          (#25=#:G258 NIL) (|re| NIL) (#26=#:G257 NIL) (|res1| #3#)
...
(SDEFUN |RDEPAR;do_SPDE_prim0|
        ...
        (SPROG
         ((#1=#:G346 NIL) (|ba| NIL) (#2=#:G347 NIL) (|bv| NIL) (#3=#:G345 NIL)
          ...
          (|j| NIL) (#14=#:G335 NIL) (#15=#:G334 NIL) (#16=#:G333 NIL)
          (#17=#:G332 NIL) (|dk| (F)) (|d| (|Integer|)) (#18=#:G331 NIL)
          (|c| NIL) (#19=#:G330 NIL) (#20=#:G328 NIL) (#21=#:G329 NIL)
          (#22=#:G327 NIL) (#23=#:G326 NIL)
...
(SDEFUN |RDEPAR;do_SPDE_exp0|
        ...
        (SPROG
         ((#1=#:G468 NIL) (|re| NIL) (#2=#:G469 NIL) (|bv| NIL) (#3=#:G467 NIL)
          ...
          (#11=#:G461 NIL) (|i| NIL) (|f0| (F)) (|d| #4#) (#12=#:G460 NIL)
          (|cr| NIL) (#13=#:G459 NIL) (#14=#:G458 NIL) (#15=#:G457 NIL)
          (#16=#:G455 NIL) (#17=#:G456 NIL) (#18=#:G454 NIL) (#19=#:G453 NIL)
          (|vg2|
...
(SDEFUN |RDEPAR;param_rde2;FLSLMML;15|
        ((|fp| (F)) (|lg| (|List| F)) (|x| (|Symbol|))
         ...
         ($ (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#1=#:G623 NIL) (|rs| NIL) (#2=#:G622 NIL)
          (|res1|
           (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (|lg1| (|List| F)) (#3=#:G621 NIL) (|g| NIL) (#4=#:G620 NIL)
          (|pf| (F)) (|p| (|SparseUnivariatePolynomial| F)) (#5=#:G601 NIL)
          ...
          (|#G156|
           #7=(|Record| (|:| |fctr| (|SparseUnivariatePolynomial| F))
                        (|:| |xpnt| (|Integer|))))
          (#8=#:G619 NIL) (|re| NIL) (|rl| (|List| #7#))
          (|der1|
           (|Mapping| (|SparseUnivariatePolynomial| F)
                      (|SparseUnivariatePolynomial| F)))
          (|dk| (|SparseUnivariatePolynomial| F)) (|dku| #6#) (#9=#:G618 NIL)
          (|k1| NIL) (#10=#:G617 NIL) (|k| (|Kernel| F)))
...
(SDEFUN |RDEPAR;do_diff_rde1|
        ((|lg| (|List| (|SparseUnivariatePolynomial| F))) (|fp0| (F))
         ...
         ($ (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#1=#:G722 NIL) (|ba| NIL) (#2=#:G723 NIL) (|bv| NIL) (#3=#:G721 NIL)
          (|nlca| (|List| F)) (#4=#:G719 NIL) (#5=#:G720 NIL) (|ca| NIL)
          (#6=#:G718 NIL) (|ncb| (|List| (|Vector| F))) (#7=#:G717 NIL)
          (#8=#:G716 NIL) (|elca| (|List| F)) (#9=#:G715 NIL) (|be| NIL)
          (#10=#:G714 NIL) (|cb1| (|List| (|Vector| F))) (#11=#:G713 NIL)
          (#12=#:G712 NIL)
          (|res2|
           #13=(|List|
                (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (|kk3| #14=(|Kernel| F)) (#15=#:G711 NIL) (#16=#:G710 NIL)
          (|m3| (|Matrix| F)) (|nlg| (|List| F)) (|ng| (F)) (#17=#:G688 NIL)
          (|nu| (|SparseUnivariatePolynomial| F))
          (|du| (|Fraction| (|SparseUnivariatePolynomial| F))) (#18=#:G707 NIL)
          (#19=#:G708 NIL) (|g1| NIL) (#20=#:G709 NIL) (|g0| NIL)
          (|lca| (|List| F)) (|nlg0| (|List| F)) (#21=#:G706 NIL)
          (#22=#:G705 NIL) (|lg3| (|List| F)) (#23=#:G704 NIL) (#24=#:G703 NIL)
          (|v3| (|Vector| F)) (|v2| (|Vector| F)) (#25=#:G702 NIL)
          (#26=#:G701 NIL) (|cb| #27=(|List| (|Vector| F)))
          (|m2| #28=(|Matrix| F))
          (|#G175| (|Record| (|:| |transform| #28#) (|:| |basis| #27#)))
          (|d1| (|Mapping| F F)) (|cb0| (|List| (|Vector| F))) (#29=#:G700 NIL)
          (#30=#:G699 NIL) (|res1| #13#) (|lk2| (|List| #31=(|Kernel| F)))
          (#32=#:G698 NIL) (|ki| NIL) (#33=#:G697 NIL) (|kk1| #14#)
          (|logi1|
           (|Mapping|
            (|Record| (|:| |logands| (|List| F))
                      (|:| |basis|
          ...
          (|ext1|
           (|Mapping|
            (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))
            (|List| (|Kernel| F)) (|List| F)))
          (|lk1| (|List| #31#)) (|lek| (|List| F)) (#34=#:G696 NIL)
          (#35=#:G695 NIL) (|fp2| (F)) (|lg2| (|List| F)) (#36=#:G694 NIL)
          (|g| NIL) (#37=#:G693 NIL) (|dvf| (F)) (|dv| (|Symbol|)) (|k1| (F))
          (|lg1| (|List| F)) (#38=#:G692 NIL) (|up| NIL) (#39=#:G691 NIL)
          (|lg0| (|List| F)) (#40=#:G690 NIL) (#41=#:G689 NIL) (|da3| (F))
          (|arg3| (F)) (|args| (|List| F)))
         (SEQ
          (EXIT
...
(SDEFUN |RDEPAR;do_alg_rde0|
        ((|fp| (F)) (|lg| (|List| F)) (|x| (|Symbol|)) (|k| (|Kernel| F))
         ...
         ($ (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#1=#:G789 NIL) (|ba| NIL) (#2=#:G790 NIL) (|bv| NIL) (#3=#:G788 NIL)
          (|kfi| (F)) (|lba| (|List| F)) (|cb| (|List| (|Vector| F)))
          (|nlba| (|List| F)) (#4=#:G787 NIL) (|be| NIL) (#5=#:G786 NIL)
          (|ncb| (|List| (|Vector| F))) (#6=#:G785 NIL) (#7=#:G784 NIL)
          (|s1|
           (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (|lgi1| (|List| F)) (#8=#:G783 NIL) (#9=#:G782 NIL)
          (|lgi| (|List| F)) (#10=#:G781 NIL) (|j| NIL) (#11=#:G780 NIL)
          (|i| NIL) (#12=#:G779 NIL) (#13=#:G778 NIL) (#14=#:G776 NIL)
          (#15=#:G777 NIL) (#16=#:G775 NIL) (#17=#:G774 NIL)
          (|m| (|NonNegativeInteger|)) (|llv| (|Vector| (|List| F)))
          (#18=#:G773 NIL) (|g| NIL) (#19=#:G772 NIL) (|kf| (F)) (|dlk| (F))
        ...
        ((|fp| (F)) (|lg| (|List| F)) (|x| (|Symbol|)) (|k| (|Kernel| F))
         ...
         ($
          #1=(|List|
              (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#2=#:G834 NIL) (|be| NIL) (#3=#:G833 NIL) (|res1| #1#)
          (#4=#:G832 NIL) (|kk| NIL) (#5=#:G831 NIL) (|lg1| (|List| F))
          (#6=#:G830 NIL) (|g| NIL) (#7=#:G829 NIL) (|fp1| (F))
          (|ky| (|Kernel| F)) (|y| (F))
          (|rec|
           (|Record| (|:| |primelt| F)
          ...
          (|part2|
           (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (#8=#:G828 NIL) (|f| NIL) (#9=#:G827 NIL)
          (|part1|
           (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (#10=#:G826 NIL) (#11=#:G825 NIL) (|n| (|NonNegativeInteger|))
          (|k1| (|Kernel| F)) (#12=#:G824 NIL) (|cc| (F)))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |RDEPAR;param_rde;IFLSLMML;21|
        ((|m| (|Integer|)) (|f| (F)) (|lg| (|List| F)) (|x| (|Symbol|))
         ...
         ($ (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#1=#:G846 NIL) (|k1| NIL) (#2=#:G845 NIL) (|k| (|Kernel| F))
          (|fp| (F)))
         (SEQ
          (LETT |fp|
        ...
        (SPROG
         ((|res2|
          ...
          (|lgd|
           (|List|
            (|Record| (|:| |poly| (|SparseUnivariatePolynomial| F))
                      ...
                      (|:| |special|
                           (|Fraction| (|SparseUnivariatePolynomial| F))))))
          (#11=#:G926 NIL) (|gu| NIL) (#12=#:G925 NIL) (#13=#:G924 NIL)
          (#14=#:G923 NIL) (|aa1| #15=(|SparseUnivariatePolynomial| F))
          ...
          (|der1|
           (|Mapping| (|SparseUnivariatePolynomial| F)
                      (|SparseUnivariatePolynomial| F)))
          (#17=#:G922 NIL) (|g| NIL) (#18=#:G921 NIL) (|fpu| #4#)
...
(DEFUN |ParametricRischDE| (&REST #1=#:G933)
  (SPROG NIL
         (PROG (#2=#:G934)
           (RETURN
            (COND
