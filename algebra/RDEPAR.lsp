...
(SDEFUN |RDEPAR;do_diff_rde1|
        ((|lg| (|List| (|SparseUnivariatePolynomial| F))) (|fp0| (F))
         ...
         ($ (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#1=#:G720 NIL) (|ba| NIL) (#2=#:G721 NIL) (|bv| NIL) (#3=#:G719 NIL)
          (|nlca| (|List| F)) (#4=#:G717 NIL) (#5=#:G718 NIL) (|ca| NIL)
          (#6=#:G716 NIL) (|ncb| (|List| (|Vector| F))) (#7=#:G715 NIL)
          (#8=#:G714 NIL) (|elca| (|List| F)) (#9=#:G713 NIL) (|be| NIL)
          (#10=#:G712 NIL) (|cb1| (|List| (|Vector| F))) (#11=#:G711 NIL)
          (#12=#:G710 NIL)
          (|res2|
           #13=(|List|
                (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (|kk3| #14=(|Kernel| F)) (#15=#:G709 NIL) (#16=#:G708 NIL)
          (|m3| (|Matrix| F)) (|nlg| (|List| F)) (|ng| (F)) (#17=#:G686 NIL)
          (|nu| (|SparseUnivariatePolynomial| F))
          (|du| (|Fraction| (|SparseUnivariatePolynomial| F))) (#18=#:G705 NIL)
          (#19=#:G706 NIL) (|g1| NIL) (#20=#:G707 NIL) (|g0| NIL)
          (|lca| (|List| F)) (|nlg0| (|List| F)) (#21=#:G704 NIL)
          (#22=#:G703 NIL) (|lg3| (|List| F)) (#23=#:G702 NIL) (#24=#:G701 NIL)
          (|v3| (|Vector| F)) (|v2| (|Vector| F)) (#25=#:G700 NIL)
          (#26=#:G699 NIL) (|cb| #27=(|List| (|Vector| F)))
          (|m2| #28=(|Matrix| F))
          (|#G175| (|Record| (|:| |transform| #28#) (|:| |basis| #27#)))
          (|d1| (|Mapping| F F)) (|cb0| (|List| (|Vector| F))) (#29=#:G698 NIL)
          (#30=#:G697 NIL) (|res1| #13#) (|lk2| (|List| #31=(|Kernel| F)))
          (#32=#:G696 NIL) (|ki| NIL) (#33=#:G695 NIL) (|kk1| #14#)
          (|logi1|
           (|Mapping|
            (|Record| (|:| |logands| (|List| F))
                      (|:| |basis|
          ...
          (|ext1|
           (|Mapping|
            (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))
            (|List| (|Kernel| F)) (|List| F)))
          (|lk1| (|List| #31#)) (|lek| (|List| F)) (#34=#:G694 NIL)
          (#35=#:G693 NIL) (|fp2| (F)) (|lg2| (|List| F)) (#36=#:G692 NIL)
          (|g| NIL) (#37=#:G691 NIL) (|dvf| (F)) (|dv| (|Symbol|)) (|k1| (F))
          (|lg1| (|List| F)) (#38=#:G690 NIL) (|up| NIL) (#39=#:G689 NIL)
          (|lg0| (|List| F)) (#40=#:G688 NIL) (#41=#:G687 NIL) (|da3| (F))
          (|arg3| (F)) (|args| (|List| F)))
         (SEQ
          (EXIT
...
(SDEFUN |RDEPAR;do_alg_rde0|
        ((|fp| (F)) (|lg| (|List| F)) (|x| (|Symbol|)) (|k| (|Kernel| F))
         ...
         ($ (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#1=#:G787 NIL) (|ba| NIL) (#2=#:G788 NIL) (|bv| NIL) (#3=#:G786 NIL)
          (|kfi| (F)) (|lba| (|List| F)) (|cb| (|List| (|Vector| F)))
          (|nlba| (|List| F)) (#4=#:G785 NIL) (|be| NIL) (#5=#:G784 NIL)
          (|ncb| (|List| (|Vector| F))) (#6=#:G783 NIL) (#7=#:G782 NIL)
          (|s1|
           (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (|lgi1| (|List| F)) (#8=#:G781 NIL) (#9=#:G780 NIL)
          (|lgi| (|List| F)) (#10=#:G779 NIL) (|j| NIL) (#11=#:G778 NIL)
          (|i| NIL) (#12=#:G777 NIL) (#13=#:G776 NIL) (#14=#:G774 NIL)
          (#15=#:G775 NIL) (#16=#:G773 NIL) (#17=#:G772 NIL)
          (|m| (|NonNegativeInteger|)) (|llv| (|Vector| (|List| F)))
          (#18=#:G771 NIL) (|g| NIL) (#19=#:G770 NIL) (|kf| (F)) (|dlk| (F))
        ...
        ((|fp| (F)) (|lg| (|List| F)) (|x| (|Symbol|)) (|k| (|Kernel| F))
         ...
         ($
          #1=(|List|
              (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#2=#:G832 NIL) (|be| NIL) (#3=#:G831 NIL) (|res1| #1#)
          (#4=#:G830 NIL) (|kk| NIL) (#5=#:G829 NIL) (|lg1| (|List| F))
          (#6=#:G828 NIL) (|g| NIL) (#7=#:G827 NIL) (|fp1| (F))
          (|ky| (|Kernel| F)) (|y| (F))
          (|rec|
           (|Record| (|:| |primelt| F)
          ...
          (|part2|
           (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (#8=#:G826 NIL) (|f| NIL) (#9=#:G825 NIL)
          (|part1|
           (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (#10=#:G824 NIL) (#11=#:G823 NIL) (|n| (|NonNegativeInteger|))
          (|k1| (|Kernel| F)) (#12=#:G822 NIL) (|cc| (F)))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |RDEPAR;param_rde;IFLSLMML;21|
        ((|m| (|Integer|)) (|f| (F)) (|lg| (|List| F)) (|x| (|Symbol|))
         ...
         ($ (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#1=#:G844 NIL) (|k1| NIL) (#2=#:G843 NIL) (|k| (|Kernel| F))
          (|fp| (F)))
         (SEQ
          (LETT |fp|
        ...
        (SPROG
         ((|res2|
          ...
          (|lgd|
           (|List|
            (|Record| (|:| |poly| (|SparseUnivariatePolynomial| F))
                      ...
                      (|:| |special|
                           (|Fraction| (|SparseUnivariatePolynomial| F))))))
          (#11=#:G924 NIL) (|gu| NIL) (#12=#:G923 NIL) (#13=#:G922 NIL)
          (#14=#:G921 NIL) (|aa1| #15=(|SparseUnivariatePolynomial| F))
          ...
          (|der1|
           (|Mapping| (|SparseUnivariatePolynomial| F)
                      (|SparseUnivariatePolynomial| F)))
          (#17=#:G920 NIL) (|g| NIL) (#18=#:G919 NIL) (|fpu| #4#)
...
(DEFUN |ParametricRischDE| (&REST #1=#:G931)
  (SPROG NIL
         (PROG (#2=#:G932)
           (RETURN
            (COND
