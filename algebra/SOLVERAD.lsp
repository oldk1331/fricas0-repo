...
(SDEFUN |SOLVERAD;findGenZeros|
        ...
        (SPROG
         ((|res| (|List| (|List| (|Expression| R)))) (#1=#:G143 NIL) (|vv| NIL)
          (#2=#:G144 NIL) (|p| NIL) (#3=#:G142 NIL) (#4=#:G141 NIL) (|r| NIL)
          (#5=#:G140 NIL) (|v| (|Symbol|)) (|pp| (|Polynomial| R)))
...
(SDEFUN |SOLVERAD;findZeros|
        ...
        (SPROG
         ((|res| (|List| (|List| (|Expression| R))))
          ...
          (#1=#:G155 NIL) (|par| NIL)
          (|parRes| (|List| (|List| (|Expression| R)))) (#2=#:G153 NIL)
          (|p| NIL) (#3=#:G154 NIL) (|v| NIL) (#4=#:G152 NIL))
         (SEQ
          (LETT |parRes|
                (PROGN
                 (LETT #4# NIL)
...
(SDEFUN |SOLVERAD;radicalSolve;FSL;10|
        ...
        (SPROG ((#1=#:G159 NIL) (|r| NIL) (#2=#:G158 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |r| NIL)
...
(SDEFUN |SOLVERAD;radicalRoots;LLL;14|
        ((|lp| |List| (|Fraction| (|Polynomial| R))) (|lv| |List| (|Symbol|))
         ($ |List| (|List| (|Expression| R))))
        (SPROG
         ((#1=#:G175 NIL) (#2=#:G174 #3=(|List| (|List| (|Expression| R))))
          (#4=#:G176 #3#) (#5=#:G185 NIL) (|res| NIL)
          (|rpRes| (|List| #6=(|List| (|Polynomial| R)))) (#7=#:G184 NIL)
          (|result| (|List| (|List| (|Expression| R)))) (#8=#:G169 NIL)
          (#9=#:G168 #10=(|List| (|List| (|Expression| R)))) (#11=#:G170 #10#)
          (#12=#:G183 NIL) (|listGen| (|List| #6#)) (#13=#:G182 NIL)
          (#14=#:G181 NIL) (#15=#:G180 NIL) (#16=#:G179 NIL)
          (|rlv| (|List| (|Symbol|)))
...
(SDEFUN |SOLVERAD;radicalSolve;LLL;17|
        ((|le| |List| (|Equation| (|Fraction| (|Polynomial| R))))
         ...
         ($ |List| (|List| (|Equation| (|Expression| R)))))
        (SPROG
         ((#1=#:G206 NIL) (|lres| NIL) (#2=#:G205 NIL)
          (|lp| (|List| (|Fraction| (|Polynomial| R)))) (#3=#:G204 NIL)
          (|p| NIL) (#4=#:G203 NIL))
         (SEQ
          (LETT |lp|
                (PROGN
...
(SDEFUN |SOLVERAD;radicalSolve;LL;18|
        ((|le| |List| (|Equation| (|Fraction| (|Polynomial| R))))
         ($ |List| (|List| (|Equation| (|Expression| R)))))
        (SPROG
         ((#1=#:G218 NIL) (|lres| NIL) (#2=#:G217 NIL)
          (|lv| #3=(|List| (|Symbol|))) (#4=#:G209 NIL) (#5=#:G208 #3#)
          (#6=#:G210 #3#) (#7=#:G216 NIL) (|p| NIL)
          (|lp| (|List| (|Fraction| (|Polynomial| R)))) (#8=#:G215 NIL)
          (#9=#:G214 NIL))
         (SEQ
          (LETT |lp|
                (PROGN
...
(SDEFUN |SOLVERAD;isGeneric?|
        ...
        (SPROG
         ((#1=#:G223 NIL) (#2=#:G222 #3=(|Boolean|)) (#4=#:G224 #3#)
          (#5=#:G226 NIL) (|f| NIL) (#6=#:G227 NIL) (|x| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |SOLVERAD;select|
        ...
        (SPROG
         ((#2=#:G229 NIL) (#3=#:G228 #1#) (#4=#:G230 #1#) (#5=#:G235 NIL)
          (|lsel| NIL) (#6=#:G234 NIL) (#7=#:G233 NIL) (|f| NIL))
         (SEQ
          (COND
...
(SDEFUN |SOLVERAD;makeEq|
        ((|nres| |List| (|Expression| R)) (|lv| |List| (|Symbol|))
         ($ |List| (|Equation| (|Expression| R))))
        (SPROG
         ((#1=#:G239 NIL) (|x| NIL) (#2=#:G240 NIL) (|r| NIL) (#3=#:G238 NIL))
         (SEQ
          (PROGN
           (LETT #3# NIL)
...
(SDEFUN |SOLVERAD;solveInner|
        ...
        (SPROG
         ((|re| (|List| (|Equation| (|Expression| R))))
          (|solutions| (|List| (|Expression| R))) (#1=#:G255 NIL) (|i| NIL)
          (T0 (|List| (|Expression| R))) (|s| (|Expression| R)) (#2=#:G254 NIL)
          (|l| (|List| (|Expression| R)))
...
(DEFUN |RadicalSolvePackage| (#1=#:G256)
  (SPROG NIL
         (PROG (#2=#:G257)
           (RETURN
            (COND
