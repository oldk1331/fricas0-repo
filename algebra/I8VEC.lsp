...
(MAKEPROP '|I8VEC;#;%Nni;1| '|SPADreplace| 'QV_LEN_I8) 

(SDEFUN |I8VEC;#;%Nni;1| ((|x| (%)) (% (|NonNegativeInteger|))) (QV_LEN_I8 |x|)) 

(MAKEPROP '|I8VEC;minIndex;%I;2| '|SPADreplace| '(XLAM (|x|) 0)) 

(SDEFUN |I8VEC;minIndex;%I;2| ((|x| (%)) (% (|Integer|))) 0) 

(MAKEPROP '|I8VEC;empty;%;3| '|SPADreplace| '(XLAM NIL (GETREFV_I8 0 0))) 

(SDEFUN |I8VEC;empty;%;3| ((% (%))) (GETREFV_I8 0 0)) 

(MAKEPROP '|I8VEC;new;NniI%;4| '|SPADreplace| 'GETREFV_I8) 

(SDEFUN |I8VEC;new;NniI%;4|
        ((|n| (|NonNegativeInteger|)) (|x| (|Integer|)) (% (%)))
        (GETREFV_I8 |n| |x|)) 

(MAKEPROP '|I8VEC;qelt;%2I;5| '|SPADreplace| 'ELT_I8) 

(SDEFUN |I8VEC;qelt;%2I;5| ((|x| (%)) (|i| (|Integer|)) (% (|Integer|)))
        (ELT_I8 |x| |i|)) 

(MAKEPROP '|I8VEC;elt;%2I;6| '|SPADreplace| 'ELT_I8) 

(SDEFUN |I8VEC;elt;%2I;6| ((|x| (%)) (|i| (|Integer|)) (% (|Integer|)))
        (ELT_I8 |x| |i|)) 

(MAKEPROP '|I8VEC;qsetelt!;%3I;7| '|SPADreplace| 'SETELT_I8) 

(SDEFUN |I8VEC;qsetelt!;%3I;7|
        ((|x| (%)) (|i| (|Integer|)) (|s| #1=(|Integer|)) (% #1#))
        (SETELT_I8 |x| |i| |s|)) 

(MAKEPROP '|I8VEC;setelt!;%3I;8| '|SPADreplace| 'SETELT_I8) 
...
(DEFUN |I8Vector;| ()
  (SPROG
   ((|dv$| NIL) (% NIL) (#1=#:G2519 NIL) (#2=#:G2518 NIL) (#3=#:G2517 NIL)
    (|pv$| NIL))
   (PROGN
    (LETT |dv$| '(|I8Vector|))
    (LETT % (GETREFV 34))
