...
(SDEFUN |SOLVETRA;logsumtolog| ((|var| (|Expression| R)) ($ (|Expression| R)))
        (SPROG
         ((|var2| (|Expression| R)) (#1=#:G353 NIL) (|i| NIL)
          (|kernelofvar| (|List| (|Kernel| (|Expression| R))))
          (|newexpr| (|Expression| R)) (|exprlist| (|List| (|Expression| R)))
          (#2=#:G352 NIL) (|gcdcoeff| (|Expression| R))
          (|listforgcd| (|List| R)) (|exprcoeff| (R)) (#3=#:G351 NIL)
...
(SDEFUN |SOLVETRA;buildnexpr|
        ...
        (SPROG
         ((|ansmant| (|Expression| R)) (|anscoeff| (|Expression| R))
          (#1=#:G378 NIL) (|i| NIL) (|n2list| (|List| (|Expression| R)))
...
(SDEFUN |SOLVETRA;combineLog|
        ...
        (SPROG
         ((|ansexpr| #1=(|Expression| R)) (#2=#:G398 NIL) (|i| NIL) (|ans| #1#)
...
(SDEFUN |SOLVETRA;tableXkernels|
        ((|evar| (|Expression| R)) (Z (|Symbol|))
         ($ (|List| (|Expression| R))))
        (SPROG
         ((|listkOfvar| (|List| (|Expression| R))) (#1=#:G412 NIL) (|i| NIL)
...
(SDEFUN |SOLVETRA;dropfun| ((|x| (|Expression| R)) ($ (|Expression| R)))
        (SPROG
         ((#1=#:G440 NIL) (|k| (|Union| (|Kernel| (|Expression| R)) "failed")))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |SOLVETRA;makeREpol|
        ...
        (SPROG
         ((|lval| (|List| (|Expression| R))) (#1=#:G504 NIL) (|v| NIL)
          (#2=#:G503 NIL) (|lvar| (|List| (|Symbol|))))
...
(SDEFUN |SOLVETRA;solve1Pol|
        ...
        (SPROG
         ((#1=#:G511 NIL) (|vsol| NIL) (#2=#:G510 NIL)
...
(SDEFUN |SOLVETRA;solve1Sys|
        ...
        (SPROG
         ((|sols| (|List| (|List| (|Equation| (|Expression| R)))))
          (#1=#:G514 NIL)
          (#2=#:G513 #3=(|List| (|List| (|Equation| (|Expression| R)))))
          (#4=#:G515 #3#) (#5=#:G521 NIL) (|sol| NIL) (#6=#:G519 NIL) (|p| NIL)
          (#7=#:G520 NIL) (|v| NIL) (|rlvar| (|List| (|Symbol|)))
...
(SDEFUN |SOLVETRA;tryLinear|
        ((|lexpr| (|List| (|Expression| R))) (|lvar| (|List| (|Symbol|)))
         ($
          (|Union| (|List| (|List| (|Equation| (|Expression| R)))) "failed")))
        (SPROG
         ((|eqs| (|List| (|Equation| (|Expression| R)))) (#1=#:G596 NIL)
          (|i| NIL) (#2=#:G595 NIL) (|sym| (|Expression| R)) (#3=#:G594 NIL)
          (|p| NIL) (|zeron| (|Vector| (|Expression| R)))
          (|rhs| (|Vector| (|Expression| R))) (#4=#:G564 NIL)
          (|sol|
           (|Record|
            (|:| |particular|
                 (|Union| (|Vector| (|Expression| R)) #5="failed"))
            (|:| |basis| (|List| (|Vector| (|Expression| R))))))
          (|vece| (|Vector| (|Expression| R))) (#6=#:G593 NIL) (|q| NIL)
          (#7=#:G592 NIL) (|mate| (|Matrix| (|Expression| R))) (#8=#:G591 NIL)
          (#9=#:G590 NIL) (#10=#:G589 NIL) (|row| NIL) (#11=#:G588 NIL)
          (|r|
           (|Record|
            (|:| |mat|
                 (|Matrix|
          ...
          (|ps|
           (|List|
            (|SparseMultivariatePolynomial| R (|Kernel| (|Expression| R)))))
          (#12=#:G587 NIL) (|expr| NIL) (#13=#:G586 NIL) (#14=#:G578 NIL)
          (#15=#:G585 NIL) (|ker| NIL)
          (|kers| (|List| (|Kernel| (|Expression| R))))
          (|llk| (|List| (|List| (|Kernel| (|Expression| R)))))
          (#16=#:G584 NIL) (#17=#:G583 NIL) (#18=#:G529 NIL)
          (#19=#:G528 #20=(|Boolean|)) (#21=#:G530 #20#) (#22=#:G582 NIL)
          (#23=#:G526 NIL) (#24=#:G525 #25=(|Boolean|)) (#26=#:G527 #25#)
          (#27=#:G581 NIL) (|lvk| (|List| (|Kernel| (|Expression| R))))
          (#28=#:G580 NIL) (|v| NIL) (#29=#:G579 NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |lvk|
...
(SDEFUN |SOLVETRA;solve;LLL;37|
        ((|leqs| (|List| (|Equation| (|Expression| R))))
         ...
         ($ (|List| (|List| (|Equation| (|Expression| R))))))
        (SPROG
         ((|lexpr| (|List| (|Expression| R))) (#1=#:G616 NIL) (|eq| NIL)
          (#2=#:G615 NIL))
         (SEQ
          (LETT |lexpr|
                (PROGN
...
(SDEFUN |SOLVETRA;solve;LLL;38|
        ((|leqs| (|List| (|Equation| (|Expression| R))))
         ...
         ($ (|List| (|List| (|Equation| (|Expression| R))))))
        (SPROG
         ((#1=#:G651 NIL) (|neq| NIL) (#2=#:G650 NIL) (#3=#:G649 NIL)
          (|sol| NIL) (#4=#:G648 NIL) (|lval2| (|List| (|Expression| R)))
          (#5=#:G647 NIL) (|k| NIL) (#6=#:G646 NIL)
          (|lker2| (|List| (|Kernel| (|Expression| R)))) (#7=#:G645 NIL)
          (|v| NIL) (#8=#:G644 NIL)
          (|ans| (|List| (|List| (|Equation| (|Expression| R)))))
          (|nlexpr| (|List| (|Expression| R))) (#9=#:G643 NIL) (|expr| NIL)
          (#10=#:G642 NIL) (|lval| (|List| (|Expression| R))) (#11=#:G641 NIL)
          (#12=#:G640 NIL) (|lvar| (|List| (|Symbol|))) (#13=#:G639 NIL)
          (#14=#:G638 NIL) (|lexpr| (|List| (|Expression| R))) (#15=#:G637 NIL)
          (|eq| NIL) (#16=#:G636 NIL))
         (SEQ
          (LETT |lexpr|
                (PROGN
...
(SDEFUN |SOLVETRA;solve;LLL;40|
        ((|leqs| (|List| (|Equation| (|Expression| R))))
         ...
         ($ (|List| (|List| (|Equation| (|Expression| R))))))
        (SPROG
         ((|lker| (|List| (|Kernel| (|Expression| R)))) (#1=#:G662 NIL)
          (|e| NIL) (#2=#:G661 NIL))
         (SEQ
          (LETT |lker|
                (PROGN
...
(DEFUN |TransSolvePackage| (#1=#:G663)
  (SPROG NIL
         (PROG (#2=#:G664)
           (RETURN
            (COND
