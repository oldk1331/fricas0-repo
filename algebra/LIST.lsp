...
(SDEFUN |LIST;mergeSort|
        ...
        (SPROG ((|q| ($)) (|l| (|NonNegativeInteger|)) (#1=#:G1532 NIL))
               (SEQ
                (COND
                 ((EQL |n| 2)
                  (COND
...
(SDEFUN |LIST;tails;$L;39| ((|x| $) ($ |List| $))
        (SPROG ((#1=#:G1546 NIL) (|i| NIL) (#2=#:G1545 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |LIST;convert;$If;46| ((|x| $) ($ |InputForm|))
        (SPROG ((#1=#:G1586 NIL) (|a| NIL) (#2=#:G1585 NIL))
               (SEQ
                (SPADCALL
...
(DEFUN |List;| (|#1|)
  (SPROG
   ((#1=#:G1595 NIL) (#2=#:G1596 NIL) (#3=#:G1598 NIL) (#4=#:G1597 NIL)
    (|pv$| NIL) (#5=#:G1592 NIL) (#6=#:G1593 NIL) (#7=#:G1594 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
             ...
             (CONS
              ...
              (|makeByteWordVec2| 105
                                  '(1 0 11 0 37 1 0 11 0 39 1 0 6 0 40 1 0 0 0
                                    ...
                                    0 6 0 9 2 0 0 0 6 1 2 0 0 0 0 63 1 0 0 47 1
                                    2 0 0 0 6 1 2 0 0 6 0 10 2 0 0 0 0 69 1 16
                                    43 0 53 1 0 47 0 1 2 4 11 0 0 1 2 0 0 0 0
                                    70 2 14 11 100 0 1 1 3 58 0 1 2 3 72 73 0 1
                                    2 3 58 0 11 1 3 3 72 73 0 11 80 2 15 11 0 0
                                    1 2 15 11 0 0 1 2 20 11 0 0 55 2 15 11 0 0
                                    1 2 15 11 0 0 1 1 14 7 0 8)))))
           '|lookupComplete|)) 
