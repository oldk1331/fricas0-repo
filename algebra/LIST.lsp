...
(SDEFUN |LIST;mergeSort|
        ...
        (SPROG ((|q| ($)) (|l| (|NonNegativeInteger|)) (#1=#:G1605 NIL))
               (SEQ
                (COND
                 ((EQL |n| 2)
                  (COND
...
(SDEFUN |LIST;tails;$L;39| ((|x| ($)) ($ (|List| $)))
        (SPROG ((#1=#:G1620 NIL) (|i| NIL) (#2=#:G1619 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |LIST;convert;$If;46| ((|x| ($)) ($ (|InputForm|)))
        (SPROG ((#1=#:G1674 NIL) (|a| NIL) (#2=#:G1673 NIL))
               (SEQ
                (SPADCALL
...
(DEFUN |List;| (|#1|)
  (SPROG
   ((#1=#:G1683 NIL) (#2=#:G1684 NIL) (#3=#:G1686 NIL) (#4=#:G1685 NIL)
    (|pv$| NIL) (#5=#:G1680 NIL) (#6=#:G1681 NIL) (#7=#:G1682 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
