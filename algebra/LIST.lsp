...
(SDEFUN |LIST;mergeSort|
        ...
        (SPROG ((|q| (%)) (|l| (|NonNegativeInteger|)) (#1=#:G1465 NIL))
               (SEQ
                (COND
                 ((EQL |n| 2)
                  (COND
...
(SDEFUN |LIST;tails;%L;38| ((|x| (%)) (% (|List| %)))
        (SPROG ((#1=#:G1480 NIL) (|i| NIL) (#2=#:G1479 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |LIST;convert;%If;45| ((|x| (%)) (% (|InputForm|)))
        (SPROG ((#1=#:G1536 NIL) (|a| NIL) (#2=#:G1535 NIL))
               (SEQ
                (SPADCALL
...
(DEFUN |List;| (|#1|)
  (SPROG
   ((#1=#:G1545 NIL) (#2=#:G1547 NIL) (#3=#:G1546 NIL) (|pv$| NIL)
    (#4=#:G1542 NIL) (#5=#:G1543 NIL) (#6=#:G1544 NIL) (% NIL) (|dv$| NIL)
    (DV$1 NIL))
   (PROGN
