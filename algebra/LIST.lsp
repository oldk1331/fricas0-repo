  ...
  (PROG (|s| |dev| |sp|)
    (RETURN
     (SEQ (LETT |s| "" . #1=(|LIST;OMwrite;$S;6|))
          ...
          (LETT |dev| (SPADCALL |sp| (SPADCALL (QREFELT $ 20)) (QREFELT $ 21))
                . #1#)
          (SPADCALL |dev| (QREFELT $ 22)) (|LIST;writeOMList| |dev| |x| $)
          (SPADCALL |dev| (QREFELT $ 23)) (SPADCALL |dev| (QREFELT $ 24))
  ...
  (PROG (|u|)
    (RETURN
     (SEQ (LETT |u| NIL . #1=(|LIST;setIntersection;3$;11|))
          ...
          (SEQ G190 (COND ((NULL (COND ((NULL |l1|) 'NIL) ('T 'T))) (GO G191)))
               (SEQ
                (COND
...
(DEFUN |List;| (|#1|)
  (PROG (#1=#:G1551 |pv$| #2=#:G1549 $ |dv$| DV$1)
    (RETURN
     (PROGN
...
(MAKEPROP '|List| '|infovec|
          (LIST
           ...
           (CONS
            (|makeByteWordVec2| 10
                                '(0 0 0 0 0 0 0 0 0 2 0 2 0 0 9 7 0 0 0 0 9 10
                                  1 7 2 3))
            (CONS
             ...
             (CONS
              ...
              (|makeByteWordVec2| 43
                                  '(1 13 12 0 14 3 13 12 0 15 15 16 3 6 12 13 0
                                    ...
                                    0 41 42 1 0 38 0 43 2 6 0 0 0 31 2 6 0 0 0
                                    33 2 6 0 0 0 36 1 12 0 0 30 1 0 8 0 9 0 0 0
                                    7 2 12 8 6 0 32 2 0 6 0 34 35 1 1 38 0 43 2
