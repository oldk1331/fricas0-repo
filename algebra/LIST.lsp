...
(SDEFUN |LIST;mergeSort|
        ...
        (SPROG ((|q| ($)) (|l| (|NonNegativeInteger|)) (#1=#:G1576 NIL))
               (SEQ
                (COND
                 ((EQL |n| 2)
                  (COND
...
(SDEFUN |LIST;tails;$L;39| ((|x| $) ($ |List| $))
        (SPROG ((#1=#:G1590 NIL) (|i| NIL) (#2=#:G1589 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |LIST;convert;$If;46| ((|x| $) ($ |InputForm|))
        (SPROG ((#1=#:G1630 NIL) (|a| NIL) (#2=#:G1629 NIL))
               (SEQ
                (SPADCALL
...
(DEFUN |List;| (|#1|)
  (SPROG
   ((#1=#:G1639 NIL) (#2=#:G1640 NIL) (#3=#:G1642 NIL) (#4=#:G1641 NIL)
    (|pv$| NIL) (#5=#:G1636 NIL) (#6=#:G1637 NIL) (#7=#:G1638 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
