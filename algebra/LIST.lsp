...
(SDEFUN |LIST;mergeSort|
        ...
        (SPROG ((|q| (%)) (|l| (|NonNegativeInteger|)) (#1=#:G1461 NIL))
               (SEQ
                (COND
                 ((EQL |n| 2)
                  (COND
...
(SDEFUN |LIST;tails;%L;38| ((|x| (%)) (% (|List| %)))
        (SPROG ((#1=#:G1476 NIL) (|i| NIL) (#2=#:G1475 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |LIST;convert;%If;45| ((|x| (%)) (% (|InputForm|)))
        (SPROG ((#1=#:G1532 NIL) (|a| NIL) (#2=#:G1531 NIL))
               (SEQ
                (SPADCALL
...
(DEFUN |List;| (|#1|)
  (SPROG
   ((#1=#:G1541 NIL) (#2=#:G1543 NIL) (#3=#:G1542 NIL) (|pv$| NIL)
    (#4=#:G1538 NIL) (#5=#:G1539 NIL) (#6=#:G1540 NIL) (% NIL) (|dv$| NIL)
    (DV$1 NIL))
   (PROGN
