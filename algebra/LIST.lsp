...
(SDEFUN |LIST;mergeSort|
        ...
        (SPROG ((|q| ($)) (|l| (|NonNegativeInteger|)) (#1=#:G1559 NIL))
               (SEQ
                (COND
                 ((EQL |n| 2)
                  (COND
...
(SDEFUN |LIST;tails;$L;39| ((|x| $) ($ |List| $))
        (SPROG ((#1=#:G1573 NIL) (|i| NIL) (#2=#:G1572 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(DEFUN |List;| (|#1|)
  (SPROG
   ((#1=#:G1622 NIL) (#2=#:G1623 NIL) (#3=#:G1625 NIL) (#4=#:G1624 NIL)
    (|pv$| NIL) (#5=#:G1619 NIL) (#6=#:G1620 NIL) (#7=#:G1621 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
