...
(SDEFUN |VECREC1;add_slots;L$V;2|
        ...
        (SPROG
         ((|j| (|Integer|)) (|li| (|Integer|)) (#1=#:G128 NIL) (#2=#:G137 NIL)
...
(SDEFUN |VECREC1;double_poly_space| ((|statearg| ($)) ($ (|Void|)))
        (SPROG
         ((|op| (|U32Vector|)) (|np| (|U32Vector|)) (#1=#:G140 NIL)
          (#2=#:G146 NIL) (|i| NIL) (|n| (|Integer|)) (|m| (|Integer|))
          (|polyvec| (|PrimitiveArray| (|U32Vector|))) (|state| (|Rep|)))
         (SEQ (LETT |state| |statearg|) (LETT |polyvec| (QVELT |state| 6))
...
(SDEFUN |VECREC1;chinese_update;UvI$V;4|
        ((|vec| (|U32Vector|)) (|pt| (|Integer|)) (|statearg| ($))
         ($ (|Void|)))
        (SPROG
         ((|mtvec| (|U32Vector|)) (|nmt| (|U32Vector|)) (#1=#:G153 NIL)
          (|cor| #2=(|Integer|)) (|pol| (|U32Vector|)) (#3=#:G159 NIL)
...
(SDEFUN |VECREC1;rational_reconstruction;2Uv2IU;5|
        ...
        (SPROG
         ((|c| #1=(|Integer|)) (|ds1| #2=(|Integer|)) (|s1| #3=(|U32Vector|))
          ...
          (|ds0a| (|Integer|)) (#6=#:G185 NIL) (|c0| #1#) (|c1| #4#)
          (|delta| #4#) (|j| #5#))
...
(SDEFUN |VECREC1;rational_reconstruction;$U;6|
        ...
        (SPROG
         ((#1=#:G218 NIL) (|cden| #2=(|U32Vector|))
          ...
          (|nums| (|PrimitiveArray| (|U32Vector|))) (#4=#:G197 NIL)
          (#5=#:G195 NIL) (|n| (|Integer|)) (|bound| (|Integer|))
          ...
          (EXIT
           (SEQ (LETT |state| |statearg|) (LETT |modulus| (QVELT |state| 1))
                ...
                (EXIT
                 (COND
                  ((<= |m| (QVELT |state| 7))
                   (PROGN (LETT #1# (CONS 1 "failed")) (GO #6=#:G217)))
                  (#7='T
                   (SEQ
                    (QSETVELT |state| 7
...
(SDEFUN |VECREC1;remove_denoms;V2PaIPa;8|
        ...
        (SPROG
         ((|dt| #1=(|Integer|)) (#2=#:G274 NIL) (|j| NIL)
          (|tmpp2| #3=(|U32Vector|)) (|tmpp1| #3#) (|dtmp| #1#) (|dresi| #1#)
          (|resi| (|U32Vector|)) (#4=#:G273 NIL) (|i| NIL) (|dcf| #1#)
          (|cfactor| (|U32Vector|)) (#5=#:G272 NIL) (#6=#:G271 NIL)
          (|dcden| #1#) (|cden| (|U32Vector|)) (|hi| #7=(|Integer|)) (|li| #7#)
          (#8=#:G270 NIL) (|ib| NIL) (|res| (|PrimitiveArray| (|U32Vector|)))
          ...
          (EXIT
           (SEQ (LETT |pp| (SPADCALL |statearg| (QREFELT $ 36)))
                (EXIT
                 (COND
                  ((QEQCAR |pp| 1)
                   (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G291)))
                  ('T
