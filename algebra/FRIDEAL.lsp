...
(SDEFUN |FRIDEAL;agcd| ((|l| (|List| A)) (% (R)))
        (SPROG ((#1=#:G31 NIL) (|a| NIL) (#2=#:G32 NIL))
               (SEQ
                (SPADCALL (ELT % 39)
                          (PROGN
                           (LETT #1# NIL)
...
(SDEFUN |FRIDEAL;oldnorm| ((|i| (%)) (% (F)))
        (SPROG ((#1=#:G48 NIL) (|u| NIL) (#2=#:G49 NIL))
               (SEQ
                (SPADCALL
                 (SPADCALL
                  (PROGN
                   ...
                   (SEQ (LETT |u| NIL)
                        ...
                        (SEQ
                         (EXIT
                          (LETT #1# (CONS (SPADCALL |u| (QREFELT % 46)) #1#))))
                        (LETT #2# (CDR #2#)) (GO G190) G191
                        (EXIT (NREVERSE #1#))))
                  (QREFELT % 48))
...
(SDEFUN |FRIDEAL;norm;%F;11| ((|i| (%)) (% (F)))
        (SPROG
         ((|v| (|Vector| A)) (|n| (|Integer|)) (|chara| (|NonNegativeInteger|))
          (|j0| (|Integer|)) (#1=#:G69 NIL)
          (|pp| (|SparseUnivariatePolynomial| A))
          (|dv| (|SingletonAsOrderedSet|)) (#2=#:G70 NIL) (|j| NIL)
          (#3=#:G71 NIL))
...
(SDEFUN |FRIDEAL;tryRange|
        ((|range| (|NonNegativeInteger|)) (|nm| (|Vector| A)) (|nrm| (R))
         (|i| (%)) (% (|Union| % "failed")))
        (SPROG
         ((|j| NIL) (|a| (A)) (#1=#:G77 NIL) (#2=#:G84 NIL) (#3=#:G83 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |FRIDEAL;summat| ((|i| (%)) (% (|Matrix| UP)))
        (SPROG
         ((|v| (|Vector| A)) (|m| (|Integer|)) (#1=#:G93 NIL) (|j| NIL)
          (#2=#:G94 NIL))
         (SEQ
          (LETT |m|
          ...
          (EXIT
           (SPADCALL (ELT % 74)
                     (PROGN
                      (LETT #1# NIL)
                      (SEQ (LETT |j| 0) (LETT #2# (- (QVSIZE |v|) 1)) G190
...
(SDEFUN |FRIDEAL;inv;2%;14| ((|i| (%)) (% (%)))
        (SPROG
         ((#1=#:G102 NIL) (|m| (|Matrix| (|Fraction| UP)))
          (|cd| (|Record| (|:| |num| (|Matrix| UP)) (|:| |den| UP)))
          (|cd2| (|Record| (|:| |num| (|List| R)) (|:| |den| R))) (|invd| (F))
          (#2=#:G230 NIL) (|p| NIL) (#3=#:G231 NIL)
          (|d| (|NonNegativeInteger|)) (#4=#:G232 NIL) (|j| NIL)
          (#5=#:G233 NIL))
         (SEQ
          (LETT |m|
                (PROG2
          ...
          (EXIT
           (SPADCALL
            (PROGN
             (LETT #4# (GETREFV (|inc_SI| |d|)))
             (SEQ (LETT |j| 0) (LETT #5# |d|) G190
...
(SDEFUN |FRIDEAL;ideal;V%;15| ((|v| (|Vector| A)) (% (%)))
        (SPROG
         ((#1=#:G248 NIL) (#2=#:G249 NIL) (|d| (R)) (#3=#:G250 NIL) (|i| NIL)
          (#4=#:G251 NIL))
         (SEQ
          (LETT |d|
                (SPADCALL (ELT % 110)
          ...
          (EXIT
           (|FRIDEAL;intIdeal|
            (PROGN
             (LETT #3# NIL)
             (SEQ (LETT |i| (SPADCALL |v| (QREFELT % 58)))
                  (LETT #4# (QVSIZE |v|)) G190 (COND ((> |i| #4#) (GO G191)))
                  (SEQ
                   (EXIT
                    (LETT #3#
                          (CONS
...
(SDEFUN |FRIDEAL;intIdeal| ((|l| (|List| A)) (|d| (R)) (% (%)))
        (SPROG
         ((|x| NIL) (#1=#:G267 NIL) (|u| (|Union| F "failed"))
          (|lr| (|List| R)) (|nr| (|List| A)) (|r| (R)) (|g| (R)) (|b| (R))
          (|a| (A)) (|invb| (F)) (#2=#:G269 NIL) (|m| NIL) (#3=#:G270 NIL)
          (#4=#:G268 NIL) (|va| (|Vector| A)))
         (SEQ (LETT |lr| NIL) (LETT |nr| NIL)
              (SEQ (LETT |x| NIL) (LETT #1# (SPADCALL |l| (QREFELT % 112)))
                   G190
                   (COND
...
(SDEFUN |FRIDEAL;vgcd| ((|v| (|Vector| F)) (% (R)))
        (SPROG ((#1=#:G274 NIL) (|i| NIL) (#2=#:G275 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #1# NIL)
...
(SDEFUN |FRIDEAL;poly| ((|i| (%)) (% (|SparseUnivariatePolynomial| A)))
        (SPROG
         ((|v| (|Vector| A)) (|m| (|Integer|)) (#1=#:G281 NIL)
          (#2=#:G278 #3=(|SparseUnivariatePolynomial| A)) (#4=#:G276 #3#)
          (#5=#:G277 NIL))
         (SEQ
          (LETT |m|
                (SPADCALL (LETT |v| (SPADCALL |i| (QREFELT % 15)))
          ...
          (EXIT
           (PROGN
            (LETT #5# NIL)
            (SEQ (LETT |i| 0) (LETT #1# (- (QVSIZE |v|) 1)) G190
                   ...
                   (PROGN
                    (LETT #2#
                          (SPADCALL (QAREF1O |v| (+ |i| |m|) 1) |i|
                                    (QREFELT % 59)))
                    (COND (#5# (LETT #4# (SPADCALL #4# #2# (QREFELT % 60))))
                          ('T (PROGN (LETT #4# #2#) (LETT #5# 'T)))))))
                 (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL))
            (COND (#5# #4#) ('T (|spadConstant| % 56)))))))) 
...
(SDEFUN |FRIDEAL;^;%I%;20| ((|i| (%)) (|m| (|Integer|)) (% (%)))
        (SPROG
         ((#1=#:G284 NIL) (|n| (|NonNegativeInteger|)) (|v| (|Vector| A))
          (#2=#:G289 NIL) (|j| NIL) (#3=#:G290 NIL))
         (SEQ
          (COND
           ((< |m| 0)
...
(SDEFUN |FRIDEAL;num2O| ((|v| (|Vector| A)) (% (|OutputForm|)))
        (SPROG ((#1=#:G294 NIL) (|i| NIL) (#2=#:G295 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #1# NIL)
...
(SDEFUN |FRIDEAL;basis;%V;22| ((|i| (%)) (% (|Vector| A)))
        (SPROG
         ((|v| (|Vector| A)) (|d| (F)) (#1=#:G302 NIL) (|j| NIL)
          (#2=#:G303 NIL) (#3=#:G301 NIL))
         (SEQ (LETT |v| (SPADCALL |i| (QREFELT % 15)))
              (LETT |d|
                    (SPADCALL
                     (SPADCALL (SPADCALL |i| (QREFELT % 16)) (QREFELT % 72))
...
(SDEFUN |FRIDEAL;randomLC;NniVA;24|
        ...
        (SPROG
         ((|j| NIL) (#1=#:G311 NIL) (#2=#:G309 (A)) (#3=#:G307 (A))
          (#4=#:G308 NIL))
         (SEQ
          (PROGN
           (LETT #4# NIL)
           (SEQ (LETT |j| (SPADCALL |v| (QREFELT % 58)))
                (LETT #1# (QVSIZE |v|)) G190 (COND ((> |j| #1#) (GO G191)))
                (SEQ
                 (EXIT
                  (PROGN
                   (LETT #2#
                   ...
                   (COND (#4# (LETT #3# (SPADCALL #3# #2# (QREFELT % 137))))
                         ('T (PROGN (LETT #3# #2#) (LETT #4# 'T)))))))
                (LETT |j| (+ |j| 1)) (GO G190) G191 (EXIT NIL))
           (COND (#4# #3#) ('T (|spadConstant| % 138))))))) 

(SDEFUN |FRIDEAL;randomLC;NniVA;25|
        ((|m| (|NonNegativeInteger|)) (|v| (|Vector| A)) (% (A)))
        (SPROG
         ((|j| NIL) (#1=#:G316 NIL) (#2=#:G314 (A)) (#3=#:G312 (A))
          (#4=#:G313 NIL))
         (SEQ
          (PROGN
           (LETT #4# NIL)
...
(SDEFUN |FRIDEAL;minimize;2%;26| ((|i| (%)) (% (%)))
        (SPROG
         ((|nm| (|Vector| A)) (|n| (|NonNegativeInteger|)) (|nrm| (R))
          (|range| NIL) (|u| (|Union| % "failed")) (#1=#:G327 NIL)
          (#2=#:G326 NIL))
         (SEQ
          (EXIT
