...
(SDEFUN |TENSPOW;coerce;$Of;1| ((|x| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|le| (|List| (|OutputForm|))) (|ko| (|OutputForm|)) (#1=#:G140 NIL)
          (|b| NIL) (#2=#:G139 NIL) (#3=#:G138 NIL) (|rec| NIL))
         (SEQ
          (COND
...
(SDEFUN |TENSPOW;partialTensor|
        ...
        (SPROG
         ((|res| (|List| (|Record| (|:| |k| (|List| B)) (|:| |c| R))))
          (#1=#:G155 NIL) (|tt| NIL) (#2=#:G154 NIL) (|s1| NIL) (#3=#:G153 NIL)
          (|xr| (|List| M)) (|x1| (M)))
...
(SDEFUN |TENSPOW;*;3$;5| ((|x1| ($)) (|x2| ($)) ($ ($)))
        (SPROG
         ((|res| (|List| (|Record| (|:| |k| (|Vector| B)) (|:| |c| R))))
          (#1=#:G186 NIL) (|t| NIL) (|t1t2| ($)) (#2=#:G184 NIL) (|b1| NIL)
          (#3=#:G185 NIL) (|b2| NIL) (#4=#:G183 NIL) (|t2k| #5=(|Vector| B))
          (|t1k| #5#) (|t2c| (R)) (|t1c| (R)) (#6=#:G182 NIL) (|t2| NIL)
          (#7=#:G181 NIL) (|t1| NIL))
         (SEQ (LETT |res| NIL)
...
(DEFUN |TensorPower;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((|pv$| NIL) (#1=#:G192 NIL) ($ NIL) (|dv$| NIL) (DV$4 NIL) (DV$3 NIL)
    (DV$2 NIL) (DV$1 NIL))
   (PROGN
    (LETT DV$1 |#1|)
