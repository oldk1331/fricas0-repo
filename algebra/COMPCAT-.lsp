...
(SDEFUN |COMPCAT-;divide;2SR;57|
        ...
        (SPROG
         ((#1=#:G346 NIL) (|y1| (S)) (|b| (R)) (|x2| (R)) (|a| (R)) (|x1| (R))
          (|xx| (S)) (|r| (R)))
...
(SDEFUN |COMPCAT-;atan2loc| ((|x| (R)) (|y| (R)) ($ (R)))
        (SPROG ((|theta| (R)) (#1=#:G351 NIL) (|pi2| (R)) (|pi1| (R)))
...
(SDEFUN |COMPCAT-;^;SFS;87| ((|x| (S)) (|q| (|Fraction| (|Integer|))) ($ (S)))
        (SPROG ((|e| (R)) (|t| (R)) (#1=#:G351 NIL) (|i| (R)) (|r| (R)))
               (SEQ
                (COND
                 ((SPADCALL |q| (QREFELT $ 280))
                  (COND
...
(DEFUN |ComplexCategory&| (|#1| |#2|)
  (SPROG
   ((#1=#:G351 NIL) (|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
