        ...
        (SPROG ((|xr| (R)))
               (SEQ
                ...
                (SEQ G190
                     (COND
                      ((NULL
                        (COND ((SPADCALL |xr| (QREFELT $ 29)) 'NIL) ('T 'T)))
                       (GO G191)))
                     (SEQ
                      (EXIT
                       (LETT |xr|
                ...
                (EXIT
                 (SPADCALL
                  (SPADCALL
                   ...
                   (SPADCALL
                    (SPADCALL
                     (SPADCALL (|spadConstant| $ 8) |ix| (QREFELT $ 266))
                     (QREFELT $ 267))
                    (SPADCALL
                   ...
                   (EXIT
                    (COND
                     ((SPADCALL (LETT |i| (SPADCALL |x| (QREFELT $ 87)) . #3#)
                                (QREFELT $ 80))
                      (SPADCALL (SPADCALL |r| |q| (QREFELT $ 281))
                                (QREFELT $ 76)))
                     (#2#
                      (SEQ
                       (LETT |t|
       ...
       (COND
        ((|testBitVector| |pv$| 6)
         (PROGN
          ...
          (QSETREFV $ 284 (CONS (|dispatchFunction| |COMPCAT-;^;SFS;89|) $))))
        ((|testBitVector| |pv$| 3)
         (QSETREFV $ 284
