...
(DEFUN |COMPCAT-;factorSquareFreePolynomial;SupF;6| (|pp| $)
  (PROG (#1=#:G190 |lF| |p2| |p1| #2=#:G197 |u| |fR| |pnorm| |k|)
    (RETURN
     (SEQ
...
(DEFUN |COMPCAT-;coordinates;SVV;29| (|x| |v| $)
  (PROG (|ix| |rx| #1=#:G235 |d| |ia| |ib| |rb| |b| |ra| |a|)
    (RETURN
     (SEQ
      (EXIT
       (SEQ
