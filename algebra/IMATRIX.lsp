...
(SDEFUN |IMATRIX;swapRows!;%2I%;1|
        ((|x| (%)) (|i1| #1=(|Integer|)) (|i2| #1#) (% (%)))
        (SPROG
         ((|t2| (R)) (|t1| (R)) (#2=#:G118 NIL) (|j| NIL) (|co| (|Integer|))
          (|ro| (|Integer|)))
         (SEQ
          (COND
...
(DEFUN |IndexedMatrix| (&REST #1=#:G143)
  (SPROG NIL
         (PROG (#2=#:G144)
           (RETURN
            (COND
...
(DEFUN |IndexedMatrix;| (|#1| |#2| |#3|)
  (SPROG
   ((|pv$| NIL) (#1=#:G140 NIL) (#2=#:G141 NIL) (% NIL) (|dv$| NIL) (DV$3 NIL)
    (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|IndexedMatrix| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL
              ...
              (|List| 40) (65 . |nullSpace|) (70 . |nullSpace|)
              ...
              (|IndexedVector| 6 (NRTEVAL (QREFELT % 8))) (|List| %)
              (|HashState|) (|SingleInteger|) (|String|) (|Void|) (|List| 55)
              (|Union| 6 '"one") (|Mapping| 6 9 9) (|List| 34)
              (|Mapping| 6 6 6) (|Mapping| 6 6) (|List| 42) (|PositiveInteger|)
              (|List| 21) (|List| 57) (|Segment| 9) (|List| 9))
