...
(DEFUN |MAGCDT3;pack_modulus;LLIU;2| (|lm| |lvz| |p| $)
  (PROG (|sizes| |msize| #1=#:G159 |deg| |ldeg| #2=#:G157 |m| #3=#:G158 |v|
         #4=#:G156 |nlmu|)
    (RETURN
     (SEQ
      (COND
...
(DEFUN |MAGCDT3;pack_exps0;SevL2IV;3| (|exps| |sizes| |ns| |start| $)
  (PROG (#1=#:G167 |j| |nstart| #2=#:G166 |i| |deg| |msize| |size1| |do_rec|
         |rsiz|)
    (RETURN
...
(DEFUN |MAGCDT3;extended_gcd| (|x| |y| |lm| |lv| |p| $)
  (PROG (#1=#:G216 |t1| |t0| |#G53| |#G52| |s1| |s0| |#G51| |#G50| |r1| |r0|
