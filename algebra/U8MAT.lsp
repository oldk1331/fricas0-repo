...
(MAKEPROP '|U8MAT;minRowIndex;%I;1| '|SPADreplace| '(XLAM (|x|) 0)) 

(SDEFUN |U8MAT;minRowIndex;%I;1| ((|x| (%)) (% (|Integer|))) 0) 

(MAKEPROP '|U8MAT;minColIndex;%I;2| '|SPADreplace| '(XLAM (|x|) 0)) 

(SDEFUN |U8MAT;minColIndex;%I;2| ((|x| (%)) (% (|Integer|))) 0) 

(MAKEPROP '|U8MAT;nrows;%Nni;3| '|SPADreplace| 'ANROWS_U8) 

(SDEFUN |U8MAT;nrows;%Nni;3| ((|x| (%)) (% (|NonNegativeInteger|)))
        (ANROWS_U8 |x|)) 

(MAKEPROP '|U8MAT;ncols;%Nni;4| '|SPADreplace| 'ANCOLS_U8) 
...
(MAKEPROP '|U8MAT;qelt;%3I;7| '|SPADreplace| 'AREF2_U8) 

(SDEFUN |U8MAT;qelt;%3I;7|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (% (|Integer|)))
        (AREF2_U8 |m| |i| |j|)) 

(MAKEPROP '|U8MAT;elt;%3I;8| '|SPADreplace| 'AREF2_U8) 

(SDEFUN |U8MAT;elt;%3I;8|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (% (|Integer|)))
        (AREF2_U8 |m| |i| |j|)) 

(MAKEPROP '|U8MAT;qsetelt!;%4I;9| '|SPADreplace| 'SETAREF2_U8) 

(SDEFUN |U8MAT;qsetelt!;%4I;9|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (|r| #2=(|Integer|)) (% #2#))
        (SETAREF2_U8 |m| |i| |j| |r|)) 

(MAKEPROP '|U8MAT;setelt!;%4I;10| '|SPADreplace| 'SETAREF2_U8) 

(SDEFUN |U8MAT;setelt!;%4I;10|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (|r| #2=(|Integer|)) (% #2#))
        (SETAREF2_U8 |m| |i| |j| |r|)) 

(MAKEPROP '|U8MAT;empty;%;11| '|SPADreplace| '(XLAM NIL (MAKE_MATRIX_U8 0 0))) 

(SDEFUN |U8MAT;empty;%;11| ((% (%))) (MAKE_MATRIX_U8 0 0)) 

(MAKEPROP '|U8MAT;qnew;2Nni%;12| '|SPADreplace| 'MAKE_MATRIX_U8) 

(SDEFUN |U8MAT;qnew;2Nni%;12|
        ((|rows| #1=(|NonNegativeInteger|)) (|cols| #1#) (% (%)))
        (MAKE_MATRIX_U8 |rows| |cols|)) 

(MAKEPROP '|U8MAT;new;2NniI%;13| '|SPADreplace| 'MAKE_MATRIX1_U8) 
