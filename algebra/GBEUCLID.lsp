         ...
         (SEQ
          ...
          (SEQ G190
               ...
               (SEQ (LETT |h| (|SPADfirst| |Pol1|) . #6#)
                    ...
                    (LETT |lch| (SPADCALL |h| (QREFELT $ 23)) . #6#)
                    (LETT |dd1|
                          (PROGN
                           (LETT #5# NIL . #6#)
                     ...
                     (COND
                      ((SPADCALL |eh| (|spadConstant| $ 40) (QREFELT $ 41))
                       (SEQ
                        ...
                        (EXIT " go to top of while ")))
                      ('T
                       (SEQ (LETT |eh| (SPADCALL |eh| (QREFELT $ 42)) . #6#)
                            (LETT |e| (SPADCALL |eh| (QREFELT $ 18)) . #6#)
                            (LETT |leh| (SPADCALL |eh| (QREFELT $ 23)) . #6#)
                            (LETT |dd1|
                                  (PROGN
                                   (LETT #3# NIL . #6#)
                                   (SEQ (LETT |x| NIL . #6#)
...
(SDEFUN |GBEUCLID;strongGbasis!5| ((|z1| NIL) (|z2| NIL) ($ NIL))
        (COND
         ((SPADCALL (SPADCALL |z1| (QREFELT $ 18))
          ...
          (|spadConstant| $ 21))
         ((SPADCALL (SPADCALL |z1| (QREFELT $ 18))
                    (SPADCALL |z2| (QREFELT $ 18)) (QREFELT $ 22))
...
(SDEFUN |GBEUCLID;ecredPol| ((|h| |Dpol|) (F |List| |Dpol|) ($ |Dpol|))
        (SPROG ((|h0| (|Dpol|)))
               (SEQ
                (LETT |h0| (|spadConstant| $ 40) . #1=(|GBEUCLID;ecredPol|))
                (EXIT
                 (COND ((NULL F) |h|)
                       ('T
                        (SEQ
...
(SDEFUN |GBEUCLID;eRed|
        ...
        (SPROG
         ...
         (SEQ
          (EXIT
           (COND
            ((OR (SPADCALL |s| (|spadConstant| $ 40) (QREFELT $ 41)) (NULL H))
             |s|)
            ('T
             (SEQ (LETT |f1| (|SPADfirst| H) . #2=(|GBEUCLID;eRed|))
                  ...
                  (EXIT
                   (COND
                    ((SPADCALL (QCDR |sdf1|) (|spadConstant| $ 38)
                               (QREFELT $ 35))
                     (|GBEUCLID;eRed|
                      (SPADCALL (SPADCALL |s| (QREFELT $ 48))
                                (SPADCALL
                                 (SPADCALL |q1| (QCDR |e|) (QREFELT $ 46))
                                 (SPADCALL |f1| (QREFELT $ 48)) (QREFELT $ 53))
                                (QREFELT $ 56))
                      |Hh| |Hh| $))
                    ('T
                     (|GBEUCLID;eRed|
...
(SDEFUN |GBEUCLID;ecritB|
        ...
        (SPROG ((|cik| (|Dom|)) (|eik| (|Expon|)))
               (SEQ
                (LETT |eik| (SPADCALL |ei| |ek| (QREFELT $ 28))
                      . #1=(|GBEUCLID;ecritB|))
                   ...
                   (COND
                    ((OR
                      (|GBEUCLID;ecritM| |eik| |cik|
                       (SPADCALL |ei| |eh| (QREFELT $ 28))
                       (SPADCALL |ci| |ch| (QREFELT $ 29)) $)
                      (|GBEUCLID;ecritM| |eik| |cik|
                       (SPADCALL |ek| |eh| (QREFELT $ 28))
                     ...
                     (COND
                      ...
                      ('T
                       (SEQ (SPADCALL "  There are " (QREFELT $ 14))
                            (|GBEUCLID;prinb| 1 $)
                            (SPADCALL (SPADCALL |n| (QREFELT $ 67))
                                      (QREFELT $ 14))
                            (|GBEUCLID;prinb| 1 $)
