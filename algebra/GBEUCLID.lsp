          ...
          (D
           (|List|
            #2=(|Record| (|:| |lcmfij| |Expon|) (|:| |lcmcij| |Dom|)
                         (|:| |poli| |Dpol|) (|:| |polj| |Dpol|))))
          (|dd1| (|List| #2#)) (#3=#:G235 NIL) (|x| NIL) (#4=#:G234 NIL)
          (|leh| (|Dom|)) (|e| (|Expon|)) (|eh| (|Dpol|)) (|ep| (|Dpol|))
          (D0
           (|Record| (|:| |lcmfij| |Expon|) (|:| |lcmcij| |Dom|)
                     (|:| |poli| |Dpol|) (|:| |polj| |Dpol|)))
          (#5=#:G233 NIL) (#6=#:G232 NIL) (|lch| (|Dom|)) (|en| (|Expon|))
...
(SDEFUN |GBEUCLID;updatH|
        ...
        (SPROG
         ((|hp| (|Dpol|)) (|hpp| (|List| |Dpol|)) (#1=#:G261 NIL)
          (|plc|
...
(SDEFUN |GBEUCLID;esPol|
        ((|p|
         ...
         ($ (|Dpol|)))
        (SPROG
         ((#1=#:G288 NIL) (#2=#:G285 NIL) (|lij| (|Dom|)) (|fj| (|Dpol|))
          (|fi| (|Dpol|)) (|Tij| (|Expon|)))
...
(SDEFUN |GBEUCLID;eRed|
        ...
        (SPROG
         ((|q1| (|Dom|))
          ...
          (#1=#:G301 NIL) (|e| (|Union| |Expon| "failed")) (|ls| (|Dom|))
...
(SDEFUN |GBEUCLID;ecritM|
        ((|e1| (|Expon|)) (|c1| (|Dom|)) (|e2| (|Expon|)) (|c2| (|Dom|))
         ($ (|Boolean|)))
        (SPROG ((#1=#:G314 NIL) (|en| (|Union| |Expon| "failed")))
               (SEQ
                (EXIT
                 (SEQ
...
(DEFUN |EuclideanGroebnerBasisPackage| (&REST #1=#:G352)
  (SPROG NIL
         (PROG (#2=#:G353)
           (RETURN
            (COND
