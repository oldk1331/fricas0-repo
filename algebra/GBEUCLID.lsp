          ...
          (D
           (|List|
            #2=(|Record| (|:| |lcmfij| |Expon|) (|:| |lcmcij| |Dom|)
                         (|:| |poli| |Dpol|) (|:| |polj| |Dpol|))))
          (|dd1| (|List| #2#)) (#3=#:G231 NIL) (|x| NIL) (#4=#:G230 NIL)
          (|leh| (|Dom|)) (|e| (|Expon|)) (|eh| (|Dpol|)) (|ep| (|Dpol|))
          (D0
           (|Record| (|:| |lcmfij| |Expon|) (|:| |lcmcij| |Dom|)
                     (|:| |poli| |Dpol|) (|:| |polj| |Dpol|)))
          (#5=#:G229 NIL) (#6=#:G228 NIL) (|lch| (|Dom|)) (|en| (|Expon|))
...
(SDEFUN |GBEUCLID;eRed|
        ...
        (SPROG
         ((|q1| (|Dom|))
          ...
          (#1=#:G296 NIL) (|e| (|Union| |Expon| "failed")) (|ls| (|Dom|))
...
(DEFUN |EuclideanGroebnerBasisPackage| (&REST #1=#:G345)
  (SPROG NIL
         (PROG (#2=#:G346)
           (RETURN
            (COND
