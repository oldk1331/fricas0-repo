...
(SDEFUN |ESC2-;allk| ((|l| (|List| S)) (% (|Set| K)))
        (SPROG ((#1=#:G37 NIL) (|f| NIL) (#2=#:G38 NIL))
               (SEQ
                (SPADCALL (ELT % 28)
                          (PROGN
                           (LETT #1# NIL)
...
(SDEFUN |ESC2-;kernels;LL;8| ((|lf| (|List| S)) (% (|List| K)))
        (SPROG ((#1=#:G45 NIL) (|f| NIL) (#2=#:G46 NIL))
               (SEQ
                (SPADCALL (ELT % 34)
                          (PROGN
                           (LETT #1# NIL)
...
(SDEFUN |ESC2-;operators;SL;9| ((|f| (S)) (% (|List| (|BasicOperator|))))
        (SPROG ((#1=#:G50 NIL) (|k| NIL) (#2=#:G51 NIL))
               (SEQ
                (PROGN
                 (LETT #1# NIL)
                 (SEQ (LETT |k| NIL) (LETT #2# (|ESC2-;listk| |f| %)) G190
                      (COND
                       ((OR (ATOM #2#) (PROGN (LETT |k| (CAR #2#)) NIL))
                        (GO G191)))
                      (SEQ
                       (EXIT
                        (LETT #1# (CONS (SPADCALL |k| (QREFELT % 40)) #1#))))
                      (LETT #2# (CDR #2#)) (GO G190) G191
                      (EXIT (NREVERSE #1#))))))) 

(SDEFUN |ESC2-;height;SNni;10| ((|f| (S)) (% (|NonNegativeInteger|)))
        (SPROG ((#1=#:G57 NIL) (|k| NIL) (#2=#:G58 NIL))
               (SEQ
                (SPADCALL (ELT % 44)
                          (PROGN
                           (LETT #1# NIL)
                           (SEQ (LETT |k| NIL)
                                (LETT #2# (SPADCALL |f| (QREFELT % 35))) G190
                                (COND
                                 ((OR (ATOM #2#)
...
(SDEFUN |ESC2-;freeOf?;SSB;11| ((|x| (S)) (|s| (|Symbol|)) (% (|Boolean|)))
        (SPROG ((#1=#:G63 NIL) (|k| NIL) (#2=#:G64 NIL))
               (SEQ
                (NULL
                 (SPADCALL |s|
                           (PROGN
...
(SDEFUN |ESC2-;distribute;2S;12| ((|x| (S)) (% (S)))
        (SPROG ((#1=#:G69 NIL) (|k| NIL) (#2=#:G70 NIL))
               (SEQ
                (|ESC2-;unwrap|
                 (PROGN
                  (LETT #1# NIL)
                  (SEQ (LETT |k| NIL) (LETT #2# (|ESC2-;listk| |x| %)) G190
                       (COND
                        ((OR (ATOM #2#) (PROGN (LETT |k| (CAR #2#)) NIL))
                         (GO G191)))
                       (SEQ
...
(SDEFUN |ESC2-;eval;SLLS;29|
        ...
        (SPROG ((#1=#:G139 NIL) (|f| NIL) (#2=#:G140 NIL))
               (SEQ
                (SPADCALL |x| |ls|
                          (PROGN
                           (LETT #1# NIL)
...
(SDEFUN |ESC2-;eval;SLLS;30|
        ((|x| (S)) (|ls| (|List| (|Symbol|))) (|lf| (|List| (|Mapping| S S)))
         (% (S)))
        (SPROG ((#1=#:G145 NIL) (|f| NIL) (#2=#:G146 NIL))
               (SEQ
                (SPADCALL |x| |ls|
                          (PROGN
                           (LETT #1# NIL)
...
(SDEFUN |ESC2-;eval;SLLS;31|
        ...
        (SPROG ((#1=#:G152 NIL) (|s| NIL) (#2=#:G153 NIL))
               (SEQ
                (SPADCALL |x|
                          (PROGN
                           (LETT #1# NIL)
                           (SEQ (LETT |s| NIL) (LETT #2# |ls|) G190
                                (COND
                                 ((OR (ATOM #2#)
...
(SDEFUN |ESC2-;map;MKS;32| ((|fn| (|Mapping| S S)) (|k| (K)) (% (S)))
        (SPROG ((#1=#:G216 NIL) (|x| NIL) (#2=#:G217 NIL) (|l| (|List| S)))
               (SEQ
                (COND
                 ((SPADCALL
                   (LETT |l|
                         (PROGN
                          (LETT #1# NIL)
                          (SEQ (LETT |x| NIL)
                               (LETT #2# (SPADCALL |k| (QREFELT % 94))) G190
                               (COND
                                ((OR (ATOM #2#)
...
(SDEFUN |ESC2-;mainKernel;SU;34| ((|x| (S)) (% (|Union| K "failed")))
        (SPROG
         ((|l| (|List| K)) (|kk| NIL) (#1=#:G234 NIL)
          (|n| (|NonNegativeInteger|)) (|k| (K)))
         (SEQ
          (COND
...
(SDEFUN |ESC2-;allKernels| ((|f| (S)) (% (|Set| K)))
        (SPROG
         ((|l| (|List| K)) (|k| NIL) (#1=#:G246 NIL)
          (|u| (|Union| (|None|) "failed")) (|s0| (|Set| K))
          (|n| (|NonNegativeInteger|)) (|arg| (|List| S)) (|t| (|Set| K))
          (|s| (|Set| K)))
         (SEQ
          (LETT |s|
...
(SDEFUN |ESC2-;okkernel| ((|op| (|BasicOperator|)) (|l| (|List| S)) (% (S)))
        (SPROG ((#1=#:G263 NIL) (|f| NIL) (#2=#:G264 NIL))
               (SEQ
                (SPADCALL
                 (SPADCALL |op| |l|
                           (+ 1
...
(SDEFUN |ESC2-;elt;BoLS;38|
        ((|op| (|BasicOperator|)) (|args| (|List| S)) (% (S)))
        (SPROG
         ((|u| (|Union| (|NonNegativeInteger|) "failed")) (#1=#:G276 NIL)
          (|v| (|Union| S "failed")))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |ESC2-;distribute;3S;44| ((|x| (S)) (|y| (S)) (% (S)))
        (SPROG ((|ky| (K)) (#1=#:G310 NIL) (|k| NIL) (#2=#:G311 NIL))
               (SEQ (LETT |ky| (SPADCALL |y| (QREFELT % 60)))
                    (EXIT
                     (|ESC2-;unwrap|
                      (PROGN
                       (LETT #1# NIL)
                       (SEQ (LETT |k| NIL) (LETT #2# (|ESC2-;listk| |x| %))
                            G190
                            (COND
                             ((OR (ATOM #2#) (PROGN (LETT |k| (CAR #2#)) NIL))
                              (GO G191)))
...
(SDEFUN |ESC2-;mkKerLists|
        ...
        (SPROG
         ((|eq| NIL) (#1=#:G329 NIL) (|k| (|Union| K "failed"))
          (|lk| (|List| K)) (|lv| (|List| S)))
