...
(MAKEPROP '|Character| '|infovec|
          (LIST
           ...
           '#(~= 35 |upperCase?| 41 |upperCase| 46 |space| 51 |smaller?| 55
              ...
              |index| 114 |hexDigit?| 119 |hash| 124 |escape| 129 |enumerate|
              133 |digit?| 137 |convert| 142 |coerce| 147 |char| 152
              |alphanumeric?| 162 |alphabetic?| 167 >= 172 > 178 = 184 <= 190 <
              196)
           'NIL
                 ...
                 (CONS
                  ...
                  (CONS
                   '#((|OrderedFinite|) (|OrderedSet|) (|Comparable|)
                      (|Finite|) (|SetCategory|) (|ConvertibleTo| 46)
                   ...
                   (|makeByteWordVec2| 48
                                       '(1 6 0 12 18 0 26 0 27 2 26 7 28 0 29 0
                                         ...
                                         15 1 0 7 0 32 1 0 48 0 1 0 0 0 22 0 0
                                         47 1 1 0 7 0 30 1 0 46 0 1 1 0 24 0 25
                                         1 0 0 12 13 1 0 0 41 43 1 0 7 0 40 1 0
                                         7 0 38 2 0 7 0 0 1 2 0 7 0 0 1 2 0 7 0
                                         0 8 2 0 7 0 0 1 2 0 7 0 0 9)))))
           '|lookupComplete|)) 
