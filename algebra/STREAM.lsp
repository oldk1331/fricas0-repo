...
(SDEFUN |STREAM;showElements;Nni$Of;10|
        ...
        (SPROG
         ((|pp| (|OutputForm|)) (|pl| #1=(|List| (|OutputForm|)))
          (#2=#:G235 NIL) (|i| NIL) (|le| #1#) (#3=#:G234 NIL)
          (|fc|
...
(SDEFUN |STREAM;showAllElements;$Of;13| ((|x| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|pp| (|OutputForm|)) (|pl| (|List| (|OutputForm|))) (#1=#:G257 NIL)
...
(SDEFUN |STREAM;copy;2$;17| ((|x| ($)) ($ ($)))
        (SPROG
         ((|head| ($)) (#1=#:G273 NIL) (|cycle| ($)) (|d| (|Integer|))
...
(SDEFUN |STREAM;setelt!;$Us2S;34|
        ...
        (SPROG
         ((#1=#:G425 NIL) (|y| ($)) (#2=#:G429 NIL) (|i| NIL) (#3=#:G418 NIL)
          (|h| (|Integer|)) (|l| (|Integer|)))
...
(SDEFUN |STREAM;cycleSplit!;2$;42| ((|x| ($)) ($ ($)))
        (SPROG
         ((|z| ($)) (#1=#:G477 NIL) (|y| ($)) (|cycElt| (|Union| $ "failed")))
         (SEQ
          (EXIT
           (SEQ (LETT |cycElt| (SPADCALL |x| (QREFELT $ 36)))
                (EXIT
...
(SDEFUN |STREAM;expand!| ((|x| ($)) (|n| (|Integer|)) ($ ($)))
        (SPROG
         ((#1=#:G489 NIL) (|e| ($)) (|y| ($)) (|nLessD| (|NonNegativeInteger|))
          (#2=#:G488 NIL) (|t| ($)) (|d| (|Integer|))
          (|cycElt| (|Union| $ "failed")) (#3=#:G494 NIL) (|i| NIL))
         (SEQ
          (COND ((< |n| 1) |x|)
                (#4='T
                 (SEQ (LETT |y| |x|)
...
(SDEFUN |STREAM;repeating?;L$B;56| ((|l| (|List| S)) (|x| ($)) ($ (|Boolean|)))
        (SPROG ((#1=#:G531 NIL) (#2=#:G532 NIL) (|s| NIL) (|x0| ($)))
               (SEQ
                (EXIT
                 (COND
                  ((NULL |l|)
...
(SDEFUN |STREAM;eltPositiveStep!0| (($$ NIL))
        (PROG (|seg| $ |x|)
          ...
          (RETURN
           (PROGN
            (SPROG
             ((|step| NIL) (|lo| NIL) (|hi| NIL) (#1=#:G703 NIL)
              (#2=#:G704 NIL) (#3=#:G707 NIL) (|z| NIL))
           ...
           (PROGN
            (SPROG
             ((|step| NIL) (|hi| NIL) (|mustEventuallyFail?| NIL)
              (#1=#:G762 NIL) (|l| NIL) (#2=#:G765 NIL) (|z| NIL) (|lo| NIL)
              (|result| NIL))
             (SEQ
              (LETT |step|
...
(DEFUN |Stream;| (|#1|)
  (SPROG
   ((#1=#:G780 NIL) (#2=#:G781 NIL) (#3=#:G783 NIL) (#4=#:G782 NIL) (|pv$| NIL)
