...
(MAKEPROP '|I16MAT;minRowIndex;%I;1| '|SPADreplace| '(XLAM (|x|) 0)) 

(SDEFUN |I16MAT;minRowIndex;%I;1| ((|x| (%)) (% (|Integer|))) 0) 

(MAKEPROP '|I16MAT;minColIndex;%I;2| '|SPADreplace| '(XLAM (|x|) 0)) 

(SDEFUN |I16MAT;minColIndex;%I;2| ((|x| (%)) (% (|Integer|))) 0) 

(MAKEPROP '|I16MAT;nrows;%Nni;3| '|SPADreplace| 'ANROWS_I16) 

(SDEFUN |I16MAT;nrows;%Nni;3| ((|x| (%)) (% (|NonNegativeInteger|)))
        (ANROWS_I16 |x|)) 

(MAKEPROP '|I16MAT;ncols;%Nni;4| '|SPADreplace| 'ANCOLS_I16) 
...
(MAKEPROP '|I16MAT;qelt;%3I;7| '|SPADreplace| 'AREF2_I16) 

(SDEFUN |I16MAT;qelt;%3I;7|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (% (|Integer|)))
        (AREF2_I16 |m| |i| |j|)) 

(MAKEPROP '|I16MAT;elt;%3I;8| '|SPADreplace| 'AREF2_I16) 

(SDEFUN |I16MAT;elt;%3I;8|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (% (|Integer|)))
        (AREF2_I16 |m| |i| |j|)) 

(MAKEPROP '|I16MAT;qsetelt!;%4I;9| '|SPADreplace| 'SETAREF2_I16) 

(SDEFUN |I16MAT;qsetelt!;%4I;9|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (|r| #2=(|Integer|)) (% #2#))
        (SETAREF2_I16 |m| |i| |j| |r|)) 

(MAKEPROP '|I16MAT;setelt!;%4I;10| '|SPADreplace| 'SETAREF2_I16) 

(SDEFUN |I16MAT;setelt!;%4I;10|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (|r| #2=(|Integer|)) (% #2#))
        (SETAREF2_I16 |m| |i| |j| |r|)) 

(MAKEPROP '|I16MAT;empty;%;11| '|SPADreplace| '(XLAM NIL (MAKE_MATRIX_I16 0 0))) 

(SDEFUN |I16MAT;empty;%;11| ((% (%))) (MAKE_MATRIX_I16 0 0)) 

(MAKEPROP '|I16MAT;qnew;2Nni%;12| '|SPADreplace| 'MAKE_MATRIX_I16) 

(SDEFUN |I16MAT;qnew;2Nni%;12|
        ((|rows| #1=(|NonNegativeInteger|)) (|cols| #1#) (% (%)))
        (MAKE_MATRIX_I16 |rows| |cols|)) 

(MAKEPROP '|I16MAT;new;2NniI%;13| '|SPADreplace| 'MAKE_MATRIX1_I16) 
...
(DEFUN |I16Matrix;| ()
  (SPROG
   ((|dv$| NIL) (% NIL) (#1=#:G2493 NIL) (#2=#:G2494 NIL) (#3=#:G2492 NIL)
    (|pv$| NIL))
   (PROGN
    (LETT |dv$| '(|I16Matrix|))
    (LETT % (GETREFV 46))
