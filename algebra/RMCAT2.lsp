...
(SDEFUN |RMCAT2;map;MM1M2;1| ((|f| |Mapping| R2 R1) (|mat| M1) ($ M2))
        (SPROG
         ((#1=#:G111 NIL) (|j| NIL) (#2=#:G112 NIL) (|l| NIL) (#3=#:G109 NIL)
          (|i| NIL) (#4=#:G110 NIL) (|k| NIL) (|ans| (M2)))
         (SEQ
          (LETT |ans|
...
(SDEFUN |RMCAT2;reduce;MM12R2;2|
        ...
        (SPROG ((|s| (R2)) (#1=#:G119 NIL) (|j| NIL) (#2=#:G118 NIL) (|i| NIL))
...
(DEFUN |RectangularMatrixCategoryFunctions2| (&REST #1=#:G120)
  (SPROG NIL
         (PROG (#2=#:G121)
           (RETURN
            (COND
