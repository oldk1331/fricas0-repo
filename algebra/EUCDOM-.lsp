...
(SDEFUN |EUCDOM-;expressIdealMember;LSU;10|
        ...
        (SPROG
         ((#1=#:G216 NIL) (|v| NIL) (#2=#:G215 NIL) (|q| (|Union| S "failed"))
          (|pid| (|Record| (|:| |coef| (|List| S)) (|:| |generator| S)))
          (#3=#:G214 NIL) (#4=#:G213 NIL))
         (SEQ
          (COND
...
(SDEFUN |EUCDOM-;multiEuclidean;LSU;11|
        ...
        (SPROG
         ((|v2| #2=(|Union| (|List| S) #1#)) (|v1| #2#)
          ...
          (#3=#:G224 NIL) (#4=#:G223 (S)) (#5=#:G225 (S)) (#6=#:G236 NIL)
          (#7=#:G104 NIL) (#8=#:G221 NIL) (#9=#:G220 (S)) (#10=#:G222 (S))
          (#11=#:G235 NIL) (#12=#:G103 NIL) (|l2| (|List| S)) (|l1| (|List| S))
