...
(DEFUN |EUCDOM-;expressIdealMember;LSU;10| (|l| |z| $)
  (PROG (#1=#:G238 |v| #2=#:G237 |q| |pid| #3=#:G236 #4=#:G235)
    (RETURN
     (SEQ
      (COND
...
(DEFUN |EUCDOM-;multiEuclidean;LSU;11| (|l| |z| $)
  (PROG (|v2| |v1| |u| #1=#:G246 #2=#:G245 #3=#:G247 #4=#:G258 #5=#:G126
         #6=#:G243 #7=#:G242 #8=#:G244 #9=#:G257 #10=#:G125 |l2| |l1| |n|)
    (RETURN
