...
(SDEFUN |EUCDOM-;extendedEuclidean;2SR;7|
        ...
        (SPROG
         ((|s3| #1#)
          ...
          (|qr| (|Record| (|:| |quotient| S) (|:| |remainder| S))) (|s1| #2#))
         (SEQ
          (LETT |s1|
                 ...
                 (EXIT
                  (CONS
                   (CONS (QVELT |u| 0)
                         (PROGN
                          (LETT #1# NIL)
                          (SEQ (LETT |vv| NIL) (LETT #2# (QCAR |v|)) G190
                               (COND
                                ((OR (ATOM #2#)
...
(SDEFUN |EUCDOM-;expressIdealMember;LSU;10|
        ...
        (SPROG
         ((#1=#:G113 NIL) (#2=#:G114 NIL)
          (|pid| (|Record| (|:| |coef| (|List| S)) (|:| |generator| S)))
          (|q| (|Union| S "failed")) (#3=#:G115 NIL) (|v| NIL) (#4=#:G116 NIL))
         (SEQ
          (COND
                   ...
                   (SEQ (LETT |v| NIL) (LETT #2# |l|) G190
                        (COND
                         ((OR (ATOM #2#) (PROGN (LETT |v| (CAR #2#)) NIL))
                          (GO G191)))
                        (SEQ
                         (EXIT (LETT #1# (CONS (|spadConstant| % 26) #1#))))
                        (LETT #2# (CDR #2#)) (GO G190) G191
                        (EXIT (NREVERSE #1#))))))
           (#5='T
                  ...
                  (COND ((QEQCAR |q| 1) (CONS 1 "failed"))
                        (#5#
                         (CONS 0
                               (PROGN
                                (LETT #3# NIL)
                                (SEQ (LETT |v| NIL) (LETT #4# (QCAR |pid|))
                                     G190
                                     (COND
                                      ((OR (ATOM #4#)
...
(SDEFUN |EUCDOM-;multiEuclidean;LSU;11|
        ...
        (SPROG
         ((|n| (|NonNegativeInteger|)) (|l1| (|List| S)) (|l2| (|List| S))
          (#2=#:G0 NIL) (#3=#:G135 NIL) (#4=#:G122 (S)) (#5=#:G120 (S))
          (#6=#:G121 NIL) (#7=#:G1 NIL) (#8=#:G136 NIL) (#9=#:G125 (S))
          (#10=#:G123 (S)) (#11=#:G124 NIL)
          (|u| (|Union| (|Record| (|:| |coef1| S) (|:| |coef2| S)) "failed"))
          (|v1| #12=(|Union| (|List| S) #1#)) (|v2| #12#))
         (SEQ (LETT |n| (LENGTH |l|))
              (EXIT
               (COND
                            ...
                            (SPADCALL
                             (PROGN
                              ...
                              (SEQ (LETT #2# NIL) (LETT #3# |l1|) G190
                                   ...
                                   (EXIT NIL))
                              (COND (#6# #5#) (#13# (|spadConstant| % 23))))
                             (PROGN
                              (LETT #11# NIL)
                              (SEQ (LETT #7# NIL) (LETT #8# |l2|) G190
                                   (COND
                                    ((OR (ATOM #8#)
