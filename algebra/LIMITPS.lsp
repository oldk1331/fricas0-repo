...
(SDEFUN |LIMITPS;is_exp_log| ((|fcn| (FE)) (|x| (|Symbol|)) ($ (|Boolean|)))
        (SPROG ((#1=#:G287 NIL) (|nm| (|Symbol|)) (#2=#:G288 NIL) (|k| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |k| NIL)
...
(SDEFUN |LIMITPS;firstNonLogPtr|
        ...
        (SPROG
         ((|list| (|List| (|Kernel| FE))) (#1=#:G300 NIL)
          (|ker| (|Kernel| FE)))
         (SEQ
          (EXIT
...
(SDEFUN |LIMITPS;specialLimit|
        ...
        (SPROG
         ((#2=#:G357 NIL) (|den| (FE)) (|num| (FE)) (|finVal| (FE))
          (|valu| (|Union| FE "failed")) (|val| (|OrderedCompletion| FE))
          (|fval| (|Union| (|OrderedCompletion| FE) #1#)) (#3=#:G360 NIL)
          (|k| NIL) (|xkers| (|List| (|Kernel| FE))) (#4=#:G359 NIL)
          (#5=#:G358 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |LIMITPS;specialLimitNormalize|
        ...
        (SPROG
         ((|lim| (|Union| FE "failed")) (|limm| (|OrderedCompletion| FE))
          ...
          (#3=#:G384 NIL) (|k| NIL) (#4=#:G383 NIL) (|xkers| (|List| #2#))
          (#5=#:G382 NIL) (#6=#:G381 NIL) (|nfcn| (FE)))
...
(SDEFUN |LIMITPS;specialLimit1|
        ...
        (SPROG
         ((|limVal|
          ...
          (|xkers| (|List| (|Kernel| FE))) (#2=#:G400 NIL) (|k| NIL)
          (#3=#:G399 NIL))
         (SEQ
          (LETT |xkers|
                (PROGN
...
(SDEFUN |LIMITPS;anyRootsOrAtrigs?| ((|fcn| (FE)) ($ (|Boolean|)))
        (SPROG ((#1=#:G536 NIL) (#2=#:G537 NIL) (#3=#:G538 NIL) (|kernel| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |kernel| NIL)
...
(SDEFUN |LIMITPS;complLimit|
        ((|fcn| (FE)) (|x| (|Symbol|))
         ($ (|Union| (|OnePointCompletion| FE) "failed")))
        (SPROG
         ((|answer| (FE)) (|lim| (FE)) (#1=#:G566 NIL) (|uls| (|Uls|))
          (|lseries|
           (|Union| (|:| |%series| |Uls|)
                    (|:| |%problem|
                         (|Record| (|:| |func| (|String|))
                     ...
                     ((|LIMITPS;anyRootsOrAtrigs?| |fcn| $)
                      (SEQ
                       ...
                       (EXIT
                        (COND
                         ((QEQCAR |pseries| 1)
                          (PROGN (LETT #1# (CONS 1 "failed")) (GO #27=#:G565)))
                         (#28='T
                          (SEQ
                           (COND
        ...
        ((|fcn| (FE)) (|x| (|Symbol|))
         ($
          (|Union| (|OrderedCompletion| FE)
                   ...
                   "failed")))
        (SPROG
         ((|answer| (FE)) (|lim| (|Union| FE "failed")) (#2=#:G642 NIL)
...
(SDEFUN |LIMITPS;limitPlus|
        ...
        (SPROG
         ((|xLim| (|Union| (|OrderedCompletion| FE) #1#)) (|answer| (FE))
          (|lim| (|Union| FE "failed")) (#2=#:G682 NIL) (|cl| (FE))
        ...
        ((|fcn| (FE)) (|eq| (|Equation| (|OrderedCompletion| FE)))
         ...
         ($
          (|Union| (|OrderedCompletion| FE)
                   ...
                   #3#)))
        (SPROG
         ((#4=#:G702 NIL) (|res2| (|Union| (|OrderedCompletion| FE) #2#))
...
(SDEFUN |LIMITPS;complexLimit;FEEU;38|
        ((|fcn| (FE)) (|eq| (|Equation| (|OnePointCompletion| FE)))
         ($ (|Union| (|OnePointCompletion| FE) "failed")))
        (SPROG
         ((#1=#:G739 NIL) (|res2| #2=(|Union| FE "failed"))
...
(DEFUN |PowerSeriesLimitPackage| (&REST #1=#:G740)
  (SPROG NIL
         (PROG (#2=#:G741)
           (RETURN
            (COND
