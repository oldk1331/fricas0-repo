...
(MAKEPROP '|U32VEC;#;%Nni;1| '|SPADreplace| 'QV_LEN_U32) 

(SDEFUN |U32VEC;#;%Nni;1| ((|x| (%)) (% (|NonNegativeInteger|)))
        (QV_LEN_U32 |x|)) 

(MAKEPROP '|U32VEC;minIndex;%I;2| '|SPADreplace| '(XLAM (|x|) 0)) 

(SDEFUN |U32VEC;minIndex;%I;2| ((|x| (%)) (% (|Integer|))) 0) 

(MAKEPROP '|U32VEC;empty;%;3| '|SPADreplace| '(XLAM NIL (GETREFV_U32 0 0))) 

(SDEFUN |U32VEC;empty;%;3| ((% (%))) (GETREFV_U32 0 0)) 

(MAKEPROP '|U32VEC;new;NniI%;4| '|SPADreplace| 'GETREFV_U32) 

(SDEFUN |U32VEC;new;NniI%;4|
        ((|n| (|NonNegativeInteger|)) (|x| (|Integer|)) (% (%)))
        (GETREFV_U32 |n| |x|)) 

(MAKEPROP '|U32VEC;qelt;%2I;5| '|SPADreplace| 'ELT_U32) 

(SDEFUN |U32VEC;qelt;%2I;5| ((|x| (%)) (|i| (|Integer|)) (% (|Integer|)))
        (ELT_U32 |x| |i|)) 

(MAKEPROP '|U32VEC;elt;%2I;6| '|SPADreplace| 'ELT_U32) 

(SDEFUN |U32VEC;elt;%2I;6| ((|x| (%)) (|i| (|Integer|)) (% (|Integer|)))
        (ELT_U32 |x| |i|)) 

(MAKEPROP '|U32VEC;qsetelt!;%3I;7| '|SPADreplace| 'SETELT_U32) 

(SDEFUN |U32VEC;qsetelt!;%3I;7|
        ((|x| (%)) (|i| (|Integer|)) (|s| #1=(|Integer|)) (% #1#))
        (SETELT_U32 |x| |i| |s|)) 

(MAKEPROP '|U32VEC;setelt!;%3I;8| '|SPADreplace| 'SETELT_U32) 
...
(DEFUN |U32Vector;| ()
  (SPROG
   ((|dv$| NIL) (% NIL) (#1=#:G2254 NIL) (#2=#:G2253 NIL) (#3=#:G2252 NIL)
    (|pv$| NIL))
   (PROGN
    (LETT |dv$| '(|U32Vector|))
    (LETT % (GETREFV 34))
