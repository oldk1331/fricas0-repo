...
(DEFUN |DifferentialPolynomialCategory| (&REST #1=#:G144)
  (LET (#2=#:G145)
    (COND
     ((SETQ #2#
                              ...
                              (|mkCategory|
                               '(((|makeVariable|
                                   ((|Mapping| $ (|NonNegativeInteger|))
                                    |t#2|))
                                  T)
                                 ((|differentialVariables| ((|List| |t#2|) $))
                                  T)
                                 ((|order| ((|NonNegativeInteger|) $ |t#2|)) T)
                                 ((|order| ((|NonNegativeInteger|) $)) T)
                                 ((|degree| ((|NonNegativeInteger|) $ |t#2|))
                                  T)
                                 ((|weights|
                                 ...
                                 ((|weights|
                                   ((|List| (|NonNegativeInteger|)) $ |t#2|))
                                  T)
                                 ((|weight| ((|NonNegativeInteger|) $ |t#2|))
                                  T)
                                 ((|isobaric?| ((|Boolean|) $)) T)
                                 ((|leader| (|t#3| $)) T) ((|initial| ($ $)) T)
                                 ((|separant| ($ $)) T)
                                 ((|makeVariable|
                                   ((|Mapping| $ (|NonNegativeInteger|)) $))
