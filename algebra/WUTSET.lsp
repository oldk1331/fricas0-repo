...
(SDEFUN |WUTSET;characteristicSerie;LMML;10|
        ...
        (SPROG
         ((#1=#:G219 NIL) (|ln| (|List| (|SplittingNode| (|List| P) $)))
...
(SDEFUN |WUTSET;removeSquares| ((|ts| ($)) ($ #1=(|Union| $ "failed")))
        (SPROG
         ((|p| (P)) (|newts| ($)) (|rsts| #1#) (#2=#:G182 NIL) (#3=#:G247 NIL))
         (SEQ
...
(DEFUN |WuWenTsunTriangularSet| (&REST #1=#:G287)
  (SPROG NIL
         (PROG (#2=#:G288)
           (RETURN
            (COND
...
(DEFUN |WuWenTsunTriangularSet;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((#1=#:G286 NIL) (|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$4 NIL) (DV$3 NIL)
    (DV$2 NIL) (DV$1 NIL))
   (PROGN
