...
(DEFUN |OC-;characteristic;Nni;1| ($) (SPADCALL (QREFELT $ 9))) 

(DEFUN |OC-;conjugate;2S;2| (|x| $)
    ...
    (SPADCALL
     (SPADCALL
      (SPADCALL
       (SPADCALL
        (SPADCALL
         (SPADCALL (SPADCALL |x| (QREFELT $ 11)) (SPADCALL |x| (QREFELT $ 11))
                   (QREFELT $ 24))
         (SPADCALL (SPADCALL |x| (QREFELT $ 12)) (SPADCALL |x| (QREFELT $ 12))
                   (QREFELT $ 24))
         (QREFELT $ 25))
        (SPADCALL (SPADCALL |x| (QREFELT $ 14)) (SPADCALL |x| (QREFELT $ 14))
                  (QREFELT $ 24))
        (QREFELT $ 25))
       (SPADCALL (SPADCALL |x| (QREFELT $ 15)) (SPADCALL |x| (QREFELT $ 15))
                 (QREFELT $ 24))
       (QREFELT $ 25))
      (SPADCALL (SPADCALL |x| (QREFELT $ 16)) (SPADCALL |x| (QREFELT $ 16))
                (QREFELT $ 24))
      (QREFELT $ 25))
     (SPADCALL (SPADCALL |x| (QREFELT $ 17)) (SPADCALL |x| (QREFELT $ 17))
               (QREFELT $ 24))
     (QREFELT $ 25))
           ...
           (COND
            ((SPADCALL (SPADCALL |x| (QREFELT $ 17)) (QREFELT $ 40))
             (COND
              ((SPADCALL (SPADCALL |x| (QREFELT $ 18)) (QREFELT $ 40))
               (COND
                ((NULL (SPADCALL (SPADCALL |x| (QREFELT $ 19)) (QREFELT $ 40)))
    ...
    (RETURN
     (SEQ
      (COND
       ...
       ((NULL (SPADCALL (SPADCALL |x| (QREFELT $ 11)) (QREFELT $ 40)))
        (SEQ
         (LETT |y|
               (SPADCALL (|spadConstant| $ 36) (SPADCALL |x| (QREFELT $ 12))
                         ...
                         (SPADCALL |x| (QREFELT $ 19)) (QREFELT $ 20))
               . #1=(|OC-;coerce;SOf;15|))
         (EXIT
          (COND
           ...
           (#2='T
            (SPADCALL (SPADCALL (SPADCALL |x| (QREFELT $ 11)) (QREFELT $ 47))
                      (SPADCALL |y| (QREFELT $ 48)) (QREFELT $ 49)))))))
       ((NULL (SPADCALL (SPADCALL |x| (QREFELT $ 12)) (QREFELT $ 40)))
        (SEQ
         (LETT |y|
               ...
               (SEQ (LETT |part| (SPADCALL '|i| (QREFELT $ 51)) . #1#)
                    (EXIT
                     (COND
                      ...
                      (#2#
                       (SPADCALL
                        (SPADCALL (SPADCALL |x| (QREFELT $ 12)) (QREFELT $ 47))
                        |part| (QREFELT $ 53))))))
               . #1#)
         (EXIT
          (COND ((SPADCALL |y| (QREFELT $ 45)) |z|)
                (#2#
                 (SPADCALL |z| (SPADCALL |y| (QREFELT $ 48))
                           (QREFELT $ 49)))))))
       ((NULL (SPADCALL (SPADCALL |x| (QREFELT $ 14)) (QREFELT $ 40)))
        (SEQ
         (LETT |y|
               (SPADCALL (|spadConstant| $ 36) (|spadConstant| $ 36)
                         (|spadConstant| $ 36) (SPADCALL |x| (QREFELT $ 15))
                         (SPADCALL |x| (QREFELT $ 16))
                         (SPADCALL |x| (QREFELT $ 17))
                         (SPADCALL |x| (QREFELT $ 18))
                         (SPADCALL |x| (QREFELT $ 19)) (QREFELT $ 20))
               ...
               (SEQ (LETT |part| (SPADCALL '|j| (QREFELT $ 51)) . #1#)
                    (EXIT
                     (COND
                      ...
                      (#2#
                       (SPADCALL
                        (SPADCALL (SPADCALL |x| (QREFELT $ 14)) (QREFELT $ 47))
                        |part| (QREFELT $ 53))))))
               . #1#)
         (EXIT
          (COND ((SPADCALL |y| (QREFELT $ 45)) |z|)
                (#2#
                 (SPADCALL |z| (SPADCALL |y| (QREFELT $ 48))
                           (QREFELT $ 49)))))))
       ((NULL (SPADCALL (SPADCALL |x| (QREFELT $ 15)) (QREFELT $ 40)))
        (SEQ
         (LETT |y|
               (SPADCALL (|spadConstant| $ 36) (|spadConstant| $ 36)
               ...
               (SEQ (LETT |part| (SPADCALL '|k| (QREFELT $ 51)) . #1#)
                    (EXIT
                     (COND
                      ...
                      (#2#
                       (SPADCALL
                        (SPADCALL (SPADCALL |x| (QREFELT $ 15)) (QREFELT $ 47))
                        |part| (QREFELT $ 53))))))
               . #1#)
         (EXIT
          (COND ((SPADCALL |y| (QREFELT $ 45)) |z|)
                (#2#
                 (SPADCALL |z| (SPADCALL |y| (QREFELT $ 48))
                           (QREFELT $ 49)))))))
       ((NULL (SPADCALL (SPADCALL |x| (QREFELT $ 16)) (QREFELT $ 40)))
        (SEQ
         (LETT |y|
               (SPADCALL (|spadConstant| $ 36) (|spadConstant| $ 36)
                         (|spadConstant| $ 36) (|spadConstant| $ 36)
                         (|spadConstant| $ 36) (SPADCALL |x| (QREFELT $ 17))
                         (SPADCALL |x| (QREFELT $ 18))
                         (SPADCALL |x| (QREFELT $ 19)) (QREFELT $ 20))
               . #1#)
         (LETT |z|
               (SEQ (LETT |part| (SPADCALL 'E (QREFELT $ 51)) . #1#)
                    (EXIT
                     (COND
                      ...
                      (#2#
                       (SPADCALL
                        (SPADCALL (SPADCALL |x| (QREFELT $ 16)) (QREFELT $ 47))
                        |part| (QREFELT $ 53))))))
               . #1#)
         (EXIT
          (COND ((SPADCALL |y| (QREFELT $ 45)) |z|)
                (#2#
                 (SPADCALL |z| (SPADCALL |y| (QREFELT $ 48))
                           (QREFELT $ 49)))))))
       ((NULL (SPADCALL (SPADCALL |x| (QREFELT $ 17)) (QREFELT $ 40)))
        (SEQ
         (LETT |y|
               (SPADCALL (|spadConstant| $ 36) (|spadConstant| $ 36)
                         (|spadConstant| $ 36) (|spadConstant| $ 36)
         ...
         (EXIT
          (COND ((SPADCALL |y| (QREFELT $ 45)) |z|)
                (#2#
                 (SPADCALL |z| (SPADCALL |y| (QREFELT $ 48))
                           (QREFELT $ 49)))))))
       ((NULL (SPADCALL (SPADCALL |x| (QREFELT $ 18)) (QREFELT $ 40)))
        (SEQ
         (LETT |y|
               (SPADCALL (|spadConstant| $ 36) (|spadConstant| $ 36)
                         (|spadConstant| $ 36) (|spadConstant| $ 36)
                         (|spadConstant| $ 36) (|spadConstant| $ 36)
                         (|spadConstant| $ 36) (SPADCALL |x| (QREFELT $ 19))
                         (QREFELT $ 20))
               . #1#)
         (LETT |z|
               (SEQ (LETT |part| (SPADCALL 'J (QREFELT $ 51)) . #1#)
                    (EXIT
                     (COND
                      ...
                      (#2#
                       (SPADCALL
                        (SPADCALL (SPADCALL |x| (QREFELT $ 18)) (QREFELT $ 47))
                        |part| (QREFELT $ 53))))))
               . #1#)
         (EXIT
          (COND ((SPADCALL |y| (QREFELT $ 45)) |z|)
       ...
       ('T
        (SEQ (LETT |part| (SPADCALL 'K (QREFELT $ 51)) . #1#)
             (EXIT
              (COND
               ((SPADCALL (SPADCALL |x| (QREFELT $ 19)) (|spadConstant| $ 52)
                          (QREFELT $ 28))
                |part|)
               (#2#
                (SPADCALL
                 (SPADCALL (SPADCALL |x| (QREFELT $ 19)) (QREFELT $ 47)) |part|
                 (QREFELT $ 53)))))))))))) 

(DEFUN |OC-;inv;2S;16| (|x| $)
  (COND
...
(DEFUN |OC-;convert;SIf;17| (|x| $)
  (PROG (|l|)
    (RETURN
     (SEQ
      (LETT |l|
            (LIST (SPADCALL '|octon| (QREFELT $ 61))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 11)) (QREFELT $ 62))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 12)) (QREFELT $ 62))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 14)) (QREFELT $ 62))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 15)) (QREFELT $ 62))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 16)) (QREFELT $ 62))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 17)) (QREFELT $ 62))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 18)) (QREFELT $ 62))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 19)) (QREFELT $ 62)))
            |OC-;convert;SIf;17|)
            ...
            (COND
             ((SPADCALL (SPADCALL |x| (QREFELT $ 17))
              ...
              (COND
               ...
               (#1='T
                (SPADCALL (SPADCALL |x| (QREFELT $ 18))
                          (SPADCALL |y| (QREFELT $ 18)) (QREFELT $ 66)))))
             (#1#
              (SPADCALL (SPADCALL |x| (QREFELT $ 17))
...
(DEFUN |OC-;abs;SR;19| (|x| $)
  (SPADCALL (SPADCALL |x| (QREFELT $ 55)) (QREFELT $ 68))) 

(DEFUN |OC-;rational?;SB;20| (|x| $)
  (COND
   ((SPADCALL (SPADCALL |x| (QREFELT $ 12)) (QREFELT $ 40))
    (COND
     ((SPADCALL (SPADCALL |x| (QREFELT $ 14)) (QREFELT $ 40))
  ...
  (PROG (|pv$| $ |dv$| DV$2 DV$1)
    (RETURN
     (PROGN
      ...
      (COND
       ((|testBitVector| |pv$| 6)
        (QSETREFV $ 65 (CONS (|dispatchFunction| |OC-;convert;SIf;17|) $))))
      (COND
       ((|testBitVector| |pv$| 7)
      ...
      (COND
       ((|testBitVector| |pv$| 2)
        (PROGN
         (QSETREFV $ 70 (CONS (|dispatchFunction| |OC-;rational?;SB;20|) $))
