...
(SDEFUN |LODOF;expsols|
        ((|l| |LinearOrdinaryDifferentialOperator1| (|Fraction| UP))
         ...
         ($ |List| (|Fraction| UP)))
        (SPROG
         ((|sol| (|List| (|Fraction| UP))) (#1=#:G132 NIL) (|f| NIL)
          (#2=#:G131 NIL))
         (SEQ
          (LETT |sol|
                (PROGN
...
(SDEFUN |LODOF;zro|
        ...
        (SPROG ((#1=#:G197 NIL) (|r| NIL) (#2=#:G196 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
...
(DEFUN |LinearOrdinaryDifferentialOperatorFactorizer| (&REST #1=#:G217)
  (SPROG NIL
         (PROG (#2=#:G218)
           (RETURN
            (COND
