...
(SDEFUN |LODOF;expsols|
        ((|l| (|LinearOrdinaryDifferentialOperator1| (|Fraction| UP)))
         ...
         ($ (|List| (|Fraction| UP))))
        (SPROG
         ((|sol| (|List| (|Fraction| UP))) (#1=#:G147 NIL) (|f| NIL)
          (#2=#:G146 NIL))
         (SEQ
          (LETT |sol|
                (PROGN
...
(SDEFUN |LODOF;zro|
        ...
        (SPROG ((#1=#:G212 NIL) (|r| NIL) (#2=#:G211 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(DEFUN |LinearOrdinaryDifferentialOperatorFactorizer| (&REST #1=#:G232)
  (SPROG NIL
         (PROG (#2=#:G233)
           (RETURN
            (COND
