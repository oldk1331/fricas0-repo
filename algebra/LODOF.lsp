...
(SDEFUN |LODOF;expsols|
        ((|l| (|LinearOrdinaryDifferentialOperator1| (|Fraction| UP)))
         ...
         (% (|List| (|Fraction| UP))))
        (SPROG
         ((#1=#:G28 NIL) (|f| NIL) (#2=#:G29 NIL)
          (|sol| (|List| (|Fraction| UP))))
         (SEQ
          (LETT |sol|
                (PROGN
                 (LETT #1# NIL)
...
(SDEFUN |LODOF;zro|
        ...
        (SPROG ((#1=#:G96 NIL) (|r| NIL) (#2=#:G97 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #1# NIL)
                  (SEQ (LETT |r| NIL)
                       ...
                       (SEQ
                        (EXIT
                         (LETT #1# (CONS (|LODOF;zro1| (QCAR |r|) %) #1#))))
                       (LETT #2# (CDR #2#)) (GO G190) G191
                       (EXIT (NREVERSE #1#))))
                 (QREFELT % 60))))) 
...
(MAKEPROP '|LinearOrdinaryDifferentialOperatorFactorizer| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              |LODOF;factor;LodoML;1| (9 . |0|) (13 . |0|) (|Fraction| 7)
              (17 . |0|) (|Union| 18 '"failed")
              ...
              (57 . |0|) (61 . |1|) (|NonNegativeInteger|) (65 . |degree|)
              (70 . |coefficient|) (76 . *) (82 . +) (88 . *)
              (|Union| % '"failed") (94 . |rightExactQuotient|) (100 . |1|)
              (104 . |leadingCoefficient|) (109 . |1|) (113 . =)
              (119 . |coerce|) (124 . -) (|Mapping| 8 8) (130 . |map!|)
              (136 . |1|) (140 . |adjoint|) (145 . |concat!|)
