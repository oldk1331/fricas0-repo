...
(SDEFUN |PIT;split;PMR;1|
        ...
        (SPROG
         ((|v| (|Union| V "failed")) (|up| (|SparseUnivariatePolynomial| P))
          (|p0| (P)) (|up1| (|SparseUnivariatePolynomial| P))
          (|rec0| #1=(|Record| (|:| |normal| P) (|:| |special| P))) (|p1| (P))
          (|gder| (P)) (|gdif| (P)) (|pbar| (P)) (#2=#:G6 NIL) (|rec1| #1#))
