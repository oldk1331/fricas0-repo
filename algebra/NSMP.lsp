...
(SDEFUN |NSMP;prem;3$;19| ((|a| ($)) (|b| ($)) ($ ($)))
        (SPROG
         ((#1=#:G242 NIL) (|test| (|Integer|)) (|delta| (|Integer|))
          (|term| ($)) (#2=#:G235 NIL) (#3=#:G246 NIL) (|r| (D))
...
(SDEFUN |NSMP;lazyPquo;3$;23| ((|a| ($)) (|b| ($)) ($ ($)))
        (SPROG
         ((|test| (|Integer|)) (|q| ($)) (|term| ($)) (#1=#:G275 NIL)
        ...
        ((|a| ($)) (|b| ($))
         ($
          (|Record| (|:| |coef| $) (|:| |gap| (|NonNegativeInteger|))
                    (|:| |quotient| $) (|:| |remainder| $))))
        (SPROG
         ((#1=#:G295 NIL) (|test| (|Integer|)) (|delta| (|Integer|)) (|q| ($))
          (|term| ($)) (#2=#:G291 NIL) (|lcb| ($))
          (|db| (|NonNegativeInteger|))
          (|cgqr|
           (|Record| (|:| |coef| $) (|:| |gap| (|NonNegativeInteger|))
...
(SDEFUN |NSMP;lazyResidueClass;2$R;25|
        ...
        (SPROG
         ((|test| (|Integer|)) (|pow| (|NonNegativeInteger|)) (|term| ($))
          (#1=#:G309 NIL) (|db| (|NonNegativeInteger|))
          (|lrc|
...
(SDEFUN |NSMP;subResultantChain;2$L;35| ((|a| ($)) (|b| ($)) ($ (|List| $)))
        (SPROG ((#1=#:G372 NIL) (|up| NIL) (#2=#:G371 NIL))
               (SEQ
                (COND
                 ((OR (QEQCAR |a| 0) (QEQCAR |b| 0))
...
(DEFUN |NewSparseMultivariatePolynomial| (&REST #1=#:G464)
  (SPROG NIL
         (PROG (#2=#:G465)
           (RETURN
            (COND
...
(DEFUN |NewSparseMultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G463 NIL) (|pv$| NIL) (#2=#:G453 NIL) (#3=#:G455 NIL) (#4=#:G454 NIL)
    (#5=#:G456 NIL) (#6=#:G457 NIL) (#7=#:G458 NIL) (#8=#:G459 NIL)
    (#9=#:G460 NIL) (#10=#:G461 NIL) (#11=#:G462 NIL) ($ NIL) (|dv$| NIL)
    (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|NewSparseMultivariatePolynomial| '|infovec|
          (LIST
           ...
           (CONS
            (|makeByteWordVec2| 45
                                '(0 0 0 10 0 10 0 16 26 25 14 1 2 3 15 27 17 4
                                  28 0 12 28 0 0 1 5 4 27 0 0 0 1 4 4 39 0 0 0
                                  0 0 1 1 39 28 11 45 12 12 0 0 44 12 0 0 0 9
                                  30 32 0 0 0 6 7 27 12 12 0 0 0 0 0 0 0 0 4 6
                                  7 8 27 13 34 36 18 12 12 20 19 19))
            (CONS
             ...
             (CONS
              '#((|RecursivePolynomialCategory| 6 (|IndexedExponents| 7) 7)
                 ...
                 (|Algebra| 133) (|CharacteristicNonZero|)
                 ...
                 (|Module| 133) (|Module| 6) (|FullyLinearlyExplicitOver| 6)
                 (|Module| $$)
                 ...
                 (|LinearlyExplicitOver| 127) (|AbelianProductCategory| 6)
                 (|LeftModule| 6) (|RightModule| 6) (|RightModule| $$)
                 (|LeftModule| $$) (|LeftModule| 133) (|RightModule| 133)
                 (|RightModule| 127) (|NonAssociativeRng|) (|AbelianGroup|)
                 ...
                 (|CoercibleFrom| 127) (|canonicalUnitNormal|)
