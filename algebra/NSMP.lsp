...
(SDEFUN |NSMP;lazyPrem;3$;22| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((|test| (|Integer|)) (|term| ($)) (#1=#:G261 NIL) (|lcb| ($))
...
(SDEFUN |NSMP;lazyPseudoDivide;2$R;24|
        ((|a| $) (|b| $)
         ($ |Record| (|:| |coef| $) (|:| |gap| (|NonNegativeInteger|))
          (|:| |quotient| $) (|:| |remainder| $)))
        (SPROG
         ((#1=#:G292 NIL) (|test| (|Integer|)) (|delta| (|Integer|)) (|q| ($))
          (|term| ($)) (#2=#:G288 NIL) (|lcb| ($))
          (|db| (|NonNegativeInteger|))
          (|cgqr|
           (|Record| (|:| |coef| $) (|:| |gap| (|NonNegativeInteger|))
...
(SDEFUN |NSMP;lazyResidueClass;2$R;25|
        ...
        (SPROG
         ((|test| (|Integer|)) (|pow| (|NonNegativeInteger|)) (|term| ($))
          (#1=#:G305 NIL) (|db| (|NonNegativeInteger|))
          (|lrc|
...
(SDEFUN |NSMP;subResultantChain;2$L;35| ((|a| $) (|b| $) ($ |List| $))
        (SPROG ((#1=#:G367 NIL) (|up| NIL) (#2=#:G366 NIL))
               (SEQ
                (COND
                 ((OR (QEQCAR |a| 0) (QEQCAR |b| 0))
...
(DEFUN |NewSparseMultivariatePolynomial| (&REST #1=#:G454)
  (SPROG NIL
         (PROG (#2=#:G455)
           (RETURN
            (COND
...
(DEFUN |NewSparseMultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G453 NIL) (|pv$| NIL) (#2=#:G444 NIL) (#3=#:G445 NIL) (#4=#:G446 NIL)
    (#5=#:G447 NIL) (#6=#:G448 NIL) (#7=#:G449 NIL) (#8=#:G450 NIL)
    (#9=#:G451 NIL) (#10=#:G452 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|NewSparseMultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|SparseMultivariatePolynomial| 6 7)
              ...
              (|Union| 126 '#1="failed") (|Matrix| $) (|Polynomial| 135)
              (|InputForm|) (|Pattern| (|Float|)) (|Pattern| 131)
              (|Record| (|:| |mat| 127) (|:| |vec| (|Vector| 131)))
              (|Vector| $) (|Matrix| 131) (|PatternMatchResult| (|Float|) $)
              ...
              (|Union| 131 '#2#) (|List| 7) (|List| 11) (|Matrix| 6)
            ...
            (CONS
             ...
             (CONS
              '#((|RecursivePolynomialCategory| 6 (|IndexedExponents| 7) 7)
                 ...
                 (|LeftOreRing|) (|Algebra| 135) (|CharacteristicNonZero|)
                 ...
                 (|SemiRng|) (|Module| 135) (|Module| 6) (|Module| $$)
                 (|BiModule| 6 6) (|BiModule| $$ $$) (|BiModule| 135 135)
                 (|NonAssociativeRing|) (|LeftModule| 6) (|RightModule| 6)
                 (|RightModule| $$) (|LeftModule| $$) (|LeftModule| 135)
                 (|RightModule| 135) (|NonAssociativeRng|) (|AbelianGroup|)
              ...
              (|makeByteWordVec2| 118
                                  '(1 8 11 0 12 0 0 0 13 1 8 2 0 14 1 8 0 0 22
                                    ...
                                    1 0 0 0 118 1 54 25 0 34 1 0 0 0 28 2 25 0
