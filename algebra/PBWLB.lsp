...
(SDEFUN |PBWLB;varList;$L;3| ((|x| $) ($ |List| |VarSet|))
        (SPROG
         ((|le| #1=(|List| |VarSet|)) (#2=#:G131 NIL) (#3=#:G130 #1#)
          (#4=#:G132 #1#) (#5=#:G135 NIL) (|l| NIL))
         (SEQ
          (COND ((NULL |x|) NIL)
                (#6='T
                 (LETT |le|
...
(SDEFUN |PBWLB;length;$Nni;14| ((|x| $) ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G165 NIL) (|n| #2=(|Integer|)) (#3=#:G163 NIL) (#4=#:G162 #2#)
          (#5=#:G164 #2#) (#6=#:G168 NIL) (|l| NIL))
         (SEQ
          (LETT |n|
                (PROGN
                 (LETT #3# NIL)
...
(DEFUN |PoincareBirkhoffWittLyndonBasis| (#1=#:G175)
  (SPROG NIL
         (PROG (#2=#:G176)
           (RETURN
            (COND
