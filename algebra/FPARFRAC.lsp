...
(SDEFUN |FPARFRAC;convert;$F;10| ((|f| ($)) ($ (|Fraction| UP)))
        (SPROG ((|ans| (|Fraction| UP)) (#1=#:G141 NIL) (|rec| NIL))
               (SEQ
                (LETT |ans|
...
(SDEFUN |FPARFRAC;REC2RF|
        ...
        (SPROG
         ((|ans| (|Fraction| UP))
          ...
          (#3=#:G148 NIL) (|p| (|SparseUnivariatePolynomial| (|Fraction| UP)))
         ...
         ((|bm| (UP)) (|em| (UP)) (|um| (|OrderlyDifferentialPolynomial| UP))
          ...
          (|ans|
           (|List|
            (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |center| UP)
                      (|:| |num| UP))))
          (#1=#:G178 NIL) (|qq| (UP)) (|lval| (|List| UP))
          (|lvar| (|List| (|OrderlyDifferentialVariable| (|Symbol|))))
          (|h| (|Fraction| (|OrderlyDifferentialPolynomial| UP))) (|pp| (UP))
          (|p| (|OrderlyDifferentialPolynomial| UP)) (#2=#:G184 NIL) (|m| NIL)
          (|cn| (UP)) (|c| (UP))
          (|rec| (|Record| (|:| |coef1| UP) (|:| |coef2| UP))) (#3=#:G169 NIL)
...
(DEFUN |FullPartialFractionExpansion| (&REST #1=#:G202)
  (SPROG NIL
         (PROG (#2=#:G203)
           (RETURN
            (COND
