...
(SDEFUN |FPARFRAC;fullPartialFraction;F$;13| ((|f| |Fraction| UP) ($ $))
        (SPROG
         ((#1=#:G156 NIL) (#2=#:G161 NIL) (|rec| NIL) (#3=#:G160 NIL)
...
(DEFUN |FullPartialFractionExpansion| (&REST #1=#:G191)
  (SPROG NIL
         (PROG (#2=#:G192)
           (RETURN
            (COND
