...
(SDEFUN |FPARFRAC;differentiate;2$;7| ((|f| ($)) ($ ($)))
        (SPROG ((#1=#:G142 NIL) (|rec| NIL) (#2=#:G141 NIL))
               (SEQ
                (SPADCALL
...
(SDEFUN |FPARFRAC;convert;$F;10| ((|f| ($)) ($ (|Fraction| UP)))
        (SPROG ((|ans| (|Fraction| UP)) (#1=#:G154 NIL) (|rec| NIL))
               (SEQ
                (LETT |ans|
...
(SDEFUN |FPARFRAC;REC2RF|
        ...
        (SPROG
         ((|ans| (|Fraction| UP))
          ...
          (#3=#:G161 NIL) (|p| (|SparseUnivariatePolynomial| (|Fraction| UP)))
         ...
         ((|bm| (UP)) (|em| (UP)) (|um| (|OrderlyDifferentialPolynomial| UP))
          ...
          (|ans|
           (|List|
            (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |center| UP)
                      (|:| |num| UP))))
          (#1=#:G188 NIL) (|qq| (UP)) (|lval| (|List| UP))
          (|lvar| (|List| (|OrderlyDifferentialVariable| (|Symbol|))))
          (|h| (|Fraction| (|OrderlyDifferentialPolynomial| UP))) (|pp| (UP))
          (|p| (|OrderlyDifferentialPolynomial| UP)) (#2=#:G194 NIL) (|m| NIL)
          (|cn| (UP)) (|c| (UP))
          (|rec| (|Record| (|:| |coef1| UP) (|:| |coef2| UP))) (#3=#:G180 NIL)
...
(DEFUN |FullPartialFractionExpansion| (&REST #1=#:G211)
  (SPROG NIL
         (PROG (#2=#:G212)
           (RETURN
            (COND
