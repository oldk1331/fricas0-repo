...
(SDEFUN |FPARFRAC;differentiate;2$;7| ((|f| ($)) ($ ($)))
        (SPROG ((#1=#:G143 NIL) (|rec| NIL) (#2=#:G142 NIL))
               (SEQ
                (SPADCALL
...
(SDEFUN |FPARFRAC;convert;$F;10| ((|f| ($)) ($ (|Fraction| UP)))
        (SPROG ((|ans| (|Fraction| UP)) (#1=#:G157 NIL) (|rec| NIL))
               (SEQ
                (LETT |ans|
...
(SDEFUN |FPARFRAC;REC2RF|
        ...
        (SPROG
         ((|ans| (|Fraction| UP))
          ...
          (#3=#:G164 NIL) (|p| (|SparseUnivariatePolynomial| (|Fraction| UP)))
         ...
         ((|bm| (UP)) (|em| (UP)) (|um| (|OrderlyDifferentialPolynomial| UP))
          ...
          (|ans|
           (|List|
            (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |center| UP)
                      (|:| |num| UP))))
          (#1=#:G194 NIL) (|qq| (UP)) (|lval| (|List| UP))
          (|lvar| (|List| (|OrderlyDifferentialVariable| (|Symbol|))))
          (|h| (|Fraction| (|OrderlyDifferentialPolynomial| UP))) (|pp| (UP))
          (|p| (|OrderlyDifferentialPolynomial| UP)) (#2=#:G200 NIL) (|m| NIL)
          (|cn| (UP)) (|c| (UP))
          (|rec| (|Record| (|:| |coef1| UP) (|:| |coef2| UP))) (#3=#:G185 NIL)
...
(DEFUN |FullPartialFractionExpansion| (&REST #1=#:G218)
  (SPROG NIL
         (PROG (#2=#:G219)
           (RETURN
            (COND
