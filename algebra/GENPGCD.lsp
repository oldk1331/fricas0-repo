...
(SDEFUN |GENPGCD;gcdSameVariables|
        ((|p1| |SparseUnivariatePolynomial| P)
         ...
         ($ |SparseUnivariatePolynomial| P))
        (SPROG
         ((#1=#:G214 NIL) (#2=#:G227 NIL)
          (|ans| (|Union| (|SparseUnivariatePolynomial| P) "failed"))
          (|uu| (|SparseUnivariatePolynomial| R)) (|r| (R))
          (|count| (|NonNegativeInteger|))
          (|up2| #3=(|SparseUnivariatePolynomial| R)) (#4=#:G209 NIL)
          (|up1| #3#) (|lr| (|List| R))
          (|u| #5=(|SparseUnivariatePolynomial| R)) (|v| #5#) (|vp2| #3#)
          (|vp1| #3#) (|lrr| (|List| R)) (#6=#:G235 NIL) (|vv| NIL)
          (#7=#:G234 NIL) (#8=#:G233 NIL) (#9=#:G232 NIL) (#10=#:G231 NIL)
          (#11=#:G230 NIL) (#12=#:G229 NIL) (#13=#:G228 NIL) (|gcdLC| (P)))
         (SEQ
          (EXIT
           (COND
            ((EQL (LENGTH |lv|) 0)
...
(SDEFUN |GENPGCD;lift|
        ...
        (SPROG
         ((#1=#:G252 NIL) (#2=#:G255 NIL) (|pn| (P))
          ...
          (|n| NIL) (|origFactors| (|List| #3#)) (|prime| (P))
          (|d| #5=(|NonNegativeInteger|)) (#6=#:G241 NIL) (#7=#:G240 #5#)
          (#8=#:G242 #5#) (#9=#:G256 NIL) (|c| NIL)
          (|thisp| (|SparseUnivariatePolynomial| P)) (|r| (R)) (|v| (OV))
          (|lcp| (P)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |lcp| (SPADCALL |p| (QREFELT $ 51)) . #10=(|GENPGCD;lift|))
            (LETT |g|
                  (SPADCALL
            ...
            (LETT |cf|
                  (SPADCALL
                   ...
                   (QREFELT $ 62))
                  . #10#)
            (LETT |p| (SPADCALL |lcp| |p| (QREFELT $ 61)) . #10#)
            (SEQ G190
                 (COND ((NULL (SPADCALL |lv| NIL (QREFELT $ 65))) (GO G191)))
                 (SEQ
                  (EXIT
                   (SEQ (LETT |v| (|SPADfirst| |lv|) . #10#)
                        (LETT |r| (|SPADfirst| |lr|) . #10#)
                        (LETT |lv| (CDR |lv|) . #10#)
                        (LETT |lr| (CDR |lr|) . #10#)
                        (LETT |thisp|
                              (SPADCALL
                        ...
                        (LETT |prime|
                              ...
                              . #10#)
                        (LETT |pn| |prime| . #10#)
                        (LETT |origFactors| (LIST |g| |cf|) . #10#)
                        (SEQ
                         (EXIT
                          (SEQ (LETT |n| 1 . #10#) G190
                                        ...
                                        (EXIT
                                         (LETT |pn|
                                               (SPADCALL |pn| |prime|
                                                         (QREFELT $ 80))
                                               . #10#)))))))))))
                               (LETT |n| (|inc_SI| |n|) . #10#) (GO G190) G191
                               (EXIT NIL)))
                         #4# (EXIT #4#))
                        (EXIT
                         (COND
...
(SDEFUN |GENPGCD;recursivelyGCDCoefficients|
        ((|g| . #1=(|SparseUnivariatePolynomial| P)) (|v| . #2=(|List| OV))
         ...
         ($ |SparseUnivariatePolynomial| P))
        (SPROG
         ((#3=#:G262 NIL) (|oldv| #2#) (#4=#:G266 NIL) (|oldg| #1#)
          (|p1| (|SparseUnivariatePolynomial| P)) (|i| NIL)
          (|d| #5=(|NonNegativeInteger|)) (#6=#:G258 NIL) (#7=#:G257 #5#)
          (#8=#:G259 #5#) (#9=#:G267 NIL) (|u| NIL) (|mv| (OV)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |mv| (|SPADfirst| |pv|)
                  . #10=(|GENPGCD;recursivelyGCDCoefficients|))
            (LETT |pv| (CDR |pv|) . #10#)
            (LETT |d|
                  (PROGN
                   (LETT #6# NIL . #10#)
                   (SEQ (LETT |u| NIL . #10#)
                        (LETT #9# (SPADCALL |p| (QREFELT $ 69)) . #10#) G190
                        (COND
                         ((OR (ATOM #9#)
                              (PROGN (LETT |u| (CAR #9#) . #10#) NIL))
                          (GO G191)))
                        (SEQ
                         (EXIT
                          (PROGN
                           (LETT #8# (SPADCALL |u| |mv| (QREFELT $ 70)) . #10#)
                           (COND (#6# (LETT #7# (MAX #7# #8#) . #10#))
                                 ('T
                                  (PROGN
                                   (LETT #7# #8# . #10#)
                                   (LETT #6# 'T . #10#)))))))
                  ...
                  (EXIT
                   (COND
                    ((SPADCALL |g| (|spadConstant| $ 29) (QREFELT $ 30))
                     (PROGN (LETT #4# (|spadConstant| $ 29) . #10#) (GO #4#)))
                    ('T
                     (SEQ
                      (EXIT
                       (COND
...
(SDEFUN |GENPGCD;flatten|
        ((|p1| |SparseUnivariatePolynomial| P) (|lv| |List| OV)
         ($ |SparseUnivariatePolynomial| P))
        (SPROG
         ((|lr| (|List| R)) (#1=#:G278 NIL) (|vv| NIL) (#2=#:G277 NIL)
          (|ans| (|SparseUnivariatePolynomial| P))
          (|dg| (|NonNegativeInteger|)) (#3=#:G276 NIL) (#4=#:G275 NIL))
         (SEQ
...
(SDEFUN |GENPGCD;variables|
        ...
        (SPROG
         ((#1=#:G280 NIL) (#2=#:G279 #3=(|List| OV)) (#4=#:G281 #3#)
          (#5=#:G283 NIL) (|u| NIL))
         (SEQ
          (SPADCALL
           (PROGN
