...
(SDEFUN |ODERTRIC;logDerOnly|
        ((|l| (|LinearOrdinaryDifferentialOperator2| UP (|Fraction| UP)))
         (% (|List| (|Fraction| UP))))
        (SPROG ((#1=#:G15 NIL) (|s| NIL) (#2=#:G16 NIL))
               (SEQ
                (PROGN
                 (LETT #1# NIL)
                 (SEQ (LETT |s| NIL)
...
(SDEFUN |ODERTRIC;FifCan|
        ...
        (SPROG ((|n| #2=(|Union| F "failed")) (|d| #2#) (#3=#:G35 NIL))
               (SEQ
                (COND
                 ((QEQCAR
                   (LETT |n|
        ...
        ((|l| (|List| (|Equation| (|Fraction| (|Polynomial| F)))))
         (%
          (|Union|
           ...
           "failed")))
        (SPROG
         ((|eq| NIL) (#1=#:G67 NIL) (|u| (|Union| F "failed"))
          (|v| (|Union| (|Symbol|) "failed")) (#2=#:G66 NIL) (#3=#:G65 NIL)
          (|lv| (|List| F)) (|ls| (|List| (|Symbol|))))
         (SEQ
          (EXIT
...
(SDEFUN |ODERTRIC;polyRicDE;LodoML;12|
        ...
        (SPROG
         ((|lc|
          ...
          (|rec| NIL) (#2=#:G103 NIL) (|a| NIL) (#3=#:G104 NIL) (|p| (UP))
          (|ans| (|List| #1#)))
         (SEQ (LETT |ans| (LIST (CONS (|spadConstant| % 18) |l|)))
              (EXIT
               (COND ((NULL (LETT |lc| (SPADCALL |l| (QREFELT % 73)))) |ans|)
                     ('T
                      (SEQ
                       (SEQ (LETT |rec| NIL) (LETT #2# (REVERSE |lc|)) G190
                            (COND
                             ((OR (ATOM #2#)
                            ...
                            (SEQ
                             (EXIT
                              (SEQ (LETT |a| NIL)
                                   (LETT #3# (SPADCALL (QCDR |rec|) |zeros|))
                                   G190
                                   (COND
                                    ((OR (ATOM #3#)
                         ...
                         (SPADCALL (SPADCALL |s| |i| (QREFELT % 88))
                                   (PROG1 (LETT #2# (- |n| |i|))
                                     (|check_subtype2| (>= #2# 0)
                                                       ...
                                                       '(|Integer|) #2#))
                                   (QREFELT % 89)))
                   (COND (#5# (LETT #4# (SPADCALL #4# #3# (QREFELT % 90))))
                         ('T (PROGN (LETT #4# #3#) (LETT #5# 'T)))))))
                (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL))
           (COND (#5# #4#) ('T (|spadConstant| % 18))))))) 
                ...
                (SEQ (LETT |i| 1) (LETT #1# |n|) G190
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |xquo| 1)
                         (PROGN (LETT #2# (CONS 1 "failed")) (GO #3=#:G150)))
                        ('T
                         (LETT |sol|
                               (SPADCALL
...
(SDEFUN |ODERTRIC;ricDsolve;LodoMML;17|
        ((|l| (|LinearOrdinaryDifferentialOperator2| UP (|Fraction| UP)))
         ...
         (% (|List| (|Fraction| UP))))
        (SPROG
         ((|n| (|NonNegativeInteger|)) (|rec| NIL) (#1=#:G167 NIL)
          (#2=#:G168 NIL) (|f| NIL) (#3=#:G169 NIL)
          (|ans| (|List| (|Fraction| UP))) (#4=#:G166 NIL) (#5=#:G165 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |n| (SPADCALL |l| (QREFELT % 95))) (LETT |ans| NIL)
                (SEQ (LETT |rec| NIL)
                     (LETT #1# (SPADCALL |l| |ezfactor| (QREFELT % 43))) G190
                     (COND
                       ...
                       (SEQ
                        ...
                        (EXIT
                         (COND
                          ((EQL (LENGTH |ans|) |n|)
                           (PROGN
                            (LETT #5# (PROGN (LETT #4# |ans|) (GO #6=#:G164)))
                            (GO #7=#:G161)))))))
                      #7# (EXIT #5#))
                     (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
                (EXIT |ans|)))
...
(SDEFUN |ODERTRIC;nonSingSolve|
        ((|n| (|NonNegativeInteger|))
         ...
         (|zeros| (|Mapping| (|List| F) UP)) (% (|List| (|Fraction| UP))))
        (SPROG
         ((|rec| NIL) (#1=#:G183 NIL) (|ans| (|List| (|Fraction| UP)))
          (#2=#:G182 NIL) (#3=#:G181 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |ans| NIL)
                (SEQ (LETT |rec| NIL)
                     (LETT #1# (SPADCALL |l| |zeros| (QREFELT % 80))) G190
                     (COND
                      ((OR (ATOM #1#) (PROGN (LETT |rec| (CAR #1#)) NIL))
                       (GO G191)))
                     (SEQ
                       ...
                       (SEQ
                        ...
                        (EXIT
                         (COND
                          ((EQL (LENGTH |ans|) |n|)
                           (PROGN
                            (LETT #3# (PROGN (LETT #2# |ans|) (GO #4=#:G180)))
                            (GO #5=#:G177)))))))
                      #5# (EXIT #3#))
                     (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
                (EXIT |ans|)))
...
(SDEFUN |ODERTRIC;nopoly|
        ((|n| (|NonNegativeInteger|)) (|p| (UP))
         ...
         (|zeros| (|Mapping| (|List| F) UP)) (% (|List| (|Fraction| UP))))
        (SPROG
         ((|rec| NIL) (#1=#:G199 NIL) (#2=#:G200 NIL) (|f| NIL) (#3=#:G201 NIL)
          (|ans| (|List| (|Fraction| UP))) (#4=#:G198 NIL) (#5=#:G197 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |ans| NIL)
                (SEQ (LETT |rec| NIL)
                       ...
                       (SEQ
                        ...
                        (EXIT
                         (COND
                          ((EQL (LENGTH |ans|) |n|)
                           (PROGN
                            (LETT #5# (PROGN (LETT #4# |ans|) (GO #6=#:G196)))
                            (GO #7=#:G193)))))))
                      #7# (EXIT #5#))
                     (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
                (EXIT |ans|)))
        ...
        (SPROG
         ...
         (SEQ
          ...
          (EXIT
           (PROGN
            (LETT #1# NIL)
            (SEQ (LETT |s| NIL) (LETT #2# |sol|) G190
                 (COND
...
(SDEFUN |ODERTRIC;zro|
        ...
        (SPROG ((#1=#:G231 NIL) (|r| NIL) (#2=#:G232 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #1# NIL)
                  (SEQ (LETT |r| NIL)
                       ...
                       (SEQ
                        (EXIT
                         (LETT #1#
                               (CONS (|ODERTRIC;zro1| (QVELT |r| 1) %) #1#))))
                       (LETT #2# (CDR #2#)) (GO G190) G191
                       (EXIT (NREVERSE #1#))))
                 (QREFELT % 143))))) 
