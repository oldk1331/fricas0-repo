...
(SDEFUN |NLINSOL;solveInField;LL;1|
        ...
        (SPROG
         ((#1=#:G109 NIL) (#2=#:G108 #3=(|List| (|Symbol|))) (#4=#:G110 #3#)
          (#5=#:G112 NIL) (|p| NIL))
         (SEQ
          (SPADCALL |l|
                    (PROGN
...
(SDEFUN |NLINSOL;solve;LL;2|
        ((|l| (|List| (|Polynomial| R)))
         ($ (|List| (|List| (|Equation| (|Fraction| (|Polynomial| R)))))))
        (SPROG
         ((#1=#:G114 NIL) (#2=#:G113 #3=(|List| (|Symbol|))) (#4=#:G115 #3#)
          (#5=#:G117 NIL) (|p| NIL))
         (SEQ
          (SPADCALL |l|
                    (PROGN
...
(SDEFUN |NLINSOL;evalSol|
        ...
        (SPROG ((#1=#:G132 NIL) (|eq| NIL) (#2=#:G131 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |NLINSOL;allRoots|
        ...
        (SPROG
         ((#1=#:G142 NIL) (|a| NIL) (#2=#:G141 NIL)
          (|s| (|Fraction| (|Polynomial| R))) (#3=#:G134 NIL)
          (|p| (|Polynomial| R))
...
(SDEFUN |NLINSOL;RIfCan|
        ...
        (SPROG ((#1=#:G174 NIL) (|d| #2=(|Union| R "failed")) (|n| #2#))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |NLINSOL;solveInField;LLL;13|
        ((|lp| (|List| (|Polynomial| R))) (|lv| (|List| (|Symbol|)))
         ($ (|List| (|List| (|Equation| (|Fraction| (|Polynomial| R)))))))
        (SPROG ((#1=#:G183 NIL) (|p| NIL) (#2=#:G182 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(DEFUN |NonLinearSolvePackage| (#1=#:G184)
  (SPROG NIL
         (PROG (#2=#:G185)
           (RETURN
            (COND
