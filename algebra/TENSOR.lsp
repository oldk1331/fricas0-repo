...
(SDEFUN |TENSOR;tensor;M1M2$;2| ((|x1| (M1)) (|x2| (M2)) ($ ($)))
        (SPROG
         ((|res| (|List| (|Record| (|:| |k| (|Product| B1 B2)) (|:| |c| R))))
          (#1=#:G139 NIL) (|s2| NIL) (#2=#:G138 NIL) (|s1| NIL)
          ...
          (EXIT
           (COND
            ((OR (SPADCALL |x1| (QREFELT $ 14)) (SPADCALL |x2| (QREFELT $ 16)))
             (PROGN (LETT #3# (|spadConstant| $ 15)) (GO #4=#:G136)))
            ('T
...
(SDEFUN |TENSOR;*;3$;3| ((|x1| ($)) (|x2| ($)) ($ ($)))
        (SPROG
         ((|res| (|List| (|Record| (|:| |k| (|Product| B1 B2)) (|:| |c| R))))
          (#1=#:G151 NIL) (|t| NIL) (|t2b| (M2)) (|t2a| (M1)) (|t1b| (M2))
          (|t1a| (M1)) (|t2k| #2=(|Product| B1 B2)) (|t1k| #2#) (#3=#:G150 NIL)
          (|t2| NIL) (#4=#:G149 NIL) (|t1| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |TENSOR;coerce;$Of;4| ((|x| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|le| (|List| (|OutputForm|))) (|ko| (|OutputForm|)) (#1=#:G161 NIL)
          (|rec| NIL))
         (SEQ
          (COND
...
(DEFUN |TensorProduct;| (|#1| |#2| |#3| |#4| |#5|)
  (SPROG
   ((|pv$| NIL) (#1=#:G167 NIL) ($ NIL) (|dv$| NIL) (DV$5 NIL) (DV$4 NIL)
