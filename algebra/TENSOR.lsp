...
(SDEFUN |TENSOR;tensor;M1M2$;2| ((|x1| (M1)) (|x2| (M2)) ($ ($)))
        (SPROG
         ((|res| (|List| (|Record| (|:| |k| (|Product| B1 B2)) (|:| |c| R))))
          (#1=#:G137 NIL) (|s2| NIL) (#2=#:G136 NIL) (|s1| NIL)
          ...
          (EXIT
           (COND
            ((OR (SPADCALL |x1| (QREFELT $ 14)) (SPADCALL |x2| (QREFELT $ 16)))
             (PROGN (LETT #3# (|spadConstant| $ 15)) (GO #4=#:G134)))
            ('T
...
(SDEFUN |TENSOR;*;3$;3| ((|x1| ($)) (|x2| ($)) ($ ($)))
        (SPROG
         ((|res| (|List| (|Record| (|:| |k| (|Product| B1 B2)) (|:| |c| R))))
          (#1=#:G146 NIL) (|t| NIL) (|t2b| (M2)) (|t2a| (M1)) (|t1b| (M2))
          (|t1a| (M1)) (|t2k| #2=(|Product| B1 B2)) (|t1k| #2#) (|t2c| (R))
          (|t1c| (R)) (#3=#:G145 NIL) (|t2| NIL) (#4=#:G144 NIL) (|t1| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |TENSOR;coerce;$Of;4| ((|x| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|le| (|List| (|OutputForm|))) (|ko| (|OutputForm|)) (#1=#:G155 NIL)
          (|rec| NIL))
         (SEQ
          (COND
...
(DEFUN |TensorProduct| (&REST #1=#:G163)
  (SPROG NIL
         (PROG (#2=#:G164)
           (RETURN
            (COND
...
(DEFUN |TensorProduct;| (|#1| |#2| |#3| |#4| |#5|)
  (SPROG
   ((|pv$| NIL) (#1=#:G161 NIL) ($ NIL) (|dv$| NIL) (DV$5 NIL) (DV$4 NIL)
