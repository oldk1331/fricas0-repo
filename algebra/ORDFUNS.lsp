...
(SDEFUN |ORDFUNS;pureLex;2VB;1|
        ...
        (SPROG ((#1=#:G116 NIL) (#2=#:G117 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |ORDFUNS;totalLex;2VB;2|
        ((|v1| (|Vector| S)) (|v2| (|Vector| S)) ($ (|Boolean|)))
        (SPROG
         ((#1=#:G128 NIL) (#2=#:G130 NIL) (|i| NIL) (|n2| (S)) (|n1| (S))
          (#3=#:G129 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |ORDFUNS;reverseLex;2VB;3|
        ((|v1| (|Vector| S)) (|v2| (|Vector| S)) ($ (|Boolean|)))
        (SPROG
         ((#1=#:G141 NIL) (|i| NIL) (|n2| (S)) (|n1| (S)) (#2=#:G142 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |n1| (|spadConstant| $ 13))
                (LETT |n2| (|spadConstant| $ 13))
...
(DEFUN |OrderingFunctions| (&REST #1=#:G143)
  (SPROG NIL
         (PROG (#2=#:G144)
           (RETURN
            (COND
