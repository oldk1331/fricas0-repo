...
(SDEFUN |QCMPACK;squareFreeFactors| ((|lp| (|List| P)) (% (|List| P)))
        (SPROG
         ((|p| NIL) (#1=#:G67 NIL) (|lsfp| (|List| P)) (|lsflp| (|List| P)))
         (SEQ (LETT |lsflp| NIL)
...
(SDEFUN |QCMPACK;moreAlgebraic?;2TSB;6|
        ((|ts| (TS)) (|us| (TS)) (% (|Boolean|)))
        (SPROG ((|p| NIL) (#1=#:G99 NIL) (#2=#:G98 NIL) (#3=#:G97 NIL))
               (SEQ
                (EXIT
                 (COND
                             ...
                             (COND
                              ((NULL
                                (SPADCALL (SPADCALL |p| (QREFELT % 44)) |ts|
                                          (QREFELT % 45)))
                               (PROGN
                                (LETT #3# (PROGN (LETT #2# NIL) (GO #4=#:G96)))
                                (GO #5=#:G91))))))
                           (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL)))
                     #5# (EXIT #3#))
                    (EXIT 'T)))))
...
(SDEFUN |QCMPACK;internalSubQuasiComponent?;2TSU;13|
        ...
        (SPROG
         ((#1=#:G166 NIL) (#2=#:G146 NIL) (#3=#:G164 NIL) (#4=#:G167 NIL)
          (#5=#:G163 NIL) (|lsfp| (|List| P)) (|p| NIL) (#6=#:G168 NIL)
          (#7=#:G165 NIL) (#8=#:G162 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |QCMPACK;subQuasiComponent?;TSLB;15|
        ...
        (SPROG ((|us| NIL) (#1=#:G183 NIL) (#2=#:G182 NIL) (#3=#:G181 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |ts| |us| (QREFELT % 61))
                             (PROGN
                              (LETT #3# (PROGN (LETT #2# 'T) (GO #4=#:G180)))
                              (GO #5=#:G178))))))
                         (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #3#))
                  (EXIT NIL)))
...
(SDEFUN |QCMPACK;removeSuperfluousQuasiComponents;2L;17|
        ((|lts| (|List| TS)) (% (|List| TS)))
        (SPROG
         ((|us| NIL) (#1=#:G235 NIL) (|ts| (TS)) (|toSave| (|List| TS))
...
(SDEFUN |QCMPACK;removeAssociates| ((|lp| (|List| P)) (% (|List| P)))
        (SPROG ((#1=#:G239 NIL) (|p| NIL) (#2=#:G240 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #1# NIL)
                  (SEQ (LETT |p| NIL) (LETT #2# |lp|) G190
                       ...
                       (SEQ
                        (EXIT
                         (LETT #1# (CONS (SPADCALL |p| (QREFELT % 82)) #1#))))
        ...
        ((|leq| (|List| P)) (|ts| (TS)) (|lineq| (|List| P)) (|b1| (|Boolean|))
         ...
         (%
          (|Union|
           ...
           "failed")))
        (SPROG
         ((#1=#:G282 NIL) (|ps| (|GeneralPolynomialSet| R E V P))
          (#2=#:G284 NIL) (#3=#:G281 NIL) (#4=#:G285 NIL) (#5=#:G280 NIL)
          (|p| NIL) (#6=#:G286 NIL) (|q| NIL) (#7=#:G287 NIL) (|g| (P))
          (#8=#:G265 NIL) (|newp| (P)) (#9=#:G283 NIL) (|newleq| (|List| P)))
         (SEQ
          (EXIT
           (SEQ
            (COND
         ...
         (%
          (|List|
           (|Record| (|:| |eq| #1=(|List| P)) (|:| |tower| TS)
                     (|:| |ineq| #2=(|List| P))))))
        (SPROG
         ((#3=#:G325 NIL) (#4=#:G326 NIL) (|p| NIL) (#5=#:G327 NIL)
          (|lsfp| (|List| P)) (|f| NIL) (#6=#:G328 NIL) (|branch| NIL)
          (#7=#:G329 NIL) (|ts| (TS))
          (|ubf1|
           #8=(|Union|
               (|Record| (|:| |eq| (|List| P)) (|:| |tower| TS)
