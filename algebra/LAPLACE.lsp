...
(SDEFUN |LAPLACE;algebraic?| ((|f| F) (|t| |Symbol|) ($ |Boolean|))
        (SPROG
         ((#1=#:G148 NIL) (#2=#:G149 NIL) (#3=#:G152 NIL) (|k| NIL)
          (|m| (|NonNegativeInteger|)) (#4=#:G151 NIL) (#5=#:G150 NIL)
          (|l| (|List| (|Kernel| F))))
         (SEQ
          (EXIT
           (SEQ
                      ...
                      ((EQL (SPADCALL |k| (QREFELT $ 25)) |m|)
                       (COND
                        ((SPADCALL (SPADCALL |k| (QREFELT $ 29)) (QREFELT $ 8)
                                   (QREFELT $ 31))
                         (PROGN
                          (LETT #1# (PROGN (LETT #2# 'T . #6#) (GO #7=#:G147))
                                . #6#)
                          (GO #8=#:G145))))))))
...
(SDEFUN |LAPLACE;isLinear|
        ...
        (SPROG
         ((|c| (F)) (|b| (F)) (#1=#:G169 NIL) (|d| (|Union| F "failed"))
              ...
              (COND
               ((OR (QEQCAR |d| 1)
                    (SPADCALL
                     ...
                     (QREFELT $ 53)))
                (PROGN (LETT #1# (CONS 1 "failed") . #2#) (GO #3=#:G167))))))
            (COND
             ((SPADCALL
               (LETT |b|
                     (SPADCALL
...
(SDEFUN |LAPLACE;atn|
        ((|f| F) (|t| |Symbol|)
         ($ |Union| (|Record| (|:| |coef| F) (|:| |deg| (|PositiveInteger|)))
          #1="failed"))
        (SPROG
         ((#2=#:G192 NIL) (|c| (F)) (|d| (|NonNegativeInteger|))
          (|r| (|Record| (|:| |coef| F) (|:| |deg| (|PositiveInteger|))))
          (|rec|
           (|Union| (|Record| (|:| |coef| F) (|:| |deg| (|PositiveInteger|)))
                    #1#))
          (#3=#:G198 NIL) (|g| NIL) (|u| (|Union| (|List| F) #4="failed"))
          (#5=#:G196 NIL) (#6=#:G197 NIL) (#7=#:G181 NIL)
         ...
         ((#2=#:G254 NIL) (#3=#:G255 NIL)
          ...
          (|v|
           (|Union| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|)))
                    #4="failed"))
          (|c| (F)) (|c1| (F)) (|c0| (F)) (#5=#:G256 NIL) (|g| NIL)
          (|u| (|Union| (|List| F) #4#)))
         (SEQ
          (EXIT
           (COND
        ...
        (SPROG
         ((|l|
           #1=(|Union| (|OrderedCompletion| F)
                       ...
                       "failed"))
          (|u| #1#) (#3=#:G287 NIL) (|i| (|Union| F (|List| F))))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ...
             (#5='T
              (SEQ
               ...
               (EXIT
                (COND
                 ((QEQCAR |i| 1)
                  (PROGN (LETT #3# (CONS 1 #4#) . #6#) (GO #7=#:G285))))))))
            (LETT |u|
                  (SPADCALL (QCDR |i|)
        ...
        (SPROG
         ((|x| (|Union| F "failed")) (|res1| (F))
          ...
          (|v|
           (|Union| (|Record| (|:| |coef| F) (|:| |deg| (|PositiveInteger|)))
                    "failed"))
          (|rec| (|Record| (|:| |const| F) (|:| |nconst| F))) (#1=#:G319 NIL)
          (#2=#:G318 (F)) (#3=#:G320 (F)) (#4=#:G342 NIL) (|g| (F))
...
(DEFUN |LaplaceTransform| (&REST #1=#:G347)
  (SPROG NIL
         (PROG (#2=#:G348)
           (RETURN
            (COND
