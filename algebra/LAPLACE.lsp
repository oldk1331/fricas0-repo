...
(SDEFUN |LAPLACE;algebraic?| ((|f| (F)) (|t| (|Symbol|)) ($ (|Boolean|)))
        (SPROG
         ((#1=#:G166 NIL) (#2=#:G167 NIL) (#3=#:G170 NIL) (|k| NIL)
          (|m| (|NonNegativeInteger|)) (#4=#:G169 NIL) (#5=#:G168 NIL)
          (|l| (|List| (|Kernel| F))))
         (SEQ
          (EXIT
           (SEQ
                      ...
                      ((EQL (SPADCALL |k| (QREFELT $ 25)) |m|)
                       (COND
                        ((SPADCALL (SPADCALL |k| (QREFELT $ 29)) (QREFELT $ 8)
                                   (QREFELT $ 31))
                         (PROGN
                          (LETT #1# (PROGN (LETT #2# 'T) (GO #6=#:G165)))
                          (GO #7=#:G163))))))))
...
(SDEFUN |LAPLACE;isLinear|
        ...
        (SPROG
         ((|c| (F)) (|b| (F)) (#1=#:G187 NIL) (|d| (|Union| F "failed"))
              ...
              (COND
               ((OR (QEQCAR |d| 1)
                    (> (SPADCALL (SPADCALL |ff| (QREFELT $ 51)) (QREFELT $ 52))
                       1))
                (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G185))))))
            (COND
             ((SPADCALL
               (LETT |b|
                     (SPADCALL
        ...
        ((|f| (F)) (|t| (|Symbol|))
         ($
          (|Union| (|Record| (|:| |coef| F) (|:| |deg| (|PositiveInteger|)))
                   #1="failed")))
        (SPROG
         ((#2=#:G212 NIL) (|c| (F)) (|d| (|NonNegativeInteger|))
          (|r| (|Record| (|:| |coef| F) (|:| |deg| (|PositiveInteger|))))
          (|rec|
           (|Union| (|Record| (|:| |coef| F) (|:| |deg| (|PositiveInteger|)))
                    #1#))
          (#3=#:G218 NIL) (|g| NIL) (|u| (|Union| (|List| F) #4="failed"))
          (#5=#:G216 NIL) (#6=#:G217 NIL) (#7=#:G199 NIL)
         ...
         ((#2=#:G277 NIL) (#3=#:G278 NIL)
          ...
          (|v|
           (|Union| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|)))
                    #4="failed"))
          (|c| (F)) (|c1| (F)) (|c0| (F)) (#5=#:G279 NIL) (|g| NIL)
          (|u| (|Union| (|List| F) #4#)))
         (SEQ
          (EXIT
           (COND
         ...
         ((|l1| #1=(|SingleInteger|)) (|u1| #1#) (|ll| (|OrderedCompletion| F))
          ...
          (|l|
           #2=(|Union| (|OrderedCompletion| F)
                       ...
                       "failed"))
          (|u| #2#) (#4=#:G312 NIL) (|i| (|Union| F (|List| F))))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ...
             (#6='T
              (SEQ (LETT |i| (SPADCALL |g| |v| (QREFELT $ 98)))
                   (EXIT
                    (COND
                     ((QEQCAR |i| 1)
                      (PROGN (LETT #4# (CONS 1 #5#)) (GO #7=#:G310))))))))
            (LETT |u|
                  (SPADCALL (QCDR |i|)
        ...
        (SPROG
         ((|x| (|Union| F "failed")) (|res1| (F))
          ...
          (|v|
           (|Union| (|Record| (|:| |coef| F) (|:| |deg| (|PositiveInteger|)))
                    "failed"))
          (|rec| (|Record| (|:| |const| F) (|:| |nconst| F))) (#1=#:G344 NIL)
          (#2=#:G343 (F)) (#3=#:G345 (F)) (#4=#:G367 NIL)
...
(DEFUN |LaplaceTransform| (&REST #1=#:G372)
  (SPROG NIL
         (PROG (#2=#:G373)
           (RETURN
            (COND
