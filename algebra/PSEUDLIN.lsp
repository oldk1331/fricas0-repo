...
(DEFUN |PSEUDLIN;normalForm0| (M |sig| |siginv| |der| $)
  (PROG (|i| |Binv| B E #1=#:G205 |k| #2=#:G206 |recOfMatrices| |j| #3=#:G202
         #4=#:G203 #5=#:G204 N)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |PseudoLinearNormalForm| (#1=#:G222)
  (PROG ()
    (RETURN
     (PROG (#2=#:G223)
       (RETURN
