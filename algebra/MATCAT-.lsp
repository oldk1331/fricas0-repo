...
(SDEFUN |MATCAT-;diagonal?;SB;2| ((|x| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G142 NIL) (#2=#:G145 NIL) (#3=#:G147 NIL) (|j| NIL)
          (#4=#:G146 NIL) (|i| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |MATCAT-;symmetric?;SB;3| ((|x| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G149 NIL) (#2=#:G153 NIL) (#3=#:G155 NIL) (|j| NIL)
          (#4=#:G154 NIL) (|i| NIL) (|mc| (|Integer|)) (|mr| (|Integer|))
          (|nRows| (|Integer|)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |MATCAT-;antisymmetric?;SB;4| ((|x| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G157 NIL) (#2=#:G161 NIL) (#3=#:G163 NIL) (|j| NIL)
          (#4=#:G162 NIL) (|i| NIL) (|mc| (|Integer|)) (|mr| (|Integer|))
          (|nRows| (|Integer|)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |MATCAT-;zero?;SB;5| ((|x| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G168 NIL) (#2=#:G170 NIL) (|j| NIL) (#3=#:G169 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ
...
(SDEFUN |MATCAT-;matrix;LS;7| ((|l| |List| (|List| R)) ($ S))
        (SPROG
         ((#1=#:G181 NIL) (|j| NIL) (#2=#:G182 NIL) (|r| NIL) (#3=#:G179 NIL)
          (|i| NIL) (#4=#:G180 NIL) (|ll| NIL) (|ans| (S))
          (|rows| (|NonNegativeInteger|)) (#5=#:G178 NIL)
...
(SDEFUN |MATCAT-;matrix;2NniMS;8|
        ...
        (SPROG
         ((#1=#:G189 NIL) (|j| NIL) (#2=#:G188 NIL) (|i| NIL) (|mat| (S)))
         (SEQ
...
(SDEFUN |MATCAT-;scalarMatrix;NniRS;9|
        ...
        (SPROG
         ((#1=#:G193 NIL) (|i| NIL) (#2=#:G194 NIL) (|j| NIL) (|ans| (S)))
         (SEQ
...
(SDEFUN |MATCAT-;diagonalMatrix;LS;10| ((|l| |List| R) ($ S))
        (SPROG
         ((#1=#:G198 NIL) (|i| NIL) (#2=#:G199 NIL) (|j| NIL) (#3=#:G200 NIL)
...
(SDEFUN |MATCAT-;get_dims|
        ...
        (SPROG ((#1=#:G207 NIL) (|a| NIL) (#2=#:G206 NIL))
               (SEQ
                (PROGN
...
(SDEFUN |MATCAT-;kronecker_prod1;SILL2NniUV;12|
        ...
        (SPROG
         ((|c_off1| (|NonNegativeInteger|)) (|mm| (R)) (|aij| (R)) (|j| NIL)
          (|i| NIL) (|c_step| #1=(|NonNegativeInteger|)) (#2=#:G241 NIL)
          (|rc| NIL) (#3=#:G240 NIL) (|r_step| #1#) (#4=#:G239 NIL)
          (#5=#:G238 NIL) (|c_ind| (|NonNegativeInteger|)) (|m| (R)) (|a| (S))
...
(SDEFUN |MATCAT-;kroneckerProduct;LS;13| ((|l| |List| S) ($ S))
        (SPROG
         ((#1=#:G268 NIL) (|a| NIL) (|res| (S))
          (|nc| #2=(|NonNegativeInteger|)) (#3=#:G267 NIL) (|rc| NIL)
          (#4=#:G266 NIL) (|nr| #2#) (#5=#:G265 NIL) (#6=#:G264 NIL)
...
(SDEFUN |MATCAT-;kroneckerSum;LS;15| ((|l| |List| S) ($ S))
        (SPROG
         ((|n0| (|Integer|)) (|off0| (|NonNegativeInteger|))
          ...
          (|nr| (|NonNegativeInteger|)) (#2=#:G304 NIL) (|a| NIL) (|res| (S))
          (|nrs| (|NonNegativeInteger|)) (#3=#:G303 NIL) (#4=#:G302 NIL)
          (|nc| (|NonNegativeInteger|)) (#5=#:G301 NIL)
          (|k| (|NonNegativeInteger|)))
...
(SDEFUN |MATCAT-;diagonalMatrix;LS;17| ((|list| |List| S) ($ S))
        (SPROG
         ((|loC| (|Integer|)) (|loR| (|Integer|)) (|j| NIL) (#1=#:G317 NIL)
          (|l| NIL) (|i| NIL) (#2=#:G316 NIL) (|k| NIL) (|hiC| #3=(|Integer|))
          (|hiR| #3#) (#4=#:G315 NIL) (|mat| NIL) (|ans| (S))
          (|cols| #5=(|NonNegativeInteger|)) (|rows| #5#) (#6=#:G314 NIL))
...
(SDEFUN |MATCAT-;kronecker_prod1;SILL2NniUV;18|
        ...
        (SPROG
         ((|c_off1| (|NonNegativeInteger|)) (|mm| (R)) (|aij| (R)) (|j| NIL)
          (|i| NIL) (|c_step| #1=(|NonNegativeInteger|)) (#2=#:G351 NIL)
          (|rc| NIL) (#3=#:G350 NIL) (|r_step| #1#) (#4=#:G349 NIL)
          (#5=#:G348 NIL) (|c_ind| (|NonNegativeInteger|)) (|m| (R)) (|a| (S))
          (|nc| #6=(|NonNegativeInteger|)) (|nr| #6#)
          (|dp| (|List| (|NonNegativeInteger|))))
         (SEQ
          (LETT |dp| (|SPADfirst| |dl|)
...
(SDEFUN |MATCAT-;kroneckerProduct;LS;19| ((|l| |List| S) ($ S))
        (SPROG
         ((#1=#:G378 NIL) (|a| NIL) (|res| (S))
          (|nc| #2=(|NonNegativeInteger|)) (#3=#:G377 NIL) (|rc| NIL)
          (#4=#:G376 NIL) (|nr| #2#) (#5=#:G375 NIL) (#6=#:G374 NIL)
          (|dl| (|List| (|List| (|NonNegativeInteger|))))
          (|k| (|NonNegativeInteger|)))
...
(SDEFUN |MATCAT-;kroneckerSum;LS;21| ((|l| |List| S) ($ S))
        (SPROG
         ((|n0| (|Integer|)) (|off0| (|NonNegativeInteger|))
          ...
          (|j| NIL) (|i| NIL) (|m| NIL) (|step0| (|NonNegativeInteger|))
          (|n2| (|NonNegativeInteger|)) (|dl| (|List| (|NonNegativeInteger|)))
          (|nr| (|NonNegativeInteger|)) (#2=#:G414 NIL) (|a| NIL) (|res| (S))
          (|nrs| (|NonNegativeInteger|)) (#3=#:G413 NIL) (#4=#:G412 NIL)
          (|nc| (|NonNegativeInteger|)) (#5=#:G411 NIL)
          (|k| (|NonNegativeInteger|)))
...
(SDEFUN |MATCAT-;diagonalMatrix;LS;23| ((|list| |List| S) ($ S))
        (SPROG
         ((|loC| (|Integer|)) (|loR| (|Integer|)) (|j| NIL) (#1=#:G427 NIL)
          (|l| NIL) (|i| NIL) (#2=#:G426 NIL) (|k| NIL) (|hiC| #3=(|Integer|))
          (|hiR| #3#) (#4=#:G425 NIL) (|mat| NIL) (|ans| (S))
          (|cols| #5=(|NonNegativeInteger|)) (|rows| #5#) (#6=#:G424 NIL))
...
(SDEFUN |MATCAT-;coerce;ColS;24| ((|v| |Col|) ($ S))
        (SPROG
         ((#1=#:G431 NIL) (|i| NIL) (#2=#:G432 NIL) (|k| NIL)
          (|one| (|Integer|)) (|x| (S)))
         (SEQ
          (LETT |x|
...
(SDEFUN |MATCAT-;transpose;RowS;25| ((|v| |Row|) ($ S))
        (SPROG
         ((#1=#:G436 NIL) (|j| NIL) (#2=#:G437 NIL) (|k| NIL)
          (|one| (|Integer|)) (|x| (S)))
         (SEQ
          (LETT |x|
...
(SDEFUN |MATCAT-;+;3S;26| ((|x| S) (|y| S) ($ S))
        (SPROG
         ((#1=#:G447 NIL) (|j| NIL) (#2=#:G446 NIL) (|i| NIL) (|ans| (S))
...
(SDEFUN |MATCAT-;-;3S;27| ((|x| S) (|y| S) ($ S))
        (SPROG
         ((#1=#:G457 NIL) (|j| NIL) (#2=#:G456 NIL) (|i| NIL) (|ans| (S))
          (|c| (|NonNegativeInteger|)) (|r| (|NonNegativeInteger|)))
         (SEQ
          (COND
           ((OR
...
(SDEFUN |MATCAT-;*;3S;32| ((|x| S) (|y| S) ($ S))
        (SPROG
         ((|entry| (R)) (|sum| (R)) (#1=#:G475 NIL) (|k| NIL) (#2=#:G476 NIL)
          (|l| NIL) (#3=#:G474 NIL) (|j| NIL) (#4=#:G473 NIL) (|i| NIL)
          (|ans| (S)))
         (SEQ
          (COND
...
(SDEFUN |MATCAT-;*;S2Col;35| ((|x| S) (|v| |Col|) ($ |Col|))
        (SPROG
         ((|sum| (R)) (#1=#:G491 NIL) (|j| NIL) (#2=#:G492 NIL) (|l| NIL)
          (#3=#:G489 NIL) (|i| NIL) (#4=#:G490 NIL) (|k| NIL) (|w| (|Col|)))
         (SEQ
          (COND
           ((SPADCALL (SPADCALL |x| (QREFELT $ 12))
...
(SDEFUN |MATCAT-;*;RowSRow;36| ((|v| |Row|) (|x| S) ($ |Row|))
        (SPROG
         ((|sum| (R)) (#1=#:G501 NIL) (|i| NIL) (#2=#:G502 NIL) (|l| NIL)
          (#3=#:G499 NIL) (|j| NIL) (#4=#:G500 NIL) (|k| NIL) (|w| (|Row|)))
         (SEQ
          (COND
           ((SPADCALL (SPADCALL |x| (QREFELT $ 11))
...
(SDEFUN |MATCAT-;B0| ((|n| |PositiveInteger|) ($ S))
        (SPROG ((|j| NIL) (#1=#:G518 NIL) (|i| NIL) (#2=#:G517 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
...
(SDEFUN |MATCAT-;PfChar| ((A S) ($ . #1=(|SparseUnivariatePolynomial| R)))
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| R)) (#2=#:G530 NIL) (|e| NIL)
          (#3=#:G531 NIL) (|k| NIL) (|c| (R)) (|i| NIL) (#4=#:G529 NIL)
          (|j| NIL) (|g| (|List| R)) (C (S)) (B (S)) (#5=#:G519 NIL)
...
(SDEFUN |MATCAT-;exquo;SRU;41| ((|x| S) (|a| R) ($ |Union| S "failed"))
        (SPROG
         ((|entry| (R)) (#1=#:G546 NIL) (|r| (|Union| R "failed"))
          (#2=#:G548 NIL) (|j| NIL) (#3=#:G547 NIL) (|i| NIL) (|ans| (S)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |ans|
