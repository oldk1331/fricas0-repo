...
(SDEFUN |MATCAT-;zero?;SB;5| ((|x| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G192 NIL) (#2=#:G194 NIL) (|j| NIL) (#3=#:G193 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ (LETT |i| (SPADCALL |x| (QREFELT $ 17)))
...
(SDEFUN |MATCAT-;matrix;LS;7| ((|l| |List| (|List| R)) ($ S))
        (SPROG
         ((#1=#:G206 NIL) (|j| NIL) (#2=#:G207 NIL) (|r| NIL) (#3=#:G204 NIL)
          (|i| NIL) (#4=#:G205 NIL) (|ll| NIL) (|ans| (S))
          (|rows| (|NonNegativeInteger|)) (#5=#:G203 NIL)
...
(SDEFUN |MATCAT-;matrix;2NniMS;8|
        ...
        (SPROG
         ((#1=#:G214 NIL) (|j| NIL) (#2=#:G213 NIL) (|i| NIL) (|mat| (S)))
         (SEQ
...
(SDEFUN |MATCAT-;scalarMatrix;NniRS;9|
        ...
        (SPROG
         ((#1=#:G218 NIL) (|i| NIL) (#2=#:G219 NIL) (|j| NIL) (|ans| (S)))
...
(SDEFUN |MATCAT-;diagonalMatrix;LS;10| ((|l| |List| R) ($ S))
        (SPROG
         ((#1=#:G223 NIL) (|i| NIL) (#2=#:G224 NIL) (|j| NIL) (#3=#:G225 NIL)
...
(SDEFUN |MATCAT-;get_dims|
        ...
        (SPROG ((#1=#:G232 NIL) (|a| NIL) (#2=#:G231 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |MATCAT-;kronecker_prod1;SILL2NniUV;18|
        ...
        (SPROG
         ((|c_off1| (|NonNegativeInteger|)) (|mm| (R)) (|aij| (R))
          (#1=#:G394 NIL) (|j| NIL) (#2=#:G393 NIL) (|i| NIL)
          (|c_step| #3=(|NonNegativeInteger|)) (#4=#:G392 NIL) (|rc| NIL)
          (#5=#:G391 NIL) (|r_step| #3#) (#6=#:G390 NIL) (#7=#:G389 NIL)
          (|c_ind| (|NonNegativeInteger|)) (#8=#:G388 NIL) (#9=#:G387 NIL)
          (|m| (R)) (|a| (S)) (|nc| #10=(|NonNegativeInteger|)) (|nr| #10#)
          (|dp| (|List| (|NonNegativeInteger|))))
         (SEQ (LETT |dp| (|SPADfirst| |dl|))
              (LETT |nr| (SPADCALL |dp| 1 (QREFELT $ 46)))
...
(SDEFUN |MATCAT-;kroneckerProduct;LS;19| ((|l| |List| S) ($ S))
        (SPROG
         ((#1=#:G425 NIL) (|a| NIL) (|res| (S))
          (|nc| #2=(|NonNegativeInteger|)) (#3=#:G424 NIL) (|rc| NIL)
          (#4=#:G423 NIL) (|nr| #2#) (#5=#:G422 NIL) (#6=#:G421 NIL)
          (|dl| (|List| (|List| (|NonNegativeInteger|))))
          (|k| (|NonNegativeInteger|)))
         (SEQ (LETT |k| (LENGTH |l|))
              (EXIT
...
(SDEFUN |MATCAT-;kroneckerSum;LS;21| ((|l| |List| S) ($ S))
        (SPROG
         ((|n0| (|Integer|)) (|off0| (|NonNegativeInteger|))
          (|off_r| #1=(|NonNegativeInteger|)) (|ind_c| #1#) (|vv| (R))
          (#2=#:G465 NIL) (|j| NIL) (#3=#:G464 NIL) (#4=#:G463 NIL) (|i| NIL)
          (#5=#:G462 NIL) (|m| NIL) (|step0| (|NonNegativeInteger|))
          (|n2| (|NonNegativeInteger|)) (|dl| (|List| (|NonNegativeInteger|)))
          (|nr| (|NonNegativeInteger|)) (#6=#:G461 NIL) (|a| NIL) (|res| (S))
          (|nrs| (|NonNegativeInteger|)) (#7=#:G460 NIL) (#8=#:G459 NIL)
          (|nc| (|NonNegativeInteger|)) (#9=#:G458 NIL)
          (|k| (|NonNegativeInteger|)))
         (SEQ (LETT |k| (LENGTH |l|))
              (EXIT
               (COND ((EQL |k| 0) (SPADCALL 1 1 (QREFELT $ 39)))
...
(SDEFUN |MATCAT-;diagonalMatrix;LS;23| ((|list| |List| S) ($ S))
        (SPROG
         ((|loC| (|Integer|)) (|loR| (|Integer|)) (#1=#:G479 NIL) (|j| NIL)
          (#2=#:G480 NIL) (|l| NIL) (#3=#:G477 NIL) (|i| NIL) (#4=#:G478 NIL)
          (|k| NIL) (|hiC| #5=(|Integer|)) (|hiR| #5#) (#6=#:G476 NIL)
          (|mat| NIL) (|ans| (S)) (|cols| #7=(|NonNegativeInteger|))
          (|rows| #7#) (#8=#:G475 NIL))
         (SEQ (LETT |rows| 0) (LETT |cols| 0)
              (SEQ (LETT |mat| NIL) (LETT #8# |list|) G190
...
(SDEFUN |MATCAT-;coerce;ColS;24| ((|v| |Col|) ($ S))
        (SPROG
         ((#1=#:G484 NIL) (|i| NIL) (#2=#:G485 NIL) (|k| NIL)
          (|one| (|Integer|)) (|x| (S)))
         (SEQ
          (LETT |x|
...
(SDEFUN |MATCAT-;transpose;RowS;25| ((|v| |Row|) ($ S))
        (SPROG
         ((#1=#:G489 NIL) (|j| NIL) (#2=#:G490 NIL) (|k| NIL)
          (|one| (|Integer|)) (|x| (S)))
         (SEQ
          (LETT |x|
...
(SDEFUN |MATCAT-;+;3S;26| ((|x| S) (|y| S) ($ S))
        (SPROG
         ((#1=#:G500 NIL) (|j| NIL) (#2=#:G499 NIL) (|i| NIL) (|ans| (S))
...
(SDEFUN |MATCAT-;-;3S;27| ((|x| S) (|y| S) ($ S))
        (SPROG
         ((#1=#:G510 NIL) (|j| NIL) (#2=#:G509 NIL) (|i| NIL) (|ans| (S))
          (|c| (|NonNegativeInteger|)) (|r| (|NonNegativeInteger|)))
         (SEQ
          (COND
           ((OR
...
(SDEFUN |MATCAT-;*;3S;32| ((|x| S) (|y| S) ($ S))
        (SPROG
         ((|entry| (R)) (|sum| (R)) (#1=#:G528 NIL) (|k| NIL) (#2=#:G529 NIL)
          (|l| NIL) (#3=#:G527 NIL) (|j| NIL) (#4=#:G526 NIL) (|i| NIL)
          (|ans| (S)))
         (SEQ
          (COND
...
(SDEFUN |MATCAT-;*;S2Col;35| ((|x| S) (|v| |Col|) ($ |Col|))
        (SPROG
         ((|sum| (R)) (#1=#:G544 NIL) (|j| NIL) (#2=#:G545 NIL) (|l| NIL)
          (#3=#:G542 NIL) (|i| NIL) (#4=#:G543 NIL) (|k| NIL) (|w| (|Col|)))
         (SEQ
          (COND
           ((SPADCALL (SPADCALL |x| (QREFELT $ 12))
...
(SDEFUN |MATCAT-;*;RowSRow;36| ((|v| |Row|) (|x| S) ($ |Row|))
        (SPROG
         ((|sum| (R)) (#1=#:G554 NIL) (|i| NIL) (#2=#:G555 NIL) (|l| NIL)
          (#3=#:G552 NIL) (|j| NIL) (#4=#:G553 NIL) (|k| NIL) (|w| (|Row|)))
         (SEQ
          (COND
           ((SPADCALL (SPADCALL |x| (QREFELT $ 11))
...
(SDEFUN |MATCAT-;columnSpace;SL;37| ((M S) ($ |List| |Col|))
        (SPROG
         ((|indRow| (|Integer|)) (|basis| (|List| |Col|)) (#1=#:G561 NIL)
...
(SDEFUN |MATCAT-;B0| ((|n| |PositiveInteger|) ($ S))
        (SPROG
         ((#1=#:G574 NIL) (|j| NIL) (#2=#:G573 NIL) (#3=#:G572 NIL) (|i| NIL)
          (#4=#:G571 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |MATCAT-;PfChar| ((A S) ($ . #1=(|SparseUnivariatePolynomial| R)))
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| R)) (#2=#:G588 NIL) (|e| NIL)
          (#3=#:G589 NIL) (|k| NIL) (|c| (R)) (#4=#:G586 NIL) (|i| NIL)
          (#5=#:G587 NIL) (|j| NIL) (|g| (|List| R)) (C (S)) (#6=#:G585 NIL)
          (B (S)) (#7=#:G575 NIL) (|d| (|NonNegativeInteger|)) (|p| #1#)
...
(SDEFUN |MATCAT-;exquo;SRU;41| ((|x| S) (|a| R) ($ |Union| S "failed"))
        (SPROG
         ((|entry| (R)) (#1=#:G605 NIL) (|r| (|Union| R "failed"))
          (#2=#:G607 NIL) (|j| NIL) (#3=#:G606 NIL) (|i| NIL) (|ans| (S)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |ans|
