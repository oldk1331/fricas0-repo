...
(DEFUN |NewSparseUnivariatePolynomial| (#1=#:G298)
  (SPROG NIL
         (PROG (#2=#:G299)
           (RETURN
            (COND
...
(DEFUN |NewSparseUnivariatePolynomial;| (|#1|)
  (SPROG
   ((#1=#:G297 NIL) (|pv$| NIL) (#2=#:G290 NIL) (#3=#:G291 NIL) (#4=#:G292 NIL)
    (#5=#:G293 NIL) (#6=#:G294 NIL) (#7=#:G295 NIL) (#8=#:G296 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
