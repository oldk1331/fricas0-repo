...
(SDEFUN |FR;convert;%If;1| ((|x| (%)) (% (|InputForm|)))
        (SPROG
         ((|lf|
          ...
          (|rec| NIL) (#1=#:G105 NIL) (|iFactor| (|InputForm|))
          (|iExpon| (|InputForm|)) (|iFun| (|List| (|InputForm|)))
          (|l| (|List| (|InputForm|))))
         (SEQ
          (COND
        ...
        ((|u| (%))
         (%
          (|List|
           (|Record| (|:| |factor| R)
                     (|:| |exponent| (|NonNegativeInteger|))))))
        (SPROG ((#1=#:G195 NIL) (|fe| NIL) (#2=#:G196 NIL))
               (SEQ
                (PROGN
                 (LETT #1# NIL)
                 (SEQ (LETT |fe| NIL) (LETT #2# (SPADCALL |u| (QREFELT % 11)))
                      G190
                      (COND
                       ((OR (ATOM #2#) (PROGN (LETT |fe| (CAR #2#)) NIL))
                        (GO G191)))
                      (SEQ
                       (EXIT
                        (LETT #1#
...
(SDEFUN |FR;expand;%R;22| ((|u| (%)) (% (R)))
        (SPROG
         ((|y| NIL) (#1=#:G201 NIL) (#2=#:G199 (R)) (#3=#:G197 (R))
          (#4=#:G198 NIL))
         (SEQ
                          ...
                          (SEQ
                           (EXIT
                            (PROGN
                             ...
                             (COND
                              (#4#
                               (LETT #3# (SPADCALL #3# #2# (QREFELT % 66))))
                              ('T (PROGN (LETT #3# #2#) (LETT #4# 'T)))))))
                          (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
                     (COND (#4# #3#) ('T (|spadConstant| % 15))))
                    (QREFELT % 66))))) 
...
(SDEFUN |FR;rational;%F;26| ((|x| (%)) (% (|Fraction| (|Integer|))))
        (SPROG
         ((|f| NIL) (#1=#:G244 NIL) (#2=#:G242 #3=(|Fraction| (|Integer|)))
          (#4=#:G240 #3#) (#5=#:G241 NIL))
         (SEQ
                          ...
                          (SEQ
                           (EXIT
                            (PROGN
                             ...
                             (COND
                              (#5#
                               (LETT #4# (SPADCALL #4# #2# (QREFELT % 80))))
                              ('T (PROGN (LETT #4# #2#) (LETT #5# 'T)))))))
                          (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
                     (COND (#5# #4#) ('T (|spadConstant| % 81))))
                    (QREFELT % 82))))) 
...
(SDEFUN |FR;eval;%L%;28| ((|x| (%)) (|l| (|List| (|Equation| %))) (% (%)))
        (SPROG ((#1=#:G249 NIL) (|e| NIL) (#2=#:G250 NIL))
               (SEQ
                (SPADCALL |x|
                          (PROGN
                           (LETT #1# NIL)
...
(SDEFUN |FR;eval;%LL%;29|
        ...
        (SPROG ((#1=#:G254 NIL) (|v| NIL) (#2=#:G255 NIL))
               (SEQ
                (SPADCALL |x| |ls|
                          (PROGN
                           (LETT #1# NIL)
...
(SDEFUN |FR;convert;%F;30| ((|x| (%)) (% (|Float|)))
        (SPROG
         ((|f| NIL) (#1=#:G264 NIL) (#2=#:G262 #3=(|Float|)) (#4=#:G260 #3#)
          (#5=#:G261 NIL))
         (SEQ
                          ...
                          (SEQ
                           (EXIT
                            (PROGN
                             ...
                             (COND
                              (#5#
                               (LETT #4# (SPADCALL #4# #2# (QREFELT % 101))))
                              ('T (PROGN (LETT #4# #2#) (LETT #5# 'T)))))))
                          (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
                     (COND (#5# #4#) ('T (|spadConstant| % 102))))
                    (QREFELT % 101))))) 

(SDEFUN |FR;convert;%Df;31| ((|x| (%)) (% (|DoubleFloat|)))
        (SPROG
         ((|f| NIL) (#1=#:G273 NIL) (#2=#:G271 #3=(|DoubleFloat|))
          (#4=#:G269 #3#) (#5=#:G270 NIL))
         (SEQ
         ...
         (%
          (|List|
           (|Record| (|:| |flag| (|Union| #1# #2# #3# #4#)) (|:| |factor| R)
                     (|:| |exponent| (|NonNegativeInteger|))))))
        (SPROG
         ((|u1| NIL) (#5=#:G318 NIL) (|f1| (R))
          (|v1|
           (|Record| (|:| |flag| (|Union| #1# #2# #3# #4#)) (|:| |factor| R)
                     (|:| |exponent| (|NonNegativeInteger|))))
          (|factor_done| (|Boolean|)) (#6=#:G317 NIL)
          (|lv1|
           (|List|
            (|Record| (|:| |flag| (|Union| #1# #2# #3# #4#)) (|:| |factor| R)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          ...
          (#7=#:G319 NIL))
         (SEQ (LETT |res| NIL)
              (SEQ (LETT |u1| NIL) (LETT #5# |lu|) G190
                   (COND
                    ((OR (ATOM #5#) (PROGN (LETT |u1| (CAR #5#)) NIL))
                     (GO G191)))
...
(SDEFUN |FR;^;%Nni%;35| ((|u| (%)) (|n| (|NonNegativeInteger|)) (% (%)))
        (SPROG ((#1=#:G335 NIL) (|x| NIL) (#2=#:G336 NIL))
               (SEQ
                      ...
                      ('T
                       (|FR;mkFF|
                        ...
                        (PROGN
                         (LETT #1# NIL)
                         (SEQ (LETT |x| NIL)
                              (LETT #2# (SPADCALL |u| (QREFELT % 11))) G190
                              (COND
                               ((OR (ATOM #2#)
         ...
         ((|lf|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| R)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (|rec| NIL) (#1=#:G352 NIL) (|l| (|List| (|OutputForm|)))
          (|e| (|OutputForm|)))
         (SEQ
          (COND
           ((NULL (LETT |lf| (REVERSE (SPADCALL |x| (QREFELT % 11)))))
...
(SDEFUN |FR;differentiate;%M%;47| ((|u| (%)) (|deriv| (|Mapping| R R)) (% (%)))
        (SPROG
         ((|ans| (%)) (|fact| NIL) (#1=#:G421 NIL) (#2=#:G416 NIL)
          (#3=#:G414 (%)) (#4=#:G412 (%)) (#5=#:G413 NIL))
         (SEQ
          (LETT |ans|
                           ...
                           (SEQ
                            (EXIT
                             (PROGN
                              ...
                              (COND
                               (#5#
                                (LETT #4# (SPADCALL #4# #3# (QREFELT % 136))))
                               ('T (PROGN (LETT #4# #3#) (LETT #5# 'T)))))))
                           (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
                      (COND (#5# #4#) ('T (|spadConstant| % 49))))
                     (QREFELT % 136)))))) 

(SDEFUN |FR;map;M2%;48| ((|fn| (|Mapping| R R)) (|u| (%)) (% (%)))
        (SPROG
         ((#1=#:G431 NIL) (|f| NIL) (#2=#:G432 NIL)
          (|l|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| R)
         ...
         (SEQ
          (LETT |l|
                (CONS
                 ...
                 (PROGN
                  (LETT #1# NIL)
                  (SEQ (LETT |f| NIL) (LETT #2# (SPADCALL |u| (QREFELT % 11)))
                       G190
                       (COND
         ...
         ((#2=#:G471 NIL) (|newunit| (R))
          ...
          (|res|
           (|List|
            (|Record| (|:| |flag| (|Union| #3# #4# #5# #6#)) (|:| |factor| R)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (|factor_done| (|Boolean|)) (#9=#:G499 NIL)
          (|lu1|
           (|List|
            (|Record| (|:| |flag| (|Union| #3# #4# #5# #6#)) (|:| |factor| R)
                      (|:| |exponent| (|NonNegativeInteger|)))))
           ...
           (SEQ
            ...
            (EXIT
             (COND ((NULL |lv|) (CONS 0 (|FR;mkFF| |newunit| |lu| %)))
                   ...
                   (#12#
                    (SEQ (LETT |res| NIL)
                         (SEQ (LETT |v1| NIL) (LETT #7# |lv|) G190
                              (COND
                               ((OR (ATOM #7#)
                                    (PROGN (LETT |v1| (CAR #7#)) NIL))
                                (GO G191)))
        ...
        ((|u| (%))
         (%
          (|Record| (|:| |unit| . #1=(%)) (|:| |canonical| . #1#)
                    (|:| |associate| . #1#))))
        (SPROG
         ((|ur| (|Union| R "failed")) (|x| NIL) (#2=#:G522 NIL)
          (|ucar|
           (|Record| (|:| |unit| R) (|:| |canonical| R) (|:| |associate| R)))
          (|e| (|NonNegativeInteger|)) (|un| (R)) (|as| (R))
          (|vl|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| R)
...
(SDEFUN |FR;all_primes|
        ((|lf|
         ...
         (% (|Boolean|)))
        (SPROG
         ((|f| NIL) (#5=#:G545 NIL) (|fg| (|Union| #1# #2# #3# #4#))
          (#6=#:G544 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |FR;all_sqf|
        ((|lf|
         ...
         (% (|Boolean|)))
        (SPROG
         ((|f| NIL) (#5=#:G557 NIL) (|fg| (|Union| #1# #2# #3# #4#))
          (#6=#:G556 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |FR;gcd1|
        ((|lu|
         ...
         (% (%)))
        (SPROG
         ((|#G124| #5=(|NonNegativeInteger|)) (|#G125| #5#) (|nu| #5#)
          (|nv| #5#) (|vr| (|Vector| R)) (#6=#:G587 NIL) (#7=#:G586 NIL)
          (#8=#:G589 NIL) (#9=#:G588 NIL)
          (|dr|
           (|Record| (|:| |basis| #10=(|Vector| R))
                     (|:| |transform| #11=(|Matrix| (|Integer|)))))
          (|nfv| #10#) (|tr| #11#) (|fg| (|Union| #1# #2# #3# #4#)) (|j| NIL)
          (#12=#:G590 NIL) (|nf| (R)) (#13=#:G592 NIL) (#14=#:G591 NIL)
          (|eu| #15=(|NonNegativeInteger|)) (|i| NIL) (#16=#:G594 NIL)
          (|f| NIL) (#17=#:G593 NIL) (|ev| #15#) (#18=#:G585 NIL)
          (|res|
           (|List|
            (|Record| (|:| |flag| (|Union| #1# #2# #3# #4#)) (|:| |factor| R)
                      (|:| |exponent| (|NonNegativeInteger|))))))
         (SEQ
          ...
          (SEQ (LETT |i| 1) (LETT #6# |nu|) (LETT |f| NIL) (LETT #7# |lu|) G190
               (COND
               ...
               G191 (EXIT NIL))
          (SEQ (LETT |i| (+ |nu| 1)) (LETT #8# (+ |nu| |nv|)) (LETT |f| NIL)
               (LETT #9# |lv|) G190
               (COND
                ((OR (ATOM #9#) (PROGN (LETT |f| (CAR #9#)) NIL) (> |i| #8#))
                 (GO G191)))
               (SEQ (EXIT (SPADCALL |vr| |i| (QVELT |f| 1) (QREFELT % 150))))
               (LETT #9# (PROG1 (CDR #9#) (LETT |i| (+ |i| 1)))) (GO G190) G191
               (EXIT NIL))
          ...
          (LETT |fg|
                (SEQ
                 ...
                 (EXIT (CONS 0 "nil"))))
          (SEQ (LETT |j| 1) (LETT #12# (QVSIZE |nfv|)) G190
                      ...
                      (EXIT
                       (COND
                        ((SPADCALL |nf| (QREFELT % 124))
                         (PROGN (LETT #18# |$NoValue|) (GO #19=#:G574)))
                        ('T
                         (SEQ (LETT |eu| 0)
                              (SEQ (LETT |i| 1) (LETT #13# |nu|) (LETT |f| NIL)
                                   (LETT #14# |lu|) G190
                                   (COND
                                    ((OR (ATOM #14#)
                              ...
                              (EXIT
                               (COND
                                ((EQL |eu| 0)
                                 (PROGN (LETT #18# |$NoValue|) (GO #19#)))
                                ('T
                                 (SEQ (LETT |ev| 0)
                                      (SEQ (LETT |i| (+ |nu| 1))
                                           (LETT #16# (+ |nu| |nv|))
                                           (LETT |f| NIL) (LETT #17# |lv|) G190
                                           (COND
                                            ((OR (ATOM #17#)
                                                 (PROGN
                                                  (LETT |f| (CAR #17#))
...
(SDEFUN |FR;gcd;3%;59| ((|u| (%)) (|v| (%)) (% (%)))
        (SPROG
         ((|#G137| #1=(|NonNegativeInteger|)) (|#G138| #1#) (|nu| #1#)
          (|nv| #1#)
          (|#G139|
           #2=(|List|
               (|Record|
                (|:| |flag| (|Union| #3="nil" #4="sqfr" #5="irred" #6="prime"))
                (|:| |factor| R) (|:| |exponent| (|NonNegativeInteger|)))))
          (|#G140| #2#) (|lu| #2#) (|lv| #2#) (|u1| NIL) (#7=#:G620 NIL)
          (|v1| NIL) (#8=#:G621 NIL)
          (|res|
           (|List|
            (|Record| (|:| |flag| (|Union| #3# #4# #5# #6#)) (|:| |factor| R)
                  ...
                  (#10='T
                   (SEQ (LETT |lu| (SPADCALL |u| (QREFELT % 11)))
                        ...
                        (SEQ (LETT |u1| NIL) (LETT #7# |lu|) G190
                             ...
                             (SEQ
                              (EXIT
                               (SEQ (LETT |v1| NIL) (LETT #8# |lv|) G190
                                    (COND
                                     ((OR (ATOM #8#)
                                          (PROGN (LETT |v1| (CAR #8#)) NIL))
                                      (GO G191)))
                                    (SEQ
                                     (EXIT
                                      (COND
...
(DEFUN |Factored;| (|#1|)
  (SPROG ((DV$1 NIL) (|dv$| NIL) (% NIL) (#1=#:G638 NIL) (|pv$| NIL))
         (PROGN
             ...
             (CONS
              ...
              (|makeByteWordVec2| 163
                                  '(1 6 13 0 14 0 6 0 15 2 6 16 0 0 17 1 20 18
                                    ...
                                    1 73 0 24 78 2 73 0 0 24 79 2 73 0 0 73 80
