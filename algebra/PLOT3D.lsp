...
(DEFUN |PLOT3D;adaptivePlot|
  ...
  (PROG (|p| |t| |todo2| |todo1| |tj| |tm| |st| |n| #1=#:G221 |dp| |s2| |s1|
...
(DEFUN |PLOT3D;basicPlot| (|f| |tRange| $)
  (PROG (|zRange| |yRange| |xRange| |p| |t| |l| #1=#:G271 |i| |s| |h|)
    (RETURN
...
(DEFUN |PLOT3D;refine;$S$;30| (|p| |nRange| $)
  (PROG (|zRange| |yRange| |xRange| |curves| |scrres| #1=#:G312 |c| #2=#:G311
         |tlimit| #3=#:G310 #4=#:G309 |tRange|)
    (RETURN
     (SEQ (SETELT $ 10 0)
...
(DEFUN |PLOT3D;plot;$S$;31| (|p| |tRange| $)
  (PROG (|zRange| |yRange| |xRange| |curves| #1=#:G322 |c| #2=#:G321 |tlimit|
         #3=#:G320 #4=#:G319)
    (RETURN
     (SEQ (SETELT $ 10 0)
          (LETT |curves|
...
(DEFUN |PLOT3D;coerce;$Of;37| (|r| $)
  (PROG (|f| |l| #1=#:G359 |p| #2=#:G358 |h| |zRange| |yRange| |xRange|
         #3=#:G357 |curve| |tRange| |tSymbol| |zSymbol| |ySymbol| |xSymbol|
         |spaces|)
    (RETURN
