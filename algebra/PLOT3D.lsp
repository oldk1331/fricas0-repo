        ...
        (SPROG
         ((|rr|
           (|Record|
            ...
            (|:| |knots| (|List| (|DoubleFloat|)))
            (|:| |points| (|List| (|Point| (|DoubleFloat|))))))
          (|r| NIL) (#1=#:G30 NIL) (|u| (|Segment| (|DoubleFloat|))))
...
(SDEFUN |PLOT3D;select|
        ((|l| (|List| (|Point| (|DoubleFloat|))))
         ...
         (% (|DoubleFloat|)))
        (SPROG ((|p| NIL) (#2=#:G60 NIL) (|fp| #1#) (|m| #1#))
...
(SDEFUN |PLOT3D;rangeRefine|
        ...
        (SPROG
         ((|l| (|DoubleFloat|)) (|h| (|DoubleFloat|)) (|f| #1#) (#4=#:G105 NIL)
          (|s| #5=(|DoubleFloat|)) (|c| (|List| (|DoubleFloat|)))
          (|q| (|List| (|Point| (|DoubleFloat|)))) (|n| (|Integer|)) (|d| #5#)
          (|i| NIL) (#6=#:G106 NIL) (|t1| (|DoubleFloat|)) (|t| #2#) (|p| #3#)
          ...
          (EXIT
           (SEQ (|PLOT3D;checkRange| |nRange| %)
                ...
                (COND
                 ((NULL |c|)
                  (PROGN
                   (LETT #4# (|PLOT3D;basicPlot| |f| |nRange| %))
                   (GO #8=#:G104))))
                (COND
        ...
        ((|curve|
         ...
         (%
          (|Record|
           ...
           (|:| |points| #3=(|List| (|Point| (|DoubleFloat|)))))))
        (SPROG
         ((|xDiff| #4=(|DoubleFloat|)) (|yDiff| #4#) (|zDiff| #4#)
          (|l| (|DoubleFloat|)) (|h| (|DoubleFloat|)) (|tDiff| #4#) (|f| #1#)
          ...
          (|x0| #8=(|DoubleFloat|)) (|y0| #9=(|DoubleFloat|))
          (|z0| #10=(|DoubleFloat|)) (|x1| #8#) (|y1| #9#) (|z1| #10#)
          (|x2| #8#) (|y2| #9#) (|z2| #10#) (|a1| #5#) (|b1| #5#) (|c1| #5#)
          (|a2| #5#) (|b2| #5#) (|c2| #5#) (|s1| #11=(|DoubleFloat|))
          (|s2| #11#) (|dp| (|DoubleFloat|)) (|st| #6#) (|sp| #7#)
          (#12=#:G150 NIL) (|n| (|Integer|)) (|tj| #5#) (|t| #2#) (|p| #3#))
         (SEQ
          (LETT |xDiff|
        ...
        ((|f| (|Mapping| (|Point| (|DoubleFloat|)) (|DoubleFloat|)))
         ...
         (%
          (|Record|
           ...
           (|:| |points| (|List| (|Point| (|DoubleFloat|)))))))
        (SPROG
         ((|h| (|DoubleFloat|)) (|s| (|DoubleFloat|)) (|i| NIL) (#1=#:G176 NIL)
         ...
         (SEQ (|PLOT3D;checkRange| |tRange| %)
              ...
              (LETT |s|
                    (|div_DF| (|sub_DF| |h| |l|)
                              (FLOAT (- (QREFELT % 8) 1)
                                     MOST-POSITIVE-DOUBLE-FLOAT)))
              (SEQ (LETT |i| 2) (LETT #1# (- (QREFELT % 8) 1)) G190
...
(SDEFUN |PLOT3D;refine;%S%;30|
        ...
        (SPROG
         ((|tRange| (|Segment| (|DoubleFloat|))) (#1=#:G217 NIL)
          (#2=#:G218 NIL) (|tlimit| (|PositiveInteger|)) (#3=#:G219 NIL)
          (|c| NIL) (#4=#:G220 NIL) (|scrres| (|Integer|))
          (|curves|
           (|List|
            (|Record|
             (|:| |source|
...
(SDEFUN |PLOT3D;plot;%S%;31|
        ...
        (SPROG
         ((#1=#:G229 NIL) (#2=#:G230 NIL) (|tlimit| (|PositiveInteger|))
          (#3=#:G231 NIL) (|c| NIL) (#4=#:G232 NIL)
          (|curves|
           (|List|
            (|Record|
             (|:| |source|
...
(SDEFUN |PLOT3D;coerce;%Of;37| ((|r| (%)) (% (|OutputForm|)))
        (SPROG
         ((|spaces| #1=(|OutputForm|)) (|xSymbol| #1#) (|ySymbol| #1#)
          (|zSymbol| #1#) (|tSymbol| #1#) (|tRange| (|OutputForm|))
          (|curve| NIL) (#2=#:G269 NIL) (|xRange| #3=(|OutputForm|))
          (|yRange| #3#) (|zRange| #3#) (|h| (|OutputForm|)) (#4=#:G270 NIL)
          (|p| NIL) (#5=#:G271 NIL) (|l| (|List| #3#))
          (|f| (|List| (|OutputForm|))))
