...
(SDEFUN |INMODGCD;lincase|
        ((|listdeg| (|List| (|NonNegativeInteger|))) (|listf| (|List| BP))
         ($ (BP)))
        (SPROG
         ((#1=#:G164 NIL) (|f1| (|Union| BP "failed")) (#2=#:G165 NIL)
...
(SDEFUN |INMODGCD;modGcdPrimitive| ((|f| (BP)) (|g| (BP)) ($ (BP)))
        (SPROG
         ((#1=#:G200 NIL) (|result| (BP)) (|testdeg| #2=(|NonNegativeInteger|))
          (|soFar| (BP)) (|soFarModulus| (R)) (|correctionFactor| (R))
          (|ans| (BP)) (#3=#:G182 NIL) (|cont| (R)) (|correction| (BP))
          ...
          (EXIT
           (SEQ (LETT |df| (SPADCALL |f| (QREFELT $ 23)))
                ...
                (EXIT
                 (COND
                  ((ZEROP |testdeg|)
                   (PROGN (LETT #1# (|spadConstant| $ 27)) (GO #4=#:G199)))
                  (#5='T
                   (SEQ
                    (LETT |ldp|
