...
(SDEFUN |INMODGCD;lincase|
        ((|listdeg| (|List| (|NonNegativeInteger|))) (|listf| (|List| BP))
         (% (BP)))
        (SPROG
         ((#1=#:G165 NIL) (|f1| (|Union| BP "failed")) (#2=#:G166 NIL)
...
(SDEFUN |INMODGCD;modGcdPrimitive| ((|f| (BP)) (|g| (BP)) (% (BP)))
        (SPROG
         ((#1=#:G201 NIL) (|result| (BP)) (|testdeg| #2=(|NonNegativeInteger|))
          (|soFar| (BP)) (|soFarModulus| (R)) (|correctionFactor| (R))
          (|ans| (BP)) (#3=#:G183 NIL) (|cont| (R)) (|correction| (BP))
          ...
          (EXIT
           (SEQ (LETT |df| (SPADCALL |f| (QREFELT % 23)))
                ...
                (EXIT
                 (COND
                  ((ZEROP |testdeg|)
                   (PROGN (LETT #1# (|spadConstant| % 27)) (GO #4=#:G200)))
                  (#5='T
                   (SEQ
                    (LETT |ldp|
...
(SDEFUN |INMODGCD;height| ((|f| (BP)) (% (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G218 NIL) (#2=#:G217 #3=(|NonNegativeInteger|)) (#4=#:G219 #3#)
          (#5=#:G221 NIL) (|cc| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
