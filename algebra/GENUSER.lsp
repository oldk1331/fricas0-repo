...
(SDEFUN |GENUSER;coerce;%Of;11| ((|x| (%)) (% (|OutputForm|)))
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|xs| (|Rep|))
          (|ti| (|Record| (|:| |k| |Expon|) (|:| |c| |Coef|))) (#1=#:G200 NIL)
...
(SDEFUN |GENUSER;exquo2| ((|x| (%)) (|y| (%)) (% (|Union| % "failed")))
        (SPROG
         ((#1=#:G342 NIL) (#2=#:G340 NIL)
          (|tx| #3=(|Record| (|:| |k| |Expon|) (|:| |c| |Coef|))) (|n| NIL)
          (|cyinv| (|Union| |Coef| "failed")) (|ky| (|Expon|)) (#4=#:G341 NIL)
          (|ty| #3#))
         (SEQ
          (EXIT
           (SEQ
                    ...
                    (EXIT
                     (COND
                      ((OR (> |n| 1000) (SPADCALL |y| (QREFELT % 18)))
                       (PROGN (LETT #1# (CONS 1 "failed")) (GO #5=#:G339)))
                      ('T
                            ...
                            (COND
                             ((NULL
                               (SPADCALL (QCDR |ty|) (|spadConstant| % 19)
                                         (QREFELT % 42)))
                              (EXIT
                               (PROGN (LETT #4# |$NoValue|) (GO #6=#:G324)))))
                            (EXIT
...
(SDEFUN |GENUSER;=;2%B;30| ((|x| (%)) (|y| (%)) (% (|Boolean|)))
        (SPROG
         ((|st| (|Rep|)) (#1=#:G430 NIL)
          (|tst| (|Record| (|:| |k| |Expon|) (|:| |c| |Coef|))) (#2=#:G431 NIL)
          (|i| NIL) (|n| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |GENUSER;truncate;%2Expon%;35|
        ...
        (SPROG
         ((|xs| (|Rep|)) (#1=#:G483 NIL)
          (|tx| (|Record| (|:| |k| |Expon|) (|:| |c| |Coef|))) (#2=#:G484 NIL)
          (|#G70| (|Expon|)) (|#G69| (|Expon|)))
         (SEQ
          (EXIT
           (SEQ
                       ...
                       (SEQ (LETT |tx| (SPADCALL |xs| (QREFELT % 50)))
                            (COND
                             ((NULL (SPADCALL (QCAR |tx|) |k1| (QREFELT % 24)))
                              (EXIT
                               (PROGN (LETT #1# |$NoValue|) (GO #4=#:G480)))))
                            (EXIT
...
(DEFUN |GeneralizedUnivariatePowerSeries| (&REST #1=#:G657)
  (SPROG NIL
         (PROG (#2=#:G658)
           (RETURN
            (COND
...
(DEFUN |GeneralizedUnivariatePowerSeries;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((|pv$| NIL) (#1=#:G648 NIL) (#2=#:G649 NIL) (#3=#:G650 NIL) (#4=#:G651 NIL)
    (#5=#:G652 NIL) (#6=#:G653 NIL) (#7=#:G655 NIL) (% NIL) (|dv$| NIL)
...
(MAKEPROP '|GeneralizedUnivariatePowerSeries| '|infovec|
          (LIST
           ...
           '#(~= 542 |zero?| 548 |variable| 553 |unitNormal| 558
              ...
              |gcdPolynomial| 836 |gcd| 842 |factor| 853 |extendedEuclidean|
              858 |extend| 871 |exquo| 877 |expressIdealMember| 883 |exp| 889
              |eval| 894 |euclideanSize| 900 |elt| 905 |divide| 917
              |differentiate| 923 |degree| 960 |csch| 965 |csc| 970 |coth| 975
              |cot| 980 |cosh| 985 |cos| 990 |constructOrdered| 995 |construct|
              1000 |complete| 1005 |commutator| 1010 |coerce| 1016
              |coefficient| 1041 |charthRoot| 1047 |characteristic| 1052
              |center| 1056 |atanh| 1061 |atan| 1066 |associator| 1071
              |associates?| 1078 |asinh| 1084 |asin| 1089 |asech| 1094 |asec|
              1099 |approximate| 1104 |apply_taylor| 1110 |antiCommutator| 1116
              |annihilate?| 1122 |acsch| 1128 |acsc| 1133 |acoth| 1138 |acot|
              1143 |acosh| 1148 |acos| 1153 ^ 1158 |Zero| 1182 |One| 1186 D
