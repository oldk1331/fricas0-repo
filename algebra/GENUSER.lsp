...
(SDEFUN |GENUSER;exquo2| ((|x| ($)) (|y| ($)) ($ (|Union| $ "failed")))
        (SPROG
         ((#1=#:G341 NIL) (#2=#:G339 NIL)
          (|tx| #3=(|Record| (|:| |k| |Expon|) (|:| |c| |Coef|))) (|n| NIL)
          (|cyinv| (|Union| |Coef| "failed")) (|ky| (|Expon|)) (#4=#:G340 NIL)
          (|ty| #3#))
         (SEQ
          (EXIT
           (SEQ
                    ...
                    (EXIT
                     (COND
                      ((OR (> |n| 1000) (SPADCALL |y| (QREFELT $ 18)))
                       (PROGN (LETT #1# (CONS 1 "failed")) (GO #5=#:G338)))
                      ('T
                            ...
                            (COND
                             ((NULL
                               (SPADCALL (QCDR |ty|) (|spadConstant| $ 19)
                                         (QREFELT $ 42)))
                              (EXIT
                               (PROGN (LETT #4# |$NoValue|) (GO #6=#:G323)))))
                            (EXIT
...
(SDEFUN |GENUSER;=;2$B;30| ((|x| ($)) (|y| ($)) ($ (|Boolean|)))
        (SPROG
         ((|st| (|Rep|)) (#1=#:G429 NIL)
          (|tst| (|Record| (|:| |k| |Expon|) (|:| |c| |Coef|))) (#2=#:G430 NIL)
          (|i| NIL) (|n| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |GENUSER;truncate;$2Expon$;35|
        ...
        (SPROG
         ((|xs| (|Rep|)) (#1=#:G482 NIL)
          (|tx| (|Record| (|:| |k| |Expon|) (|:| |c| |Coef|))) (#2=#:G483 NIL)
          (|#G70| (|Expon|)) (|#G69| (|Expon|)))
         (SEQ
          (EXIT
           (SEQ
                       ...
                       (SEQ (LETT |tx| (SPADCALL |xs| (QREFELT $ 50)))
                            (COND
                             ((NULL (SPADCALL (QCAR |tx|) |k1| (QREFELT $ 24)))
                              (EXIT
                               (PROGN (LETT #1# |$NoValue|) (GO #4=#:G479)))))
                            (EXIT
...
(DEFUN |GeneralizedUnivariatePowerSeries| (&REST #1=#:G656)
  (SPROG NIL
         (PROG (#2=#:G657)
           (RETURN
            (COND
...
(DEFUN |GeneralizedUnivariatePowerSeries;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((|pv$| NIL) (#1=#:G647 NIL) (#2=#:G648 NIL) (#3=#:G649 NIL) (#4=#:G650 NIL)
    (#5=#:G651 NIL) (#6=#:G652 NIL) (#7=#:G654 NIL) ($ NIL) (|dv$| NIL)
