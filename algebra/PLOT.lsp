...
(DEFUN |PLOT;listBranches;$L;3| (|plot| $)
  (PROG (|outList| |newl| #1=#:G161 |p| #2=#:G160 |curve|)
    (RETURN
...
(DEFUN |PLOT;rangeRefine| (|curve| |nRange| $)
  (PROG (|yRange| |xRange| |p| |t| |i| |d| |n| |q| |c| |s| #1=#:G225 |f| |h|
         |l|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |PLOT;adaptivePlot|
  ...
  (PROG (|p| |t| |todo2| |todo1| |tj| |tm| |st| |n| #1=#:G252 |dp| |s2| |s1|
...
(DEFUN |PLOT;basicPlot| (|f| |tRange| $)
  (PROG (|yRange| |xRange| |p| |t| |l| #1=#:G290 |i| |s| |h|)
    (RETURN
...
(DEFUN |PLOT;refine;$S$;31| (|p| |nRange| $)
  (PROG (|yRange| |xRange| |curves| #1=#:G328 |c| #2=#:G327 |tlimit| #3=#:G326
         #4=#:G325 |tRange|)
    (RETURN
     (SEQ (SETELT $ 10 0)
...
(DEFUN |PLOT;plot;$S$;32| (|p| |tRange| $)
  (PROG (|yRange| |xRange| |curves| #1=#:G339 |c| #2=#:G338 |tlimit| #3=#:G337
         #4=#:G336)
    (RETURN
     (SEQ (SETELT $ 10 0)
          (LETT |curves|
...
(DEFUN |PLOT;plot;LS$;41| (|l| |xRange| $)
  (PROG (|yRange| |t| #1=#:G391 |f| #2=#:G392 |p| #3=#:G390 #4=#:G389
         #5=#:G388)
    (RETURN
...
(DEFUN |PLOT;coerce;$Of;45| (|r| $)
  (PROG (|f| |l| #1=#:G413 |p| #2=#:G412 |h| |yRange| |xRange| #3=#:G411
