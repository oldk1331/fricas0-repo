...
(SDEFUN |PLOT;listBranches;$L;3|
        ...
        (SPROG
         ((|outList| (|List| (|List| (|Point| (|DoubleFloat|)))))
          (|newl| (|List| (|Point| (|DoubleFloat|)))) (#1=#:G161 NIL) (|p| NIL)
          (#2=#:G160 NIL) (|curve| NIL))
...
(SDEFUN |PLOT;join|
        ...
        (SPROG
         ((|u| (|Segment| (|DoubleFloat|))) (#1=#:G171 NIL) (|r| NIL)
          (|rr|
           (|Record|
            (|:| |source|
                 (|Mapping| (|Point| (|DoubleFloat|)) (|DoubleFloat|)))
...
(SDEFUN |PLOT;select|
        ((|l| (|List| (|Point| (|DoubleFloat|))))
         ...
         ($ (|DoubleFloat|)))
        (SPROG ((|m| #1#) (|n| #1#) (#2=#:G196 NIL) (|p| NIL))
...
(SDEFUN |PLOT;rangeRefine|
        ...
        (SPROG
         ((|yRange| #4=(|Segment| (|DoubleFloat|))) (|xRange| #4#) (|p| #3#)
          (|t| #2#) (#5=#:G236 NIL) (|i| NIL) (|d| #6=(|DoubleFloat|))
          (|n| (|Integer|)) (|q| (|List| (|Point| (|DoubleFloat|))))
          (|c| (|List| (|DoubleFloat|))) (|s| #6#) (#7=#:G235 NIL) (|f| #1#)
...
(SDEFUN |PLOT;adaptivePlot|
        ...
        (SPROG
         ((|p| #3#) (|t| #2#) (|tj| #4=(|DoubleFloat|)) (|n| (|Integer|))
          (#5=#:G274 NIL) (|sp| #6=(|List| (|Point| (|DoubleFloat|))))
...
(SDEFUN |PLOT;basicPlot|
        ...
        (SPROG
         ((|yRange| #1=(|Segment| (|DoubleFloat|))) (|xRange| #1#)
          ...
          (|t| (|List| (|DoubleFloat|))) (|l| (|DoubleFloat|)) (#2=#:G294 NIL)
          ...
          (|curves|
           (|List|
            (|Record|
             ...
             (|:| |knots| (|List| (|DoubleFloat|)))
             (|:| |points| (|List| (|Point| (|DoubleFloat|)))))))
          (#2=#:G335 NIL) (|c| NIL) (#3=#:G334 NIL)
          (|tlimit| (|PositiveInteger|)) (#4=#:G333 NIL) (#5=#:G332 NIL)
          (|tRange| (|Segment| (|DoubleFloat|))))
          ...
          (|curves|
           (|List|
            (|Record|
             ...
             (|:| |knots| (|List| (|DoubleFloat|)))
             (|:| |points| (|List| (|Point| (|DoubleFloat|)))))))
          (#2=#:G348 NIL) (|c| NIL) (#3=#:G347 NIL)
          (|tlimit| (|PositiveInteger|)) (#4=#:G346 NIL) (#5=#:G345 NIL))
         (SEQ (SETELT $ 10 0)
              (LETT |curves|
                    (PROGN
                     (LETT #5# NIL)
          ...
          (|t|
           (|List|
            (|Record|
             ...
             (|:| |knots| (|List| (|DoubleFloat|)))
             (|:| |points| (|List| (|Point| (|DoubleFloat|)))))))
          (#1=#:G405 NIL) (|f| NIL) (#2=#:G406 NIL) (|p| NIL) (#3=#:G404 NIL)
          (#4=#:G403 NIL) (#5=#:G402 NIL))
...
(SDEFUN |PLOT;coerce;$Of;45| ((|r| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|f| (|List| (|OutputForm|))) (|l| (|List| #1=(|OutputForm|)))
          (#2=#:G428 NIL) (|p| NIL) (#3=#:G427 NIL) (|h| (|OutputForm|))
          (|yRange| #1#) (|xRange| (|OutputForm|)) (#4=#:G426 NIL)
