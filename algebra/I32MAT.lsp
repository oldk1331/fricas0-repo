...
(MAKEPROP '|I32MAT;minRowIndex;%I;1| '|SPADreplace| '(XLAM (|x|) 0)) 

(SDEFUN |I32MAT;minRowIndex;%I;1| ((|x| (%)) (% (|Integer|))) 0) 

(MAKEPROP '|I32MAT;minColIndex;%I;2| '|SPADreplace| '(XLAM (|x|) 0)) 

(SDEFUN |I32MAT;minColIndex;%I;2| ((|x| (%)) (% (|Integer|))) 0) 

(MAKEPROP '|I32MAT;nrows;%Nni;3| '|SPADreplace| 'ANROWS_I32) 

(SDEFUN |I32MAT;nrows;%Nni;3| ((|x| (%)) (% (|NonNegativeInteger|)))
        (ANROWS_I32 |x|)) 

(MAKEPROP '|I32MAT;ncols;%Nni;4| '|SPADreplace| 'ANCOLS_I32) 
...
(MAKEPROP '|I32MAT;qelt;%3I;7| '|SPADreplace| 'AREF2_I32) 

(SDEFUN |I32MAT;qelt;%3I;7|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (% (|Integer|)))
        (AREF2_I32 |m| |i| |j|)) 

(MAKEPROP '|I32MAT;elt;%3I;8| '|SPADreplace| 'AREF2_I32) 

(SDEFUN |I32MAT;elt;%3I;8|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (% (|Integer|)))
        (AREF2_I32 |m| |i| |j|)) 

(MAKEPROP '|I32MAT;qsetelt!;%4I;9| '|SPADreplace| 'SETAREF2_I32) 

(SDEFUN |I32MAT;qsetelt!;%4I;9|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (|r| #2=(|Integer|)) (% #2#))
        (SETAREF2_I32 |m| |i| |j| |r|)) 

(MAKEPROP '|I32MAT;setelt!;%4I;10| '|SPADreplace| 'SETAREF2_I32) 

(SDEFUN |I32MAT;setelt!;%4I;10|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (|r| #2=(|Integer|)) (% #2#))
        (SETAREF2_I32 |m| |i| |j| |r|)) 

(MAKEPROP '|I32MAT;empty;%;11| '|SPADreplace| '(XLAM NIL (MAKE_MATRIX_I32 0 0))) 

(SDEFUN |I32MAT;empty;%;11| ((% (%))) (MAKE_MATRIX_I32 0 0)) 

(MAKEPROP '|I32MAT;qnew;2Nni%;12| '|SPADreplace| 'MAKE_MATRIX_I32) 

(SDEFUN |I32MAT;qnew;2Nni%;12|
        ((|rows| #1=(|NonNegativeInteger|)) (|cols| #1#) (% (%)))
        (MAKE_MATRIX_I32 |rows| |cols|)) 

(MAKEPROP '|I32MAT;new;2NniI%;13| '|SPADreplace| 'MAKE_MATRIX1_I32) 
