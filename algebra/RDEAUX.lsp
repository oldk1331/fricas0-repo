         ...
         (%
          (|Union|
           ...
           (|Record| (|:| |ans| (|List| (|SparseUnivariatePolynomial| F)))
                     ...
                     (|:| |dpar| (|Integer|))))))
        (SPROG
         ((#1=#:G30 NIL) (#2=#:G31 NIL) (#3=#:G32 NIL) (#4=#:G33 NIL)
          (|ee|
           (|Record| (|:| |coef1| (|SparseUnivariatePolynomial| F))
                     (|:| |coef2| (|SparseUnivariatePolynomial| F))
                     (|:| |generator| (|SparseUnivariatePolynomial| F))))
          (#5=#:G34 NIL) (#6=#:G35 NIL) (|c| NIL) (#7=#:G36 NIL)
          (|cc1| #8=(|SparseUnivariatePolynomial| F)) (|cc2| #8#)
          (|qr|
           (|Record| (|:| |quotient| (|SparseUnivariatePolynomial| F))
                     (|:| |remainder| #9=(|SparseUnivariatePolynomial| F))))
          (|r| #9#) (|nc| (|SparseUnivariatePolynomial| F))
          ...
          (|dres|
           (|Record| (|:| |ans| (|List| (|SparseUnivariatePolynomial| F)))
                     ...
                     (|:| |lcpar| (|List| (|SparseUnivariatePolynomial| F)))
                     (|:| |dpar| (|Integer|))))
          (#10=#:G37 NIL) (#11=#:G39 NIL) (|s2| NIL) (#12=#:G38 NIL)
          (#13=#:G40 NIL) (#14=#:G42 NIL) (|s1| NIL) (#15=#:G41 NIL))
         (SEQ
          (COND
           ((< |d| 0)
            (CONS 0
                          ...
                          (COND
                                 ...
                                 (EXIT
                                  (CONS 1
                                        (VECTOR
                                         (PROGN
                                          (LETT #10# NIL)
                                          (SEQ (LETT #11# |lr|) (LETT |s2| NIL)
                                               (LETT #12# (QVELT |dres| 0))
                                               G190
                                               (COND
                                                ((OR (ATOM #12#)
                                                     (PROGN
                           ...
                           (#16#
                            (CONS 0
                                  (PROGN
                                   (LETT #13# NIL)
                                   (SEQ (LETT #14# |lr|) (LETT |s1| NIL)
                                        (LETT #15# (QCDR |res1|)) G190
                                        (COND
                                         ((OR (ATOM #15#)
                                              (PROGN
                                               (LETT |s1| (CAR #15#))
        ...
        ((|b| (|SparseUnivariatePolynomial| F))
         ...
         (%
          (|Record| (|:| |ans| (|SparseUnivariatePolynomial| F))
                    (|:| |remainder| (|SparseUnivariatePolynomial| F)))))
        (SPROG
         ((|db| (|Integer|)) (|lb| (F)) (|n| (|Integer|)) (#1=#:G51 NIL)
          (#2=#:G45 NIL) (|qq| (|SparseUnivariatePolynomial| F))
                ...
                (SEQ G190
                     ...
                     (SEQ (LETT |n| (- (SPADCALL |c| (QREFELT % 25)) |db|))
                          (EXIT
                           (COND
                            ((< |n| 0)
                             (PROGN (LETT #1# (CONS |q| |c|)) (GO #3=#:G50)))
                            ('T
                             (SEQ
                              (LETT |qq|
                                    (SPADCALL
