         ...
         (SEQ
          (EXIT
           (SEQ (LETT |f1| (SPADCALL |exprf| (QREFELT $ 28)))
                ...
                (EXIT
                 (COND ((QEQCAR N 1) (PROGN (LETT #1# |exprf|) (GO #5=#:G122)))
                       (#6='T
                        (SEQ (LETT |m| (QCDR N))
                             (LETT |newF1|
...
(SDEFUN |SOLVESER;subsSolve|
        ...
        (SPROG
         ((|resul| (|SparseUnivariatePolynomial| (|Expression| R)))
          (|solvevarlist| (|Vector| (|Expression| R))) (#1=#:G183 NIL)
          (#2=#:G188 NIL)
          (|solvar|
           (|Record|
            (|:| |particular|
          ...
          (|coeffmat| (|Matrix| (|Expression| R))) (#4=#:G179 NIL)
          (#5=#:G189 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
            ...
            (EXIT
             (COND
              ((QEQCAR (QCAR |solvar|) 1)
               (PROGN (LETT #2# (CONS 1 "failed")) (GO #6=#:G187)))
              ('T
               (SEQ
                (LETT |solvevarlist|
...
(DEFUN |TransSolvePackageService| (#1=#:G190)
  (SPROG NIL
         (PROG (#2=#:G191)
           (RETURN
            (COND
