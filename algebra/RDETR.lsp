              ...
              (SEQ
               ...
               (COND
                ((NOT |b0?|)
                 (COND
                  ((OR |baseCase?|
                       (SPADCALL (SPADCALL (QVELT (QCDR |u|) 0) (QREFELT $ 17))
                                 (MAX 0 |n|) (QREFELT $ 23)))
                   (EXIT
                    (SEQ
                     (LETT |answ|
               ...
               (COND
                ((SPADCALL |n| 0 (QREFELT $ 23))
                 (COND
                  ((OR |b0?|
                       (< (SPADCALL (QVELT (QCDR |u|) 0) (QREFELT $ 17)) |n|))
                   (EXIT
                    (SEQ
                     (LETT |uansw|
...
(DEFUN |RDETR;SPDE| (|aa| |bb| |cc| |d| |derivation| $)
  (PROG (|v| |r| |qr| |bc| #1=#:G179 |a1| |ra| #2=#:G171 |u| |g|)
    (RETURN
     (SEQ
      (COND
          ...
          (COND ((QEQCAR |u| 1) (CONS 1 "failed"))
                (#3#
                 (SEQ
                  (LETT |aa|
                        (PROG2
                            (LETT #2# (SPADCALL |aa| |g| (QREFELT $ 33)) . #4#)
                            (QCDR #2#)
                          (|check_union| (QEQCAR #2# 0) (QREFELT $ 7) #2#))
                        . #4#)
                  (LETT |bb|
                        (PROG2
                            (LETT #2# (SPADCALL |bb| |g| (QREFELT $ 33)) . #4#)
                            (QCDR #2#)
                          (|check_union| (QEQCAR #2# 0) (QREFELT $ 7) #2#))
                        . #4#)
                  (LETT |cc| (QCDR |u|) . #4#)
                  (LETT |ra| (SPADCALL |aa| (QREFELT $ 35)) . #4#)
                  (EXIT
                   (COND
                    ((QEQCAR |ra| 0)
                     (SEQ
                      (LETT |a1| (SPADCALL (QCDR |ra|) (QREFELT $ 36)) . #4#)
                      (EXIT
                       (CONS 0
                             (VECTOR (SPADCALL |a1| |bb| (QREFELT $ 37))
                                     (SPADCALL |a1| |cc| (QREFELT $ 37)) |d|
                                     (|spadConstant| $ 13)
                                     (|spadConstant| $ 9))))))
                    (#3#
                     (SEQ
...
(DEFUN |RDETR;SPDEnocancel1| (|bb| |cc| |d| |derivation| $)
  (PROG (|q| |r| #1=#:G190 #2=#:G191 #3=#:G194 |n| |lb| |db|)
    (RETURN
     (SEQ
      (EXIT
       (SEQ (LETT |q| (|spadConstant| $ 9) . #4=(|RDETR;SPDEnocancel1|))
            ...
            (SEQ G190
                 (COND
                  ((NULL (SPADCALL |cc| (|spadConstant| $ 9) (QREFELT $ 44)))
                   (GO G191)))
                 (SEQ
                  (EXIT
                   (SEQ
                    (COND
                     ((< |d| 0)
                      (EXIT (PROGN (LETT #3# (CONS |q| 'T) . #4#) (GO #3#))))
                     ('T
                      (SEQ
                    ...
                    (LETT |cc|
                          (SPADCALL
                           (SPADCALL |cc| (SPADCALL |bb| |r| (QREFELT $ 18))
                                     (QREFELT $ 43))
                           (SPADCALL |r| |derivation|) (QREFELT $ 43))
                          . #4#)
                    (LETT |d| (- |n| 1) . #4#)
                    (EXIT (LETT |q| (SPADCALL |q| |r| (QREFELT $ 19)) . #4#))))
                  #2# (EXIT #2#))
...
(DEFUN |RDETR;SPDEnocancel2| (|bb| |cc| |d| |dtm1| |lt| |derivation| $)
  (PROG (|q| |r| #1=#:G209 |db| #2=#:G200 #3=#:G206 |n|)
    (RETURN
     (SEQ
      (EXIT
                         ...
                         (COND
                          ...
                          ('T
                           (SEQ
                            ...
                            (EXIT
                             (LETT |q|
                                   (SPADCALL |q| (SPADCALL |r| (QREFELT $ 48))
                                             (QREFELT $ 19))
                                   . #4#))))))))))))
                  #3# (EXIT #3#))
                 NIL (GO G190) G191 (EXIT NIL))
              ...
              (CONS 0
                    (VECTOR |aa|
                            (SPADCALL (SPADCALL |aa| |f| (QREFELT $ 53))
                                      (SPADCALL
                                       (SPADCALL |d|
                                                 (SPADCALL |tt| |derivation|)
                                                 (QREFELT $ 18))
                                       (QREFELT $ 54))
                                      (QREFELT $ 55))
                            (SPADCALL (SPADCALL (QCDR |u|) |e| (QREFELT $ 18))
                                      |g| (QREFELT $ 53))
                            |tt|))))))))) 

(DEFUN |RDETR;baseRDE;2FR;6| (|f| |g| $)
  (PROG (|v| #1=#:G236 |n| |cc| |bb| |u|)
    (RETURN
     (SEQ
              ...
              (SEQ
               (LETT |n|
                     (|RDETR;getBound| (QVELT (QCDR |u|) 0)
                      (LETT |bb| (SPADCALL (QVELT (QCDR |u|) 1) (QREFELT $ 60))
                            . #2#)
                      (SPADCALL
                       (LETT |cc|
               ...
               (LETT |v|
                     ...
                     . #2#)
               (EXIT
                (CONS (SPADCALL (QCAR |v|) (QVELT (QCDR |u|) 3) (QREFELT $ 61))
                      (QCDR |v|))))))))))) 

(DEFUN |RDETR;getBound| (|a| |b| |dc| $)
  (PROG (|n| |db| |da|)
    (RETURN
     (SEQ (LETT |da| (SPADCALL |a| (QREFELT $ 17)) . #1=(|RDETR;getBound|))
          (EXIT
           (COND ((SPADCALL |b| (QREFELT $ 11)) (MAX 0 (+ (- |dc| |da|) 1)))
                 (#2='T
...
(DEFUN |TranscendentalRischDE| (&REST #1=#:G251)
  (PROG ()
    (RETURN
     (PROG (#2=#:G252)
       (RETURN
  ...
  (PROG (|pv$| $ |dv$| DV$2 DV$1)
    (RETURN
     (PROGN
      ...
      (|haddProp| |$ConstructorCache| '|TranscendentalRischDE| (LIST DV$1 DV$2)
                  (CONS 1 $))
      (|stuffDomainSlots| $)
      (QSETREFV $ 6 |#1|)
      (QSETREFV $ 7 |#2|)
