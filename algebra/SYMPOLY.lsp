...
(SDEFUN |SYMPOLY;*;3%;1| ((|p1| (%)) (|p2| (%)) (% (%)))
        (SPROG
         ((#1=#:G113 NIL) (#2=#:G112 (%)) (#3=#:G114 (%)) (#4=#:G123 NIL)
          (|t2| NIL) (#5=#:G122 NIL) (#6=#:G121 NIL) (|t1| NIL))
         (SEQ
...
(SDEFUN |SYMPOLY;*;3%;2| ((|p1| (%)) (|p2| (%)) (% (%)))
        (SPROG
         ((#1=#:G125 NIL) (#2=#:G124 (%)) (#3=#:G126 (%)) (|r| (R))
          (#4=#:G135 NIL) (|t2| NIL) (#5=#:G134 NIL) (#6=#:G133 NIL)
          (|t1| NIL))
         (SEQ
          (COND ((OR (NULL |p1|) (NULL |p2|)) (|spadConstant| % 9))
                ((SPADCALL (QCAR (|SPADfirst| |p1|)) (QREFELT % 12))
...
(DEFUN |SymmetricPolynomial| (#1=#:G157)
  (SPROG NIL
         (PROG (#2=#:G158)
           (RETURN
            (COND
...
(DEFUN |SymmetricPolynomial;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G154 NIL) (#2=#:G155 NIL) (#3=#:G156 NIL) (% NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|SymmetricPolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|PolynomialRing| 6 11) (|local| |#1|)
              ...
              (|Fraction| 25) (|Record| (|:| |k| 11) (|:| |c| 6)) (|List| 30)
              (|Mapping| 6 11) (|Union| 29 '#1="failed") (|Union| 25 '#1#)
            ...
            (CONS
             ...
             (CONS
              '#((|FiniteAbelianMonoidRing| 6 11) (|AbelianMonoidRing| 6 11)
                 ...
                 (|RetractableTo| 29) (|RetractableTo| 25) (|Hashable|)
                 (|VariablesCommuteWithCoefficients|) (|CoercibleFrom| 6)
                 (|BasicType|) (|CoercibleTo| 43) (|TwoSidedRecip|)
                 (|unitsKnown|) (|noZeroDivisors|) (|CoercibleFrom| 29)
                 (|CoercibleFrom| 25) (|canonicalUnitNormal|))
              (|makeByteWordVec2| 31
                                  '(0 0 0 9 1 11 10 0 12 2 0 0 6 0 13 0 0 0 14
                                    ...
                                    6 10 0 0 22 0 31 0 9 0 29 0 14 2 0 10 0 0
