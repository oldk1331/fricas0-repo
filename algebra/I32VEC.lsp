...
(MAKEPROP '|I32VEC;#;%Nni;1| '|SPADreplace| 'QV_LEN_I32) 

(SDEFUN |I32VEC;#;%Nni;1| ((|x| (%)) (% (|NonNegativeInteger|)))
        (QV_LEN_I32 |x|)) 

(MAKEPROP '|I32VEC;minIndex;%I;2| '|SPADreplace| '(XLAM (|x|) 0)) 

(SDEFUN |I32VEC;minIndex;%I;2| ((|x| (%)) (% (|Integer|))) 0) 

(MAKEPROP '|I32VEC;empty;%;3| '|SPADreplace| '(XLAM NIL (GETREFV_I32 0 0))) 

(SDEFUN |I32VEC;empty;%;3| ((% (%))) (GETREFV_I32 0 0)) 

(MAKEPROP '|I32VEC;new;NniI%;4| '|SPADreplace| 'GETREFV_I32) 

(SDEFUN |I32VEC;new;NniI%;4|
        ((|n| (|NonNegativeInteger|)) (|x| (|Integer|)) (% (%)))
        (GETREFV_I32 |n| |x|)) 

(MAKEPROP '|I32VEC;qelt;%2I;5| '|SPADreplace| 'ELT_I32) 

(SDEFUN |I32VEC;qelt;%2I;5| ((|x| (%)) (|i| (|Integer|)) (% (|Integer|)))
        (ELT_I32 |x| |i|)) 

(MAKEPROP '|I32VEC;elt;%2I;6| '|SPADreplace| 'ELT_I32) 

(SDEFUN |I32VEC;elt;%2I;6| ((|x| (%)) (|i| (|Integer|)) (% (|Integer|)))
        (ELT_I32 |x| |i|)) 

(MAKEPROP '|I32VEC;qsetelt!;%3I;7| '|SPADreplace| 'SETELT_I32) 

(SDEFUN |I32VEC;qsetelt!;%3I;7|
        ((|x| (%)) (|i| (|Integer|)) (|s| #1=(|Integer|)) (% #1#))
        (SETELT_I32 |x| |i| |s|)) 

(MAKEPROP '|I32VEC;setelt!;%3I;8| '|SPADreplace| 'SETELT_I32) 
...
(DEFUN |I32Vector;| ()
  (SPROG
   ((|dv$| NIL) (% NIL) (#1=#:G2416 NIL) (#2=#:G2415 NIL) (#3=#:G2414 NIL)
    (|pv$| NIL))
   (PROGN
    (LETT |dv$| '(|I32Vector|))
    (LETT % (GETREFV 34))
