...
(SDEFUN |I32VEC;#;$Nni;1| ((|x| $) ($ |NonNegativeInteger|)) (QV_LEN_I32 |x|)) 
...
(SDEFUN |I32VEC;new;NniI$;4| ((|n| |NonNegativeInteger|) (|x| |Integer|) ($ $))
        (GETREFV_I32 |n| |x|)) 
...
(DEFUN |I32Vector;| ()
  (SPROG
   ((|dv$| NIL) ($ NIL) (#1=#:G2516 NIL) (#2=#:G2515 NIL) (#3=#:G2514 NIL)
    (|pv$| NIL))
   (PROGN
    (LETT |dv$| '(|I32Vector|))
    (LETT $ (GETREFV 34))
