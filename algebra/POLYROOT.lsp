     ...
     (SEQ
      (COND ((OR (ZEROP |x|) (EQL |x| 1)) (VECTOR 1 |x| 1))
            ('T
             (SEQ
              (LETT |s|
                    (SPADCALL (SPADCALL |x| (QREFELT $ 15)) |n| (QREFELT $ 20))
                    . #6=(|POLYROOT;zroot|))
              (EXIT
  ...
  (PROG (|rec|)
    (RETURN
     (SEQ (LETT |rec| (|POLYROOT;zroot| |x| |n| $) |POLYROOT;czroot|)
          ...
          (EXIT
           (VECTOR (QVELT |rec| 0) (SPADCALL (QVELT |rec| 1) (QREFELT $ 25))
                   (SPADCALL (QVELT |rec| 2) (QREFELT $ 25)))))))) 
    ...
    (RETURN
     (SEQ
      (LETT |sn| (|POLYROOT;czroot| (SPADCALL |x| (QREFELT $ 27)) |n| $)
            . #2=(|POLYROOT;qroot;FNniR;3|))
      (LETT |sd| (|POLYROOT;czroot| (SPADCALL |x| (QREFELT $ 28)) |n| $) . #2#)
      (LETT |m|
            (PROG1
                (LETT #1#
                      (SPADCALL (QVELT |sn| 0) (QVELT |sd| 0) (QREFELT $ 29))
                      . #2#)
    ...
    (RETURN
     (SEQ
      (LETT |sn| (|POLYROOT;zroot| (SPADCALL |x| (QREFELT $ 27)) |n| $)
            . #2=(|POLYROOT;qroot;FNniR;4|))
      (LETT |sd| (|POLYROOT;zroot| (SPADCALL |x| (QREFELT $ 28)) |n| $) . #2#)
      (LETT |m|
            (PROG1
                (LETT #1#
                      (SPADCALL (QVELT |sn| 0) (QVELT |sd| 0) (QREFELT $ 29))
      ...
      (EXIT
       (VECTOR |m|
               (SPADCALL (SPADCALL (QVELT |sn| 1) (QREFELT $ 25))
                         ...
                         (QREFELT $ 30))
               (SPADCALL
                (SPADCALL (EXPT (QVELT |sn| 2) (QUOTIENT2 |m| (QVELT |sn| 0)))
                          (QREFELT $ 25))
                (SPADCALL (EXPT (QVELT |sd| 2) (QUOTIENT2 |m| (QVELT |sd| 0)))
                          (QREFELT $ 25))
                (QREFELT $ 30)))))))) 

(DEFUN |POLYROOT;rroot;RNniR;5| (|x| |n| $)
  (PROG (|r|)
    (RETURN
     (SEQ (LETT |r| (SPADCALL |x| (QREFELT $ 35)) |POLYROOT;rroot;RNniR;5|)
          (EXIT
           (COND
            ((QEQCAR |r| 1)
...
(DEFUN |POLYROOT;rroot;RNniR;6| (|x| |n| $)
  (PROG (|r|)
    (RETURN
     (SEQ (LETT |r| (SPADCALL |x| (QREFELT $ 39)) |POLYROOT;rroot;RNniR;6|)
          (EXIT
           (COND
            ((QEQCAR |r| 1)
             (VECTOR |n| (|spadConstant| $ 36)
...
(DEFUN |POLYROOT;rroot;RNniR;7| (|x| |n| $)
  (VECTOR |n| (|spadConstant| $ 36)
          (SPADCALL (SPADCALL |x| (QREFELT $ 22)) (QREFELT $ 23)))) 
...
(DEFUN |POLYROOT;nthr;PNniR;9| (|x| |n| $)
  (PROG (|rec| |r|)
    (RETURN
     (SEQ
      (LETT |r| (SPADCALL |x| (QREFELT $ 45)) . #1=(|POLYROOT;nthr;PNniR;9|))
      (EXIT
       (COND
        ((QEQCAR |r| 1)
...
(DEFUN |POLYROOT;nthr;PNniR;10| (|x| |n| $)
  (SPADCALL (SPADCALL |x| (QREFELT $ 46)) |n| (QREFELT $ 50))) 

(DEFUN |POLYROOT;froot;FNniR;11| (|x| |n| $)
  (PROG (|m| #1=#:G170 |rd| |rn| |pd| |pn| |sd| |sn|)
    (RETURN
     (SEQ
      (COND
       ...
       ('T
        (SEQ
         (LETT |sn| (SPADCALL (SPADCALL |x| (QREFELT $ 56)) |n| (QREFELT $ 52))
               . #2=(|POLYROOT;froot;FNniR;11|))
         (LETT |sd| (SPADCALL (SPADCALL |x| (QREFELT $ 57)) |n| (QREFELT $ 52))
               . #2#)
         (LETT |pn| (|POLYROOT;rsplit| (QVELT |sn| 2) $) . #2#)
         (LETT |pd| (|POLYROOT;rsplit| (QVELT |sd| 2) $) . #2#)
         (LETT |rn| (SPADCALL (QCAR |pn|) (QVELT |sn| 0) (QREFELT $ 37)) . #2#)
         (LETT |rd| (SPADCALL (QCAR |pd|) (QVELT |sd| 0) (QREFELT $ 37)) . #2#)
         (LETT |m|
               (PROG1
                   (LETT #1#
                         (SPADCALL
                          (LIST (QVELT |rn| 0) (QVELT |rd| 0) (QVELT |sn| 0)
                                (QVELT |sd| 0))
                          (QREFELT $ 59))
                         . #2#)
                 (|check_subtype| (>= #1# 0) '(|NonNegativeInteger|) #1#))
         ...
         (EXIT
          (VECTOR |m|
                  ...
                  (SPADCALL
                   (SPADCALL
                    (SPADCALL
                     (SPADCALL (QVELT |rn| 2) (QUOTIENT2 |m| (QVELT |rn| 0))
                               (QREFELT $ 31))
                     (SPADCALL (QVELT |rd| 2) (QUOTIENT2 |m| (QVELT |rd| 0))
                               (QREFELT $ 31))
                     (QREFELT $ 30))
                    (SPADCALL
         ...
         ('T
          (UNWIND-PROTECT
              (PROG1 (APPLY (|function| |PolynomialRoots;|) #1#)
                (LETT #2# T . #3#))
            (COND
             ((NOT #2#) (HREM |$ConstructorCache| '|PolynomialRoots|))))))))))) 
     ...
     (PROGN
      ...
      (COND
       ((|HasSignature| |#3| (LIST '|imaginary| (LIST (|devaluate| |#3|))))
        (PROGN
         (QSETREFV $ 33
                   (CONS (|dispatchFunction| |POLYROOT;qroot;FNniR;3|) $))))
       ('T
        (QSETREFV $ 33
                  (CONS (|dispatchFunction| |POLYROOT;qroot;FNniR;4|) $))))
      (COND
       ...
       ('T
        (QSETREFV $ 37
                  (CONS (|dispatchFunction| |POLYROOT;rroot;RNniR;7|) $))))
      (COND
       ((|testBitVector| |pv$| 1)
        (PROGN
         (COND
          ((|HasCategory| |#3| '(|RetractableTo| (|Integer|)))
           (QSETREFV $ 52
                     (CONS (|dispatchFunction| |POLYROOT;nthr;PNniR;9|) $)))
          ('T
           (QSETREFV $ 52
