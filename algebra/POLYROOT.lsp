...
(SDEFUN |POLYROOT;zroot|
        ...
        (SPROG
         ((#1=#:G128 NIL) (#2=#:G127 #3=(|Integer|)) (#4=#:G129 #3#)
          (#5=#:G132 NIL) (#6=#:G119 NIL)
          (|s|
           (|Record| (|:| |exponent| (|NonNegativeInteger|))
        ...
        ((|x| (|Fraction| (|Integer|))) (|n| (|NonNegativeInteger|))
         ($
          (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                    (|:| |radicand| F))))
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#1=#:G140 NIL)
          (|sd|
        ...
        ((|x| (|Fraction| (|Integer|))) (|n| (|NonNegativeInteger|))
         ($
          (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                    (|:| |radicand| F))))
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#1=#:G146 NIL)
          (|sd|
...
(SDEFUN |POLYROOT;rsplit|
        ...
        (SPROG
         ((|r| (R)) (|p| (P)) (|u| (|Union| R "failed")) (#1=#:G172 NIL)
          (|q| NIL))
        ...
        ((|x| (F)) (|n| (|NonNegativeInteger|))
         ($
          (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                    (|:| |radicand| F))))
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#1=#:G187 NIL)
          (|rd|
           #2=(|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                        (|:| |radicand| F)))
...
(DEFUN |PolynomialRoots| (&REST #1=#:G190)
  (SPROG NIL
         (PROG (#2=#:G191)
           (RETURN
            (COND
