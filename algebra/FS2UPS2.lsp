...
(DEFUN |FS2UPS2;carefulNthRootIfCan| (|ups| |n| |opt_rec| |rightOnly?| $)
  (PROG (|ans| #1=#:G302 |signum| |coef| |deg| |posCheck?|)
    (RETURN
     (SEQ
      (EXIT
       (SEQ
...
(DEFUN |FS2UPS2;polyToUPS| (|poly| |opt_rec| $)
  (PROG (|ans| #1=#:G405 #2=#:G392 |coef| |deg|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |FS2UPS2;powerToUPS| (|fcn| |n| |opt_rec| $)
  (PROG (|coef| |deg| |ups| #1=#:G423 #2=#:G429 |b|)
    (RETURN
     (SEQ
...
(DEFUN |FS2UPS2;handle_args| (|args| |opt_rec| $)
  (PROG (|lsers| |lsere| |lcoef| |losers| |coef| #1=#:G451 |ups| #2=#:G438
         |nsu| #3=#:G452 |arg|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |FS2UPS2;do_taylor_via_deriv| (|nf| |lsyms| |lser| $)
  (PROG (|ups| |lders| #1=#:G466 |sym| #2=#:G465)
    (RETURN
     (SEQ
      (LETT |lders|
            (PROGN
...
(DEFUN |FS2UPS2;do_taylor_via_deriv2| (|nk| |lsyms| |lser| $)
  (PROG (|ups| |lders| #1=#:G480 |sym| #2=#:G479)
    (RETURN
     (SEQ
      (LETT |lders|
            (PROGN
...
(DEFUN |FS2UPS2;convert_args| (|lsers| |lsere| |lser0| $)
  (PROG (|nargs| |lser| |lsyms| |nsym| #1=#:G486 |s| #2=#:G487 |e| #3=#:G488
         |c|)
    (RETURN
...
(DEFUN |FS2UPS2;do_diff_eq| (|ker| |losers| |lsers| |lsere| |lser0| |getEq| $)
  (PROG (|ups| |lc| #1=#:G524 |c| #2=#:G523 |nker| #3=#:G522 |lsyms| |sym|
         |ecl| #4=#:G521 #5=#:G520 |cn1| |cn1u| |cn| |z0| |nargs| |cargs|)
    (RETURN
     (SEQ
...
(DEFUN |FS2UPS2;do_weierstrass|
  ...
  (PROG (#1=#:G535 |nres2| |lsyms| |nres| |nargs| |cargs| |z_inv| |coef| |deg|
         |z_ser|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |FS2UPS2;spec_to_UPS| (|ker| |args| |opt_rec| $)
  (PROG (|nker| |nargs| |cargs| #1=#:G658 |nexpr| |narg1| |arg1| |ii| |ir| |nm|
...
(DEFUN |FS2UPS2;prim_to_UPS| (|ker| |args| |opt_rec| $)
  (PROG (|coef| #1=#:G688 |ups| #2=#:G438 |nsu| |arg| |nm|)
    (RETURN
     (SEQ
      (EXIT
       (SEQ
...
(DEFUN |FS2UPS2;logToUPS| (|arg| |opt_rec| $)
  (PROG (|logTerm| |lt| #1=#:G729 #2=#:G734 #3=#:G732 |signum| |coef| |deg|
         |ups| #4=#:G438 |result|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |FS2UPS2;atanacot2| (|ups| |coef| |ord| |opt_rec| |plusMinus| $)
  (PROG (|cc| |n| |left?| |posNegPi2| |signum| |lc| #1=#:G759 |rn| |atanFlag|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |FS2UPS2;atancotToUPS| (|arg| |opt_rec| |plusMinus| $)
  (PROG (|res1| #1=#:G767 #2=#:G769 |ord| |coef| |ups| #3=#:G438 |result|)
    (RETURN
     (SEQ
      (EXIT
       (SEQ
...
(DEFUN |FS2UPS2;k2Elem| (|k| $)
  (PROG (|cosz| |sinz| |iez| |ez| |z| |args| #1=#:G872 |a| #2=#:G871)
    (RETURN
     (SEQ
      (LETT |args|
            (PROGN
...
(DEFUN |FS2UPS2;opsInvolvingX| (|fcn| $)
  (PROG (|opList| |op| #1=#:G916 |k| #2=#:G915)
    (RETURN
     (SEQ
      (LETT |opList|
            (PROGN
...
(DEFUN |FS2UPS2;productOfNonZeroes?| (|fcn| $)
  (PROG (#1=#:G932 #2=#:G936 #3=#:G937 |term| |prod|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |FS2UPS2;powerToGenUPS| (|fcn| |n| |opt_rec| $)
  (PROG (|xOpList| |coef| |deg| |ups| #1=#:G438 #2=#:G942 |b|)
    (RETURN
     (SEQ
...
(DEFUN |FS2UPS2;logToGenUPS| (|arg| |opt_rec| $)
  (PROG (|logTerm| |term1| |pow| |mon| |negRat?| |rat| |cen| |lt| #1=#:G986
         #2=#:G988 |signum| |coef| |deg| |ups| #3=#:G438 |result|)
    (RETURN
     (SEQ
      (EXIT
       (SEQ
...
(DEFUN |FS2UPS2;atancotToGenUPS| (|fe| |arg| |opt_rec| |plusMinus| $)
  (PROG (#1=#:G1002 |ord| |coef| |ups| #2=#:G438 |trouble| |result|)
    (RETURN
     (SEQ
      (LETT |result| (|FS2UPS2;iExprToGenUPS| |arg| |opt_rec| $)
...
(DEFUN |FS2UPS2;genUPSApplyIfCan| (|fcn| |arg| |fcnName| |opt_rec| $)
  (PROG (#1=#:G1007 |xOpList| |lc| |deg| |ups| #2=#:G438 |series|)
    (RETURN
     (SEQ
...
(DEFUN |FunctionSpaceToUnivariatePowerSeries2| (&REST #1=#:G1058)
  (PROG ()
    (RETURN
     (PROG (#2=#:G1059)
       (RETURN
