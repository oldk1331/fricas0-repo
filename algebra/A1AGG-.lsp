...
(SDEFUN |A1AGG-;any?;MAB;3|
        ...
        (SPROG ((#1=#:G149 NIL) (#2=#:G152 NIL) (#3=#:G153 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |A1AGG-;every?;MAB;4|
        ((|f| |Mapping| (|Boolean|) S) (|a| A) ($ |Boolean|))
        (SPROG ((#1=#:G155 NIL) (#2=#:G157 NIL) (#3=#:G158 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |A1AGG-;position;MAI;5|
        ...
        (SPROG ((#1=#:G160 NIL) (#2=#:G162 NIL) (#3=#:G163 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |A1AGG-;find;MAU;6|
        ...
        (SPROG ((#1=#:G168 NIL) (#2=#:G173 NIL) (#3=#:G174 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |A1AGG-;count;MANni;7|
        ...
        (SPROG ((|n| (|NonNegativeInteger|)) (#1=#:G179 NIL) (|i| NIL))
...
(SDEFUN |A1AGG-;reduce;MAS;10| ((|f| |Mapping| S S S) (|a| A) ($ S))
        (SPROG ((|r| (S)) (#1=#:G196 NIL) (|k| NIL) (|m| (|Integer|)))
               (SEQ
                (COND
...
(SDEFUN |A1AGG-;stupidget| ((|l| |List| A) ($ S))
        (SPROG ((#1=#:G209 NIL) (#2=#:G211 NIL) (#3=#:G212 NIL) (|a| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |A1AGG-;map;M3A;15| ((|f| |Mapping| S S S) (|a| A) (|b| A) ($ A))
        (SPROG
         ((|i| NIL) (|j| NIL) (|c| (A)) (|l| (|NonNegativeInteger|))
          (#1=#:G213 NIL) (|n| (|Integer|)) (|m| (|Integer|)))
         (SEQ
          (LETT |m|
...
(SDEFUN |A1AGG-;elt;AUsA;17|
        ...
        (SPROG
         ((|k| NIL) (|i| NIL) (|r| (A)) (#1=#:G228 NIL) (|h| (|Integer|))
          (|l| (|Integer|)))
         (SEQ
...
(SDEFUN |A1AGG-;insert;2AIA;18| ((|a| A) (|b| A) (|i| |Integer|) ($ A))
        (SPROG
         ((|k| NIL) (|j| NIL) (#1=#:G238 NIL) (#2=#:G237 NIL) (|y| (A))
          (|n| (|Integer|)) (|m| (|Integer|)))
         (SEQ
...
(SDEFUN |A1AGG-;copy;2A;19| ((|x| A) ($ A))
        (SPROG ((#1=#:G242 NIL) (|i| NIL) (|j| NIL) (|y| (A)))
               (SEQ
                (LETT |y|
...
(SDEFUN |A1AGG-;construct;LA;21| ((|l| |List| S) ($ A))
        (SPROG ((|i| NIL) (#1=#:G253 NIL) (|x| NIL) (|a| (A)))
               (SEQ
...
(SDEFUN |A1AGG-;delete;AUsA;22|
        ((|a| A) (|s| |UniversalSegment| (|Integer|)) ($ A))
        (SPROG
         ((|k| NIL) (#1=#:G264 NIL) (|i| NIL) (#2=#:G263 NIL) (|r| (A))
          (#3=#:G257 NIL) (|h| (|Integer|)) (|l| (|Integer|)))
         (SEQ
          (LETT |l| (SPADCALL |s| (QREFELT $ 31))
...
(SDEFUN |A1AGG-;delete;AIA;23| ((|x| A) (|i| |Integer|) ($ A))
        (SPROG
         ((#1=#:G273 NIL) (|j| NIL) (#2=#:G272 NIL) (|y| (A)) (#3=#:G267 NIL))
         (SEQ
          (COND
...
(SDEFUN |A1AGG-;reverse!;2A;24| ((|x| A) ($ A))
        (SPROG ((#1=#:G277 NIL) (|i| NIL) (|n| (|Integer|)) (|m| (|Integer|)))
               (SEQ
...
(SDEFUN |A1AGG-;concat;LA;25| ((|l| |List| A) ($ A))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G287 NIL) (|a| NIL) (|r| (A))
          (|n| #2=(|NonNegativeInteger|)) (#3=#:G279 NIL) (#4=#:G278 #2#)
          (#5=#:G280 #2#) (#6=#:G286 NIL))
         (SEQ
          (COND ((NULL |l|) (SPADCALL (QREFELT $ 42)))
                (#7='T
...
(SDEFUN |A1AGG-;sorted?;MAB;26|
        ...
        (SPROG ((#1=#:G289 NIL) (#2=#:G291 NIL) (#3=#:G292 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |A1AGG-;=;2AB;29| ((|x| A) (|y| A) ($ |Boolean|))
        (SPROG ((#1=#:G301 NIL) (#2=#:G304 NIL) (#3=#:G305 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (COND
...
(SDEFUN |A1AGG-;position;SA2I;30|
        ...
        (SPROG ((#1=#:G308 NIL) (#2=#:G310 NIL) (|k| NIL) (|n| (|Integer|)))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |A1AGG-;<;2AB;31| ((|a| A) (|b| A) ($ |Boolean|))
        (SPROG
         ((#1=#:G312 NIL) (#2=#:G314 NIL) (#3=#:G315 NIL) (|i| NIL)
          (#4=#:G316 NIL) (|j| NIL))
         (SEQ
          (EXIT
           (SEQ
