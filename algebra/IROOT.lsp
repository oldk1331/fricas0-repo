                  ...
                  (SEQ
                   (SEQ (LETT |m| 0 . #3#) G190
                        (COND
                         ((NULL
                           (QEQCAR
                            (LETT |r| (SPADCALL |n| |p| (QREFELT $ 18)) . #3#)
                            0))
                          (GO G191)))
                        (SEQ
                         (EXIT
             ...
             (COND
              ((SPADCALL |a| (QREFELT $ 32))
               (COND
                ((ODDP |n|)
                 (SPADCALL
                  (SPADCALL (SPADCALL |a| (QREFELT $ 22)) |n| (QREFELT $ 33))
                  (QREFELT $ 22)))
                (#2# (|spadConstant| $ 7))))
                ...
                (#2#
                 (SEQ
                  ...
                  (SEQ G190
                       (COND
                        ((NULL
                          (SPADCALL |z| (|spadConstant| $ 7) (QREFELT $ 41)))
                         (GO G191)))
                       (SEQ (LETT |x| |y| . #3#)
...
(DEFUN |IROOT;perfectNthRoot;INniU;5| (|b| |n| $)
  (PROG (|r|)
    (RETURN
     (COND
      ((SPADCALL
...
(DEFUN |IROOT;perfectSqrt;IU;6| (|a| $)
  (PROG (|s|)
    (RETURN
     (COND
      ((OR (SPADCALL |a| (|spadConstant| $ 7) (QREFELT $ 45))
           (NULL
            (SPADCALL
             (SPADCALL |a| (SPADCALL 144 (QREFELT $ 10)) (QREFELT $ 46))
      ...
      ('T
       (COND
        ((SPADCALL
          (SPADCALL
           (LETT |s| (SPADCALL |a| (QREFELT $ 31)) |IROOT;perfectSqrt;IU;6|)
           |s| (QREFELT $ 44))
          |a| (QREFELT $ 20))
         (CONS 0 |s|))
        ('T (CONS 1 "failed")))))))) 
...
(DEFUN |IROOT;approxSqrt;2I;7| (|a| $)
  (PROG (|old| |new| |#G18| |#G17| |#G16| |#G15| #1=#:G159 |s| |n|)
    (RETURN
     (SEQ
      (EXIT
       (COND
        ...
        ('T
         (SEQ
           ...
           (EXIT
            (COND
             ((SPADCALL |n| (SPADCALL 100 (QREFELT $ 10)) (QREFELT $ 41))
              (SEQ
               (LETT |n|
                     (SPADCALL |n| (SPADCALL 4 (QREFELT $ 10)) (QREFELT $ 38))
                     . #2#)
               (LETT |s|
                     (SPADCALL
                      (SPADCALL |a|
          ...
          (PROGN
           ...
           (LETT |old| |#G16| . #2#))
          (SEQ G190
               (COND ((NULL (SPADCALL |new| |old| (QREFELT $ 50))) (GO G191)))
               (SEQ
                (EXIT
                 (PROGN
                  (LETT |#G17|
                        (SPADCALL
                         (SPADCALL
                          (SPADCALL (|spadConstant| $ 8) |new| (QREFELT $ 24))
                          (SPADCALL |a| |new| (QREFELT $ 38)) (QREFELT $ 24))
                         (QREFELT $ 12) (QREFELT $ 38))
                        . #2#)
                  (LETT |#G18| |new| . #2#)
                  (LETT |new| |#G17| . #2#)
  ...
  (PROG (|pv$| $ |dv$| DV$1)
    (RETURN
     (PROGN
      ...
      (|haddProp| |$ConstructorCache| '|IntegerRoots| (LIST DV$1) (CONS 1 $))
      (|stuffDomainSlots| $)
      (QSETREFV $ 6 |#1|)
      (SETF |pv$| (QREFELT $ 3))
      (QSETREFV $ 11
                (LIST (|spadConstant| $ 7) (|spadConstant| $ 8)
                      (SPADCALL 4 (QREFELT $ 10)) (SPADCALL 9 (QREFELT $ 10))
                      (SPADCALL 16 (QREFELT $ 10)) (SPADCALL 25 (QREFELT $ 10))
                      (SPADCALL 36 (QREFELT $ 10)) (SPADCALL 49 (QREFELT $ 10))
                      (SPADCALL 52 (QREFELT $ 10)) (SPADCALL 64 (QREFELT $ 10))
                      (SPADCALL 73 (QREFELT $ 10)) (SPADCALL 81 (QREFELT $ 10))
