...
(SDEFUN |INTG0;rationalize_log|
        ...
        (SPROG
         ((|res|
          ...
          (|ppc| (|SparseUnivariatePolynomial| F)) (#3=#:G152 NIL)
...
(SDEFUN |INTG0;palgRDE0;2F2KMKFFFU;17|
        ((|f| F) (|g| F) (|x| |Kernel| F) (|y| |Kernel| F)
         ...
         (|dx| |Fraction| (|SparseUnivariatePolynomial| F)) (|r| F)
         ($ |Union| F #2#))
        (SPROG ((|u| #1#) (#3=#:G254 NIL) (|g1| (F)) (|f1| (F)))
               (SEQ
                (LETT |f1|
                      (SPADCALL |f| |y|
                                (SPADCALL |r| (SPADCALL |z| (QREFELT $ 74))
...
(SDEFUN |INTG0;palgLODE0;LF2KFSupR;20|
        ((|eq| L) (|g| F) (|x| |Kernel| F) (|y| |Kernel| F) (|den| F)
         ...
         ($ |Record| (|:| |particular| (|Union| F "failed"))
          (|:| |basis| (|List| F))))
        (SPROG
         ((#1=#:G290 NIL) (|bas| (|List| F)) (#2=#:G300 NIL) (|b| NIL)
          (#3=#:G299 NIL)
          (|rec|
           (|Record|
            (|:| |particular|
...
(SDEFUN |INTG0;palgLODE0;LF3KFFFR;21|
        ((|eq| L) (|g| F) (|x| |Kernel| F) (|y| |Kernel| F) (|kz| |Kernel| F)
         ...
         ($ |Record| (|:| |particular| (|Union| F "failed"))
          (|:| |basis| (|List| F))))
        (SPROG
         ((#1=#:G307 NIL) (|bas| (|List| F)) (#2=#:G316 NIL) (|b| NIL)
          (#3=#:G315 NIL)
...
(DEFUN |GenusZeroIntegration| (&REST #1=#:G317)
  (SPROG NIL
         (PROG (#2=#:G318)
           (RETURN
            (COND
