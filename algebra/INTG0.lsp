...
(SDEFUN |INTG0;rationalize_log|
        ...
        (SPROG
         ((|res|
          ...
          (|ppc| (|SparseUnivariatePolynomial| F)) (#3=#:G153 NIL)
        ...
        (SPROG
         ...
         (SEQ (LETT |at| (SPADCALL |lf| (QREFELT $ 99))) (LETT |res| NIL)
              (SEQ (LETT |k| NIL) (LETT #1# |at|) G190
                   ...
                   (SEQ
                    (EXIT
                     (COND ((SPADCALL |k| |y| (QREFELT $ 100)) "iterate")
                           ('T
                            (LETT |res|
                                  (CONS (SPADCALL |k| (QREFELT $ 73))
                                        |res|))))))
                   (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
              (EXIT |res|)))) 
...
(SDEFUN |INTG0;palgRDE0;2F2KMKFFFU;17|
        ((|f| (F)) (|g| (F)) (|x| (|Kernel| F)) (|y| (|Kernel| F))
         ...
         (|dx| (|Fraction| (|SparseUnivariatePolynomial| F))) (|r| (F))
         ($ (|Union| F #2#)))
        (SPROG ((|u| #1#) (#3=#:G257 NIL) (|g1| (F)) (|f1| (F)))
               (SEQ
                (LETT |f1|
                      (SPADCALL |f| |y|
                                (SPADCALL |r| (SPADCALL |z| (QREFELT $ 73))
        ...
        ((|eq| (L)) (|g| (F)) (|x| (|Kernel| F)) (|y| (|Kernel| F)) (|den| (F))
         ...
         ($
          (|Record| (|:| |particular| (|Union| F "failed"))
                    (|:| |basis| (|List| F)))))
        (SPROG
         ((#1=#:G295 NIL) (|bas| (|List| F)) (#2=#:G305 NIL) (|b| NIL)
          (#3=#:G304 NIL)
          (|rec|
           (|Record|
            (|:| |particular|
        ...
        ((|eq| (L)) (|g| (F)) (|x| (|Kernel| F)) (|y| (|Kernel| F))
         ...
         ($
          (|Record| (|:| |particular| (|Union| F "failed"))
                    (|:| |basis| (|List| F)))))
        (SPROG
         ((#1=#:G314 NIL) (|bas| (|List| F)) (#2=#:G323 NIL) (|b| NIL)
          (#3=#:G322 NIL)
...
(DEFUN |GenusZeroIntegration| (&REST #1=#:G324)
  (SPROG NIL
         (PROG (#2=#:G325)
           (RETURN
            (COND
