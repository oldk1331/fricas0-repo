...
(SDEFUN |PNTHEORY;hermite;ISup;6|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| (|Integer|)))
          ...
          (|#G27| (|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G168 NIL)
          (|k| NIL) (|s| (|Integer|))
          (|#G22|
           (|Record| (|:| |Hn| (|Integer|))
...
(SDEFUN |PNTHEORY;legendre;ISup;7|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          ...
          (|t| (|Integer|)) (#2=#:G176 NIL) (|k| NIL) (|s| (|Integer|))
          (|#G30|
           (|Record| (|:| |Pn| (|Integer|))
                     (|:| P1
                          (|SparseUnivariatePolynomial|
...
(SDEFUN |PNTHEORY;chebyshevT;ISup;9|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| (|Integer|)))
          ...
          (|#G51| (|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G191 NIL)
          (|k| NIL) (|s| (|Integer|))
          (|#G46|
           (|Record| (|:| |Tn| (|Integer|))
...
(SDEFUN |PNTHEORY;chebyshevU;ISup;10|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| (|Integer|)))
          ...
          (|#G59| (|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G198 NIL)
          (|k| NIL) (|s| (|Integer|))
          (|#G54|
           (|Record| (|:| |Un| (|Integer|))
