...
(SDEFUN |PNTHEORY;MonicQuotient|
        ...
        (SPROG
         ((|da| #1=(|NonNegativeInteger|))
          ...
          (|t| (|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G134 NIL)
          (|db| #1#))
         (SEQ
          (COND
...
(SDEFUN |PNTHEORY;cyclotomic;ISup;2|
        ...
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#2=#:G148 NIL) (|s| #3=(|Integer|))
          (|c| (|SparseUnivariatePolynomial| (|Integer|)))
          (|t| (|SparseUnivariatePolynomial| (|Integer|))) (#4=#:G144 NIL)
...
(SDEFUN |PNTHEORY;euler;ISup;3|
        ...
        (SPROG
         ((|p| #1=(|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (|c| (|Fraction| (|Integer|))) (#2=#:G155 NIL)
          (|t| (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (#3=#:G161 NIL) (|i| NIL) (|s| #4=(|Integer|))
          (|#G10|
           (|Record| (|:| |En| (|Integer|))
                     (|:| |Ev|
...
(SDEFUN |PNTHEORY;hermite;ISup;6|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| (|Integer|)))
          ...
          (|#G29| (|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G179 NIL)
          (|k| NIL) (|s| (|Integer|))
          (|#G24|
           (|Record| (|:| |Hn| (|Integer|))
...
(SDEFUN |PNTHEORY;legendre;ISup;7|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          ...
          (|t| (|Integer|)) (#2=#:G187 NIL) (|k| NIL) (|s| (|Integer|))
          (|#G32|
           (|Record| (|:| |Pn| (|Integer|))
                     (|:| P1
                          (|SparseUnivariatePolynomial|
...
(SDEFUN |PNTHEORY;chebyshevT;ISup;9|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| (|Integer|)))
          ...
          (|#G53| (|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G202 NIL)
          (|k| NIL) (|s| (|Integer|))
          (|#G48|
           (|Record| (|:| |Tn| (|Integer|))
...
(SDEFUN |PNTHEORY;chebyshevU;ISup;10|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| (|Integer|)))
          ...
          (|#G61| (|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G209 NIL)
          (|k| NIL) (|s| (|Integer|))
          (|#G56|
           (|Record| (|:| |Un| (|Integer|))
