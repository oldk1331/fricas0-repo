...
(SDEFUN |PNTHEORY;euler;ISup;3|
        ...
        (SPROG
         ((|p| #1=(|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (|c| (|Fraction| (|Integer|))) (#2=#:G130 NIL)
          (|t| (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (#3=#:G136 NIL) (|i| NIL) (|s| #4=(|Integer|))
          (|#G8|
           (|Record| (|:| |En| (|Integer|))
                     (|:| |Ev|
...
(SDEFUN |PNTHEORY;hermite;ISup;6|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| (|Integer|)))
          ...
          (|#G27| (|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G157 NIL)
          (|k| NIL) (|s| (|Integer|))
          (|#G22|
           (|Record| (|:| |Hn| (|Integer|))
...
(SDEFUN |PNTHEORY;legendre;ISup;7|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          ...
          (|t| (|Integer|)) (#2=#:G166 NIL) (|k| NIL) (|s| (|Integer|))
          (|#G30|
           (|Record| (|:| |Pn| (|Integer|))
                     (|:| P1
                          (|SparseUnivariatePolynomial|
...
(SDEFUN |PNTHEORY;chebyshevT;ISup;9|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| (|Integer|)))
          ...
          (|#G51| (|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G183 NIL)
          (|k| NIL) (|s| (|Integer|))
          (|#G46|
           (|Record| (|:| |Tn| (|Integer|))
...
(SDEFUN |PNTHEORY;chebyshevU;ISup;10|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| (|Integer|)))
          ...
          (|#G59| (|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G191 NIL)
          (|k| NIL) (|s| (|Integer|))
          (|#G54|
           (|Record| (|:| |Un| (|Integer|))
