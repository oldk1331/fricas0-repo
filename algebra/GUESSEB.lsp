...
(SDEFUN |GUESSEB;ord1|
        ...
        (SPROG
         ((#1=#:G172 NIL) (|k| NIL) (#2=#:G171 NIL) (#3=#:G170 NIL) (|j| NIL)
          (#4=#:G169 NIL) (#5=#:G168 NIL) (#6=#:G167 NIL) (|n| (|Integer|)))
...
(SDEFUN |GUESSEB;ord2|
        ((|x| (|List| (|Integer|))) (|i| (|Integer|)) ($ (|Integer|)))
        (SPROG ((#1=#:G181 NIL) (|j| NIL) (#2=#:G180 NIL) (|n| (|Integer|)))
               (SEQ
                (COND
                 ((ZEROP |i|)
                  (SEQ (LETT |n| (- (- (LENGTH |x|) 3) |i|))
...
(SDEFUN |GUESSEB;deg1|
        ((|x| (|List| (|Integer|))) (|i| (|Integer|)) ($ (|Integer|)))
        (SPROG
         ((#1=#:G201 NIL) (|k| NIL) (#2=#:G200 NIL) (#3=#:G199 NIL) (|j| NIL)
          (#4=#:G198 NIL) (#5=#:G197 NIL) (#6=#:G196 NIL) (|m| (|Integer|)))
...
(SDEFUN |GUESSEB;deg2|
        ((|x| (|List| (|Integer|))) (|i| (|Integer|)) ($ (|Integer|)))
        (SPROG ((#1=#:G209 NIL) (|j| NIL) (#2=#:G208 NIL) (|m| (|Integer|)))
               (SEQ (LETT |m| (- (LENGTH |x|) 3))
                    (EXIT
                     (+ (|GUESSEB;deg1| |x| |i| $)
                        (*
...
(SDEFUN |GUESSEB;checkResult|
        ((|res| (EXPRR)) (|n| (|Symbol|)) (|l| (|Integer|)) (|list| (|List| F))
         ($ (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G217 NIL) (#2=#:G212 NIL) (|num| (EXPRR)) (#3=#:G211 NIL)
          (|den| (EXPRR)) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GUESSEB;evalResultant|
        ...
        (SPROG
         ((|res| (|List| S)) (#1=#:G241 NIL) (#2=#:G239 NIL) (|lead| (S))
          (#3=#:G237 NIL) (#4=#:G235 NIL) (|d2atk| #5=(|NonNegativeInteger|))
          (|d1atk| #5#) (|p2atk| #6=(|SparseUnivariatePolynomial| S))
          (|p1atk| #6#) (#7=#:G247 NIL) (|k| NIL)
...
(SDEFUN |GUESSEB;guessExpRatAux|
        ...
        (SPROG
         ((#1=#:G332 NIL) (|res| (|List| EXPRR)) (|res4| (EXPRR))
          ...
          (|t2|
           #3=(|SparseMultivariatePolynomial| F
                                              (|OrderedVariableList|
                                               (|construct| '|a1| 'A))))
          (|t1| #3#) (|a1v| (F)) (#4=#:G339 NIL) (|g| NIL)
          (|evalPoly|
           (|SparseMultivariatePolynomial| F
                                           (|OrderedVariableList|
                                            (|construct| '|a1| 'A))))
          (|Av| (F)) (#5=#:G338 NIL) (|f| NIL)
            ...
            (|SparseUnivariatePolynomial|
             (|Fraction|
              (|SparseMultivariatePolynomial| S
                                              (|OrderedVariableList|
                                               (|construct| '|a1| 'A)))))))
          (#8=#:G308 NIL) (#9=#:G337 NIL) (|i| NIL) (|maxDeg| (|Integer|))
          ...
          (|x3|
           #13=(|Fraction|
                (|SparseMultivariatePolynomial| S
                                                (|OrderedVariableList|
                                                 (|construct| '|a1| 'A)))))
          (|x2| #13#) (|x1| #13#) (|xlist| (|List| #13#)) (#14=#:G334 NIL)
          (#15=#:G333 NIL) (|len| (|NonNegativeInteger|)) (#16=#:G264 NIL)
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |a1| (SPADCALL 1 (QREFELT $ 72)))
                ...
                (COND ((< |len| 4) (PROGN (LETT #1# NIL) (GO #18=#:G331)))
                      (#19='T
                       (LETT |len|
                             (PROG1 (LETT #16# (- |len| 3))
                               (|check_subtype2| (>= #16# 0)
...
(SDEFUN |GUESSEB;guessExpRatAux0|
        ((|list| (|List| F)) (|basis| (|Mapping| EXPRR EXPRR))
         (|options| (|List| (|GuessOption|))) ($ (|List| EXPRR)))
        (SPROG
         ((|res| (|List| EXPRR)) (#1=#:G360 NIL) (|f| NIL) (#2=#:G359 NIL)
          (|xValues| (|List| (|Integer|))) (|newlist| (|List| F))
          (|i| (|Integer|)) (#3=#:G358 NIL) (|x| NIL) (|zeros| (EXPRR))
          (#4=#:G357 NIL) (|shortlist| (|List| F)) (#5=#:G342 NIL)
          (#6=#:G356 NIL) (|len| (|Integer|)) (|xx| (|Symbol|)))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |GUESSEB;guessBinRatAux|
        ((|xx| (|Symbol|)) (|list| (|List| F))
         ...
         ($ (|List| EXPRR)))
        (SPROG
         ((#1=#:G411 NIL) (|res| (|List| EXPRR)) (|res4| (EXPRR))
          (|denr| #2=(|SparseUnivariatePolynomial| F)) (|numr| #2#)
          (|ri1|
           (|Fraction|
            (|SparseUnivariatePolynomial|
          ...
          (|t2|
           #3=(|SparseMultivariatePolynomial| F
                                              (|OrderedVariableList|
                                               (|construct| '|a1| 'A))))
          (|t1| #3#) (|a1v| (F)) (#4=#:G418 NIL) (|g| NIL)
          (|evalPoly|
           (|SparseMultivariatePolynomial| F
                                           (|OrderedVariableList|
                                            (|construct| '|a1| 'A))))
          (|Av| (F)) (#5=#:G417 NIL) (|f| NIL)
          (|res3| (|SparseUnivariatePolynomial| F))
          (|res2| #6=(|SparseUnivariatePolynomial| S)) (|res1| #6#)
          (|poly3|
           #7=(|SparseMultivariatePolynomial| S
            ...
            (|SparseUnivariatePolynomial|
             (|Fraction|
              (|SparseMultivariatePolynomial| S
                                              (|OrderedVariableList|
                                               (|construct| '|a1| 'A)))))))
          (#8=#:G391 NIL) (#9=#:G416 NIL) (|i| NIL) (|maxDeg| (|Integer|))
          (|maxD| (|Union| (|NonNegativeInteger|) "arbitrary"))
          (|y3|
           #10=(|Fraction|
                (|SparseMultivariatePolynomial| S
          ...
          (|x3|
           #13=(|Fraction|
                (|SparseMultivariatePolynomial| S
                                                (|OrderedVariableList|
                                                 (|construct| '|a1| 'A)))))
          (|x2| #13#) (|x1| #13#) (|xlist| (|List| #13#)) (#14=#:G413 NIL)
          (#15=#:G412 NIL) (|len| (|NonNegativeInteger|)) (#16=#:G376 NIL)
          (A #17=(|OrderedVariableList| (|construct| '|a1| 'A))) (|a1| #17#))
         (SEQ
          (EXIT
           (SEQ (LETT |a1| (SPADCALL 1 (QREFELT $ 72)))
                (LETT A (SPADCALL 2 (QREFELT $ 72)))
                (LETT |len| (LENGTH |list|))
                (COND ((< |len| 4) (PROGN (LETT #1# NIL) (GO #18=#:G410)))
                      (#19='T
                       (LETT |len|
                             (PROG1 (LETT #16# (- |len| 3))
                               (|check_subtype2| (>= #16# 0)
...
(SDEFUN |GUESSEB;guessBinRatAux0|
        ((|list| (|List| F)) (|basis| (|Mapping| EXPRR EXPRR))
         ...
         (|options| (|List| (|GuessOption|))) ($ (|List| EXPRR)))
        (SPROG
         ((|res| (|List| EXPRR)) (#1=#:G445 NIL) (|f| NIL) (#2=#:G444 NIL)
          (|xValues| (|List| (|Integer|))) (|newlist| (|List| F))
          (|i| (|Integer|)) (#3=#:G443 NIL) (|x| NIL) (|zeros| (EXPRR))
          (#4=#:G442 NIL) (|shortlist| (|List| F)) (#5=#:G421 NIL)
          (#6=#:G441 NIL) (|len| (|Integer|)) (|xx| (|Symbol|)))
         (SEQ
          (EXIT
           (SEQ
            (COND
