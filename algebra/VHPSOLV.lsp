        ...
        ((|lv|
         ...
         ($
          (|Matrix|
           (|SparseUnivariatePolynomial| (|Expression| (|Integer|))))))
        (SPROG
         ((#1=#:G145 NIL) (|j| NIL) (|i1| #2=(|NonNegativeInteger|))
          (#3=#:G144 NIL) (|i| NIL)
          (|res|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
          (|n1| #2#) (#4=#:G143 NIL) (|n| (|NonNegativeInteger|))
          (|res1|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
          (C (|List| (|Expression| (|Integer|)))) (#5=#:G142 NIL)
          (#6=#:G141 NIL) (|vd| (|Vector| (|Integer|))) (#7=#:G140 NIL)
          (|ei| NIL) (#8=#:G139 NIL)
          (|lpp|
