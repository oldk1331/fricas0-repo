        ...
        ((|lv|
         ...
         ($
          (|Matrix|
           (|SparseUnivariatePolynomial| (|Expression| (|Integer|))))))
        (SPROG
         ((#1=#:G144 NIL) (|j| NIL) (|i1| #2=(|NonNegativeInteger|))
          (#3=#:G143 NIL) (|i| NIL)
          (|res|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
          (|n1| #2#) (#4=#:G142 NIL) (|n| (|NonNegativeInteger|))
          (|res1|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
          (C (|List| (|Expression| (|Integer|)))) (#5=#:G141 NIL)
          (#6=#:G140 NIL) (|vd| (|Vector| (|Integer|))) (#7=#:G139 NIL)
          (|ei| NIL) (#8=#:G138 NIL)
          (|lpp|
