        ...
        ((|lv|
         ...
         ($
          (|Matrix|
           (|SparseUnivariatePolynomial| (|Expression| (|Integer|))))))
        (SPROG
         ((#1=#:G161 NIL) (|j| NIL) (|i1| #2=(|NonNegativeInteger|))
          (#3=#:G160 NIL) (|i| NIL)
          (|res|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
          (|n1| #2#) (#4=#:G159 NIL) (|n| (|NonNegativeInteger|))
          (|res1|
           (|Matrix|
            (|SparseUnivariatePolynomial| (|Expression| (|Integer|)))))
          (C (|List| (|Expression| (|Integer|)))) (#5=#:G158 NIL)
          (#6=#:G157 NIL) (|vd| (|Vector| (|Integer|))) (#7=#:G156 NIL)
          (|ei| NIL) (#8=#:G155 NIL)
          (|lpp|
