...
(SDEFUN |LODOF2;factor_riccati|
        ...
        (SPROG
         ((#1=#:G518 NIL)
          ...
          (|xsubsr|
           (|UnivariateLaurentSeries| (|Expression| (|Integer|)) |var| |cen|))
          (#15=#:G521 NIL) (|vi| NIL) (|sym| (|Symbol|)) (#16=#:G428 NIL)
          (#17=#:G175 NIL)
          (|cxs|
           (|UnivariateLaurentSeries| (|Expression| (|Integer|)) |var| |cen|))
          (|il|
           ...
           (SEQ
            ...
            (EXIT
             (COND
              ((QEQCAR |f| 0)
               (SEQ (LETT |fl| (QCDR |f|))
                    (EXIT (PROGN (LETT #1# (CONS 0 |res|)) (GO #3=#:G549)))))
              (#2#
               (SEQ (LETT |fr| (QCDR |f|))
                    (EXIT
                     (PROGN
