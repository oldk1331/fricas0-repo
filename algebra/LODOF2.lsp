                     ...
                     (COND
                      ((EQUAL |option| "split over k((x))")
                       (SEQ
                        ...
                        (LETT |r1|
                              (PROG2
                                  (LETT #18# (SPADCALL |ric| (QREFELT % 196)))
                                  (QCDR #18#)
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |fi| (|spadConstant| % 308))
                ...
                (SEQ (LETT |i| 0) (LETT #1# (SPADCALL |f| (QREFELT % 318)))
                ...
                (LETT |dlc|
                      (PROGN
                       ...
                       (SEQ (LETT |e| (SPADCALL |fi| (QREFELT % 355)))
                            (LETT #4# (SPADCALL |fi| (QREFELT % 318))) G190
                            (COND ((> |e| #4#) (GO G191)))
                            (SEQ
                             (EXIT
                              (LETT #3#
           ...
           (SEQ
            ...
            (LETT |bound|
                  (PROGN
                   (LETT #3# NIL)
                   (SEQ (LETT |i| 1)
                        (LETT #4# (- (SPADCALL |f| (QREFELT % 318)) 1)) G190
                        (COND ((|greater_SI| |i| #4#) (GO G191)))
                        (SEQ
            ...
            (SEQ (LETT |s| NIL) (LETT #5# |gem|) G190
                 ...
                 (SEQ
                  ...
                  (SEQ (LETT |i| 1) (LETT #6# (- (LENGTH |np|) 1)) G190
                       ...
                       (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL))
                  (SEQ (LETT |i| 1)
                       (LETT #10# (- (SPADCALL |f| (QREFELT % 318)) 1)) G190
                       (COND ((|greater_SI| |i| #10#) (GO G191)))
                       (SEQ
                        (EXIT
                         (SPADCALL |bound| |i|
            ...
            (LETT |bound|
                  (PROGN
                   (LETT #11# NIL)
                   (SEQ (LETT |j| 1)
                        (LETT #12# (- (SPADCALL |f| (QREFELT % 318)) 1)) G190
                     ...
                     (COND
                      ((> (SPADCALL |iarf1| (QREFELT % 41)) 1)
                       (SEQ
                        ...
                        (LETT |jj|
                              (PROG2
                                  (LETT #28# (SPADCALL |j1| (QREFELT % 196)))
                                  (QCDR #28#)
          ...
          (LETT |dlc|
                (PROGN
                 ...
                 (SEQ (LETT |e| (SPADCALL |f| (QREFELT % 355)))
                      (LETT #3# (SPADCALL |f| (QREFELT % 318))) G190
                      (COND ((> |e| #3#) (GO G191)))
                      (SEQ
                       (EXIT
                        (LETT #2#
...
(MAKEPROP '|LinearOrdinaryDifferentialOperatorFactorizer2| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|Matrix| 13) (937 . |matrix|) (942 . ~=) (948 . |1|) (952 . /)
              (958 . |1|) (962 . |1|) (|List| 58) (|Mapping| 58 17)
              (|ListFunctions2| 17 58) (966 . |map|) (972 . |elt|) (978 . ~=)
              (984 . /) |LODOF2;testsc;2LodoMB;42| (990 . |retract|)
              (|Union| 295 '"failed") (995 . ~=) (|List| 95) (1001 . |elt|)
              (1007 . |1|) (1011 . |monomial|) (1017 . *) (1023 . +)
              (1029 . |1|) (1033 . /) (1039 . /) (1045 . |adjoint|)
              (|LinearOrdinaryDifferentialOperator1| 25)
              (|LODOConvertions| 11 8 25) (1050 . |convert|) (1055 . |0|)
              ...
              (1237 . -) (1242 . |1|) (1246 . |coefficient|) (1252 . /)
              ...
              |LODOF2;testlp;LodoULodo;54| (1359 . |0|) (1363 . ^) (1369 . *)
              (1375 . +) (|Kernel| %) (1381 . |minPoly|) (|Kernel| 11)
              (|PolynomialCategoryQuotientFunctions| (|IndexedExponents| 392)
                                                     392 38
                                                     (|SparseMultivariatePolynomial|
                                                      38 392)
                                                     11)
              (1386 . |univariate|) |LODOF2;testgt;EKE;57| (1393 . |0|)
