...
(SDEFUN |PMTOOLS;negConstant| ((|l| (|List| P)) (% (|Union| P "failed")))
        (SPROG
         ((|x| NIL) (#1=#:G48 NIL) (|r| (|Union| R "failed")) (#2=#:G47 NIL)
          (#3=#:G46 NIL))
         (SEQ
          (EXIT
           (SEQ
        ...
        ((|lp| (|List| (|Pattern| S)))
         ...
         (%
          (|Union|
           ...
           "failed")))
        (SPROG
         ((|p| NIL) (#4=#:G62 NIL) (|rec| #1#) (|l| #2#) (#5=#:G61 NIL)
          (|ls| #3#))
         (SEQ
          (EXIT
           (SEQ
                  ...
                  (EXIT
                   (COND
                    ((SPADCALL (LETT |l| (QCAR |rec|)) (QREFELT % 20))
                     (PROGN (LETT #5# (CONS 1 "failed")) (GO #6=#:G60)))
                    ('T (LETT |ls| (QCDR |rec|))))))
...
(SDEFUN |PMTOOLS;patternMatchTimes;LLPmrMPmr;3!1| ((|l1| NIL) (% NIL))
        (SPROG
         ((#1=#:G1 NIL) (#2=#:G81 NIL) (#3=#:G79 NIL) (#4=#:G77 NIL)
          (#5=#:G78 NIL))
         (SEQ
          (PROGN
           (LETT #5# NIL)
           (SEQ (LETT #1# NIL) (LETT #2# |l1|) G190
                ...
                (SEQ
                 (EXIT
                  (PROGN
                   (LETT #3# #1#)
                   (COND (#5# (LETT #4# (SPADCALL #4# #3# (QREFELT % 28))))
                         ('T (PROGN (LETT #4# #3#) (LETT #5# 'T)))))))
                (LETT #2# (CDR #2#)) (GO G190) G191 (EXIT NIL))
           (COND (#5# #4#) ('T (|spadConstant| % 9))))))) 

(SDEFUN |PMTOOLS;patternMatchTimes;LLPmrMPmr;3!0| ((|l1| NIL) (% NIL))
        (SPROG
         ((#1=#:G0 NIL) (#2=#:G71 NIL) (#3=#:G69 NIL) (#4=#:G67 NIL)
          (#5=#:G68 NIL))
         (SEQ
          (PROGN
           (LETT #5# NIL)
        ...
        ((|p| (|Pattern| S)) (|ls| (|List| P)) (|l| (|PatternMatchResult| S P))
         ...
         (%
          (|Record| (|:| |res| (|PatternMatchResult| S P))
                    (|:| |s| (|List| P)))))
        (SPROG
         ((|bad| (|List| P)) (#1=#:G98 NIL) (|x| NIL) (#2=#:G99 NIL) (|t| (P))
          (|l1| (|PatternMatchResult| S P)))
         (SEQ
          (LETT |bad|
                (COND
          ...
          (SEQ (LETT |x| NIL) (LETT #1# (SPADCALL |ls| |bad| (QREFELT % 37)))
               G190
               (COND
                ((OR (ATOM #1#) (PROGN (LETT |x| (CAR #1#)) NIL)
                     (NULL
          ...
          (EXIT
           (COND
            ((SPADCALL |l1| (QREFELT % 20))
             (SEQ
              (SEQ (LETT |x| NIL) (LETT #2# |bad|) G190
                   (COND
        ...
        ((|lp| (|List| (|Pattern| S))) (|ls| (|List| P))
         ...
         (%
          (|Union|
           ...
           "failed")))
        (SPROG
         ((|p| NIL) (#1=#:G125 NIL) (|rc| (|Union| (|List| P) "failed"))
          (#2=#:G124 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |PMTOOLS;selBestGen|
        ...
        (SPROG
         ((|p| NIL) (#1=#:G133 NIL) (|ans| (|List| (|Pattern| S)))
          (#2=#:G132 NIL) (#3=#:G131 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |ans| NIL)
...
(SDEFUN |PMTOOLS;patternMatch;LLMPmrMPmr;8|
        ((|ls| (|List| P)) (|lp| (|List| (|Pattern| S)))
         ...
         (% (|PatternMatchResult| S P)))
        (SPROG
         ((|ident| (P)) (#1=#:G224 NIL) (|lpm| #2=(|List| (|Pattern| S)))
          (|l1| #2#) (|l2| #2#) (|l3| (|List| (|Pattern| S))) (|l4| #2#)
          (|rc|
           (|Union|
            (|Record| (|:| |pat| (|List| (|Pattern| S))) (|:| |s| (|List| P)))
            "failed"))
          ...
          (EXIT
           (SEQ (LETT |ident| (SPADCALL NIL |op|))
                ...
                (EXIT
                 (COND
                  ((QEQCAR |rc| 1)
                   (PROGN (LETT #1# (SPADCALL (QREFELT % 23))) (GO #3=#:G223)))
                  (#4='T
