...
(SDEFUN |EXPRODE;k2exquo| ((|k| (|Kernel| F)) (% (F)))
        (SPROG
         ((|op| (|BasicOperator|)) (#1=#:G14 NIL) (|f| NIL) (#2=#:G15 NIL))
         (SEQ
          (COND
           ...
           ('T
            (SPADCALL |op|
                      (PROGN
                       (LETT #1# NIL)
                       (SEQ (LETT |f| NIL)
                            (LETT #2# (SPADCALL |k| (QREFELT % 23))) G190
                            (COND
...
(SDEFUN |EXPRODE;findCompat| ((|yx| (F)) (|l| (|List| (|Equation| F))) (% (F)))
        (SPROG ((|eq| NIL) (#1=#:G33 NIL) (#2=#:G32 NIL) (#3=#:G31 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |EXPRODE;findEq|
        ...
        (SPROG ((|eq| NIL) (#1=#:G41 NIL) (#2=#:G40 NIL) (#3=#:G39 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (LETT |k|
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |k| (SPADCALL |eq| (QREFELT % 60))
                                       (QREFELT % 62))
                             (PROGN
                              (LETT #3# (PROGN (LETT #2# |eq|) (GO #4=#:G38)))
                              (GO #5=#:G36))))))
                         (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #3#))
                  (EXIT (|error| "Improper differential equation"))))
...
(SDEFUN |EXPRODE;checkOrderN|
        ...
        (SPROG
         ((|i| NIL) (#1=#:G49 NIL) (|f| (F)) (|l| (|List| (|Kernel| F)))
          (|m| (F)) (|lv| (|List| F)))
         (SEQ
...
(SDEFUN |EXPRODE;checkSystem|
        ...
        (SPROG ((|k| NIL) (#1=#:G57 NIL) (#2=#:G56 NIL) (#3=#:G55 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                   (EXIT
                    (SEQ (LETT |k| NIL)
                         (LETT #1# (SPADCALL |diffeq| (QREFELT % 60))) G190
                         (COND
...
(SDEFUN |EXPRODE;seriesSolve;LLELA;13|
        ...
        (SPROG ((#1=#:G61 NIL) (|deq| NIL) (#2=#:G62 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #1# NIL)
                  (SEQ (LETT |deq| NIL) (LETT #2# |l|) G190
                       (COND
                        ((OR (ATOM #2#) (PROGN (LETT |deq| (CAR #2#)) NIL))
                         (GO G191)))
                       (SEQ
                        (EXIT
                         (LETT #1#
...
(SDEFUN |EXPRODE;seriesSolve;LLELA;14|
        ...
        (SPROG ((#1=#:G68 NIL) (|deq| NIL) (#2=#:G69 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #1# NIL)
...
(SDEFUN |EXPRODE;seriesSolve;LLELA;15|
        ((|l| (|List| F)) (|ly| (|List| (|BasicOperator|)))
         (|eqx| (|Equation| F)) (|eqy| (|List| (|Equation| F))) (% (|Any|)))
        (SPROG ((#1=#:G73 NIL) (|y| NIL) (#2=#:G74 NIL))
               (SEQ
                (SPADCALL |l| |ly| |eqx|
                          (PROGN
                           (LETT #1# NIL)
...
(SDEFUN |EXPRODE;seriesSolve;FBoEFA;20|
        ((|diffeq| (F)) (|y| (|BasicOperator|)) (|eqx| (|Equation| F))
         (|y0| (F)) (% (|Any|)))
        (SPROG
         ((#1=#:G80 NIL) (|x| (|Symbol|)) (|sy| (|Symbol|)) (|yx| (|Kernel| F))
          (|f| (F)) (|center| (F)))
         (SEQ
          (LETT |x|
                (PROG2
...
(SDEFUN |EXPRODE;seriesSolve;FBoELA;21|
        ((|diffeq| (F)) (|y| (|BasicOperator|)) (|eqx| (|Equation| F))
         (|y0| (|List| F)) (% (|Any|)))
        (SPROG
         ((#1=#:G86 NIL) (|x| (|Symbol|)) (|sy| (|Symbol|)) (|yx| (|Kernel| F))
          (|f| (F)) (|center| (F)))
         (SEQ
          (LETT |x|
                (PROG2
...
(SDEFUN |EXPRODE;seriesSolve;LLELA;22|
        ...
        (SPROG
         ((|kx| (|Kernel| F)) (#1=#:G92 NIL) (|x| (|Symbol|)) (|sy| (|Symbol|))
          (|fsy| (F)) (#2=#:G109 NIL) (|y| NIL) (#3=#:G110 NIL)
          (|yx| (|List| (|Kernel| F))) (#4=#:G111 NIL) (#5=#:G112 NIL)
          (|m| (F)) (|lelt| (|List| F)) (#6=#:G113 NIL) (|k| NIL)
          (#7=#:G114 NIL) (#8=#:G115 NIL) (|eq| NIL) (#9=#:G116 NIL)
          (|l| (|List| F)) (|center| (F)) (#10=#:G117 NIL) (|f| NIL)
          (#11=#:G118 NIL))
         (SEQ
          (LETT |x|
                (PROG2
          ...
          (LETT |sys|
                (PROGN
                 (LETT #6# NIL)
                 (SEQ (LETT |k| NIL) (LETT #7# (CDR |yx|)) G190
                      (COND
