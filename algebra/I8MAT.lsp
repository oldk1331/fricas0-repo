...
(SDEFUN |I8MAT;nrows;$Nni;3| ((|x| $) ($ |NonNegativeInteger|)) (ANROWS_I8 |x|)) 

(PUT '|I8MAT;ncols;$Nni;4| '|SPADreplace| 'ANCOLS_I8) 

(SDEFUN |I8MAT;ncols;$Nni;4| ((|x| $) ($ |NonNegativeInteger|)) (ANCOLS_I8 |x|)) 

(SDEFUN |I8MAT;maxRowIndex;$I;5| ((|x| $) ($ |Integer|)) (- (ANROWS_I8 |x|) 1)) 

(SDEFUN |I8MAT;maxColIndex;$I;6| ((|x| $) ($ |Integer|)) (- (ANCOLS_I8 |x|) 1)) 
...
(DEFUN |I8Matrix;| ()
  (SPROG
   ((|dv$| NIL) ($ NIL) (#1=#:G2663 NIL) (#2=#:G2664 NIL) (#3=#:G2662 NIL)
    (|pv$| NIL))
   (PROGN
    (LETT |dv$| '(|I8Matrix|))
    (LETT $ (GETREFV 46))
