...
(DEFUN |SPLTREE;localCoerce| (|a| |k| $)
  (PROG (|lo| #1=#:G257 |c| #2=#:G256 |ro| |s| |i|)
    (RETURN
     (SEQ
...
(DEFUN |SplittingTree;| (|#1| |#2|)
  (PROG (|pv$| #1=#:G330 #2=#:G331 #3=#:G332 $ |dv$| DV$2 DV$1)
    (RETURN
     (PROGN
