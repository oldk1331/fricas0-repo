...
(SDEFUN |MONOTOOL;split;UPMR;2|
        ...
        (SPROG
         ((|rec| (|Record| (|:| |normal| UP) (|:| |special| UP)))
          (#1=#:G129 NIL) (|pbar| (UP)) (|g| (UP)) (|difp| (UP)) (|derp| (UP)))
...
(SDEFUN |MONOTOOL;splitSquarefree;UPMR;3|
        ((|p| UP) (|derivation| |Mapping| UP UP)
         ($ |Record| (|:| |normal| (|Factored| UP))
          (|:| |special| (|Factored| UP))))
        (SPROG
         ((|n| #1=(|Factored| UP)) (|h| (UP)) (#2=#:G141 NIL) (|s| #1#)
          (|g| (UP)) (|r| (UP)) (#3=#:G148 NIL) (|rec| NIL)
          (|q| (|Factored| UP)))
...
(SDEFUN |MONOTOOL;decompose;FMR;4|
        ((|f| |Fraction| UP) (|derivation| |Mapping| UP UP)
         ($ |Record| (|:| |poly| UP) (|:| |normal| (|Fraction| UP))
          (|:| |special| (|Fraction| UP))))
        (SPROG
         ((|eeu| (|Record| (|:| |coef1| UP) (|:| |coef2| UP))) (#1=#:G155 NIL)
          (|rec| (|Record| (|:| |normal| UP) (|:| |special| UP)))
...
(DEFUN |MonomialExtensionTools| (&REST #1=#:G160)
  (SPROG NIL
         (PROG (#2=#:G161)
           (RETURN
            (COND
