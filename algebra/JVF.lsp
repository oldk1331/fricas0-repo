...
(SDEFUN |JVF;prolong;$Nni$;16| ((|v| ($)) (|q| (|NonNegativeInteger|)) ($ ($)))
        (SPROG
         ((|oldDir| (|List| JB)) (|oldCo| (|List| D)) (|newDir| (|List| JB))
          ...
          (|nu| (|List| (|NonNegativeInteger|))) (#1=#:G231 NIL) (|i| NIL)
          (|j| (|Integer|)) (#2=#:G206 NIL) (|newjv| (JB)) (#3=#:G201 NIL)
          (#4=#:G199 NIL) (#5=#:G230 NIL) (|k| NIL)
          (|mu| (|List| (|NonNegativeInteger|))) (|a| (|PositiveInteger|))
          (|jm| (|SparseEchelonMatrix| JB D)) (#6=#:G228 NIL) (|jv| NIL)
          (#7=#:G229 NIL) (|co| NIL) (#8=#:G227 NIL) (|qq| NIL) (#9=#:G190 NIL)
          (#10=#:G226 NIL) (#11=#:G225 NIL) (#12=#:G224 NIL) (#13=#:G222 NIL)
          (#14=#:G223 NIL) (#15=#:G179 NIL) (#16=#:G221 NIL) (#17=#:G220 NIL)
          (|dxi| (|Matrix| D)) (|ind2| (|List| (|PositiveInteger|)))
          (|eta| (|List| D)) (|ind1| (|List| (|PositiveInteger|)))
          (|xi| (|List| D)) (|jt| (|Symbol|)) (#18=#:G218 NIL) (#19=#:G219 NIL)
...
(SDEFUN |JVF;eval;$2D;17| ((|v| ($)) (|f| (D)) ($ (D)))
        (SPROG
         ((|res| (D)) (#1=#:G235 NIL) (|c| NIL) (#2=#:G236 NIL) (|jb| NIL))
...
(SDEFUN |JVF;commutator;3$;18| ((|v| ($)) (|w| ($)) ($ ($)))
        (SPROG
         ((|res2| ($)) (|rjb| (|List| JB)) (|rco| (|List| D)) (|sum| (D))
          (#1=#:G253 NIL) (|c1| NIL) (#2=#:G254 NIL) (|j1| NIL) (#3=#:G251 NIL)
          (|c2| NIL) (#4=#:G252 NIL) (|j2| NIL) (|res1| ($)) (#5=#:G249 NIL)
          (#6=#:G250 NIL) (#7=#:G247 NIL) (#8=#:G248 NIL))
...
(SDEFUN |JVF;table;LTda;19| ((|lv| (|List| $)) ($ (|TwoDimensionalArray| $)))
        (SPROG
         ((|c| ($)) (#1=#:G263 NIL) (|v2| NIL) (|j| NIL) (|v1| ($)) (|i| NIL)
          (#2=#:G262 NIL) (|res| (|TwoDimensionalArray| $))
...
(DEFUN |JetVectorField| (&REST #1=#:G269)
  (SPROG NIL
         (PROG (#2=#:G270)
           (RETURN
            (COND
...
(DEFUN |JetVectorField;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G268 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
