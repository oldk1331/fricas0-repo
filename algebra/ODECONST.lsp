...
(SDEFUN |ODECONST;homoBasis| ((|op| L) (|x| F) ($ |List| F))
        (SPROG
         ...
         (SEQ (LETT |p| (|spadConstant| $ 21) . #2=(|ODECONST;homoBasis|))
              ...
              (SEQ (LETT |ff| NIL . #2#)
                   (LETT #1# (SPADCALL |fp| (QREFELT $ 39)) . #2#) G190
                   (COND
...
(SDEFUN |ODECONST;basisSol|
        ((|p| |SparseUnivariatePolynomial| F) (|n| |Integer|) (|x| F)
         ($ |List| F))
        (SPROG
         ((|xn| (F)) (|l| (|List| F)) (#1=#:G131 NIL) (|f| NIL) (#2=#:G130 NIL)
          (#3=#:G129 NIL) (|i| NIL) (|ll| (|List| F)))
         (SEQ
          ...
          (EXIT
           (COND ((ZEROP |n|) |l|)
                 ('T
                  (SEQ (LETT |ll| (SPADCALL |l| (QREFELT $ 41)) . #4#)
                       (LETT |xn| |x| . #4#)
                       (SEQ (LETT |i| 1 . #4#) (LETT #3# |n| . #4#) G190
                            ...
                            (SEQ
                             (LETT |l|
                                   ...
                                   . #4#)
                             (EXIT
                              (LETT |xn| (SPADCALL |x| |xn| (QREFELT $ 42))
                                    . #4#)))
...
(SDEFUN |ODECONST;basisSqfr|
        ...
        (SPROG
         ...
         (SEQ
          (LETT |d| (SPADCALL |p| (QREFELT $ 43)) . #3=(|ODECONST;basisSqfr|))
          (EXIT
           (COND
            ((EQL |d| 1)
             (LIST
              (SPADCALL
               (SPADCALL
                (SPADCALL
                 (SPADCALL (SPADCALL |p| 0 (QREFELT $ 46)) |x| (QREFELT $ 42))
            ...
            ('T
             (PROGN
              (LETT #2# NIL . #3#)
              (SEQ (LETT |a| NIL . #3#)
                   (LETT #1# (SPADCALL |p| (QREFELT $ 53)) . #3#) G190
                   (COND
...
(SDEFUN |ODECONST;quadSol|
        ((|p| |SparseUnivariatePolynomial| F) (|x| F) ($ |List| F))
        (SPROG
         ((#1=#:G148 NIL) (|a| (F)) (#2=#:G147 NIL) (#3=#:G146 NIL) (|i| (F))
           ...
           (SEQ
             ...
             (LETT |u|
                   (SPADCALL
                    (LETT |delta|
                          (SPADCALL
                           (SPADCALL
                            (LETT |b| (SPADCALL |p| 1 (QREFELT $ 46))
                                  . #4=(|ODECONST;quadSol|))
                            2 (QREFELT $ 55))
                           (SPADCALL
                            (SPADCALL 4
                                      (LETT |a| (SPADCALL |p| (QREFELT $ 47))
                                            . #4#)
                                      (QREFELT $ 56))
                            (LETT |c| (SPADCALL |p| 0 (QREFELT $ 46)) . #4#)
                            (QREFELT $ 42))
                           (QREFELT $ 57))
                          . #4#)
                    (QREFELT $ 60))
            ...
            (EXIT
             (PROGN
              (LETT #2# NIL . #4#)
              (SEQ (LETT |a| NIL . #4#)
                   (LETT #1# (SPADCALL |p| (QREFELT $ 66)) . #4#) G190
                   (COND
...
(DEFUN |ConstantLODE| (&REST #1=#:G149)
  (SPROG NIL
         (PROG (#2=#:G150)
           (RETURN
            (COND
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 66
                                                 '(1 7 0 9 10 2 11 7 7 9 12 4
                                                   ...
                                                   20 35 1 33 38 0 39 2 14 0 0
                                                   0 40 1 14 0 0 41 2 7 0 0 0
                                                   42 1 20 28 0 43 0 6 0 44 0 7
                                                   0 45 2 20 7 0 28 46 1 20 7 0
                                                   47 2 7 0 0 0 48 1 7 0 0 49 1
                                                   7 0 0 50 1 7 51 52 53 2 7 0
                                                   0 54 55 2 7 0 54 0 56 2 7 0
                                                   0 0 57 1 59 58 7 60 1 7 0 0
                                                   61 1 62 7 7 63 1 7 0 0 64 1
                                                   7 0 0 65 1 7 51 52 66 3 0 18
                                                   8 7 9 19)))))
           '|lookupComplete|)) 
