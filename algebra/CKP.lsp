...
(SDEFUN |CKP;displayCartan|
        ...
        (SPROG ((#1=#:G169 NIL) (|cc| NIL) (#2=#:G168 NIL))
               (SEQ
...
(SDEFUN |CKP;stirling;4Nni;11|
        ...
        (SPROG
         ((|res| (|NonNegativeInteger|)) (#1=#:G203 NIL) (#2=#:G202 NIL)
          (#3=#:G201 NIL) (#4=#:G213 NIL) (|j| NIL) (#5=#:G212 NIL)
          (#6=#:G211 NIL) (#7=#:G210 NIL)
...
(SDEFUN |CKP;alpha;Nni2L;12|
        ...
        (SPROG
         ((#1=#:G215 NIL) (#2=#:G219 NIL) (|bi| NIL) (#3=#:G220 NIL) (|i| NIL)
          (#4=#:G218 NIL))
         (SEQ
          (PROGN
           (LETT #4# NIL)
...
(SDEFUN |CKP;hilbert;LSup;13|
        ...
        (SPROG
         ((|ifac| #1=(|Integer|))
          ...
          (|coeff| (|Fraction| (|Integer|))) (#2=#:G223 NIL) (|kfac| #1#)
          (#3=#:G231 NIL) (|k| NIL) (#4=#:G230 NIL) (|i| NIL))
...
(SDEFUN |CKP;alphaHilbert;SupL;14|
        ((|hilp| (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
         ($ (|List| (|NonNegativeInteger|))))
        (SPROG
         ((|res| (|List| (|NonNegativeInteger|))) (#1=#:G370 NIL)
          (|ai| (|Integer|)) (#2=#:G368 NIL) (|kfac| #3=(|Integer|))
          (|sum| (|Fraction| (|Integer|))) (#4=#:G237 NIL) (#5=#:G236 NIL)
          (#6=#:G375 NIL) (|k| NIL) (|ifac| #3#) (|i| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |CKP;arbFunctions;NniILL;15|
        ...
        (SPROG
         ((|res| (|List| (|Integer|))) (|t| (|Fraction| (|Integer|)))
          (#1=#:G415 NIL) (#2=#:G414 NIL) (#3=#:G405 NIL) (|kfac| (|Integer|))
          (|ki| (|NonNegativeInteger|)) (#4=#:G378 NIL) (#5=#:G422 NIL)
...
(SDEFUN |CKP;gauge;NniILL;16|
        ...
        (SPROG
         ((|res| (|List| (|Integer|))) (|t| (|Fraction| (|Integer|)))
          (#1=#:G445 NIL) (#2=#:G444 NIL) (|kfac| (|Integer|))
          (|ki| (|NonNegativeInteger|)) (#3=#:G435 NIL) (#4=#:G455 NIL)
          (|k| NIL) (|ifac| (|Integer|)) (#5=#:G432 NIL) (#6=#:G431 NIL)
          (#7=#:G453 NIL) (|l| NIL) (#8=#:G454 NIL) (|g| NIL) (|i| NIL)
...
(SDEFUN |CKP;gaugeHilbert;NniLSup;17|
        ...
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (|t| (|NonNegativeInteger|)) (#1=#:G459 NIL) (#2=#:G458 NIL)
          (#3=#:G467 NIL) (|l| NIL) (#4=#:G468 NIL) (|g| NIL) (#5=#:G466 NIL)
...
(SDEFUN |CKP;bound;4Nni;18|
        ...
        (SPROG
         ((#1=#:G473 NIL) (#2=#:G470 NIL) (|tmp| (|NonNegativeInteger|))
          (#3=#:G469 NIL))
         (SEQ
          (COND
           ((EQL |qq| 1)
...
(SDEFUN |CKP;complete2;JdeR;20|
        ...
        (SPROG
         ((|Cartan| (|List| (|NonNegativeInteger|)))
          ...
          (#4=#:G498 NIL) (|ProjDe| (|JetDifferentialEquation| JB D))
          ...
          (#7=#:G484 NIL) (#8=#:G482 NIL) (#9=#:G507 NIL)
          (|solved?| (|Boolean|)))
...
(DEFUN |CartanKuranishi| (&REST #1=#:G508)
  (SPROG NIL
         (PROG (#2=#:G509)
           (RETURN
            (COND
