...
(SDEFUN |RULE;F2Symbol| ((|f| F) ($ F))
        (SPROG
         ((#1=#:G131 NIL) (#2=#:G138 NIL) (|k| NIL) (#3=#:G137 NIL)
          (|l| (|List| (|Kernel| F))))
         (SEQ
          (LETT |l|
...
(SDEFUN |RULE;appear?|
        ...
        (SPROG ((#1=#:G163 NIL) (#2=#:G164 NIL) (#3=#:G165 NIL) (|p| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |RULE;bad?|
        ...
        (SPROG ((#1=#:G174 NIL) (#2=#:G175 NIL) (#3=#:G176 NIL) (|x| NIL))
               (SEQ
                (EXIT
                 (COND
                  ((QEQCAR |u| 0)
