...
(SDEFUN |SAE;represents;V$;18| ((|vect| (|Vector| R)) ($ ($)))
        (SPROG
         ((#1=#:G158 NIL) (#2=#:G157 ($)) (#3=#:G159 ($)) (#4=#:G161 NIL)
          (|i| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |SAE;coordinates;$VV;25|
        ((|x| ($)) (|bas| (|Vector| $)) ($ (|Vector| R)))
        (SPROG
         ((|xi| (|qf|)) (#1=#:G182 NIL) (|i| NIL) (|vec| (|Vector| R))
...
(SDEFUN |SAE;mkDiscMat| ((|b| (|Boolean|)) ($ (|Void|)))
        (SPROG
         ((#1=#:G202 NIL) (|j| NIL) (#2=#:G201 NIL) (|i| NIL)
...
(SDEFUN |SAE;trace;$R;32| ((|x| ($)) ($ (R)))
        (SPROG ((|ans| (R)) (|xn| ($)) (#1=#:G208 NIL) (|n| NIL))
               (SEQ (LETT |xn| |x|)
                    (LETT |ans|
...
(DEFUN |SimpleAlgebraicExtension| (&REST #1=#:G272)
  (SPROG NIL
         (PROG (#2=#:G273)
           (RETURN
            (COND
...
(DEFUN |SimpleAlgebraicExtension;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G271 NIL) (|i| NIL) (#2=#:G270 NIL) (#3=#:G127 NIL) (#4=#:G124 NIL)
    (|pv$| NIL) (#5=#:G267 NIL) (#6=#:G268 NIL) (#7=#:G269 NIL) ($ NIL)
...
(MAKEPROP '|SimpleAlgebraicExtension| '|infovec|
          (LIST
           ...
           (CONS
            (|makeByteWordVec2| 15
                                '(0 2 2 4 4 15 4 4 4 0 4 0 0 3 3 3 0 0 1 3 3 5
             ...
             (CONS
              ...
              (|makeByteWordVec2| 169
                                  '(1 7 6 0 9 1 6 10 0 11 2 7 0 6 0 14 1 13 15
                                    ...
                                    154 1 0 0 7 72 0 2 0 1 1 0 22 79 84 1 0 35
                                    0 70 2 0 35 0 79 88 2 0 22 79 79 1 1 6 156
                                    0 1 1 0 0 7 1 1 0 7 0 1 1 0 0 35 1 1 0 35 0
                                    ...
                                    2 3 0 144 0 1 2 3 0 0 144 1 2 10 0 0 43 1 2
                                    0 0 0 6 1 2 0 0 6 0 42 2 0 0 15 0 1 2 0 0
                                    43 0 45 2 0 0 0 0 68 2 0 0 75 0 1)))))
           '|lookupComplete|)) 
