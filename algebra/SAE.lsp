...
(DEFUN |SimpleAlgebraicExtension| (&REST #1=#:G258)
  (PROG ()
    (RETURN
     (PROG (#2=#:G259)
       (RETURN
...
(DEFUN |SimpleAlgebraicExtension;| (|#1| |#2| |#3|)
  (PROG (#1=#:G257 |i| #2=#:G256 #3=#:G133 #4=#:G130 |pv$| #5=#:G254 #6=#:G255
         $ |dv$| DV$3 DV$2 DV$1)
    (RETURN
     (SEQ
      (PROGN
...
(MAKEPROP '|SimpleAlgebraicExtension| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (321 . |lookup|) (|Symbol|) (|List| 127) (|List| 15)
              (|Fraction| 49)
              (|Record| (|:| |unit| $) (|:| |canonical| $) (|:| |associate| $))
              (|List| $) (|Record| (|:| |coef| 132) (|:| |generator| $))
              (|SparseUnivariatePolynomial| $) (|Union| 132 '"failed")
              (|Record| (|:| |coef1| $) (|:| |coef2| $))
              (|Union| 136 '"failed")
              (|Record| (|:| |coef1| $) (|:| |coef2| $) (|:| |generator| $))
              (|Factored| $) (|Mapping| 6 6) (|Fraction| 7) (|InputForm|)
              (|Union| 15 '"failed") (|OnePointCompletion| 76)
              (|Union| 80 '"failed") (|Table| 76 15)
              (|Record| (|:| |factor| 49) (|:| |exponent| 49)) (|List| 147)
              (|Union| '"prime" '"polynomial" '"normal" '"cyclic")
              (|Matrix| 49)
              (|Record| (|:| |mat| 150) (|:| |vec| (|Vector| 49)))
              (|Union| 130 '#1="failed") (|Union| 49 '#1#) (|Union| 6 '#1#)
           ...
           '#(~= 326 |zero?| 332 |unitNormal| 337 |unitCanonical| 342 |unit?|
              ...
              585 |lcm| 590 |latex| 601 |inv| 606 |init| 611 |index| 615 |hash|
              620 |generator| 625 |gcdPolynomial| 629 |gcd| 635
              |factorsOfCyclicGroupSize| 646 |factor| 650 |extendedEuclidean|
              655 |exquo| 668 |expressIdealMember| 674 |euclideanSize| 680
              |enumerate| 685 |divide| 689 |discriminant| 695 |discreteLog| 704
              |differentiate| 715 |derivationCoordinates| 765
              |definingPolynomial| 771 |createPrimitiveElement| 775
              |coordinates| 779 |convert| 801 |conditionP| 826 |coerce| 831
              |charthRoot| 856 |characteristicPolynomial| 866 |characteristic|
              871 |basis| 875 |associates?| 879 ^ 885 |Zero| 903 |One| 907 D
              911 = 961 / 967 - 973 + 984 * 990)
           'NIL
           (CONS
            (|makeByteWordVec2| 12
                                '(0 2 2 4 4 4 3 0 4 0 4 3 0 0 3 3 3 0 0 0 1 3 3
                                  3 5 7 12 10 0 0 0 3 0 0 0 0 0 3 3 0 0 0 0 0 0
                                  0 0 6 2 0 0 0 0 0 0 0 0 3 3 3 6 8 9))
            (CONS
             ...
             (CONS
              '#((|MonogenicAlgebra| 6 7) (|FiniteFieldCategory|)
                 ...
                 (|canonicalsClosed|) (|ConvertibleTo| 142)
              ...
              (|makeByteWordVec2| 156
                                  '(1 7 6 0 9 1 6 10 0 11 2 7 0 6 0 14 1 13 15
                                    ...
                                    0 115 1 2 146 49 1 2 0 10 0 0 1 1 3 0 0 1 1
                                    3 139 0 1 2 3 25 0 0 1 0 6 15 40 0 0 0 1 1
                                    8 152 0 1 1 9 153 0 1 1 0 154 0 1 1 8 130 0
