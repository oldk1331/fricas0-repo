...
(SDEFUN |SREGSET;coerce;%Of;12| ((|ts| (%)) (% (|OutputForm|)))
        (SPROG ((|lp| (|List| P)) (#1=#:G63 NIL) (|p| NIL) (#2=#:G64 NIL))
...
(SDEFUN |SREGSET;removeZero;P%P;22| ((|p| (P)) (|ts| (%)) (% (P)))
        (SPROG
         ((|v| (V)) (|ts_v-| (%)) (#1=#:G128 NIL) (#2=#:G139 NIL) (|q| (P)))
         (SEQ
          (EXIT
           (COND
                     ...
                     (EXIT
                      (COND
                       ((SPADCALL |q| (QREFELT % 65))
                        (PROGN (LETT #2# |q|) (GO #3=#:G138)))
                       ((SPADCALL (SPADCALL |q| |ts_v-| (QREFELT % 66))
                                  (QREFELT % 65))
                        (PROGN (LETT #2# (|spadConstant| % 67)) (GO #3#))))))))
                  (EXIT
...
(SDEFUN |SREGSET;internalAugment;P%5BL;25|
        ((|p| (P)) (|ts| (%)) (|rem?| (|Boolean|)) (|red?| (|Boolean|))
         ...
         (% (|List| %)))
        (SPROG
         ((|v| (V)) (|ts_v-| (%)) (|ts_v+| (%)) (|lsfp| (|List| P)) (|f| NIL)
          (#1=#:G158 NIL)
          (|lpwt| (|List| (|Record| (|:| |val| P) (|:| |tower| %))))
          (|pwt| NIL) (#2=#:G159 NIL) (|lts| (|List| %)) (#3=#:G160 NIL)
          (|us| NIL) (#4=#:G161 NIL))
         (SEQ (LETT |v| (SPADCALL |p| (QREFELT % 32)))
              (LETT |ts_v-| (SPADCALL |ts| |v| (QREFELT % 44)))
              ...
              (COND
               (|sqfr?|
                (SEQ (LETT |lts| NIL)
                     ...
                     (EXIT
                      (SEQ (LETT |f| NIL) (LETT #1# |lsfp|) G190
                           (COND
                             ...
                             (COND
                              ...
                              ('T
                               (SEQ
                                ...
                                (EXIT
                                 (SEQ (LETT |pwt| NIL) (LETT #2# |lpwt|) G190
                                      (COND
                                       ((OR (ATOM #2#)
                                            (PROGN (LETT |pwt| (CAR #2#)) NIL))
                                        (GO G191)))
                                      (SEQ
                                       (EXIT
                                        (LETT |lts|
...
(SDEFUN |SREGSET;extend;P%L;27| ((|p| (P)) (|ts| (%)) (% (|List| %)))
        (SPROG
         ((|split| (|List| %)) (|us| NIL) (#1=#:G171 NIL) (|lts| (|List| %)))
         (SEQ
          (COND
           ((SPADCALL |p| (QREFELT % 49))
...
(SDEFUN |SREGSET;pre_process;L2BR;44|
        ...
        (SPROG
         ((|ts| (%)) (#1=#:G271 NIL) (|lp1| (|List| P)) (#2=#:G272 NIL)
          (#3=#:G273 NIL) (#4=#:G274 NIL) (#5=#:G275 NIL) (#6=#:G276 NIL)
          (#7=#:G277 NIL) (#8=#:G278 NIL) (#9=#:G279 NIL) (#10=#:G280 NIL)
          (#11=#:G281 NIL) (|lp4| (|List| P)) (#12=#:G282 NIL)
          (|lp3| (|List| P)) (|p| NIL) (#13=#:G283 NIL) (|lts| (|List| %))
          (|lp2| (|List| P)) (#14=#:G270 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |ts| (SPADCALL NIL (QREFELT % 20)))
                (LETT |lts| (LIST |ts|))
