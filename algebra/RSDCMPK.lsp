...
(SDEFUN |RSDCMPK;numberOfVariables;LLNni;2|
        ((|lp| |List| P) (|lts| |List| TS) ($ |NonNegativeInteger|))
        (SPROG ((|lv| (|List| V)) (#1=#:G159 NIL) (|ts| NIL))
               (SEQ
                (LETT |lv|
...
(SDEFUN |RSDCMPK;algebraicDecompose;PTSBR;3|
        ...
        (SPROG
         ((|llpwt| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (#1=#:G184 NIL) (|vs| NIL) (#2=#:G183 NIL) (|f| NIL)
          (|lus| (|List| TS)) (|lsfp| (|List| P)) (|b| (|Boolean|)) (|h| (P))
          (|lts| (|List| TS)) (|us| (TS)) (|g| (P)) (#3=#:G182 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v| (P)) (#4=#:G162 NIL) (|ts_v+| (TS)) (|ts_v-| (TS))
...
(SDEFUN |RSDCMPK;printInfo;LNniV;11|
        ...
        (SPROG
         ((|s| (|String|)) (|m| (|NonNegativeInteger|)) (#1=#:G253 NIL)
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
         (SEQ
...
(SDEFUN |RSDCMPK;upDateBranches;LLLRNniL;13|
        ...
        (SPROG
         ((|branches|
          ...
          (#2=#:G292 NIL) (|us| (TS)) (|branches1| (|List| #1#))
          (|newleq| (|List| P)) (#3=#:G291 NIL) (|branch| NIL)
...
(DEFUN |RegularSetDecompositionPackage| (&REST #1=#:G293)
  (SPROG NIL
         (PROG (#2=#:G294)
           (RETURN
            (COND
