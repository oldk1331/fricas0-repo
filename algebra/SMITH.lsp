...
(SDEFUN |SMITH;test1|
        ...
        (SPROG ((|km| #1#) (#2=#:G120 NIL) (|m0| (|Integer|)))
               (SEQ
                (EXIT
...
(SDEFUN |SMITH;test2|
        ((|sm| M) (|b| |Col|) (|n1| |NonNegativeInteger|) (|dk| |Integer|)
         ($ |Union| |Col| "failed"))
        (SPROG
         ((|sol| (|List| R)) (#1=#:G135 NIL) (|k| NIL) (#2=#:G133 NIL)
          (|c| (|Union| R "failed")) (#3=#:G134 NIL) (|m0| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |SMITH;findEqMat|
        ...
        (SPROG
         ((#1=#:G206 NIL) (|u1| (|Matrix| (|Fraction| R))) (#2=#:G188 NIL)
          (#3=#:G198 NIL) (#4=#:G197 (R)) (#5=#:G199 (R)) (#6=#:G217 NIL)
          (|k| NIL) (|j0| (|NonNegativeInteger|)) (|tjj| (R)) (#7=#:G216 NIL)
          (|j| (|NonNegativeInteger|)) (#8=#:G215 NIL) (|i| NIL) (|t11| (R))
          (|mm| (M)) (|t1| (M)) (|u| (M)) (|mmh| (M)) (#9=#:G212 NIL)
          (#10=#:G181 NIL) (#11=#:G180 #12=(|Boolean|)) (#13=#:G182 #12#)
          (#14=#:G214 NIL) (#15=#:G178 NIL) (#16=#:G177 #12#) (#17=#:G179 #12#)
          (#18=#:G213 NIL) (|n1| (|NonNegativeInteger|))
...
(SDEFUN |SMITH;diophantineSystem;MColR;18|
        ((|m| M) (|b| |Col|)
         ($ |Record| (|:| |particular| (|Union| |Col| "failed"))
          (|:| |basis| (|List| |Col|))))
        (SPROG
         ((|lsol| (|List| |Col|)) (#1=#:G246 NIL) (|i| NIL) (#2=#:G245 NIL)
...
(DEFUN |SmithNormalForm| (&REST #1=#:G247)
  (SPROG NIL
         (PROG (#2=#:G248)
           (RETURN
            (COND
