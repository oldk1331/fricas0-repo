...
(SDEFUN |GDMP;maxNorm| ((|p| ($)) ($ (R)))
        (SPROG ((|m| (R)) (#1=#:G210 NIL) (|r| NIL) (|l| (|List| R)))
...
(DEFUN |GeneralDistributedMultivariatePolynomial| (&REST #1=#:G368)
  (SPROG NIL
         (PROG (#2=#:G369)
           (RETURN
            (COND
...
(DEFUN |GeneralDistributedMultivariatePolynomial;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G367 NIL) (|pv$| NIL) (#2=#:G360 NIL) (#3=#:G361 NIL) (#4=#:G362 NIL)
    (#5=#:G363 NIL) (#6=#:G364 NIL) (#7=#:G365 NIL) (#8=#:G366 NIL) ($ NIL)
