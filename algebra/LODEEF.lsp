...
(SDEFUN |LODEEF;homosolve1|
        ((|oper| (L)) (|sols| (|List| F)) (|k| (|Kernel| F)) (|x| (|Symbol|))
         ($ (|List| F)))
        (SPROG
         ((#1=#:G278 NIL) (|e| NIL) (#2=#:G277 NIL) (|int| (|List| F))
          (#3=#:G276 NIL) (|h| NIL) (#4=#:G275 NIL)
          (|rec| (|Record| (|:| |eq| L) (|:| |op| (|List| F))))
          (|n| (|NonNegativeInteger|)) (#5=#:G264 NIL))
         (SEQ
          (COND
           ((ZEROP
             (LETT |n|
...
(SDEFUN |LODEEF;kovode|
        ((|op|
         ...
         (|k| (|Kernel| F)) (|x| (|Symbol|)) ($ (|List| F)))
        (SPROG
         ((|y2| (F)) (|y1| (F)) (#1=#:G305 NIL) (|e| NIL) (#2=#:G304 NIL)
          (|zp| (|List| F)) (|lc| (|List| F)) (#3=#:G303 NIL) (|crf| NIL)
          (#4=#:G302 NIL)
...
(SDEFUN |LODEEF;solve;LFSFLU;20|
        ((|op| (L)) (|g| (F)) (|x| (|Symbol|)) (|a| (F)) (|y0| (|List| F))
         ($ (|Union| F "failed")))
        (SPROG
         ((|hp| (F)) (#1=#:G355 NIL) (|f| NIL) (|i| NIL) (|s| (|Vector| F))
          (|sol| (|Union| (|Vector| F) "failed")) (|h| (F)) (#2=#:G353 NIL)
          (#3=#:G354 NIL) (|yy| NIL) (|kx| (|Kernel| F)) (|v| (|Vector| F))
...
(DEFUN |ElementaryFunctionLODESolver| (&REST #1=#:G371)
  (SPROG NIL
         (PROG (#2=#:G372)
           (RETURN
            (COND
