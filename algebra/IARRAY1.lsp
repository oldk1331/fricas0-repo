...
(SDEFUN |IARRAY1;map!;M2%;6| ((|f| (|Mapping| S S)) (|s1| (%)) (% (%)))
        (SPROG ((#1=#:G893 NIL) (|i| NIL) (|n| (|Integer|)))
...
(SDEFUN |IARRAY1;map;M2%;7| ((|f| (|Mapping| S S)) (|s1| (%)) (% (%)))
        (SPROG ((#1=#:G899 NIL) (|i| NIL) (|ss2| (%)) (|n| (|Integer|)))
               (SEQ (LETT |n| (QVMAXINDEX |s1|))
                    (EXIT
                     (COND ((< |n| 0) |s1|)
                           ('T
...
(SDEFUN |IARRAY1;map;M3%;8|
        ((|f| (|Mapping| S S S)) (|a| (%)) (|b| (%)) (% (%)))
        (SPROG ((#1=#:G906 NIL) (|i| NIL) (|c| (%)) (|maxind| (|Integer|)))
...
(DEFUN |IndexedOneDimensionalArray| (&REST #1=#:G949)
  (SPROG NIL
         (PROG (#2=#:G950)
           (RETURN
            (COND
...
(DEFUN |IndexedOneDimensionalArray;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G946 NIL) (#2=#:G947 NIL) (#3=#:G948 NIL) (% NIL)
...
(MAKEPROP '|IndexedOneDimensionalArray| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|HashState|) (0 . |hashUpdate!|) (6 . |hashUpdate!|) '#:G877
