...
(DEFUN |IndexedOneDimensionalArray| (&REST #1=#:G1196)
  (SPROG NIL
         (PROG (#2=#:G1197)
           (RETURN
            (COND
...
(DEFUN |IndexedOneDimensionalArray;| (|#1| |#2|)
  (SPROG
   ((#1=#:G1195 NIL) (|pv$| NIL) (#2=#:G1191 NIL) (#3=#:G1192 NIL)
    (#4=#:G1193 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|IndexedOneDimensionalArray| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|HashState|) (0 . |hashUpdate!|) (6 . |hashUpdate!|) '#:G1130
