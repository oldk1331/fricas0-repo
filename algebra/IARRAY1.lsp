...
(SDEFUN |IARRAY1;map!;M2$;6| ((|f| |Mapping| S S) (|s1| $) ($ $))
        (SPROG ((#1=#:G1154 NIL) (|i| NIL) (|n| (|Integer|)))
...
(SDEFUN |IARRAY1;map;M2$;7| ((|f| |Mapping| S S) (|s1| $) ($ $))
        (SPROG ((#1=#:G1159 NIL) (|i| NIL) (|ss2| ($)) (|n| (|Integer|)))
...
(SDEFUN |IARRAY1;map;M3$;8| ((|f| |Mapping| S S S) (|a| $) (|b| $) ($ $))
        (SPROG ((#1=#:G1165 NIL) (|i| NIL) (|c| ($)) (|maxind| (|Integer|)))
               (SEQ
...
(DEFUN |IndexedOneDimensionalArray| (&REST #1=#:G1207)
  (SPROG NIL
         (PROG (#2=#:G1208)
           (RETURN
            (COND
...
(DEFUN |IndexedOneDimensionalArray;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G1204 NIL) (#2=#:G1205 NIL) (#3=#:G1206 NIL) ($ NIL)
...
(MAKEPROP '|IndexedOneDimensionalArray| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|HashState|) (0 . |hashUpdate!|) (6 . |hashUpdate!|) '#:G1140
