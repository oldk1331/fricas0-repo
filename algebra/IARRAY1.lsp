...
(SDEFUN |IARRAY1;map!;M2$;6| ((|f| |Mapping| S S) (|s1| $) ($ $))
        (SPROG ((#1=#:G1008 NIL) (|i| NIL) (|n| (|Integer|)))
...
(SDEFUN |IARRAY1;map;M2$;7| ((|f| |Mapping| S S) (|s1| $) ($ $))
        (SPROG ((#1=#:G1013 NIL) (|i| NIL) (|ss2| ($)) (|n| (|Integer|)))
               (SEQ (LETT |n| (QVMAXINDEX |s1|))
                    (EXIT
                     (COND ((< |n| 0) |s1|)
                           ('T
...
(SDEFUN |IARRAY1;map;M3$;8| ((|f| |Mapping| S S S) (|a| $) (|b| $) ($ $))
        (SPROG ((#1=#:G1019 NIL) (|i| NIL) (|c| ($)) (|maxind| (|Integer|)))
...
(DEFUN |IndexedOneDimensionalArray| (&REST #1=#:G1061)
  (SPROG NIL
         (PROG (#2=#:G1062)
           (RETURN
            (COND
...
(DEFUN |IndexedOneDimensionalArray;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G1058 NIL) (#2=#:G1059 NIL) (#3=#:G1060 NIL) ($ NIL)
...
(MAKEPROP '|IndexedOneDimensionalArray| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|HashState|) (0 . |hashUpdate!|) (6 . |hashUpdate!|) '#:G994
