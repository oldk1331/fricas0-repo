...
(DEFUN |RecursivePolynomialCategory| (&REST #1=#:G262)
  (LET (#2=#:G263)
    (COND
     ((SETQ #2#
                             ...
                             (|Join|
                              ...
                              (|mkCategory|
                               '(((|mvar| (|t#3| $)) T)
                                 ...
                                 ((|supRittWu?| ((|Boolean|) $ $)) T)
                                 ((|reduced?| ((|Boolean|) $ $)) T)
                                 ((|reduced?| ((|Boolean|) $ (|List| $))) T)
                                 ((|headReduced?| ((|Boolean|) $ $)) T)
                                 ((|headReduced?| ((|Boolean|) $ (|List| $)))
                                  T)
