...
(SDEFUN |MAMA;fill_diagonal|
        ((B M) (A M) (|nr| |NonNegativeInteger|) (|nc| |NonNegativeInteger|)
         (|n| |Integer|) ($ |Void|))
        (SPROG
         ((#1=#:G139 NIL) (|i| NIL) (|sc| (|Integer|)) (|sr| (|Integer|))
          (|dl| (|Integer|)))
         (SEQ
          (COND
...
(SDEFUN |MAMA;bandMatrix;MLM;11| ((A M) (|ln| |List| (|Integer|)) ($ M))
        (SPROG
         ((#1=#:G146 NIL) (|n| NIL) (B (M)) (|nc| (|NonNegativeInteger|))
...
(SDEFUN |MAMA;subMatrix;M2LM;13|
        ...
        (SPROG
         ((#1=#:G154 NIL) (|j| NIL) (#2=#:G155 NIL) (|jj| NIL) (#3=#:G152 NIL)
          (|i| NIL) (#4=#:G153 NIL) (|ii| NIL) (|res| (M)) (|minC| (|Integer|))
...
(SDEFUN |MAMA;blockSplit;MLPiL;15|
        ((A M) (|lr| |List| (|NonNegativeInteger|)) (|nc| |PositiveInteger|)
         ($ |List| (|List| M)))
        (SPROG ((#1=#:G160 NIL) (X NIL) (#2=#:G159 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |MAMA;blockSplit;MPiLL;16|
        ((A M) (|nr| |PositiveInteger|) (|lc| |List| (|NonNegativeInteger|))
         ($ |List| (|List| M)))
        (SPROG ((#1=#:G164 NIL) (X NIL) (#2=#:G163 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(DEFUN |MatrixManipulation| (&REST #1=#:G165)
  (SPROG NIL
         (PROG (#2=#:G166)
           (RETURN
            (COND
