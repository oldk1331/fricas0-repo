...
(SDEFUN |MAMA;fill_diagonal|
        ...
        (SPROG
         ((#1=#:G140 NIL) (|i| NIL) (|sc| (|Integer|)) (|sr| (|Integer|))
          (|dl| (|Integer|)))
         (SEQ
          (COND
...
(SDEFUN |MAMA;bandMatrix;MLM;11| ((A (M)) (|ln| (|List| (|Integer|))) ($ (M)))
        (SPROG
         ((#1=#:G148 NIL) (|n| NIL) (B (M)) (|nc| (|NonNegativeInteger|))
...
(SDEFUN |MAMA;subMatrix;M2LM;13|
        ((A (M)) (|lr| (|List| (|Integer|))) (|lc| (|List| (|Integer|)))
         ($ (M)))
        (SPROG
         ((#1=#:G158 NIL) (|j| NIL) (#2=#:G159 NIL) (|jj| NIL) (#3=#:G156 NIL)
          (|i| NIL) (#4=#:G157 NIL) (|ii| NIL) (|res| (M)) (|minC| (|Integer|))
...
(SDEFUN |MAMA;blockSplit;MLPiL;15|
        ...
        (SPROG ((#1=#:G165 NIL) (X NIL) (#2=#:G164 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(DEFUN |MatrixManipulation| (&REST #1=#:G171)
  (SPROG NIL
         (PROG (#2=#:G172)
           (RETURN
            (COND
