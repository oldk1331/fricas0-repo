...
(SDEFUN |INBFF;^;VIV;2|
        ...
        (SPROG
         ((|mult| (|Integer|)) (|k| (|SingleInteger|))
          ...
          (|e| (|NonNegativeInteger|)) (#1=#:G131 NIL) (#2=#:G130 NIL))
         (SEQ
          (LETT |e|
                (PROG1
                    (LETT #1#
...
(SDEFUN |INBFF;dAndcExp;VNniSiV;4|
        ...
        (SPROG
         ((|i| #1#) (|erg| (|Vector| GF)) (#2=#:G159 NIL) (|j| NIL)
          (|ex| (|Integer|)) (|l| (|List| (|NonNegativeInteger|)))
          (|plist| (|List| (|Vector| GF))) (|b| (|Vector| GF)) (#3=#:G158 NIL)
          (|qk| (|Integer|)))
...
(SDEFUN |INBFF;*;3V;5|
        ...
        (SPROG
         ((|k| (|SingleInteger|)) (|x| (|SingleInteger|)) (|y| (GF))
          (#1=#:G179 NIL) (|t| NIL) (#2=#:G178 NIL) (|j| NIL) (#3=#:G177 NIL)
          (|i| NIL) (#4=#:G176 NIL) (#5=#:G175 NIL) (|erg| (|Vector| GF))
          (|e| (|SingleInteger|)))
...
(SDEFUN |INBFF;lookup;VPi;6| ((|x| (|Vector| GF)) ($ (|PositiveInteger|)))
        (SPROG ((#1=#:G183 NIL) (#2=#:G182 NIL) (|erg| (|Integer|)) (|j| NIL))
               (SEQ (LETT |erg| 0)
...
(SDEFUN |INBFF;expPot;V2SiV;8|
        ...
        (SPROG
         ((|qpot| #1#) (|erg| #2=(|Vector| GF)) (|k2| #1#) (|y| #2#)
          (#3=#:G200 NIL) (|k| NIL) (|deg| (|SingleInteger|)))
...
(SDEFUN |INBFF;qPot;VIV;9|
        ...
        (SPROG
         ((#1=#:G209 NIL) (|i| NIL) (#2=#:G208 NIL) (|e1| (|Vector| GF))
...
(SDEFUN |INBFF;trace;VPiV;10|
        ((|a| (|Vector| GF)) (|d| (|PositiveInteger|)) ($ (|Vector| GF)))
        (SPROG
         ((#1=#:G219 NIL) (|j| NIL) (#2=#:G218 NIL) (|i| NIL)
...
(SDEFUN |INBFF;minimalPolynomial;VSup;16|
        ...
        (SPROG
         ((|v| (|Vector| GF)) (|y| (|Vector| GF)) (#1=#:G242 NIL) (|k| NIL)
          (#2=#:G241 NIL) (|j| NIL) (|dy| #3=(|NonNegativeInteger|))
          (#4=#:G240 NIL) (|i| NIL) (|m| (|Matrix| GF)) (|dx| #3#))
...
(SDEFUN |INBFF;basis;PiV;17|
        ...
        (SPROG
         ((|uniti| (|Vector| GF)) (#1=#:G248 NIL) (|i| NIL)
...
(SDEFUN |INBFF;index;2PiV;19|
        ((|degm| (|PositiveInteger|)) (|n| (|PositiveInteger|))
         ($ (|Vector| GF)))
        (SPROG
         ((|m| (|Integer|)) (#1=#:G256 NIL) (|j| NIL) (|erg| (|Vector| GF)))
...
(SDEFUN |INBFF;pol;VSup;20|
        ((|x| (|Vector| GF)) ($ (|SparseUnivariatePolynomial| GF)))
        (SPROG
         ((#1=#:G258 NIL) (#2=#:G257 #3=(|SparseUnivariatePolynomial| GF))
          (#4=#:G259 #3#) (#5=#:G260 NIL) (#6=#:G262 NIL) (|i| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(DEFUN |InnerNormalBasisFieldFunctions| (#1=#:G263)
  (SPROG NIL
         (PROG (#2=#:G264)
           (RETURN
            (COND
