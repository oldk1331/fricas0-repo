...
(SDEFUN |INBFF;dAndcExp;VNniSiV;4|
        ...
        (SPROG
         ((|i| #1#) (|erg| (|Vector| GF)) (#2=#:G160 NIL) (|j| NIL)
          (|ex| (|Integer|)) (|l| (|List| (|NonNegativeInteger|)))
          (|plist| (|List| (|Vector| GF))) (|b| (|Vector| GF)) (#3=#:G159 NIL)
          (|qk| (|Integer|)))
...
(SDEFUN |INBFF;*;3V;5|
        ...
        (SPROG
         ((|k| (|SingleInteger|)) (|x| (|SingleInteger|)) (|y| (GF))
          (#1=#:G180 NIL) (|t| NIL) (#2=#:G179 NIL) (|j| NIL) (#3=#:G178 NIL)
          (|i| NIL) (#4=#:G177 NIL) (#5=#:G176 NIL) (|erg| (|Vector| GF))
          (|e| (|SingleInteger|)))
...
(SDEFUN |INBFF;lookup;VPi;6| ((|x| (|Vector| GF)) (% (|PositiveInteger|)))
        (SPROG ((#1=#:G184 NIL) (#2=#:G183 NIL) (|erg| (|Integer|)) (|j| NIL))
               (SEQ (LETT |erg| 0)
...
(SDEFUN |INBFF;expPot;V2SiV;8|
        ...
        (SPROG
         ((|qpot| #1#) (|erg| #2=(|Vector| GF)) (|k2| #1#) (|y| #2#)
          (#3=#:G201 NIL) (|k| NIL) (|deg| (|SingleInteger|)))
...
(SDEFUN |INBFF;qPot;VIV;9|
        ...
        (SPROG
         ((#1=#:G210 NIL) (|i| NIL) (#2=#:G209 NIL) (|e1| (|Vector| GF))
...
(SDEFUN |INBFF;random;PiV;11| ((|n| (|PositiveInteger|)) (% (|Vector| GF)))
        (SPROG ((#1=#:G225 NIL) (|i| NIL) (|v| (|Vector| GF)))
...
(SDEFUN |INBFF;minimalPolynomial;VSup;16|
        ...
        (SPROG
         ((|v| (|Vector| GF)) (|y| (|Vector| GF)) (#1=#:G243 NIL) (|k| NIL)
          (#2=#:G242 NIL) (|j| NIL) (|dy| #3=(|NonNegativeInteger|))
          (#4=#:G241 NIL) (|i| NIL) (|m| (|Matrix| GF)) (|dx| #3#))
...
(SDEFUN |INBFF;basis;PiV;17|
        ...
        (SPROG
         ((|uniti| (|Vector| GF)) (#1=#:G249 NIL) (|i| NIL)
...
(SDEFUN |INBFF;index;2PiV;19|
        ((|degm| (|PositiveInteger|)) (|n| (|PositiveInteger|))
         (% (|Vector| GF)))
        (SPROG
         ((|m| (|Integer|)) (#1=#:G257 NIL) (|j| NIL) (|erg| (|Vector| GF)))
...
(SDEFUN |INBFF;pol;VSup;20|
        ((|x| (|Vector| GF)) (% (|SparseUnivariatePolynomial| GF)))
        (SPROG
         ((#1=#:G259 NIL) (#2=#:G258 #3=(|SparseUnivariatePolynomial| GF))
          (#4=#:G260 #3#) (#5=#:G261 NIL) (#6=#:G263 NIL) (|i| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(DEFUN |InnerNormalBasisFieldFunctions| (#1=#:G264)
  (SPROG NIL
         (PROG (#2=#:G265)
           (RETURN
            (COND
