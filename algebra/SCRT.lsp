...
(SDEFUN |SCRT;Pnan?;$B;9| ((|p| ($)) ($ (|Boolean|)))
        (SPROG ((#1=#:G138 NIL) (#2=#:G139 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |SCRT;unitVector;2$;11| ((|p| ($)) ($ ($)))
        (SPROG
         ((#1=#:G148 NIL) (|i| NIL) (|pt| ($)) (|factor| (|DoubleFloat|))
          (#2=#:G147 NIL))
         (SEQ (LETT |factor| 0.0)
              (SEQ (LETT |i| 0) (LETT #2# (- (QREFELT $ 6) 1)) G190
                   (COND ((|greater_SI| |i| #2#) (GO G191)))
...
(SDEFUN |SCRT;distanceSquared;2$Df;12|
        ((|p1| ($)) (|p2| ($)) ($ (|DoubleFloat|)))
        (SPROG ((|factor| (|DoubleFloat|)) (#1=#:G153 NIL) (|i| NIL))
               (SEQ (LETT |factor| 0.0)
                    (SEQ (LETT |i| 0) (LETT #1# (- (QREFELT $ 6) 1)) G190
                         (COND ((|greater_SI| |i| #1#) (GO G191)))
                         (SEQ
...
(SDEFUN |SCRT;screenCoords;$L;21| ((|pt| ($)) ($ (|List| (|DoubleFloat|))))
        (SPROG ((|res| (|List| (|DoubleFloat|))) (#1=#:G189 NIL) (|i| NIL))
               (SEQ (LETT |res| NIL)
                    (SEQ (LETT |i| 0) (LETT #1# (- (QREFELT $ 6) 1)) G190
                         (COND ((|greater_SI| |i| #1#) (GO G191)))
                         (SEQ
...
(SDEFUN |SCRT;=;2$B;28| ((|x| ($)) (|y| ($)) ($ (|Boolean|)))
        (SPROG ((#1=#:G209 NIL) (#2=#:G210 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |i| 0) (LETT #2# (+ (QREFELT $ 6) 1)) G190
...
(SDEFUN |SCRT;coerce;$Of;30| ((|pt| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|eles| (|List| (|OutputForm|))) (#1=#:G219 NIL) (|i| NIL)
          (#2=#:G218 NIL) (|s| (|Symbol|)))
         (SEQ (LETT |s| '|proj|)
              (COND
