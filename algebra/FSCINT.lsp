...
(SDEFUN |FSCINT;internalIntegrate;FSIr;7|
        ((|f| F) (|x| |Symbol|) ($ |IntegrationResult| F))
        (SPROG
         ((|g| (F)) (|h| (|Expression| (|Complex| R))) (#1=#:G152 NIL)
          (|k| NIL) (#2=#:G151 NIL) (#3=#:G150 NIL) (#4=#:G149 NIL))
         (SEQ
          (LETT |f|
...
(DEFUN |FunctionSpaceComplexIntegration| (&REST #1=#:G153)
  (SPROG NIL
         (PROG (#2=#:G154)
           (RETURN
            (COND
...
(MAKEPROP '|FunctionSpaceComplexIntegration| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'RTRIG
              ...
              |FSCINT;complexIntegrate;FSF;2| '#:G119
