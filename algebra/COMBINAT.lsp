...
(SDEFUN |COMBINAT;partition;2I;1| ((|n| (I)) (% (I)))
        (SPROG
         ((|m| (|NonNegativeInteger|)) (#1=#:G20 NIL) (|i| NIL) (#2=#:G34 NIL)
          (|k| NIL) (|l| (|Integer|)) (|u| (|Integer|)) (#3=#:G33 NIL)
          (|t| (I)) (|s| (I)))
         (SEQ
          (COND
...
(SDEFUN |COMBINAT;factorial;2I;3| ((|n| (I)) (% (I)))
        (SPROG
         ((|#G10| (|Record| (|:| |Fn| I) (|:| |Fv| I))) (|s| (I)) (|k| NIL)
          (#1=#:G57 NIL) (|t| (I)) (|f| (I)))
         (SEQ
          (COND
           ((SPADCALL |n| (|spadConstant| % 7) (QREFELT % 24))
...
(SDEFUN |COMBINAT;binomial;3I;4| ((|n| (I)) (|m| (I)) (% (I)))
        (SPROG
         ((|#G17| (I)) (|#G18| (I)) (#1=#:G69 NIL) (|#G19| (I)) (|#G20| (I))
          (|s| (I)) (|k| NIL) (#2=#:G70 NIL) (|b| (I)))
         (SEQ
          (EXIT
           (COND
            ((OR
                  ...
                  (COND
                   ((SPADCALL (QVELT (QREFELT % 10) 1)
                    ...
                    (SEQ
                     ...
                     (EXIT
                      (PROGN
                       (LETT #1# (QSETVELT (QREFELT % 10) 2 |b|))
                       (GO #4=#:G68)))))
                ...
                (SEQ
                 (LETT |k|
                       (SPADCALL
                        (SPADCALL |s| (|spadConstant| % 8) (QREFELT % 28))
                        (QREFELT % 26)))
                 (LETT #2# (SPADCALL |m| (QREFELT % 26))) G190
                 (COND ((> |k| #2#) (GO G191)))
                 (SEQ
                  (EXIT
                   (LETT |b|
...
(SDEFUN |COMBINAT;multinomial;ILI;5| ((|n| (I)) (|m| (|List| I)) (% (I)))
        (SPROG
         ((#1=#:G83 NIL) (#2=#:G82 NIL) (#3=#:G81 NIL) (#4=#:G0 NIL)
          (#5=#:G84 NIL) (#6=#:G75 (I)) (#7=#:G73 (I)) (#8=#:G74 NIL) (|t| NIL)
          (#9=#:G85 NIL) (|s| (I)))
         (SEQ
          (EXIT
           (SEQ
                                ...
                                (EXIT
                                 (PROGN
                                  ...
                                  (COND
                                   (#8#
                                    (LETT #7#
                                          (SPADCALL #7# #6# (QREFELT % 28))))
                                   ('T
                                    (PROGN (LETT #7# #6#) (LETT #8# 'T)))))))
                               (LETT #5# (CDR #5#)) (GO G190) G191 (EXIT NIL))
                          (COND (#8# #7#) (#12='T (|spadConstant| % 7))))
                         (QREFELT % 24))
               (|spadConstant| % 7))
              (#12#
               (SEQ (LETT |s| (|spadConstant| % 8))
...
(SDEFUN |COMBINAT;stirling1;3I;7| ((|n| (I)) (|m| (I)) (% (I)))
        (SPROG
         ((#1=#:G94 NIL) (|x| (|SparseUnivariatePolynomial| I)) (|k| NIL)
          (#2=#:G102 NIL) (#3=#:G97 NIL))
         (SEQ
          (COND
...
(SDEFUN |COMBINAT;stirling2;3I;8| ((|n| (I)) (|m| (I)) (% (I)))
        (SPROG ((|k| NIL) (#1=#:G113 NIL) (|s| (I)) (#2=#:G108 NIL) (|t| (I)))
               (SEQ
                (COND
                 ((SPADCALL |n| (QREFELT % 52))
                  (COND
                ...
                (LETT |s|
                      (COND
                       ...
                       ('T (|spadConstant| % 8))))
                (LETT |t| (|spadConstant| % 7))
                (SEQ (LETT |k| 1) (LETT #1# (SPADCALL |m| (QREFELT % 26))) G190
