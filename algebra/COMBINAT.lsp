...
(SDEFUN |COMBINAT;partition;2I;1| ((|n| (I)) ($ (I)))
        (SPROG
         ((|s| (I)) (|t| (I)) (#1=#:G133 NIL) (|u| (|Integer|))
          (|l| (|Integer|)) (|k| NIL) (#2=#:G134 NIL) (|i| NIL) (#3=#:G120 NIL)
...
(SDEFUN |COMBINAT;distinct_partition;2I;2| ((|n| (I)) ($ (I)))
        (SPROG
         ((|s| (I)) (|t| (I)) (#1=#:G148 NIL) (|u| (|Integer|))
          (|l| (|Integer|)) (|l1| (|Integer|)) (|k| NIL) (#2=#:G149 NIL)
          (|i| NIL) (Q (|IndexedOneDimensionalArray| I (|Zero|)))
          (#3=#:G135 NIL) (|nz| (|Integer|)))
...
(SDEFUN |COMBINAT;binomial;3I;4| ((|n| (I)) (|m| (I)) ($ (I)))
        (SPROG
         ((|b| (I)) (#1=#:G170 NIL) (|k| NIL) (|s| (I)) (|#G20| (I))
          (|#G19| (I)) (#2=#:G169 NIL) (|#G18| (I)) (|#G17| (I)))
         (SEQ
          (EXIT
           (COND
            ((OR
...
(SDEFUN |COMBINAT;multinomial;ILI;5| ((|n| (I)) (|m| (|List| I)) ($ (I)))
        (SPROG
         ((|s| (I)) (#1=#:G185 NIL) (|t| NIL) (#2=#:G174 NIL) (#3=#:G173 (I))
          (#4=#:G175 (I)) (#5=#:G184 NIL) (#6=#:G104 NIL) (#7=#:G181 NIL)
          (#8=#:G182 NIL) (#9=#:G183 NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ
...
(SDEFUN |COMBINAT;permutation;3I;6| ((|n| (I)) (|m| (I)) ($ (I)))
        (SPROG ((|p| (I)) (|t| (I)) (#1=#:G191 NIL) (|k| NIL))
               (SEQ
                (COND
...
(SDEFUN |COMBINAT;stirling1;3I;7| ((|n| (I)) (|m| (I)) ($ (I)))
        (SPROG
         ((#1=#:G195 NIL) (#2=#:G200 NIL) (|k| NIL)
          (|x| (|SparseUnivariatePolynomial| I)) (#3=#:G192 NIL))
         (SEQ
          (COND
           ((OR
             (OR (SPADCALL |n| (|spadConstant| $ 7) (QREFELT $ 24))
...
(SDEFUN |COMBINAT;stirling2;3I;8| ((|n| (I)) (|m| (I)) ($ (I)))
        (SPROG ((|t| (I)) (#1=#:G204 NIL) (|s| (I)) (#2=#:G209 NIL) (|k| NIL))
               (SEQ
                (COND
                 ((OR
                   (OR (SPADCALL |n| (|spadConstant| $ 7) (QREFELT $ 24))
...
(DEFUN |IntegerCombinatoricFunctions| (#1=#:G214)
  (SPROG NIL
         (PROG (#2=#:G215)
           (RETURN
            (COND
