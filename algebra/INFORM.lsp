...
(SDEFUN |INFORM;flatten;2%;10| ((|s| (%)) (% (%)))
        (SPROG
         ((#1=#:G141 NIL) (|u| NIL) (#2=#:G140 NIL) (#3=#:G139 NIL)
          ...
          (|n| (|NonNegativeInteger|)) (#5=#:G137 NIL) (|l| (|List| %))
          (|x| NIL) (#6=#:G136 NIL) (|sy| (|Symbol|)))
         (SEQ
          (COND
...
(SDEFUN |INFORM;flatten0|
        ...
        (SPROG
         ((#1=#:G157 NIL) (|u| NIL) (#2=#:G156 NIL) (#3=#:G155 NIL)
          (#4=#:G154 NIL)
          (|l2| (|List| (|Record| (|:| |lst| (|List| %)) (|:| |symb| %))))
          (#5=#:G153 NIL) (|l| (|List| %)) (|x| NIL) (#6=#:G152 NIL) (|a| (%)))
         (SEQ
...
(SDEFUN |INFORM;unparse;%S;13| ((|x| (%)) (% (|String|)))
        (SPROG ((#1=#:G166 NIL) (|a| NIL) (#2=#:G165 NIL) (|s| (%)))
               (SEQ
                (COND
...
(SDEFUN |INFORM;tuplify| ((|l| (|List| (|Symbol|))) (% (%)))
        (SPROG ((#1=#:G180 NIL) (|x| NIL) (#2=#:G179 NIL))
               (SEQ
                (COND
...
(SDEFUN |INFORM;function;%LS%;20|
        ...
        (SPROG ((#1=#:G186 NIL) (|x| NIL) (#2=#:G185 NIL) (|nn| (%)))
               (SEQ
                (LETT |nn|
                      (SPADCALL
                       (SPADCALL (+ 1 (LENGTH |l|))
