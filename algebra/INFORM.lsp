...
(SDEFUN |INFORM;flatten;2$;10| ((|s| $) ($ $))
        (SPROG
         ((#1=#:G138 NIL) (|u| NIL) (#2=#:G137 NIL) (#3=#:G136 NIL)
          (#4=#:G135 NIL)
          (|l2| (|List| (|Record| (|:| |lst| (|List| $)) (|:| |symb| $))))
          (|n| (|NonNegativeInteger|)) (#5=#:G134 NIL) (|l| (|List| $))
          (|x| NIL) (#6=#:G133 NIL) (|sy| (|Symbol|)))
         (SEQ
          (COND
...
(SDEFUN |INFORM;flatten0|
        ...
        (SPROG
         ((#1=#:G151 NIL) (|u| NIL) (#2=#:G150 NIL) (#3=#:G149 NIL)
          (#4=#:G148 NIL)
          (|l2| (|List| (|Record| (|:| |lst| (|List| $)) (|:| |symb| $))))
          (#5=#:G147 NIL) (|l| (|List| $)) (|x| NIL) (#6=#:G146 NIL) (|a| ($)))
         (SEQ
...
(SDEFUN |INFORM;unparse;$S;13| ((|x| $) ($ |String|))
        (SPROG ((#1=#:G159 NIL) (|a| NIL) (#2=#:G158 NIL) (|s| ($)))
               (SEQ
                (COND
...
(SDEFUN |INFORM;tuplify| ((|l| |List| (|Symbol|)) ($ $))
        (SPROG ((#1=#:G172 NIL) (|x| NIL) (#2=#:G171 NIL))
               (SEQ
                (COND
...
(SDEFUN |INFORM;function;$LS$;20|
        ...
        (SPROG ((#1=#:G177 NIL) (|x| NIL) (#2=#:G176 NIL) (|nn| ($)))
               (SEQ
                (LETT |nn|
                      (SPADCALL
                       (SPADCALL (+ 1 (LENGTH |l|))
        ...
        (SEQ
         (COND
          ((SPADCALL |s1| (|spadConstant| $ 9) (QREFELT $ 61))
           (COND
            ((SPADCALL |n| 0 (QREFELT $ 64)) (EXIT (|spadConstant| $ 9))))))
         (COND
...
(MAKEPROP '|InputForm| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|SExpression|) '|Rep| (|Integer|)
              ...
              |INFORM;+;3$;21| |INFORM;*;3$;22| (145 . >) |INFORM;^;$I$;23|
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 67
                                            '(1 0 0 7 8 1 14 13 0 15 1 5 0 17
                                              ...
                                              0 59 2 0 26 0 0 61 2 7 26 0 0 64
                                              1 0 39 0 47 1 0 26 0 44 1 0 14 0
                                              45 1 0 26 0 42 1 0 39 0 43 1 0 0
                                              39 48 2 0 0 0 19 20 1 0 21 0 22 3
                                              0 0 0 19 14 60 1 0 0 0 38 1 0 17
                                              0 28 1 0 14 17 49 1 0 0 5 12 1 0
                                              5 0 11 1 0 0 23 25 1 0 0 7 8 1 0
                                              0 14 16 1 0 0 17 56 2 0 14 14 17
                                              52 1 0 0 0 51 1 0 0 0 50 2 0 0 0
                                              17 57 1 0 26 0 27 2 0 0 0 53 66 2
                                              0 0 0 7 65 0 0 0 9 0 0 0 10 2 0
                                              26 0 0 61 2 0 0 0 0 67 2 0 0 0 0
                                              62 2 0 0 0 0 63)))))
           '|lookupIncomplete|)) 
