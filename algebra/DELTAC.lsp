...
(SDEFUN |DELTAC;dim1todim0|
        ((|dim1| (|List| (|List| (|Integer|)))) (|n| #1=(|NonNegativeInteger|))
         (% (|List| (|List| (|Integer|)))))
        (SPROG
         ((|res| (|List| (|List| (|Integer|)))) (#2=#:G145 NIL) (|x| NIL)
          (#3=#:G144 NIL) (|m3| (|NonNegativeInteger|)) (#4=#:G131 NIL)
          (#5=#:G143 NIL) (|m2| NIL) (#6=#:G142 NIL) (|smp| NIL)
          (|pointsUsed| (|List| (|Boolean|))) (|m| #1#) (#7=#:G125 NIL)
          (#8=#:G141 NIL) (#9=#:G140 NIL))
         (SEQ (LETT |m| |n|)
...
(SDEFUN |DELTAC;deltaComplex;FscB%;4|
        ...
        (SPROG
         ((|vs| #1=(|List| VS)) (|previousFaceList| (|List| (|OrientedFacet|)))
          ...
          (|newIndexes| (|List| (|Integer|))) (|i| (|Integer|)) (#2=#:G195 NIL)
          (|oldFaceLow| NIL) (|oldFacesLow| (|List| (|OrientedFacet|)))
          (#3=#:G194 NIL) (|oldFaceHigh| NIL) (#4=#:G193 NIL) (|x| NIL)
          (#5=#:G192 NIL) (|m3| (|NonNegativeInteger|)) (#6=#:G164 NIL)
          (#7=#:G191 NIL) (|m2| NIL) (#8=#:G190 NIL) (|smp| NIL)
          (|pointsUsed| (|List| (|Boolean|))) (|m| #9=(|NonNegativeInteger|))
          (#10=#:G158 NIL) (#11=#:G189 NIL) (#12=#:G188 NIL)
          (|map2| (|List| (|List| (|Integer|)))) (|fm| (|List| (|Integer|)))
          (#13=#:G187 NIL) (#14=#:G185 NIL) (|gradeList| NIL) (#15=#:G186 NIL)
          (|grn| NIL) (|allFacetsGraded| (|List| (|List| (|OrientedFacet|))))
          (#16=#:G184 NIL) (|l| NIL) (#17=#:G183 NIL)
...
(SDEFUN |DELTAC;deltaComplex;Fcc%;5|
        ...
        (SPROG
         ((|fp| (|List| (|List| (|List| (|Integer|)))))
          ...
          (|faceMaps| (|List| (|List| (|List| (|Integer|)))))
          (|map1| (|List| (|List| (|Integer|))))
          (|newIndexes| (|List| (|Integer|))) (|i| (|Integer|)) (#1=#:G217 NIL)
          (|oldFaceLow| NIL) (|oldFacesLow| (|List| (|CubicalFacet|)))
          (#2=#:G216 NIL) (|oldFaceHigh| NIL) (#3=#:G212 NIL) (#4=#:G214 NIL)
          (|gradeList| NIL) (#5=#:G215 NIL) (|grn| NIL)
              ...
              (SEQ (LETT |grn| 1) (LETT #5# (LENGTH |allFacetsGraded|))
                   ...
                   (SEQ
                    (EXIT
                     (COND
                      ((EQL |grn| 1)
                       (PROGN (LETT #3# |$NoValue|) (GO #7=#:G198)))
                      ('T
                       (SEQ (LETT |map1| NIL)
...
(SDEFUN |DELTAC;faceMap;%NniL;8|
        ((|s| (%)) (|n| (|NonNegativeInteger|))
         (% (|List| (|List| (|Integer|)))))
        (SPROG
         ((#1=#:G225 NIL) (|maps1| (|List| (|List| (|List| (|Integer|))))))
         (SEQ
          (EXIT
...
(SDEFUN |DELTAC;chain;%Cc;9| ((|s| (%)) (% (|ChainComplex|)))
        (SPROG
         ((|res| (|List| (|Matrix| (|Integer|)))) (|m| (|Matrix| (|Integer|)))
          ...
          (|v2| (|Integer|)) (#1=#:G240 NIL) (|v| NIL) (#2=#:G238 NIL)
          (|u| NIL) (#3=#:G239 NIL) (|nu| NIL)
          (|n_cols| (|NonNegativeInteger|)) (#4=#:G237 NIL) (|faces| NIL)
...
(SDEFUN |DELTAC;oneSkeleton;%Ug;13|
        ...
        (SPROG
         ((|nodes|
          ...
          (|to1| #3=(|NonNegativeInteger|)) (|from1| #3#) (#4=#:G259 NIL)
...
(SDEFUN |DELTAC;fundamentalGroup;%2BGp;17|
        ((|s| (%)) (|simplify| (|Boolean|)) (|trace| (|Boolean|))
         (% (|GroupPresentation|)))
        (SPROG
         ((#1=#:G301 NIL) (|gp| (|GroupPresentation|))
          (|generators| (|List| (|NonNegativeInteger|))) (#2=#:G308 NIL)
          (|x| NIL) (|m| (|NonNegativeInteger|))
          (|rules| (|List| (|List| (|Integer|)))) (|rule| (|List| (|Integer|)))
          (#3=#:G307 NIL) (|vertn| NIL) (#4=#:G306 NIL) (|t| NIL)
          (|polygons| #5=(|List| (|List| (|Integer|)))) (#6=#:G304 NIL)
          (|edge| NIL) (#7=#:G305 NIL) (|edgen| NIL)
          (|edgesInTree| (|List| (|Boolean|))) (#8=#:G303 NIL) (|y| NIL)
          (#9=#:G302 NIL) (|res| (|List| (|List| (|Integer|)))) (|edges| #5#)
          (|span| (|Tree| (|Integer|)))
         ...
         (SEQ
          (EXIT
           (SEQ
            ...
            (COND ((NULL |simplify|) (PROGN (LETT #1# |gp|) (GO #10=#:G300))))
...
(SDEFUN |DELTAC;equalSimplex|
        ...
        (SPROG
         ((|offset| (|Integer|)) (#1=#:G317 NIL) (#2=#:G318 NIL) (|n| NIL)
...
(SDEFUN |DELTAC;=;2%B;19| ((|a| (%)) (|b| (%)) (% (|Boolean|)))
        (SPROG
         ((#1=#:G322 NIL) (|len| (|NonNegativeInteger|))
