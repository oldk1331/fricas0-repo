...
(SDEFUN |HTMLFORM;formatSpecial|
        ...
        (SPROG
         ((|tmp| (|Tree| (|String|))) (#1=#:G331 NIL) (|u| NIL)
          (#2=#:G330 NIL))
         (SEQ
          (COND
           ((QREFELT $ 21)
...
(SDEFUN |HTMLFORM;formatPlex|
        ((|op| (|Symbol|)) (|args| (|List| (|OutputForm|)))
         (|prec| (|Integer|)) ($ (|Tree| (|String|))))
        (SPROG
         ((#1=#:G356 NIL) (|s| (|Tree| (|String|))) (|n| (|Integer|))
          (|p| (|Integer|)))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |HTMLFORM;buildColumnTable|
        ...
        (SPROG
         ((|rows| (|List| (|Tree| (|String|)))) (#1=#:G381 NIL) (|i| NIL)
          (#2=#:G380 NIL) (|cells| (|List| (|Tree| (|String|))))
          (#3=#:G379 NIL) (|j| NIL) (#4=#:G378 NIL))
...
(SDEFUN |HTMLFORM;formatSub|
        ((|expr| (|OutputForm|)) (|args| (|List| (|OutputForm|)))
         (|opPrec| (|Integer|)) ($ (|Tree| (|String|))))
        (SPROG
         ((#1=#:G400 NIL) (#2=#:G402 NIL) (|e| NIL) (#3=#:G401 NIL)
...
(SDEFUN |HTMLFORM;formatNaryNoGroup|
        ((|op| (|String|)) (|args| (|List| (|OutputForm|)))
         (|prec| (|Integer|)) ($ (|Tree| (|String|))))
        (SPROG
         ((|tags| (|List| (|Tree| (|String|)))) (#1=#:G440 NIL) (|a| NIL)
...
(SDEFUN |HTMLFORM;formatHtml|
        ...
        (SPROG
         ((|op| (|Symbol|)) (|nargs| (|Integer|))
          ...
          (|str| (|String|)) (#1=#:G455 NIL) (|i| (|Integer|)))
         (SEQ
          (EXIT
           (SEQ
            (COND
