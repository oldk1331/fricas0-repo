...
(SDEFUN |MATRIX;swapRows!;$2I$;5|
        ((|x| $) (|i1| . #1=(|Integer|)) (|i2| . #1#) ($ $))
        (SPROG ((|t2| (R)) (|t1| (R)) (#2=#:G2163 NIL) (|j| NIL))
               (SEQ
                (COND
...
(SDEFUN |MATRIX;copy;2$;6| ((|m| $) ($ $))
        (SPROG
         ((#1=#:G2169 NIL) (|j| NIL) (#2=#:G2168 NIL) (|i| NIL) (|ans| ($)))
...
(SDEFUN |MATRIX;diagonalMatrix;V$;15| ((|v| |Vector| R) ($ $))
        (SPROG
         ((#1=#:G2190 NIL) (|i| NIL) (#2=#:G2191 NIL) (|j| NIL)
          (#3=#:G2192 NIL) (|k| NIL) (|ans| ($)) (|n| (|NonNegativeInteger|)))
         (SEQ (LETT |n| (QVSIZE |v|))
...
(DEFUN |Matrix;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G2202 NIL) (#2=#:G2203 NIL) (#3=#:G2204 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
