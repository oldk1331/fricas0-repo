...
(SDEFUN |MATRIX;swapRows!;$2I$;5|
        ((|x| $) (|i1| . #1=(|Integer|)) (|i2| . #1#) ($ $))
        (SPROG ((|t2| (R)) (|t1| (R)) (#2=#:G2086 NIL) (|j| NIL))
               (SEQ
                (COND
...
(SDEFUN |MATRIX;copy;2$;6| ((|m| $) ($ $))
        (SPROG
         ((#1=#:G2092 NIL) (|j| NIL) (#2=#:G2091 NIL) (|i| NIL) (|ans| ($)))
         (SEQ
...
(SDEFUN |MATRIX;diagonalMatrix;V$;14| ((|v| |Vector| R) ($ $))
        (SPROG
         ((#1=#:G2109 NIL) (|i| NIL) (#2=#:G2110 NIL) (|j| NIL)
          (#3=#:G2111 NIL) (|k| NIL) (|ans| ($)) (|n| (|NonNegativeInteger|)))
...
(DEFUN |Matrix;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G2120 NIL) (#2=#:G2121 NIL) (#3=#:G2122 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
