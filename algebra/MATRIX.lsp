...
(SDEFUN |MATRIX;swapRows!;$2I$;5|
        ((|x| $) (|i1| . #1=(|Integer|)) (|i2| . #1#) ($ $))
        (SPROG ((|t2| (R)) (|t1| (R)) (#2=#:G2105 NIL) (|j| NIL))
               (SEQ
                (COND
...
(SDEFUN |MATRIX;diagonalMatrix;V$;15| ((|v| |Vector| R) ($ $))
        (SPROG
         ((#1=#:G2132 NIL) (|i| NIL) (#2=#:G2133 NIL) (|j| NIL)
          (#3=#:G2134 NIL) (|k| NIL) (|ans| ($)) (|n| (|NonNegativeInteger|)))
...
(DEFUN |Matrix;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G2143 NIL) (#2=#:G2144 NIL) (#3=#:G2145 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
