...
(SDEFUN |MATRIX;swapRows!;$2I$;5|
        ((|x| $) (|i1| . #1=(|Integer|)) (|i2| . #1#) ($ $))
        (SPROG ((|t2| (R)) (|t1| (R)) (#2=#:G2075 NIL) (|j| NIL))
               (SEQ
                (COND
...
(SDEFUN |MATRIX;copy;2$;6| ((|m| $) ($ $))
        (SPROG
         ((#1=#:G2081 NIL) (|j| NIL) (#2=#:G2080 NIL) (|i| NIL) (|ans| ($)))
         (SEQ
...
(SDEFUN |MATRIX;diagonalMatrix;V$;14| ((|v| |Vector| R) ($ $))
        (SPROG
         ((#1=#:G2098 NIL) (|i| NIL) (#2=#:G2099 NIL) (|j| NIL)
          (#3=#:G2100 NIL) (|k| NIL) (|ans| ($)) (|n| (|NonNegativeInteger|)))
...
(DEFUN |Matrix;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G2109 NIL) (#2=#:G2110 NIL) (#3=#:G2111 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
