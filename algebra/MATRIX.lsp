...
(SDEFUN |MATRIX;copy;2%;6| ((|m| (%)) (% (%)))
        (SPROG
         ((#1=#:G2184 NIL) (|j| NIL) (#2=#:G2183 NIL) (|i| NIL) (|ans| (%)))
...
(SDEFUN |MATRIX;diagonalMatrix;V%;15| ((|v| (|Vector| R)) (% (%)))
        (SPROG
         ((#1=#:G2206 NIL) (|i| NIL) (#2=#:G2207 NIL) (|j| NIL)
          (#3=#:G2208 NIL) (|k| NIL) (|ans| (%)) (|n| (|NonNegativeInteger|)))
         (SEQ (LETT |n| (QVSIZE |v|))
...
(DEFUN |Matrix;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G2218 NIL) (#2=#:G2219 NIL) (#3=#:G2220 NIL) (% NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
