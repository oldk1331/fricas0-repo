...
(SDEFUN |MATRIX;swapRows!;$2I$;5|
        ((|x| $) (|i1| . #1=(|Integer|)) (|i2| . #1#) ($ $))
        (SPROG ((|t2| (R)) (|t1| (R)) (#2=#:G2221 NIL) (|j| NIL))
               (SEQ
                (COND
...
(SDEFUN |MATRIX;copy;2$;6| ((|m| $) ($ $))
        (SPROG
         ((#1=#:G2227 NIL) (|j| NIL) (#2=#:G2226 NIL) (|i| NIL) (|ans| ($)))
...
(SDEFUN |MATRIX;diagonalMatrix;V$;15| ((|v| |Vector| R) ($ $))
        (SPROG
         ((#1=#:G2248 NIL) (|i| NIL) (#2=#:G2249 NIL) (|j| NIL)
          (#3=#:G2250 NIL) (|k| NIL) (|ans| ($)) (|n| (|NonNegativeInteger|)))
         (SEQ (LETT |n| (QVSIZE |v|))
...
(DEFUN |Matrix;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G2260 NIL) (#2=#:G2261 NIL) (#3=#:G2262 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
