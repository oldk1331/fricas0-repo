...
(SDEFUN |MATRIX;copy;2$;6| ((|m| $) ($ $))
        (SPROG
         ((#1=#:G2099 NIL) (|j| NIL) (#2=#:G2098 NIL) (|i| NIL) (|ans| ($)))
         (SEQ
...
(SDEFUN |MATRIX;diagonalMatrix;V$;15| ((|v| |Vector| R) ($ $))
        (SPROG
         ((#1=#:G2120 NIL) (|i| NIL) (#2=#:G2121 NIL) (|j| NIL)
          (#3=#:G2122 NIL) (|k| NIL) (|ans| ($)) (|n| (|NonNegativeInteger|)))
...
(DEFUN |Matrix;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G2131 NIL) (#2=#:G2132 NIL) (#3=#:G2133 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
