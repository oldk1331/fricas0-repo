...
(DEFUN |MATCAT2;map;MM1M2;1| (|f| |m| $)
  (PROG (#1=#:G132 |j| #2=#:G133 |l| #3=#:G130 |i| #4=#:G131 |k| |ans|)
    (RETURN
     (SEQ
      (LETT |ans|
...
(DEFUN |MATCAT2;map;MM1U;2| (|f| |m| $)
  (PROG (#1=#:G138 #2=#:G151 |r| #3=#:G154 |j| #4=#:G155 |l| #5=#:G152 |i|
         #6=#:G153 |k| |ans|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |MatrixCategoryFunctions2| (&REST #1=#:G163)
  (PROG ()
    (RETURN
     (PROG (#2=#:G164)
       (RETURN
