...
(SDEFUN |PMKERNEL;patternMatchArg|
        ...
        (SPROG
         ((#1=#:G129 NIL) (#2=#:G131 NIL) (#3=#:G134 NIL) (|p| NIL)
          (#4=#:G135 NIL) (|s| NIL) (#5=#:G130 NIL) (#6=#:G132 NIL)
          (#7=#:G133 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |PMKERNEL;patternMatchInner|
        ...
        (SPROG
         ((#1=#:G155 NIL) (|w| (|Union| (|Symbol|) "failed"))
...
(SDEFUN |PMKERNEL;patternMatchMonoid|
        ((|s| (|Kernel| E)) (|p| (|Pattern| S))
         ...
         ($ (|Union| (|PatternMatchResult| S E) "failed")))
        (SPROG
         ((|w| (|Union| (|List| (|Pattern| S)) "failed")) (#1=#:G184 NIL)
...
(DEFUN |PatternMatchKernel| (&REST #1=#:G204)
  (SPROG NIL
         (PROG (#2=#:G205)
           (RETURN
            (COND
