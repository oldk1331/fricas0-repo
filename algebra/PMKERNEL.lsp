...
(SDEFUN |PMKERNEL;patternMatchArg|
        ...
        (SPROG
         ((#1=#:G144 NIL) (#2=#:G146 NIL) (#3=#:G149 NIL) (|p| NIL)
          (#4=#:G150 NIL) (|s| NIL) (#5=#:G145 NIL) (#6=#:G147 NIL)
          (#7=#:G148 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |PMKERNEL;patternMatchInner|
        ...
        (SPROG
         ((#1=#:G170 NIL) (|w| (|Union| (|Symbol|) "failed"))
...
(SDEFUN |PMKERNEL;patternMatchMonoid|
        ((|s| (|Kernel| E)) (|p| (|Pattern| S))
         ...
         ($ (|Union| (|PatternMatchResult| S E) "failed")))
        (SPROG
         ((|w| (|Union| (|List| (|Pattern| S)) "failed")) (#1=#:G199 NIL)
...
(DEFUN |PatternMatchKernel| (&REST #1=#:G219)
  (SPROG NIL
         (PROG (#2=#:G220)
           (RETURN
            (COND
