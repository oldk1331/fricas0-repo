...
(SDEFUN |IRURPK;checkRur;TSLB;1| ((|ts| TS) (|lts| |List| TS) ($ |Boolean|))
        (SPROG
         ((#1=#:G156 NIL) (#2=#:G157 NIL) (|rems| (|List| P)) (#3=#:G160 NIL)
          (|p| NIL) (#4=#:G159 NIL) (|dlts| (|NonNegativeInteger|))
          (#5=#:G158 NIL) (|us| NIL) (|lp| (|List| P))
          (|dts| (|NonNegativeInteger|)) (|z| (V)) (|f0| (P)) (#6=#:G145 NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |f0|
...
(SDEFUN |IRURPK;prepareRur|
        ...
        (SPROG
         ((|toSave|
           (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (|newf0| (P)) (#1=#:G177 NIL) (|ff1| NIL) (|newf1| (P)) (|x1| (V))
...
(SDEFUN |IRURPK;makeMonic|
        ...
        (SPROG ((|newts| (TS)) (|p| (P)) (#1=#:G185 NIL) (|lp| (|List| P)))
               (SEQ (LETT |lp| (SPADCALL |ts| (QREFELT $ 18)))
                    (LETT |lp| (SPADCALL (ELT $ 35) |lp| (QREFELT $ 37)))
         ...
         ((|toSee|
           (|List|
            (|Record| (|:| |pol| P) (|:| |gap| #1=(|Integer|))
                      (|:| |tower| TS))))
          (|toSave| (|List| TS)) (#2=#:G213 NIL) (|fr| NIL) (|r| (P)) (|h| (P))
...
(SDEFUN |IRURPK;rur;TSBL;7| ((|ts| TS) (|univ?| |Boolean|) ($ |List| TS))
        (SPROG
         ((|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          ...
          (#1=#:G228 NIL) (|lts| (|List| TS)) (|p| (P)) (|xi| (V))
...
(DEFUN |InternalRationalUnivariateRepresentationPackage| (&REST #1=#:G229)
  (SPROG NIL
         (PROG (#2=#:G230)
           (RETURN
            (COND
