...
(SDEFUN |IRURPK;checkRur;TSLB;1|
        ...
        (SPROG
         ((#1=#:G158 NIL) (#2=#:G159 NIL) (|rems| (|List| P)) (#3=#:G162 NIL)
          (|p| NIL) (#4=#:G161 NIL) (|dlts| (|NonNegativeInteger|))
          (#5=#:G160 NIL) (|us| NIL) (|lp| (|List| P))
...
(SDEFUN |IRURPK;prepareRur|
        ...
        (SPROG
         ((|toSave|
           (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (|newf0| (P)) (#1=#:G180 NIL) (|ff1| NIL) (|newf1| (P)) (|x1| (V))
...
(SDEFUN |IRURPK;makeMonic|
        ((|z| (V)) (|c| (P)) (|r| (P)) (|ts| (TS)) (|s| (P))
         (|univ?| (|Boolean|)) ($ (TS)))
        (SPROG ((|newts| (TS)) (|p| (P)) (#1=#:G189 NIL) (|lp| (|List| P)))
               (SEQ (LETT |lp| (SPADCALL |ts| (QREFELT $ 18)))
                    (LETT |lp| (SPADCALL (ELT $ 35) |lp| (QREFELT $ 37)))
         ...
         ((|toSee|
           (|List|
            (|Record| (|:| |pol| P) (|:| |gap| #1=(|Integer|))
                      (|:| |tower| TS))))
          (|toSave| (|List| TS)) (#2=#:G220 NIL) (|fr| NIL) (|r| (P)) (|h| (P))
...
(SDEFUN |IRURPK;rur;TSBL;7| ((|ts| (TS)) (|univ?| (|Boolean|)) ($ (|List| TS)))
        (SPROG
         ((|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          ...
          (#1=#:G237 NIL) (|lts| (|List| TS)) (|p| (P)) (|xi| (V))
...
(DEFUN |InternalRationalUnivariateRepresentationPackage| (&REST #1=#:G238)
  (SPROG NIL
         (PROG (#2=#:G239)
           (RETURN
            (COND
