...
(SDEFUN |CYCLES;complete;ISp;3|
        ...
        (SPROG
         ((#1=#:G133 NIL)
          (#2=#:G132 #3=(|SymmetricPolynomial| (|Fraction| (|Integer|))))
          (#4=#:G134 #3#) (#5=#:G136 NIL) (|pt| NIL))
         (SEQ
...
(SDEFUN |CYCLES;alternating;ISp;5|
        ...
        (SPROG
         ((#1=#:G143 NIL)
          (#2=#:G142 #3=(|SymmetricPolynomial| (|Fraction| (|Integer|))))
          (#4=#:G144 #3#) (#5=#:G146 NIL) (|li| NIL))
         (SEQ
          (SPADCALL 2
                    (PROGN
                     (LETT #1# NIL)
...
(SDEFUN |CYCLES;divisors| ((|n| |Integer|) ($ |List| (|Integer|)))
        (SPROG
         ((|c| (|List| (|Integer|))) (#1=#:G155 NIL)
          (#2=#:G154 #3=(|List| (|Integer|))) (#4=#:G156 #3#) (#5=#:G163 NIL)
          (|j| NIL) (#6=#:G162 NIL) (#7=#:G161 NIL) (|a| NIL)
          (|b|
           (|List|
...
(SDEFUN |CYCLES;ss|
        ...
        (SPROG
         ((|li| (|List| (|Integer|))) (#1=#:G168 NIL) (|j| NIL)
          (#2=#:G167 NIL))
         (SEQ
          (LETT |li|
                (PROGN
...
(SDEFUN |CYCLES;trm2|
        ...
        (SPROG
         ((|prod| #1=(|SymmetricPolynomial| (|Fraction| (|Integer|))))
          ...
          (|k| (|Integer|)) (|ll1| #2#) (|ll0| #3#) (#5=#:G184 NIL) (|ll| NIL)
          (|xx| (|Fraction| (|Integer|)))
...
(SDEFUN |CYCLES;graphs;ISp;13|
        ...
        (SPROG
         ((#1=#:G187 NIL)
          (#2=#:G186 #3=(|SymmetricPolynomial| (|Fraction| (|Integer|))))
          (#4=#:G188 #3#) (#5=#:G190 NIL) (|li| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
           (SEQ (LETT |li| NIL)
...
(SDEFUN |CYCLES;mtpol|
        ((|n| |Integer|)
         ...
         ($ |SymmetricPolynomial| (|Fraction| (|Integer|))))
        (SPROG
         ((|deg| (|Partition|)) (#1=#:G206 NIL) (|k| NIL) (#2=#:G205 NIL))
         (SEQ
          (COND ((SPADCALL |spol| (QREFELT $ 54)) (|spadConstant| $ 18))
                ('T
                 (SEQ
...
(SDEFUN |CYCLES;SFunction;LSp;22|
        ...
        (SPROG
         ((|a| (|Matrix| (|SymmetricPolynomial| (|Fraction| (|Integer|)))))
          (#1=#:G225 NIL) (|k| NIL) (#2=#:G226 NIL) (|j| NIL) (#3=#:G224 NIL)
          (#4=#:G223 NIL) (|i| NIL) (#5=#:G222 NIL))
         (SEQ
          (LETT |a|
                (SPADCALL
                 (PROGN
...
(SDEFUN |CYCLES;skewSFunction;2LSp;24|
        ...
        (SPROG
         ((|a| (|Matrix| (|SymmetricPolynomial| (|Fraction| (|Integer|)))))
          (#1=#:G237 NIL) (|k| NIL) (#2=#:G238 NIL) (|j| NIL) (#3=#:G236 NIL)
          (#4=#:G235 NIL) (|i| NIL) (#5=#:G234 NIL))
         (SEQ
          (COND
           ((< (LENGTH |li1|) (LENGTH |li2|))
