...
(DEFUN |FiniteFieldCyclicGroup| (&REST #1=#:G142)
  (SPROG NIL
         (PROG (#2=#:G143)
           (RETURN
            (COND
...
(MAKEPROP '|FiniteFieldCyclicGroup| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL
              ...
              (|PrimitiveArray| 48) (|PrimeField| (NRTEVAL (QREFELT $ 6)))
              (|Vector| 32) (|Matrix| 32) (|Vector| $) (|Union| 32 '"failed")
              (|Fraction| 26) (|Factored| $) (|Union| 18 '#2="failed")
