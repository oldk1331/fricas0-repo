...
(SDEFUN |LSAGG-;insert!;SAIA;7| ((|s| S) (|x| A) (|i| |Integer|) ($ A))
        (SPROG ((|z| (A)) (|y| (A)) (#1=#:G203 NIL) (|m| (|Integer|)))
...
(SDEFUN |LSAGG-;insert!;2AIA;8| ((|w| A) (|x| A) (|i| |Integer|) ($ A))
        (SPROG ((|z| (A)) (|y| (A)) (#1=#:G207 NIL) (|m| (|Integer|)))
               (SEQ (LETT |m| (SPADCALL |x| (QREFELT $ 31)))
                    (EXIT
                     (COND ((< |i| |m|) (|error| "index out of range"))
...
(SDEFUN |LSAGG-;delete!;AIA;10| ((|x| A) (|i| |Integer|) ($ A))
        (SPROG ((|y| (A)) (#1=#:G220 NIL) (|m| (|Integer|)))
               (SEQ (LETT |m| (SPADCALL |x| (QREFELT $ 31)))
                    (EXIT
                     (COND ((< |i| |m|) (|error| "index out of range"))
...
(SDEFUN |LSAGG-;delete!;AUsA;11|
        ...
        (SPROG
         ((#1=#:G227 NIL) (|t| (A)) (#2=#:G226 NIL) (#3=#:G225 NIL)
...
(SDEFUN |LSAGG-;mergeSort|
        ...
        (SPROG ((|q| (A)) (|l| (|NonNegativeInteger|)) (#1=#:G249 NIL))
               (SEQ
                (COND
                 ((EQL |n| 2)
                  (COND
...
(SDEFUN |LSAGG-;copyInto!;2AIA;22| ((|y| A) (|x| A) (|s| |Integer|) ($ A))
        (SPROG ((|z| (A)) (#1=#:G300 NIL) (|m| (|Integer|)))
...
(SDEFUN |LSAGG-;position;SA2I;23|
        ...
        (SPROG ((|k| NIL) (#1=#:G308 NIL) (|m| (|Integer|)))
               (SEQ (LETT |m| (SPADCALL |x| (QREFELT $ 31)))
                    (EXIT
                     (COND ((< |s| |m|) (|error| "index out of range"))
                           (#2='T
...
(MAKEPROP '|ListAggregate&| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (141 . =) (147 . |remove!|) (153 . |removeDuplicates!|) (158 . <)
              (164 . <) (170 . |smaller?|) (176 . |smaller?|) (|Mapping| 7 7))
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 67
                                            '(1 6 8 0 9 0 6 0 12 2 6 0 7 0 13 1
                                              ...
                                              58 3 0 30 7 0 30 60 2 7 15 0 0 61
                                              2 6 0 26 0 62 1 0 0 0 63 2 7 15 0
                                              0 64 2 0 15 0 0 65 2 7 15 0 0 66
                                              2 0 15 0 0 67 2 0 15 10 0 49 2 0
                                              0 10 0 11 2 0 15 0 0 67 2 0 0 26
                                              0 27 1 0 0 0 55 1 0 0 0 63 2 0 0
                                              26 0 36 4 0 7 19 0 7 7 52 2 0 7
                                              19 0 21 3 0 7 19 0 7 50 2 0 30 26
                                              0 46 3 0 30 7 0 30 60 2 0 0 8 7
                                              53 3 0 0 10 0 0 29 3 0 0 10 0 0
                                              24 3 0 0 19 0 0 54 1 0 0 7 14 3 0
                                              0 0 0 30 35 3 0 0 7 0 30 33 2 0
                                              44 26 0 45 2 0 0 0 30 37 2 0 0 0
                                              38 43 3 0 0 0 0 30 59 1 0 0 0 57
                                              2 0 15 0 0 65)))))
           '|lookupComplete|)) 
