                       ...
                       ('T
                        (SEQ (LETT |p| |x| . #1#)
                             ...
                             (SEQ G190
                                  (COND
                                   ((NULL
                                     (COND ((SPADCALL |q| (QREFELT $ 16)) 'NIL)
                                           ('T 'T)))
                                    (GO G191)))
                                  (SEQ
                                   (EXIT
        ...
        (SPROG ((|l| (A)) (|k| NIL))
               (SEQ
                (LETT |l| (SPADCALL (QREFELT $ 12))
                      . #1=(|LSAGG-;new;NniSA;18|))
                (SEQ (LETT |k| 1 . #1#) G190
                     (COND ((|greater_SI| |k| |n|) (GO G191)))
                     (SEQ
                      (EXIT
                       (LETT |l| (SPADCALL |s| |l| (QREFELT $ 13)) . #1#)))
                 ...
                 ('T
                  (SEQ (SPADCALL |x| (SPADCALL (QREFELT $ 12)) (QREFELT $ 25))
                       (SEQ G190
                            (COND
                             ((NULL
                               (COND ((SPADCALL |y| (QREFELT $ 16)) 'NIL)
                                     ('T 'T)))
                              (GO G191)))
        ...
        (SPROG ((|y| (A)) (|k| NIL))
               (SEQ
                ...
                (SEQ (LETT |k| 0 . #1#) G190
                     (COND
                      ((NULL
                        (COND ((SPADCALL |x| (QREFELT $ 16)) 'NIL) ('T 'T)))
                       (GO G191)))
                     (SEQ
                      (COND
                       ((EQL |k| 1000)
...
(SDEFUN |LSAGG-;copyInto!;2AIA;22| ((|y| A) (|x| A) (|s| |Integer|) ($ A))
        (SPROG ((|z| (A)) (#1=#:G292 NIL) (|m| (|Integer|)))
               (SEQ
...
(SDEFUN |LSAGG-;position;SA2I;23|
        ...
        (SPROG ((|k| NIL) (#1=#:G300 NIL) (|m| (|Integer|)))
               (SEQ
                (LETT |m| (SPADCALL |x| (QREFELT $ 31))
