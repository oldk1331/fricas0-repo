    ...
    (RETURN
     (SEQ
      (COND
       ...
       (#4='T
        (SEQ
         (LETT |vr| (SPADCALL |u| (QREFELT $ 16)) . #5=(|FRNAAF2;map;MARAS;1|))
           ...
           (#4#
            (SEQ (LETT |ba| (SPADCALL (QREFELT $ 23)) . #5#)
                 (EXIT
                  (SPADCALL |vs|
                            (PROGN
                             (LETT #3# (GETREFV #6=(SPADCALL (QREFELT $ 11)))
                                   . #5#)
...
(DEFUN |FramedNonAssociativeAlgebraFunctions2| (&REST #1=#:G111)
  (PROG ()
    (RETURN
     (PROG (#2=#:G112)
       (RETURN
        (COND
         ...
         ('T
          (UNWIND-PROTECT
              (PROG1
                  (APPLY (|function| |FramedNonAssociativeAlgebraFunctions2;|)
                         #1#)
                (LETT #2# T . #3#))
            (COND
             ((NOT #2#)
