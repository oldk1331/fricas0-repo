...
(DEFUN |LPOLY;eval;$LL$;4| (|p| |lv| |lnv| $)
  (PROG (#1=#:G163 #2=#:G162 #3=#:G164 #4=#:G166 |t|)
    (RETURN
     (SEQ
      (PROGN
...
(DEFUN |LPOLY;lquo;Xrp$Xrp;8| (|p| |lp| $)
  (PROG (#1=#:G175 #2=#:G174 #3=#:G176 #4=#:G178 |t|)
    (RETURN
     (SEQ
      (COND
...
(DEFUN |LPOLY;rquo;Xrp$Xrp;9| (|p| |lp| $)
  (PROG (#1=#:G180 #2=#:G179 #3=#:G181 #4=#:G183 |t|)
    (RETURN
     (SEQ
      (COND
       ((SPADCALL |lp| (|spadConstant| $ 23) (QREFELT $ 44))
...
(DEFUN |LPOLY;LiePolyIfCan;XdpU;10| (|p| $)
  (PROG (|p1| |r| |lp| #1=#:G196 |l| |coef| |w| |t|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |LPOLY;cr1| (|l| |p| $)
  (PROG (#1=#:G204 #2=#:G203 #3=#:G205 #4=#:G207 |t|)
    (RETURN
     (SEQ
      (PROGN
...
(DEFUN |LPOLY;cr2| (|p| |l| $)
  (PROG (#1=#:G209 #2=#:G208 #3=#:G210 #4=#:G212 |t|)
    (RETURN
     (SEQ
      (PROGN
...
(DEFUN |LPOLY;construct;3$;19| (|x| |y| $)
  (PROG (#1=#:G221 #2=#:G220 #3=#:G222 #4=#:G224 |t|)
    (RETURN
     (SEQ
      (PROGN
...
(DEFUN |LPOLY;coerce;$Xrp;24| (|p| $)
  (PROG (#1=#:G234 #2=#:G233 #3=#:G235 #4=#:G237 |t|)
    (RETURN
     (SEQ
      (PROGN
...
(DEFUN |LPOLY;varList;$L;26| (|p| $)
  (PROG (|le| #1=#:G240 #2=#:G239 #3=#:G241 #4=#:G244 |t|)
    (RETURN
     (SEQ
      (LETT |le|
            (PROGN
...
(DEFUN |LiePolynomial| (&REST #1=#:G271)
  (PROG ()
    (RETURN
     (PROG (#2=#:G272)
       (RETURN
...
(DEFUN |LiePolynomial;| (|#1| |#2|)
  (PROG (|pv$| #1=#:G268 #2=#:G269 #3=#:G270 $ |dv$| DV$2 DV$1)
    (RETURN
     (PROGN
...
(MAKEPROP '|LiePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|FreeModule| 7 10) (|local| |#1|)
              ...
              (|List| 7) (|List| 10) (|SingleInteger|) (|String|))
           '#(~= 304 |zero?| 310 |varList| 315 |trunc| 320 |support| 326 |sup|
              ...
              |leadingCoefficient| 456 |latex| 461 |hash| 466 |eval| 471
              |degree| 485 |constructOrdered| 490 |construct| 495 |coerce| 524
             ...
             (CONS
              ...
              (|makeByteWordVec2| 110
                                  '(1 10 9 0 11 2 9 12 6 0 13 1 10 15 0 16 2 6
                                    ...
                                    0 108 0 1 2 3 0 0 0 1 2 6 55 0 0 1 2 11 12
                                    ...
                                    110 0 1 1 0 109 0 1 3 0 0 0 6 0 30 3 0 0 0
                                    9 31 32 1 0 87 0 88 1 0 0 105 1 2 0 0 10 0
                                    75 2 0 0 0 10 76 2 0 0 10 10 77 1 0 0 105 1
                                    2 0 0 0 0 20 1 2 0 10 25 1 0 49 0 58 1 0 33
                                    0 41 1 0 0 6 74 1 0 93 0 101 1 0 107 0 1 2
                                    0 7 0 10 1 2 0 7 33 0 43 0 8 0 23 1 0 55 49
                                    60 1 0 0 10 14 2 4 12 0 0 1 2 4 12 0 0 1 2
                                    0 12 0 0 44 2 4 12 0 0 1 2 4 12 0 0 1 2 7 0
                                    0 7 1 1 1 0 0 66 2 1 0 0 0 1 2 0 0 0 0 29 2
                                    1 0 21 0 1 2 8 0 87 0 1 2 0 0 7 10 1 2 0 0
                                    10 7 1 2 0 0 7 0 28 2 0 0 0 7 1 2 0 0 83 0
                                    1)))))
           '|lookupComplete|)) 
