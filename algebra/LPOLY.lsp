...
(SDEFUN |LPOLY;eval;$VarSet2$;3| ((|p| $) (|v| |VarSet|) (|nv| $) ($ $))
        (SPROG
         ((#1=#:G136 NIL) (#2=#:G135 ($)) (#3=#:G137 ($)) (#4=#:G139 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
...
(SDEFUN |LPOLY;eval;$LL$;4|
        ...
        (SPROG
         ((#1=#:G141 NIL) (#2=#:G140 ($)) (#3=#:G142 ($)) (#4=#:G144 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
...
(SDEFUN |LPOLY;lquo;Xrp$Xrp;8|
        ((|p| |XRecursivePolynomial| |VarSet| R) (|lp| $)
         ($ |XRecursivePolynomial| |VarSet| R))
        (SPROG
         ((#1=#:G153 NIL) (#2=#:G152 #3=(|XRecursivePolynomial| |VarSet| R))
          (#4=#:G154 #3#) (#5=#:G156 NIL) (|t| NIL))
         (SEQ
          (COND
...
(SDEFUN |LPOLY;rquo;Xrp$Xrp;9|
        ((|p| |XRecursivePolynomial| |VarSet| R) (|lp| $)
         ($ |XRecursivePolynomial| |VarSet| R))
        (SPROG
         ((#1=#:G158 NIL) (#2=#:G157 #3=(|XRecursivePolynomial| |VarSet| R))
          (#4=#:G159 #3#) (#5=#:G161 NIL) (|t| NIL))
         (SEQ
          (COND
           ((SPADCALL |lp| (|spadConstant| $ 23) (QREFELT $ 44))
            (|spadConstant| $ 35))
...
(SDEFUN |LPOLY;cr2| ((|p| $) (|l| |LyndonWord| |VarSet|) ($ $))
        (SPROG
         ((#1=#:G188 NIL) (#2=#:G187 ($)) (#3=#:G189 ($)) (#4=#:G191 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
...
(SDEFUN |LPOLY;coerce;VarSet$;18| ((|v| |VarSet|) ($ $))
        (SPADCALL (SPADCALL |v| (QREFELT $ 73)) (|spadConstant| $ 67)
                  (QREFELT $ 68))) 

(SDEFUN |LPOLY;construct;3$;19| ((|x| $) (|y| $) ($ $))
        (SPROG
         ((#1=#:G200 NIL) (#2=#:G199 ($)) (#3=#:G201 ($)) (#4=#:G203 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
...
(SDEFUN |LPOLY;coerce;$Xdp;23|
        ...
        (SPROG
         ((#1=#:G208 NIL) (#2=#:G207 #3=(|XDistributedPolynomial| |VarSet| R))
          (#4=#:G209 #3#) (#5=#:G211 NIL) (|t| NIL))
         (SEQ
          (PROGN
...
(SDEFUN |LPOLY;coerce;$Xrp;24| ((|p| $) ($ |XRecursivePolynomial| |VarSet| R))
        (SPROG
         ((#1=#:G213 NIL) (#2=#:G212 #3=(|XRecursivePolynomial| |VarSet| R))
          (#4=#:G214 #3#) (#5=#:G216 NIL) (|t| NIL))
         (SEQ
          (PROGN
...
(SDEFUN |LPOLY;varList;$L;26| ((|p| $) ($ |List| |VarSet|))
        (SPROG
         ((|le| #1=(|List| |VarSet|)) (#2=#:G219 NIL) (#3=#:G218 #1#)
          (#4=#:G220 #1#) (#5=#:G223 NIL) (|t| NIL))
         (SEQ
          (LETT |le|
                (PROGN
...
(SDEFUN |LPOLY;mirror;2$;27| ((|p| $) ($ $))
        (SPROG ((#1=#:G228 NIL) (|t| NIL) (#2=#:G227 NIL))
               (SEQ
                (PROGN
...
(SDEFUN |LPOLY;coerce;$Of;31| ((|a| $) ($ |OutputForm|))
        (SPROG ((#1=#:G239 NIL) (|t| NIL) (#2=#:G238 NIL))
               (SEQ
                (COND
...
(DEFUN |LiePolynomial| (&REST #1=#:G247)
  (SPROG NIL
         (PROG (#2=#:G248)
           (RETURN
            (COND
...
(MAKEPROP '|LiePolynomial| '|infovec|
          (LIST
           ...
           '#(~= 304 |zero?| 310 |varList| 315 |trunc| 320 |support| 326 |sup|
              ...
              |monomial| 395 |monom| 401 |mirror| 407 |min| 412 |max| 418 |map|
              424 |lquo| 430 |listOfTerms| 436 |linearExtend| 441 |leadingTerm|
              447 |leadingSupport| 452 |leadingMonomial| 457
              |leadingCoefficient| 462 |latex| 467 |hashUpdate!| 472 |hash| 478
              |eval| 483 |degree| 497 |constructOrdered| 502 |construct| 507
              |coerce| 536 |coefficients| 561 |coefficient| 566 |coef| 572
              |Zero| 578 |LiePolyIfCan| 582 |LiePoly| 587 >= 592 > 598 = 604 <=
              610 < 616 / 622 - 628 + 639 * 645)
           'NIL
           (CONS
            (|makeByteWordVec2| 7
             ...
             (CONS
              ...
              (|makeByteWordVec2| 111
                                  '(1 10 9 0 11 2 9 12 6 0 13 1 10 15 0 16 2 6
                                    ...
                                    1 0 31 0 1 1 0 12 0 1 2 0 0 7 10 1 2 0 0 10
                                    7 68 1 0 0 0 86 2 5 0 0 0 1 2 5 0 0 0 1 2 0
                                    0 106 0 1 2 0 33 33 0 47 1 0 105 0 1 2 11 7
                                    102 0 1 1 0 104 0 1 1 0 10 0 1 1 0 10 0 1 1
                                    0 7 0 1 1 0 109 0 1 2 0 111 111 0 1 1 0 110
                                    0 1 3 0 0 0 6 0 30 3 0 0 0 9 31 32 1 0 87 0
                                    88 1 0 0 105 1 2 0 0 10 0 75 2 0 0 0 10 76
                                    2 0 0 10 10 77 1 0 0 105 1 2 0 0 0 0 20 1 2
                                    0 10 25 1 0 49 0 58 1 0 33 0 41 1 0 0 6 74
                                    1 0 93 0 101 1 0 107 0 1 2 0 7 0 10 1 2 0 7
                                    33 0 43 0 9 0 23 1 0 55 49 60 1 0 0 10 14 2
                                    5 12 0 0 1 2 5 12 0 0 1 2 0 12 0 0 44 2 5
                                    12 0 0 1 2 5 12 0 0 1 2 8 0 0 7 1 2 1 0 0 0
                                    1 1 1 0 0 66 2 0 0 0 0 29 2 9 0 87 0 1 2 1
                                    0 21 0 1 2 0 0 7 10 1 2 0 0 10 7 1 2 0 0 0
                                    7 1 2 0 0 83 0 1 2 0 0 7 0 28)))))
           '|lookupComplete|)) 
