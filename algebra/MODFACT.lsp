...
(SDEFUN |MODFACT;mvmul|
        ...
        (SPROG
         ((|ss| (|Integer|)) (#1=#:G118 NIL) (|j| NIL) (#2=#:G117 NIL)
...
(SDEFUN |MODFACT;mmul;2UmIUm;2|
        ...
        (SPROG
         ((|ss| (|Integer|)) (#1=#:G128 NIL) (|k| NIL) (#2=#:G127 NIL)
          (|j| NIL) (#3=#:G126 NIL) (|i| NIL) (|res| (|U32Matrix|))
...
(SDEFUN |MODFACT;red_pol;UvLV;4|
        ((|pol| |U32Vector|)
         ...
         ($ |Void|))
        (SPROG
         ((#1=#:G142 NIL) (|i| NIL) (|tmp| (|U32Vector|))
          (|mi| (|NonNegativeInteger|)) (|ni| #2=(|Integer|))
          (|ii| #3=(|NonNegativeInteger|)) (#4=#:G141 NIL) (|ri| NIL)
...
(SDEFUN |MODFACT;mod_exp;UvILUv;5|
        ((|pol| |U32Vector|) (|n| |Integer|)
         ...
         ($ |U32Vector|))
        (SPROG
         ((|pow1| #1=(|U32Vector|)) (#2=#:G152 NIL) (|has_res| (|Boolean|))
               ...
               (SEQ G190
                    ...
                    (SEQ
                     ...
                     (EXIT
                      (COND
                       ((EQL |n| 0)
                        (PROGN (LETT #2# |$NoValue| . #4#) (GO #5=#:G149)))
                       ('T
                        (SEQ
...
(SDEFUN |MODFACT;power_matrix;UvNniLR;6|
        ...
        (SPROG
         ((#1=#:G164 NIL) (|k| NIL) (|nn1| (|Integer|)) (|pow1| (|U32Vector|))
          (#2=#:G163 NIL) (#3=#:G162 NIL) (|j| NIL) (|n1| (|SingleInteger|))
...
(SDEFUN |MODFACT;modular_compose;UvUmUv2NniLUv;7|
        ((|pol| |U32Vector|) (|pm| |U32Matrix|) (|xp1| |U32Vector|)
         ...
         ($ |U32Vector|))
        (SPROG
         ((|res1| (|U32Vector|)) (#1=#:G177 NIL) (|i| (|SingleInteger|))
          (|k| NIL) (|ns1| (|SingleInteger|)) (|res| #2=(|U32Vector|))
          (|p1| #2#) (|m2| (|U32Matrix|)) (#3=#:G176 NIL) (#4=#:G175 NIL)
        ...
        ((|pol| |U32Vector|) (|p| |Integer|)
         ($ |List|
          #1=(|Record| (|:| |ind| (|NonNegativeInteger|))
                       (|:| |poly| (|U32Vector|)))))
        (SPROG
         ((|res| (|List| #1#)) (|tmp1| #2=(|U32Vector|)) (#3=#:G186 NIL)
...
(SDEFUN |MODFACT;eqfact|
        ...
        (SPROG
         ((|dg| #3=(|NonNegativeInteger|)) (|dp| (|NonNegativeInteger|))
          ...
          (|tr| #5#) (#6=#:G206 NIL) (|i| NIL) (#7=#:G205 NIL) (#8=#:G204 NIL)
          (|kk| (|Integer|)) (#9=#:G203 NIL) (|n0| (|Integer|)) (|rpol| #5#)
         ...
         ((|res|
           (|List|
            (|Record| (|:| |poly| (|U32Vector|))
                      ...
                      (|:| |separate_factors|
                           (|Mapping| (|List| (|U32Vector|)))))))
          (#1=#:G224 NIL) (|dg| (|Integer|)) (|pk| (|U32Vector|))
          (#2=#:G231 NIL) (#3=#:G229 NIL) (#4=#:G230 NIL)
          (|n| #5=(|NonNegativeInteger|)) (|tmp| #6=(|U32Vector|))
          (#7=#:G235 NIL) (|g1| NIL) (|res1| (|List| (|U32Vector|)))
          (|g| (|U32Vector|)) (|i| (|NonNegativeInteger|)) (#8=#:G234 NIL)
          (|pj| #9=(|U32Vector|)) (#10=#:G233 NIL) (|i1| NIL)
          (|xp2| #11=(|U32Vector|)) (|pmat2| #12=(|U32Matrix|)) (|#G72| #11#)
          (|#G71| #12#)
          (|#G70| #13=(|Record| (|:| |matr| #12#) (|:| |poly| #11#)))
          (|pk1| #6#) (|lpj| (|List| #6#)) (#14=#:G232 NIL)
            ...
            (SEQ (LETT |i1| 1 . #15#) (LETT #10# |k2| . #15#) G190
                 ...
                 (SEQ
                  ...
                  (EXIT
                   (COND
                    ((>= |i| (QUOTIENT2 |n| 2))
                     (PROGN (LETT #2# |$NoValue| . #15#) (GO #19=#:G222)))
                    ('T
                     (LETT |pk|
