        ...
        (SPROG
         ...
         (SEQ
          (COND
           ((EQUAL |x|
                   (SPADCALL
                    (LETT |y| (SPADCALL |l| (QREFELT $ 37))
                          . #1=(|COMBF;dvdsum|))
                    (QREFELT $ 61)))
            (|spadConstant| $ 62))
           ('T
            (SEQ (LETT |f| (|SPADfirst| |l|) . #1#)
                 (LETT |v| (SPADCALL |l| (QREFELT $ 38)) . #1#)
                 (LETT |g| (SPADCALL |l| 4 (QREFELT $ 64)) . #1#)
                 (LETT |h| (SPADCALL |l| 5 (QREFELT $ 64)) . #1#)
                 (LETT |r1|
                       (SPADCALL (QREFELT $ 17)
        ...
        (SPROG ((|p| (F)) (|f| (F)) (|dm| (|Symbol|)))
               (SEQ
                ...
                (LETT |f|
                      ...
                      . #1#)
                (LETT |p| (SPADCALL |f| |dm| (QREFELT $ 58)) . #1#)
                (EXIT
                 (SPADCALL (QREFELT $ 16)
                           (LIST
                            (SPADCALL
...
(SDEFUN |COMBF;equalsumprod|
        ...
        (SPROG ((|l2| #1=(|List| F)) (|l1| #1#))
               (SEQ
                (LETT |l1| (SPADCALL |s1| (QREFELT $ 75))
                      . #2=(|COMBF;equalsumprod|))
                (LETT |l2| (SPADCALL |s2| (QREFELT $ 75)) . #2#)
                (EXIT
                 (SPADCALL
...
(SDEFUN |COMBF;K2fact| ((|k| |Kernel| F) (|l| |List| (|Symbol|)) ($ F))
        (SPROG
         ((|p| (F)) (|n| (F)) (|args| (|List| F)) (#1=#:G201 NIL) (|a| NIL)
          (#2=#:G200 NIL) (#3=#:G199 NIL) (|kf| (F)) (|v| NIL) (#4=#:G198 NIL))
         (SEQ
          (COND
           ((OR
             (NULL
              (PROGN
               ...
               (SEQ (LETT |v| NIL . #5#)
                    (LETT #3#
                          (SPADCALL
                           (LETT |kf| (SPADCALL |k| (QREFELT $ 57)) . #5#)
                           (QREFELT $ 43))
                          . #5#)
                    G190
                    (COND
             ...
             (NULL
              (LETT |args|
                    (PROGN
                     (LETT #2# NIL . #5#)
                     (SEQ (LETT |a| NIL . #5#)
                          (LETT #1# (SPADCALL |k| (QREFELT $ 75)) . #5#) G190
                          (COND
                           ((OR (ATOM #1#)
           ...
           ((SPADCALL |k| (QREFELT $ 14) (QREFELT $ 91))
            (SPADCALL
             ...
             (SPADCALL
              (SPADCALL |n| (SPADCALL |args| (QREFELT $ 38)) (QREFELT $ 40))
              (QREFELT $ 24))
             (QREFELT $ 49)))
...
(SDEFUN |COMBF;iidsum;LF;37| ((|l| |List| F) ($ F))
        (SPROG
         ((#1=#:G240 NIL) (#2=#:G239 (F)) (#3=#:G241 (F)) (#4=#:G245 NIL)
          (|i| NIL) (#5=#:G244 NIL) (|k| (|Union| (|Kernel| F) #6="failed"))
          (|r2| #7=(|Union| (|Integer|) #6#)) (|r1| #7#))
         (SEQ
          (EXIT
           (SEQ
            (SEQ
             (LETT |r1| (SPADCALL (|COMBF;fourth| |l| $) (QREFELT $ 100))
                   . #8=(|COMBF;iidsum;LF;37|))
             (EXIT
              (COND
               ((QEQCAR |r1| 1)
                (PROGN (LETT #5# (|COMBF;idsum| |l| $) . #8#) (GO #9=#:G242)))
               (#10='T
                (SEQ
                 (LETT |r2|
                       (SPADCALL (|COMBF;fourth| (CDR |l|) $) (QREFELT $ 100))
                       . #8#)
                 (EXIT
                  (COND
                   ((QEQCAR |r2| 1)
                    ...
                    (EXIT
                     (PROGN
                      (LETT #3#
                            ...
                            . #8#)
                      (COND
                       (#1# (LETT #2# (SPADCALL #2# #3# (QREFELT $ 67)) . #8#))
                       ('T
                        (PROGN (LETT #2# #3# . #8#) (LETT #1# 'T . #8#)))))))
                   (LETT |i| (+ |i| 1) . #8#) (GO G190) G191 (EXIT NIL))
              (COND (#1# #2#) (#10# (|spadConstant| $ 62)))))))
          #9# (EXIT #5#)))) 

(SDEFUN |COMBF;iidprod;LF;38| ((|l| |List| F) ($ F))
        (SPROG
         ((#1=#:G256 NIL) (#2=#:G255 (F)) (#3=#:G257 (F)) (#4=#:G261 NIL)
          (|i| NIL) (#5=#:G260 NIL) (|k| (|Union| (|Kernel| F) #6="failed"))
          (|r2| #7=(|Union| (|Integer|) #6#)) (|r1| #7#))
         (SEQ
          (EXIT
           (SEQ
            (SEQ
             ...
             (EXIT
              (COND
               ((QEQCAR |r1| 1)
                (PROGN (LETT #5# (|COMBF;idprod| |l| $) . #8#) (GO #9=#:G258)))
               (#10='T
                (SEQ
                 (LETT |r2|
                       (SPADCALL (|COMBF;fourth| (CDR |l|) $) (QREFELT $ 100))
          ...
          (COND
           ...
           ('T
            (COND ((SPADCALL |n| (|spadConstant| $ 39) (QREFELT $ 76)) |x|)
                  (#3#
                   (SEQ (LETT |u| (SPADCALL |x| '|exp| (QREFELT $ 108)) . #2#)
                        (EXIT
                         (COND
                          ((QEQCAR |u| 1)
                           (SPADCALL (QREFELT $ 20) |l| (QREFELT $ 66)))
...
(SDEFUN |COMBF;iifact;2F;43| ((|x| F) ($ F))
        (SPROG ((|r| (|Union| R "failed")))
               (SEQ
                (LETT |r| (SPADCALL |x| (QREFELT $ 116)) |COMBF;iifact;2F;43|)
                (EXIT
...
(SDEFUN |COMBF;iiperm;LF;44| ((|l| |List| F) ($ F))
        (SPROG ((#1=#:G308 NIL) (|r2| #2=(|Union| R "failed")) (|r1| #2#))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                   (LETT |r1| (SPADCALL (|SPADfirst| |l|) (QREFELT $ 116))
...
(SDEFUN |COMBF;iibinom;LF;45| ((|l| |List| F) ($ F))
        (SPROG
         ((#1=#:G327 NIL) (|r2| #2=(|Union| R #3="failed")) (|r1| #2#)
          (|ans| (F)) (#4=#:G329 NIL) (|i| NIL) (|t| (|Union| (|Integer|) #3#))
          (|s| #2#) (#5=#:G328 NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ
             (LETT |s| (SPADCALL (SPADCALL |l| (QREFELT $ 38)) (QREFELT $ 116))
                   . #6=(|COMBF;iibinom;LF;45|))
             (EXIT
              (COND
               ((QEQCAR |s| 0)
                (SEQ (LETT |t| (SPADCALL (QCDR |s|) (QREFELT $ 121)) . #6#)
                     (EXIT
                      (COND
                       ((QEQCAR |t| 0)
                        (COND
                         ((SPADCALL (QCDR |t|) 0 (QREFELT $ 122))
                          (PROGN
                           (LETT #1#
                                 (SEQ (LETT |ans| (|spadConstant| $ 39) . #6#)
                                      (SEQ (LETT |i| 0 . #6#)
                                           (LETT #5# (- (QCDR |t|) 1) . #6#)
                                           G190
                                           (COND
                         ...
                         ((SPADCALL (QCDR |t|) 0 (QREFELT $ 122))
                          (PROGN
                           (LETT #1#
                                 ...
                                 . #6#)
                           (GO #7#))))))))))))
            (SEQ (LETT |r1| (SPADCALL (|SPADfirst| |l|) (QREFELT $ 116)) . #6#)
                 (EXIT
                  (COND
                   ((QEQCAR |r1| 1)
...
(SDEFUN |COMBF;iibinom;LF;46| ((|l| |List| F) ($ F))
        (SPROG ((#1=#:G337 NIL) (|r2| #2=(|Union| R "failed")) (|r1| #2#))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |COMBF;iibinom;LF;47| ((|l| |List| F) ($ F))
        (SPROG ((#1=#:G345 NIL) (|r2| #2=(|Union| R "failed")) (|r1| #2#))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                  ...
                  (SEQ
                   ...
                   (EXIT
                    (COND
                     ((QEQCAR |r1| 1)
                      (PROGN
                       (LETT #1# (SPADCALL |l| (QREFELT $ 112)) . #3#)
                       (GO #4=#:G354)))
                     ('T
                      (SEQ
                       (LETT |r2|
...
(DEFUN |CombinatorialFunction| (&REST #1=#:G411)
  (SPROG NIL
         (PROG (#2=#:G412)
           (RETURN
            (COND
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 140
                                                 '(1 11 9 10 12 1 7 9 9 21 2 7
                                                   ...
                                                   29 0 30 1 7 31 0 32 2 9 29 0
                                                   10 34 1 36 7 0 37 1 36 7 0
                                                   38 0 7 0 39 2 7 0 0 0 40 2 7
                                                   0 0 0 41 1 7 42 0 43 1 7 46
                                                   0 47 1 7 46 0 48 2 7 0 0 0
                                                   49 1 7 50 0 51 3 7 0 0 50 0
                                                   52 0 10 0 53 1 7 0 10 54 1
                                                   55 0 10 56 1 7 0 50 57 2 7 0
                                                   0 10 60 1 7 10 0 61 0 7 0 62
                                                   2 36 7 0 63 64 2 42 29 10 0
                                                   65 2 7 0 9 25 66 2 7 0 0 0
                                                   67 1 7 68 0 69 2 68 0 0 0 70
                                                   2 68 0 0 0 71 3 68 0 0 0 0
                                                   72 2 68 0 0 0 73 3 68 0 0 0
                                                   0 74 1 55 36 0 75 2 7 29 0 0
                                                   76 1 77 10 0 78 1 77 79 0 80
                                                   1 79 7 0 81 1 79 7 0 82 1 7
                                                   0 6 85 3 89 7 86 87 88 90 2
                                                   55 29 0 9 91 1 55 9 0 92 2 9
                                                   29 0 10 93 1 7 29 0 95 0 6 0
                                                   96 2 7 0 9 0 97 0 6 0 98 1 7
                                                   99 0 100 1 7 101 0 102 1 7 0
                                                   63 103 1 0 7 36 104 1 0 7 36
                                                   105 2 7 107 0 10 108 2 7 0
                                                   63 0 109 2 7 0 0 110 111 1 0
                                                   7 36 112 2 7 0 0 63 113 1 7
                                                   0 0 114 1 7 115 0 116 1 6 0
                                                   0 117 1 0 7 7 118 2 6 0 0 0
                                                   119 1 0 7 36 120 1 6 99 0
                                                   121 2 63 29 0 0 122 1 6 0 63
                                                   123 1 63 0 0 124 2 110 0 63
                                                   63 125 2 7 0 110 0 126 2 6 0
                                                   0 0 127 1 0 7 36 128 2 6 0 0
                                                   0 129 1 0 7 36 130 1 7 0 0
                                                   131 2 133 9 9 132 134 2 133
                                                   9 9 135 136 2 133 9 9 137
                                                   138 3 9 0 0 10 139 140 2 0 7
                                                   7 10 59 2 0 7 7 77 84 2 0 7
                                                   7 10 58 2 0 7 7 77 83 2 0 7
                                                   7 7 28 1 0 9 9 94 1 0 7 36
                                                   112 1 0 7 36 130 1 0 7 36
                                                   120 1 0 7 7 118 1 0 7 36 104
                                                   1 0 7 36 105 1 0 7 36 128 1
                                                   0 7 7 44 2 0 7 7 10 45 1 0 7
                                                   7 24 2 0 7 7 7 27 1 0 29 9
                                                   35 2 0 7 7 7 33)))))
           '|lookupComplete|)) 
