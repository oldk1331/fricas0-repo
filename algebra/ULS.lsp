...
(DEFUN |UnivariateLaurentSeries| (&REST #1=#:G162)
  (SPROG NIL
         (PROG (#2=#:G163)
           (RETURN
            (COND
...
(DEFUN |UnivariateLaurentSeries;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G161 NIL) (|pv$| NIL) (#2=#:G151 NIL) (#3=#:G152 NIL) (#4=#:G154 NIL)
    (#5=#:G155 NIL) (#6=#:G156 NIL) (#7=#:G157 NIL) (#8=#:G159 NIL)
    (#9=#:G160 NIL) ($ NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|UnivariateLaurentSeries| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|UnivariateLaurentSeriesConstructor| 6 32)
              ...
              (|Pattern| 47) (|Pattern| 16) (|UnivariateTaylorSeries| 6 7 8)
              ...
              (|Factored| 44) (|DoubleFloat|) (|Float|)
              (|Union| 50 '#2="failed") (|Union| 16 '#2#) (|Fraction| 16)
            ...
            (CONS
             ...
             (CONS
              '#((|UnivariateLaurentSeriesConstructorCategory| 6
                 ...
                 (|RetractableTo| 50) (|RetractableTo| 16)
