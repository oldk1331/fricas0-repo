...
(SDEFUN |FMTCAT-;numberOfPrimes;OfI;3| ((|a2| (|OutputForm|)) (% (|Integer|)))
        (SPROG
         ((|aa2| (|List| (|OutputForm|))) (|o2| (|String|))
          (|opex| (|OutputForm|)) (#1=#:G51 NIL) (#2=#:G52 NIL) (|i| NIL)
...
(SDEFUN |FMTCAT-;float?| ((|s| (|String|)) (% (|Boolean|)))
        (SPROG
         ((#1=#:G82 NIL) (|i| (|Integer|)) (#2=#:G80 NIL) (#3=#:G81 NIL)
          (|n| (|NonNegativeInteger|)) (#4=#:G83 NIL) (|d| (|Integer|)))
         (SEQ
          (EXIT
           (COND
            ((ZEROP
...
(SDEFUN |FMTCAT-;nary;SI2M;22!0| ((|prec| NIL) (|args| NIL) ($$ NIL))
        (PROG (% |sep| |p| |hh|)
          ...
          (RETURN
           (PROGN
            (SPROG ((|l| NIL) (#1=#:G132 NIL) (|a| NIL) (|sepbox| NIL))
                   (SEQ
                    (COND
...
(SDEFUN |FMTCAT-;naryPlus;2SI2M;24!0| ((|prec| NIL) (|args| NIL) ($$ NIL))
        (PROG (% |p| |hh| |minus| |plus|)
          ...
          (RETURN
           (PROGN
            (SPROG ((|l| NIL) (|sep| NIL) (|a| NIL) (#1=#:G146 NIL))
                   (SEQ
                    (COND
                     ((SPADCALL |args| (QREFELT % 82))
                      (SPADCALL (QREFELT % 67)))
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 88
                                            '(1 12 10 11 13 1 12 10 11 14 1 12
                                              ...
                                              43 1 0 37 15 40 2 0 37 11 7 65 1
                                              0 37 11 66 1 0 46 7 71 1 0 46 15
