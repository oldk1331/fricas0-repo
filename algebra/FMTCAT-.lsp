...
(SDEFUN |FMTCAT-;numberOfPrimes;OfI;3| ((|a2| |OutputForm|) ($ |Integer|))
        (SPROG
         ((|aa2| (|List| (|OutputForm|))) (|o2| (|String|))
          (|opex| (|OutputForm|)) (#1=#:G153 NIL) (#2=#:G154 NIL) (|i| NIL)
...
(SDEFUN |FMTCAT-;float?| ((|s| |String|) ($ |Boolean|))
        (SPROG
         ((#1=#:G179 NIL) (|i| (|Integer|)) (#2=#:G177 NIL) (#3=#:G178 NIL)
          (|n| (|NonNegativeInteger|)) (#4=#:G180 NIL) (|d| (|Integer|)))
         (SEQ
          (EXIT
           (COND
            ((ZEROP
                       ...
                       ((NULL
                        ...
                        (COND
                         ((NULL
                           (|eql_SI| (SPADCALL |s| |i| (QREFELT $ 18))
                                     (SPADCALL (QREFELT $ 35))))
                          (PROGN (LETT #3# |$NoValue|) (GO #7=#:G166))))))
                      (EXIT (LETT |i| (+ |i| 1))))
                     NIL (GO G190) G191 (EXIT NIL)))
               #7# (EXIT #3#))
              (EXIT
...
(SDEFUN |FMTCAT-;formatFunctionSymbol;SOb;9| ((|s| |String|) ($ |OutputBox|))
        (SPADCALL |s| (QREFELT $ 38))) 

(SDEFUN |FMTCAT-;formatFunction|
        ((|b| |OutputBox|) (|args| |List| (|OutputForm|)) ($ |OutputBox|))
...
(SDEFUN |FMTCAT-;nary;SI2M;22!0| ((|prec| NIL) (|args| NIL) ($$ NIL))
        (PROG ($ |sep| |p| |hh|)
          ...
          (RETURN
           (PROGN
            (SPROG ((|l| NIL) (#1=#:G228 NIL) (|a| NIL) (|sepbox| NIL))
                   (SEQ
                    (COND
...
(SDEFUN |FMTCAT-;naryPlus;2SI2M;24!0| ((|prec| NIL) (|args| NIL) ($$ NIL))
        (PROG ($ |p| |hh| |minus| |plus|)
          ...
          (RETURN
           (PROGN
            (SPROG ((|l| NIL) (|sep| NIL) (|a| NIL) (#1=#:G241 NIL))
                   (SEQ
                    (COND
                     ((SPADCALL |args| (QREFELT $ 82))
                      (SPADCALL (QREFELT $ 67)))
