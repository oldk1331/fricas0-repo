...
(SDEFUN |FMTCAT-;numberOfPrimes;OfI;3| ((|a2| (|OutputForm|)) (% (|Integer|)))
        (SPROG
         ((|s2| (|String|)) (|n| (|NonNegativeInteger|)) (|i| NIL)
          (#1=#:G53 NIL) (#2=#:G52 NIL) (|opex| (|OutputForm|))
          (|o2| (|String|)) (|aa2| (|List| (|OutputForm|))))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |FMTCAT-;float?| ((|s| (|String|)) (% (|Boolean|)))
        (SPROG
         ((|d| (|Integer|)) (#1=#:G84 NIL) (|n| (|NonNegativeInteger|))
          (#2=#:G82 NIL) (#3=#:G81 NIL) (|i| (|Integer|)) (#4=#:G83 NIL))
         (SEQ
          (EXIT
           (COND
            ((ZEROP
                       ...
                       ((NULL
                        ...
                        (COND
                         ((NULL
                           (|eql_SI| (SPADCALL |s| |i| (QREFELT % 18))
                                     (SPADCALL (QREFELT % 35))))
                          (PROGN (LETT #2# |$NoValue|) (GO #7=#:G68))))))
                      (EXIT (LETT |i| (+ |i| 1))))
                     NIL (GO G190) G191 (EXIT NIL)))
               #7# (EXIT #2#))
              (EXIT
               (COND ((> |i| |n|) (PROGN (LETT #4# 'T) (GO #6#)))
                     ((SPADCALL (SPADCALL |s| |i| (QREFELT % 18))
                             ...
                             (EXIT
                              (COND
                               ((SPADCALL (SPADCALL |s| |i| (QREFELT % 18))
                                          (QREFELT % 34))
                                (LETT |i| (+ |i| 1)))
                               ('T (PROGN (LETT #4# NIL) (GO #6#))))))
                            NIL (GO G190) G191 (EXIT NIL))
                       (EXIT (PROGN (LETT #4# 'T) (GO #6#)))))))))))
          #6# (EXIT #4#)))) 
...
(SDEFUN |FMTCAT-;formatFunction;ObLOb;10|
        ...
        (SPROG ((|x| NIL) (#1=#:G95 NIL) (|bx| (|OutputBox|)))
               (SEQ
                (COND
                 ((NULL |lb|)
                  (SPADCALL
...
(SDEFUN |FMTCAT-;formatExpression;OfIOb;12|
        ...
        (SPROG
         ((|operatorData|
          ...
          (|s| (|String|)) (|str| #1=(|String|)) (|opex| (|OutputForm|))
          (|args| (|List| (|OutputForm|))) (#2=#:G113 NIL) (#3=#:G114 NIL)
          (|nargs| (|Integer|)) (|op| #1#) (#4=#:G115 NIL) (|a| NIL)
          (#5=#:G116 NIL) (|bargs| (|List| (|OutputBox|))))
                        ...
                        (EXIT
                         (SEQ
                          (LETT |bargs|
                                (PROGN
                                 (LETT #2# NIL)
                                 (SEQ (LETT |a| NIL) (LETT #3# |args|) G190
                                      (COND
                                       ((OR (ATOM #3#)
                        ...
                        (#6#
                         (SEQ
                          (LETT |bargs|
                                (PROGN
                                 (LETT #4# NIL)
                                 (SEQ (LETT |a| NIL) (LETT #5# |args|) G190
                                      (COND
                                       ((OR (ATOM #5#)
...
(SDEFUN |FMTCAT-;nary;SI2M;23!0| ((|prec| NIL) (|args| NIL) ($$ NIL))
        (PROG (% |sep| |p| |hh|)
          ...
          (RETURN
           (PROGN
            (SPROG ((|sepbox| NIL) (|a| NIL) (#1=#:G152 NIL) (|l| NIL))
                   (SEQ
                    (COND
...
(SDEFUN |FMTCAT-;naryPlus;2SI2M;25!0| ((|prec| NIL) (|args| NIL) ($$ NIL))
        (PROG (% |p| |hh| |minus| |plus|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G166 NIL) (|a| NIL) (|sep| NIL) (|l| NIL))
                   (SEQ
                    (COND
                     ((SPADCALL |args| (QREFELT % 87))
                      (SPADCALL (QREFELT % 44)))
