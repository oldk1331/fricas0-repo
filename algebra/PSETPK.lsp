...
(SDEFUN |PSETPK;removeRoughlyRedundantFactorsInPols;2LBL;12|
        ...
        (SPROG
         ((|newlp| (|List| P)) (|stop| (|Boolean|)) (|p| (P)) (#1=#:G299 NIL)
...
(SDEFUN |PSETPK;interReduce;2L;18| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|rs| (|List| P)) (|ps| (|List| P)) (#1=#:G342 NIL) (|r| (P))
          (|p| (P)))
         (SEQ
          (EXIT
                ...
                (EXIT
                 (SEQ G190 NIL
                      (SEQ
                       (EXIT
                        (COND
                         ((NULL |ps|) (PROGN (LETT #1# |rs|) (GO #2=#:G341)))
                         ('T
                          (SEQ
                           (LETT |ps|
...
(SDEFUN |PSETPK;crushedSet;2L;22| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|finished| #1=(|Boolean|)) (#2=#:G371 NIL) (|contradiction| #1#)
          (|rec|
           (|Union|
...
(SDEFUN |PSETPK;rewriteSetByReducingWithParticularGenerators;LMMML;23|
        ((|ps| |List| P) (|pred?| |Mapping| (|Boolean|) P)
         ...
         ($ |List| P))
        (SPROG
         ((|rs| (|List| P)) (|contradiction| #1=(|Boolean|)) (#2=#:G388 NIL)
          (|stop| #1#) (|bs1| (|GeneralTriangularSet| R E V P))
          (|bs2| (|GeneralTriangularSet| R E V P)) (#3=#:G387 NIL)
...
(SDEFUN |PSETPK;irreducibleFactors;2L;26| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|newlp| (|List| P)) (|lf| (|List| P)) (#1=#:G425 NIL) (|rrz| NIL)
          (#2=#:G424 NIL)
          (|lrrz|
           (|List|
...
(SDEFUN |PSETPK;lazyIrreducibleFactors;2L;27| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|newlp| (|List| P)) (|lf| (|List| P)) (#1=#:G435 NIL) (|rrz| NIL)
          (#2=#:G434 NIL)
          (|lrrz|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
...
(SDEFUN |PSETPK;squareFreeFactors;PL;29| ((|p| P) ($ |List| P))
        (SPROG
         ((|lsf| (|List| P)) (#1=#:G445 NIL) (|foo| NIL) (#2=#:G444 NIL)
          (|sfp| (|Factored| P)))
...
(SDEFUN |PSETPK;removeSquaresIfCan;2L;32| ((|lp| |List| P) ($ |List| P))
        (SPROG ((#1=#:G466 NIL) (|p| NIL) (#2=#:G465 NIL))
               (SEQ
                (COND ((NULL |lp|) |lp|)
                      ('T
                       (SPADCALL
...
(SDEFUN |PSETPK;removeRoughlyRedundantFactorsInContents;3L;34|
        ...
        (SPROG
         ((|newps| (|List| P)) (|newp| (P)) (|newcp| (P)) (#1=#:G475 NIL)
          (|test| (|Union| P "failed")) (|copylf| (|List| P)) (|f| (P))
          (#2=#:G492 NIL) (#3=#:G491 NIL) (|cp| (P)) (|p| (P)))
         (SEQ
          (COND ((NULL |ps|) |ps|)
                ('T
                 (SEQ (LETT |newps| NIL)
...
(SDEFUN |PSETPK;removeRedundantFactorsInContents;3L;35|
        ...
        (SPROG
         ((|newps| (|List| P)) (|newp| (P)) (|newcp| (P)) (#2=#:G495 NIL)
...
(SDEFUN |PSETPK;removeRedundantFactorsInPols;3L;36|
        ((|ps| |List| P) (|lf| . #1=(|List| P)) ($ |List| P))
        (SPROG
         ((|newps| (|List| P)) (|newp| (P)) (#2=#:G511 NIL) (|g| (P))
...
(SDEFUN |PSETPK;unprotectedRemoveRedundantFactors;2PL;42|
        ((|a| P) (|b| P) ($ |List| P))
        (SPROG
         ((#1=#:G560 NIL) (|d| (P)) (|#G102| (P)) (|#G101| (P)) (#2=#:G553 NIL)
          (|c| (|Union| P #3="failed")))
         (SEQ
          (EXIT
           (SEQ (LETT |c| (SPADCALL |b| |a| (QREFELT $ 45)))
...
(SDEFUN |PSETPK;removeRedundantFactors;2L;43| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|top| (|List| P)) (|base| (|List| P)) (|p| (P)) (#1=#:G576 NIL)
          (#2=#:G575 NIL) (#3=#:G574 NIL) (#4=#:G573 NIL))
...
(DEFUN |PolynomialSetUtilitiesPackage| (&REST #1=#:G604)
  (SPROG NIL
         (PROG (#2=#:G605)
           (RETURN
            (COND
