                ...
                (EXIT
                 (SEQ G190 NIL
                      (SEQ
                       (EXIT
                        (COND
                         ((NULL |ps|) (PROGN (LETT #1# |rs|) (GO #2=#:G325)))
                         ('T
                          (SEQ
                           (LETT |ps|
...
(SDEFUN |PSETPK;crushedSet;2L;22| ((|lp| |List| P) ($ |List| P))
        (SPROG
         ((|finished| #1=(|Boolean|)) (#2=#:G355 NIL) (|contradiction| #1#)
          (|rec|
           (|Union|
