...
(MAKEPROP '|PAdicRational| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|PAdicRationalConstructor| 6 15)
              ...
              (|Equation| 15) (|List| 16) (|List| 15) (|List| 20) (|Symbol|)
              ...
              (|Union| 36 '#2#) (|Fraction| 24) (|Union| 20 '#2#)
            ...
            (CONS
             ...
             (CONS
              '#((|QuotientFieldCategory| (|PAdicInteger| 6)) (|Field|)
                 ...
                 (|Algebra| $$) (|LinearlyExplicitRingOver| (|PAdicInteger| 6))
                 (|Module| (|PAdicInteger| 6)) (|Module| 36)
                 (|CommutativeRing|) (|EntireRing|) (|Module| $$)
                 (|CharacteristicNonZero|) (|CharacteristicZero|)
                 (|OrderedRing|) (|PartialDifferentialRing| 20)
                 ...
                 (|RetractableTo| 20) (|ConvertibleTo| 11) (|ConvertibleTo| 33)
                 (|ConvertibleTo| 32) (|PartialOrder|) (|RetractableTo| 36)
                 (|RetractableTo| 24) (|InnerEvalable| 20 (|PAdicInteger| 6))
