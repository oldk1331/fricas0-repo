...
(SDEFUN |IMODHP;eval1s|
        ...
        (SPROG
         ((|resl| (|List| (|U32Vector|))) (|nlc| (|Integer|))
          (|dms| (|SingleInteger|)) (#2=#:G157 NIL) (|dm| #3=(|Integer|))
          (|nm| #3#)
          (|nlcq|
           (|Record| (|:| |numer| (|Polynomial| (|Integer|)))
                     (|:| |denom| (|Polynomial| (|Integer|)))))
          (#4=#:G159 NIL) (|j| NIL) (|ress| (|U32Vector|))
          (|n| (|NonNegativeInteger|)) (#5=#:G158 NIL) (|gv0| NIL) (|p| #1#))
         (SEQ
          (EXIT
         ...
         ((|resl|
          ...
          (|ress|
           (|PrimitiveArray|
            (|Record| (|:| |numer| (|Polynomial| (|Integer|)))
                      (|:| |denom| (|Polynomial| (|Integer|))))))
          (|n| (|NonNegativeInteger|)) (#3=#:G181 NIL) (|gv0| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |resl| NIL)
          ...
          (|res1|
           (|Union|
            (|Record| (|:| |numer| (|Polynomial| (|Integer|)))
                      (|:| |denom| (|Polynomial| (|Integer|))))
            "failed"))
          (|nlcq| (|Fraction| (|Polynomial| (|Integer|)))) (#2=#:G199 NIL)
          (|j| NIL)
          (|ress|
           (|PrimitiveArray|
            (|Record| (|:| |numer| (|Polynomial| (|Integer|)))
                      (|:| |denom| (|Polynomial| (|Integer|))))))
          (|n| (|NonNegativeInteger|)) (#3=#:G198 NIL) (|gv0| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |resl| NIL)
                (SEQ (LETT |gv0| NIL) (LETT #3# |gvl|) G190
        ...
        ((|gv| (|Vector| (|U32Vector|))) (|ve| (|Vector| (|Integer|)))
         ...
         (%
          (|Union|
           ...
           "no_solution")))
        (SPROG
         ((#2=#:G244 NIL) (|j| (|Integer|)) (#3=#:G243 NIL) (#4=#:G251 NIL)
          (|i| NIL) (|cindk| (|Integer|)) (#5=#:G250 NIL) (|k| NIL)
          (#6=#:G249 NIL) (#7=#:G248 NIL)
          ...
          (#9=#:G247 NIL) (|m2| #10=(|NonNegativeInteger|))
          (|va| (|Vector| (|Integer|))) (|dva| #8#) (|blr| (|List| (|Any|)))
          (|nve| (|Vector| (|Integer|))) (|ngv| (|Vector| (|U32Vector|)))
          (#11=#:G246 NIL) (|m1| (|NonNegativeInteger|)) (#12=#:G245 NIL)
          (|m0| #10#))
         (SEQ
          (EXIT
...
(SDEFUN |IMODHP;compute_blocks|
        ...
        (SPROG
         ((#1=#:G256 NIL) (|i| NIL) (|block_offsets| (|Vector| (|Integer|))))
...
(SDEFUN |IMODHP;merge_exponents;IVSevVSevL;7|
        ...
        (SPROG
         ((|j0| (|Integer|)) (|i0| (|Integer|)) (|j| (|Integer|))
          (|i| (|Integer|)) (|ci| (|Integer|)) (#1=#:G288 NIL)
          (|j0i| (|Integer|)) (|ji| #2=(|Integer|)) (|jl| (|List| (|Integer|)))
          (|i0i| (|Integer|)) (|ii| #2#) (|il| (|List| (|Integer|)))
          (#3=#:G292 NIL) (|k| NIL) (|lj| (|Integer|)) (|li| (|Integer|))
          (#4=#:G289 NIL) (#5=#:G291 NIL) (|jj| NIL) (#6=#:G290 NIL)
...
(SDEFUN |IMODHP;merge2;I2LVSevVSevR;8|
        ...
        (SPROG
         ((#1=#:G324 NIL) (|i| (|Integer|)) (|ci| (|Integer|))
          (|i00| (|Integer|)) (|i0| (|Integer|)) (|j0| (|Integer|))
          (|j| (|Integer|)) (#2=#:G323 NIL) (|k| NIL) (|j00| (|Integer|))
          (#3=#:G322 NIL) (|lj| #4=(|Integer|)) (|li| #4#) (|kk| (|Integer|))
          (#5=#:G321 NIL) (|ci0| (|Integer|)) (|nv1| (|Integer|))
          (|noffsets| (|Vector| (|Integer|))) (|m| (|NonNegativeInteger|))
          (|nexps| (|SortedExponentVector|)) (#6=#:G295 NIL)
...
(SDEFUN |IMODHP;check_defects|
        ...
        (SPROG
         ((#4=#:G345 NIL) (#5=#:G344 NIL) (|is_bad| (|Boolean|))
          (|all_bad| (|Boolean|)) (#6=#:G346 NIL) (|i| NIL) (|ociv| #2#)
          (|ova| #1#) (|nsols| #3#))
         (SEQ
          (EXIT
           (SEQ (LETT |nsols| (QVELT |pss| 9))
                ...
                (EXIT
                 (COND
                  (|is_bad|
                   (PROGN (LETT #4# (CONS 1 "failed")) (GO #8=#:G343)))
            ...
            (|List|
             (|PrimitiveArray|
              (|Record| (|:| |numer| (|Polynomial| (|Integer|)))
                        (|:| |denom| (|Polynomial| (|Integer|))))))
            "failed"))
          (#6=#:G395 NIL) (|i| NIL) (|nev| #7=(|SortedExponentVector|))
          (#8=#:G376 NIL) (|ncv| #9=(|U32Vector|)) (#10=#:G374 NIL)
          (|k| (|Integer|)) (|cpl| (|Integer|)) (#11=#:G394 NIL) (|l| NIL)
          (|cp| (|U32Vector|)) (|mm| (|Integer|)) (|k1| (|Integer|))
          (#12=#:G393 NIL) (|j| NIL) (#13=#:G392 NIL)
          (|ov| (|Vector| (|Integer|))) (|ev| #7#) (#14=#:G363 NIL) (|cv| #9#)
          (#15=#:G361 NIL) (|r_cnt| (|Integer|)) (#16=#:G391 NIL)
                  ...
                  ((EQL |nvars| 1)
                   (SEQ
                    ...
                    (EXIT
                     (COND
                      ((QEQCAR |ngv10p| 1)
                       (PROGN (LETT #5# (CONS 1 "failed")) (GO #21=#:G389)))
                      (#22='T
          ...
          (|pp|
           (|Union|
            (|Record| (|:| |nvars| (|Integer|))
                      ...
                      (|:| |coeffdata| (|U32Vector|)))
            "failed"))
          (#6=#:G459 NIL) (|j| NIL) (|hi| #7=(|Integer|)) (|lo| #7#)
          (|invc| (|Integer|)) (#8=#:G452 NIL) (|ok| #9=(|Boolean|))
          (|nofi| #7#) (|ofi| #7#) (|ofin| #10=(|Integer|)) (|cnum| #7#)
          (#11=#:G458 NIL) (|i| (|Integer|)) (|n1| (|NonNegativeInteger|))
          (|block_offsets| (|Vector| (|Integer|))) (|coeffs| (|U32Vector|))
          (|jl| (|Integer|)) (|ndl| #12=(|List| (|Integer|))) (#13=#:G457 NIL)
          ...
          (|pprp|
           (|Union|
            (|Record| (|:| |defects| (|Vector| (|Integer|)))
                      ...
                      (|:| |coeffdata| (|U32Vector|)))
            "failed" "no_solution"))
          (|qn| (|Integer|)) (#15=#:G456 NIL) (|k| NIL) (|pts| #1#)
          (|npt| (|Integer|)) (|lpt| (|List| (|Integer|))) (#16=#:G453 NIL)
        ...
        ((|vars| (|List| (|Symbol|)))
         ...
         (%
          (|Union|
           ...
           "no_solution")))
        (SPROG
         ((#3=#:G509 NIL) (#4=#:G510 NIL)
          (|pp| (|Union| (|PrimitiveArray| (|Integer|)) "failed"))
          (#5=#:G513 NIL) (|j| NIL) (|hi| #6=(|Integer|)) (|lo| #6#)
          (|invc| (|Integer|)) (#7=#:G507 NIL) (|ok| #8=(|Boolean|))
          (|nofi| #6#) (|ofi| #6#) (|ofin| #9=(|Integer|)) (|cnum| #6#)
          (#10=#:G512 NIL) (|i| (|Integer|)) (|n1| (|NonNegativeInteger|))
          (|block_offsets| (|Vector| (|Integer|))) (|coeffs| (|U32Vector|))
          (|jl| (|Integer|)) (|ndl| #11=(|List| (|Integer|))) (#12=#:G511 NIL)
          (|ncoeffs| (|U32Vector|)) (|nn| (|NonNegativeInteger|))
          (|n0| (|NonNegativeInteger|))
            ...
            (|List|
             (|PrimitiveArray|
              (|Record| (|:| |numer| (|Polynomial| (|Integer|)))
                        (|:| |denom| (|Polynomial| (|Integer|))))))
            "failed"))
          (|lp| (|List| (|Integer|))) (#13=#:G508 NIL) (|p| (|Integer|))
