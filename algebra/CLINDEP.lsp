...
(SDEFUN |CLINDEP;kmap|
        ((|k| (|Kernel| F)) (|ldmvar| (|List| (|Kernel| F)))
         ...
         (% (|Expression| F)))
        (SPROG
         ((|dmval| NIL) (#1=#:G33 NIL) (|dmvar| NIL) (#2=#:G32 NIL)
          (#3=#:G31 NIL) (|kf| (F)) (|d| NIL) (#4=#:G34 NIL)
          (|is_const| (|Boolean|)) (#5=#:G30 NIL) (|op| (|BasicOperator|))
          (|args| (|List| F)) (|u| (|Union| (|None|) "failed"))
          (|n| (|NonNegativeInteger|)) (|a1| (F)) (|da| #6=(|Kernel| F))
          (|sa1| #7=(|Symbol|)) (|a2| (F)) (|da2| #6#) (|sa2| #7#)
          (|kmap1| (|Mapping| (|Expression| F) (|Kernel| F))) (#8=#:G35 NIL)
          (|a| NIL) (#9=#:G36 NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ (LETT |dmval| NIL) (LETT #1# |ldmval|) (LETT |dmvar| NIL)
                 (LETT #2# |ldmvar|) G190
                 (COND
                  ((OR (ATOM #2#) (PROGN (LETT |dmvar| (CAR #2#)) NIL)
                       (ATOM #1#) (PROGN (LETT |dmval| (CAR #1#)) NIL))
                   (GO G191)))
                 (SEQ
                  (EXIT
                   (COND
                    ((SPADCALL |k| |dmvar| (QREFELT % 11))
                     (PROGN (LETT #3# |dmval|) (GO #10=#:G29))))))
                 (LETT #2# (PROG1 (CDR #2#) (LETT #1# (CDR #1#)))) (GO G190)
                 G191 (EXIT NIL))
            (LETT |is_const| 'T) (LETT |kf| (SPADCALL |k| (QREFELT % 13)))
            (SEQ
             (EXIT
              (SEQ (LETT |d| NIL) (LETT #4# |ld|) G190
                   (COND
...
(SDEFUN |CLINDEP;constant_subspace;LLR;15|
        ...
        (SPROG
         ((|nc| (|NonNegativeInteger|)) (|nr| (|NonNegativeInteger|))
          (#1=#:G105 NIL) (#2=#:G106 NIL) (|m0b| #3=(|Matrix| F))
          (|m0| (|Matrix| F)) (|m1| (|Matrix| F)) (#4=#:G107 NIL)
          (|k1| #5=(|Integer|)) (#6=#:G104 NIL) (|k| #5#)
          (|lri| (|List| (|Integer|))) (|lpiv| (|List| (|Integer|)))
          (#7=#:G108 NIL) (|j| NIL) (#8=#:G109 NIL) (|kk| (|Integer|))
          (|lpiv1| (|List| (|Integer|))) (|d1| NIL) (#9=#:G110 NIL)
          (|ll1| (|List| F)) (|ll| (|List| (|List| F)))
          (|lr| (|List| (|Vector| F))) (|m| (|Matrix| F))
          (|s1| (|List| (|Vector| F))) (#10=#:G111 NIL) (#11=#:G112 NIL)
          (|l3| (|List| (|Vector| F))) (#12=#:G113 NIL) (#13=#:G114 NIL)
          (#14=#:G115 NIL) (|i| NIL) (#15=#:G116 NIL) (|m2| #3#)
          (#16=#:G117 NIL) (|bv| NIL) (#17=#:G118 NIL))
         (SEQ
          (COND
           ...
           ('T
            (SEQ (LETT |nc| (QVSIZE (|SPADfirst| |b|)))
                 ...
                 (SEQ (LETT |i| 1) (LETT #4# (ANROWS |m1|)) G190
                       ...
                       (EXIT
                        (SEQ (LETT |k1| |k|)
                             ...
                             (EXIT
                              (COND
                               ((< |nc| |k1|)
                                (PROGN (LETT #6# |$NoValue|) (GO #18=#:G76)))
                               ('T
                                (SEQ (LETT |k| |k1|)
                                     (EXIT
                                      (COND
                 ...
                 (LETT |ll| NIL)
                 (SEQ (LETT |i| NIL) (LETT #7# |lri|) G190
                      (COND
                                ...
                                (SEQ
                                 (EXIT
                                  (COND
                                   ...
                                   ('T
                                    (SEQ (LETT |d1| NIL) (LETT #9# |ld|) G190
                                         (COND
                                          ((OR (ATOM #9#)
                                               (PROGN
                                                (LETT |d1| (CAR #9#))
                 ...
                 (LETT |l3|
                       (PROGN
                        (LETT #10# NIL)
                        (SEQ (LETT |bv| NIL) (LETT #11# |s1|) G190
                             (COND
                              ((OR (ATOM #11#)
                 ...
                 (LETT |m2|
                       (SPADCALL
                        (PROGN
                         (LETT #12# NIL)
                         (SEQ (LETT |bv| NIL) (LETT #13# |l3|) G190
                              (COND
                               ((OR (ATOM #13#)
                 ...
                 (EXIT
                  (CONS |m2|
                        (PROGN
                         (LETT #16# NIL)
                         (SEQ (LETT |bv| NIL) (LETT #17# |l3|) G190
                              (COND
                               ((OR (ATOM #17#)
