...
(SDEFUN |INTHERAL;HermiteIntegrate;RMRR;2|
        ...
        (SPROG
         ((|n| (|PositiveInteger|))
          ...
          (|m| (|Matrix| UP))
          (|cform| #1=(|Record| (|:| |num| #2=(|Vector| UP)) (|:| |den| UP)))
          (|e| (UP)) (|coef| (UP)) (|trm| NIL) (#3=#:G35 NIL) (|v| (UP))
          (|u| (UP)) (|u'| (UP)) (|sys| (|Matrix| UP)) (|nn| (|Integer|))
          (#4=#:G24 NIL) (|j| (|NonNegativeInteger|)) (|p| (UP))
          (|sol| (|Vector| UP)) (|s0| (R)) (|corr| #1#) (|cnum| #2#)
          (|ratform| (R)) (#5=#:G37 NIL) (|i| NIL) (#6=#:G38 NIL)
          (#7=#:G36 NIL) (#8=#:G17 NIL) (|inum| #2#) (|iden| (UP)))
                ...
                ('T
                 (SEQ
                  ...
                  (SEQ (LETT |trm| NIL)
                       ...
                       G190
                       (COND
                        ((OR (ATOM #3#) (PROGN (LETT |trm| (CAR #3#)) NIL))
                         (GO G191)))
                       (SEQ
                        (EXIT
                         (COND
...
(SDEFUN |INTHERAL;localsolve|
        ((|mat| (|Matrix| UP)) (|vec| (|Vector| UP)) (|modulus| (UP))
         (% (|Vector| UP)))
        (SPROG
         ((|ans| (|Vector| UP)) (|k| NIL) (#1=#:G60 NIL) (|j| NIL)
          (#2=#:G59 NIL) (#3=#:G58 NIL)
          (|sol| (|Union| (|Vector| (|Fraction| UP)) "failed")) (|i| NIL)
          (#4=#:G61 NIL)
          (|bc|
                  ...
                  ((SPADCALL |mat| (QREFELT % 58))
                   (SEQ
                    (SEQ (LETT |k| (PROGN |mat| 1))
                         (LETT #1# (SPADCALL |mat| (QREFELT % 60)))
                         (LETT |j| (PROGN |mat| 1))
                         (LETT #2# (SPADCALL |mat| (QREFELT % 59)))
                         ...
                         (SEQ
                          ...
                          (EXIT
                           (COND
                            ((QEQCAR |bc| 1)
                             (PROGN
                              (LETT #5# (MAKEARR1 0 (|spadConstant| % 11)))
                              (GO #6=#:G56)))
