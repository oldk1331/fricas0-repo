        ...
        (SPROG
         ((|fobs|
          ...
          (|f|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))))
          (#1=#:G144 NIL) (|fn| NIL) (|too| (|NonNegativeInteger|))
          (|fromo| (|NonNegativeInteger|)) (#2=#:G143 NIL) (|a| NIL)
          (|arrs| (|List| (|NonNegativeInteger|))) (#3=#:G142 NIL) (|x| NIL)
          (#4=#:G141 NIL))
         (SEQ
          (LETT |arrs|
                (PROGN
         ...
         ((|obs|
          ...
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     ...
                     (|:| |next| (|NonNegativeInteger|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|n| (|NonNegativeInteger|)) (#1=#:G156 NIL) (|j| NIL)
          (#2=#:G154 NIL) (|vert| NIL) (#3=#:G155 NIL) (|i| NIL)
         ...
         ((|obs|
          ...
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     ...
                     (|:| |next| (|NonNegativeInteger|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|n| (|NonNegativeInteger|)) (|ob| (S)) (#1=#:G189 NIL) (|obn| NIL))
         ...
         ((|obs|
          ...
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     ...
                     (|:| |next| (|NonNegativeInteger|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|n| (|NonNegativeInteger|)) (|ob| (S)) (#1=#:G196 NIL) (|obn| NIL))
...
(SDEFUN |FNGRPH;unit;LS$;14| ((|objs| |List| S) (|arrowName| |String|) ($ $))
        (SPROG ((#1=#:G201 NIL) (|x| NIL) (#2=#:G200 NIL))
               (SEQ
                (LETT |objs|
                      (PROGN
...
(SDEFUN |FNGRPH;indexProd|
        ((|aObj| $) (|a| |NonNegativeInteger|) (|b| |NonNegativeInteger|)
         ($ |NonNegativeInteger|))
        (SPROG ((|x| (|NonNegativeInteger|)) (#1=#:G214 NIL))
               (SEQ
                (LETT |x|
                      (+ |a|
                         (*
...
(SDEFUN |FNGRPH;*;2$Fg;19|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #5=(|NonNegativeInteger|)) (|bi| (S)) (#6=#:G227 NIL)
...
(SDEFUN |FNGRPH;closedTensor;2$M$;20|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #1#) (|bi| (S)) (#5=#:G236 NIL) (|boi| NIL) (|ani| #3#)
          (|ayi| #2#) (|axi| #1#) (|ai| (S)) (#6=#:G235 NIL) (|aoi| NIL))
...
(SDEFUN |FNGRPH;map;$LL2I$;21|
        ...
        (SPROG
         ((|nwob|
          ...
          (#5=#:G241 NIL) (|newX| (|NonNegativeInteger|)) (#6=#:G240 NIL)
          (|newObj| (S)) (|inext| #4#) (|i| #4#) (|oldObj| #2#) (#7=#:G252 NIL)
          (|oi| NIL)
          (|oldObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
...
(SDEFUN |FNGRPH;mapContra;$LL2I$;22|
        ...
        (SPROG
         ((|nwob|
          ...
          (|newY| (|NonNegativeInteger|)) (#5=#:G258 NIL)
          (|newX| (|NonNegativeInteger|)) (#6=#:G257 NIL) (|newObj| (S))
          (|inext| #4#) (|i| #4#) (|oldObj| #2#) (#7=#:G270 NIL) (|oi| NIL)
          (|oldObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|))
...
(MAKEPROP '|FunctionGraph| '|infovec|
          (LIST
           ...
           '#(~= 187 |unit| 193 |terminal| 199 |subdiagramSvg| 204
              ...
              555 |coAdjoint| 565 |closedTensor| 571 |arrowsToNode| 578
              |arrowsToArrow| 584 |arrowsFromNode| 590 |arrowsFromArrow| 596
              |arrowName| 602 |apply| 609 |adjacencyMatrix| 615 |addObject!|
              620 |addArrow!| 632 = 663 + 669 * 675)
           'NIL
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 99
                                            '(3 15 13 0 14 13 16 2 18 17 0 14
                                              ...
                                              79 0 15 82 1 0 98 0 1 1 0 98 0 1
                                              2 0 79 0 15 80 3 0 0 0 0 66 67 2
                                              0 15 0 13 1 2 0 15 0 13 1 2 0 15
                                              0 13 1 2 0 15 0 13 1 3 0 41 0 13
                                              13 1 2 0 13 0 13 83 1 0 93 0 1 2
                                              0 0 0 17 39 2 0 0 0 6 38 5 0 0 0
                                              41 13 13 15 1 4 0 0 0 41 6 6 1 2
                                              0 0 0 22 1 4 0 0 0 41 13 13 42 2
                                              0 27 0 0 1 2 0 0 0 0 54 2 0 63 0
                                              0 65)))))
           '|lookupComplete|)) 
