                 ...
                 (SEQ (LETT |x| NIL) (LETT #2# |ob|) G190
                      (COND
                       ((OR (ATOM #2#) (PROGN (LETT |x| (CAR #2#)) NIL))
                        (GO G191)))
                      (SEQ (EXIT (LETT #1# (CONS (VECTOR |x| 0 0 0 NIL) #1#))))
...
(SDEFUN |FNGRPH;functionGraph;LL%;3|
        ((|ob|
         ...
         (% (%)))
        (SPROG
         ((#1=#:G41 NIL) (|x| NIL) (#2=#:G42 NIL)
          (|arrs| (|List| (|NonNegativeInteger|))) (|a| NIL) (#3=#:G43 NIL)
         ...
         (SEQ
          ...
          (LETT |fobs| NIL)
          (SEQ (LETT |fn| 1) (LETT #4# (LENGTH |ob|)) G190
               (COND ((|greater_SI| |fn| #4#) (GO G191)))
...
(SDEFUN |FNGRPH;functionGraph;L%;4|
        ...
        (SPROG
         ((|perm| (|Permutation| S))
          (|lr|
           (|Record| (|:| |preimage| #1=(|List| S))
                     (|:| |image| #2=(|List| S))))
          (|im| #2#) (|preim| #1#) (|i| NIL) (#3=#:G57 NIL) (|vert| NIL)
          (#4=#:G56 NIL) (|j| NIL) (#5=#:G58 NIL) (|n| (|NonNegativeInteger|))
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))
                     (|:| |next| (|NonNegativeInteger|))
          ...
          (SEQ (LETT |i| 1) (LETT #3# (LENGTH |im|)) (LETT |vert| NIL)
               ...
               (COND
                ((OR (ATOM #4#) (PROGN (LETT |vert| (CAR #4#)) NIL)
                 ...
                 (GO G191)))
               (SEQ (LETT |n| 1)
                    (SEQ (LETT |j| 1) (LETT #5# (LENGTH |preim|)) G190
               ...
               (LETT #4# (PROG1 (CDR #4#) (LETT |i| (|inc_SI| |i|)))) (GO G190)
               G191 (EXIT NIL))
          (EXIT (LIST |obs|))))) 
...
(SDEFUN |FNGRPH;cycleOpen;LS%;12|
        ...
        (SPROG
         ((|obn| NIL) (#1=#:G94 NIL) (|ob| (S)) (|n| (|NonNegativeInteger|))
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))
                     (|:| |next| (|NonNegativeInteger|))
...
(SDEFUN |FNGRPH;cycleClosed;LS%;13|
        ((|objs| (|List| S)) (|arrowName| (|String|)) (% (%)))
        (SPROG
         ((|obn| NIL) (#1=#:G102 NIL) (|ob| (S)) (|n| (|NonNegativeInteger|))
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))
                     (|:| |next| (|NonNegativeInteger|))
...
(SDEFUN |FNGRPH;unit;LS%;14|
        ((|objs| (|List| S)) (|arrowName| (|String|)) (% (%)))
        (SPROG ((#1=#:G107 NIL) (|x| NIL) (#2=#:G108 NIL))
               (SEQ
                (LETT |objs|
                      (PROGN
                       (LETT #1# NIL)
...
(SDEFUN |FNGRPH;indexProd|
        ((|aObj| (%)) (|a| (|NonNegativeInteger|)) (|b| (|NonNegativeInteger|))
         (% (|NonNegativeInteger|)))
        (SPROG ((#1=#:G122 NIL) (|x| (|NonNegativeInteger|)))
               (SEQ
                (LETT |x|
                      (+ |a|
                         (*
...
(SDEFUN |FNGRPH;*;2%Fg;19|
        ...
        (SPROG
         ((|aoi| NIL) (#1=#:G136 NIL) (|ai| (S))
          (|axi| #2=(|NonNegativeInteger|)) (|ayi| #3=(|NonNegativeInteger|))
          (|ani| #4=(|NonNegativeInteger|)) (|boi| NIL) (#5=#:G137 NIL)
          (|bi| (S)) (|bxi| #2#) (|byi| #3#) (|bni| #4#)
          (|x| #6=(|NonNegativeInteger|)) (|y| #6#)
          (|nextA| (|NonNegativeInteger|)) (|sp| (|Product| S S))
          (|ob|
...
(SDEFUN |FNGRPH;closedTensor;2%M%;20|
        ((|a| (%)) (|b| (%)) (|f| (|Mapping| S S S)) (% (%)))
        (SPROG
         ((|aoi| NIL) (#1=#:G147 NIL) (|ai| (S))
          (|axi| #2=(|NonNegativeInteger|)) (|ayi| #3=(|NonNegativeInteger|))
          (|ani| #4=(|NonNegativeInteger|)) (|boi| NIL) (#5=#:G148 NIL)
          (|bi| (S)) (|bxi| #2#) (|byi| #3#) (|bni| #4#)
          (|x| #6=(|NonNegativeInteger|)) (|y| #6#)
          (|nextA| (|NonNegativeInteger|)) (|sp| (S))
          (|ob|
         ...
         ((#2=#:G165 NIL) (|o| NIL) (#3=#:G166 NIL)
          ...
          (|oldObj|
           #5=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                        ...
                        (|:| |next| (|NonNegativeInteger|))
                        (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|i| #6=(|NonNegativeInteger|)) (|inext| #6#) (|newObj| (S))
          (#7=#:G154 NIL) (|newX| (|NonNegativeInteger|)) (#8=#:G155 NIL)
          (|newY| (|NonNegativeInteger|)) (|newNext| #6#)
          (|nv|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))
                     (|:| |next| (|NonNegativeInteger|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|p| NIL) (#9=#:G168 NIL) (|nwob| #5#))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |o| NIL) (LETT #3# |newOb|) G190
                      (COND
                       ((OR (ATOM #3#) (PROGN (LETT |o| (CAR #3#)) NIL))
                        (GO G191)))
                      (SEQ (EXIT (LETT #2# (CONS (VECTOR |o| 0 0 0 NIL) #2#))))
                      (LETT #3# (CDR #3#)) (GO G190) G191
                      (EXIT (NREVERSE #2#)))))
          (LETT |oldObjs| (QCAR |s|))
          (SEQ (LETT |oi| 1) (LETT #4# (LENGTH |oldObjs|)) G190
               ...
               (SEQ (LETT |oldObj| (SPADCALL |oldObjs| |oi| (QREFELT % 40)))
                    ...
                    (LETT |newX|
                          (PROG1 (LETT #7# (+ (QVELT |oldObj| 1) |offsetX|))
                            (|check_subtype2| (>= #7# 0)
                                              '(|NonNegativeInteger|)
                                              '(|Integer|) #7#)))
                    (LETT |newY|
                          (PROG1 (LETT #8# (+ (QVELT |oldObj| 2) |offsetY|))
                            (|check_subtype2| (>= #8# 0)
                                              '(|NonNegativeInteger|)
                                              '(|Integer|) #8#)))
                    (LETT |newNext|
          ...
          (SEQ (LETT |p| 1) (LETT #9# (LENGTH |newObjs|)) G190
               (COND ((|greater_SI| |p| #9#) (GO G191)))
         ...
         ((#2=#:G186 NIL) (|o| NIL) (#3=#:G187 NIL)
          ...
          (|oldObj|
           #5=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                        ...
                        (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|i| #6=(|NonNegativeInteger|)) (|inext| #6#) (|newObj| (S))
          (#7=#:G174 NIL) (|newX| (|NonNegativeInteger|)) (#8=#:G175 NIL)
          (|newY| (|NonNegativeInteger|))
          (|incoming| (|List| (|NonNegativeInteger|))) (|newNext| #6#)
          (|n|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))
                     (|:| |next| (|NonNegativeInteger|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|p| NIL) (#9=#:G189 NIL) (|nwob| #5#))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |FNGRPH;coAdjoint;%LU;23|
        ...
        (SPROG
         ((#1=#:G211 NIL) (|codomainSize| (|NonNegativeInteger|))
          (#2=#:G212 NIL) (#3=#:G213 NIL)
          (|ret| (|List| (|NonNegativeInteger|))) (#4=#:G214 NIL)
          (#5=#:G215 NIL) (|retOpt| (|List| (|List| (|NonNegativeInteger|))))
          (|mi| NIL) (#6=#:G216 NIL) (|ri| NIL) (#7=#:G217 NIL)
          (|x| (|NonNegativeInteger|)) (#8=#:G210 NIL)
                ...
                (LETT |retOpt|
                      (PROGN
                       ...
                       (SEQ (LETT |x| 1) (LETT #5# |codomainSize|) G190
                            ...
                            (LETT |x| (|inc_SI| |x|)) (GO G190) G191
                            (EXIT (NREVERSE #4#)))))
                (SEQ (LETT |mi| 1) (LETT #6# (SPADCALL |m| (QREFELT % 71)))
...
(SDEFUN |FNGRPH;contraAdjoint;%LU;24|
        ((|s| (%)) (|m| (|List| (|NonNegativeInteger|)))
         (% (|Union| (|List| (|NonNegativeInteger|)) "failed")))
        (SPROG
         ((#1=#:G236 NIL) (|codomainSize| (|NonNegativeInteger|))
          (#2=#:G237 NIL) (#3=#:G238 NIL)
          (|ret| (|List| (|NonNegativeInteger|))) (#4=#:G239 NIL)
          (#5=#:G240 NIL) (|retOpt| (|List| (|List| (|NonNegativeInteger|))))
          (|mi| NIL) (#6=#:G241 NIL) (|ri| NIL) (#7=#:G242 NIL)
          (|x| (|NonNegativeInteger|)) (#8=#:G235 NIL)
          (|entry| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (SEQ (LETT |codomainSize| 0)
...
(SDEFUN |FNGRPH;limit;%NniL;26|
        ...
        (SPROG
         ((|s1| NIL) (#1=#:G254 NIL) (|lp| (|List| (|Loop|))) (#2=#:G253 NIL)
