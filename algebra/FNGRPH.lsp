        ...
        (SPROG
         ((|fobs|
          ...
          (|f|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))))
          (#1=#:G163 NIL) (|fn| NIL) (|too| (|NonNegativeInteger|))
          (|fromo| (|NonNegativeInteger|)) (#2=#:G162 NIL) (|a| NIL)
          (|arrs| (|List| (|NonNegativeInteger|))) (#3=#:G161 NIL) (|x| NIL)
          (#4=#:G160 NIL))
         (SEQ
          (LETT |arrs|
                (PROGN
         ...
         ((|obs|
          ...
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     ...
                     (|:| |next| (|NonNegativeInteger|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|n| (|NonNegativeInteger|)) (#1=#:G177 NIL) (|j| NIL)
          (#2=#:G175 NIL) (|vert| NIL) (#3=#:G176 NIL) (|i| NIL)
         ...
         ((|obs|
          ...
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     ...
                     (|:| |next| (|NonNegativeInteger|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|n| (|NonNegativeInteger|)) (|ob| (S)) (#1=#:G213 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL)
         ...
         ((|obs|
          ...
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     ...
                     (|:| |next| (|NonNegativeInteger|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (|n| (|NonNegativeInteger|)) (|ob| (S)) (#1=#:G221 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL)
              (SEQ (LETT |obn| 1) (LETT #1# (LENGTH |objs|)) G190
                   (COND ((|greater_SI| |obn| #1#) (GO G191)))
                   (SEQ (LETT |ob| (SPADCALL |objs| |obn| (QREFELT $ 31)))
...
(SDEFUN |FNGRPH;unit;LS$;14|
        ((|objs| (|List| S)) (|arrowName| (|String|)) ($ ($)))
        (SPROG ((#1=#:G227 NIL) (|x| NIL) (#2=#:G226 NIL))
               (SEQ
                (LETT |objs|
                      (PROGN
                       (LETT #2# NIL)
...
(SDEFUN |FNGRPH;indexProd|
        ((|aObj| ($)) (|a| (|NonNegativeInteger|)) (|b| (|NonNegativeInteger|))
         ($ (|NonNegativeInteger|)))
        (SPROG ((|x| (|NonNegativeInteger|)) (#1=#:G241 NIL))
               (SEQ
                (LETT |x|
                      (+ |a|
                         (*
...
(SDEFUN |FNGRPH;*;2$Fg;19|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #5=(|NonNegativeInteger|)) (|bi| (S)) (#6=#:G256 NIL)
...
(SDEFUN |FNGRPH;closedTensor;2$M$;20|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #1#) (|bi| (S)) (#5=#:G267 NIL) (|boi| NIL) (|ani| #3#)
          (|ayi| #2#) (|axi| #1#) (|ai| (S)) (#6=#:G266 NIL) (|aoi| NIL))
         (SEQ (LETT |newObjs| NIL)
...
(SDEFUN |FNGRPH;map;$LL2I$;21|
        ...
        (SPROG
         ((|nwob|
          ...
          (#5=#:G274 NIL) (|newX| (|NonNegativeInteger|)) (#6=#:G273 NIL)
          (|newObj| (S)) (|inext| #4#) (|i| #4#) (|oldObj| #2#) (#7=#:G286 NIL)
          (|oi| NIL)
          (|oldObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
...
(SDEFUN |FNGRPH;mapContra;$LL2I$;22|
        ...
        (SPROG
         ((|nwob|
          ...
          (|newY| (|NonNegativeInteger|)) (#5=#:G294 NIL)
          (|newX| (|NonNegativeInteger|)) (#6=#:G293 NIL) (|newObj| (S))
          (|inext| #4#) (|i| #4#) (|oldObj| #2#) (#7=#:G307 NIL) (|oi| NIL)
          (|oldObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|))
...
(SDEFUN |FNGRPH;coAdjoint;$LU;23|
        ...
        (SPROG
         ((|entry| (|NonNegativeInteger|)) (#1=#:G329 NIL)
          (|x| (|NonNegativeInteger|)) (#2=#:G336 NIL) (|ri| NIL)
          (#3=#:G335 NIL) (|mi| NIL)
          (|retOpt| (|List| (|List| (|NonNegativeInteger|)))) (#4=#:G334 NIL)
          (#5=#:G333 NIL) (|ret| (|List| (|NonNegativeInteger|)))
          (#6=#:G332 NIL) (#7=#:G331 NIL)
          (|codomainSize| (|NonNegativeInteger|)) (#8=#:G330 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |FNGRPH;contraAdjoint;$LU;24|
        ((|s| ($)) (|m| (|List| (|NonNegativeInteger|)))
         ($ (|Union| (|List| (|NonNegativeInteger|)) "failed")))
        (SPROG
         ((|entry| (|NonNegativeInteger|)) (#1=#:G354 NIL)
          (|x| (|NonNegativeInteger|)) (#2=#:G361 NIL) (|ri| NIL)
          (#3=#:G360 NIL) (|mi| NIL)
          (|retOpt| (|List| (|List| (|NonNegativeInteger|)))) (#4=#:G359 NIL)
          (#5=#:G358 NIL) (|ret| (|List| (|NonNegativeInteger|)))
          (#6=#:G357 NIL) (#7=#:G356 NIL)
          (|codomainSize| (|NonNegativeInteger|)) (#8=#:G355 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |codomainSize| 0)
                (SEQ (LETT |mi| NIL) (LETT #8# |m|) G190
...
(SDEFUN |FNGRPH;limit;$NniL;26|
        ...
        (SPROG
         ((|ptr| (|NonNegativeInteger|)) (#1=#:G372 NIL)
          (|lp| (|List| (|Loop|))) (#2=#:G373 NIL) (|s1| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |ptr| |a|)
