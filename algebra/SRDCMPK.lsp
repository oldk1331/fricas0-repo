...
(SDEFUN |SRDCMPK;numberOfVariables;LLNni;2|
        ((|lp| (|List| P)) (|lts| (|List| TS)) (% (|NonNegativeInteger|)))
        (SPROG ((|ts| NIL) (#1=#:G53 NIL) (|lv| (|List| V)))
               (SEQ
                (LETT |lv|
                    ...
                    (|:| |todo|
                         (|List|
                          (|Record| (|:| |val| (|List| P))
                                    (|:| |tower| TS)))))))
        (SPROG
         ((|v| (V)) (|n| (|NonNegativeInteger|)) (|ts_v-| (TS)) (|ts_v+| (TS))
          (#1=#:G56 NIL) (|ts_v| (P))
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|gwt| NIL) (#2=#:G78 NIL) (|g| (P)) (|us| (TS)) (|h| (P))
          (|lus| (|List| TS)) (|lsfp| (|List| P)) (|f| NIL) (#3=#:G79 NIL)
          (|vs| NIL) (#4=#:G80 NIL)
          (|llpwt| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (|lts| (|List| TS)) (#5=#:G77 NIL))
         (SEQ
          (COND
                ...
                (COND
                 ((NULL
                  ...
                  (SEQ
                   ...
                   (EXIT
                    (LETT |p|
                          (PROG2 (LETT #1# (SPADCALL |p| |lmp| (QREFELT % 62)))
                              (QCDR #1#)
                            (|check_union2| (QEQCAR #1# 0) (QREFELT % 9)
                                            (|Union| (QREFELT % 9) "failed")
                                            #1#)))))))))
...
(SDEFUN |SRDCMPK;printInfo;LNniV;11|
        ...
        (SPROG
         ((|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS)))
          (#1=#:G148 NIL) (|m| (|NonNegativeInteger|)) (|s| (|String|)))
...
(SDEFUN |SRDCMPK;upDateBranches;LLLRNniL;13|
        ...
        (SPROG
         ((|newBranches|
           (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (|newComponents| (|List| TS)) (|branch| NIL) (#1=#:G186 NIL)
          (|us| (TS)) (|newleq| (|List| P))
          (|branches1|
           (|List| #2=(|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (#3=#:G187 NIL) (|branches2| (|List| #2#))
          (|branches|
           (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS)))))
