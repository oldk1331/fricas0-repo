...
(SDEFUN |SRDCMPK;numberOfVariables;LLNni;2|
        ((|lp| |List| P) (|lts| |List| TS) ($ |NonNegativeInteger|))
        (SPROG ((|lv| (|List| V)) (#1=#:G155 NIL) (|ts| NIL))
               (SEQ
                (LETT |lv|
...
(SDEFUN |SRDCMPK;algebraicDecompose;PTSR;3|
        ...
        (SPROG
         ((#1=#:G176 NIL) (|lts| (|List| TS))
          (|llpwt| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (#2=#:G179 NIL) (|vs| NIL) (#3=#:G178 NIL) (|f| NIL)
          (|lsfp| (|List| P)) (|lus| (|List| TS)) (|h| (P)) (|us| (TS))
          (|g| (P)) (#4=#:G177 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v| (P)) (#5=#:G158 NIL) (|ts_v+| (TS)) (|ts_v-| (TS))
...
(SDEFUN |SRDCMPK;printInfo;LNniV;11|
        ...
        (SPROG
         ((|s| (|String|)) (|m| (|NonNegativeInteger|)) (#1=#:G244 NIL)
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
...
(SDEFUN |SRDCMPK;decompose;LL5BL;12|
        ...
        (SPROG
         ((|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          ...
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS)))
          (|bound| (|NonNegativeInteger|)) (#1=#:G263 NIL) (|br| NIL)
          (#2=#:G262 NIL)
          (|branches|
           (|List|
...
(SDEFUN |SRDCMPK;upDateBranches;LLLRNniL;13|
        ...
        (SPROG
         ((|branches|
          ...
          (#2=#:G283 NIL) (|us| (TS)) (|branches1| (|List| #1#))
          (|newleq| (|List| P)) (#3=#:G282 NIL) (|branch| NIL)
...
(DEFUN |SquareFreeRegularSetDecompositionPackage| (&REST #1=#:G284)
  (SPROG NIL
         (PROG (#2=#:G285)
           (RETURN
            (COND
