...
(SDEFUN |MFGRPH;multifunctionGraph;LL$;3|
        ...
        (SPROG
         ((|fobs|
          ...
          (|fo| #1#) (#2=#:G150 NIL) (|f| NIL) (#3=#:G151 NIL) (|fn| NIL)
          (|too| (|NonNegativeInteger|)) (|fromo| (|NonNegativeInteger|))
          (#4=#:G149 NIL) (|a| NIL) (|arrs| (|List| (|NonNegativeInteger|)))
          (#5=#:G148 NIL) (|x| NIL) (#6=#:G147 NIL))
         (SEQ
          (LETT |arrs|
                (PROGN
                 (LETT #6# NIL)
         ...
         ((|fobs|
           (|List|
            #1=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         ...
                         (|:| |map|
                              (|List| (|List| (|NonNegativeInteger|)))))))
          (|fo| #1#) (#2=#:G165 NIL) (|f| NIL) (#3=#:G166 NIL) (|fn| NIL)
          (|obs|
           (|List|
            #4=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #4#) (|ob| (S)) (#5=#:G164 NIL) (|obn| NIL))
         (SEQ (LETT |obs| NIL)
         ...
         ((|verts|
           (|List|
            #1=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         ...
                         (|:| |map|
                              (|List| (|List| (|NonNegativeInteger|)))))))
          (|o| #1#) (#2=#:G324 NIL) (|vert| NIL) (#3=#:G325 NIL) (|i| NIL)
          (#4=#:G303 NIL) (#5=#:G302 NIL) (|pout| #6=(|Integer|)) (|pin| #6#)
          (#7=#:G323 NIL) (|pt| NIL) (|preim| #8=(|List| S))
          (|im| #9=(|List| S))
          (|lr| (|Record| (|:| |preimage| #8#) (|:| |image| #9#)))
          (#10=#:G321 NIL) (|perm| NIL) (#11=#:G322 NIL) (|pi| NIL)
          (|tab| (|List| (|List| (|NonNegativeInteger|)))) (#12=#:G320 NIL)
          (|a| NIL) (#13=#:G319 NIL) (#14=#:G318 NIL) (|b| NIL)
          (#15=#:G317 NIL) (|obs| (|List| S)) (#16=#:G316 NIL) (|v| NIL)
          (#17=#:G314 NIL) (#18=#:G315 NIL) (|px| NIL))
         (SEQ (LETT |obs| NIL)
         ...
         ((|obs|
           (|List|
            #1=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         ...
                         (|:| |map|
                              (|List| (|List| (|NonNegativeInteger|)))))))
          (|o| #1#) (|n| (|NonNegativeInteger|)) (|ob| (S)) (#2=#:G375 NIL)
          (|obn| NIL))
         (SEQ (LETT |obs| NIL)
         ...
         ((|obs|
           (|List|
            #1=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         ...
                         (|:| |map|
                              (|List| (|List| (|NonNegativeInteger|)))))))
          (|o| #1#) (|n| (|NonNegativeInteger|)) (|ob| (S)) (#2=#:G384 NIL)
          (|obn| NIL))
         (SEQ (LETT |obs| NIL)
              (SEQ (LETT |obn| 1) (LETT #2# (LENGTH |objs|)) G190
                   (COND ((|greater_SI| |obn| #2#) (GO G191)))
...
(SDEFUN |MFGRPH;cartesianNext|
        ...
        (SPROG
         ((|res| (|List| (|NonNegativeInteger|)))
          (|y| #1=(|NonNegativeInteger|)) (|x| #1#) (#2=#:G430 NIL) (|i| NIL))
         (SEQ
          (COND
           ((SPADCALL (SPADCALL |a| (QREFELT $ 47))
                      (SPADCALL |b| (QREFELT $ 47)) (QREFELT $ 59))
...
(SDEFUN |MFGRPH;*;2$Mg;22|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bi| (S)) (#6=#:G443 NIL) (|boi| NIL) (|ani| #3#) (|ayi| #4#)
          (|axi| #5#) (|ai| (S)) (#7=#:G442 NIL) (|aoi| NIL))
...
(SDEFUN |MFGRPH;cartesian;2$Mg;23|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bni| #3=(|List| (|NonNegativeInteger|)))
          (|byi| #4=(|NonNegativeInteger|)) (|bxi| #5=(|NonNegativeInteger|))
          (|bi| (S)) (#6=#:G458 NIL) (|bptr| NIL) (#7=#:G459 NIL) (|boi| NIL)
          (|ani| #3#) (|ayi| #4#) (|axi| #5#) (|ai| (S)) (#8=#:G456 NIL)
          (|aptr| NIL) (#9=#:G457 NIL) (|aoi| NIL))
         (SEQ (LETT |newObjs| NIL)
...
(SDEFUN |MFGRPH;closedTensor;2$M$;24|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #2#) (|bi| (S)) (#6=#:G471 NIL) (|boi| NIL) (|ani| #4#)
          (|ayi| #3#) (|axi| #2#) (|ai| (S)) (#7=#:G470 NIL) (|aoi| NIL))
         (SEQ (LETT |newObjs| NIL)
              (SEQ (LETT |aoi| NIL) (LETT #7# (QCAR |a|)) G190
                   (COND
                    ((OR (ATOM #7#) (PROGN (LETT |aoi| (CAR #7#)) NIL))
...
(SDEFUN |MFGRPH;closedCartesian;2$M$;25|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|ob| #1#) (|sp| (S)) (|nextA| (|List| (|NonNegativeInteger|)))
          (|y| #5=(|NonNegativeInteger|)) (|x| #5#) (|bni| #4#) (|byi| #3#)
          (|bxi| #2#) (|bi| (S)) (#6=#:G485 NIL) (|bptr| NIL) (#7=#:G486 NIL)
          (|boi| NIL) (|ani| #4#) (|ayi| #3#) (|axi| #2#) (|ai| (S))
          (#8=#:G483 NIL) (|aptr| NIL) (#9=#:G484 NIL) (|aoi| NIL))
         (SEQ (LETT |newObjs| NIL)
              (SEQ (LETT |aoi| NIL) (LETT #9# (QCAR |a|)) (LETT |aptr| 1)
                   (LETT #8# (LENGTH (QCAR |a|))) G190
                   (COND
         ...
         ((|newObjs|
           (|List|
            #1=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         ...
                         (|:| |map|
                              (|List| (|List| (|NonNegativeInteger|)))))))
          (|ob| #1#) (|nextA| (|List| (|NonNegativeInteger|))) (#2=#:G499 NIL)
          (|x| NIL) (#3=#:G498 NIL) (|aoi| NIL))
         (SEQ (LETT |newObjs| NIL)
        ...
        (SPROG
         ((|nv|
           #2=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                        ...
                        (|:| |next| (|List| (|NonNegativeInteger|)))
                        (|:| |map| (|List| (|List| (|NonNegativeInteger|))))))
          (|newNext| (|List| (|NonNegativeInteger|))) (#3=#:G518 NIL) (|n| NIL)
          (|newY| (|NonNegativeInteger|)) (#4=#:G507 NIL)
          (|newX| (|NonNegativeInteger|)) (#5=#:G506 NIL) (|newObj| (S))
          ...
          (|oldObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      ...
                      (|:| |next| (|List| (|NonNegativeInteger|)))
                      (|:| |map| (|List| (|List| (|NonNegativeInteger|)))))))
          (|newObjs| (|List| #2#)) (#7=#:G516 NIL) (|o| NIL) (#8=#:G515 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #8# NIL)
...
(SDEFUN |MFGRPH;mapContra;$LL2I$;28|
        ...
        (SPROG
         ((|nv|
          ...
          (|incoming| (|List| (|NonNegativeInteger|))) (#3=#:G538 NIL)
          (|n| NIL) (|newY| (|NonNegativeInteger|)) (#4=#:G526 NIL)
          (|newX| (|NonNegativeInteger|)) (#5=#:G525 NIL) (|newObj| (S))
          (|i| (|NonNegativeInteger|))
          (|oldObj|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))
          ...
          (|oldObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      ...
                      (|:| |next| (|List| (|NonNegativeInteger|)))
                      (|:| |map| (|List| (|List| (|NonNegativeInteger|)))))))
          (|newObjs| (|List| #2#)) (#7=#:G536 NIL) (|o| NIL) (#8=#:G535 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #8# NIL)
...
(SDEFUN |MFGRPH;coAdjoint;$LU;29|
        ...
        (SPROG
         ((|entry| (|NonNegativeInteger|)) (#1=#:G561 NIL)
          (|x| (|NonNegativeInteger|)) (#2=#:G568 NIL) (|ri| NIL)
          (#3=#:G567 NIL) (|mi| NIL)
          (|retOpt| (|List| (|List| (|NonNegativeInteger|)))) (#4=#:G566 NIL)
          (#5=#:G565 NIL) (|ret| (|List| (|NonNegativeInteger|)))
          (#6=#:G564 NIL) (#7=#:G563 NIL)
          (|codomainSize| (|NonNegativeInteger|)) (#8=#:G562 NIL)
...
(SDEFUN |MFGRPH;contraAdjoint;$LU;30|
        ((|s| ($)) (|m| (|List| (|NonNegativeInteger|)))
         ($ (|Union| (|List| (|NonNegativeInteger|)) "failed")))
        (SPROG
         ((|entry| (|NonNegativeInteger|)) (#1=#:G588 NIL)
          (|x| (|NonNegativeInteger|)) (#2=#:G595 NIL) (|ri| NIL)
          (#3=#:G594 NIL) (|mi| NIL)
          (|retOpt| (|List| (|List| (|NonNegativeInteger|)))) (#4=#:G593 NIL)
          (#5=#:G592 NIL) (|ret| (|List| (|NonNegativeInteger|)))
          (#6=#:G591 NIL) (#7=#:G590 NIL)
          (|codomainSize| (|NonNegativeInteger|)) (#8=#:G589 NIL)
          (|domainSize| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (SEQ (LETT |domainSize| (LENGTH (QCAR |s|))) (LETT |codomainSize| 0)
...
(SDEFUN |MFGRPH;limit;$2NniL;32|
        ((|s| ($)) (|a| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|))
         ($ (|Loop|)))
        (SPROG
         ((|ptr| (|NonNegativeInteger|)) (#1=#:G608 NIL)
          (|lp| (|List| (|Loop|))) (#2=#:G609 NIL) (|s1| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |ptr| |a|)
...
(SDEFUN |MFGRPH;permIndex|
        ...
        (SPROG
         ((|resu| (|NonNegativeInteger|)) (|e2| (|Permutation| S))
          (#1=#:G616 NIL) (|i| NIL) (|dimen| (|NonNegativeInteger|)))
...
(SDEFUN |MFGRPH;generateNewPerms|
        ...
        (SPROG
         ((|resstr| (|List| (|String|))) (|resu| (|List| (|Permutation| S)))
          (|foundNew| (|Boolean|)) (|p| (|Permutation| S)) (#1=#:G629 NIL)
          (|j| NIL) (#2=#:G628 NIL) (|i| NIL) (|dimen| (|NonNegativeInteger|)))
...
(SDEFUN |MFGRPH;generateNames|
        ...
        (SPROG ((#1=#:G636 NIL) (|ptr2| NIL) (#2=#:G635 NIL))
               (SEQ
                (COND ((EQL |n| 0) (LIST "0"))
                      ('T
                       (PROGN
...
(SDEFUN |MFGRPH;generateNamesCycle|
        ...
        (SPROG
         ((|s2| (|List| (|String|))) (#1=#:G642 NIL) (|ptr2| NIL)
          (#2=#:G641 NIL) (|s1| (|String|)))
...
(SDEFUN |MFGRPH;toCayleyGraph;LBMg;39|
        ...
        (SPROG
         ((|gens| (|List| (|List| (|NonNegativeInteger|)))) (#1=#:G666 NIL)
          (|i| NIL) (#2=#:G665 NIL)
          (|ct| (|List| (|List| (|NonNegativeInteger|)))) (#3=#:G664 NIL)
          (|j| NIL) (#4=#:G663 NIL) (#5=#:G662 NIL) (#6=#:G661 NIL)
...
(SDEFUN |MFGRPH;toPermutation;$Pg;41|
        ...
        (SPROG
         ((|lp| (|List| (|Permutation| (|NonNegativeInteger|))))
          ...
          (|imgs| (|List| (|NonNegativeInteger|))) (#1=#:G694 NIL) (|i| NIL)
          (|preImgs| (|List| (|NonNegativeInteger|))) (#2=#:G693 NIL)
          (#3=#:G692 NIL)
          (|cayleyTable| (|List| (|List| (|NonNegativeInteger|))))
          (#4=#:G691 NIL) (|j| NIL) (#5=#:G690 NIL) (#6=#:G689 NIL)
          (#7=#:G688 NIL) (|numCols| (|NonNegativeInteger|))
          (|numRows| (|NonNegativeInteger|))
          (|preTable| (|List| (|List| (|NonNegativeInteger|))))
          (|newNext| (|List| (|NonNegativeInteger|))) (#8=#:G686 NIL)
          (|obj| NIL) (#9=#:G687 NIL) (|oi| NIL)
          (|objs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|))
...
(DEFUN |MultifunctionGraph| (#1=#:G695)
  (SPROG NIL
         (PROG (#2=#:G696)
           (RETURN
            (COND
