...
(SDEFUN |MDDFACT;ddfactor| ((|u| (EMR)) (% (|List| EMR)))
        (SPROG
         ((#1=#:G60 NIL) (|f| NIL) (#2=#:G59 NIL) (|ans| (|List| EMR))
          (|c| (|Integer|)))
         (SEQ
          (COND
...
(SDEFUN |MDDFACT;sepfact|
        ((|factList|
         ...
         (% (|List| EMR)))
        (SPROG
         ((#1=#:G86 NIL) (#2=#:G85 #3=(|List| EMR)) (#4=#:G87 #3#)
          (#5=#:G89 NIL) (|f| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |MDDFACT;separateFactors;LIL;14|
        ((|uddList|
         ...
         (|q| (|Integer|)) (% (|List| U)))
        (SPROG
         ((#1=#:G101 NIL) (|f| NIL) (#2=#:G100 NIL) (|ans| (|List| EMR))
          (#3=#:G99 NIL) (|udd| NIL) (#4=#:G98 NIL))
         (SEQ
          (LETT |ans|
                (|MDDFACT;sepfact|
                 (PROGN
...
(SDEFUN |MDDFACT;sepFact1|
        ((|f| (|Record| (|:| |factor| EMR) (|:| |degree| #1=(|Integer|))))
         (% (|List| EMR)))
        (SPROG
         ((#2=#:G131 NIL) (|x| (U)) (|ss| (|Integer|)) (|s| (|Integer|))
          (|ans| (|List| EMR)) (|stack| (|List| EMR)) (|df1| #3=(|Integer|))
          (|f1| (EMR)) (#4=#:G133 NIL) (|fact| NIL)
          (|flist| (|Union| (|List| EMR) "failed")) (|t| (EMR)) (#5=#:G132 NIL)
...
(SDEFUN |MDDFACT;probSplit|
        ...
        (SPROG
         ((|g| (EMR)) (|f2| (EMR)) (|n| (EMR)) (|r| (|NonNegativeInteger|))
          (#1=#:G205 NIL) (#2=#:G204 NIL) (|f1| (EMR)) (|p| (|Integer|)))
         (SEQ (LETT |p| (SPADCALL |u| (QREFELT % 26)))
              (EXIT
...
(DEFUN |ModularDistinctDegreeFactorizer| (#1=#:G220)
  (SPROG NIL
         (PROG (#2=#:G221)
           (RETURN
            (COND
