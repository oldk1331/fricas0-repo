...
(SDEFUN |MATSTOR;copy!;3M;2|
        ...
        (SPROG
         ((#1=#:G141 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|aRow| #2#) (#3=#:G140 NIL) (|i| NIL)
...
(SDEFUN |MATSTOR;plus!;4M;3|
        ((|c| (|Matrix| R)) (|a| (|Matrix| R)) (|b| (|Matrix| R))
         ($ (|Matrix| R)))
        (SPROG
         ((#1=#:G154 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|bRow| #2#) (|aRow| #2#) (#3=#:G153 NIL) (|i| NIL)
...
(SDEFUN |MATSTOR;minus!;3M;4|
        ((|c| (|Matrix| R)) (|a| (|Matrix| R)) ($ (|Matrix| R)))
        (SPROG
         ((#1=#:G165 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|aRow| #2#) (#3=#:G164 NIL) (|i| NIL)
          (|cc| #4=(|PrimitiveArray| (|PrimitiveArray| R))) (|aa| #4#)
          (|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|)))
         (SEQ (LETT |m| (ANROWS |a|)) (LETT |n| (ANCOLS |a|))
              (COND
...
(SDEFUN |MATSTOR;minus!;4M;5|
        ((|c| (|Matrix| R)) (|a| (|Matrix| R)) (|b| (|Matrix| R))
         ($ (|Matrix| R)))
        (SPROG
         ((#1=#:G178 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|bRow| #2#) (|aRow| #2#) (#3=#:G177 NIL) (|i| NIL)
          (|cc| #4=(|PrimitiveArray| (|PrimitiveArray| R))) (|bb| #4#)
          (|aa| #4#) (|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|)))
         (SEQ (LETT |m| (ANROWS |a|)) (LETT |n| (ANCOLS |a|))
              (COND
...
(SDEFUN |MATSTOR;rightScalarTimes!;2MRM;7|
        ...
        (SPROG
         ((#1=#:G200 NIL) (|j| NIL) (|cRow| #2=(|PrimitiveArray| R))
          (|aRow| #2#) (#3=#:G199 NIL) (|i| NIL)
          (|cc| #4=(|PrimitiveArray| (|PrimitiveArray| R))) (|aa| #4#)
          (|n| (|NonNegativeInteger|)) (|m| (|NonNegativeInteger|)))
         (SEQ (LETT |m| (ANROWS |a|)) (LETT |n| (ANCOLS |a|))
              (COND
...
(SDEFUN |MATSTOR;power!;4MNniM;10|
        ...
        (SPROG
         ((#1=#:G237 NIL) (|flag| (|Boolean|)) (|nn| (|NonNegativeInteger|))
...
(DEFUN |StorageEfficientMatrixOperations| (#1=#:G241)
  (SPROG NIL
         (PROG (#2=#:G242)
           (RETURN
            (COND
