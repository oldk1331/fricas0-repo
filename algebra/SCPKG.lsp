         ...
         ((#1=#:G127 NIL)
          (|res|
           (|Record| (|:| |particular| (|Union| (|Vector| R) "failed"))
                     (|:| |basis| (|List| (|Vector| R)))))
          (#2=#:G131 NIL) (|i| NIL) (|transitionMatrix| (|Matrix| R))
...
(SDEFUN |SCPKG;structuralConstants;LV;3|
        ...
        (SPROG
         ((#1=#:G149 NIL) (|k| NIL) (|covec| (|Vector| R)) (#2=#:G148 NIL)
          (|j| NIL) (#3=#:G147 NIL) (|i| NIL) (|sC| (|Vector| (|Matrix| R)))
          (#4=#:G144 NIL) (#5=#:G146 NIL) (#6=#:G145 NIL)
          (|m| (|NonNegativeInteger|)) (#7=#:G132 NIL))
         (SEQ
          (LETT |m|
...
(SDEFUN |SCPKG;structuralConstants;LMV;4|
        ...
        (SPROG
         ((|lscopy| (|List| (|Symbol|)))
          ...
          (|p| (|Polynomial| R)) (#1=#:G165 NIL) (|j| NIL) (#2=#:G164 NIL)
...
(SDEFUN |SCPKG;structuralConstants;LMV;5|
        ...
        (SPROG
         ((|lscopy| (|List| (|Symbol|)))
          ...
          (|r| (|Fraction| (|Polynomial| R))) (#1=#:G182 NIL) (|j| NIL)
          (#2=#:G181 NIL) (|i| NIL) (|s| (|Symbol|))
...
(DEFUN |StructuralConstantsPackage| (#1=#:G183)
  (SPROG NIL
         (PROG (#2=#:G184)
           (RETURN
            (COND
