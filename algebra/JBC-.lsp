...
(SDEFUN |JBC-;r2m;LL;2|
        ...
        (SPROG
         ((#1=#:G145 NIL) (|i| NIL) (|mi| (|List| (|NonNegativeInteger|))))
...
(SDEFUN |JBC-;allRepeated;LL;3|
        ...
        (SPROG
         ((|res| (|List| (|List| (|PositiveInteger|))))
          (|tmp| (|List| (|List| (|PositiveInteger|)))) (#1=#:G147 NIL)
          (|nu| (|List| (|NonNegativeInteger|))) (#2=#:G171 NIL) (|i| NIL)
          (#3=#:G172 NIL) (|k| NIL))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |JBC-;class;LNni;5|
        ...
        (SPROG ((|res| (|PositiveInteger|)) (#1=#:G178 NIL) (|i| NIL))
               (SEQ (LETT |res| 1)
...
(SDEFUN |JBC-;order;SNni;7| ((|jv| (S)) (% (|NonNegativeInteger|)))
        (SPROG ((|sum| (|NonNegativeInteger|)) (#1=#:G186 NIL) (|i| NIL))
               (SEQ
                (COND
...
(SDEFUN |JBC-;P;PiLS;15|
        ((|up| (|PositiveInteger|)) (|lo| (|List| (|NonNegativeInteger|)))
         (% (S)))
        (SPROG
         ((|lop| (|List| (|PositiveInteger|))) (#1=#:G200 NIL) (#2=#:G205 NIL)
          (|i| NIL))
         (SEQ
          (COND
...
(SDEFUN |JBC-;dimJ;2Nni;18|
        ((|q| (|NonNegativeInteger|)) (% (|NonNegativeInteger|)))
        (SPROG
         ((|res| (|NonNegativeInteger|)) (#1=#:G215 NIL) (#2=#:G219 NIL)
...
(SDEFUN |JBC-;dimS;2Nni;19|
        ((|q| (|NonNegativeInteger|)) (% (|NonNegativeInteger|)))
        (SPROG
         ((|res| (|NonNegativeInteger|)) (#1=#:G227 NIL) (#2=#:G231 NIL)
...
(SDEFUN |JBC-;derivativeOf?;2SL;21|
        ...
        (SPROG
         ((|res| (|List| (|NonNegativeInteger|))) (#1=#:G251 NIL)
          (#2=#:G257 NIL) (#3=#:G258 NIL) (|i1| NIL) (#4=#:G259 NIL) (|i2| NIL)
          (|jt| (|Symbol|)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |JBC-;integrateIfCan;SPiU;22|
        ...
        (SPROG
         ((|rind| (|List| (|PositiveInteger|))) (|pos| (|Integer|))
          (#1=#:G263 NIL) (|mi| (|NonNegativeInteger|))
...
(SDEFUN |JBC-;<;2SB;27| ((|jv1| (S)) (|jv2| (S)) (% (|Boolean|)))
        (SPROG
         ((#1=#:G297 NIL) (#2=#:G298 NIL) (|i1| NIL) (#3=#:G299 NIL) (|i2| NIL)
...
(SDEFUN |JBC-;variables;NniL;29| ((|q| (|NonNegativeInteger|)) (% (|List| S)))
        (SPROG
         ((#1=#:G352 NIL) (#2=#:G369 NIL) (|i| NIL) (#3=#:G368 NIL)
          (#4=#:G348 NIL) (#5=#:G367 NIL) (#6=#:G366 NIL) (JV (|List| S))
          (#7=#:G323 NIL) (#8=#:G365 NIL) (|k| NIL) (#9=#:G364 NIL) (|ind| NIL)
          (|IndList| (|List| (|List| (|PositiveInteger|))))
          (|OIndList| (|List| (|List| (|PositiveInteger|))))
          (|NIndList| (|List| (|List| (|PositiveInteger|)))) (#10=#:G315 NIL)
          (#11=#:G363 NIL) (|j| NIL) (#12=#:G362 NIL) (#13=#:G361 NIL)
          (|qq| NIL) (#14=#:G309 NIL) (#15=#:G360 NIL) (#16=#:G306 NIL)
          (#17=#:G359 NIL) (#18=#:G358 NIL) (#19=#:G303 NIL) (#20=#:G357 NIL))
         (SEQ
          (COND
           ((ZEROP |q|)
            (PROGN
...
(SDEFUN |JBC-;variables;NniPiL;30|
        ...
        (SPROG
         ((JV (|List| S)) (#1=#:G385 NIL) (#2=#:G397 NIL) (|k| NIL)
          (#3=#:G396 NIL) (|ind| NIL)
          (|OIndList| (|List| (|List| (|PositiveInteger|))))
          (|NIndList| (|List| (|List| (|PositiveInteger|)))) (#4=#:G377 NIL)
          (#5=#:G395 NIL) (|j| NIL) (#6=#:G394 NIL) (#7=#:G393 NIL) (|qq| NIL)
          (#8=#:G371 NIL) (#9=#:G392 NIL) (|i| NIL) (#10=#:G391 NIL))
         (SEQ
          (COND ((ZEROP |q|) NIL)
                ('T
                 (SEQ
