...
(DEFUN |JBC-;allRepeated;LL;3| (|mu| $)
  (PROG (|res| |tmp| #1=#:G143 |nu| #2=#:G167 |i| #3=#:G168 |k|)
    (RETURN
...
(DEFUN |JBC-;dimJ;2Nni;18| (|q| $)
  (PROG (|res| #1=#:G207 #2=#:G211 |qq| |oldJV| #3=#:G202)
    (RETURN
     (SEQ
      (COND
...
(DEFUN |JBC-;dimS;2Nni;19| (|q| $)
  (PROG (|res| #1=#:G218 #2=#:G222 |qq| |oldSV| #3=#:G213)
    (RETURN
     (SEQ
      (COND
...
(DEFUN |JBC-;derivativeOf?;2SL;21| (|jv1| |jv2| $)
  (PROG (|res| #1=#:G240 #2=#:G245 #3=#:G246 |i1| #4=#:G247 |i2| |jt|)
    (RETURN
     (SEQ
      (EXIT
       (COND
...
(DEFUN |JBC-;<;2SB;27| (|jv1| |jv2| $)
  (PROG (#1=#:G282 #2=#:G283 |i1| #3=#:G284 |i2| |o2| |o1| |t2| |t1|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |JBC-;variables;NniL;29| (|q| $)
  (PROG (#1=#:G319 #2=#:G335 |i| #3=#:G334 #4=#:G316 #5=#:G333 #6=#:G332 JV
         #7=#:G300 #8=#:G331 |k| #9=#:G330 |ind| |IndList| |OIndList|
         |NIndList| #10=#:G294 #11=#:G329 |j| #12=#:G328 |qq| #13=#:G291
         #14=#:G327 #15=#:G289 #16=#:G326 #17=#:G325 #18=#:G287 #19=#:G324)
    (RETURN
     (SEQ
      (COND
       ((ZEROP |q|)
...
(DEFUN |JBC-;variables;NniPiL;30| (|q| |c| $)
  (PROG (JV #1=#:G345 #2=#:G356 |k| #3=#:G355 |ind| |OIndList| |NIndList|
         #4=#:G339 #5=#:G354 |j| #6=#:G353 |qq| #7=#:G336 #8=#:G352 |i|
         #9=#:G351)
    (RETURN
     (SEQ
      (COND ((ZEROP |q|) NIL)
