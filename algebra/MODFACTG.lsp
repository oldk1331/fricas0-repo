...
(SDEFUN |MODFACTG;eqfact|
        ((|pol| (PA)) (|l| (|Integer|)) (|pmat1| (MMT)) (|xp1| (PA))
         ...
         (|res| (|List| PA)) ($ (|List| PA)))
        (SPROG
         ((|xp11| (PA)) (|rdata2| (PMD)) (|rdata1| (PMD)) (#1=#:G130 NIL)
          (|n| #2=(|NonNegativeInteger|)) (|dg| #3=(|NonNegativeInteger|))
          (|dp| #4=(|NonNegativeInteger|)) (|#G23| #2#) (|#G22| #3#) (|g| (PA))
          (|#G21| (PA)) (|#G20| (PA)) (|bad_cnt| (|NonNegativeInteger|))
          (|tr1| (PA)) (|tr| (PA)) (#5=#:G131 NIL) (|i| NIL) (|kk| (|Integer|))
          (|rpol| (PA)) (|l2| #4#) (|n0| (|Integer|)) (|pp| (|Integer|))
          (|p| (MD)))
         (SEQ
          (EXIT
        ...
        (SPROG
         ((|res|
           (|List|
            (|Record| (|:| |poly| PA) (|:| |degree| (|NonNegativeInteger|))
                      (|:| |separate_factors| (|Mapping| (|List| PA))))))
          (|pk| (PA)) (#1=#:G171 NIL) (#2=#:G169 NIL) (#3=#:G170 NIL)
          (|xp2| (PA)) (|xp1| (PA)) (|pmat21| (MMT)) (|pmat11| (MMT))
          (#4=#:G175 NIL) (|g1| NIL) (|res1| (|List| PA)) (|xp21| (PA))
          (|xp11| (PA)) (|rdata2| (PMD)) (|rdata1| (PMD)) (|rdata| (PMD))
          (|all_done| (|Boolean|)) (|l11| (|NonNegativeInteger|))
          (|n| #5=(|NonNegativeInteger|)) (|dg| (|Integer|)) (|g| (PA))
          (|pk1| (PA)) (|i| (|NonNegativeInteger|)) (#6=#:G174 NIL)
          (#7=#:G173 NIL) (|i1| NIL) (|pmat2| (MMT)) (|#G33| (PA))
          (|#G32| (MMT))
          (|#G31| #8=(|Record| (|:| |matr| MMT) (|:| |poly| PA))) (|pj| (PA))
          (|lpj| (|List| PA)) (#9=#:G172 NIL) (|k2| (|NonNegativeInteger|))
...
(DEFUN |ModularFactorizationGeneral| (&REST #1=#:G186)
  (SPROG NIL
         (PROG (#2=#:G187)
           (RETURN
            (COND
