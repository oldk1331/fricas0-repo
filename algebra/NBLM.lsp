...
(SDEFUN |NBLM;naiveBeckermannLabahn1;VVNniIM2ML;5|
        ...
        (SPROG
         ((|p| (|SparseUnivariatePolynomial| (|Integer|)))
          (|l| (|NonNegativeInteger|)) (|vk| (|U32Vector|)) (#1=#:G178 NIL)
          (|k| NIL) (|vpa| (|Vector| (|U32Vector|))) (#2=#:G177 NIL)
          (#3=#:G176 NIL) (|m| (|NonNegativeInteger|)))
         (SEQ
          (COND
...
(SDEFUN |NBLM;naiveBeckermannLabahn1;VVNniIM2ML;6|
        ((|vpa| (|Vector| (|U32Vector|))) (|vn| (|Vector| (|Integer|)))
         ...
         ($ (|List| (|Any|))))
        (SPROG
         ((|vd| (|Vector| (|Integer|))) (#1=#:G199 NIL) (|k| NIL)
          (#2=#:G198 NIL) (|m2| (|Integer|)) (|vk| (|U32Vector|))
          (#3=#:G197 NIL) (|mp| (|Vector| (|U32Vector|))) (|m1| (|Integer|))
          (#4=#:G196 NIL) (|m| (|NonNegativeInteger|)))
         (SEQ
          (COND
...
(SDEFUN |NBLM;mul_by_binomial_pointwise|
        ((|v| (|U32Vector|)) (|pt| (|Integer|)) (|pts| (|U32Vector|))
         (|p| (|Integer|)) ($ (|Void|)))
        (SPROG
         ((|pp| (|Integer|)) (#1=#:G210 NIL) (|i| NIL) (|n| (|SingleInteger|)))
...
(SDEFUN |NBLM;naiveBeckermannLabahn0;2VVNniIM2MV;9|
        ((|mp| (|Vector| (|U32Vector|))) (|vp| (|Vector| (|U32Vector|)))
         ...
         ($ (|Void|)))
        (SPROG
         ((|vckinv| (|Integer|)) (#1=#:G231 NIL) (|k| NIL)
          (|vcinv| (|Integer|)) (|maxd| (|Integer|)) (|cpi| (|Integer|))
          (|pi| (|Integer|)) (#2=#:G230 NIL) (|pt| (|Integer|)) (#3=#:G229 NIL)
...
(SDEFUN |NBLM;critical_index|
        ...
        (SPROG
         ((#1=#:G238 NIL) (#2=#:G239 NIL) (|pa| (|U32Vector|))
          (|nj| (|Integer|)) (#3=#:G240 NIL) (|j| NIL)
...
(SDEFUN |NBLM;swap_rows|
        ((|m| (|TwoDimensionalArray| (|U32Vector|))) (|i| (|Integer|))
         (|j| (|Integer|)) ($ (|Void|)))
        (SPROG
         ((|t2| #1=(|U32Vector|)) (|t1| #1#) (#2=#:G246 NIL) (|k| NIL)
...
(SDEFUN |NBLM;mult_vector|
        ...
        (SPROG ((#1=#:G251 NIL) (|i| NIL) (|n| (|NonNegativeInteger|)))
               (SEQ (LETT |n| (QV_LEN_U32 |v|))
                    (EXIT
...
(SDEFUN |NBLM;mult_row|
        ...
        (SPROG ((#1=#:G256 NIL) (|j| NIL) (|jmax| (|NonNegativeInteger|)))
...
(SDEFUN |NBLM;add_vector|
        ...
        (SPROG ((#1=#:G261 NIL) (|i| NIL) (|n| (|NonNegativeInteger|)))
...
(SDEFUN |NBLM;add_row|
        ((|m| (|TwoDimensionalArray| (|U32Vector|))) (|j1| (|Integer|))
         ...
         (|p| (|Integer|)) ($ (|Void|)))
        (SPROG ((#1=#:G266 NIL) (|i| NIL) (|imax| (|NonNegativeInteger|)))
...
(SDEFUN |NBLM;reduce_row_by_row1|
        ...
        (SPROG
         ((#1=#:G270 NIL) (|c| (|Integer|)) (|k| (|Integer|))
          (|rj0| (|U32Vector|)))
...
(SDEFUN |NBLM;top_reduce_by_row|
        ...
        (SPROG
         ((#1=#:G275 NIL) (|j| NIL) (|minv| (|Integer|)) (|mcoeff| (|Integer|))
...
(SDEFUN |NBLM;final_reduce|
        ((|m| (|TwoDimensionalArray| (|U32Vector|)))
         ...
         (|vd| (|Vector| (|Integer|))) (|p| (|Integer|)) ($ (|Void|)))
        (SPROG
         ((|ci| #1=(|Integer|)) (#2=#:G287 NIL) (|vdi| #1#) (#3=#:G290 NIL)
          (|i| NIL) (#4=#:G289 NIL) (|d| NIL) (|vdj| #1#) (#5=#:G288 NIL)
...
(SDEFUN |NBLM;reduceBasis0;Tda2VIR;19|
        ...
        (SPROG
         ((|tmp| #1=(|Integer|)) (|maxj| (|Integer|)) (|ci| #2=(|Integer|))
          (|nci| #2#) (|maxd| (|Integer|)) (|cd| #1#) (#3=#:G305 NIL) (|j| NIL)
          (#4=#:G304 NIL) (|i| NIL) (|civ| (|Vector| (|Integer|)))
        ...
        ((|m| (|Vector| (|U32Vector|))) (|vn| (|Vector| (|Integer|)))
         ...
         ($
          (|Record| (|:| |basis| (|TwoDimensionalArray| (|U32Vector|)))
                    ...
                    (|:| |cinds| (|Vector| (|Integer|))))))
        (SPROG
         ((|j| (|NonNegativeInteger|)) (|m2| (|SingleInteger|)) (#1=#:G324 NIL)
          (|i1| NIL) (|resjk| (|U32Vector|)) (|vnk1| (|SingleInteger|))
          (#2=#:G323 NIL) (|k| NIL) (|mi| (|U32Vector|)) (#3=#:G322 NIL)
          (|i| NIL) (|nvd| (|Vector| (|Integer|)))
          (|res| (|TwoDimensionalArray| (|U32Vector|)))
          (|ns| (|NonNegativeInteger|)) (#4=#:G321 NIL)
