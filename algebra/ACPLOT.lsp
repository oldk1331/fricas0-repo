...
(SDEFUN |ACPLOT;findPtOnList|
        ...
        (SPROG ((#1=#:G206 NIL) (#2=#:G207 NIL) (#3=#:G208 NIL) (|point| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |ACPLOT;listPtsOnHorizBdry|
        ...
        (SPROG
         ((|pointList| (|List| (|Point| (|DoubleFloat|)))) (#1=#:G234 NIL)
...
(SDEFUN |ACPLOT;listPtsOnVertBdry|
        ...
        (SPROG
         ((|pointList| (|List| (|Point| (|DoubleFloat|)))) (#1=#:G239 NIL)
          (|root| NIL) (|roots| (|List| (|Float|)))
          (|f| (|Polynomial| (|Fraction| (|Integer|))))
          (|xSF| (|DoubleFloat|)))
...
(SDEFUN |ACPLOT;ptsSuchThat?|
        ...
        (SPROG ((#1=#:G251 NIL) (#2=#:G252 NIL) (|point| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |ACPLOT;makeOneVarSketch|
        ...
        (SPROG
         ((|bran| (|List| (|List| (|Point| (|DoubleFloat|)))))
          ...
          (|rt| (|List| (|Point| (|DoubleFloat|)))) (|pt1| #1#) (#2=#:G305 NIL)
          (|rootSF| NIL) (|xMaxSF| #3=(|DoubleFloat|)) (|xMinSF| #3#)
          (|bt| (|List| (|Point| (|DoubleFloat|))))
          (|tp| (|List| (|Point| (|DoubleFloat|)))) (#4=#:G304 NIL)
          (|yMaxSF| #3#) (|yMinSF| #3#)
          (|sketchRoots| (|List| (|DoubleFloat|))) (#5=#:G303 NIL) (|root| NIL)
          (|roots| (|List| (|Float|)))
...
(SDEFUN |ACPLOT;singValBetween?|
        ...
        (SPROG ((#1=#:G317 NIL) (#2=#:G318 NIL) (#3=#:G319 NIL) (|xVal| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                           ...
                           (COND
                            ((|less_DF| |xCurrent| |xVal|)
                             (COND
                              ((|less_DF| |xVal| |xNext|)
                               (PROGN
                                (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G316)))
                                (GO #5=#:G314))))))))
                         (LETT #3# (CDR #3#)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #1#))
                  (EXIT NIL)))
...
(SDEFUN |ACPLOT;segmentInfo|
        ...
        (SPROG
         ((#2=#:G344 NIL) (|val| #1#) (|nextFrom| #3=(|String|))
...
(SDEFUN |ACPLOT;makeRatFcnSketch|
        ...
        (SPROG
         ((|bran| (|List| (|List| (|Point| (|DoubleFloat|)))))
          ...
          (#5=#:G426 NIL) (|segment| NIL) (#6=#:G417 NIL)
          (|topList| (|List| (|DoubleFloat|)))
          ...
          (|top| #8=(|DoubleFloat|)) (|bot| #8#) (#9=#:G418 NIL)
          (|tp| (|List| (|Point| (|DoubleFloat|)))) (#10=#:G425 NIL)
          (|val| NIL) (|bt| (|List| (|Point| (|DoubleFloat|))))
          (#11=#:G424 NIL) (|rt| (|List| (|Point| (|DoubleFloat|))))
          (|lf| (|List| (|Point| (|DoubleFloat|)))) (#12=#:G423 NIL)
          (#13=#:G422 NIL) (|rightVal| #14=(|DoubleFloat|)) (|leftVal| #14#)
          (|denUPolyRN|
           (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (|outList| (|List| (|DoubleFloat|))) (#15=#:G421 NIL) (|root| NIL)
          (|roots| (|List| (|Float|))) (#16=#:G420 NIL)
          (|singList| (|List| (|DoubleFloat|))) (#17=#:G419 NIL)
                ...
                (SEQ G190
                     ...
                     (SEQ
                      (EXIT
                       (COND
                        ((EQL |i| |bound|)
                         (PROGN (LETT #2# (CONS 1 "failed")) (GO #3=#:G578)))
                        ('T
...
(SDEFUN |ACPLOT;coerce;$Of;42| ((|acplot| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|ff| (|OutputForm|)) (|f| (|List| (|OutputForm|)))
          (|ll| (|List| (|OutputForm|))) (#1=#:G590 NIL) (|p| NIL)
          (#2=#:G589 NIL) (#3=#:G588 NIL) (|branch| NIL)
