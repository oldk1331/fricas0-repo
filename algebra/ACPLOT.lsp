            ...
            (SEQ G190
                 ...
                 (SEQ
                  (EXIT
                   (COND
                    ((EQL |i| |bound|)
                     (PROGN (LETT #2# (CONS 1 "failed") . #3#) (GO #4=#:G536)))
                    ('T
...
(SDEFUN |ACPLOT;coerce;$Of;42| ((|acplot| $) ($ |OutputForm|))
        (SPROG
         ((|ff| (|OutputForm|)) (|f| (|List| (|OutputForm|)))
          (|ll| (|List| (|OutputForm|))) (#1=#:G546 NIL) (|p| NIL)
          (#2=#:G545 NIL) (#3=#:G544 NIL) (|branch| NIL)
