...
(SDEFUN |ACPLOT;makeOneVarSketch|
        ...
        (SPROG
         ((|bran| (|List| (|List| (|Point| (|DoubleFloat|)))))
          ...
          (|rt| (|List| (|Point| (|DoubleFloat|)))) (|pt1| #1#) (#2=#:G297 NIL)
          (|rootSF| NIL) (|xMaxSF| #3=(|DoubleFloat|)) (|xMinSF| #3#)
          (|bt| (|List| (|Point| (|DoubleFloat|))))
          (|tp| (|List| (|Point| (|DoubleFloat|)))) (#4=#:G296 NIL)
          (|yMaxSF| #3#) (|yMinSF| #3#)
          (|sketchRoots| (|List| (|DoubleFloat|))) (#5=#:G295 NIL) (|root| NIL)
          (|roots| (|List| (|Float|)))
...
(SDEFUN |ACPLOT;makeRatFcnSketch|
        ...
        (SPROG
         ((|bran| (|List| (|List| (|Point| (|DoubleFloat|)))))
          ...
          (#5=#:G407 NIL) (|segment| NIL) (#6=#:G398 NIL)
          ...
          (|top| #8=(|DoubleFloat|)) (|bot| #8#) (#9=#:G399 NIL)
          (|tp| (|List| (|Point| (|DoubleFloat|)))) (#10=#:G406 NIL)
          (|val| NIL) (|bt| (|List| (|Point| (|DoubleFloat|))))
          (#11=#:G405 NIL) (|rt| (|List| (|Point| (|DoubleFloat|))))
          (|lf| (|List| (|Point| (|DoubleFloat|)))) (#12=#:G404 NIL)
          (#13=#:G403 NIL) (|rightVal| #14=(|DoubleFloat|)) (|leftVal| #14#)
          (|denUPolyRN|
           (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (|outList| (|List| (|DoubleFloat|))) (#15=#:G402 NIL) (|root| NIL)
          (|roots| (|List| (|Float|))) (#16=#:G401 NIL)
          (|singList| (|List| (|DoubleFloat|))) (#17=#:G400 NIL)
                ...
                (SEQ G190
                     ...
                     (SEQ
                      (EXIT
                       (COND
                        ((EQL |i| |bound|)
                         (PROGN (LETT #2# (CONS 1 "failed")) (GO #3=#:G553)))
                        ('T
...
(SDEFUN |ACPLOT;coerce;$Of;42| ((|acplot| $) ($ |OutputForm|))
        (SPROG
         ((|ff| (|OutputForm|)) (|f| (|List| (|OutputForm|)))
          ...
          (#2=#:G562 NIL) (#3=#:G561 NIL) (|branch| NIL)
