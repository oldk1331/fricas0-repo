...
(SDEFUN |ACPLOT;findPtOnList|
        ...
        (SPROG ((#1=#:G166 NIL) (#2=#:G167 NIL) (#3=#:G168 NIL) (|point| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |ACPLOT;listPtsOnHorizBdry|
        ...
        (SPROG
         ((|pointList| (|List| (|Point| (|DoubleFloat|)))) (#1=#:G193 NIL)
...
(SDEFUN |ACPLOT;listPtsOnVertBdry|
        ((|pRN| |Polynomial| (|Fraction| (|Integer|))) (|x| |Symbol|)
         ...
         ($ |List| (|Point| (|DoubleFloat|))))
        (SPROG
         ((|pointList| (|List| (|Point| (|DoubleFloat|)))) (#1=#:G197 NIL)
          (|root| NIL) (|roots| (|List| (|Float|)))
          (|f| (|Polynomial| (|Fraction| (|Integer|))))
          (|xSF| (|DoubleFloat|)))
...
(SDEFUN |ACPLOT;ptsSuchThat?|
        ...
        (SPROG ((#1=#:G207 NIL) (#2=#:G208 NIL) (|point| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |ACPLOT;makeOneVarSketch|
        ...
        (SPROG
         ((|bran| (|List| (|List| (|Point| (|DoubleFloat|)))))
          ...
          (|pt1| #1#) (#3=#:G258 NIL) (|rootSF| NIL)
          (|xMaxSF| #4=(|DoubleFloat|)) (|xMinSF| #4#) (|bt| #2#) (|tp| #2#)
          (#5=#:G257 NIL) (|yMaxSF| #4#) (|yMinSF| #4#)
          (|sketchRoots| (|List| (|DoubleFloat|))) (#6=#:G256 NIL) (|root| NIL)
...
(SDEFUN |ACPLOT;singValBetween?|
        ...
        (SPROG ((#1=#:G269 NIL) (#2=#:G270 NIL) (#3=#:G271 NIL) (|xVal| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |ACPLOT;segmentInfo|
        ...
        (SPROG
         ((#2=#:G289 NIL) (|val| #1#) (|nextFrom| #3=(|String|))
...
(SDEFUN |ACPLOT;makeRatFcnSketch|
        ...
        (SPROG
         ((|bran| (|List| (|List| (|Point| (|DoubleFloat|)))))
          ...
          (#5=#:G348 NIL) (|segment| NIL) (#6=#:G339 NIL)
          ...
          (|top| #8=(|DoubleFloat|)) (|bot| #8#) (#9=#:G340 NIL)
          (|tp| #10=(|List| (|Point| (|DoubleFloat|)))) (#11=#:G347 NIL)
          (|val| NIL) (|bt| #10#) (#12=#:G346 NIL) (|rt| #10#) (|lf| #10#)
          (#13=#:G345 NIL) (#14=#:G344 NIL) (|rightVal| #15=(|DoubleFloat|))
          (|leftVal| #15#)
          (|denUPolyRN|
           (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
          (|outList| (|List| (|DoubleFloat|))) (#16=#:G343 NIL) (|root| NIL)
          (|roots| (|List| (|Float|))) (#17=#:G342 NIL)
          (|singList| (|List| (|DoubleFloat|))) (#18=#:G341 NIL)
...
(SDEFUN |ACPLOT;traceBranches|
        ...
        (SPROG
         ...
         (SEQ (LETT |lf| (QVELT |bdPts| 0) . #5=(|ACPLOT;traceBranches|))
              ...
              (SEQ G190
                   (COND
                    ((NULL (COND ((NULL |bdry|) 'NIL) ('T 'T))) (GO G191)))
                   (SEQ (LETT |pt| (|SPADfirst| |bdry|) . #5#)
                        ...
                        (LETT |crits| (SPADCALL |segInfo| (QREFELT $ 128))
                              . #5#)
                        (EXIT
                         (LETT |bdry| (SPADCALL |segInfo| (QREFELT $ 129))
                               . #5#)))
                   NIL (GO G190) G191 (EXIT NIL))
              (SEQ G190
                   (COND
                    ((NULL (COND ((NULL |crits|) 'NIL) ('T 'T))) (GO G191)))
            ...
            (EXIT
             (COND
              ((EQUAL (QCDR |ptInfo|) (QREFELT $ 17))
               (SEQ (LETT |bdry| (SPADCALL |p2| |bdry| (QREFELT $ 133)) . #4#)
              ...
              ('T
               (SEQ
                ...
                (SEQ G190 NIL
                     (SEQ
                      (LETT |pt0| (SPADCALL |pointList| (QREFELT $ 134)) . #4#)
             ...
             (COND
              ...
              (#6='T
               (SEQ
                ...
                (SEQ G190 NIL
                     (SEQ
                      (LETT |pt0| (SPADCALL |pointList| (QREFELT $ 134)) . #5#)
...
(SDEFUN |ACPLOT;newtonApprox|
        ...
        (SPROG
         ((|i| (|PositiveInteger|)) (|newApprox| (|DoubleFloat|))
          (|oldApprox| #1#) (#2=#:G485 NIL)
          (|Df| (|SparseUnivariatePolynomial| (|DoubleFloat|))))
         (SEQ
          (EXIT
           (SEQ
            (LETT |Df| (SPADCALL |f| (QREFELT $ 138))
            ...
            (SEQ G190
                 ...
                 (SEQ
                  (EXIT
                   (COND
                    ((EQL |i| |bound|)
                     (PROGN (LETT #2# (CONS 1 "failed") . #3#) (GO #4=#:G484)))
                    ('T
...
(SDEFUN |ACPLOT;coerce;$Of;42| ((|acplot| $) ($ |OutputForm|))
        (SPROG
         ((|ff| (|OutputForm|)) (|f| (|List| (|OutputForm|)))
          (|ll| (|List| (|OutputForm|))) (#1=#:G494 NIL) (|p| NIL)
          (#2=#:G493 NIL) (#3=#:G492 NIL) (|branch| NIL)
         ...
         (SEQ
          ...
          (LETT |xx| (SPADCALL (QVELT |acplot| 1) (QREFELT $ 142)) . #6#)
          (LETT |yy| (SPADCALL (QVELT |acplot| 2) (QREFELT $ 142)) . #6#)
          (LETT |xLo| (SPADCALL (QVELT |acplot| 3) (QREFELT $ 143)) . #6#)
          (LETT |xHi| (SPADCALL (QVELT |acplot| 4) (QREFELT $ 143)) . #6#)
          (LETT |yLo| (SPADCALL (QVELT |acplot| 5) (QREFELT $ 143)) . #6#)
          (LETT |yHi| (SPADCALL (QVELT |acplot| 6) (QREFELT $ 143)) . #6#)
          (LETT |zip| (SPADCALL " = 0" (QREFELT $ 145)) . #6#)
          (LETT |com| (SPADCALL ",   " (QREFELT $ 145)) . #6#)
          (LETT |les| (SPADCALL " <= " (QREFELT $ 145)) . #6#)
          (LETT |l|
                      ...
                      (PROGN
                       ...
                       (SEQ (LETT |p| NIL . #6#) (LETT #1# |branch| . #6#) G190
                            ...
                            (SEQ
                             (EXIT
                              (LETT #2#
                                    (CONS (SPADCALL |p| (QREFELT $ 146)) #2#)
                                    . #6#)))
                            (LETT #1# (CDR #1#) . #6#) (GO G190) G191
                            (EXIT (NREVERSE #2#))))
                      . #6#)
                (EXIT
                 (LETT |f| (CONS (SPADCALL |ll| (QREFELT $ 148)) |f|) . #6#)))
          ...
          (LETT |ff|
                ...
                . #6#)
          (EXIT
           (SPADCALL (SPADCALL "ACPLOT" (QREFELT $ 145)) |ff|
                     (QREFELT $ 150)))))) 
