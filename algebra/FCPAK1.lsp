...
(SDEFUN |FCPAK1;zeroVector;SPFc;1|
        ((|fname| (|Symbol|)) (|n| (|Polynomial| (|Integer|)))
         (% (|FortranCode|)))
        (SPROG
         ((|ue| (|Expression| (|Integer|))) (|i1| (|Symbol|))
          (|lp1| (|Polynomial| (|Integer|))) (|hp1| (|Polynomial| (|Integer|)))
          (|segp1| (|Segment| (|Polynomial| (|Integer|))))
          (|segbp1| (|SegmentBinding| (|Polynomial| (|Integer|))))
          (|ip1| #1=(|Polynomial| (|Integer|))) (|indices| (|List| #1#))
          (|fa| (|FortranCode|)))
...
(SDEFUN |FCPAK1;zeroMatrix;S2PFc;2|
        ...
        (SPROG
         ((|ue| (|Expression| (|Integer|))) (|i1| (|Symbol|))
          (|lp1| (|Polynomial| (|Integer|))) (|hp1| (|Polynomial| (|Integer|)))
          (|segp1| #1=(|Segment| (|Polynomial| (|Integer|))))
          (|segbp1| #2=(|SegmentBinding| (|Polynomial| (|Integer|))))
          (|i2| (|Symbol|)) (|hp2| (|Polynomial| (|Integer|))) (|segp2| #1#)
          (|segbp2| #2#) (|ip1| (|Polynomial| (|Integer|)))
          (|ip2| #3=(|Polynomial| (|Integer|))) (|indices| (|List| #3#))
          (|fa| (|FortranCode|)))
         (SEQ (LETT |ue| (|spadConstant| % 7)) (LETT |i1| 'I1)
...
(SDEFUN |FCPAK1;zeroMatrix;S2SbFc;3|
        ((|fname| (|Symbol|))
         ...
         (% (|FortranCode|)))
        (SPROG
         ((|ue| (|Expression| (|Integer|))) (|i1| #1=(|Symbol|)) (|i2| #1#)
          (|ip1| (|Polynomial| (|Integer|)))
          (|ip2| #2=(|Polynomial| (|Integer|))) (|indices| (|List| #2#))
          (|fa| (|FortranCode|)))
...
(SDEFUN |FCPAK1;zeroSquareMatrix;SPFc;4|
        ...
        (SPROG
         ((|ue| (|Expression| (|Integer|))) (|i1| (|Symbol|))
          (|lp1| (|Polynomial| (|Integer|))) (|hp1| (|Polynomial| (|Integer|)))
          (|segp1| (|Segment| (|Polynomial| (|Integer|))))
          (|segbp1| #1=(|SegmentBinding| (|Polynomial| (|Integer|))))
          (|i2| (|Symbol|)) (|segbp2| #1#) (|ip1| (|Polynomial| (|Integer|)))
          (|ip2| #2=(|Polynomial| (|Integer|))) (|indices| (|List| #2#))
          (|fa| (|FortranCode|)))
         (SEQ (LETT |ue| (|spadConstant| % 7)) (LETT |i1| 'I1)
              (LETT |lp1| (|spadConstant| % 9)) (LETT |hp1| |n|)
...
(SDEFUN |FCPAK1;identitySquareMatrix;SPFc;5|
        ((|fname| (|Symbol|)) (|n| (|Polynomial| (|Integer|)))
         (% (|FortranCode|)))
        (SPROG
         ((|ue| (|Expression| (|Integer|))) (|u1| (|Expression| (|Integer|)))
          (|i1| (|Symbol|)) (|lp1| (|Polynomial| (|Integer|)))
          (|hp1| (|Polynomial| (|Integer|)))
          (|segp1| (|Segment| (|Polynomial| (|Integer|))))
          (|segbp1| #1=(|SegmentBinding| (|Polynomial| (|Integer|))))
          (|i2| (|Symbol|)) (|segbp2| #1#)
          (|ip1| #2=(|Polynomial| (|Integer|)))
          (|ip2| #3=(|Polynomial| (|Integer|))) (|indice1| (|List| #2#))
          (|indices| (|List| #3#)) (|fc| #4=(|FortranCode|))
          (|f1| #5=(|FortranCode|)) (|fl| (|List| #5#)) (|fa| #4#))
         (SEQ (LETT |ue| (|spadConstant| % 7))
