...
(SDEFUN |BRILL;primeEnough?|
        ...
        (SPROG
         ((#1=#:G144 NIL) (#2=#:G145 NIL) (|bb| (|Float|)) (#3=#:G137 NIL)
          (|d| (|Union| (|Integer|) #4="failed")) (#5=#:G146 NIL) (|i| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |BRILL;brillhartIrreducible?;UP2B;6|
        ...
        (SPROG
         ((#1=#:G164 NIL) (#2=#:G165 NIL) (|small| (|Integer|)) (#3=#:G166 NIL)
