...
(SDEFUN |BRILL;primeEnough?|
        ...
        (SPROG
         ((#1=#:G128 NIL) (#2=#:G129 NIL) (|bb| (|Float|)) (#3=#:G121 NIL)
          (|d| (|Union| (|Integer|) #4="failed")) (#5=#:G130 NIL) (|i| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |BRILL;brillhartIrreducible?;UP2B;6|
        ...
        (SPROG
         ((#1=#:G148 NIL) (#2=#:G149 NIL) (|small| (|Integer|)) (#3=#:G150 NIL)
