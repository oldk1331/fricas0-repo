...
(SDEFUN |BRILL;primeEnough?|
        ...
        (SPROG
         ((#1=#:G142 NIL) (#2=#:G143 NIL) (|bb| (|Float|)) (#3=#:G135 NIL)
          (|d| (|Union| (|Integer|) #4="failed")) (#5=#:G144 NIL) (|i| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |BRILL;brillhartIrreducible?;UP2B;6|
        ...
        (SPROG
         ((#1=#:G161 NIL) (#2=#:G162 NIL) (|small| (|Integer|)) (#3=#:G163 NIL)
