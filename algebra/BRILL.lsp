...
(SDEFUN |BRILL;primeEnough?|
        ...
        (SPROG
         ((#1=#:G129 NIL) (#2=#:G130 NIL) (|bb| (|Float|)) (#3=#:G122 NIL)
          (|d| (|Union| (|Integer|) #4="failed")) (#5=#:G131 NIL) (|i| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |BRILL;brillhartIrreducible?;UP2B;6|
        ...
        (SPROG
         ((#1=#:G149 NIL) (#2=#:G150 NIL) (|small| (|Integer|)) (#3=#:G151 NIL)
