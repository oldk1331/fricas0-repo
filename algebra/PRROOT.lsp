...
(SDEFUN |PRROOT;get_rational_roots;UPL;1|
        ...
        (SPROG
         ...
         (SEQ
          ...
          (LETT |facl| (SPADCALL |ff| (QREFELT $ 32)) . #5#)
          (LETT |res| NIL . #5#)
          (SEQ (LETT |facr| NIL . #5#) (LETT #2# |facl| . #5#) G190
               ...
               (SEQ (LETT |fac| (QCAR |facr|) . #5#)
                    (EXIT
                     (COND
                      ((SPADCALL (SPADCALL |fac| (QREFELT $ 33)) 1
                                 (QREFELT $ 35))
                       "iterate")
                      ('T
                       (SEQ
                        (LETT |val1r|
                              (SPADCALL
                               (SPADCALL (SPADCALL |fac| 0 (QREFELT $ 38))
                                         (SPADCALL |fac| (QREFELT $ 39))
                                         (QREFELT $ 41))
                               (QREFELT $ 42))
                              . #5#)
...
(SDEFUN |PRROOT;integerBound;UPI;2| ((|p| UP) ($ |Integer|))
        (SPROG
         ((|res| (|Integer|)) (|q| (|Integer|))
          (|qu| (|Union| (|Integer|) "failed")) (#1=#:G123 NIL) (|r| NIL)
          (|lr| (|List| (|Fraction| (|Integer|)))))
         (SEQ
          (LETT |lr| (SPADCALL |p| (QREFELT $ 44))
          ...
          (SEQ (LETT |r| NIL . #2#) (LETT #1# |lr| . #2#) G190
               (COND
                ((OR (ATOM #1#) (PROGN (LETT |r| (CAR #1#) . #2#) NIL))
                 (GO G191)))
               (SEQ (LETT |qu| (SPADCALL |r| (QREFELT $ 46)) . #2#)
                    (EXIT
...
(DEFUN |PolynomialRationalRoots| (&REST #1=#:G124)
  (SPROG NIL
         (PROG (#2=#:G125)
           (RETURN
            (COND
...
(MAKEPROP '|PolynomialRationalRoots| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (37 . |gcd|) (|Factored| 23)
              (|MultivariateFactorize| (|SingletonAsOrderedSet|) 8 21 23)
              (42 . |factor|) (|Record| (|:| |factor| 23) (|:| |exponent| 21))
              (|List| 30) (47 . |factors|) (52 . |degree|) (|Boolean|)
              (57 . ~=) (63 . |Zero|) (67 . |Zero|) (71 . |coefficient|)
              (77 . |leadingCoefficient|) (|Fraction| 21) (82 . /) (88 . -)
              (|List| 40) |PRROOT;get_rational_roots;UPL;1|
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 47
                                                 '(1 7 8 0 9 2 7 10 0 8 11 1 10
                                                   ...
                                                   20 24 1 23 0 25 26 1 28 27
                                                   23 29 1 27 31 0 32 1 23 8 0
                                                   33 2 8 34 0 0 35 0 6 0 36 0
                                                   7 0 37 2 23 21 0 8 38 1 23
                                                   21 0 39 2 40 0 21 21 41 1 40
                                                   0 0 42 1 40 45 0 46 1 0 21 7
                                                   47 1 0 43 7 44)))))
           '|lookupComplete|)) 
