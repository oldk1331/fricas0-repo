...
(SDEFUN |PRROOT;get_rational_roots;UPL;1|
        ...
        (SPROG
         ((|res| (|List| (|Fraction| (|Integer|))))
          ...
          (|fac| #1=(|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G129 NIL)
          (|facr| NIL)
          (|facl|
           (|List|
...
(SDEFUN |PRROOT;integerBound;UPI;2| ((|p| (UP)) ($ (|Integer|)))
        (SPROG
         ((|res| (|Integer|)) (|q| (|Integer|))
          (|qu| (|Union| (|Integer|) "failed")) (#1=#:G138 NIL) (|r| NIL)
...
(DEFUN |PolynomialRationalRoots| (&REST #1=#:G139)
  (SPROG NIL
         (PROG (#2=#:G140)
           (RETURN
            (COND
