...
(SDEFUN |PRROOT;get_rational_roots;UPL;1|
        ...
        (SPROG
         ((|res| (|List| (|Fraction| (|Integer|))))
          ...
          (|fac| #1=(|SparseUnivariatePolynomial| (|Integer|))) (#2=#:G131 NIL)
          (|facr| NIL)
          (|facl|
           (|List|
...
(SDEFUN |PRROOT;integerBound;UPI;2| ((|p| (UP)) ($ (|Integer|)))
        (SPROG
         ((|res| (|Integer|)) (|q| (|Integer|))
          (|qu| (|Union| (|Integer|) "failed")) (#1=#:G141 NIL) (|r| NIL)
...
(DEFUN |PolynomialRationalRoots| (&REST #1=#:G142)
  (SPROG NIL
         (PROG (#2=#:G143)
           (RETURN
            (COND
