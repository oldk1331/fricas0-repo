...
(SDEFUN |AF;UP2R|
        ...
        (SPROG
         ((|ans| (|SparseUnivariatePolynomial| R)) (#1=#:G112 NIL)
          (|r| (|Union| R "failed")))
         (SEQ
          (EXIT
                ...
                (SEQ G190
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |r| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G111)))
                        ('T
                         (SEQ
                          (LETT |ans|
                                (SPADCALL |ans|
...
(SDEFUN |AF;root_sum1|
        ...
        (SPROG
         ((|nexpr| (|SparseUnivariatePolynomial| F)) (|res| (F))
          (#1=#:G140 NIL) (|i| NIL) (|xs| (|Symbol|)) (|a| (F))
          (|k| (|Kernel| F)))
         (SEQ
          (COND
...
(SDEFUN |AF;hackroot| ((|x| (F)) (|n| (|Integer|)) (% (F)))
        (SPROG
         ((#1=#:G285 NIL) (|rx| (|Union| (|Integer|) "failed"))
...
(SDEFUN |AF;inroot| ((|l| (|List| F)) (% (F)))
        (SPROG
         ((|r| (|Union| R "failed")) (#1=#:G293 NIL) (|x| (F))
          (|n| (|Integer|)))
         (SEQ
          (COND
           ((ZEROP
         ...
         ((#1=#:G295 NIL)
          (|rec|
           (|Record| (|:| |exponent| (|NonNegativeInteger|)) (|:| |coef| F)
                     (|:| |radicand| F)))
          (#2=#:G302 NIL) (#3=#:G300 NIL) (#4=#:G297 NIL)
...
(DEFUN |AlgebraicFunction| (&REST #1=#:G342)
  (SPROG NIL
         (PROG (#2=#:G343)
           (RETURN
            (COND
