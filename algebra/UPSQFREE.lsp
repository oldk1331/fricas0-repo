          ...
          (|lffe|
           (|List|
            (|Record| (|:| |flg| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |fctr| P) (|:| |xpnt| (|Integer|)))))
          (|lcp| (RC)) (#2=#:G162 NIL) (|i| (|NonNegativeInteger|)) (|pi| (P))
          (|di| (P)) (#3=#:G159 NIL) (|ci| (P)) (|a| (P)) (|c| (P)) (|u| (P))
          (|#G11|
             ...
             (SEQ
              (LETT |di|
                    (PROG2 (LETT #7# (SPADCALL |p| |ci| (QREFELT $ 11)) . #9#)
                        (QCDR #7#)
                      (|check_union| (QEQCAR #7# 0) (QREFELT $ 7) #7#))
                    . #9#)
                        ...
                        (LETT |ci|
                              (PROG2
                                  (LETT #7# (SPADCALL |ci| |di| (QREFELT $ 11))
                                        . #9#)
                                  (QCDR #7#)
                                (|check_union| (QEQCAR #7# 0) (QREFELT $ 7)
                                               #7#))
                              . #9#)
                        (LETT |i| (+ |i| 1) . #9#)
                        (EXIT
                            ...
                            (LETT |lc|
                                  (PROG2
                                      (LETT #8#
                                            ...
                                            . #9#)
                                      (QCDR #8#)
                                    (|check_union| (QEQCAR #8# 0) (QREFELT $ 6)
                                                   #8#))
                                  . #9#)
                            (EXIT
                             (LETT |dunit|
