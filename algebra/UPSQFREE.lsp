...
(SDEFUN |UPSQFREE;squareFreePart;2P;2| ((|p| (P)) ($ (P)))
        (SPROG
         ((#1=#:G122 NIL) (#2=#:G121 (P)) (#3=#:G123 (P)) (#4=#:G125 NIL)
          (|f| NIL) (|s| (|Factored| P)))
         (SEQ
          (SPADCALL
          ...
          (|lffe|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| P)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (|lcp| (RC)) (#2=#:G164 NIL) (|i| (|NonNegativeInteger|)) (|pi| (P))
          (|di| (P)) (#3=#:G161 NIL) (|ci| (P)) (|a| (P)) (|c| (P)) (|u| (P))
          (|#G11|
...
(SDEFUN |UPSQFREE;squareFree1|
        ...
        (SPROG
         ((|res_le| (|List| (|NonNegativeInteger|))) (|res_lf| (|List| P))
          (#2=#:G204 NIL) (|f| NIL) (#3=#:G205 NIL) (|e| NIL)
          (|le| (|List| (|NonNegativeInteger|))) (|lf| (|List| P))
          (|nle| (|List| (|NonNegativeInteger|))) (|nlf| (|List| P)) (|nf| (P))
          (|rec_f| (P)) (#4=#:G175 NIL) (|f1| (P)) (#5=#:G202 NIL)
          (#6=#:G203 NIL) (#7=#:G200 NIL) (#8=#:G201 NIL) (|rec_e| NIL)
         ...
         ((|fl|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| P)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (#1=#:G215 NIL) (|f| NIL) (#2=#:G216 NIL) (|e| NIL)
          (|res1|
         ...
         ((|lffe|
          ...
          (|lsnil|
           (|List|
            (|Record| (|:| |flag| (|Union| #1# #2# #3# #4#)) (|:| |factor| P)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (#5=#:G241 NIL) (|ffe| NIL) (#6=#:G240 NIL)
          (|redSqfr| (|Factored| P)) (#7=#:G226 NIL) (|dunit| (P)) (|pi| (P))
          (|lc| (RC)) (#8=#:G229 NIL) (|i| (|NonNegativeInteger|)) (|ci| (P))
...
(DEFUN |UnivariatePolynomialSquareFree| (&REST #1=#:G242)
  (SPROG NIL
         (PROG (#2=#:G243)
           (RETURN
            (COND
