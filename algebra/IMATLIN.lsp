                      ...
                      (EXIT
                       (COND
                        ((SPADCALL (SPADCALL |x| |i| |j| (QREFELT $ 13))
                         ...
                         (PROGN
                          (LETT #1# (PROGN (LETT #2# NIL . #4#) (GO #5=#:G122))
                                . #4#)
                          (GO #6=#:G120))))))
                      ...
                      (EXIT
                       (COND
                        ((SPADCALL (SPADCALL |x| |i| |j| (QREFELT $ 13))
                                   (|spadConstant| $ 14) (QREFELT $ 16))
                         (PROGN
                          (LETT #1# (PROGN (LETT #2# NIL . #4#) (GO #5=#:G129))
                                . #4#)
                          (GO #6=#:G127))))))
         ...
         (SEQ
          (EXIT
           (SEQ
            ...
            (LETT |minR| (PROGN |x| 1) . #9#)
            (LETT |maxR| (SPADCALL |x| (QREFELT $ 18)) . #9#)
            (LETT |minC| (PROGN |x| 1) . #9#)
...
(SDEFUN |IMATLIN;nullSpace;ML;6| ((|y| M) ($ |List| |Col|))
        (SPROG
         ...
         (SEQ
          ...
          (LETT |minR| (PROGN |x| 1) . #10#)
          (LETT |maxR| (SPADCALL |x| (QREFELT $ 18)) . #10#)
          (LETT |minC| (PROGN |x| 1) . #10#)
