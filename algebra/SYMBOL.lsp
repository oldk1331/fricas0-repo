...
(SDEFUN |SYMBOL;convert;%If;3| ((|s| (%)) (% (|InputForm|)))
        (SPROG
         ((|n| (|InputForm|))
          ...
          (#1=#:G1945 NIL) (#2=#:G1946 NIL) (A (|List| (|InputForm|)))
          (#3=#:G1947 NIL) (#4=#:G1948 NIL) (B (|List| (|InputForm|)))
          (#5=#:G1949 NIL) (#6=#:G1950 NIL) (C (|List| (|InputForm|)))
          (#7=#:G1951 NIL) (#8=#:G1952 NIL) (D (|List| (|InputForm|)))
          (#9=#:G1953 NIL) (#10=#:G1954 NIL) (E (|List| (|InputForm|)))
          (|a| #11=(|InputForm|)) (|b| #11#) (#12=#:G1955 NIL) (|e| NIL)
          (#13=#:G1956 NIL) (FF (|List| (|List| (|InputForm|))))
          (#14=#:G1957 NIL) (F NIL) (#15=#:G1958 NIL)
          (G (|List| (|InputForm|))) (|d| (|InputForm|)))
         (SEQ (LETT |n| (SPADCALL |s| (QREFELT % 29)))
              ...
              (LETT A
                    (PROGN
                     (LETT #1# NIL)
                     (SEQ (LETT |e| NIL) (LETT #2# (QVELT |ls| 0)) G190
                          (COND
                          ...
                          (SEQ
                           (EXIT
                            (LETT #1#
                                  (CONS (SPADCALL |e| (QREFELT % 34)) #1#))))
                          (LETT #2# (CDR #2#)) (GO G190) G191
                          (EXIT (NREVERSE #1#)))))
              (LETT B
                    (PROGN
                     (LETT #3# NIL)
                     (SEQ (LETT |e| NIL) (LETT #4# (QVELT |ls| 1)) G190
                          (COND
                          ...
                          (SEQ
                           (EXIT
                            (LETT #3#
                                  (CONS (SPADCALL |e| (QREFELT % 34)) #3#))))
                          (LETT #4# (CDR #4#)) (GO G190) G191
                          (EXIT (NREVERSE #3#)))))
              (LETT C
                    (PROGN
                     (LETT #5# NIL)
                     (SEQ (LETT |e| NIL) (LETT #6# (QVELT |ls| 2)) G190
                          (COND
              ...
              (LETT E
                    (PROGN
                     (LETT #9# NIL)
                     (SEQ (LETT |e| NIL) (LETT #10# (QVELT |ls| 4)) G190
                          (COND
              ...
              (LETT FF
                    (PROGN
                     (LETT #12# NIL)
                     (SEQ (LETT |e| NIL) (LETT #13# (LIST A B C D E)) G190
                          (COND
                           ((OR (ATOM #13#) (PROGN (LETT |e| (CAR #13#)) NIL))
                            (GO G191)))
                          (SEQ (EXIT (LETT #12# (CONS (CONS |b| |e|) #12#))))
                          (LETT #13# (CDR #13#)) (GO G190) G191
                          (EXIT (NREVERSE #12#)))))
              (LETT G
                    (PROGN
                     (LETT #14# NIL)
                     (SEQ (LETT F NIL) (LETT #15# FF) G190
                          (COND
        ...
        (SPROG
         ((|ss|
           (|Record| (|:| |sub| (|List| (|OutputForm|)))
                     ...
                     (|:| |presub| (|List| (|OutputForm|)))
                     (|:| |args| (|List| (|OutputForm|)))))
          (|rsl| (|List| (|List| (|OutputForm|)))) (|si| NIL) (#1=#:G1978 NIL)
          (#2=#:G1977 NIL) (|se| (|OutputForm|)) (|sl| (|List| (|OutputForm|)))
          (|x0| (|OutputForm|)) (|a| (|List| (|OutputForm|))))
         (SEQ
          (COND
...
(SDEFUN |SYMBOL;syprefix|
        ((|sc|
         ...
         (% (|String|)))
        (SPROG
         ((|ns| (|List| (|Integer|))) (#1=#:G1992 NIL) (|n| NIL)
          (#2=#:G1993 NIL))
         (SEQ
          (LETT |ns|
          ...
          (EXIT
           (SPADCALL
            (CONS
             ...
             (PROGN
              (LETT #1# NIL)
              (SEQ (LETT |n| NIL) (LETT #2# |ns|) G190
                   (COND
                    ((OR (ATOM #2#) (PROGN (LETT |n| (CAR #2#)) NIL))
                     (GO G191)))
                   (SEQ (EXIT (LETT #1# (CONS (|SYMBOL;istring| |n| %) #1#))))
        ...
        (SPROG
         ((|qr|
           (|Record| (|:| |quotient| (|Integer|))
                     (|:| |remainder| (|Integer|))))
          (|ns| (|String|)) (#1=#:G2023 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |ns| "")
                (EXIT
                 (SEQ G190 NIL
                      (SEQ (LETT |qr| (|divide_INT| |n| (QCSIZE |s|)))
                           (LETT |n| (QCAR |qr|))
                           (LETT |ns|
                                 (SPADCALL
                                  (SPADCALL |s|
...
(SDEFUN |SYMBOL;new;2%;25| ((|x| (%)) (% (%)))
        (SPROG
         ((|u| (|Union| (|Integer|) "failed")) (|n| (|Integer|))
          (|xx| (|String|)))
         (SEQ
          (LETT |n|
...
(SDEFUN |SYMBOL;name;2%;29| ((|sy| (%)) (% (%)))
        (SPROG ((|str| (|String|)) (|si| (|NonNegativeInteger|)))
               (SEQ
        ...
        ((|sy| (%))
         (%
          (|Record| (|:| |sub| (|List| (|OutputForm|)))
                    ...
                    (|:| |args| (|List| (|OutputForm|))))))
        (SPROG
         ((|lscripts| (|List| (|List| (|OutputForm|)))) (|str| (|String|))
          (|j| NIL) (#1=#:G2063 NIL) (#2=#:G2055 NIL)
          (|nscripts| (|List| (|NonNegativeInteger|))) (|m| (|Integer|))
          (|n| NIL) (#3=#:G2064 NIL) (|i| NIL)
          (|allscripts| (|List| (|OutputForm|))))
         (SEQ
          (COND
           ...
           ('T
            (SEQ (LETT |nscripts| (LIST 0 0 0 0 0))
                 ...
                 (SEQ (LETT |j| (+ (QREFELT % 27) 1))
                      (LETT #1# (+ (+ (QREFELT % 27) 4) 1)) (LETT |i| |m|) G190
                      (COND ((> |j| #1#) (GO G191)))
                      (SEQ
                       (EXIT
                        (SPADCALL |nscripts| |i|
                 ...
                 (SEQ (LETT |n| NIL) (LETT #3# |nscripts|) (LETT |i| |m|) G190
                      (COND
