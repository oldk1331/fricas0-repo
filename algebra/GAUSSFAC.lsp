...
(DEFUN |GAUSSFAC;findelt| (|q| $)
  (PROG (|t| |s| #1=#:G140 |i| |qq1| |r1| |r| #2=#:G115 |q1|)
    (RETURN
...
(DEFUN |GAUSSFAC;intfactor| (|n| $)
  (PROG (|r| |z| |sz| |unity| #1=#:G162 |exp| #2=#:G170 |term| |lfn|)
    (RETURN
     (SEQ
...
(DEFUN |GAUSSFAC;factor;CF;7| (|m| $)
  (PROG (|unity| |result| |z| #1=#:G186 |part| |g0| #2=#:G182 |exp| |n|
         #3=#:G195 |term| |factn| |r| |b| #4=#:G115 |a| |d| |ris|)
    (RETURN
     (SEQ
      (COND
