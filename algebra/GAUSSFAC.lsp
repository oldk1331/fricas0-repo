         ...
         (SEQ (LETT |lfn| (SPADCALL |n| (QREFELT % 27))) (LETT |r| NIL)
              (LETT |unity|
                    (SPADCALL (SPADCALL |lfn| (QREFELT % 28)) 0
                              (QREFELT % 14)))
              (SEQ (LETT |term| NIL) (LETT #2# (SPADCALL |lfn| (QREFELT % 32)))
                   G190
                   (COND
...
(MAKEPROP '|GaussianFactorizationPackage| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|Integer|) (0 . |positiveRemainder|)
              ...
              (6 . |extendedEuclidean|) '|FMod| (13 . |One|) (|Complex| 6)
              ...
              (|List| 38) (|Factored| 13) (96 . |makeFR|) (102 . |Zero|)
              (106 . |Zero|) (110 . =) (116 . |primeFactor|) (122 . |real|)
              (127 . |imag|) (132 . |unit|) (137 . |factorList|) (142 . |One|)
