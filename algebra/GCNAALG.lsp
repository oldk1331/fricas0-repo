...
(DEFUN |GCNAALG;eval| (|rf| |a| $)
  (PROG (|bot| |top| |lEq| #1=#:G140 |i| #2=#:G139 |s| #3=#:G138 |coefOfa|)
    (RETURN
     (SEQ
      (LETT |coefOfa|
            (SPADCALL (ELT $ 36)
...
(DEFUN |GCNAALG;genericLeftDiscriminant;F;3| ($)
  (PROG (|m| #1=#:G149 |a| #2=#:G148 #3=#:G147 |b| #4=#:G146 |listBasis|)
    (RETURN
     (SEQ
...
(DEFUN |GCNAALG;genericRightDiscriminant;F;5| ($)
  (PROG (|m| #1=#:G158 |a| #2=#:G157 #3=#:G156 |b| #4=#:G155 |listBasis|)
    (RETURN
     (SEQ
      (LETT |listBasis| (SPADCALL (SPADCALL (QREFELT $ 56)) (QREFELT $ 59))
...
(DEFUN |GCNAALG;generic;SV$;20| (|s| |ve| $)
  (PROG (|sFC| #1=#:G206 #2=#:G208 |i| #3=#:G207 |lON| #4=#:G205 |q| #5=#:G204)
    (RETURN
     (SEQ
      (LETT |lON|
            (PROGN
...
(DEFUN |GCNAALG;generic;V$;21| (|ve| $)
  (PROG (|v| #1=#:G220 #2=#:G222 |i| #3=#:G221 |sFC| #4=#:G217 #5=#:G219
         #6=#:G218 |lON| #7=#:G216 |q| #8=#:G215)
    (RETURN
     (SEQ
      (LETT |lON|
            (PROGN
...
(DEFUN |GenericNonAssociativeAlgebra| (&REST #1=#:G238)
  (PROG ()
    (RETURN
     (PROG (#2=#:G239)
       (RETURN
...
(DEFUN |GenericNonAssociativeAlgebra;| (|#1| |#2| |#3| |#4|)
  (PROG (|v| #1=#:G236 |i| #2=#:G237 #3=#:G233 #4=#:G235 #5=#:G234 |q|
         #6=#:G232 |pv$| $ |dv$| DV$4 DV$3 DV$2 DV$1)
    (RETURN
     (SEQ
      (PROGN
