...
(SDEFUN |LF;eqint| ((|k1| (|Kernel| F)) (|k2| (|Kernel| F)) ($ (|Boolean|)))
        (SPROG
         ((|res| (|Boolean|)) (#1=#:G180 NIL) (|a2| #2=(|List| F)) (|a1| #2#))
         (SEQ
          (EXIT
           (SEQ (LETT |a1| (SPADCALL |k1| (QREFELT $ 70)))
                ...
                (COND ((NULL |res|) (PROGN (LETT #1# |res|) (GO #3=#:G179))))
...
(SDEFUN |LF;dviint| ((|l| (|List| F)) (|v| (|Symbol|)) ($ (F)))
        (SPROG
         ((|m| (|Integer|)) (|lv| (|List| (|Symbol|))) (#1=#:G198 NIL)
          (|vf| NIL) (#2=#:G197 NIL) (|lvf| (|List| F))
...
(DEFUN |LiouvillianFunction| (&REST #1=#:G284)
  (SPROG NIL
         (PROG (#2=#:G285)
           (RETURN
            (COND
