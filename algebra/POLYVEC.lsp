...
(SDEFUN |POLYVEC;inner_mul|
        ((|x| . #1=(|U32Vector|)) (|y| |U32Vector|) (|z| |U32Vector|)
         ...
         ($ |Void|))
        (SPROG
         ((|ss| (|U64Int|)) (#4=#:G244 NIL) (|j| NIL) (#5=#:G243 NIL) (|i| NIL)
          (#6=#:G242 NIL) (#7=#:G241 NIL) (#8=#:G240 NIL) (#9=#:G239 NIL)
          (|tmp| #2#) (|tmpp| #1#) (|ds| #3#))
         (SEQ (LETT |ds| |d|)
              (COND
               ((|less_SI| |ydeg| |xdeg|)
...
(SDEFUN |POLYVEC;differentiate;UvIUv;24|
        ...
        (SPROG
         ((|i1| (|NonNegativeInteger|)) (#1=#:G261 NIL) (|i| NIL)
          (|r| (|U32Vector|)) (#2=#:G255 NIL) (|d| (|Integer|)))
...
(SDEFUN |POLYVEC;differentiate;UvNniIUv;25|
        ((|x| |U32Vector|) (|n| |NonNegativeInteger|) (|p| |Integer|)
         ($ |U32Vector|))
        (SPROG
         ((|f| (|Integer|)) (#1=#:G270 NIL) (|k| NIL) (|j| #2=(|Integer|))
          (#3=#:G269 NIL) (|i| NIL) (|r| (|U32Vector|)) (|d| #2#))
         (SEQ
          (COND ((ZEROP |n|) |x|)
                (#4='T
                 (SEQ (LETT |d| (- (QV_LEN_U32 |x|) 1))
