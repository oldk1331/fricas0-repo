...
(SDEFUN |POLYVEC;divide!;3UvIV;12|
        ((|r0| |U32Vector|) (|r1| |U32Vector|) (|res| |U32Vector|)
         (|p| |Integer|) ($ |Void|))
        (SPROG
         ((#1=#:G191 NIL) (|dr0| #2=(|SingleInteger|)) (#3=#:G192 NIL)
                ...
                (EXIT
                 (SEQ G190
                      ...
                      (SEQ (LETT |delta| (|sub_SI| |dr0| |dr1|))
                           ...
                           (COND
                            ((|less_SI| |dr0| 0)
                             (PROGN (LETT #3# |$NoValue|) (GO #4=#:G188))))
...
(SDEFUN |POLYVEC;remainder!;2UvIV;13|
        ...
        (SPROG
         ((#1=#:G199 NIL) (|dr0| #2=(|SingleInteger|)) (#3=#:G200 NIL)
          (|c1| (|Integer|)) (|delta| (|SingleInteger|)) (|c0| (|Integer|))
          (|dr1| #2#))
         (SEQ (LETT |dr0| (SPADCALL |r0| (QREFELT $ 30)))
              (LETT |dr1| (SPADCALL |r1| (QREFELT $ 30)))
                ...
                (EXIT
                 (SEQ G190
                      ...
                      (SEQ (LETT |delta| (|sub_SI| |dr0| |dr1|))
                           ...
                           (COND
                            ((|less_SI| |dr0| 0)
                             (PROGN (LETT #3# |$NoValue|) (GO #4=#:G196))))
                           (SPADCALL |r0| 1 |r1| |c1| |dr0| |delta| |p|
                                     (QREFELT $ 31))
                           (EXIT
                            (SEQ
...
(SDEFUN |POLYVEC;gcd;2UvIUv;14|
        ...
        (SPROG
         ((#1=#:G218 NIL) (|c| #2=(|Integer|)) (|dr1| #3=(|SingleInteger|))
          (|r1| #4=(|U32Vector|)) (|dr0| #3#) (|r0| #4#)
          (|tmp| #5=(|SingleInteger|)) (|tmpp| (|U32Vector|)) (#6=#:G217 NIL)
          ...
          (EXIT
           (SEQ (LETT |dr0| (SPADCALL |y| (QREFELT $ 30)))
                ...
                (EXIT
                 (COND
                  ((|less_SI| |dr0| 0)
                   (PROGN (LETT #1# (GETREFV_U32 1 0)) (GO #8=#:G216)))
                  (#7#
...
(SDEFUN |POLYVEC;gcd;Pa3IUv;15|
        ((|a| |PrimitiveArray| (|U32Vector|)) (|lo| |Integer|) (|hi| |Integer|)
         (|p| |Integer|) ($ |U32Vector|))
        (SPROG ((|res| (|U32Vector|)) (#1=#:G222 NIL) (|i| NIL))
...
(SDEFUN |POLYVEC;lcm;Pa3IUv;17|
        ((|a| |PrimitiveArray| (|U32Vector|)) (|lo| |Integer|) (|hi| |Integer|)
         (|p| |Integer|) ($ |U32Vector|))
        (SPROG ((|res| (|U32Vector|)) (#1=#:G229 NIL) (|i| NIL))
               (SEQ (LETT |res| (QAREF1 |a| |lo|))
                    (SEQ (LETT |i| (+ |lo| 1)) (LETT #1# |hi|) G190
                         (COND ((> |i| #1#) (GO G191)))
                         (SEQ
...
(SDEFUN |POLYVEC;inner_mul|
        ...
        (SPROG
         ((|ss| (|Integer|)) (#3=#:G252 NIL) (|j| NIL) (#4=#:G251 NIL)
          (|i| NIL) (#5=#:G250 NIL) (#6=#:G249 NIL) (#7=#:G248 NIL)
          (#8=#:G247 NIL) (|tmp| #2#) (|tmpp| #1#))
         (SEQ
          (COND
           ((|less_SI| |ydeg| |xdeg|)
            (SEQ (LETT |tmpp| |x|) (LETT |tmp| |xdeg|) (LETT |x| |y|)
...
(SDEFUN |POLYVEC;differentiate;UvIUv;23|
        ...
        (SPROG
         ((|i1| (|NonNegativeInteger|)) (#1=#:G267 NIL) (|i| NIL)
          (|r| (|U32Vector|)) (#2=#:G261 NIL) (|d| (|Integer|)))
...
(SDEFUN |POLYVEC;differentiate;UvNniIUv;24|
        ((|x| |U32Vector|) (|n| |NonNegativeInteger|) (|p| |Integer|)
         ($ |U32Vector|))
        (SPROG
         ((|f| (|Integer|)) (#1=#:G276 NIL) (|k| NIL) (|j| #2=(|Integer|))
          (#3=#:G275 NIL) (|i| NIL) (|r| (|U32Vector|)) (|d| #2#))
         (SEQ
          (COND ((ZEROP |n|) |x|)
                (#4='T
                 (SEQ (LETT |d| (- (QV_LEN_U32 |x|) 1))
