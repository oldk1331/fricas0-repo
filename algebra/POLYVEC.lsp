...
(SDEFUN |POLYVEC;pa_to_sup;UvSup;5|
        ...
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| (|Integer|))) (#1=#:G136 NIL)
...
(SDEFUN |POLYVEC;vector_add_mul;2Uv4IV;6|
        ...
        (SPROG
         ((#1=#:G140 NIL) (|i| NIL) (|ns| #2=(|SingleInteger|)) (|ms| #2#))
         (SEQ (LETT |ms| |m|) (LETT |ns| |n|)
              (EXIT
...
(SDEFUN |POLYVEC;mul_by_binomial;Uv3IV;7|
        ((|v| |U32Vector|) (|n| |Integer|) (|pt| |Integer|) (|p| |Integer|)
         ($ |Void|))
        (SPROG
         ((|prev_coeff| (|Integer|)) (|pp| (|Integer|)) (#1=#:G145 NIL)
...
(SDEFUN |POLYVEC;mul_by_scalar;Uv3IV;9|
        ((|v| |U32Vector|) (|n| |Integer|) (|c| |Integer|) (|p| |Integer|)
         ($ |Void|))
        (SPROG ((#1=#:G150 NIL) (|i| NIL) (|ns| (|SingleInteger|)))
               (SEQ (LETT |ns| |n|)
                    (EXIT
                        ...
                        (EXIT
                         (COND
                          ((NULL (EQL (ELT_U32 |v| |i|) 0))
                           (PROGN
                            (LETT #1# (PROGN (LETT #2# |i|) (GO #3=#:G154)))
                            (GO #4=#:G152))))))
...
(SDEFUN |POLYVEC;vector_combination;UvIUv4IV;11|
        ((|v1| |U32Vector|) (|c1| |Integer|) (|v2| |U32Vector|)
         ...
         ($ |Void|))
        (SPROG
         ((#1=#:G168 NIL) (|i| NIL) (#2=#:G167 NIL) (#3=#:G166 NIL)
          (#4=#:G165 NIL) (|ds| #5=(|SingleInteger|)) (|ns| #5#))
...
(SDEFUN |POLYVEC;divide!;3UvIV;12|
        ((|r0| |U32Vector|) (|r1| |U32Vector|) (|res| |U32Vector|)
         (|p| |Integer|) ($ |Void|))
        (SPROG
         ((#1=#:G178 NIL) (|dr0| #2=(|SingleInteger|)) (#3=#:G179 NIL)
...
(SDEFUN |POLYVEC;remainder!;2UvIV;13|
        ...
        (SPROG
         ((#1=#:G190 NIL) (|dr0| #2=(|SingleInteger|)) (#3=#:G191 NIL)
          (|c1| (|Integer|)) (|delta| (|SingleInteger|)) (|c0| (|Integer|))
          (#4=#:G192 NIL) (|dr1| #2#))
         (SEQ
          (EXIT
           (SEQ (LETT |dr0| (SPADCALL |r0| (QREFELT $ 30)))
                ...
                (EXIT
                 (COND
                  ...
                  ((|less_SI| |dr0| 0)
                   (PROGN (LETT #4# (SPADCALL (QREFELT $ 32))) (GO #5=#:G189)))
                  ((|eql_SI| |dr1| 0)
                   (SEQ G190
...
(SDEFUN |POLYVEC;gcd;2UvIUv;14|
        ...
        (SPROG
         ((#1=#:G210 NIL) (|c| #2=(|Integer|)) (|dr1| #3=(|SingleInteger|))
          (|r1| #4=(|U32Vector|)) (|dr0| #3#) (|r0| #4#)
          (|tmp| #5=(|SingleInteger|)) (|tmpp| (|U32Vector|)) (#6=#:G209 NIL)
          ...
          (EXIT
           (SEQ (LETT |dr0| (SPADCALL |y| (QREFELT $ 30)))
                ...
                (EXIT
                 (COND
                  ((|less_SI| |dr0| 0)
                   (PROGN (LETT #1# (GETREFV_U32 1 0)) (GO #8=#:G208)))
                  (#7#
...
(SDEFUN |POLYVEC;gcd;Pa3IUv;15|
        ((|a| |PrimitiveArray| (|U32Vector|)) (|lo| |Integer|) (|hi| |Integer|)
         (|p| |Integer|) ($ |U32Vector|))
        (SPROG ((|res| (|U32Vector|)) (#1=#:G214 NIL) (|i| NIL))
...
(SDEFUN |POLYVEC;lcm;Pa3IUv;17|
        ((|a| |PrimitiveArray| (|U32Vector|)) (|lo| |Integer|) (|hi| |Integer|)
         (|p| |Integer|) ($ |U32Vector|))
        (SPROG ((|res| (|U32Vector|)) (#1=#:G221 NIL) (|i| NIL))
               (SEQ (LETT |res| (QAREF1 |a| |lo|))
                    (SEQ (LETT |i| (+ |lo| 1)) (LETT #1# |hi|) G190
                         (COND ((> |i| #1#) (GO G191)))
                         (SEQ
...
(SDEFUN |POLYVEC;inner_mul|
        ...
        (SPROG
         ((|ss| (|Integer|)) (#3=#:G244 NIL) (|j| NIL) (#4=#:G243 NIL)
          (|i| NIL) (#5=#:G242 NIL) (#6=#:G241 NIL) (#7=#:G240 NIL)
          (#8=#:G239 NIL) (|tmp| #2#) (|tmpp| #1#))
         (SEQ
          (COND
           ((|less_SI| |ydeg| |xdeg|)
            (SEQ (LETT |tmpp| |x|) (LETT |tmp| |xdeg|) (LETT |x| |y|)
...
(SDEFUN |POLYVEC;differentiate;UvIUv;23|
        ...
        (SPROG
         ((|i1| (|NonNegativeInteger|)) (#1=#:G259 NIL) (|i| NIL)
          (|r| (|U32Vector|)) (#2=#:G253 NIL) (|d| (|Integer|)))
...
(SDEFUN |POLYVEC;differentiate;UvNniIUv;24|
        ((|x| |U32Vector|) (|n| |NonNegativeInteger|) (|p| |Integer|)
         ($ |U32Vector|))
        (SPROG
         ((|f| (|Integer|)) (#1=#:G268 NIL) (|k| NIL) (|j| #2=(|Integer|))
          (#3=#:G267 NIL) (|i| NIL) (|r| (|U32Vector|)) (|d| #2#))
         (SEQ
          (COND ((ZEROP |n|) |x|)
                (#4='T
                 (SEQ (LETT |d| (- (QV_LEN_U32 |x|) 1))
