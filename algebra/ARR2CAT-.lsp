...
(SDEFUN |ARR2CAT-;any?;MSB;1|
        ...
        (SPROG
         ((#1=#:G216 NIL) (#2=#:G217 NIL) (#3=#:G219 NIL) (|j| NIL)
          (#4=#:G218 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
                         ...
                         (EXIT
                          (COND
                           ((SPADCALL (SPADCALL |m| |i| |j| (QREFELT $ 15))
                                      |f|)
                            (PROGN
                             (LETT #1# (PROGN (LETT #2# 'T) (GO #5=#:G215)))
                             (GO #6=#:G211))))))
...
(SDEFUN |ARR2CAT-;every?;MSB;2|
        ((|f| |Mapping| (|Boolean|) R) (|m| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G225 NIL) (#2=#:G226 NIL) (#3=#:G228 NIL) (|j| NIL)
          (#4=#:G227 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
                          ...
                          (COND
                           ((NULL
                             (SPADCALL (SPADCALL |m| |i| |j| (QREFELT $ 15))
                                       |f|))
                            (PROGN
                             (LETT #1# (PROGN (LETT #2# NIL) (GO #5=#:G224)))
                             (GO #6=#:G221))))))
                        (LETT |j| (+ |j| 1)) (GO G190) G191 (EXIT NIL)))
                  #6# (EXIT #1#))
                 (LETT |i| (+ |i| 1)) (GO G190) G191 (EXIT NIL))
...
(SDEFUN |ARR2CAT-;smaller?;2SB;6| ((|m1| S) (|m2| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G241 NIL) (|el2| (R)) (|el1| (R)) (#2=#:G243 NIL) (|j| NIL)
          (#3=#:G242 NIL) (|i| NIL) (|maxColIndex| (|Integer|))
...
(SDEFUN |ARR2CAT-;count;MSNni;9|
        ...
        (SPROG
         ((|num| (|NonNegativeInteger|)) (#1=#:G257 NIL) (|j| NIL)
          (#2=#:G256 NIL) (|i| NIL))
         (SEQ (LETT |num| 0)
              (SEQ (LETT |i| (SPADCALL |m| (QREFELT $ 11)))
...
(SDEFUN |ARR2CAT-;parts;SL;10| ((|m| S) ($ |List| R))
        (SPROG
         ((|entryList| (|List| R)) (#1=#:G263 NIL) (|j| NIL) (#2=#:G262 NIL)
          (|i| NIL))
...
(SDEFUN |ARR2CAT-;listOfLists;SL;11| ((|x| S) ($ |List| (|List| R)))
        (SPROG
         ((|ll| (|List| (|List| R))) (|l| (|List| R)) (#1=#:G270 NIL) (|j| NIL)
          (#2=#:G269 NIL) (|i| NIL))
         (SEQ (LETT |ll| NIL)
...
(SDEFUN |ARR2CAT-;subMatrix;S4IS;12|
        ((|x| S) (|i1| |Integer|) (|i2| |Integer|) (|j1| |Integer|)
         (|j2| |Integer|) ($ S))
        (SPROG
         ((#1=#:G283 NIL) (|j| NIL) (#2=#:G284 NIL) (|l| NIL) (#3=#:G281 NIL)
          (|i| NIL) (#4=#:G282 NIL) (|k| NIL) (|y| (S))
...
(SDEFUN |ARR2CAT-;elt;SILS;13|
        ...
        (SPROG
         ((#1=#:G295 NIL) (|ej| NIL) (#2=#:G296 NIL) (|j| NIL) (|y| (S))
          (#3=#:G293 NIL) (#4=#:G294 NIL))
         (SEQ
          (COND
...
(SDEFUN |ARR2CAT-;elt;SLIS;14|
        ...
        (SPROG
         ((#1=#:G307 NIL) (|ei| NIL) (#2=#:G308 NIL) (|i| NIL) (|y| (S))
          (#3=#:G305 NIL) (#4=#:G306 NIL))
         (SEQ
          (SEQ
           (EXIT
...
(SDEFUN |ARR2CAT-;elt;S2LS;15|
        ((|x| S) (|rowList| |List| (|Integer|)) (|colList| |List| (|Integer|))
         ($ S))
        (SPROG
         ((#1=#:G325 NIL) (|ej| NIL) (#2=#:G326 NIL) (|j| NIL) (#3=#:G323 NIL)
          (|ei| NIL) (#4=#:G324 NIL) (|i| NIL) (|y| (S)) (#5=#:G319 NIL)
          (#6=#:G322 NIL) (#7=#:G320 NIL) (#8=#:G321 NIL))
         (SEQ
          (SEQ
           (EXIT
...
(SDEFUN |ARR2CAT-;elt;SLSS;17|
        ((|x| S) (|rowList| |List| (|Integer|)) (|sc| |Segment| (|Integer|))
         ($ S))
        (SPROG
         ((#1=#:G344 NIL) (|j| NIL) (#2=#:G345 NIL) (#3=#:G346 NIL) (|l| NIL)
          (#4=#:G342 NIL) (|i| NIL) (#5=#:G343 NIL) (|k| NIL) (|y| (S))
...
(SDEFUN |ARR2CAT-;elt;SSLS;18|
        ((|x| S) (|sr| |Segment| (|Integer|)) (|colList| |List| (|Integer|))
         ($ S))
        (SPROG
         ((#1=#:G354 NIL) (|j| NIL) (#2=#:G355 NIL) (|l| NIL) (#3=#:G351 NIL)
          (|i| NIL) (#4=#:G352 NIL) (#5=#:G353 NIL) (|k| NIL) (|y| (S))
          (|nc| (|NonNegativeInteger|)) (|nr| (|NonNegativeInteger|))
...
(SDEFUN |ARR2CAT-;elt;S2SS;19|
        ((|x| S) (|sr| |Segment| (|Integer|)) (|sc| |Segment| (|Integer|))
         ($ S))
        (SPROG
         ((#1=#:G363 NIL) (|j| NIL) (#2=#:G364 NIL) (#3=#:G365 NIL) (|l| NIL)
          (#4=#:G360 NIL) (|i| NIL) (#5=#:G361 NIL) (#6=#:G362 NIL) (|k| NIL)
...
(SDEFUN |ARR2CAT-;check_segs|
        ...
        (SPROG ((|res| (|NonNegativeInteger|)) (#1=#:G369 NIL) (|s| NIL))
               (SEQ (LETT |res| 0)
...
(SDEFUN |ARR2CAT-;elt;SILS;21|
        ((|x| S) (|row| |Integer|) (|lsc| |List| (|Segment| (|Integer|)))
         ($ S))
        (SPROG
         ((|j| (|Integer|)) (#1=#:G377 NIL) (#2=#:G378 NIL) (|l| NIL)
          (#3=#:G376 NIL) (|sc| NIL) (|y| (S)) (|nc| (|NonNegativeInteger|)))
         (SEQ
          (LETT |nc|
...
(SDEFUN |ARR2CAT-;elt;SLIS;22|
        ((|x| S) (|lsr| |List| (|Segment| (|Integer|))) (|col| |Integer|)
         ($ S))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G386 NIL) (#2=#:G387 NIL) (|k| NIL)
          (#3=#:G385 NIL) (|sr| NIL) (|y| (S)) (|nr| (|NonNegativeInteger|)))
         (SEQ
          (LETT |nr|
...
(SDEFUN |ARR2CAT-;elt;SSLS;23|
        ...
        (SPROG
         ((|j| (|Integer|)) (#1=#:G397 NIL) (|i| NIL) (#2=#:G398 NIL)
          (#3=#:G399 NIL) (|k| NIL) (#4=#:G395 NIL) (#5=#:G396 NIL) (|l| NIL)
          (#6=#:G394 NIL) (|sc| NIL) (|y| (S)) (|nc| (|NonNegativeInteger|))
...
(SDEFUN |ARR2CAT-;elt;SLSS;24|
        ...
        (SPROG
         ((|i| (|Integer|)) (#1=#:G409 NIL) (|j| NIL) (#2=#:G410 NIL)
          (#3=#:G411 NIL) (|l| NIL) (#4=#:G407 NIL) (#5=#:G408 NIL) (|k| NIL)
          (#6=#:G406 NIL) (|sr| NIL) (|y| (S)) (|nc| (|NonNegativeInteger|))
...
(SDEFUN |ARR2CAT-;elt;S2LS;25|
        ((|x| S) (|lsr| |List| (|Segment| (|Integer|)))
         (|lsc| |List| (|Segment| (|Integer|))) ($ S))
        (SPROG
         ((|i| (|Integer|)) (|j| (|Integer|)) (#1=#:G425 NIL) (#2=#:G426 NIL)
          (|l| NIL) (#3=#:G424 NIL) (|sc| NIL) (#4=#:G422 NIL) (#5=#:G423 NIL)
          (|k| NIL) (|ir| (|Integer|)) (|ur| (|Integer|)) (|lr| (|Integer|))
          (#6=#:G421 NIL) (|sr| NIL) (|y| (S)) (|nc| #7=(|NonNegativeInteger|))
          (|nr| #7#))
         (SEQ
          (LETT |nr|
                (|ARR2CAT-;check_segs| |lsr| (SPADCALL |x| (QREFELT $ 11))
...
(SDEFUN |ARR2CAT-;setelt!;SIL2S;28|
        ((|x| S) (|row| |Integer|) (|colList| |List| (|Integer|)) (|y| S)
         ($ S))
        (SPROG
         ((#1=#:G441 NIL) (|ej| NIL) (#2=#:G442 NIL) (|j| NIL)
          (|rowiy| (|Integer|)) (#3=#:G439 NIL) (#4=#:G440 NIL))
         (SEQ
          (COND
           ((OR (< |row| (SPADCALL |x| (QREFELT $ 11)))
                (SPADCALL |row| (SPADCALL |x| (QREFELT $ 12)) (QREFELT $ 32)))
...
(SDEFUN |ARR2CAT-;setelt!;SLI2S;29|
        ((|x| S) (|rowList| |List| (|Integer|)) (|col| |Integer|) (|y| S)
         ($ S))
        (SPROG
         ((#1=#:G455 NIL) (|ei| NIL) (#2=#:G456 NIL) (|i| NIL)
          (|coliy| (|Integer|)) (#3=#:G453 NIL) (#4=#:G454 NIL))
         (SEQ
          (SEQ
           (EXIT
            (SEQ (LETT |ei| NIL) (LETT #4# |rowList|) G190
...
(SDEFUN |ARR2CAT-;setelt!;S2L2S;30|
        ((|x| S) (|rowList| |List| (|Integer|)) (|colList| |List| (|Integer|))
         (|y| S) ($ S))
        (SPROG
         ((#1=#:G475 NIL) (|ej| NIL) (#2=#:G476 NIL) (|j| NIL) (#3=#:G473 NIL)
          (|ei| NIL) (#4=#:G474 NIL) (|i| NIL) (#5=#:G469 NIL) (#6=#:G472 NIL)
          (#7=#:G470 NIL) (#8=#:G471 NIL))
         (SEQ
          (SEQ
           (EXIT
            (SEQ (LETT |ei| NIL) (LETT #8# |rowList|) G190
...
(SDEFUN |ARR2CAT-;setelt!;S2S2S;31|
        ((|x| S) (|sr| |Segment| (|Integer|)) (|sc| |Segment| (|Integer|))
         (|y| S) ($ S))
        (SPROG
         ((#1=#:G486 NIL) (|j| NIL) (#2=#:G487 NIL) (#3=#:G488 NIL) (|l| NIL)
          (#4=#:G483 NIL) (|i| NIL) (#5=#:G484 NIL) (#6=#:G485 NIL) (|k| NIL)
...
(SDEFUN |ARR2CAT-;setelt!;SLS2S;32|
        ((|x| S) (|rowList| |List| (|Integer|)) (|sc| |Segment| (|Integer|))
         (|y| S) ($ S))
        (SPROG
         ((#1=#:G497 NIL) (|j| NIL) (#2=#:G498 NIL) (#3=#:G499 NIL) (|l| NIL)
          (#4=#:G495 NIL) (|i| NIL) (#5=#:G496 NIL) (|k| NIL)
          (|nc| (|NonNegativeInteger|)) (|nr| (|NonNegativeInteger|))
          (|ic| (|Integer|)) (|uc| (|Integer|)) (|lc| (|Integer|)))
         (SEQ (LETT |lc| (SPADCALL |sc| (QREFELT $ 48)))
              (LETT |uc| (SPADCALL |sc| (QREFELT $ 49)))
...
(SDEFUN |ARR2CAT-;setelt!;SSL2S;33|
        ((|x| S) (|sr| |Segment| (|Integer|)) (|colList| |List| (|Integer|))
         (|y| S) ($ S))
        (SPROG
         ((#1=#:G509 NIL) (|j| NIL) (#2=#:G510 NIL) (|l| NIL) (#3=#:G506 NIL)
          (|i| NIL) (#4=#:G507 NIL) (#5=#:G508 NIL) (|k| NIL)
          (|nc| (|NonNegativeInteger|)) (|nr| (|NonNegativeInteger|))
          (|ir| (|Integer|)) (|ur| (|Integer|)) (|lr| (|Integer|)))
         (SEQ (LETT |lr| (SPADCALL |sr| (QREFELT $ 48)))
              (LETT |ur| (SPADCALL |sr| (QREFELT $ 49)))
...
(SDEFUN |ARR2CAT-;setelt!;SIL2S;34|
        ((|x| S) (|row| |Integer|) (|lsc| |List| (|Segment| (|Integer|)))
         (|y| S) ($ S))
        (SPROG
         ((|j| (|Integer|)) (#1=#:G520 NIL) (#2=#:G521 NIL) (|l| NIL)
          (#3=#:G519 NIL) (|sc| NIL) (|i| (|Integer|))
...
(SDEFUN |ARR2CAT-;setelt!;SLI2S;35|
        ((|x| S) (|lsr| |List| (|Segment| (|Integer|))) (|col| |Integer|)
         (|y| S) ($ S))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G531 NIL) (#2=#:G532 NIL) (|k| NIL)
          (#3=#:G530 NIL) (|sr| NIL) (|j| (|Integer|))
...
(SDEFUN |ARR2CAT-;setelt!;SSL2S;36|
        ...
        (SPROG
         ((|j| (|Integer|)) (#1=#:G544 NIL) (|i| NIL) (#2=#:G545 NIL)
          (#3=#:G546 NIL) (|k| NIL) (#4=#:G542 NIL) (#5=#:G543 NIL) (|l| NIL)
          (#6=#:G541 NIL) (|sc| NIL) (|nc| (|NonNegativeInteger|))
          (|nr| (|NonNegativeInteger|)) (|ir| (|Integer|)) (|ur| (|Integer|))
          (|lr| (|Integer|)))
         (SEQ (LETT |lr| (SPADCALL |sr| (QREFELT $ 48)))
              (LETT |ur| (SPADCALL |sr| (QREFELT $ 49)))
...
(SDEFUN |ARR2CAT-;setelt!;SLS2S;37|
        ...
        (SPROG
         ((|i| (|Integer|)) (#1=#:G558 NIL) (|j| NIL) (#2=#:G559 NIL)
          (#3=#:G560 NIL) (|l| NIL) (#4=#:G556 NIL) (#5=#:G557 NIL) (|k| NIL)
          (#6=#:G555 NIL) (|sr| NIL) (|nc| (|NonNegativeInteger|))
          (|nr| (|NonNegativeInteger|)) (|ic| (|Integer|)) (|uc| (|Integer|))
          (|lc| (|Integer|)))
         (SEQ (LETT |lc| (SPADCALL |sc| (QREFELT $ 48)))
              (LETT |uc| (SPADCALL |sc| (QREFELT $ 49)))
...
(SDEFUN |ARR2CAT-;setelt!;S2L2S;38|
        ((|x| S) (|lsr| |List| (|Segment| (|Integer|)))
         (|lsc| |List| (|Segment| (|Integer|))) (|y| S) ($ S))
        (SPROG
         ((|i| (|Integer|)) (|j| (|Integer|)) (#1=#:G576 NIL) (#2=#:G577 NIL)
          (|l| NIL) (#3=#:G575 NIL) (|sc| NIL) (#4=#:G573 NIL) (#5=#:G574 NIL)
          (|k| NIL) (|ir| (|Integer|)) (|ur| (|Integer|)) (|lr| (|Integer|))
          (#6=#:G572 NIL) (|sr| NIL) (|nc| #7=(|NonNegativeInteger|))
          (|nr| #7#))
         (SEQ
          (LETT |nr|
                (|ARR2CAT-;check_segs| |lsr| (SPADCALL |x| (QREFELT $ 11))
...
(SDEFUN |ARR2CAT-;setsubMatrix!;S2I2S;39|
        ...
        (SPROG
         ((#1=#:G588 NIL) (|j| NIL) (#2=#:G589 NIL) (|l| NIL) (#3=#:G586 NIL)
          (|i| NIL) (#4=#:G587 NIL) (|k| NIL) (|j2| #5=(|Integer|)) (|i2| #5#))
...
(SDEFUN |ARR2CAT-;transpose;2S;42| ((|x| S) ($ S))
        (SPROG
         ((#1=#:G615 NIL) (|j| NIL) (#2=#:G614 NIL) (|i| NIL) (|ans| (S)))
         (SEQ
          (LETT |ans|
...
(SDEFUN |ARR2CAT-;squareTop;2S;43| ((|x| S) ($ S))
        (SPROG
         ((#1=#:G622 NIL) (|j| NIL) (#2=#:G621 NIL) (|i| NIL) (|ans| (S))
...
(SDEFUN |ARR2CAT-;horizConcat;LS;45| ((|la| |List| S) ($ S))
        (SPROG
         ((|l| (|Integer|)) (#1=#:G637 NIL) (|j| NIL) (#2=#:G636 NIL) (|a| NIL)
          (#3=#:G635 NIL) (|i| NIL) (|ans| (S)) (|nc| (|NonNegativeInteger|))
          (#4=#:G634 NIL) (|nr| (|NonNegativeInteger|)) (|a1| (S)))
         (SEQ
...
(SDEFUN |ARR2CAT-;blockConcat;LS;48| ((LLA |List| (|List| S)) ($ S))
        (SPROG ((#1=#:G655 NIL) (LA NIL) (#2=#:G654 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |ARR2CAT-;vertSplit;SPiL;49|
        ...
        (SPROG
         ((#1=#:G664 NIL) (|i| NIL) (#2=#:G663 NIL) (|mac| (|Integer|))
...
(SDEFUN |ARR2CAT-;vertSplit;SLL;50|
        ...
        (SPROG
         ((#1=#:G682 NIL) (|i| NIL) (#2=#:G681 NIL) (|mac| (|Integer|))
          (|mic| (|Integer|)) (|mir| (|Integer|))
...
(SDEFUN |ARR2CAT-;horizSplit;SPiL;51|
        ...
        (SPROG
         ((#1=#:G691 NIL) (|i| NIL) (#2=#:G690 NIL) (|mic| (|Integer|))
...
(SDEFUN |ARR2CAT-;horizSplit;SLL;52|
        ...
        (SPROG
         ((#1=#:G709 NIL) (|i| NIL) (#2=#:G708 NIL) (|mic| (|Integer|))
          (|mar| (|Integer|)) (|mir| (|Integer|))
          (|l| (|List| (|NonNegativeInteger|))))
         (SEQ
          (COND
...
(SDEFUN |ARR2CAT-;blockSplit;S2PiL;53|
        ((A S) (|nr| |PositiveInteger|) (|nc| |PositiveInteger|)
         ($ |List| (|List| S)))
        (SPROG ((#1=#:G713 NIL) (X NIL) (#2=#:G712 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |ARR2CAT-;blockSplit;S2LL;54|
        ...
        (SPROG ((#1=#:G717 NIL) (X NIL) (#2=#:G716 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |ARR2CAT-;map;M2S;57| ((|f| |Mapping| R R) (|m| S) ($ S))
        (SPROG
         ((#1=#:G736 NIL) (|j| NIL) (#2=#:G735 NIL) (|i| NIL) (|ans| (S)))
         (SEQ
          (LETT |ans|
                (SPADCALL (SPADCALL |m| (QREFELT $ 21))
                          (SPADCALL |m| (QREFELT $ 22)) NIL (QREFELT $ 113)))
...
(SDEFUN |ARR2CAT-;map!;M2S;58| ((|f| |Mapping| R R) (|m| S) ($ S))
        (SPROG ((#1=#:G742 NIL) (|j| NIL) (#2=#:G741 NIL) (|i| NIL))
               (SEQ
                (SEQ (LETT |i| (SPADCALL |m| (QREFELT $ 11)))
                     (LETT #2# (SPADCALL |m| (QREFELT $ 12))) G190
                     (COND ((> |i| #2#) (GO G191)))
...
(SDEFUN |ARR2CAT-;map;M3S;59| ((|f| |Mapping| R R R) (|m| S) (|n| S) ($ S))
        (SPROG
         ((#1=#:G751 NIL) (|j| NIL) (#2=#:G750 NIL) (|i| NIL) (|ans| (S)))
         (SEQ
          (COND
           ((OR
             (SPADCALL (SPADCALL |m| (QREFELT $ 21))
...
(SDEFUN |ARR2CAT-;map;M2SRS;60|
        ...
        (SPROG
         ((#1=#:G757 NIL) (|j| NIL) (#2=#:G756 NIL) (|i| NIL) (|ans| (S))
...
(SDEFUN |ARR2CAT-;setRow!;SIRowS;61|
        ...
        (SPROG ((#1=#:G763 NIL) (|j| NIL) (#2=#:G764 NIL) (|k| NIL))
               (SEQ
                (COND
                 ((OR (< |i| (SPADCALL |m| (QREFELT $ 11)))
...
(SDEFUN |ARR2CAT-;setColumn!;SIColS;62|
        ...
        (SPROG ((#1=#:G770 NIL) (|i| NIL) (#2=#:G771 NIL) (|k| NIL))
               (SEQ
                (COND
                 ((OR (< |j| (SPADCALL |m| (QREFELT $ 13)))
                 ...
                 ('T
                  (SEQ
                   (SEQ (LETT |k| (SPADCALL |v| (QREFELT $ 127)))
                        (LETT #2# (SPADCALL |v| (QREFELT $ 128)))
...
(SDEFUN |ARR2CAT-;member?;RSB;64| ((|r| R) (|m| S) ($ |Boolean|))
        (SPROG
         ((#1=#:G789 NIL) (#2=#:G790 NIL) (#3=#:G792 NIL) (|j| NIL)
          (#4=#:G791 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
                         ...
                         (EXIT
                          (COND
                           ((SPADCALL (SPADCALL |m| |i| |j| (QREFELT $ 15)) |r|
                                      (QREFELT $ 29))
                            (PROGN
                             (LETT #1# (PROGN (LETT #2# 'T) (GO #5=#:G788)))
                             (GO #6=#:G785))))))
                        (LETT |j| (+ |j| 1)) (GO G190) G191 (EXIT NIL)))
                  #6# (EXIT #1#))
                 (LETT |i| (+ |i| 1)) (GO G190) G191 (EXIT NIL))
...
(SDEFUN |ARR2CAT-;row;SIRow;66| ((|m| S) (|i| |Integer|) ($ |Row|))
        (SPROG
         ((#1=#:G801 NIL) (|j| NIL) (#2=#:G802 NIL) (|k| NIL) (|v| (|Row|))
          ...
          (COND
           ...
           ('T
            (SEQ (LETT |nc| (SPADCALL |m| (QREFELT $ 22)))
                 (EXIT
                  (COND ((EQL |nc| 0) (SPADCALL (QREFELT $ 136)))
                        ('T
...
(SDEFUN |ARR2CAT-;column;SICol;67| ((|m| S) (|j| |Integer|) ($ |Col|))
        (SPROG
         ((#1=#:G809 NIL) (|i| NIL) (#2=#:G810 NIL) (|k| NIL) (|v| (|Col|))
          ...
          (COND
           ...
           ('T
            (SEQ (LETT |nr| (SPADCALL |m| (QREFELT $ 21)))
                 (EXIT
                  (COND ((EQL |nr| 0) (SPADCALL (QREFELT $ 140)))
                        ('T
...
(SDEFUN |ARR2CAT-;coerce;SOf;68| ((|m| S) ($ |OutputForm|))
        (SPROG
         ((|l| (|List| (|List| (|OutputForm|)))) (#1=#:G818 NIL) (|j| NIL)
          (#2=#:G817 NIL) (#3=#:G816 NIL) (|i| NIL) (#4=#:G815 NIL))
         (SEQ
          (LETT |l|
                (PROGN
                 (LETT #4# NIL)
   ...
   (PROGN
    ...
    (COND
     ((|HasCategory| |#2| '(|CoercibleTo| (|OutputForm|)))
      (QSETREFV $ 147 (CONS (|dispatchFunction| |ARR2CAT-;coerce;SOf;68|) $))))
    $))) 
...
(MAKEPROP '|TwoDimensionalArrayCategory&| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (265 . |member?|) (271 . |count|) (277 . |count|) (283 . |empty|)
              (287 . |new|) (293 . |qsetelt!|) (300 . |row|) (306 . |empty|)
              (310 . |new|) (316 . |qsetelt!|) (323 . |column|) (|OutputForm|)
              (329 . |coerce|) (334 . |matrix|) (339 . |coerce|))
           '#(|vertSplit| 344 |vertConcat| 356 |transpose| 367 |swapRows!| 372
              |swapColumns!| 379 |subMatrix| 386 |squareTop| 395 |smaller?| 400
              |size?| 406 |setsubMatrix!| 412 |setelt!| 420 |setRow!| 508
              |setColumn!| 515 |rowSlice| 522 |row| 527 |parts| 533 |more?| 538
              |member?| 544 |map!| 550 |map| 556 |listOfLists| 577 |less?| 582
              |horizSplit| 588 |horizConcat| 600 |fill!| 611 |every?| 617 |elt|
              623 |count| 708 |copy| 720 |column| 725 |colSlice| 731 |coerce|
              736 |blockSplit| 741 |blockConcat| 755 |any?| 760 = 766 |#| 772)
           'NIL
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 147
                                            '(1 6 10 0 11 1 6 10 0 12 1 6 10 0
                                              ...
                                              110 2 6 83 0 98 111 3 6 0 20 20 7
                                              113 4 6 7 0 10 10 7 121 1 8 10 0
                                              123 1 8 10 0 124 2 8 7 0 10 125 1
                                              9 10 0 127 1 9 10 0 128 2 9 7 0
                                              10 129 2 6 16 0 0 131 2 0 16 0 0
                                              132 2 0 16 7 0 133 2 6 20 17 0
                                              134 2 0 20 7 0 135 0 8 0 136 2 8
                                              0 20 7 137 3 8 7 0 10 7 138 2 0 8
                                              0 10 139 0 9 0 140 2 9 0 20 7 141
                                              3 9 7 0 10 7 142 2 0 9 0 10 143 1
                                              7 144 0 145 1 144 0 90 146 1 0
                                              144 0 147 2 0 83 0 94 95 2 0 83 0
                                              98 104 1 0 0 83 89 2 0 0 0 0 88 1
                                              0 0 0 81 3 0 0 0 10 10 79 3 0 0 0
                                              10 10 80 5 0 0 0 10 10 10 10 41 1
                                              0 0 0 82 2 0 16 0 0 30 2 0 16 0
                                              20 23 4 0 0 0 10 10 0 78 4 0 0 0
                                              54 54 0 75 4 0 0 0 46 54 0 73 4 0
                                              0 0 54 46 0 74 4 0 0 0 42 46 0 69
                                              4 0 0 0 46 42 0 70 4 0 0 0 42 42
                                              0 66 4 0 0 0 46 46 0 68 4 0 0 0
                                              10 42 0 64 4 0 0 0 42 10 0 65 4 0
                                              0 0 54 10 0 72 4 0 0 0 10 54 0 71
                                              3 0 0 0 10 8 126 3 0 0 0 10 9 130
                                              1 0 46 0 61 2 0 8 0 10 139 1 0 35
                                              0 36 2 0 16 0 20 26 2 0 16 7 0
                                              133 2 0 0 116 0 118 4 0 0 119 0 0
                                              7 122 3 0 0 119 0 0 120 2 0 0 116
                                              0 117 1 0 37 0 38 2 0 16 0 20 24
                                              2 0 83 0 94 105 2 0 83 0 98 106 2
                                              0 0 0 0 85 1 0 0 83 86 2 0 0 0 7
                                              115 2 0 16 17 0 19 3 0 0 0 54 46
                                              58 3 0 0 0 54 54 59 3 0 0 0 46 54
                                              57 3 0 0 0 54 10 56 3 0 0 0 46 42
                                              51 3 0 0 0 10 54 55 3 0 0 0 46 46
                                              53 3 0 0 0 42 46 50 3 0 0 0 42 10
                                              44 3 0 0 0 42 42 45 3 0 0 0 10 42
                                              43 4 0 7 0 10 10 7 33 2 0 20 7 0
                                              135 2 0 20 17 0 34 1 0 0 0 114 2
                                              0 9 0 10 143 1 0 46 0 62 1 0 144
                                              0 147 3 0 90 0 94 94 109 3 0 90 0
                                              98 98 112 1 0 0 90 91 2 0 16 17 0
                                              18 2 0 16 0 0 132 1 0 20 0
                                              31)))))
           '|lookupComplete|)) 
