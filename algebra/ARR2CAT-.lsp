...
(DEFUN |ARR2CAT-;any?;MSB;1| (|f| |m| $)
  (PROG (#1=#:G155 #2=#:G159 #3=#:G161 |j| #4=#:G160 |i|)
    (RETURN
     (SEQ
      (EXIT
       (SEQ
...
(DEFUN |ARR2CAT-;every?;MSB;2| (|f| |m| $)
  (PROG (#1=#:G163 #2=#:G166 #3=#:G168 |j| #4=#:G167 |i|)
    (RETURN
     (SEQ
      (EXIT
       (SEQ
...
(DEFUN |ARR2CAT-;parts;SL;9| (|m| $)
  (PROG (|entryList| #1=#:G191 |j| #2=#:G190 |i|)
    (RETURN
...
(DEFUN |ARR2CAT-;=;2SB;18| (|m| |n| $)
  (PROG (#1=#:G247 #2=#:G251 #3=#:G253 |j| #4=#:G252 |i|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |ARR2CAT-;member?;RSB;19| (|r| |m| $)
  (PROG (#1=#:G255 #2=#:G258 #3=#:G260 |j| #4=#:G259 |i|)
    (RETURN
     (SEQ
      (EXIT
       (SEQ
...
(DEFUN |ARR2CAT-;coerce;SOf;23| (|m| $)
  (PROG (|l| #1=#:G284 |j| #2=#:G283 #3=#:G282 |i| #4=#:G281)
    (RETURN
     (SEQ
      (LETT |l|
            (PROGN
