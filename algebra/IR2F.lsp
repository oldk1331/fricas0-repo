...
(SDEFUN |IR2F;pairprod| ((|x| (F)) (|l| (|List| F)) (% (|List| F)))
        (SPROG ((#1=#:G35 NIL) (|y| NIL) (#2=#:G36 NIL))
               (SEQ
                (PROGN
                 (LETT #1# NIL)
                 (SEQ (LETT |y| NIL) (LETT #2# |l|) G190
                      ...
                      (SEQ
                       (EXIT
                        (LETT #1#
                              (CONS (SPADCALL |x| |y| (QREFELT % 11)) #1#))))
                      (LETT #2# (CDR #2#)) (GO G190) G191
                      (EXIT (NREVERSE #1#))))))) 

(SDEFUN |IR2F;evenRoots| ((|x| (F)) (% (|List| F)))
        (SPROG ((#1=#:G43 NIL) (|k| NIL) (#2=#:G44 NIL))
               (SEQ
                (PROGN
                 (LETT #1# NIL)
                 (SEQ (LETT |k| NIL) (LETT #2# (SPADCALL |x| (QREFELT % 22)))
                      G190
                      (COND
...
(SDEFUN |IR2F;split;2Ir;6|
        ...
        (SPROG ((#1=#:G53 NIL) (|l| NIL) (#2=#:G54 NIL))
               (SEQ
                (SPADCALL (SPADCALL |i| (QREFELT % 13))
                          (SPADCALL
                           (PROGN
                            (LETT #1# NIL)
                            (SEQ (LETT |l| NIL)
                                 (LETT #2# (SPADCALL |i| (QREFELT % 35))) G190
                                 (COND
                                  ((OR (ATOM #2#)
...
(SDEFUN |IR2F;complexExpand;IrF;7| ((|i| (|IntegrationResult| F)) (% (F)))
        (SPROG
         ((|j| (|IntegrationResult| F)) (|lg| NIL) (#1=#:G61 NIL)
          (#2=#:G58 (F)) (#3=#:G56 (F)) (#4=#:G57 NIL))
         (SEQ (LETT |j| (SPADCALL |i| (QREFELT % 34)))
              (EXIT
               (SPADCALL (|IR2F;IR2F| |j| %)
                         (PROGN
                          (LETT #4# NIL)
                          (SEQ (LETT |lg| NIL)
                               (LETT #1# (SPADCALL |j| (QREFELT % 35))) G190
                               (COND
                                ((OR (ATOM #1#)
                                     (PROGN (LETT |lg| (CAR #1#)) NIL))
                                 (GO G191)))
                               (SEQ
                                (EXIT
                                 (PROGN
                                  ...
                                  (COND
                                   (#4#
                                    (LETT #3#
                                          (SPADCALL #3# #2# (QREFELT % 41))))
                                   ('T
                                    (PROGN (LETT #3# #2#) (LETT #4# 'T)))))))
                               (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
                          (COND (#4# #3#) ('T (|spadConstant| % 42))))
                         (QREFELT % 41)))))) 
...
(SDEFUN |IR2F;quadratic|
        ((|p| (|SparseUnivariatePolynomial| F))
         ...
         (% (|List| F)))
        (SPROG
         ((|b| (F)) (|a| (F)) (|p0| (F)) (|delta| (F)) (|d| (F)) (|c| (F))
          (|q| (|Record| (|:| |ans1| F) (|:| |ans2| F))) (|e| (F)) (|f| (F))
          (|nrm| (F)) (|lgp| (F))
          (|sqr|
           (|Record| (|:| |sqrt| #1=(|Record| (|:| |ans1| F) (|:| |ans2| F)))
                     (|:| |sgn| (|Integer|))))
          (|s| #1#) (|sqrp| (F)) (|pp| (F)) (|sqrn| (F)) (|nn| (F)))
         (SEQ
          (COND
           ((SPADCALL
             (LETT |delta|
...
(SDEFUN |IR2F;tantrick| ((|a| (F)) (|b| (F)) (% (F)))
        (SPROG
         ((|f| (F)) (|sb| #1=(|Union| (|Integer|) "failed")) (|sa| #1#)
          (#2=#:G81 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |IR2F;var_kers|
        ((|p| (|SparseMultivariatePolynomial| R (|Kernel| F))) (|x| (|Symbol|))
         (% (|List| (|Kernel| F))))
        (SPROG ((#1=#:G85 NIL) (|k| NIL) (#2=#:G86 NIL))
               (SEQ
                (PROGN
                 (LETT #1# NIL)
                 (SEQ (LETT |k| NIL) (LETT #2# (SPADCALL |p| (QREFELT % 73)))
                      G190
                      (COND
                       ((OR (ATOM #2#) (PROGN (LETT |k| (CAR #2#)) NIL))
                        (GO G191)))
...
(SDEFUN |IR2F;ilog0|
        ...
        (SPROG
         ((|#G34| (|SparseUnivariatePolynomial| F)) (|#G35| #1#) (|#G36| (F))
          (|#G37| (F))
          (|r|
...
(SDEFUN |IR2F;root_pair|
        ((|lg| (|SparseUnivariatePolynomial| F)) (|a| (F)) (|b| (F))
         (|x| (|Symbol|)) (% (F)))
        (SPROG
         ((|lge| (|Record| (|:| |ans1| F) (|:| |ans2| F))) (|f| (F)) (|g| (F)))
         (SEQ
          (LETT |lge|
...
(SDEFUN |IR2F;do_rr|
        ((|rr|
         ...
         (% (|List| F)))
        (SPROG
         ((|rl| #1#) (|cl| #2#) (|r1| NIL) (#3=#:G118 NIL) (|cp1| NIL)
          (#4=#:G119 NIL) (|res| (F)))
         (SEQ (LETT |rl| (QCAR |rr|)) (LETT |cl| (QCDR |rr|))
              (LETT |res| (|spadConstant| % 42))
              (SEQ (LETT |r1| NIL) (LETT #3# |rl|) G190
                   (COND
              ...
              (SEQ (LETT |cp1| NIL) (LETT #4# |cl|) G190
                   (COND
                    ((OR (ATOM #4#) (PROGN (LETT |cp1| (CAR #4#)) NIL))
                     (GO G191)))
                   (SEQ
                    (EXIT
                     (LETT |res|
...
(SDEFUN |IR2F;lg2func|
        ((|lg|
         ...
         (|x| (|Symbol|)) (% (|List| F)))
        (SPROG
         ((|p| #1#) (|d| (|NonNegativeInteger|)) (|r| (|Union| F "failed"))
          (|sn| (|Union| (|Integer|) "failed")) (|alpha| (F)) (#2=#:G134 NIL)
          (#3=#:G142 NIL))
         (SEQ
          (COND
           ((ZEROP
...
(SDEFUN |IR2F;lg2cfunc2|
        ...
        (SPROG
         ((|alpha| NIL) (#1=#:G149 NIL) (#2=#:G147 (F)) (#3=#:G145 (F))
          (#4=#:G146 NIL))
         (SEQ
          (PROGN
           (LETT #4# NIL)
           (SEQ (LETT |alpha| NIL) (LETT #1# (SPADCALL |p| (QREFELT % 113)))
                G190
                (COND
                 ((OR (ATOM #1#) (PROGN (LETT |alpha| (CAR #1#)) NIL))
                  (GO G191)))
                (SEQ
                 (EXIT
                  (PROGN
                   (LETT #2# (|IR2F;cmplex| |alpha| |lg| %))
                   (COND (#4# (LETT #3# (SPADCALL #3# #2# (QREFELT % 41))))
        ...
        ((|l|
          (|List|
           (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                     ...
                     (|:| |logand| (|SparseUnivariatePolynomial| F)))))
         (|x| (|Symbol|)) (% (|List| F)))
        (SPROG ((|lg| NIL) (#1=#:G155 NIL) (|ans| (|List| F)))
               (SEQ (LETT |ans| NIL)
...
(SDEFUN |IR2F;quadeval|
        ...
        (SPROG
         ((|v| (|Vector| F)) (|i| NIL) (#1=#:G165 NIL) (|c| (F)) (|d| (F))
          (|temp| (F)) (|bi| (F)) (|ai| (F)))
         (SEQ
          (COND
...
(SDEFUN |IR2F;compatible?|
        ...
        (SPROG
         ((|x| NIL) (#1=#:G180 NIL) (|y| NIL) (#2=#:G181 NIL)
          (|s| (|Union| (|Integer|) "failed")) (#3=#:G179 NIL) (#4=#:G178 NIL))
         (SEQ
          (EXIT
           (COND ((NULL |ly|) 'T)
                 ('T
...
(SDEFUN |IR2F;pairsum| ((|lx| (|List| F)) (|ly| (|List| F)) (% (|List| F)))
        (SPROG
         ((|x| NIL) (#1=#:G191 NIL) (|ls| (|List| F)) (#2=#:G192 NIL) (|y| NIL)
          (#3=#:G193 NIL) (|ln| (|List| F)) (|l| (|List| F)))
         (SEQ
         ...
         (%
          (|List|
           (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                     (|:| |coeff| (|SparseUnivariatePolynomial| F))
                     (|:| |logand| (|SparseUnivariatePolynomial| F))))))
        (SPROG ((#1=#:G209 NIL) (|f| NIL) (#2=#:G210 NIL))
               (SEQ
                (PROGN
                 (LETT #1# NIL)
                 (SEQ (LETT |f| NIL)
