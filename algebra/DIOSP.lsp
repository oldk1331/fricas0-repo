...
(SDEFUN |DIOSP;initializeGraph|
        ((|mon| |List| (|Polynomial| (|Integer|))) (|c| |Integer|)
         ($ |Record|
          ...
          (|:| |dim| (|NonNegativeInteger|)) (|:| |zeroNode| (|Integer|))))
        (SPROG
         ((#1=#:G147 NIL) (|i| NIL) (#2=#:G148 NIL) (|n| (|Integer|))
          (|m| (|Integer|)) (|k| (|NonNegativeInteger|))
          (|coeffs| (|Vector| (|Integer|))) (#3=#:G146 NIL) (|x| NIL)
          (#4=#:G145 NIL))
         (SEQ
          (LETT |coeffs|
                (SPADCALL
...
(SDEFUN |DIOSP;findSolutions|
        ...
        (SPROG
         ((|sols| (|List| (|Vector| (|NonNegativeInteger|))))
          ...
          (|x| (|NonNegativeInteger|)) (#3=#:G169 NIL) (|i| NIL) (|k| #1#)
          (|v| #2#)
          (|node|
           (|Record| (|:| |vert| (|Vector| (|Integer|)))
                     (|:| |is_free| (|Boolean|)))))
...
(SDEFUN |DIOSP;verifyMinimality|
        ...
        (SPROG
         ((#1=#:G172 NIL) (|x| (|NonNegativeInteger|))
...
(SDEFUN |DIOSP;verifySolution|
        ((|sol| |Vector| (|NonNegativeInteger|)) (|ind| |Integer|)
         ...
         ($ |Boolean|))
        (SPROG
         ((#3=#:G183 NIL) (|flag| (|Boolean|)) (#4=#:G178 NIL)
          (|x| (|NonNegativeInteger|)) (#5=#:G188 NIL) (|i| NIL) (|k| #1#)
          (|v| #2#)
          (|node|
           (|Record| (|:| |vert| (|Vector| (|Integer|)))
                     (|:| |is_free| (|Boolean|)))))
