         ...
         ($
          (|Record| (|:| |logands| (|List| F))
                    (|:| |basis|
                         (|List| (|Vector| (|Fraction| (|Integer|))))))))
        (SPROG
         ((#1=#:G243 NIL) (|k1| NIL) (#2=#:G242 NIL) (|k| (|Kernel| F))
...
(SDEFUN |INTPAR2;extendedint;SLLL;9|
        ...
        (SPROG
         ((#1=#:G267 NIL) (|k1| NIL) (#2=#:G266 NIL) (|k| (|Kernel| F))
          (#3=#:G265 NIL) (|kv| NIL) (#4=#:G264 NIL)
          (|cb| (|List| (|Vector| F))))
         (SEQ
          (COND
           ((NULL |l|)
...
(SDEFUN |INTPAR2;gen_polylog|
        ...
        (SPROG
         ((|nn| (R)) (|s| (F)) (#1=#:G321 NIL) (|j| NIL) (|lv| (F))
          (|res| (F)))
         (SEQ
          (COND
           ((EQL |d| 1)
...
(SDEFUN |INTPAR2;polylog_int;FSKNniLFU;14|
        ...
        (SPROG
         ((|res2|
           (|Union| (|Record| (|:| |ratpart| F) (|:| |coeff| F) (|:| |prim| F))
                    #1#))
          (#2=#:G340 NIL) (|res| (F)) (|c0| (F)) (|v1| (F)) (|dv| (F))
          (|v| (F)) (|ans1| (F))
...
(SDEFUN |INTPAR2;wrapfn!0| ((|lrf| NIL) ($$ NIL))
        (PROG (|k| $ |fn|)
          ...
          (RETURN
           (PROGN
            (SPROG
             ((#1=#:G359 NIL) (|a| NIL) (#2=#:G360 NIL) (|be| NIL)
              (#3=#:G358 NIL) (|la| NIL) (#4=#:G357 NIL) (#5=#:G356 NIL)
              (|r1| NIL) (|lf| NIL) (#6=#:G355 NIL) (|rf| NIL) (#7=#:G354 NIL))
             (SEQ
              (LETT |lf|
                    (PROGN
                     (LETT #7# NIL)
...
(SDEFUN |INTPAR2;algextint|
        ((|x| (|Symbol|)) (|k| (|Kernel| F)) (|l| (|List| (|Kernel| F)))
         ...
         ($ (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#1=#:G517 NIL) (|be| NIL) (#2=#:G516 NIL)
          (|res1|
           (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (|lg1| (|List| F)) (#3=#:G515 NIL) (|g| NIL) (#4=#:G514 NIL)
          ...
          (#6=#:G512 NIL) (|a1| NIL) (#7=#:G513 NIL) (|bv| NIL) (#8=#:G511 NIL)
          (|cb| (|List| (|Vector| F))) (|ncb| (|List| (|Vector| F)))
          (#9=#:G510 NIL) (#10=#:G509 NIL) (|ca| (|List| F)) (|nca| (|List| F))
          (#11=#:G507 NIL) (#12=#:G508 NIL) (#13=#:G506 NIL) (|na1| (|List| F))
          (#14=#:G505 NIL) (#15=#:G504 NIL) (#16=#:G503 NIL) (#17=#:G502 NIL)
          (|oroot| (F)) (|nrr| #5#) (#18=#:G501 NIL) (#19=#:G500 NIL)
          (#20=#:G499 NIL) (#21=#:G497 NIL) (|i| NIL) (#22=#:G498 NIL)
          (#23=#:G496 NIL) (#24=#:G495 NIL) (#25=#:G494 NIL) (#26=#:G493 NIL)
          (|n| (|NonNegativeInteger|))
          (|al|
           (|List|
            (|Record| (|:| |funs| (|List| F)) (|:| |nroot| F)
                      (|:| |npow1| (|Integer|)) (|:| |npow2| (|Integer|)))))
          (#27=#:G492 NIL) (|k2| NIL) (#28=#:G491 NIL)
          (|rde2|
           (|Mapping|
            (|List|
             (|Record|
          ...
          (|d1| (|Mapping| F F)) (#29=#:G490 NIL) (#30=#:G489 NIL)
          (|k1| (|Kernel| F)))
...
(SDEFUN |INTPAR2;primextint|
        ((|x| (|Symbol|)) (|k| (|Kernel| F)) (|l| (|List| (|Kernel| F)))
         ...
         ($ (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#1=#:G539 NIL) (|si| NIL) (#2=#:G538 NIL)
          (|res1|
           (|List|
            (|Record|
             (|:| |ratpart| (|Fraction| (|SparseUnivariatePolynomial| F)))
             (|:| |coeffs| (|Vector| F)))))
          (#3=#:G537 NIL) (|u| NIL) (#4=#:G536 NIL)
          (|cs1| (|Mapping| (|List| (|Vector| F)) (|Matrix| F)))
          (|ext|
           (|Mapping|
            (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))
...
(SDEFUN |INTPAR2;expextint|
        ((|x| (|Symbol|)) (|k| (|Kernel| F)) (|l| (|List| (|Kernel| F)))
         ...
         ($ (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#1=#:G568 NIL) (|si| NIL) (#2=#:G567 NIL)
          (|res1|
           (|List|
            (|Record|
             (|:| |ratpart| (|Fraction| (|SparseUnivariatePolynomial| F)))
             (|:| |coeffs| (|Vector| F)))))
          (#3=#:G566 NIL) (|u| NIL) (#4=#:G565 NIL)
          (|cs1| (|Mapping| (|List| (|Vector| F)) (|Matrix| F)))
          (|rde|
           (|Mapping|
            (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))
...
(SDEFUN |INTPAR2;diffextint1|
        ((|lup| (|List| (|SparseUnivariatePolynomial| F))) (|x| (|Symbol|))
         ...
         ($ (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((#1=#:G649 NIL) (|ba| NIL) (#2=#:G650 NIL) (|bv| NIL) (#3=#:G648 NIL)
          (|nlca| (|List| F)) (#4=#:G646 NIL) (#5=#:G647 NIL) (|be| NIL)
          (#6=#:G645 NIL) (|ncb| (|List| (|Vector| F))) (#7=#:G644 NIL)
          (#8=#:G643 NIL) (#9=#:G642 NIL) (#10=#:G641 NIL)
          (|cb1| (|List| #11=(|Vector| F))) (#12=#:G640 NIL) (#13=#:G639 NIL)
          (|res2|
           #14=(|List|
                (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))))
          (|nlg| (|List| F)) (|ng| (F)) (#15=#:G617 NIL)
          (|nu| (|SparseUnivariatePolynomial| F))
          (|du| (|Fraction| (|SparseUnivariatePolynomial| F))) (#16=#:G636 NIL)
          (|ca| NIL) (#17=#:G637 NIL) (|g1| NIL) (#18=#:G638 NIL) (|g0| NIL)
          (|lca| (|List| F)) (|nlg0| (|List| F)) (#19=#:G635 NIL)
          (#20=#:G634 NIL) (|lg3| (|List| F)) (#21=#:G633 NIL) (#22=#:G632 NIL)
          (|v3| (|Vector| F)) (|v2| (|Vector| F)) (#23=#:G631 NIL)
          (#24=#:G630 NIL) (|cb| #25=(|List| (|Vector| F)))
          (|m2| #26=(|Matrix| F))
          (|#G130| (|Record| (|:| |transform| #26#) (|:| |basis| #25#)))
          (|d1| (|Mapping| F F)) (|cb0| (|List| #11#)) (#27=#:G629 NIL)
          (#28=#:G628 NIL) (|res1| #14#) (|lk1| (|List| (|Kernel| F)))
          (|lek| (|List| F)) (#29=#:G627 NIL) (|ki| NIL) (#30=#:G626 NIL)
          (|lg2| (|List| F)) (#31=#:G625 NIL) (|g| NIL) (#32=#:G624 NIL)
          (|dvf| (F)) (|dv| (|Symbol|)) (|k1| (F)) (|lg1| (|List| F))
          (#33=#:G623 NIL) (|up| NIL) (#34=#:G622 NIL) (|lg0| (|List| F))
          (#35=#:G621 NIL) (#36=#:G620 NIL) (#37=#:G619 NIL) (#38=#:G618 NIL)
...
(DEFUN |ParametricIntegration| (&REST #1=#:G676)
  (SPROG NIL
         (PROG (#2=#:G677)
           (RETURN
            (COND
