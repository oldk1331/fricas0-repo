...
(SDEFUN |REP;evalvect|
        ...
        (SPROG
         ((|v| (|Expression| (|Integer|))) (#1=#:G114 NIL) (|i| NIL)
...
(SDEFUN |REP;radicalEigenvector;EML;5|
        ...
        (SPROG
         ((#1=#:G132 NIL) (|v| NIL) (#2=#:G131 NIL) (#3=#:G130 NIL) (|j| NIL)
          (#4=#:G129 NIL) (|i| NIL) (B (|Matrix| (|Expression| (|Integer|))))
          (|n| (|NonNegativeInteger|)))
         ...
         ((|sln|
           (|List|
            (|Record| (|:| |radval| (|Expression| (|Integer|)))
                      ...
                      (|:| |radvect|
                           (|List| (|Matrix| (|Expression| (|Integer|))))))))
          (|nsl| #1#) (#2=#:G162 NIL) (|ep| NIL) (#3=#:G161 NIL)
          (#4=#:G160 NIL) (|alg| NIL)
          (|lval| (|List| (|Expression| (|Integer|)))) (|xx| (|Symbol|))
          (|sym| (|SuchThat| (|Symbol|) (|Polynomial| (|Integer|))))
          (#5=#:G138 NIL) (#6=#:G137 NIL)
          (|veclist| (|List| (|Matrix| (|Expression| (|Integer|)))))
          (#7=#:G159 NIL) (|i| NIL) (|m| (|Matrix| (|Expression| (|Integer|))))
          (#8=#:G158 NIL) (|ll| NIL) (#9=#:G157 NIL) (|eig| NIL)
          (|n| (|NonNegativeInteger|))
          (|leig|
           (|List|
            (|Record|
...
(SDEFUN |REP;gramschmidt;2L;7|
        ...
        (SPROG
         ((|orth| (|List| (|Matrix| (|Expression| (|Integer|)))))
          (|pol| (|Matrix| (|Expression| (|Integer|)))) (#1=#:G171 NIL)
          (#2=#:G170 (RMR)) (#3=#:G172 (RMR)) (#4=#:G178 NIL) (|w| NIL)
          (#5=#:G177 NIL)
          (RMR
           (|Join|
...
(SDEFUN |REP;eigenMatrix;MU;8|
        ...
        (SPROG
         ((|d| (|Matrix| (|Expression| (|Integer|)))) (#1=#:G195 NIL) (|v| NIL)
          (|n| (|NonNegativeInteger|))
          (|lef| #2=(|List| (|Matrix| (|Expression| (|Integer|)))))
          (#3=#:G184 NIL) (#4=#:G183 #2#) (#5=#:G185 #2#) (#6=#:G194 NIL)
          (|eiv| NIL))
         (SEQ
          (LETT |lef|
                (PROGN
