...
(SDEFUN |INTALG;algintexp|
        ...
        (SPROG
         ((|u|
          ...
          (#2=#:G219 NIL) (|i| NIL) (|vf| (|Vector| (|Fraction| UP)))
...
(SDEFUN |INTALG;find_multiples|
        ...
        (SPROG
         ((|res|
          ...
          (|cp| (F)) (|p| (UP)) (#2=#:G259 NIL) (|f| NIL)
          (|n| #3=(|NonNegativeInteger|)) (|rp1| (UP)) (#4=#:G258 NIL)
               ...
               (EXIT
                (SEQ G190
                     ...
                     (SEQ (LETT |cp1| (SPADCALL |rp1| (QREFELT $ 79)))
                          ...
                          (COND
                           ((ODDP (- |k| |l|))
                            (PROGN (LETT #4# |$NoValue|) (GO #5=#:G238))))
...
(SDEFUN |INTALG;handle_multiples1|
        ...
        (SPROG
         ((|llg|
          ...
          (|nfac| #1#) (#4=#:G275 NIL) (|peq| NIL) (|alpha| (F)) (|p| (UP))
          (|pc1|
           (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                     (|:| |coeff| (|Fraction| (|Integer|))))))
          ...
          (|fu|
           (|Union|
            (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                      (|:| |coeff| (|Fraction| (|Integer|))))
            "failed"))
          (|nfac| #2#) (#4=#:G298 NIL) (|peq| NIL) (|lp1| (|List| #1#))
          (#5=#:G297 NIL) (#6=#:G296 NIL)
          (|llg|
           (|List|
            (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                      (|:| |coeff| (|SparseUnivariatePolynomial| R))
          ...
          (|nfl1|
           (|List|
            (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                      (|:| |coeff| (|Fraction| (|Integer|))) (|:| |scalar| F)
                      (|:| |divisor| (|FiniteDivisor| F UP UPUP R)))))
          (#5=#:G451 NIL) (|nfl| NIL) (#6=#:G450 NIL) (#7=#:G449 NIL)
          (#8=#:G448 NIL)
          (|nlins2|
           (|List|
            (|List|
           ...
           (|Union|
            (|List|
             (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                       ...
                       (|:| |logand| (|SparseUnivariatePolynomial| R))))
            "failed"))
          (#9=#:G447 NIL) (|nlins1| (|List| #4#)) (#10=#:G446 NIL)
          (#11=#:G445 NIL) (|nfacs2| (|List| #2#)) (|nfacs1| (|List| #4#))
          (|ppr|
           (|Record|
            (|:| |result1|
                 (|List|
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |c| |derivation|)
                             ...
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G470)))
                              (GO #5=#:G468))))))
...
(SDEFUN |INTALG;trace1|
        ...
        (SPROG
         ((|rc|
          ...
          (|v0| #1=(|FiniteDivisor| F UP UPUP R)) (#2=#:G514 NIL)
          (#3=#:G513 #1#) (#4=#:G515 #1#) (#5=#:G525 NIL) (|a| NIL)
          (#6=#:G526 NIL) (|dv| NIL)
          (|cd|
           (|Record| (|:| |num| (|List| (|Integer|))) (|:| |den| (|Integer|))))
          (#7=#:G524 NIL) (#8=#:G523 NIL))
         (SEQ
          (LETT |cd|
                (SPADCALL
                 (PROGN
...
(DEFUN |AlgebraicIntegrate| (&REST #1=#:G640)
  (SPROG NIL
         (PROG (#2=#:G641)
           (RETURN
            (COND
