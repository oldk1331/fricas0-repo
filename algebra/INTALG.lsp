...
(SDEFUN |INTALG;algintexp|
        ...
        (SPROG
         ((|u|
          ...
          (#1=#:G182 NIL) (|i| NIL) (|vf| (|Vector| (|Fraction| UP)))
...
(SDEFUN |INTALG;handle_multiples1|
        ...
        (SPROG
         ((|llg|
          ...
          (|nfac| #1#) (#4=#:G235 NIL) (|peq| NIL) (|alpha| (F)) (|p| (UP))
          (|pc1|
           (|Record| (|:| |factor| UP) (|:| |exponent| (|Integer|))
                     (|:| |coeff| (|Fraction| (|Integer|))))))
          ...
          (|fu|
           (|Union|
            (|Record| (|:| |factor| UP) (|:| |exponent| (|Integer|))
                      (|:| |coeff| (|Fraction| (|Integer|))))
            "failed"))
          (|nfac| #2#) (#4=#:G258 NIL) (|peq| NIL) (|lp1| (|List| #1#))
          (#5=#:G257 NIL) (#6=#:G256 NIL)
          (|llg|
           (|List|
            (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                      (|:| |coeff| (|SparseUnivariatePolynomial| R))
...
(SDEFUN |INTALG;get_coeffs0| ((|lp| |List| UP) ($ |List| F))
        (SPROG ((|res| (|List| F)) (#1=#:G262 NIL) (|p| NIL))
...
(SDEFUN |INTALG;classify_divisors|
        ...
        (SPROG
         ((|nlm2|
          ...
          (|lf2|
           (|List| (|Record| (|:| |factor| UP) (|:| |exponent| (|Integer|)))))
          (|u| (|Factored| UP)) (|cl| (|List| F)))
         (SEQ
          (LETT |cl| (|INTALG;get_coeffs| |rec| $)
                . #2=(|INTALG;classify_divisors|))
          (LETT |u|
                (SPADCALL (SPADCALL |r| (QREFELT $ 132)) |cl| (QREFELT $ 135))
                . #2#)
          (LETT |lf| (SPADCALL |u| (QREFELT $ 138)) . #2#)
...
(SDEFUN |INTALG;get_lf|
        ((|ll1| |List|
         ...
         ($ |List| UP))
        (SPROG
         ((#1=#:G299 NIL) (|peq| NIL) (#2=#:G298 NIL) (#3=#:G297 NIL)
          (#4=#:G296 NIL))
         (SEQ (COND ((NULL |ll1|) (COND ((NULL |ll2|) (EXIT NIL)))))
              (EXIT
               (COND
                ((SPADCALL (+ (LENGTH |ll1|) (LENGTH |ll2|)) 1 (QREFELT $ 139))
                 (|error|
         ...
         (|ll2| |List|
          (|List|
           (|Record| (|:| |factor| UP) (|:| |exponent| (|Integer|))
                     (|:| |coeff| (|Fraction| (|Integer|))))))
         ($ |List| F))
        (SPROG ((#1=#:G305 NIL) (|lfac| NIL) (#2=#:G304 NIL))
               (SEQ
                (PROGN
...
(SDEFUN |INTALG;get_ld|
        ...
        (SPROG
         ((#1=#:G321 NIL) (|peq| NIL) (#2=#:G320 NIL) (#3=#:G319 NIL) (|a| NIL)
          (#4=#:G318 NIL))
         (SEQ (COND ((NULL |ll1|) (COND ((NULL |ll2|) (EXIT NIL)))))
              (EXIT
               (COND
         ...
         ((|tr1u|
          ...
          (|nfl1|
           (|List|
            (|Record| (|:| |factor| UP) (|:| |exponent| (|Integer|))
                      (|:| |coeff| (|Fraction| (|Integer|))) (|:| |scalar| F)
                      (|:| |divisor| (|FiniteDivisor| F UP UPUP R)))))
          (#5=#:G394 NIL) (|nfl| NIL) (#6=#:G393 NIL) (#7=#:G392 NIL)
          (#8=#:G391 NIL) (|nlins2| (|List| #2#)) (#9=#:G390 NIL)
          (#10=#:G389 NIL) (|nlins1| (|List| #4#)) (#11=#:G388 NIL)
          (#12=#:G387 NIL) (|nfacs2| (|List| #2#)) (|nfacs1| (|List| #4#))
          (|ppr|
           (|Record|
            (|:| |result1|
                 (|List|
          ...
          (|rec|
           (|Record| (|:| |num| R) (|:| |den| UP) (|:| |derivden| UP)
                     (|:| |gd| UP))))
         (SEQ
          (LETT |rec| (SPADCALL |f| |derivation| (QREFELT $ 141))
                . #13=(|INTALG;palglogint|))
          (EXIT
           (COND
            ((SPADCALL
              (LETT |r| (SPADCALL |f| |derivation| (QREFELT $ 143)) . #13#)
              (QREFELT $ 144))
             (CONS 1 "failed"))
            (#14='T
                         ...
                         ((NULL |nlins1|)
                          (COND
                           ((EQL (LENGTH |lins1|) 1)
                            (EXIT (CONS 1 "failed"))))))))
                      (COND
                       ((SPADCALL (LENGTH |nfacs1|) 0 (QREFELT $ 139))
                        (COND
                         ((EQL (LENGTH |nlins2|) 0)
                          (EXIT
                           (SEQ
                            (COND
                             ...
                             ((SPADCALL (LENGTH |lins1|) 1 (QREFELT $ 139))
                              (|error|
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |c| |derivation|)
                                       (|spadConstant| $ 30) (QREFELT $ 156))
                             (PROGN
                              (LETT #1#
                                    (PROGN (LETT #2# 'T . #4#) (GO #5=#:G403))
                                    . #4#)
                              (GO #6=#:G401))))))
...
(SDEFUN |INTALG;pLogDeriv|
        ...
        (SPROG
         ...
         (SEQ
          (COND
           ((SPADCALL (SPADCALL |derivation| (QVELT |log| 1) (QREFELT $ 158))
                      (|spadConstant| $ 159) (QREFELT $ 160))
            (|error| "can only handle logs with constant coefficients"))
           (#3='T
            (SEQ
             (LETT |n| (SPADCALL (QVELT |log| 1) (QREFELT $ 161))
                   . #4=(|INTALG;pLogDeriv|))
             (EXIT
              (COND
               ((EQL |n| 1)
                (SEQ
                 (LETT |c|
                       (SPADCALL
                        (SPADCALL
                         (SPADCALL (SPADCALL (QVELT |log| 1) (QREFELT $ 162))
                                   (QREFELT $ 163))
                         (SPADCALL (QVELT |log| 1) (QREFELT $ 163))
                         (QREFELT $ 164))
                        (QREFELT $ 165))
                       . #4#)
                 (LETT |ans| (SPADCALL (QVELT |log| 2) |c| (QREFELT $ 166))
                       . #4#)
                 (EXIT
                  (SPADCALL
                   (SPADCALL
                    (SPADCALL (SPADCALL (QVELT |log| 0) (QREFELT $ 167)) |c|
                              (QREFELT $ 168))
                    (SPADCALL |ans| |derivation|) (QREFELT $ 168))
                   |ans| (QREFELT $ 164)))))
               (#3#
                (SEQ
                 (LETT |numlog|
                       (SPADCALL |derivation| (QVELT |log| 2) (QREFELT $ 158))
                       . #4#)
                 (LETT |diflog|
                  ...
                  (COND ((QEQCAR |diflog| 1) (|error| "this shouldn't happen"))
                        (#3#
                         (SEQ (LETT |algans| (QCAR (QCDR |diflog|)) . #4#)
                              ...
                              (EXIT
                               (SPADCALL
                                (SPADCALL (QVELT |log| 0) (QREFELT $ 167))
                                |ans| (QREFELT $ 168))))))))))))))))) 
...
(SDEFUN |INTALG;R2UP|
        ...
        (SPROG ((|g| (F)) (|y| (F)) (|x| (F)))
               (SEQ
                (LETT |x| (SPADCALL (QREFELT $ 17) (QREFELT $ 178))
                      . #1=(|INTALG;R2UP|))
                (LETT |g|
                      (SPADCALL
                       (SPADCALL (CONS #'|INTALG;R2UP!0| (VECTOR $ |x|))
                                 ...
                                 (QREFELT $ 183))
                       (LETT |y| (SPADCALL (QREFELT $ 18) (QREFELT $ 178))
                             . #1#)
                       (QREFELT $ 184))
                      . #1#)
                (EXIT
                 (SPADCALL
                  ...
                  (SPADCALL |g| |k| (SPADCALL |k| (QREFELT $ 185))
                            (QREFELT $ 187))
                  (QREFELT $ 190)))))) 
...
(SDEFUN |INTALG;R2UP!0| ((|f1| NIL) ($$ NIL))
        (PROG (|x| $)
          ...
          (LETT $ (QREFELT $$ 0) . #1#)
          (RETURN (PROGN (SPADCALL |f1| |x| (QREFELT $ 180)))))) 

(SDEFUN |INTALG;univ| ((|f| F) (|k| |Kernel| F) ($ |Fraction| UP))
        (SPROG ((|g| (|Fraction| (|SparseUnivariatePolynomial| F))))
               (SEQ (LETT |g| (SPADCALL |f| |k| (QREFELT $ 192)) |INTALG;univ|)
                    (EXIT
                     (SPADCALL
                      (|INTALG;SUP2UP| (SPADCALL |g| (QREFELT $ 194)) $)
...
(SDEFUN |INTALG;rlift| ((|f| F) (|kx| |Kernel| F) (|ky| |Kernel| F) ($ R))
        (SPROG ((|uf| (|Fraction| (|SparseUnivariatePolynomial| F))))
               (SEQ
                (LETT |uf| (SPADCALL |f| |ky| (QREFELT $ 192)) |INTALG;rlift|)
                (EXIT
                 (SPADCALL
                  (SPADCALL (CONS #'|INTALG;rlift!0| (VECTOR $ |kx|))
                            (SPADCALL |uf| (QREFELT $ 196)) (QREFELT $ 199))
                  (QREFELT $ 200)))))) 
...
(SDEFUN |INTALG;trace1|
        ...
        (SPROG
         ((|rc|
          ...
          (|v0| #1=(|FiniteDivisor| F UP UPUP R)) (#2=#:G449 NIL)
          (#3=#:G448 #1#) (#4=#:G450 #1#) (#5=#:G460 NIL) (|a| NIL)
          (#6=#:G461 NIL) (|dv| NIL)
          (|cd|
           (|Record| (|:| |num| (|List| (|Integer|))) (|:| |den| (|Integer|))))
          (#7=#:G459 NIL) (#8=#:G458 NIL))
         (SEQ
          (LETT |cd|
                (SPADCALL
                 (PROGN
                ...
                (PROGN
                 ...
                 (SEQ (LETT |dv| NIL . #9#) (LETT #6# |ld| . #9#)
                      ...
                      (SEQ
                       (EXIT
                        (PROGN
                         (LETT #4# (SPADCALL |a| |dv| (QREFELT $ 206)) . #9#)
                         (COND
                          (#2#
                           (LETT #3# (SPADCALL #3# #4# (QREFELT $ 207)) . #9#))
                          ('T
                           (PROGN
                            (LETT #3# #4# . #9#)
                            (LETT #2# 'T . #9#)))))))
                 ...
                 (COND (#2# #3#) (#10='T (|spadConstant| $ 208))))
                . #9#)
          (LETT |v2|
                (SPADCALL |v0| (SPADCALL (QCDR |cd|) |v1| (QREFELT $ 206))
                          (QREFELT $ 95))
                . #9#)
          ...
          (EXIT
           (COND
            ((QEQCAR |rc| 1)
             (COND
              ((SPADCALL (SPADCALL |q| (QREFELT $ 64)) 2 (QREFELT $ 209))
               (CONS 1 "failed"))
              (#10#
               (|error|
        ...
        ((|q| UP) (|scalr| |Fraction| (|Integer|)) (|lgd| R) (|alpha| F)
         ($ |List|
          (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                    ...
                    (|:| |logand| (|SparseUnivariatePolynomial| R)))))
        (COND
         ((SPADCALL (SPADCALL |q| (QREFELT $ 64)) 1 (QREFELT $ 209))
          (LIST
           (VECTOR |scalr|
                   (SPADCALL
                    (SPADCALL (|spadConstant| $ 172) 1 (QREFELT $ 173))
                    (|INTALG;F2UPR| |alpha| $) (QREFELT $ 210))
          ...
          (LIST
           (VECTOR |scalr|
                   (SPADCALL (CONS (|function| |INTALG;F2R|) $) |q|
                             (QREFELT $ 212))
                   (|INTALG;R2UP| |lgd| (SPADCALL |alpha| (QREFELT $ 213))
                    $)))))) 
         ...
         ((|ans|
           (|Record|
            (|:| |factor|
                 (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
            (|:| |exponent| (|Integer|))))
          (|found| (|Boolean|)) (#1=#:G475 NIL) (#2=#:G476 NIL) (|q| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |found| 'NIL . #3=(|INTALG;nonLinear|))
                ...
                (SEQ (LETT |q| NIL . #3#) (LETT #2# |l| . #3#) G190
                     ...
                     (SEQ
                      (EXIT
                       (COND
                        ((SPADCALL (SPADCALL (QCAR |q|) (QREFELT $ 214)) 1
                                   (QREFELT $ 139))
                         (COND
                          (|found|
                           (PROGN
...
(SDEFUN |INTALG;palgextintegrate;RMUPUP2FU;28|
        ...
        (SPROG
         ...
         (SEQ
          (LETT |h| (SPADCALL |f| |derivation| (QREFELT $ 45))
                . #1=(|INTALG;palgextintegrate;RMUPUP2FU;28|))
          (EXIT
           (COND
            ((SPADCALL (QCDR |h|) (QREFELT $ 52))
             (CONS 0 (CONS (QCAR |h|) (|spadConstant| $ 30))))
            (#2='T
             (SEQ (LETT |numc| (SPADCALL |c1| (QREFELT $ 123)) . #1#)
                  (LETT |nder| (SPADCALL |numc| |derivation|) . #1#)
                  (LETT |denc| (SPADCALL |c1| (QREFELT $ 128)) . #1#)
                  (LETT |dder| (SPADCALL |denc| |derivation|) . #1#)
                  (LETT |dcdx|
                        (SPADCALL
                         (SPADCALL (SPADCALL |nder| |denc| (QREFELT $ 217))
                                   (SPADCALL |numc| |dder| (QREFELT $ 217))
                                   (QREFELT $ 218))
                         (SPADCALL
                         ...
                         (QREFELT $ 221))
                        . #1#)
                  (LETT |lp| (SPADCALL (QCDR |h|) (QREFELT $ 130)) . #1#)
                  (LETT |lp1|
                        (SPADCALL |dcdx|
                                  (SPADCALL |lp| |c1| |c2| (QREFELT $ 223))
                                  (QREFELT $ 224))
                        . #1#)
                  (LETT |cu0| (SPADCALL |lp1| |g| (QREFELT $ 226)) . #1#)
                  (EXIT
                   (COND ((QEQCAR |cu0| 1) (CONS 1 "failed"))
                         (#2#
                          (SEQ (LETT |c| (QCDR |cu0|) . #1#)
                               (EXIT
                                (COND
                                 ((SPADCALL (SPADCALL |c| (QREFELT $ 227)) 0
                                            (QREFELT $ 77))
                                  (CONS 1 "failed"))
                                 (#2#
                                  (SEQ
                                   (LETT |cr| (SPADCALL |c| (QREFELT $ 228))
                                         . #1#)
                                   (LETT |cu2| (SPADCALL |cr| (QREFELT $ 230))
                                         . #1#)
                                   (EXIT
...
(SDEFUN |INTALG;palgintegrate;RMIr;29|
        ((|f| R) (|derivation| |Mapping| UP UP) ($ |IntegrationResult| R))
        (SPROG
         ((|difFirstKind| (R)) (#1=#:G573 NIL) (#2=#:G572 (R)) (#3=#:G574 (R))
          (#4=#:G581 NIL) (|lg| NIL) (#5=#:G580 NIL)
          (|u|
           (|Union|
            (|List|
             (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
         ...
         (SEQ
          (LETT |h| (SPADCALL |f| |derivation| (QREFELT $ 45))
                . #6=(|INTALG;palgintegrate;RMIr;29|))
          (EXIT
           (COND
            ((SPADCALL (QCDR |h|) (QREFELT $ 52))
             (SPADCALL (QCAR |h|) (QREFELT $ 54)))
                                           ...
                                           (EXIT
                                            (PROGN
                                             (LETT #3#
                                                   (|INTALG;pLogDeriv| |lg|
                                                    (CONS
                                                     #'|INTALG;palgintegrate;RMIr;29!0|
                                                     (VECTOR $ |derivation|))
                                                    $)
                                                   . #6#)
                                             (COND
...
(SDEFUN |INTALG;palgintegrate;RMIr;29!0| ((|x1| NIL) ($$ NIL))
        (PROG (|derivation| $)
          (LETT |derivation| (QREFELT $$ 1)
                . #1=(|INTALG;palgintegrate;RMIr;29|))
          (LETT $ (QREFELT $$ 0) . #1#)
          (RETURN (PROGN (SPADCALL |x1| |derivation| (QREFELT $ 237)))))) 

(SDEFUN |INTALG;algintegrate;RMIr;30|
        ((|f| R) (|derivation| |Mapping| UP UP) ($ |IntegrationResult| R))
        (SPROG
         ((#1=#:G595 NIL) (|xx| (|Union| UP "failed")) (|x'| (UP)) (|x| (UP)))
         (SEQ
          (LETT |x'|
                (SPADCALL
                 (LETT |x| (SPADCALL (|spadConstant| $ 76) 1 (QREFELT $ 86))
                       . #2=(|INTALG;algintegrate;RMIr;30|))
                 |derivation|)
                . #2#)
          (EXIT
           (COND
            ...
            ('T
             (SEQ
              (EXIT
               (SEQ
                (SEQ (LETT |xx| (SPADCALL |x'| |x| (QREFELT $ 240)) . #2#)
                     (EXIT
                      (COND
                       ((QEQCAR |xx| 0)
                        (COND
                         ((QEQCAR (SPADCALL (QCDR |xx|) (QREFELT $ 232)) 0)
                          (PROGN
...
(SDEFUN |INTALG;alglogint|
        ...
        (SPROG NIL
               (COND
                ((|INTALG;varRoot?| (SPADCALL |f| |derivation| (QREFELT $ 143))
...
(DEFUN |AlgebraicIntegrate| (&REST #1=#:G604)
  (SPROG NIL
         (PROG (#2=#:G605)
           (RETURN
            (COND
...
(MAKEPROP '|AlgebraicIntegrate| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (398 . |primitivePart|) (|Factored| 8)
              (|FunctionSpaceUnivariatePolynomialFactor| 6 7 8)
              (403 . |ffactor|) (|Record| (|:| |factor| 8) (|:| |exponent| 32))
              (|List| 136) (409 . |factors|) (414 . >)
              (|Record| (|:| |num| $) (|:| |den| 8) (|:| |derivden| 8)
                        (|:| |gd| 8))
              (420 . |algSplitSimple|) (|DoubleResultantPackage| 7 8 9 10)
              (426 . |doubleResultant|) (432 . |ground?|) (437 . |zero?|)
              (|Mapping| 7 61) (|SparseUnivariatePolynomial| 61)
              (|UnivariatePolynomialCategoryFunctions2| 61 147 7 8)
              (442 . |map|) (|SparseUnivariatePolynomial| 7) (|Mapping| 7 7)
              (|UnivariatePolynomialCategoryFunctions2| 7 8 7 150)
              (448 . |map|)
              (|UnivariatePolynomialCategoryFunctions2| 7 150 7 8)
              (454 . |map|) (460 . ~=) (|Mapping| 10 10) (466 . |map|)
              (472 . |Zero|) (476 . ~=) (482 . |degree|) (487 . |reductum|)
              (492 . |leadingCoefficient|) (497 . /) (503 . -) (508 . |elt|)
              (514 . |coerce|) (519 . *)
              (|Record| (|:| |coef1| $) (|:| |coef2| $))
              (|Union| 169 '"failed") (525 . |extendedEuclidean|) (532 . |One|)
              (536 . |monomial|) (542 . *) (548 . |rem|) (554 . |coefficient|)
              (|Kernel| $) (560 . |coerce|) (|Fraction| $) (565 . |elt|)
              (|Mapping| 7 22)
              (|UnivariatePolynomialCategoryFunctions2| 22 9 7 8) (571 . |map|)
              (577 . |elt|) (583 . |minPoly|)
              (|PolynomialCategoryQuotientFunctions| (|IndexedExponents| 15) 15
                                                     ...
                                                     (|SparseMultivariatePolynomial|
                                                      6 15)
                                                     7)
              (588 . |univariate|) (|Mapping| 10 7)
              (|UnivariatePolynomialCategoryFunctions2| 7 150 10 19)
              (595 . |map|) (|Fraction| 89) (601 . |univariate|)
              (|Fraction| 150) (607 . |numer|) (612 . |denom|)
              (617 . |retract|) (|Mapping| 22 7)
              (|UnivariatePolynomialCategoryFunctions2| 7 150 22 9)
              (622 . |map|) (628 . |reduce|) (633 . |retract|)
              (|Record| (|:| |num| (|List| 32)) (|:| |den| 32)) (|List| 61)
              (|InnerCommonDenominator| 32 61 (|List| 32) 203)
              (638 . |splitDenominator|) (643 . *) (649 . +) (655 . |Zero|)
              (659 . <=) (665 . -)
              (|UnivariatePolynomialCategoryFunctions2| 7 8 10 19)
              (671 . |map|) (677 . |retract|) (682 . |degree|)
              (|Union| 10 '"failed") |INTALG;palginfieldint;RMU;27| (687 . *)
              (693 . -) (699 . |inv|) (704 . ^) (710 . *)
              (|ChangeOfVariable| 7 8 9) (716 . |eval|) (723 . *)
              (|Union| $ '"failed") (729 . |exquo|) (735 . |degree|)
              (740 . |leadingCoefficient|) (|Union| 8 '"failed")
              (745 . |retractIfCan|) (|Union| 7 '#1#) (750 . |retractIfCan|)
              (|Record| (|:| |ratpart| 10) (|:| |coeff| 7))
              (|Union| 233 '"failed") |INTALG;palgextintegrate;RMUPUP2FU;28|
              (755 . |integralAtInfinity?|) (760 . |differentiate|) (766 . -)
              |INTALG;palgintegrate;RMIr;29| (772 . |exquo|)
              |INTALG;algintegrate;RMIr;30| (778 . |retract|))
           '#(|palgintegrate| 783 |palginfieldint| 789 |palgextintegrate| 795
              |algintegrate| 804)
           'NIL
           (CONS (|makeByteWordVec2| 1 'NIL)
                 (CONS '#()
                       (CONS '#()
                             (|makeByteWordVec2| 242
                                                 '(0 10 0 11 0 13 0 14 1 15 0
                                                   ...
                                                   131 1 8 0 0 132 2 134 133 8
                                                   118 135 1 133 137 0 138 2 32
                                                   51 0 0 139 2 10 140 0 43 141
                                                   2 142 8 10 43 143 1 8 51 0
                                                   144 1 7 51 0 145 2 148 8 146
                                                   147 149 2 152 150 151 8 153
                                                   2 154 8 151 150 155 2 7 51 0
                                                   0 156 2 19 0 157 0 158 0 19
                                                   0 159 2 19 51 0 0 160 1 19
                                                   63 0 161 1 19 0 0 162 1 19
                                                   10 0 163 2 10 0 0 0 164 1 10
                                                   0 0 165 2 19 10 0 10 166 1
                                                   10 0 61 167 2 10 0 0 0 168 3
                                                   19 170 0 0 0 171 0 10 0 172
                                                   2 19 0 10 63 173 2 19 0 0 0
                                                   174 2 19 0 0 0 175 2 19 10 0
                                                   63 176 1 7 0 177 178 2 8 7
                                                   179 7 180 2 182 8 181 9 183
                                                   2 8 7 0 7 184 1 7 89 177 185
                                                   3 186 150 7 15 150 187 2 189
                                                   19 188 150 190 2 7 191 0 177
                                                   192 1 193 150 0 194 1 193
                                                   150 0 195 1 193 150 0 196 2
                                                   198 9 197 150 199 1 10 0 9
                                                   200 1 7 61 0 201 1 204 202
                                                   203 205 2 92 0 32 0 206 2 92
                                                   0 0 0 207 0 92 0 208 2 32 51
                                                   0 0 209 2 19 0 0 0 210 2 211
                                                   19 188 8 212 1 7 177 0 213 1
                                                   147 63 0 214 2 8 0 0 0 217 2
                                                   8 0 0 0 218 1 22 0 0 219 2
                                                   22 0 0 32 220 2 22 0 8 0 221
                                                   3 222 9 9 22 22 223 2 9 0 22
                                                   0 224 2 9 225 0 0 226 1 9 63
                                                   0 227 1 9 22 0 228 1 22 229
                                                   0 230 1 8 231 0 232 1 10 51
                                                   0 236 2 10 0 0 43 237 2 10 0
                                                   0 0 238 2 8 225 0 0 240 1 8
                                                   7 0 242 2 0 53 10 43 239 2 0
                                                   215 10 43 216 5 0 234 10 43
                                                   9 22 22 235 2 0 53 10 43
                                                   241)))))
           '|lookupComplete|)) 
