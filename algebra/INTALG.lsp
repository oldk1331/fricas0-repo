...
(SDEFUN |INTALG;algintexp|
        ...
        (SPROG
         ((|u|
          ...
          (#2=#:G220 NIL) (|i| NIL) (|vf| (|Vector| (|Fraction| UP)))
...
(SDEFUN |INTALG;find_multiples|
        ...
        (SPROG
         ((|res|
          ...
          (|cp| (F)) (|p| (UP)) (#2=#:G262 NIL) (|f| NIL)
          (|n| #3=(|NonNegativeInteger|)) (|rp1| (UP)) (#4=#:G261 NIL)
...
(SDEFUN |INTALG;handle_multiples1|
        ...
        (SPROG
         ((|llg|
          ...
          (|nfac| #1#) (#4=#:G279 NIL) (|peq| NIL) (|alpha| (F)) (|p| (UP))
          (|pc1|
           (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                     (|:| |coeff| (|Fraction| (|Integer|))))))
          ...
          (|fu|
           (|Union|
            (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                      (|:| |coeff| (|Fraction| (|Integer|))))
            "failed"))
          (|nfac| #2#) (#4=#:G304 NIL) (|peq| NIL) (|lp1| (|List| #1#))
          (#5=#:G303 NIL) (#6=#:G302 NIL) (|p| (UP))
          (|pc1|
           (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                     (|:| |coeff| (|Fraction| (|Integer|))))))
         (SEQ
...
(SDEFUN |INTALG;get_coeffs0| ((|lp| (|List| UP)) ($ (|List| F)))
        (SPROG ((|res| (|List| F)) (#1=#:G309 NIL) (|p| NIL))
               (SEQ (LETT |res| NIL)
...
(SDEFUN |INTALG;get_lf|
        ((|ll1|
         ...
         ($ (|List| UP)))
        (SPROG
         ((#1=#:G351 NIL) (|peq| NIL) (#2=#:G350 NIL) (#3=#:G349 NIL)
          (#4=#:G348 NIL))
          ...
          (|List|
           (|List|
            (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                      (|:| |coeff| (|Fraction| (|Integer|)))))))
         ($ (|List| F)))
        (SPROG ((#1=#:G358 NIL) (|lfac| NIL) (#2=#:G357 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |lfac| NIL)
...
(SDEFUN |INTALG;get_ld|
        ...
        (SPROG
         ((#1=#:G376 NIL) (|peq| NIL) (#2=#:G375 NIL) (#3=#:G374 NIL) (|a| NIL)
          (#4=#:G373 NIL))
         (SEQ (COND ((NULL |ll1|) (COND ((NULL |ll2|) (EXIT NIL)))))
              (EXIT
               (COND
          ...
          (|nfl1|
           (|List|
            (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                      (|:| |coeff| (|Fraction| (|Integer|))) (|:| |scalar| F)
                      (|:| |divisor| (|FiniteDivisor| F UP UPUP R)))))
          (#5=#:G469 NIL) (|nfl| NIL) (#6=#:G468 NIL) (#7=#:G467 NIL)
          (#8=#:G466 NIL)
          (|nlins2|
           (|List|
            (|List|
           ...
           (|Union|
            (|List|
             (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                       ...
                       (|:| |logand| (|SparseUnivariatePolynomial| R))))
            "failed"))
          (#9=#:G465 NIL) (|nlins1| (|List| #4#)) (#10=#:G464 NIL)
          (#11=#:G463 NIL) (|nfacs2| (|List| #2#)) (|nfacs1| (|List| #4#))
          (|ppr|
           (|Record|
            (|:| |result1|
                 (|List|
...
(SDEFUN |INTALG;varRoot?|
        ...
        (SPROG ((#1=#:G490 NIL) (#2=#:G491 NIL) (#3=#:G492 NIL) (|c| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |c| |derivation|)
                             ...
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G489)))
                              (GO #5=#:G487))))))
...
(SDEFUN |INTALG;trace1|
        ...
        (SPROG
         ((|rc|
          ...
          (|v0| #1=(|FiniteDivisor| F UP UPUP R)) (#2=#:G535 NIL)
          (#3=#:G534 #1#) (#4=#:G536 #1#) (#5=#:G546 NIL) (|a| NIL)
          (#6=#:G547 NIL) (|dv| NIL)
          (|cd|
           (|Record| (|:| |num| (|List| (|Integer|))) (|:| |den| (|Integer|))))
          (#7=#:G545 NIL) (#8=#:G544 NIL))
         (SEQ
          (LETT |cd|
                (SPADCALL
                 (PROGN
...
(SDEFUN |INTALG;palgintegrate;RMIr;28|
        ((|f| (R)) (|derivation| (|Mapping| UP UP))
         ($ (|IntegrationResult| R)))
        (SPROG
         ((|difFirstKind| (R)) (#1=#:G608 NIL) (#2=#:G607 (R)) (#3=#:G609 (R))
          (#4=#:G616 NIL) (|lg| NIL) (#5=#:G615 NIL)
          (|u|
           (|Union|
            (|List|
             (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
...
(SDEFUN |INTALG;algintegrate;RMMIr;29|
        ((|f| (R)) (|derivation| (|Mapping| UP UP))
         ...
         ($ (|IntegrationResult| R)))
        (SPROG
         ((#1=#:G630 NIL) (|xx| (|Union| UP "failed")) (|x'| (UP)) (|x| (UP)))
         (SEQ
          (LETT |x'|
                (SPADCALL
        ...
        ((|f| (R)) (|derivation| (|Mapping| UP UP))
         ($
          (|Union|
           ...
           "failed")))
        (SPROG
         ((|diff1| (R)) (#1=#:G653 NIL) (#2=#:G652 (R)) (#3=#:G654 (R))
          (#4=#:G661 NIL) (|lg| NIL)
          (|ll|
           (|List|
            (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
...
(DEFUN |AlgebraicIntegrate| (&REST #1=#:G662)
  (SPROG NIL
         (PROG (#2=#:G663)
           (RETURN
            (COND
