...
(SDEFUN |INTALG;get_coeffs0| ((|lp| |List| UP) ($ |List| F))
        (SPROG ((|res| (|List| F)) (#1=#:G259 NIL) (|p| NIL))
...
(SDEFUN |INTALG;varRoot?| ((|p| UP) (|derivation| |Mapping| F F) ($ |Boolean|))
        (SPROG ((#1=#:G398 NIL) (#2=#:G400 NIL) (#3=#:G401 NIL) (|c| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(SDEFUN |INTALG;trace1|
        ...
        (SPROG
         ((|rc|
          ...
          (|v0| #1=(|FiniteDivisor| F UP UPUP R)) (#2=#:G444 NIL)
          (#3=#:G443 #1#) (#4=#:G445 #1#) (#5=#:G455 NIL) (|a| NIL)
          (#6=#:G456 NIL) (|dv| NIL)
          (|cd|
           (|Record| (|:| |num| (|List| (|Integer|))) (|:| |den| (|Integer|))))
          (#7=#:G454 NIL) (#8=#:G453 NIL))
         (SEQ
          (LETT |cd|
                (SPADCALL
                 (PROGN
         ...
         ((|ans|
           (|Record|
            (|:| |factor|
                 (|SparseUnivariatePolynomial| (|Fraction| (|Integer|))))
            (|:| |exponent| (|Integer|))))
          (|found| (|Boolean|)) (#1=#:G469 NIL) (#2=#:G470 NIL) (|q| NIL))
         (SEQ
          (EXIT
...
(SDEFUN |INTALG;palgintegrate;RMIr;29|
        ((|f| R) (|derivation| |Mapping| UP UP) ($ |IntegrationResult| R))
        (SPROG
         ((|difFirstKind| (R)) (#1=#:G567 NIL) (#2=#:G566 (R)) (#3=#:G568 (R))
          (#4=#:G574 NIL) (|lg| NIL) (#5=#:G571 NIL)
          (|u|
           (|Union|
            (|List|
             (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
...
(SDEFUN |INTALG;algintegrate;RMIr;30|
        ((|f| R) (|derivation| |Mapping| UP UP) ($ |IntegrationResult| R))
        (SPROG
         ((#1=#:G585 NIL) (|xx| (|Union| UP "failed")) (|x'| (UP)) (|x| (UP)))
         (SEQ
          (LETT |x'|
                (SPADCALL
...
(DEFUN |AlgebraicIntegrate| (&REST #1=#:G596)
  (SPROG NIL
         (PROG (#2=#:G597)
           (RETURN
            (COND
