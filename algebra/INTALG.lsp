...
(SDEFUN |INTALG;algintexp|
        ...
        (SPROG
         ((|u|
          ...
          (#2=#:G237 NIL) (|i| NIL) (|vf| (|Vector| (|Fraction| UP)))
...
(SDEFUN |INTALG;find_multiples|
        ...
        (SPROG
         ((|res|
          ...
          (|cp| (F)) (|p| (UP)) (#2=#:G279 NIL) (|f| NIL)
          (|n| #3=(|NonNegativeInteger|)) (|rp1| (UP)) (#4=#:G278 NIL)
...
(SDEFUN |INTALG;handle_multiples1|
        ...
        (SPROG
         ((|llg|
          ...
          (|nfac| #1#) (#4=#:G296 NIL) (|peq| NIL) (|alpha| (F)) (|p| (UP))
          (|pc1|
           (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                     (|:| |coeff| (|Fraction| (|Integer|))))))
          ...
          (|fu|
           (|Union|
            (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                      (|:| |coeff| (|Fraction| (|Integer|))))
            "failed"))
          (|nfac| #2#) (#4=#:G321 NIL) (|peq| NIL) (|lp1| (|List| #1#))
          (#5=#:G320 NIL) (#6=#:G319 NIL) (|p| (UP))
          (|pc1|
           (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                     (|:| |coeff| (|Fraction| (|Integer|))))))
         (SEQ
...
(SDEFUN |INTALG;get_coeffs0| ((|lp| (|List| UP)) ($ (|List| F)))
        (SPROG ((|res| (|List| F)) (#1=#:G326 NIL) (|p| NIL))
               (SEQ (LETT |res| NIL)
...
(SDEFUN |INTALG;get_lf|
        ((|ll1|
         ...
         ($ (|List| UP)))
        (SPROG
         ((#1=#:G368 NIL) (|peq| NIL) (#2=#:G367 NIL) (#3=#:G366 NIL)
          (#4=#:G365 NIL))
          ...
          (|List|
           (|List|
            (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                      (|:| |coeff| (|Fraction| (|Integer|)))))))
         ($ (|List| F)))
        (SPROG ((#1=#:G375 NIL) (|lfac| NIL) (#2=#:G374 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |lfac| NIL)
...
(SDEFUN |INTALG;get_ld|
        ...
        (SPROG
         ((#1=#:G393 NIL) (|peq| NIL) (#2=#:G392 NIL) (#3=#:G391 NIL) (|a| NIL)
          (#4=#:G390 NIL))
         (SEQ (COND ((NULL |ll1|) (COND ((NULL |ll2|) (EXIT NIL)))))
              (EXIT
               (COND
          ...
          (|nfl1|
           (|List|
            (|Record| (|:| |factor| UP) (|:| |exponent| (|NonNegativeInteger|))
                      (|:| |coeff| (|Fraction| (|Integer|))) (|:| |scalar| F)
                      (|:| |divisor| (|FiniteDivisor| F UP UPUP R)))))
          (#5=#:G486 NIL) (|nfl| NIL) (#6=#:G485 NIL) (#7=#:G484 NIL)
          (#8=#:G483 NIL)
          (|nlins2|
           (|List|
            (|List|
           ...
           (|Union|
            (|List|
             (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                       ...
                       (|:| |logand| (|SparseUnivariatePolynomial| R))))
            "failed"))
          (#9=#:G482 NIL) (|nlins1| (|List| #4#)) (#10=#:G481 NIL)
          (#11=#:G480 NIL) (|nfacs2| (|List| #2#)) (|nfacs1| (|List| #4#))
          (|ppr|
           (|Record|
            (|:| |result1|
                 (|List|
...
(SDEFUN |INTALG;varRoot?|
        ...
        (SPROG ((#1=#:G507 NIL) (#2=#:G508 NIL) (#3=#:G509 NIL) (|c| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |c| |derivation|)
                             ...
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 'T) (GO #4=#:G506)))
                              (GO #5=#:G504))))))
...
(SDEFUN |INTALG;trace1|
        ...
        (SPROG
         ((|rc|
          ...
          (|v0| #1=(|FiniteDivisor| F UP UPUP R)) (#2=#:G552 NIL)
          (#3=#:G551 #1#) (#4=#:G553 #1#) (#5=#:G563 NIL) (|a| NIL)
          (#6=#:G564 NIL) (|dv| NIL)
          (|cd|
           (|Record| (|:| |num| (|List| (|Integer|))) (|:| |den| (|Integer|))))
          (#7=#:G562 NIL) (#8=#:G561 NIL))
         (SEQ
          (LETT |cd|
                (SPADCALL
                 (PROGN
...
(SDEFUN |INTALG;pole_parts|
        ...
        (SPROG
         ((#1=#:G574 NIL) (|c| NIL) (#2=#:G573 NIL)
          (|nn| (|NonNegativeInteger|)) (#3=#:G568 NIL))
         (SEQ
          (LETT |nn|
                (PROG1 (LETT #3# (- |ii| 1))
...
(SDEFUN |INTALG;get_e_coeffs|
        ((|f| (R)) (|e_forms| (|List| R)) (|der| (|Mapping| UP UP))
         ($ (|Union| (|List| F) "failed")))
        (SPROG
         ((#1=#:G604 NIL) (#2=#:G608 NIL) (|c| NIL) (|cl| (|List| F))
          ...
          (|e_mat| (|Matrix| UP)) (|ll| (|List| (|List| UP))) (#4=#:G607 NIL)
          (|e_f| NIL) (#5=#:G606 NIL) (|fv| (|Vector| UP)) (#6=#:G603 NIL)
          (|inf_integral| (|Boolean|)) (#7=#:G605 NIL) (|ii| (|Integer|))
...
(SDEFUN |INTALG;palgintegrate;RFMR;31|
        ...
        (SPROG
         ((|el_f|
          ...
          (#1=#:G635 NIL) (#2=#:G634 (R)) (#3=#:G636 (R)) (#4=#:G665 NIL)
          (|lg| NIL) (#5=#:G657 NIL)
          (|u|
           (|Union|
            (|List|
             (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
                       ...
                       (|:| |logand| (|SparseUnivariatePolynomial| R))))
            "failed"))
          (|h_lp| (R)) (#6=#:G663 NIL) (|c_i| NIL) (#7=#:G664 NIL) (|e_f| NIL)
          (#8=#:G662 NIL) (|e_coeffs| (|List| F))
          (|e_cu| (|Union| (|List| F) "failed")) (|f_forms| (|List| R))
          (#9=#:G661 NIL) (|el| NIL) (#10=#:G660 NIL) (|e_forms| (|List| R))
          (#11=#:G659 NIL) (#12=#:G658 NIL)
          (|ell_lst|
           (|List|
...
(SDEFUN |INTALG;algintegrate;RMMIr;32|
        ((|f| (R)) (|derivation| (|Mapping| UP UP))
         ...
         ($ (|IntegrationResult| R)))
        (SPROG
         ((#1=#:G679 NIL) (|xx| (|Union| UP "failed")) (|x'| (UP)) (|x| (UP)))
         (SEQ
          (LETT |x'|
                (SPADCALL
        ...
        ((|f| (R)) (|derivation| (|Mapping| UP UP))
         ($
          (|Union|
           ...
           "failed")))
        (SPROG
         ((|diff1| (R)) (#1=#:G702 NIL) (#2=#:G701 (R)) (#3=#:G703 (R))
          (#4=#:G710 NIL) (|lg| NIL)
          (|ll|
           (|List|
            (|Record| (|:| |scalar| (|Fraction| (|Integer|)))
...
(DEFUN |AlgebraicIntegrate| (&REST #1=#:G711)
  (SPROG NIL
         (PROG (#2=#:G712)
           (RETURN
            (COND
