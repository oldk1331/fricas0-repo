...
(DEFUN |JCT;jacobi| (|y| $)
  (PROG (|res| |tmp| #1=#:G136 #2=#:G142 |i| JM |ly|)
    (RETURN
...
(DEFUN |JCT;transform;JB1Jbe;4| (|jv| $)
  (PROG (|res| #1=#:G158 #2=#:G164 #3=#:G166 |k| #4=#:G165 |qint| |pint|
         #5=#:G148 |i| |jt| |ans|)
    (RETURN
     (SEQ
      (LETT |ans|
...
(DEFUN |JCT;transform;JbeJbe;5| (|e1| $)
  (PROG (|e2| #1=#:G173 |jv| #2=#:G174 |je| JE #3=#:G172 #4=#:G171 JV)
    (RETURN
     (SEQ
...
(DEFUN |JetCoordinateTransformation| (&REST #1=#:G175)
  (PROG ()
    (RETURN
     (PROG (#2=#:G176)
       (RETURN
