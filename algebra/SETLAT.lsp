...
(SDEFUN |SETLAT;complement;2$;4| ((|a| ($)) ($ ($)))
        (SPROG
         ((|r| (|List| S)) (|contains| (|Boolean|)) (#1=#:G130 NIL) (|c| NIL)
          (#2=#:G129 NIL) (|b| NIL))
         (SEQ (LETT |r| NIL)
...
(SDEFUN |SETLAT;complement;$L$;5| ((|a| ($)) (|pseudoTop| (|List| S)) ($ ($)))
        (SPROG
         ((|r| (|List| S)) (|contains| (|Boolean|)) (#1=#:G139 NIL) (|c| NIL)
          (#2=#:G138 NIL) (|b| NIL))
         (SEQ (LETT |r| NIL)
...
(SDEFUN |SETLAT;coerce;$Of;9| ((|s| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|oup| (|List| (|OutputForm|))) (#1=#:G147 NIL) (|x| NIL)
          (|inp| ($)))
...
(DEFUN |SubsetLattice| (&REST #1=#:G148)
  (SPROG NIL
         (PROG (#2=#:G149)
           (RETURN
            (COND
