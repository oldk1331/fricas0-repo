...
(SDEFUN |SETLAT;complement;2$;4| ((|a| ($)) ($ ($)))
        (SPROG
         ((|r| (|List| S)) (|contains| (|Boolean|)) (#1=#:G128 NIL) (|c| NIL)
          (#2=#:G127 NIL) (|b| NIL))
         (SEQ (LETT |r| NIL)
...
(SDEFUN |SETLAT;complement;$L$;5| ((|a| ($)) (|pseudoTop| (|List| S)) ($ ($)))
        (SPROG
         ((|r| (|List| S)) (|contains| (|Boolean|)) (#1=#:G135 NIL) (|c| NIL)
          (#2=#:G134 NIL) (|b| NIL))
         (SEQ (LETT |r| NIL)
...
(SDEFUN |SETLAT;coerce;$Of;9| ((|s| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|oup| (|List| (|OutputForm|))) (#1=#:G142 NIL) (|x| NIL)
          (|inp| ($)))
...
(DEFUN |SubsetLattice| (&REST #1=#:G143)
  (SPROG NIL
         (PROG (#2=#:G144)
           (RETURN
            (COND
