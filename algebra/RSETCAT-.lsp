...
(SDEFUN |RSETCAT-;purelyAlgebraic?;SB;5| ((|ts| (S)) (% (|Boolean|)))
        (SPROG
         ((|lp| (|List| P)) (|p| NIL) (#1=#:G82 NIL) (|v| (V)) (#2=#:G70 NIL)
          (|i| (|NonNegativeInteger|)) (#3=#:G81 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |RSETCAT-;intersect;L2L;13|
        ((|lp| (|List| P)) (|lts| (|List| S)) (% (|List| S)))
        (SPROG
         ((#1=#:G159 NIL) (#2=#:G160 NIL) (#3=#:G161 NIL) (#4=#:G162 NIL)
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| S))) (|ts| (S))
          (|toSave| (|List| S)) (|p| (P)) (|lus| (|List| S)) (#5=#:G163 NIL)
          (|us| NIL) (#6=#:G164 NIL)
