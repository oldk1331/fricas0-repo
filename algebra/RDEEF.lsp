...
(SDEFUN |RDEEF;logdiff|
        ((|twr| |List| (|Kernel| F)) (|bad| |List| (|Kernel| F))
         ($ |List| (|Kernel| F)))
        (SPROG ((#1=#:G168 NIL) (|u| NIL) (#2=#:G167 NIL))
               (SEQ
                (PROGN
...
(SDEFUN |RDEEF;normalise0|
        ...
        (SPROG
         ((|y| (F))
          ...
          (#1=#:G242 NIL) (|m| (|Integer|))
          (|mu| (|Union| (|Integer|) "failed")) (|mq| (|Fraction| (|Integer|)))
          (#2=#:G249 NIL) (|v| NIL) (|nfprime| (F))
          (|data|
           (|List|
...
(SDEFUN |RDEEF;polyDElog|
        ...
        (SPROG
         ((|u3| (|Union| (|SparseUnivariatePolynomial| F) #2#))
          ...
          (|i| #1#) (#5=#:G413 NIL) (#6=#:G414 NIL)
          (|ans1| (|Union| (|SparseUnivariatePolynomial| F) #2#))
          (|alph| (|Union| F "failed")) (|if0| #1#) (#7=#:G416 NIL)
          (|u| (|Union| (|SparseUnivariatePolynomial| F) "failed"))
          (#8=#:G415 NIL) (|lk1| (|List| (|Kernel| F)))
...
(SDEFUN |RDEEF;gpolDEexp|
        ...
        (SPROG
         ((|v| (|Union| (|SparseUnivariatePolynomial| F) "failed"))
          (|tm| (|SparseUnivariatePolynomial| F)) (#1=#:G437 NIL)
            ...
            (SEQ
             (LETT |lb|
                   (SPADCALL |twr| |ftwr|
                             ...
                             (LETT |nc| (SPADCALL |c| (QREFELT $ 157)) . #3#)
                             |x| |t| |limint| (QREFELT $ 158))
                   . #3#)
             (LETT |tm|
...
(SDEFUN |RDEEF;exppolyint|
        ...
        (SPROG
         ...
         (SEQ
          ...
          (EXIT
           (COND ((QEQCAR |u| 1) (CONS 1 "failed"))
                 ('T (SPADCALL (QCDR |u|) (QREFELT $ 164)))))))) 

(SDEFUN |RDEEF;boundInf;2LF3ISKMI;16|
        ...
        (SPROG
         ((|al|
          ...
          (|alpha| (|Union| F "failed")) (|if0| #1#) (#2=#:G520 NIL) (|u| NIL)
          (#3=#:G519 NIL) (|l1| (|List| (|Kernel| F)))
          (|l0| (|List| (|Kernel| F))))
         (SEQ
          (COND ((< |da| |db|) (- |dc| |db|))
                        ...
                        ((QEQCAR |alpha| 0)
                         (SEQ
                          (LETT |al|
                                ...
                                . #5#)
                          (COND
                           ((SPADCALL (QCDR |al|) (QREFELT $ 167))
                            (COND
                             ((SPADCALL (QCAR |al|) (QREFELT $ 168))
                              (EXIT
                               (MAX 0
                                    (MAX (SPADCALL (QCAR |al|) (QREFELT $ 169))
                                         (- |dc| |db|))))))))
                          (EXIT (- |dc| |db|))))
                        (#4# (- |dc| |db|)))))))))))))) 

(SDEFUN |RDEEF;boundAt0;2LF2ISKMI;17|
        ((|twr| |List| (|Kernel| F)) (|ftwr| |List| (|Kernel| F)) (|f0| F)
         ...
         ((|al|
           (|Record|
            (|:| |polyPart|
                 (|LaurentPolynomial| F (|SparseUnivariatePolynomial| F)))
            (|:| |fracPart| (|Fraction| (|SparseUnivariatePolynomial| F)))))
          (|alpha| (|Union| F "failed")) (|if0| #1#) (#2=#:G538 NIL) (|u| NIL)
          (#3=#:G537 NIL) (|l1| (|List| (|Kernel| F)))
          (|l0| (|List| (|Kernel| F))))
         (SEQ
          (COND
           ((SPADCALL |nb| 0 (QREFELT $ 170)) (MIN 0 (- |nc| (MIN 0 |nb|))))
           (#4='T
            (SEQ
             (LETT |l1|
                   (|RDEEF;logdiff| |twr|
                    (LETT |l0| (SPADCALL |f0| (QREFELT $ 95))
                          . #5=(|RDEEF;boundAt0;2LF2ISKMI;17|))
                    $)
                   . #5#)
             (LETT |if0|
                   (SPADCALL |f0|
                           ...
                           ((SPADCALL (QCDR |al|) (QREFELT $ 167))
                            (COND
                             ((SPADCALL (QCAR |al|) (QREFELT $ 168))
                              (EXIT
                               (MIN 0
                                    (MIN (SPADCALL (QCAR |al|) (QREFELT $ 169))
                                         |nc|)))))))
                          (EXIT (MIN 0 |nc|))))
                        (#4# (MIN 0 |nc|)))))))))))))) 
...
(SDEFUN |RDEEF;logdegrad|
        ((|twr| |List| (|Kernel| F)) (|b| F)
         ...
         ($ |Union| (|SparseUnivariatePolynomial| F) "failed"))
        (SPROG
         ((#2=#:G559 NIL) (#3=#:G558 (F)) (#4=#:G560 (F)) (#5=#:G570 NIL)
          (|v| NIL) (|u1| (|Union| (|SparseUnivariatePolynomial| F) "failed"))
          (|alpha| (|Union| F "failed")) (|if0| #1#) (#6=#:G569 NIL) (|u| NIL)
          (#7=#:G568 NIL) (|lk1| (|List| (|Kernel| F)))
                     ...
                     ((QEQCAR |alpha| 0)
                      (SEQ
                       (LETT |u1|
                             (SPADCALL
                              (SPADCALL
                               (SPADCALL (QCDR |alpha|) (QREFELT $ 171)) |c|
                               (QREFELT $ 139))
...
(SDEFUN |RDEEF;logdeg|
        ((|c| |SparseUnivariatePolynomial| F) (|f| F) (|n| |Integer|)
         ...
         ($ |Union| (|SparseUnivariatePolynomial| F) "failed"))
        (SPROG
         ((|answr| (|SparseUnivariatePolynomial| F)) (#1=#:G588 NIL)
          (#2=#:G597 NIL)
          (|u|
           (|Record| (|:| |ans| F) (|:| |right| F) (|:| |sol?| (|Boolean|))))
          (#3=#:G596 NIL) (|m| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
          ...
          (|al|
           (|Record|
            (|:| |polyPart|
                 (|LaurentPolynomial| F (|SparseUnivariatePolynomial| F)))
            (|:| |fracPart| (|Fraction| (|SparseUnivariatePolynomial| F)))))
          (|alpha| (|Union| F "failed")) (|intf0| (F)) (#3=#:G608 NIL)
          (#4=#:G607 (F)) (#5=#:G609 (F)) (#6=#:G646 NIL) (|v| NIL) (|if0| #1#)
          (#7=#:G645 NIL) (|u| NIL) (#8=#:G644 NIL)
                       ...
                       (COND
                        ((SPADCALL (QCDR |al|) (QREFELT $ 167))
                         (COND
                          ((SPADCALL (QCAR |al|) (QREFELT $ 168))
                           (COND
                            ((>= (SPADCALL (QCAR |al|) (QREFELT $ 169)) 0)
                             (EXIT
                              (SEQ
                               (LETT |u1|
                                     (SPADCALL
...
(SDEFUN |RDEEF;expdeg|
        ((|c| |SparseUnivariatePolynomial| F) (|f| F) (|n| |Integer|)
         ...
         ($ |Union| (|SparseUnivariatePolynomial| F) "failed"))
        (SPROG
         ((|answr| (|SparseUnivariatePolynomial| F)) (#1=#:G672 NIL)
          (|u|
           (|Record| (|:| |ans| F) (|:| |right| F) (|:| |sol?| (|Boolean|))))
          (#2=#:G671 NIL) (|m| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
...
(SDEFUN |RDEEF;RRF2F|
        ((|rrf| |Record| (|:| |mainpart| F)
         ...
         ($ F))
        (SPROG
         ((#1=#:G676 NIL) (#2=#:G675 (F)) (#3=#:G677 (F)) (#4=#:G679 NIL)
          (|v| NIL))
         (SEQ
          (SPADCALL (QCAR |rrf|)
                    (PROGN
...
(DEFUN |ElementaryRischDE| (&REST #1=#:G680)
  (SPROG NIL
         (PROG (#2=#:G681)
           (RETURN
            (COND
...
(MAKEPROP '|ElementaryRischDE| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'ALGOP
              ...
              (501 . |coefficient|) (507 . |order|)
              |RDEEF;boundAt0;2LF2ISKMI;17| (512 . |Zero|) (516 . *)
              (522 . |retract|) (527 . |monomial|)
              |RDEEF;boundInf;2LF3ISKMI;16| (533 . |retractIfCan|)
              (|Record| (|:| |polyPart| $) (|:| |fracPart| 18))
              (538 . |separate|) (543 . |zero?|) (548 . |monomial?|)
              (553 . |degree|) (558 . ~=) (564 . |inv|) (569 . |reductum|)
              (574 . -) (580 . |recip|) (585 . *))
           '#(|rischDE| 591 |boundInf| 601 |boundAt0| 614) 'NIL
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 175
                                                 '(2 12 10 0 11 13 1 12 14 0 15
                                                   ...
                                                   70 0 159 2 20 0 0 0 160 1 20
                                                   17 0 161 2 20 0 7 49 162 1
                                                   20 129 0 164 1 20 165 18 166
                                                   1 18 10 0 167 1 20 10 0 168
                                                   1 20 49 0 169 2 49 10 0 0
                                                   170 1 7 0 0 171 1 17 0 0 172
                                                   2 17 0 0 0 173 1 20 23 0 174
                                                   2 7 0 78 0 175 6 0 48 49 7 7
                                                   11 53 56 57 9 0 49 25 25 7
                                                   49 49 49 11 12 53 163 8 0 49
                                                   25 25 7 49 49 11 12 53
                                                   158)))))
           '|lookupComplete|)) 
