                           ...
                           (COND
                            ((SPADCALL |op| |s| (QREFELT $ 151))
                             (PROGN
                              (LETT #1#
                                    (PROGN
                                     (LETT #2# (SPADCALL |op| (QREFELT $ 152))
                                           . #4#)
                                     (GO #2#))
                                    . #4#)
                              (GO #1#))))))
...
(SDEFUN |COMMONOP;dexp| ((|x| |OutputForm|) ($ |OutputForm|))
        (SPROG ((|e| (|OutputForm|)))
               (SEQ (LETT |e| (SPADCALL '|%e| (QREFELT $ 155)) |COMMONOP;dexp|)
                    (EXIT
                     (COND
                      ((SPADCALL |x| (SPADCALL 1 (QREFELT $ 163))
                                 (QREFELT $ 164))
                       |e|)
...
(SDEFUN |COMMONOP;startUp| ((|b| |Boolean|) ($ |Void|))
        (SPROG
         ...
         (SEQ (SPADCALL (QREFELT $ 9) |b| (QREFELT $ 166))
              ...
              (SEQ (LETT |op| NIL . #14#) (LETT #12# (QREFELT $ 135) . #14#)
                   G190
                   (COND
              ...
              (SEQ (LETT |op| NIL . #14#) (LETT #11# (QREFELT $ 136) . #14#)
                   G190
                   (COND
              ...
              (SEQ (LETT |op| NIL . #14#) (LETT #10# (QREFELT $ 139) . #14#)
                   G190
                   (COND
              ...
              (SEQ (LETT |op| NIL . #14#) (LETT #9# (QREFELT $ 140) . #14#)
                   G190
                   (COND
              ...
              (SEQ (LETT |op| NIL . #14#) (LETT #8# (QREFELT $ 141) . #14#)
                   G190
                   (COND
              ...
              (SEQ (LETT |op| NIL . #14#) (LETT #7# (QREFELT $ 142) . #14#)
                   G190
                   (COND
              ...
              (SEQ (LETT |op| NIL . #14#) (LETT #6# (QREFELT $ 143) . #14#)
                   G190
                   (COND
              ...
              (SEQ (LETT |op| NIL . #14#) (LETT #5# (QREFELT $ 144) . #14#)
                   G190
                   (COND
              ...
              (SEQ (LETT |op| NIL . #14#) (LETT #4# (QREFELT $ 146) . #14#)
                   G190
                   (COND
              ...
              (SEQ (LETT |op| NIL . #14#) (LETT #3# (QREFELT $ 147) . #14#)
                   G190
                   (COND
              ...
              (SEQ (LETT |op| NIL . #14#) (LETT #2# (QREFELT $ 148) . #14#)
                   G190
                   (COND
              ...
              (SEQ (LETT |op| NIL . #14#) (LETT #1# (QREFELT $ 149) . #14#)
                   G190
                   (COND
...
(SDEFUN |COMMONOP;startUp!6| ((|z1| NIL) ($ NIL))
        (SPADCALL
         (SPADCALL (SPADCALL '|(| (QREFELT $ 185))
                   (SPADCALL |z1| (SPADCALL '|)| (QREFELT $ 185))
                             (QREFELT $ 187))
                   (QREFELT $ 188))
         (QREFELT $ 189))) 
...
(SDEFUN |COMMONOP;startUp!5| ((|z1| NIL) ($ NIL))
        (SPADCALL
         (SPADCALL (SPADCALL |z1| (QREFELT $ 174))
                   ...
                   (QREFELT $ 181))
         (SPADCALL (QREFELT $ 182)) (SPADCALL |z1| (QREFELT $ 177))
         (QREFELT $ 183))) 

(SDEFUN |COMMONOP;startUp!4| ((|z1| NIL) ($ NIL))
        (SPADCALL (SPADCALL |z1| (QREFELT $ 174))
                  (SPADCALL |z1| (QREFELT $ 175))
...
(SDEFUN |COMMONOP;startUp!2| ((|z1| NIL) ($ NIL))
        (SPADCALL (SPADCALL |z1| (QREFELT $ 174))
                  (SPADCALL |z1| (QREFELT $ 175)) (QREFELT $ 165))) 

(SDEFUN |COMMONOP;startUp!1| ((|z1| NIL) ($ NIL))
        (SPADCALL (SPADCALL |z1| (QREFELT $ 174))
                  (SPADCALL |z1| (QREFELT $ 175)) (QREFELT $ 176))) 
...
(DEFUN |CommonOperators;| ()
  (SPROG ((|dv$| NIL) ($ NIL) (|pv$| NIL))
         (PROGN
          ...
          (QSETREFV $ 145
                    (SPADCALL
                     (SPADCALL
                      (SPADCALL
                       (SPADCALL
                        (SPADCALL (QREFELT $ 134) (QREFELT $ 140)
                                  (QREFELT $ 138))
          ...
          (QSETREFV $ 149
                    (LIST (QREFELT $ 114) (QREFELT $ 120) (QREFELT $ 122)))
          $))) 
