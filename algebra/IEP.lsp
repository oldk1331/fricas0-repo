...
(SDEFUN |IEP;characteristicPolynomial;MSup;9|
        ((A (|Matrix| F)) (% (|SparseUnivariatePolynomial| F)))
        (SPROG
         ((#1=#:G42 NIL) (|j| NIL) (#2=#:G41 NIL) (|i| NIL)
...
(SDEFUN |IEP;eigenvalues;MML;10|
        ((A (|Matrix| F))
         ...
         (% (|List| (|Union| F (|SparseUnivariatePolynomial| F)))))
        (SPROG
         ((#1=#:G61 NIL) (|ls| NIL) (#2=#:G60 NIL) (#3=#:G59 NIL) (|lr| NIL)
          (#4=#:G58 NIL) (|lsym| (|List| (|SparseUnivariatePolynomial| F)))
          (|lrat| (|List| F)) (|rv| (F))
          (|f1| (|SparseUnivariatePolynomial| F)) (#5=#:G57 NIL) (|fr| NIL)
...
(SDEFUN |IEP;intRatEig|
        ...
        (SPROG
         ((|sol| (|List| (|Vector| (|SparseUnivariatePolynomial| F))))
          (#1=#:G81 NIL) (|i| NIL)
          (|w| (|Vector| (|SparseUnivariatePolynomial| F))) (#2=#:G80 NIL)
          (|v| NIL) (#3=#:G79 NIL) (|j| NIL) (#4=#:G78 NIL) (B (|Matrix| F))
...
(SDEFUN |IEP;intAlgEig|
        ...
        (SPROG
         ((|sol| (|List| (|Vector| (|SparseUnivariatePolynomial| F))))
          (#1=#:G111 NIL) (|i| NIL)
          (|w| (|Vector| (|SparseUnivariatePolynomial| F))) (#2=#:G110 NIL)
          (|vec| NIL) (#3=#:G109 NIL) (|j| NIL) (#4=#:G108 NIL) (B (AM))
...
(SDEFUN |IEP;eigenvectors;MML;17|
        ...
        (SPROG
         ((|algSol|
          ...
          (|vec| (F)) (|pol| #2#) (#3=#:G143 NIL) (|fact| NIL)
          (|lff|
           (|List|
...
(DEFUN |InnerEigenPackage| (#1=#:G144)
  (SPROG NIL
         (PROG (#2=#:G145)
           (RETURN
            (COND
