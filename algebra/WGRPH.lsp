...
(DEFUN |WGRPH;weightedGraph;LL$;4| (|ob| |ar| $)
  (PROG (|fobs| |fo| #1=#:G195 |f| #2=#:G196 |fn| |arrs| |arro| #3=#:G194 |a|)
    (RETURN
...
(DEFUN |WGRPH;weightedGraph;LL$;5| (|objs| |am| $)
  (PROG (|ar| |a| #1=#:G210 |j| #2=#:G209 |i| |obs| |o| |ob| #3=#:G208 |obn|)
    (RETURN
...
(DEFUN |WGRPH;cycleOpen;LS$;14| (|objs| |arrowName| $)
  (PROG (|arn| |ars| |a| |next| |obs| |o| |ob| #1=#:G256 |obn|)
    (RETURN
...
(DEFUN |WGRPH;cycleClosed;LS$;15| (|objs| |arrowName| $)
  (PROG (|arn| |ars| |a| |next| |obs| |o| |ob| #1=#:G266 |obn|)
    (RETURN
...
(DEFUN |WGRPH;unit;LS$;16| (|objs| |arrowName| $)
  (PROG (|arn| |ars| |a| |obs| |o| |ob| #1=#:G274 |obn|)
    (RETURN
...
(DEFUN |WGRPH;kgraph;LS$;17| (|objs| |arrowName| $)
  (PROG (|arn| |ars| |a| #1=#:G286 |obm| |obs| |o| |ob| #2=#:G285 |obn|)
    (RETURN
...
(DEFUN |WGRPH;+;3$;18| (|a| |b| $)
  (PROG (|la| |lb| |arr| #1=#:G294 |ba| |bStart| |lo|)
    (RETURN
     (SEQ
...
(DEFUN |WGRPH;merge;3$;19| (|a| |b| $)
  (PROG (|la| |lb| |arr| |fromI| |toI| #1=#:G314 |ba| |bStart| |bmap| #2=#:G302
         |newIndex| |mergedObjects| |i| #3=#:G313 |bob| #4=#:G312 |x|
         #5=#:G311)
    (RETURN
     (SEQ
      (LETT |bmap|
...
(DEFUN |WGRPH;objProd| (|a| |b| $)
  (PROG (|newObjs| |ob| |sp| |heighta| |widtha| |y| |x| |byi| |bxi| |bi|
         #1=#:G325 |boi| |ayi| |axi| |ai| #2=#:G324 |aoi|)
    (RETURN
...
(DEFUN |WGRPH;*;2$Wg;22| (|a| |b| $)
  (PROG (|newArrs| |arr| |an| #1=#:G348 |bv| #2=#:G347 |bu| #3=#:G346 |av|
         #4=#:G345 |au|)
    (RETURN
...
(DEFUN |WGRPH;cartesian;2$Wg;23| (|a| |b| $)
  (PROG (|newArrs| |arr| |an| #1=#:G373 |bv| #2=#:G372 |bu| #3=#:G371 |av|
         #4=#:G370 |au|)
    (RETURN
...
(DEFUN |WGRPH;closedObjProd| (|a| |b| |f| $)
  (PROG (|newObjs| |ob| |sp| |heighta| |widtha| |y| |x| |byi| |bxi| |bi|
         #1=#:G382 |boi| |ayi| |axi| |ai| #2=#:G381 |aoi|)
    (RETURN
...
(DEFUN |WGRPH;closedTensor;2$M$;25| (|a| |b| |f| $)
  (PROG (|newArrs| |arr| |an| #1=#:G403 |bv| #2=#:G402 |bu| #3=#:G401 |av|
         #4=#:G400 |au|)
    (RETURN
...
(DEFUN |WGRPH;closedCartesian;2$M$;26| (|a| |b| |f| $)
  (PROG (|newArrs| |arr| |an| #1=#:G429 |bv| #2=#:G428 |bu| #3=#:G427 |av|
         #4=#:G426 |au|)
    (RETURN
...
(DEFUN |WGRPH;map;$LL2I$;27| (|s| |m| |newOb| |offsetX| |offsetY| $)
  (PROG (|newArrs| |newArr| #1=#:G446 |oldArrow| #2=#:G434 #3=#:G433 |i|
         #4=#:G445 |oi| |newObjs| #5=#:G444 |o| #6=#:G443)
    (RETURN
     (SEQ
      (LETT |newObjs|
            (PROGN
...
(DEFUN |WGRPH;mapContra;$LL2I$;28| (|s| |m| |newOb| |offsetX| |offsetY| $)
  (PROG (|newArrs| |newArr| #1=#:G463 |oldArrow| #2=#:G451 #3=#:G450 |i|
         #4=#:G462 |oi| |newObjs| #5=#:G461 |o| #6=#:G460)
    (RETURN
     (SEQ
      (LETT |newObjs|
            (PROGN
...
(DEFUN |WGRPH;routeNodeRecursive| (|s| |a| |b| |visited| $)
  (PROG (#1=#:G475 |shortest| |d| #2=#:G476 |arr|)
    (RETURN
     (SEQ
      (EXIT
       (SEQ
...
(DEFUN |WGRPH;routeArrowRecursive| (|s| |a| |b| |visited| $)
  (PROG (#1=#:G492 |shortestFullPath| |shortest| |fullPath| |d| |aa| #2=#:G493
         |arr| |arrs| |arrn|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |WGRPH;getWeightBetween| (|s| |i1| |i2| $)
  (PROG (|res| |isDisjoint| #1=#:G519 |arr| |arrs|)
    (RETURN
...
(MAKEPROP '|WeightedGraph| '|infovec|
          (LIST
           ...
           '#(~= 221 |weightedGraph| 227 |weightedDistanceMatrix| 255 |unit|
              ...
              |initial| 475 |incidenceMatrix| 479 |inDegree| 484 |hash| 490
              |getVertices| 495 |getVertexIndex| 500 |getArrows| 506
              |getArrowIndex| 511 |flatten| 518 |distanceWeighted| 523
              |distanceMatrix| 530 |distance| 535 |diagramWidth| 542
              |diagramSvg| 547 |diagramHeight| 554 |deepDiagramSvg| 559
              |cycleOpen| 566 |cycleClosed| 572 |createY| 578 |createX| 584
              |createWidth| 590 |coerce| 595 |closedTensor| 605
              |closedCartesian| 612 |cartesian| 619 |arrowsToNode| 625
              |arrowsToArrow| 631 |arrowsFromNode| 637 |arrowsFromArrow| 643
              |arrowName| 649 |adjacencyMatrix| 656 |addWArrow!| 661
              |addObject!| 670 |addArrow!| 682 = 707 + 713 * 719)
           'NIL
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 109
                                            '(0 7 0 9 2 16 0 0 15 18 2 13 0 0
                                              ...
                                              27 0 27 1 1 0 109 0 1 1 0 21 0 45
                                              2 0 27 0 6 1 1 0 23 0 47 3 0 27 0
                                              27 27 90 1 0 0 107 1 3 0 93 0 27
                                              27 94 1 0 102 0 1 3 0 25 0 27 27
                                              1 1 0 27 0 62 3 0 100 40 0 36 1 1
                                              0 27 0 63 3 0 100 40 0 36 1 2 0 0
                                              10 40 51 2 0 0 10 40 52 2 0 27 27
                                              27 29 2 0 27 27 27 28 1 0 27 27 1
                                              1 0 108 0 1 1 0 108 0 1 3 0 0 0 0
                                              77 78 3 0 0 0 0 77 79 2 0 73 0 0
                                              76 2 0 30 0 27 1 2 0 30 0 27 1 2
                                              0 30 0 27 1 2 0 30 0 27 1 3 0 40
                                              0 27 27 70 1 0 103 0 1 5 0 0 0 40
                                              27 27 7 41 2 0 0 0 6 38 2 0 0 0
                                              20 39 5 0 0 0 40 27 27 30 1 4 0 0
                                              0 40 6 6 1 4 0 0 0 40 27 27 42 2
                                              0 36 0 0 1 2 0 0 0 0 58 2 0 73 0
                                              0 75)))))
           '|lookupComplete|)) 
