...
(SDEFUN |JBFC-;freeOf?;SJBB;19| ((|fun| S) (|jv| JB) ($ |Boolean|))
        (COND
         ((SPADCALL |jv| (SPADCALL |fun| (QREFELT $ 42)) (QREFELT $ 58)) 'NIL)
         ('T 'T))) 
...
(SDEFUN |JBFC-;formalDiff;SLS;30|
        ...
        (SPROG
         ((JV (|List| JB)) (|df| (S))
          ...
          (#1=#:G276 NIL) (|jm| (|SparseEchelonMatrix| JB S)) (|k| NIL)
          (#2=#:G283 NIL) (|i| NIL) (#3=#:G284 NIL) (|j| NIL))
         (SEQ
          (LETT JV (SPADCALL |f| (QREFELT $ 42))
                . #4=(|JBFC-;formalDiff;SLS;30|))
          (LETT |df| |f| . #4#)
...
(SDEFUN |JBFC-;formalDiff2;LPiSemR;31|
        ...
        (SPROG
         ((LJV (|List| (|List| JB))) (JV (|List| JB)) (|LRes| (|List| S))
          (|res| (S)) (|djv| (|Union| JB "0")) (#1=#:G315 NIL) (|df| NIL)
          (#2=#:G316 NIL) (|jv| NIL)
          (|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| S))))
          (#3=#:G314 NIL) (|l| NIL) (#4=#:G313 NIL) (|eq| NIL) (#5=#:G312 NIL)
          (#6=#:G311 NIL) (#7=#:G310 NIL) (|inds| (|List| JB)))
         (SEQ
          (LETT |inds| (SPADCALL JM (QREFELT $ 95))
...
(SDEFUN |JBFC-;sortLD;2L;34| ((|sys| |List| S) ($ |List| S))
        (SPROG
         ((#1=#:G335 NIL) (|l| NIL) (#2=#:G334 NIL)
          (|sl|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                      (|:| |Dep| (|List| (|NonNegativeInteger|)))
                      (|:| |Fun| S))))
          (#3=#:G333 NIL) (|f| NIL) (#4=#:G332 NIL))
         (SEQ
          (LETT |sl|
                (PROGN
         ...
         ((|newL|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                      (|:| |Dep| (|List| (|NonNegativeInteger|)))
                      (|:| |Fun| S))))
          (|newld| (JB)) (#1=#:G377 NIL) (|eq| NIL) (#2=#:G378 NIL)
          (JV #3=(|List| JB)) (|sjv| (JB)) (#4=#:G375 NIL) (#5=#:G376 NIL)
          (|lJV| (|List| #3#)) (|minlen| #6=(|NonNegativeInteger|)) (|sj| #3#)
          (|seq|
           (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                     (|:| |Dep| (|List| (|NonNegativeInteger|)))
                     (|:| |Fun| S)))
          (|len| #6#) (#7=#:G374 NIL) (|neweq| (S)) (#8=#:G343 NIL)
          (#9=#:G373 NIL) (|solvable?| (|Boolean|)) (|s| (|Union| S "failed"))
          (#10=#:G371 NIL) (#11=#:G372 NIL)
          (|eqLD|
           (|List|
            #12=(|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                          (|:| |Dep| (|List| (|NonNegativeInteger|)))
                          (|:| |Fun| S))))
          (|fl| #12#) (|cur| #12#))
         (SEQ
          (COND ((< (LENGTH |l|) 2) |l|)
                (#13='T
                 (SEQ (LETT |cur| (|SPADfirst| |l|) . #14=(|JBFC-;simpLD|))
                      (LETT |l| (CDR |l|) . #14#)
                      (EXIT
                       (COND
                                   ...
                                   (SEQ
                                    (EXIT
                                     (COND
                                      ...
                                      ('T
                                       (SEQ
                                        (LETT |eqLD| (CONS |fl| |eqLD|) . #14#)
                                        (EXIT (LETT |l| (CDR |l|) . #14#)))))))
                                   NIL (GO G190) G191 (EXIT NIL))
                              (LETT |solvable?| 'NIL . #14#)
                              (SEQ (LETT #11# NIL . #14#)
                                   (LETT |eq| NIL . #14#)
                                   (LETT #10# |eqLD| . #14#) G190
                                   (COND
                                    ((OR (ATOM #10#)
                                         (PROGN
                                          (LETT |eq| (CAR #10#) . #14#)
                              ...
                              (COND
                               (|solvable?|
                                (SEQ (LETT |eq| NIL . #14#)
                                     ...
                                     (EXIT NIL)))
                               (#13#
                                (SEQ (LETT |seq| (|SPADfirst| |eqLD|) . #14#)
                                     (LETT |sj|
                                           (SPADCALL (QVELT |seq| 3)
                                                     (QREFELT $ 42))
                                           . #14#)
                                     (LETT |minlen| (LENGTH |sj|) . #14#)
                                     (LETT |lJV| (LIST |sj|) . #14#)
                                     (SEQ (LETT |eq| NIL . #14#)
                                          (LETT #7# (CDR |eqLD|) . #14#) G190
                                          (COND
                                           ((OR (ATOM #7#)
                                                (PROGN
                                                 (LETT |eq| (CAR #7#) . #14#)
                                          ...
                                          (SEQ
                                           (LETT JV
                                                 (SPADCALL (QVELT |eq| 3)
                                                           (QREFELT $ 42))
                                                 . #14#)
                                           (LETT |len| (LENGTH JV) . #14#)
                                           (LETT |lJV| (CONS JV |lJV|) . #14#)
                                           (EXIT
                                            (COND
                                             ((< |len| |minlen|)
                                              (SEQ (LETT |seq| |eq| . #14#)
...
(SDEFUN |JBFC-;simplify;LSemR;36|
        ...
        (SPROG
         ((|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| S))))
          (|tmp| (|SparseEchelonMatrix| JB S)) (#1=#:G413 NIL) (|eq| NIL)
          (#2=#:G414 NIL) (|dep| NIL) (|i| NIL)
          (|resJM| (|SparseEchelonMatrix| JB S)) (|inds| (|List| JB))
          (|resDep| (|List| #3=(|List| (|NonNegativeInteger|))))
          (#4=#:G412 NIL) (|l| NIL) (#5=#:G411 NIL) (|resSys| (|List| S))
          (#6=#:G410 NIL) (#7=#:G409 NIL)
          (|sl|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|)) (|:| |Dep| #3#)
                      (|:| |Fun| S))))
          (#8=#:G408 NIL) (|f| NIL) (#9=#:G407 NIL) (|newSys| (|List| S))
          (|jmi| (|SparseEchelonMatrix| JB S)) (|neq| (S)) (#10=#:G406 NIL))
...
(SDEFUN |JBFC-;simpMod;3L;38|
        ...
        (SPROG
         ((|res| #1=(|List| S)) (|neq| (S)) (LS1 (|List| S)) (LD1 (|List| JB))
          (|ld| (JB)) (#2=#:G441 NIL) (#3=#:G440 NIL) (|eq1| NIL)
          (|newSys| (|List| S)) (LS #1#) (LD (|List| JB))
          (|i| (|NonNegativeInteger|)) (#4=#:G439 NIL) (|jv| NIL)
          (|ls| (|Union| S "failed")) (#5=#:G438 NIL) (|eq2| NIL))
         (SEQ
                ...
                ('T
                 (SEQ (LETT LD NIL . #6=(|JBFC-;simpMod;3L;38|))
                      ...
                      (SEQ (LETT |eq2| NIL . #6#) (LETT #5# |sys2| . #6#) G190
                           ...
                           (EXIT NIL))
                      (LETT |newSys|
                            (SPADCALL (ELT $ 129) |sys1| (QREFELT $ 142))
                            . #6#)
                      (EXIT
                       (COND ((NULL LD) |newSys|)
                             ('T
        ...
        ((|sys1| |List| S) (|jm| |SparseEchelonMatrix| JB S) (|sys2| |List| S)
         ($ |Record| (|:| |Sys| (|List| S))
          ...
          (|:| |Depend|
               (|Union| "failed" (|List| (|List| (|NonNegativeInteger|)))))))
        (SPROG
         ((#1=#:G484 NIL) (|i| (|NonNegativeInteger|)) (#2=#:G483 NIL)
          (|resSys| #3=(|List| S)) (|njm| (|SparseEchelonMatrix| JB S))
          (#4=#:G481 NIL) (|neq| (S)) (#5=#:G482 NIL) (|oeq| NIL)
          (|resJM| (|SparseEchelonMatrix| JB S)) (|res| #3#) (LS1 (|List| S))
          (LD1 (|List| JB)) (|ld| (JB)) (#6=#:G480 NIL) (#7=#:G479 NIL)
          (|eq1| NIL) (|newSys| (|List| S)) (LS #3#) (LD (|List| JB))
          (#8=#:G478 NIL) (|jv| NIL) (|ls| (|Union| S "failed"))
          (#9=#:G477 NIL) (|eq2| NIL) (|osys| (|List| S)) (#10=#:G476 NIL)
          (#11=#:G475 NIL))
         (SEQ
          (COND
           ...
           ('T
            (SEQ (LETT |osys| |sys1| . #12#) (LETT LD NIL . #12#)
                 ...
                 (LETT |newSys| (SPADCALL (ELT $ 129) |sys1| (QREFELT $ 142))
                       . #12#)
                 (LETT |res| NIL . #12#)
...
(SDEFUN |JBFC-;reduceMod;3L;40|
        ...
        (SPROG
         ((|res| #1=(|List| S)) (LS1 (|List| S)) (LD1 (|List| JB)) (|neq| (S))
          (|ld| (JB)) (#2=#:G511 NIL) (|oeq| (S)) (|eq| (S)) (#3=#:G510 NIL)
          (|eq1| NIL) (|newSys| (|List| S)) (LS #1#) (LD (|List| JB))
          (|i| (|NonNegativeInteger|)) (#4=#:G509 NIL) (|jv| NIL)
          (|ls| (|Union| S "failed")) (#5=#:G508 NIL) (|eq2| NIL))
         (SEQ
          (COND ((OR (NULL |sys1|) (NULL |sys2|)) |sys1|)
                ('T
...
(SDEFUN |JBFC-;autoReduce;2L;41| ((|sys| |List| S) ($ |List| S))
        (SPROG
         ((#1=#:G566 NIL)
          ...
          (|tmp1|
           (|List|
            #4=(|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                         (|:| |Dep| (|List| (|NonNegativeInteger|)))
                         (|:| |Fun| S))))
          (|tmp2| (|List| #4#)) (#5=#:G564 NIL) (#6=#:G563 NIL) (#7=#:G562 NIL)
          (|eq| NIL) (#8=#:G561 NIL) (|nl| (|List| S)) (|ol| #9=(|List| S))
          (|seq| (S)) (#10=#:G560 NIL) (|sub| #2#) (#11=#:G559 NIL) (|nsl| #9#)
          (#12=#:G558 NIL) (#13=#:G557 NIL)
          (|sl|
           #14=(|List|
                (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                          (|:| |Dep| (|List| (|NonNegativeInteger|)))
          ...
          (#15=#:G556 NIL) (#16=#:G554 NIL) (|osl| #14#)
          (|su| (|Union| S "failed")) (|ld| (JB)) (#17=#:G555 NIL))
         (SEQ
          (COND ((NULL |sys|) NIL) ((EQL (LENGTH |sys|) 1) |sys|)
                ('T
                 (SEQ
                  (LETT |nl| (SPADCALL (ELT $ 129) |sys| (QREFELT $ 142))
                        . #18=(|JBFC-;autoReduce;2L;41|))
                  (LETT |nsl| NIL . #18#) (LETT |sl| NIL . #18#)
                  (LETT |osl| |sl| . #18#)
                  (SEQ G190
                       (COND
                        ((NULL (COND ((NULL |nl|) 'NIL) ('T 'T))) (GO G191)))
                       (SEQ
...
(MAKEPROP '|JetBundleFunctionCategory&| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (321 . |solveFor|) (327 . ~=) (333 . |simpOne|) (338 . |merge|)
              (345 . |second|) (350 . |setRow!|) (357 . |#|)
              (|Union| '"failed" (|List| 16))
              (|Record| (|:| |Sys| 69) (|:| JM 70) (|:| |Depend| 134))
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 152
                                                 '(0 7 8 9 1 7 0 8 11 1 6 0 7
                                                   ...
                                                   0 0 128 1 6 0 0 129 3 122 0
                                                   121 0 0 130 1 41 7 0 131 3
                                                   83 32 0 82 109 132 1 16 25 0
                                                   133 1 6 0 0 137 3 41 0 7 0
                                                   82 139 3 86 0 6 0 82 140 2
                                                   86 0 141 0 142 1 6 69 69 143
                                                   3 6 0 0 7 0 146 2 6 44 0 0
                                                   147 3 122 0 121 0 0 149 2 6
                                                   0 0 0 150 2 122 0 0 0 151 1
                                                   0 70 69 94 1 0 69 69 124 2 0
                                                   135 69 70 136 1 0 0 0 138 3
                                                   0 135 69 70 69 145 2 0 69 69
                                                   69 144 1 0 32 30 33 1 0 46 0
                                                   47 2 0 69 69 69 148 3 0 25
                                                   69 70 25 73 1 0 25 0 54 0 0
                                                   8 36 0 0 8 38 1 0 7 0 57 2 0
                                                   70 69 75 88 1 0 70 69 77 0 0
                                                   30 35 2 0 0 0 0 40 2 0 44 0
                                                   7 59 3 0 100 69 8 70 118 3 0
                                                   105 0 8 70 119 2 0 69 69 8
                                                   102 2 0 0 0 8 104 2 0 0 0 16
                                                   107 1 0 70 70 98 3 0 25 69
                                                   70 25 71 3 0 0 0 7 0 67 1 0
                                                   44 0 51 1 0 25 0 56 0 0 25
                                                   60 1 0 69 69 152 0 0 0 20 1
                                                   0 0 8 13 0 0 0 22 1 0 0 8 15
                                                   2 0 0 8 25 27 1 0 0 25 29 1
