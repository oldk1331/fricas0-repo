...
(SDEFUN |JBFC-;dSubst;SJB2S;21| ((|f| (S)) (|jv| (JB)) (|exp| (S)) ($ (S)))
        (SPROG
         ((|nf| (S)) (|dexp| (S)) (|d| (|List| (|NonNegativeInteger|)))
          (#1=#:G220 NIL) (|jvar| NIL) (#2=#:G221 NIL) (|JVar| (|List| JB))
          (|of| (S)))
...
(SDEFUN |JBFC-;jacobiMatrix;LSem;24|
        ...
        (SPROG ((#1=#:G229 NIL) (|fun| NIL) (#2=#:G228 NIL))
               (SEQ
                (SPADCALL |funs|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |JBFC-;jacobiMatrix;LLSem;25|
        ...
        (SPROG
         ((|inds| (|List| JB)) (|ents| (|List| S)) (|df| (S)) (#1=#:G245 NIL)
          (|jv| NIL) (#2=#:G243 NIL) (|f| NIL) (#3=#:G244 NIL) (|vars| NIL)
...
(SDEFUN |JBFC-;symbol;LSem;26|
        ...
        (SPROG
         ((|inds| #1=(|List| JB)) (|ents| (|List| S)) (|df| (S))
          (#2=#:G288 NIL) (|jv| NIL) (#3=#:G286 NIL) (|f| NIL) (#4=#:G287 NIL)
          (|i| NIL) (|symb| (|SparseEchelonMatrix| JB S))
          (|oJV| (|List| (|List| JB))) (|allJV| #1#) (|ojl| #1#)
          (|jl| (|List| JB)) (#5=#:G285 NIL) (|ord| (|NonNegativeInteger|))
          (|ol| (|List| (|NonNegativeInteger|))) (#6=#:G284 NIL)
          (#7=#:G283 NIL) (JVL (|List| (|List| JB))) (#8=#:G282 NIL)
          (|fun| NIL) (#9=#:G281 NIL))
         (SEQ
          (LETT JVL
                (PROGN
...
(SDEFUN |JBFC-;formalDiff;SLS;30|
        ...
        (SPROG
         ((JV (|List| JB)) (|df| (S))
          ...
          (#1=#:G299 NIL) (|jm| (|SparseEchelonMatrix| JB S)) (#2=#:G308 NIL)
          (|k| NIL) (#3=#:G306 NIL) (|i| NIL) (#4=#:G307 NIL) (|j| NIL))
...
(SDEFUN |JBFC-;formalDiff2;LPiSemR;31|
        ...
        (SPROG
         ((LJV (|List| (|List| JB))) (JV (|List| JB)) (|LRes| (|List| S))
          (|res| (S)) (|djv| (|Union| JB "0")) (#1=#:G339 NIL) (|df| NIL)
          (#2=#:G340 NIL) (|jv| NIL)
          (|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| S))))
          (#3=#:G338 NIL) (|l| NIL) (#4=#:G337 NIL) (|eq| NIL) (#5=#:G336 NIL)
          (#6=#:G335 NIL) (#7=#:G334 NIL) (|inds| (|List| JB)))
         (SEQ (LETT |inds| (SPADCALL JM (QREFELT $ 94)))
              (EXIT
               (COND
                ((NULL |inds|)
...
(SDEFUN |JBFC-;sortLD;2L;34| ((|sys| (|List| S)) ($ (|List| S)))
        (SPROG
         ((#1=#:G360 NIL) (|l| NIL) (#2=#:G359 NIL)
          (|sl|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                      (|:| |Dep| (|List| (|NonNegativeInteger|)))
                      (|:| |Fun| S))))
          (#3=#:G358 NIL) (|f| NIL) (#4=#:G357 NIL))
         (SEQ
          (LETT |sl|
                (PROGN
                 (LETT #4# NIL)
         ...
         ((|newL|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                      (|:| |Dep| (|List| (|NonNegativeInteger|)))
                      (|:| |Fun| S))))
          (|newld| (JB)) (#1=#:G406 NIL) (|eq| NIL) (#2=#:G407 NIL)
          (|sjv| (JB)) (#3=#:G404 NIL) (#4=#:G405 NIL)
          ...
          (|seq|
           (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                     (|:| |Dep| (|List| (|NonNegativeInteger|)))
                     (|:| |Fun| S)))
          (|len| #6#) (JV #5#) (#7=#:G403 NIL) (|neweq| (S)) (#8=#:G368 NIL)
          (#9=#:G402 NIL) (|solvable?| (|Boolean|))
          (|s| (|Union| S #10="failed")) (#11=#:G400 NIL) (#12=#:G401 NIL)
          (|eqLD|
           (|List|
...
(SDEFUN |JBFC-;simplify;LSemR;36|
        ...
        (SPROG
         ((|r|
           (|Record| (|:| |Indices| (|List| JB)) (|:| |Entries| (|List| S))))
          (|tmp| (|SparseEchelonMatrix| JB S)) (#1=#:G443 NIL) (|eq| NIL)
          (#2=#:G444 NIL) (|dep| NIL) (|i| NIL)
          (|resJM| (|SparseEchelonMatrix| JB S)) (|inds| (|List| JB))
          (|resDep| (|List| #3=(|List| (|NonNegativeInteger|))))
          (#4=#:G442 NIL) (|l| NIL) (#5=#:G441 NIL) (|resSys| (|List| S))
          (#6=#:G440 NIL) (#7=#:G439 NIL)
          (|sl|
           (|List|
            (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|)) (|:| |Dep| #3#)
                      (|:| |Fun| S))))
          (#8=#:G438 NIL) (|f| NIL) (#9=#:G437 NIL) (|newSys| (|List| S))
          (|jmi| (|SparseEchelonMatrix| JB S)) (|neq| (S)) (#10=#:G436 NIL))
         (SEQ (LETT |newSys| NIL)
...
(SDEFUN |JBFC-;simpMod;3L;38|
        ...
        (SPROG
         ((|res| #1=(|List| S)) (|neq| (S)) (LS1 (|List| S)) (LD1 (|List| JB))
          (|ld| (JB)) (#2=#:G472 NIL) (#3=#:G471 NIL) (|eq1| NIL)
          (|newSys| (|List| S)) (LS #1#) (LD (|List| JB))
          (|i| (|NonNegativeInteger|)) (#4=#:G470 NIL) (|jv| NIL)
          (|ls| (|Union| S "failed")) (#5=#:G469 NIL) (|eq2| NIL))
         (SEQ
          ...
          (|Record| (|:| |Sys| (|List| S))
                    ...
                    (|:| |Depend|
                         (|Union| "failed"
                                  (|List| (|List| (|NonNegativeInteger|))))))))
        (SPROG
         ((#1=#:G515 NIL) (|i| (|NonNegativeInteger|)) (#2=#:G514 NIL)
          (|resSys| #3=(|List| S)) (|njm| (|SparseEchelonMatrix| JB S))
          (#4=#:G512 NIL) (#5=#:G513 NIL) (|oeq| NIL)
          (|resJM| (|SparseEchelonMatrix| JB S)) (|res| #3#) (|neq| (S))
          (LS1 (|List| S)) (LD1 (|List| JB)) (|ld| (JB)) (#6=#:G511 NIL)
          (#7=#:G510 NIL) (|eq1| NIL) (|newSys| (|List| S)) (LS #3#)
          (LD (|List| JB)) (#8=#:G509 NIL) (|jv| NIL)
          (|ls| (|Union| S "failed")) (#9=#:G508 NIL) (|eq2| NIL)
          (|osys| (|List| S)) (#10=#:G507 NIL) (#11=#:G506 NIL))
         (SEQ
          (COND
...
(SDEFUN |JBFC-;reduceMod;3L;40|
        ...
        (SPROG
         ((|res| #1=(|List| S)) (LS1 (|List| S)) (LD1 (|List| JB)) (|neq| (S))
          (|ld| (JB)) (#2=#:G542 NIL) (|oeq| (S)) (|eq| (S)) (#3=#:G541 NIL)
          (|eq1| NIL) (|newSys| (|List| S)) (LS #1#) (LD (|List| JB))
          (|i| (|NonNegativeInteger|)) (#4=#:G540 NIL) (|jv| NIL)
          (|ls| (|Union| S "failed")) (#5=#:G539 NIL) (|eq2| NIL))
         (SEQ
          (COND ((OR (NULL |sys1|) (NULL |sys2|)) |sys1|)
                ('T
                 (SEQ (LETT LD NIL) (LETT LS NIL)
...
(SDEFUN |JBFC-;autoReduce;2L;41| ((|sys| (|List| S)) ($ (|List| S)))
        (SPROG
         ((#1=#:G600 NIL) (#2=#:G599 NIL)
          (|tmp1|
           (|List|
            #3=(|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                         (|:| |Dep| (|List| (|NonNegativeInteger|)))
                         (|:| |Fun| S))))
          (|tmp2| (|List| #3#)) (#4=#:G598 NIL) (#5=#:G597 NIL) (#6=#:G596 NIL)
          (|eq| NIL) (#7=#:G595 NIL) (|nl| (|List| S)) (|ol| #8=(|List| S))
          (|seq| (S)) (#9=#:G594 NIL) (#10=#:G593 NIL) (|nsl| #8#)
