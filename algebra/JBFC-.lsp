...
(SDEFUN |JBFC-;symbol;LSem;26|
        ...
        (SPROG
         ((|inds| #1=(|List| JB)) (|ents| (|List| S)) (|df| (S))
          ...
          (#5=#:G285 NIL) (|ord| (|NonNegativeInteger|))
...
(SDEFUN |JBFC-;simpLD|
        ...
        (SPROG
         ((|newL|
          ...
          (JV #3=(|List| JB)) (|sjv| (JB)) (#4=#:G404 NIL) (#5=#:G405 NIL)
          (|lJV| (|List| #3#)) (|minlen| #6=(|NonNegativeInteger|)) (|sj| #3#)
          (|seq|
           (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                     (|:| |Dep| (|List| (|NonNegativeInteger|)))
                     (|:| |Fun| S)))
          (|len| #6#) (#7=#:G403 NIL) (|neweq| (S)) (#8=#:G368 NIL)
...
(SDEFUN |JBFC-;simpMod;LSemLR;39|
        ...
        (SPROG
         ((#1=#:G515 NIL) (|i| (|NonNegativeInteger|)) (#2=#:G514 NIL)
          ...
          (#4=#:G512 NIL) (|neq| (S)) (#5=#:G513 NIL) (|oeq| NIL)
          (|resJM| (|SparseEchelonMatrix| JB S)) (|res| #3#) (LS1 (|List| S))
          (LD1 (|List| JB)) (|ld| (JB)) (#6=#:G511 NIL) (#7=#:G510 NIL)
          (|eq1| NIL) (|newSys| (|List| S)) (LS #3#) (LD (|List| JB))
          (#8=#:G509 NIL) (|jv| NIL) (|ls| (|Union| S "failed"))
          (#9=#:G508 NIL) (|eq2| NIL) (|osys| (|List| S)) (#10=#:G507 NIL)
          (#11=#:G506 NIL))
         (SEQ
          (COND
...
(SDEFUN |JBFC-;autoReduce;2L;41| ((|sys| |List| S) ($ |List| S))
        (SPROG
         ((#1=#:G600 NIL)
          ...
          (|tmp1|
           (|List|
            #4=(|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                         (|:| |Dep| (|List| (|NonNegativeInteger|)))
                         (|:| |Fun| S))))
          (|tmp2| (|List| #4#)) (#5=#:G598 NIL) (#6=#:G597 NIL) (#7=#:G596 NIL)
          (|eq| NIL) (#8=#:G595 NIL) (|nl| (|List| S)) (|ol| #9=(|List| S))
          (|seq| (S)) (#10=#:G594 NIL) (|sub| #2#) (#11=#:G593 NIL) (|nsl| #9#)
          (#12=#:G592 NIL) (#13=#:G591 NIL)
          (|sl|
           #14=(|List|
                (|Record| (|:| LD JB) (|:| |Fake?| (|Boolean|))
                          (|:| |Dep| (|List| (|NonNegativeInteger|)))
          ...
          (#15=#:G590 NIL) (#16=#:G588 NIL) (|osl| #14#)
          (|su| (|Union| S "failed")) (|ld| (JB)) (#17=#:G589 NIL))
         (SEQ
