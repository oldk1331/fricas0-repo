...
(DEFUN |FSPECF;iiHypergeometricF;LF;258| (|l| $)
  (PROG (#1=#:G997 #2=#:G999 |q| |p| |pqi| |pq| |nn| #3=#:G996 |z| |n|)
    (RETURN
     (SEQ
      (EXIT
