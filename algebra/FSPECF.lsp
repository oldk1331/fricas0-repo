...
(DEFUN |FSPECF;iiHypergeometricF;LF;259| (|l| $)
  (PROG (#1=#:G893 #2=#:G895 |q| |p| |pqi| |pq| |nn| #3=#:G892 |z| |n|)
    (RETURN
     (SEQ
      (EXIT
