...
(DEFUN |FSPECF;iiHypergeometricF;LF;257| (|l| $)
  (PROG (#1=#:G986 #2=#:G988 |q| |p| |pqi| |pq| |nn| #3=#:G985 |z| |n|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |FSPECF;dvmeijer| (|l| |x| $)
  (PROG (|l2| |na| |a| |n2| |n1| |z| |l1| |nli| |nl| |l0| |nn| #1=#:G1008 |n|)
    (RETURN
...
(DEFUN |FunctionalSpecialFunction| (&REST #1=#:G1129)
  (PROG ()
    (RETURN
     (PROG (#2=#:G1130)
       (RETURN
