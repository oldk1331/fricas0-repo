...
(SDEFUN |LZSTAGG-;#;ANni;5| ((|x| (A)) ($ (|NonNegativeInteger|)))
        (SPROG ((#1=#:G244 NIL) (|y| (A)) (#2=#:G245 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;every?;MAB;7|
        ((|f| (|Mapping| (|Boolean|) S)) (|x| (A)) ($ (|Boolean|)))
        (SPROG ((#1=#:G267 NIL) (#2=#:G268 NIL) (|y| (A)) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;indices;AL;14| ((|x| (A)) ($ (|List| (|Integer|))))
        (SPROG
         ((#1=#:G303 NIL) (|y| (A)) (|l| (|List| (|Integer|))) (#2=#:G304 NIL)
          (|i| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |y| |x|) (LETT |l| NIL)
                 ...
                 (SEQ (LETT |i| 1) G190 NIL
                      (SEQ
                       (EXIT
                        (COND
                         ((SPADCALL |y| (QREFELT $ 27))
                          (PROGN (LETT #2# (NREVERSE |l|)) (GO #3=#:G302)))
                         ((SPADCALL |y| (QREFELT $ 28))
...
(SDEFUN |LZSTAGG-;maxIndex;AI;15| ((|x| (A)) ($ (|Integer|)))
        (SPROG ((#1=#:G314 NIL) (|y| (A)) (#2=#:G315 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (COND
...
(SDEFUN |LZSTAGG-;delete;AUsA;18|
        ...
        (SPROG
         ((#1=#:G330 NIL) (#2=#:G326 NIL) (#3=#:G325 NIL) (|high| (|Integer|))
          (|low| (|Integer|)))
...
(SDEFUN |LZSTAGG-;insert;SAIA;19|
        ((|s| (S)) (|x| (A)) (|n| (|Integer|)) ($ (A)))
        (SPROG ((|nn| (|NonNegativeInteger|)) (#1=#:G335 NIL))
               (SEQ
                (COND
                 ((NULL (SPADCALL |n| |x| (QREFELT $ 46)))
...
(SDEFUN |LZSTAGG-;insert;2AIA;20|
        ((|y| (A)) (|x| (A)) (|n| (|Integer|)) ($ (A)))
        (SPROG ((|nn| (|NonNegativeInteger|)) (#1=#:G339 NIL))
               (SEQ
                (COND
                 ((NULL (SPADCALL |n| |x| (QREFELT $ 46)))
                  (|error| "insert: index out of range"))
...
(SDEFUN |LZSTAGG-;distance;2AI;25| ((|x| (A)) (|z| (A)) ($ (|Integer|)))
        (SPROG ((#1=#:G365 NIL) (|y| (A)) (#2=#:G366 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;node?;2AB;26| ((|z| (A)) (|x| (A)) ($ (|Boolean|)))
        (SPROG ((#1=#:G375 NIL) (#2=#:G376 NIL) (|y| (A)) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;nodes;AL;27| ((|x| (A)) ($ (|List| A)))
        (SPROG
         ((#1=#:G385 NIL) (|y| (A)) (|l| (|List| A)) (#2=#:G386 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |y| |x|) (LETT |l| NIL)
                (SEQ (LETT |i| 0) G190 NIL
                     (SEQ
                      (EXIT
                       (COND
                        ((SPADCALL |y| (QREFELT $ 27))
                         (PROGN (LETT #2# (NREVERSE |l|)) (GO #3=#:G384)))
                        ((SPADCALL |y| (QREFELT $ 28))
...
(SDEFUN |LZSTAGG-;leaves;AL;28| ((|x| (A)) ($ (|List| S)))
        (SPROG ((#1=#:G396 NIL) (|y| (A)) (#2=#:G397 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;cycleTail;2A;34| ((|x| (A)) ($ (A)))
        (SPROG
         ((|z| (A)) (|y| (A)) (#1=#:G421 NIL) (|cycElt| (|Union| A "failed")))
         (SEQ
          (EXIT
           (SEQ (LETT |cycElt| (|LZSTAGG-;cycleElt| |x| $))
                (EXIT
...
(SDEFUN |LZSTAGG-;last;ANniA;41|
        ((|x| (A)) (|n| (|NonNegativeInteger|)) ($ (A)))
        (SPROG ((#1=#:G445 NIL) (|m| (|NonNegativeInteger|)))
               (SEQ
                (COND
...
(SDEFUN |LZSTAGG-;tail;2A;43| ((|x| (A)) ($ (A)))
        (SPROG
         ((#1=#:G459 NIL) (|y2| (A)) (|y1| (A)) (#2=#:G460 NIL) (|i| NIL))
         (SEQ
          (EXIT
