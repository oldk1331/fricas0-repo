...
(SDEFUN |LZSTAGG-;#;ANni;5| ((|x| (A)) (% (|NonNegativeInteger|)))
        (SPROG ((|i| NIL) (#1=#:G126 NIL) (|y| (A)) (#2=#:G125 NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;any?;MAB;6|
        ...
        (SPROG ((|i| NIL) (|y| (A)) (#1=#:G138 NIL) (#2=#:G137 NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;every?;MAB;7|
        ((|f| (|Mapping| (|Boolean|) S)) (|x| (A)) (% (|Boolean|)))
        (SPROG ((|i| NIL) (|y| (A)) (#1=#:G149 NIL) (#2=#:G148 NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;entries;AL;8| ((|x| (A)) (% (|List| S)))
        (SPROG
         ((|i| NIL) (#1=#:G159 NIL) (|l| (|List| S)) (|y| (A)) (#2=#:G158 NIL))
         (SEQ
          (EXIT
                 ...
                 (SEQ (LETT |i| 0) G190 NIL
                      (SEQ
                       (EXIT
                        (COND
                         ((SPADCALL |y| (QREFELT % 27))
                          (PROGN (LETT #1# (NREVERSE |l|)) (GO #3=#:G157)))
                         ((SPADCALL |y| (QREFELT % 28))
                          (|error|
                           (SPADCALL "entries:"
                                     " potentially infinite stream, maybe use 'complete'"
...
(SDEFUN |LZSTAGG-;indices;AL;14| ((|x| (A)) (% (|List| (|Integer|))))
        (SPROG
         ((|i| NIL) (#1=#:G185 NIL) (|l| (|List| (|Integer|))) (|y| (A))
          (#2=#:G184 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |y| |x|) (LETT |l| NIL)
                 ...
                 (SEQ (LETT |i| 1) G190 NIL
                      (SEQ
                       (EXIT
                        (COND
                         ((SPADCALL |y| (QREFELT % 27))
                          (PROGN (LETT #1# (NREVERSE |l|)) (GO #3=#:G183)))
                         ((SPADCALL |y| (QREFELT % 28))
                          (|error|
                           (SPADCALL "indices:"
                                     " potentially infinite stream, maybe use 'complete'"
...
(SDEFUN |LZSTAGG-;maxIndex;AI;15| ((|x| (A)) (% (|Integer|)))
        (SPROG ((|i| NIL) (#1=#:G196 NIL) (|y| (A)) (#2=#:G195 NIL))
               (SEQ
                (EXIT
                 (COND
...
(SDEFUN |LZSTAGG-;delete;AUsA;18|
        ...
        (SPROG
         ((|low| (|Integer|)) (|high| (|Integer|)) (#1=#:G206 NIL)
          (#2=#:G207 NIL) (#3=#:G211 NIL))
...
(SDEFUN |LZSTAGG-;insert;SAIA;19|
        ((|s| (S)) (|x| (A)) (|n| (|Integer|)) (% (A)))
        (SPROG ((#1=#:G216 NIL) (|nn| (|NonNegativeInteger|)))
               (SEQ
                (COND
                 ((NULL (SPADCALL |n| |x| (QREFELT % 48)))
...
(SDEFUN |LZSTAGG-;insert;2AIA;20|
        ((|y| (A)) (|x| (A)) (|n| (|Integer|)) (% (A)))
        (SPROG ((#1=#:G220 NIL) (|nn| (|NonNegativeInteger|)))
               (SEQ
                (COND
                 ((NULL (SPADCALL |n| |x| (QREFELT % 48)))
                  (|error| "insert: index out of range"))
...
(SDEFUN |LZSTAGG-;distance;2AI;25| ((|x| (A)) (|z| (A)) (% (|Integer|)))
        (SPROG ((|i| NIL) (#1=#:G247 NIL) (|y| (A)) (#2=#:G246 NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;node?;2AB;26| ((|z| (A)) (|x| (A)) (% (|Boolean|)))
        (SPROG ((|i| NIL) (|y| (A)) (#1=#:G257 NIL) (#2=#:G256 NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;nodes;AL;27| ((|x| (A)) (% (|List| A)))
        (SPROG
         ((|i| NIL) (#1=#:G267 NIL) (|l| (|List| A)) (|y| (A)) (#2=#:G266 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |y| |x|) (LETT |l| NIL)
                (SEQ (LETT |i| 0) G190 NIL
                     (SEQ
                      (EXIT
                       (COND
                        ((SPADCALL |y| (QREFELT % 27))
                         (PROGN (LETT #1# (NREVERSE |l|)) (GO #3=#:G265)))
                        ((SPADCALL |y| (QREFELT % 28))
                         (|error|
                          (SPADCALL "nodes:"
                                    " potentially infinite stream, maybe use 'complete'"
...
(SDEFUN |LZSTAGG-;leaves;AL;28| ((|x| (A)) (% (|List| S)))
        (SPROG ((|i| NIL) (#1=#:G278 NIL) (|y| (A)) (#2=#:G277 NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
...
(SDEFUN |LZSTAGG-;cycleTail;2A;34| ((|x| (A)) (% (A)))
        (SPROG
         ((|cycElt| (|Union| A "failed")) (#1=#:G302 NIL) (|y| (A)) (|z| (A)))
         (SEQ
          (EXIT
           (SEQ (LETT |cycElt| (|LZSTAGG-;cycleElt| |x| %))
                (EXIT
...
(SDEFUN |LZSTAGG-;last;AS;40| ((|x| (A)) (% (S)))
        (SPROG
         ((|i| NIL) (#1=#:G325 NIL) (|y1| (A)) (|y2| (A)) (#2=#:G324 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |LZSTAGG-;last;ANniA;41|
        ((|x| (A)) (|n| (|NonNegativeInteger|)) (% (A)))
        (SPROG ((|m| (|NonNegativeInteger|)) (#1=#:G326 NIL))
               (SEQ
                (COND
...
(SDEFUN |LZSTAGG-;tail;2A;43| ((|x| (A)) (% (A)))
        (SPROG
         ((|i| NIL) (#1=#:G341 NIL) (|y1| (A)) (|y2| (A)) (#2=#:G340 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |LZSTAGG-;possiblyInfinite?;AB;44| ((|x| (A)) (% (|Boolean|)))
        (SPROG ((|i| NIL) (|y| (A)) (#1=#:G351 NIL) (#2=#:G350 NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |y| |x|)
                      (EXIT
