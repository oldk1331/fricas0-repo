...
(SDEFUN |INTPM;splitConstant;FSR;2|
        ...
        (SPROG
         ((#1=#:G194 NIL) (|rec| (|Record| (|:| |const| F) (|:| |nconst| F)))
          (|vv| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|))))
          (|v|
           (|Union| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|)))
                    #2="failed"))
          (|cc| (F)) (#3=#:G196 NIL) (|g| NIL) (|nc| (F))
          (|u| (|Union| (|List| F) #2#)) (#4=#:G195 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |INTPM;matchdilog| ((|f| F) (|x| |Symbol|) ($ |List| F))
        (SPROG
         ((#1=#:G223 NIL) (#2=#:G224 NIL) (|l| (|List| F)) (#3=#:G225 NIL)
          (|k| NIL) (|df| (F))
                            ...
                            (NULL
                             (LETT |l|
                                   (|INTPM;matchdilog0| |f| |k| |x| |n| |df|
                                    $))))
                           (PROGN
                            (LETT #1# (PROGN (LETT #2# |l|) (GO #4=#:G222)))
                            (GO #5=#:G220))))))
...
(SDEFUN |INTPM;matchli| ((|f| F) (|x| |Symbol|) ($ |List| F))
        (SPROG
         ((#1=#:G234 NIL) (#2=#:G235 NIL) (|l| (|List| F)) (#3=#:G236 NIL)
                        ...
                        (EXIT
                         (COND
                          ((NULL
                           ...
                           (PROGN
                            (LETT #1# (PROGN (LETT #2# |l|) (GO #4=#:G233)))
                            (GO #5=#:G231))))))
                       (LETT #3# (CDR #3#)) (GO G190) G191 (EXIT NIL)))
                 #5# (EXIT #1#))
                (EXIT NIL)))
...
(SDEFUN |INTPM;formula1|
        ...
        (SPROG
         ((#1=#:G292 NIL) (|mmi| (|Integer|)) (|mm| (F)) (#2=#:G296 NIL)
...
(DEFUN |PatternMatchIntegration| (&REST #1=#:G321)
  (SPROG NIL
         (PROG (#2=#:G322)
           (RETURN
            (COND
