...
(SDEFUN |INTPM;splitConstant;FSR;2|
        ...
        (SPROG
         ((#1=#:G156 NIL) (|rec| (|Record| (|:| |const| F) (|:| |nconst| F)))
          (|vv| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|))))
          (|v|
           (|Union| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|)))
                    #2="failed"))
          (|cc| (F)) (#3=#:G158 NIL) (|g| NIL) (|nc| (F))
          (|u| (|Union| (|List| F) #2#)) (#4=#:G157 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |INTPM;formula1|
        ...
        (SPROG
         ((#1=#:G177 NIL) (|mmi| (|Integer|)) (|mm| (F)) (#2=#:G181 NIL)
...
(DEFUN |PatternMatchIntegration| (&REST #1=#:G206)
  (SPROG NIL
         (PROG (#2=#:G207)
           (RETURN
            (COND
