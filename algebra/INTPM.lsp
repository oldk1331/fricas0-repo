...
(DEFUN |INTPM;splitConstant;FSR;2| (|f| |x| $)
  (PROG (#1=#:G180 |rec| |vv| |v| |cc| #2=#:G182 |g| |nc| |u| #3=#:G181)
    (RETURN
     (SEQ
      (EXIT
       (COND
...
(DEFUN |INTPM;matcherfei| (|f| |x| |comp?| $)
  (PROG (#1=#:G195 |d| |sa| |u| |cc| |da| |a| |l| |res| |pat| |res0|)
    (RETURN
...
(DEFUN |INTPM;matchdilog| (|f| |x| $)
  (PROG (#1=#:G205 #2=#:G207 |l| #3=#:G208 |k| |df| |d| |n|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |INTPM;matchli| (|f| |x| $)
  (PROG (#1=#:G214 #2=#:G216 |l| #3=#:G217 |k| |d|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |INTPM;matchsici| (|f| |x| $)
  (PROG (|d| |nden| |ta| |dna| |na| |a_val| |l| #1=#:G232 |res| |ci0?| |ci?|
...
(DEFUN |INTPM;formula1| (|f| |x| |t| |cc| $)
  (PROG (#1=#:G289 |mmi| |mm| #2=#:G290 |sgz| |z| |sgs| |ms| |mw| |l|)
    (RETURN
     (SEQ
      (COND
       ((NULL
