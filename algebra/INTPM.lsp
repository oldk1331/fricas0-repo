...
(SDEFUN |INTPM;splitConstant;FSR;2|
        ...
        (SPROG
         ((#1=#:G175 NIL) (|rec| (|Record| (|:| |const| F) (|:| |nconst| F)))
          (|vv| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|))))
          (|v|
           (|Union| (|Record| (|:| |val| F) (|:| |exponent| (|Integer|)))
                    #2="failed"))
          (|cc| (F)) (#3=#:G177 NIL) (|g| NIL) (|nc| (F))
          (|u| (|Union| (|List| F) #2#)) (#4=#:G176 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |INTPM;formula1|
        ((|f| (F)) (|x| (|Symbol|)) (|t| (F)) (|cc| (F))
         ($ (|Union| F "failed")))
        (SPROG
         ((#1=#:G198 NIL) (|mmi| (|Integer|)) (|mm| (F)) (#2=#:G202 NIL)
...
(DEFUN |PatternMatchIntegration| (&REST #1=#:G227)
  (SPROG NIL
         (PROG (#2=#:G228)
           (RETURN
            (COND
