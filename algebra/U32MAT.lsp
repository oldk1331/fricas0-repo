...
(MAKEPROP '|U32MAT;minRowIndex;%I;1| '|SPADreplace| '(XLAM (|x|) 0)) 

(SDEFUN |U32MAT;minRowIndex;%I;1| ((|x| (%)) (% (|Integer|))) 0) 

(MAKEPROP '|U32MAT;minColIndex;%I;2| '|SPADreplace| '(XLAM (|x|) 0)) 

(SDEFUN |U32MAT;minColIndex;%I;2| ((|x| (%)) (% (|Integer|))) 0) 

(MAKEPROP '|U32MAT;nrows;%Nni;3| '|SPADreplace| 'ANROWS_U32) 

(SDEFUN |U32MAT;nrows;%Nni;3| ((|x| (%)) (% (|NonNegativeInteger|)))
        (ANROWS_U32 |x|)) 

(MAKEPROP '|U32MAT;ncols;%Nni;4| '|SPADreplace| 'ANCOLS_U32) 
...
(MAKEPROP '|U32MAT;qelt;%3I;7| '|SPADreplace| 'AREF2_U32) 

(SDEFUN |U32MAT;qelt;%3I;7|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (% (|Integer|)))
        (AREF2_U32 |m| |i| |j|)) 

(MAKEPROP '|U32MAT;elt;%3I;8| '|SPADreplace| 'AREF2_U32) 

(SDEFUN |U32MAT;elt;%3I;8|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (% (|Integer|)))
        (AREF2_U32 |m| |i| |j|)) 

(MAKEPROP '|U32MAT;qsetelt!;%4I;9| '|SPADreplace| 'SETAREF2_U32) 

(SDEFUN |U32MAT;qsetelt!;%4I;9|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (|r| #2=(|Integer|)) (% #2#))
        (SETAREF2_U32 |m| |i| |j| |r|)) 

(MAKEPROP '|U32MAT;setelt!;%4I;10| '|SPADreplace| 'SETAREF2_U32) 

(SDEFUN |U32MAT;setelt!;%4I;10|
        ((|m| (%)) (|i| #1=(|Integer|)) (|j| #1#) (|r| #2=(|Integer|)) (% #2#))
        (SETAREF2_U32 |m| |i| |j| |r|)) 

(MAKEPROP '|U32MAT;empty;%;11| '|SPADreplace| '(XLAM NIL (MAKE_MATRIX_U32 0 0))) 

(SDEFUN |U32MAT;empty;%;11| ((% (%))) (MAKE_MATRIX_U32 0 0)) 

(MAKEPROP '|U32MAT;qnew;2Nni%;12| '|SPADreplace| 'MAKE_MATRIX_U32) 

(SDEFUN |U32MAT;qnew;2Nni%;12|
        ((|rows| #1=(|NonNegativeInteger|)) (|cols| #1#) (% (%)))
        (MAKE_MATRIX_U32 |rows| |cols|)) 

(MAKEPROP '|U32MAT;new;2NniI%;13| '|SPADreplace| 'MAKE_MATRIX1_U32) 
...
(DEFUN |U32Matrix;| ()
  (SPROG
   ((|dv$| NIL) (% NIL) (#1=#:G2284 NIL) (#2=#:G2285 NIL) (#3=#:G2283 NIL)
    (|pv$| NIL))
   (PROGN
    (LETT |dv$| '(|U32Matrix|))
    (LETT % (GETREFV 46))
