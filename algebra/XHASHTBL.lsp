                         ...
                         (COND
                          ((EQ |mk| (QREFELT $ 9))
                           (SEQ (LETT |deletedPosition?| 'T)
                                (EXIT (PROGN (LETT #2# 1) (GO #3=#:G120)))))
                          ((SPADCALL |k| |mk| (QREFELT $ 17))
                           (PROGN (LETT #1# |p|) (GO #4=#:G131)))
                          ('T
                           (SEQ (LETT |p| (+ |p| |h2|))
                                (COND ((>= |p| |n|) (LETT |p| (- |p| |n|))))
                         ...
                         (COND
                          ((COND
                           ...
                           (SEQ
                            ...
                            (EXIT
                             (COND
                              ((< |p| 0) (PROGN (LETT #2# NIL) (GO #7=#:G286)))
                              ('T
                               (SEQ
                                (EXIT
                                 (COND
...
(DEFUN |XHashTable;| (|#1| |#2|)
  (SPROG
   ((#1=#:G342 NIL) (#2=#:G341 NIL) (|pv$| NIL) (#3=#:G339 NIL) (#4=#:G340 NIL)
