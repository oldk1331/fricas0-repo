...
(SDEFUN |IIARRAY2;latex;$S;14| ((|m| $) ($ |String|))
        (SPROG
         ((|s| (|String|)) (#1=#:G2329 NIL) (|j| NIL) (#2=#:G2328 NIL)
          (|i| NIL) (#3=#:G2327 NIL))
...
(SDEFUN |IIARRAY2;hashUpdate!;Hs$Hs;15|
        ...
        (SPROG ((#1=#:G2335 NIL) (|j| NIL) (#2=#:G2334 NIL) (|i| NIL))
               (SEQ
                (SEQ (LETT |i| (SPADCALL |m| (QREFELT $ 16)))
                     (LETT #2# (SPADCALL |m| (QREFELT $ 19))) G190
                     (COND ((> |i| #2#) (GO G191)))
...
(DEFUN |InnerIndexedTwoDimensionalArray| (&REST #1=#:G2343)
  (SPROG NIL
         (PROG (#2=#:G2344)
           (RETURN
            (COND
...
(DEFUN |InnerIndexedTwoDimensionalArray;| (|#1| |#2| |#3| |#4| |#5|)
  (SPROG
   ((|pv$| NIL) (#1=#:G2340 NIL) (#2=#:G2341 NIL) ($ NIL) (|dv$| NIL)
