...
(SDEFUN |IIARRAY2;latex;$S;14| ((|m| $) ($ |String|))
        (SPROG
         ((|s| (|String|)) (#1=#:G2328 NIL) (|j| NIL) (#2=#:G2327 NIL)
          (|i| NIL) (#3=#:G2326 NIL))
...
(SDEFUN |IIARRAY2;hashUpdate!;Hs$Hs;15|
        ...
        (SPROG ((#1=#:G2334 NIL) (|j| NIL) (#2=#:G2333 NIL) (|i| NIL))
               (SEQ
                (SEQ (LETT |i| (SPADCALL |m| (QREFELT $ 16)))
                     (LETT #2# (SPADCALL |m| (QREFELT $ 19))) G190
                     (COND ((> |i| #2#) (GO G191)))
...
(DEFUN |InnerIndexedTwoDimensionalArray| (&REST #1=#:G2342)
  (SPROG NIL
         (PROG (#2=#:G2343)
           (RETURN
            (COND
...
(DEFUN |InnerIndexedTwoDimensionalArray;| (|#1| |#2| |#3| |#4| |#5|)
  (SPROG
   ((|pv$| NIL) (#1=#:G2339 NIL) (#2=#:G2340 NIL) ($ NIL) (|dv$| NIL)
