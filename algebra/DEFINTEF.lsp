                     ...
                     ((SPADCALL
                       (PROG2 (LETT #3# |z| . #6#)
                         ...
                         (|check_union2| (QEQCAR #3# 0) (|Integer|)
                                         (|Union| (|Integer|) #5#) #3#))
                       0 (QREFELT $ 78))
                      (PROGN (LETT #2# (CONS 0 'T) . #6#) (GO #8=#:G357))))))))
            (LETT |z|
                     ...
                     ((<
                       (PROG2 (LETT #3# |z| . #6#)
                         ...
                         (|check_union2| (QEQCAR #3# 0) (|Integer|)
                                         (|Union| (|Integer|) #5#) #3#))
                       0)
                      (PROGN (LETT #2# (CONS 0 'T) . #6#) (GO #8=#:G376))))))))
            (LETT |z|
                  (SEQ (LETT |r| (SPADCALL |b| (QREFELT $ 51)) . #6#)
                       (EXIT
                        (COND
                   ...
                   (COND
                    ((SPADCALL |x|
                               (SPADCALL
                                ...
                                (QREFELT $ 88))
                               (QREFELT $ 90))
                     (PROGN (LETT #1# (CONS 1 "failed") . #2#) (GO #3=#:G387)))
                    ('T
                     (SEQ
                      (LETT |ans|
                            (SPADCALL |ans|
