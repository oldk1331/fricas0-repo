...
(SDEFUN |INTRF;extendedIntegrate;FSFU;3|
        ((|f| |Fraction| (|Polynomial| F)) (|x| |Symbol|)
         (|g| |Fraction| (|Polynomial| F))
         ($ |Union|
          (|Record| (|:| |ratpart| (|Fraction| (|Polynomial| F)))
                    (|:| |coeff| (|Fraction| (|Polynomial| F))))
          "failed"))
        (SPROG NIL
               (SPADCALL
                (CONS #'|INTRF;extendedIntegrate;FSFU;3!0| (VECTOR $ |x|))
                (SPADCALL (SPADCALL |f| |x| (QREFELT $ 12))
                          (SPADCALL |g| |x| (QREFELT $ 12)) (QREFELT $ 28))
                (QREFELT $ 31)))) 

(SDEFUN |INTRF;extendedIntegrate;FSFU;3!0| ((|x1| NIL) ($$ NIL))
        (PROG (|x| $)
          (LETT |x| (QREFELT $$ 1) . #1=(|INTRF;extendedIntegrate;FSFU;3|))
          (LETT $ (QREFELT $$ 0) . #1#)
          (RETURN (PROGN (SPADCALL |x1| |x| (QREFELT $ 11)))))) 

(SDEFUN |INTRF;limitedIntegrate;FSLU;4|
        ((|f| |Fraction| (|Polynomial| F)) (|x| |Symbol|)
         (|lu| |List| (|Fraction| (|Polynomial| F)))
         ($ |Union|
          (|Record| (|:| |mainpart| (|Fraction| (|Polynomial| F)))
                    (|:| |limitedlogs|
                         (|List|
                          (|Record| (|:| |coeff| (|Fraction| (|Polynomial| F)))
                                    (|:| |logand|
...
(SDEFUN |INTRF;limitedIntegrate;FSLU;4!0| ((|x1| NIL) ($$ NIL))
        (PROG (|x| $)
