...
(SDEFUN |ACF-;binomialRoots|
        ((|p| (|SparseUnivariatePolynomial| S)) (|y| (|Symbol|))
         ...
         (% (|List| S)))
        (SPROG
         ((|alpha| (S)) (|n| (|NonNegativeInteger|))
          (|cyclo| (|SparseUnivariatePolynomial| S)) (|x| (|Symbol|))
          (|beta| (S)) (#1=#:G93 NIL) (|i| NIL) (#2=#:G88 NIL) (#3=#:G94 NIL))
         (SEQ
          (LETT |alpha|
...
(SDEFUN |ACF-;allroots|
        ...
        (SPROG
         ((|p1| (|SparseUnivariatePolynomial| S))
          ...
          (|g| (|SparseUnivariatePolynomial| S)) (|groots| #1=(|List| S))
          (|r| NIL) (#2=#:G189 NIL) (#3=#:G141 #1#) (#4=#:G139 #1#)
          (#5=#:G140 NIL) (|x| (|Symbol|)) (|alpha| (S))
          (|q| (|SparseUnivariatePolynomial| S)) (#6=#:G135 NIL)
          (|ans| (|List| S)))
         (SEQ
          (COND
                  ...
                  (COND
                   ((> (LENGTH |decompList|) 1)
                    (SEQ (LETT |h| (SPADCALL |decompList| (QREFELT % 70)))
                         (LETT |g|
                               (PROG2
                                   (LETT #6# (SPADCALL |p| |h| (QREFELT % 72)))
                                   (QCDR #6#)
                         ...
                         (EXIT
                          (PROGN
                           (LETT #5# NIL)
                           (SEQ (LETT |r| NIL) (LETT #2# |groots|) G190
                                (COND
                                 ((OR (ATOM #2#)
