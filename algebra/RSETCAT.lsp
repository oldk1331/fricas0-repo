...
(DEFUN |RegularTriangularSetCategory| (&REST #1=#:G163)
  (LET (#2=#:G164)
    (COND
     ((SETQ #2#
                             ...
                             (|Join|
                              ...
                              (|mkCategory|
                               '(((|purelyAlgebraic?| ((|Boolean|) |t#4| $)) T)
                                 ...
                                 ((|intersect| ((|List| $) (|List| |t#4|) $))
                                  T)
                                 ((|intersect|
                                   ((|List| $) (|List| |t#4|) (|List| $)))
                                  T)
                                 ((|intersect| ((|List| $) |t#4| (|List| $)))
                                  T)
                                 ((|augment| ((|List| $) |t#4| $)) T)
                                 ((|augment| ((|List| $) |t#4| (|List| $))) T)
                                 ((|augment| ((|List| $) (|List| |t#4|) $)) T)
                                 ((|augment|
                                   ((|List| $) (|List| |t#4|) (|List| $)))
                                  T)
                                 ((|internalAugment| ($ |t#4| $)) T)
                                 ((|internalAugment| ($ (|List| |t#4|) $)) T)
                                 ((|extend| ((|List| $) |t#4| $)) T)
                                 ((|extend| ((|List| $) |t#4| (|List| $))) T)
                                 ((|extend| ((|List| $) (|List| |t#4|) $)) T)
                                 ((|extend|
                                   ((|List| $) (|List| |t#4|) (|List| $)))
                                  T)
                                 ((|zeroSetSplit|
