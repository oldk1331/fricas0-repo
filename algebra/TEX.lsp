...
(SDEFUN |TEX;display;$IV;8| ((|f| ($)) (|len| (|Integer|)) ($ (|Void|)))
        (SPROG
         ((#1=#:G252 NIL) (|s| NIL) (#2=#:G251 NIL) (|t| NIL) (#3=#:G250 NIL)
          (#4=#:G249 NIL))
         (SEQ
...
(SDEFUN |TEX;coerce;$Of;16| ((|f| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|l| (|List| (|String|))) (#1=#:G273 NIL) (|s| NIL) (#2=#:G272 NIL)
          (|t| NIL) (#3=#:G271 NIL) (#4=#:G270 NIL))
         (SEQ (LETT |l| NIL)
              (SEQ (LETT |s| NIL) (LETT #4# (QVELT |f| 0)) G190
                   (COND
...
(SDEFUN |TEX;postcondition| ((|str| (|String|)) ($ (|String|)))
        (SPROG
         ((#1=#:G287 NIL) (|i| NIL) (|minus| #2=(|Character|)) (|plus| #2#)
          (|len| (|Integer|)))
...
(SDEFUN |TEX;format_prime|
        ...
        (SPROG
         ((|narg2| #1=(|OutputForm|)) (|k| (|NonNegativeInteger|))
          (#2=#:G336 NIL) (|j| NIL) (#3=#:G335 NIL) (|i| NIL)
...
(SDEFUN |TEX;formatSpecial|
        ...
        (SPROG
         ((|tmp| (|String|)) (|prescript| (|Boolean|))
          (|form| (|List| (|String|))) (#1=#:G389 NIL) (|u| NIL)
          (#2=#:G388 NIL))
...
(SDEFUN |TEX;formatMatrix| ((|args| (|List| (|OutputForm|))) ($ (|String|)))
        (SPROG ((|cols| (|String|)) (#1=#:G409 NIL) (|i| NIL))
               (SEQ (LETT |cols| "{")
                    (SEQ (LETT |i| 1)
                         (LETT #1#
                               (LENGTH
...
(SDEFUN |TEX;formatNaryNoGroup|
        ((|op| (|Symbol|)) (|sep| (|String|)) (|opprec| (|Integer|))
         (|args| (|List| (|OutputForm|))) (|prec| (|Integer|)) ($ (|String|)))
        (SPROG
         ((|s| (|String|)) (|l| (|List| (|String|))) (#1=#:G439 NIL) (|a| NIL)
...
(SDEFUN |TEX;formatExpr|
        ...
        (SPROG
         ((|op| #1=(|Symbol|)) (|nargs| (|Integer|))
          ...
          (|i| (|Integer|)) (|str| (|String|)) (|s| (|String|)) (#2=#:G487 NIL)
          (#3=#:G486 NIL) (|u| (|UniversalSegment| (|Integer|)))
          (|len| (|Integer|)) (#4=#:G485 NIL) (|es| #1#) (|nstr| (|String|))
          (|intSplitLen| (|Integer|)))
         (SEQ
          (EXIT
