...
(SDEFUN |TEX;display;$IV;6| ((|f| ($)) (|len| (|Integer|)) ($ (|Void|)))
        (SPROG
         ((#1=#:G227 NIL) (|s| NIL) (#2=#:G226 NIL) (|t| NIL) (#3=#:G225 NIL)
          (#4=#:G224 NIL))
         (SEQ
...
(SDEFUN |TEX;coerce;$Of;14| ((|f| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|l| (|List| (|String|))) (#1=#:G248 NIL) (|s| NIL) (#2=#:G247 NIL)
          (|t| NIL) (#3=#:G246 NIL) (#4=#:G245 NIL))
         (SEQ (LETT |l| NIL)
              (SEQ (LETT |s| NIL) (LETT #4# (QVELT |f| 0)) G190
                   (COND
...
(SDEFUN |TEX;postcondition| ((|str| (|String|)) ($ (|String|)))
        (SPROG
         ((#1=#:G262 NIL) (|i| NIL) (|minus| #2=(|Character|)) (|plus| #2#)
          (|len| (|Integer|)))
...
(SDEFUN |TEX;format_prime|
        ...
        (SPROG
         ((|narg2| #1=(|OutputForm|)) (|k| (|NonNegativeInteger|))
          (#2=#:G311 NIL) (|j| NIL) (#3=#:G310 NIL) (|i| NIL)
...
(SDEFUN |TEX;formatSpecial|
        ...
        (SPROG
         ((|tmp| (|String|)) (|prescript| (|Boolean|))
          (|form| (|List| (|String|))) (#1=#:G364 NIL) (|u| NIL)
          (#2=#:G363 NIL))
...
(SDEFUN |TEX;formatMatrix| ((|args| (|List| (|OutputForm|))) ($ (|String|)))
        (SPROG ((|cols| (|String|)) (#1=#:G384 NIL) (|i| NIL))
               (SEQ (LETT |cols| "{")
                    (SEQ (LETT |i| 1)
                         (LETT #1#
                               (LENGTH
...
(SDEFUN |TEX;formatNaryNoGroup|
        ((|op| (|Symbol|)) (|sep| (|String|)) (|opprec| (|Integer|))
         (|args| (|List| (|OutputForm|))) (|prec| (|Integer|)) ($ (|String|)))
        (SPROG
         ((|s| (|String|)) (|l| (|List| (|String|))) (#1=#:G411 NIL) (|a| NIL)
...
(SDEFUN |TEX;formatExpr|
        ...
        (SPROG
         ((|op| #1=(|Symbol|)) (|nargs| (|Integer|))
          ...
          (|i| (|Integer|)) (|str| (|String|)) (|s| (|String|)) (#2=#:G459 NIL)
          (#3=#:G458 NIL) (|u| (|UniversalSegment| (|Integer|)))
          (|len| (|Integer|)) (#4=#:G457 NIL) (|es| #1#) (|nstr| (|String|))
          (|intSplitLen| (|Integer|)))
         (SEQ
          (EXIT
