...
(SDEFUN |OREMAT;rowEchelon;MFLR;2|
        ((|m| |Matrix| LO) (|cc| F) (|lv| |List| (|Vector| F))
         ($ |Record| (|:| |mat| (|Matrix| LO))
          (|:| |vecs| (|List| (|Vector| F)))))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G171 NIL) (|w| NIL) (#2=#:G170 NIL)
          (|k1| NIL) (|r| (LO)) (|q| (LO))
          (|#G18| (|Record| (|:| |quotient| LO) (|:| |remainder| LO)))
          (|mkj| (LO)) (#3=#:G169 NIL) (|k| NIL) (|elf2| (F)) (|elf1| (F))
          (#4=#:G168 NIL) (|el2| (LO)) (|el1| (LO)) (#5=#:G167 NIL) (|v| (LO))
          (|u| (LO)) (|d| (LO)) (|c| (LO)) (|mij| (LO))
          (|#G14|
           (|Record| (|:| |generator| LO) (|:| |coef1| LO) (|:| |coef2| LO)
                     (|:| |coefu| LO) (|:| |coefv| LO)))
          (#6=#:G166 NIL) (#7=#:G165 NIL) (|mm| (|Matrix| LO))
          (|dpiv| (|Integer|)) (|pivk| (|Integer|))
          (|dp1| (|NonNegativeInteger|)) (#8=#:G164 NIL) (#9=#:G159 NIL)
          (#10=#:G163 NIL) (|j| NIL) (#11=#:G162 NIL)
          (|nr| (|NonNegativeInteger|)) (|nc| (|NonNegativeInteger|))
          (|lw| (|List| (|Vector| F))) (#12=#:G161 NIL) (|vv| NIL)
          (#13=#:G160 NIL))
               ...
               (EXIT
                (SEQ (LETT |j| 1) (LETT #10# |nc|) G190
                     ...
                     (SEQ
                      (COND
                       ((> |i| |nr|)
                        (PROGN (LETT #9# |$NoValue|) (GO #14=#:G156))))
...
(SDEFUN |OREMAT;triangular_solve|
        ((|m| |Matrix| LO) (|cc| F) (|lv| |List| (|Vector| F))
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((#4=#:G250 NIL) (|ba| NIL) (#5=#:G251 NIL) (|bv| #6=(|Vector| F))
          (#7=#:G249 NIL) (|bvl| (|List| (|Vector| F))) (|cba| (|List| #6#))
          (|cb| (|List| #6#)) (|ncba| (|List| (|Vector| F)))
          (|na| (|Vector| F)) (|ncb| (|List| (|Vector| F))) (#8=#:G248 NIL)
          (|k| NIL) (|nbcv2| #6#) (#9=#:G247 NIL) (|nbcv1| #6#)
          (#10=#:G245 NIL) (|j| NIL) (#11=#:G246 NIL) (|slj| NIL)
          (|nsl2| (|List| F)) (|nbvl| (|List| (|Vector| F))) (#12=#:G244 NIL)
          (|nbcv| #6#) (#13=#:G216 NIL) (#14=#:G215 NIL)
          (|nrl1| (|NonNegativeInteger|)) (#15=#:G243 NIL) (#16=#:G242 NIL)
          (|ss| (F)) (#17=#:G241 NIL) (|slk| NIL) (#18=#:G240 NIL)
          (|noff| (|NonNegativeInteger|)) (|cm2| (|Matrix| F))
          (|cm1| (|Matrix| F)) (#19=#:G239 NIL) (|ncv| NIL) (#20=#:G238 NIL)
          (|nsl1| (|List| F)) (#21=#:G237 NIL) (|pr| NIL) (#22=#:G236 NIL)
          (|ncvl| (|List| #3#)) (#23=#:G235 NIL) (#24=#:G234 NIL)
          (|nrl| (|NonNegativeInteger|)) (|prl| #2#) (#25=#:G233 NIL)
          (|be| NIL) (|resi| #1#) (|lvi| (|List| F)) (|lvi2| (|List| F))
          (|vvi| (F)) (#26=#:G232 NIL) (#27=#:G230 NIL) (#28=#:G231 NIL)
          (|lvi1| (|List| F)) (#29=#:G229 NIL) (#30=#:G228 NIL)
          (|nbas| #31=(|NonNegativeInteger|)) (|nlvi| (|NonNegativeInteger|))
          (#32=#:G227 NIL) (#33=#:G226 NIL) (|lvi0| (|List| F))
          (#34=#:G225 NIL) (|v| NIL) (#35=#:G224 NIL) (#36=#:G217 NIL)
          (|i| NIL) (#37=#:G222 NIL) (#38=#:G223 NIL) (#39=#:G221 NIL)
          (#40=#:G220 NIL) (#41=#:G219 NIL) (#42=#:G218 NIL) (|n| #31#)
          (|nr| (|NonNegativeInteger|)) (|nc| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
...
(DEFUN |OrePolynomialMatrixOperations| (&REST #1=#:G266)
  (SPROG NIL
         (PROG (#2=#:G267)
           (RETURN
            (COND
