...
(DEFUN |DistributedMultivariatePolynomial| (&REST #1=#:G161)
  (PROG ()
    (RETURN
     (PROG (#2=#:G162)
       (RETURN
...
(DEFUN |DistributedMultivariatePolynomial;| (|#1| |#2|)
  (PROG (#1=#:G160 |pv$| #2=#:G159 $ |dv$| DV$2 DV$1)
    (RETURN
     (PROGN
      (LETT DV$1 (|devaluate| |#1|) . #3=(|DistributedMultivariatePolynomial|))
      (LETT DV$2 (|devaluate| |#2|) . #3#)
      (LETT |dv$| (LIST '|DistributedMultivariatePolynomial| DV$1 DV$2) . #3#)
      (LETT $ (GETREFV 55) . #3#)
      (QSETREFV $ 0 |dv$|)
      (QSETREFV $ 3
                (LETT |pv$|
...
(MAKEPROP '|DistributedMultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL
              ...
              (|DirectProduct| (NRTEVAL (LENGTH (QREFELT $ 6))) 18)
           ...
           (CONS
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 7 (|DirectProduct| (LENGTH 6) 18)
