...
(SDEFUN |PREASSOC;makeMonic|
        ...
        (SPROG
         ((#1=#:G139 NIL) (|u| (|Union| R "failed")) (#2=#:G140 NIL)
          (#3=#:G131 NIL) (|i| NIL) (|a| (|PrimitiveArray| R))
                ...
                (SEQ (LETT |i| 0)
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |u| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #4=#:G138)))
                        ('T
                         (QSETAREF1 |a| |i|
...
(DEFUN |PrecomputedAssociatedEquations| (&REST #1=#:G163)
  (SPROG NIL
         (PROG (#2=#:G164)
           (RETURN
            (COND
