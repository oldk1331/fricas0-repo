...
(SDEFUN |PREASSOC;makeMonic|
        ...
        (SPROG
         ((#1=#:G124 NIL) (|u| (|Union| R "failed")) (#2=#:G125 NIL)
          (#3=#:G116 NIL) (|i| NIL) (|a| (|PrimitiveArray| R))
            ...
            (SEQ (LETT |i| 0 . #4#)
                 ...
                 (SEQ
                  ...
                  (EXIT
                   (COND
                    ((QEQCAR |u| 1)
                     (PROGN (LETT #1# (CONS 1 "failed") . #4#) (GO #5=#:G123)))
                    ('T
                     (QSETAREF1 |a| |i|
...
(DEFUN |PrecomputedAssociatedEquations| (&REST #1=#:G148)
  (SPROG NIL
         (PROG (#2=#:G149)
           (RETURN
            (COND
