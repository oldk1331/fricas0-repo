...
(SDEFUN |PREASSOC;makeMonic|
        ...
        (SPROG
         ((#1=#:G140 NIL) (|u| (|Union| R "failed")) (#2=#:G141 NIL)
          (#3=#:G132 NIL) (|i| NIL) (|a| (|PrimitiveArray| R))
                ...
                (SEQ (LETT |i| 0)
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |u| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #4=#:G139)))
                        ('T
                         (QSETAREF1 |a| |i|
...
(DEFUN |PrecomputedAssociatedEquations| (&REST #1=#:G165)
  (SPROG NIL
         (PROG (#2=#:G166)
           (RETURN
            (COND
