...
(DEFUN |RURPK;rur;L2BL;1| (|lp| |univ?| |check?| $)
  (PROG (|toReturn| |lc| #1=#:G193 |q| #2=#:G192 |g| #3=#:G141 #4=#:G191 |us|
         #5=#:G190 |lus| #6=#:G189 |ts| |toSee| |newlq| #7=#:G188 #8=#:G187
         |newts| #9=#:G186 |qwt| |lsfqwt| #10=#:G185 #11=#:G184 #12=#:G183 |fq|
         |lfq| #13=#:G152 |lq| |toSave| |lqwt| |rif| #14=#:G182 |p|)
    (RETURN
     (SEQ
             ...
             ('T
              (SEQ
               ...
               (SEQ (LETT |p| NIL . #15#) (LETT #14# |lp| . #15#) G190
                    (COND
                     ((OR (ATOM #14#) (PROGN (LETT |p| (CAR #14#) . #15#) NIL))
                      (GO G191)))
               ...
               (SEQ (LETT |ts| NIL . #15#) (LETT #6# |toSave| . #15#) G190
                    (COND
                     ((OR (ATOM #6#) (PROGN (LETT |ts| (CAR #6#) . #15#) NIL))
                      (GO G191)))
                    (SEQ
                     (LETT |lus| (SPADCALL |ts| |univ?| (QREFELT $ 55)) . #15#)
                     (COND
                      (|check?|
                       (COND
                         ...
                         (EXIT
                          (SEQ (SPADCALL "RUR for: " (QREFELT $ 60))
                               ...
                               (SEQ (LETT |us| NIL . #15#)
                                    ...
                                    (SEQ
                                     (EXIT
                                      (SPADCALL (SPADCALL |us| (QREFELT $ 62))
                                                (QREFELT $ 63))))
                     ...
                     (EXIT
                      (SEQ (LETT |us| NIL . #15#) (LETT #4# |lus| . #15#) G190
                           (COND
                            ((OR (ATOM #4#)
                                   ...
                                   (SEQ (LETT |q| NIL . #15#)
                                        ...
                                        (SEQ
                                         (EXIT
                                          (LETT #2#
                                                (CONS
                                                 (SPADCALL |q| (QREFELT $ 70))
                                                 #2#)
                                                . #15#)))
                                        (LETT #1# (CDR #1#) . #15#) (GO G190)
                                        G191 (EXIT (NREVERSE #2#))))
                                  . #15#)
                            (EXIT
                             (LETT |toReturn| (CONS (CONS |g| |lc|) |toReturn|)
                                   . #15#)))
...
(DEFUN |RURPK;rur;LBL;2| (|lp| |univ?| $)
  (SPADCALL |lp| |univ?| 'NIL (QREFELT $ 73))) 

(DEFUN |RURPK;rur;LL;3| (|lp| $) (SPADCALL |lp| 'T (QREFELT $ 74))) 

(DEFUN |RationalUnivariateRepresentationPackage| (&REST #1=#:G198)
  (PROG ()
    (RETURN
     (PROG (#2=#:G199)
       (RETURN
        (COND
         ...
         ('T
          (UNWIND-PROTECT
              (PROG1
                  (APPLY
                   (|function| |RationalUnivariateRepresentationPackage;|) #1#)
                (LETT #2# T . #3#))
            (COND
             ((NOT #2#)
    ...
    (RETURN
     (PROGN
      ...
      (|haddProp| |$ConstructorCache|
                  '|RationalUnivariateRepresentationPackage| (LIST DV$1 DV$2)
                  (CONS 1 $))
      (|stuffDomainSlots| $)
      (QSETREFV $ 6 |#1|)
      (QSETREFV $ 7 |#2|)
      ...
      (QSETREFV $ 17
                (PROG2
                    (LETT #1# (SPADCALL (QREFELT $ 10) (QREFELT $ 16)) . #2#)
                    (QCDR #1#)
