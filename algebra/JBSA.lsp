...
(DEFUN |JBSA;setNotation;2S;1| (|s| $)
  (SEQ (SPADCALL "only repeated index notation possible" (QREFELT $ 34))
       (EXIT '|Repeated|))) 

(PUT '|JBSA;getNotation;S;2| '|SPADreplace| '(XLAM NIL '|Repeated|)) 

(DEFUN |JBSA;getNotation;S;2| ($) '|Repeated|) 

(DEFUN |JBSA;multiIndex;$L;3| (|jv| $) (SPADCALL |jv| (QREFELT $ 38))) 

(DEFUN |JBSA;index;$Pi;4| (|jv| $) (SPADCALL |jv| (QREFELT $ 40))) 

(DEFUN |JBSA;type;$S;5| (|jv| $) (SPADCALL |jv| (QREFELT $ 42))) 

(DEFUN |JBSA;X;Pi$;6| (|up| $) (SPADCALL |up| (QREFELT $ 44))) 

(DEFUN |JBSA;U;Pi$;7| (|up| $) (SPADCALL |up| (QREFELT $ 46))) 

(DEFUN |JBSA;Pm;PiL$;8| (|up| |lo| $) (SPADCALL |up| |lo| (QREFELT $ 48))) 

(DEFUN |JBSA;coerce;S$;9| (|s| $) (SPADCALL |s| (QREFELT $ 50))) 

(DEFUN |JBSA;D;SL$;10| (|u| |der| $) (SPADCALL |u| |der| (QREFELT $ 53))) 

(DEFUN |JBSA;One;$;11| ($) (SPADCALL (QREFELT $ 55))) 

(DEFUN |JBSA;numIndVar;Pi;12| ($) (+ (QREFELT $ 11) (QREFELT $ 13))) 

(DEFUN |JBSA;numDepVar;Pi;13| ($) (+ (QREFELT $ 11) (QREFELT $ 13))) 

(DEFUN |JBSA;name;$S;14| (|jv| $) (SPADCALL |jv| (QREFELT $ 58))) 
      ...
      (PROGN
       ...
       (QSETREFV $ 18
                 (SPADCALL
                  ...
                  (PROGN
                   (LETT #9# NIL . #13#)
                   (SEQ (LETT |i| 1 . #13#) (LETT #8# (QREFELT $ 13) . #13#)
...
(MAKEPROP '|JetBundleSymAna| '|infovec|
          (LIST
           ...
           '#(~= 111 |weight| 117 |variables| 122 |type| 133 |smaller?| 138
              ...
              |integrateIfCan| 209 |integrate| 215 |index| 221 |hash| 226
              |getNotation| 231 |dimS| 235 |dimJ| 240 |differentiate| 245
              |derivativeOf?| 251 |coerce| 257 |class| 272 |allRepeated| 282 X
              287 U 296 |Pr| 305 |Pm| 311 P 317 |One| 339 D 343 >= 349 > 355 =
              361 <= 367 < 373)
           'NIL
                  ...
                  (CONS
                   ...
                   (|makeByteWordVec2| 69
                                       '(0 6 9 10 0 6 9 12 1 6 0 9 14 1 6 0 9
                                         ...
                                         0 1 2 0 0 0 0 1 1 0 64 37 1 1 0 68 0 1
                                         2 0 65 0 9 1 2 0 0 0 9 1 1 0 9 0 41 1
                                         0 69 0 1 0 0 19 36 1 0 28 28 1 1 0 28
                                         28 1 2 0 66 0 9 1 2 0 37 0 0 1 1 0 0
                                         19 51 1 0 60 0 62 1 0 27 0 1 1 0 28 37
                                         1 1 0 28 0 1 1 0 67 37 1 0 0 0 1 1 0 0
                                         9 45 0 0 0 1 1 0 0 9 47 2 0 0 9 64 1 2
                                         0 0 9 37 49 1 0 0 28 1 2 0 0 9 28 1 1
                                         0 0 37 1 2 0 0 9 37 1 0 0 0 23 2 0 0
                                         19 52 54 2 0 25 0 0 1 2 0 25 0 0 1 2 0
                                         25 0 0 1 2 0 25 0 0 1 2 0 25 0 0
                                         1)))))
           '|lookupComplete|)) 
