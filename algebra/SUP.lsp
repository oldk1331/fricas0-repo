...
(SDEFUN |SUP;^;$Nni$;4| ((|p| ($)) (|n| (|NonNegativeInteger|)) ($ ($)))
        (SPROG
         ((|rn| #1=(|NonNegativeInteger|)) (|qn| #2=(|NonNegativeInteger|))
          ...
          (#3=#:G176 NIL) (|t| NIL) (#4=#:G175 NIL) (#5=#:G174 NIL) (|y| ($))
          (|cc| (R)))
         (SEQ
          (EXIT
...
(SDEFUN |SUP;multiplyExponents;$Nni$;8|
        ...
        (SPROG ((#1=#:G192 NIL) (|u| NIL) (#2=#:G191 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SUP;karatsubaDivide;$NniR;10|
        ...
        (SPROG
         ((|highp| (|Rep|)) (#1=#:G211 NIL) (|lowp| (|Rep|)) (#2=#:G219 NIL)
...
(SDEFUN |SUP;shiftRight;$Nni$;11|
        ((|p| ($)) (|n| (|NonNegativeInteger|)) ($ ($)))
        (SPROG ((#1=#:G223 NIL) (#2=#:G228 NIL) (|t| NIL) (#3=#:G227 NIL))
               (SEQ
                (PROGN
                 (LETT #3# NIL)
...
(SDEFUN |SUP;shiftLeft;$Nni$;12|
        ((|p| ($)) (|n| (|NonNegativeInteger|)) ($ ($)))
        (SPROG ((#1=#:G234 NIL) (|t| NIL) (#2=#:G233 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SUP;outputForm;$2Of;24|
        ...
        (SPROG
         ((|l| (|List| (|OutputForm|))) (#1=#:G277 NIL) (|t| NIL)
          (#2=#:G276 NIL))
         (SEQ
          (LETT |l|
                (PROGN
...
(SDEFUN |SUP;elt;$2R;26| ((|p| ($)) (|val| (R)) ($ (R)))
        (SPROG
         ((#1=#:G284 NIL) (|co| (R)) (#2=#:G281 NIL)
          (|n| (|NonNegativeInteger|)) (#3=#:G288 NIL) (|tm| NIL))
         (SEQ
...
(SDEFUN |SUP;elt;3$;27| ((|p| ($)) (|val| ($)) ($ ($)))
        (SPROG
         ((#1=#:G294 NIL) (|coef| ($)) (#2=#:G291 NIL)
          (|n| (|NonNegativeInteger|)) (#3=#:G298 NIL) (|tm| NIL))
         (SEQ
...
(SDEFUN |SUP;content;$R;32| ((|p| ($)) ($ (R)))
        (SPROG
         ((#1=#:G321 NIL) (#2=#:G320 (R)) (#3=#:G322 (R)) (#4=#:G325 NIL)
          (|tm| NIL))
         (SEQ
          (COND ((NULL |p|) (|spadConstant| $ 36))
                (#5='T
...
(DEFUN |SparseUnivariatePolynomial;| (|#1|)
  (SPROG
   ((#1=#:G401 NIL) (|pv$| NIL) (#2=#:G392 NIL) (#3=#:G394 NIL) (#4=#:G393 NIL)
    (#5=#:G395 NIL) (#6=#:G396 NIL) (#7=#:G397 NIL) (#8=#:G398 NIL)
    (#9=#:G399 NIL) (#10=#:G400 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|SparseUnivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|PolynomialRing| 6 11) (|local| |#1|) '|Rep|
              ...
              (397 . |divide|) (403 . *) (409 . /) (|Union| 141 '#1#)
              (|Matrix| $) (|InputForm|) (|Pattern| (|Float|)) (|Pattern| 33)
              (|Matrix| 33)
              (|Record| (|:| |mat| 139) (|:| |vec| (|Vector| 33))) (|Vector| $)
              (|List| 144) (|List| 11) (|Symbol|)
             ...
             (CONS
              ...
              (|makeByteWordVec2| 133
                                  '(2 0 0 0 11 12 2 0 0 0 13 14 0 0 0 15 0 0 0
                                    ...
                                    0 132 2 0 0 0 6 133 2 0 18 0 0 130 1 54 18
                                    0 26 1 0 0 8 10 2 0 52 0 43 53 1 0 8 0 42 1
                                    49 0 0 125 2 19 0 0 0 119 1 10 65 52 66 2
                                    10 82 83 52 84 2 4 0 0 11 40 2 0 0 0 11 41
                                    2 5 6 0 0 121 1 26 0 0 51 1 16 0 0 126 2 0
                                    89 0 89 102 1 52 18 0 29 2 0 0 8 43 44 2 0
                                    0 52 43 60 2 0 0 0 11 31 2 0 0 6 11 58 2 4
                                    38 0 0 114 1 0 8 0 9 1 26 6 0 47 2 4 38 0
                                    11 39 1 0 18 0 30 2 16 0 0 0 128 4 4 0 0 11
                                    6 0 113 1 10 65 52 72 1 10 65 52 71 1 10 76
                                    0 77 2 15 32 0 6 124 2 0 0 0 0 110 2 0 6 0
                                    6 109 2 0 32 0 11 35 2 13 38 0 0 131 1 5 6
                                    0 117 1 0 11 0 49 1 16 6 0 123 1 0 0 6 48 1
                                    0 89 0 105 3 46 0 0 0 11 24 2 52 0 0 11 12
                                    2 0 0 0 13 14 0 54 0 16 0 52 0 15 2 0 18 0
                                    0 112 2 13 0 0 6 133 2 0 0 0 0 61 2 0 0 6 0
                                    132 2 0 0 0 0 23)))))
           '|lookupIncomplete|)) 
