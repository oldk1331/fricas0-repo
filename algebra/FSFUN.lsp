...
(SDEFUN |FSFUN;li2_series|
        ...
        (SPROG
         ((|res| (|Complex| (|Float|))) (|ck| (|Float|)) (|k2| (|Integer|))
          ...
          (|oz| (|Integer|)) (|nz| (|Float|)))
         (SEQ
          (LETT |nz| (SPADCALL |z| (QREFELT $ 80)) . #2=(|FSFUN;li2_series|))
          (LETT |oz| (SPADCALL |nz| (QREFELT $ 53)) . #2#)
          (LETT |n|
                (COND
                 ((< |oz| -200)
                  (+
