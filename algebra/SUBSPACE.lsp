...
(DEFUN |SUBSPACE;merge;L$;13| (|listOfSpaces| $)
  (PROG (#1=#:G197 |c| #2=#:G196 #3=#:G195 |s| |space|)
    (RETURN
     (SEQ
      (COND
...
(DEFUN |SUBSPACE;addPoint;$LP$;15| (|space| |path| |point| $)
  (PROG (|node| #1=#:G214 |more| |depth| #2=#:G213 |i| |which| |lastPt|)
    (RETURN
     (SEQ
      (COND
       ((NULL
...
(DEFUN |SUBSPACE;addPoint2;$P$;16| (|space| |point| $)
  (PROG (|node| #1=#:G223 |more| |first| |depth| |which| |lastPt|)
    (RETURN
     (SEQ
      (COND
       ((NULL
...
(DEFUN |SUBSPACE;addPoint;$LNni$;18| (|space| |path| |which| $)
  (PROG (|node| #1=#:G240 |more| |depth| #2=#:G239 |i|)
    (RETURN
...
(DEFUN |SUBSPACE;modifyPoint;$LP$;20| (|space| |path| |point| $)
  (PROG (|node| #1=#:G257 |i| |which| |lastPt|)
    (RETURN
     (SEQ
      (COND
       ((NULL
...
(DEFUN |SUBSPACE;=;2$B;33| (|s1| |s2| $)
  (PROG (#1=#:G297 #2=#:G296 #3=#:G298 #4=#:G303 |c1| #5=#:G304 |c2|)
    (RETURN
     (SEQ
      (COND
...
(MAKEPROP '|SubSpace| '|infovec|
          (LIST
           ...
           '#(~= 155 |traverse| 161 |subspace| 167 |shallowCopy| 171 |separate|
              ...
              242 |latex| 247 |internal?| 252 |hash| 257 |extractProperty| 262
              |extractPoint| 267 |extractIndex| 272 |extractClosed| 277
              |defineProperty| 282 |deepCopy| 289 |coerce| 294 |closeComponent|
              299 |children| 306 |child| 311 |birth| 317 |addPointLast| 322
              |addPoint2| 330 |addPoint| 336 = 356)
           'NIL
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 86
                                            '(1 13 12 0 14 1 19 0 18 20 0 21 0
                                              ...
                                              52 34 60 3 0 0 0 52 19 59 1 0 0
                                              10 49 2 0 0 0 0 47 1 0 34 0 74 1
                                              0 12 0 15 1 0 28 0 1 1 0 12 0 17
                                              1 0 86 0 1 1 0 21 0 72 1 0 19 0
                                              68 1 0 34 0 69 1 0 12 0 71 3 0 0
                                              0 52 21 65 1 0 0 0 42 1 0 27 0 85
                                              3 0 0 0 52 12 64 1 0 10 0 11 2 0
                                              0 0 34 35 1 0 0 0 31 4 0 0 0 0 19
                                              34 55 2 0 0 0 19 54 2 0 34 0 19
                                              58 3 0 0 0 52 34 57 3 0 0 0 52 19
                                              53 2 0 12 0 0 79)))))
           '|lookupComplete|)) 
