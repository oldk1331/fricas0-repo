...
(SDEFUN |NUMQUAD;romberg;M4F2IR;4|
        ...
        (SPROG
         ((|qx1| (F)) (|pts| (|Integer|)) (|delta| (F)) (|oldsum| (F))
          (#1=#:G175 NIL) (|change| (F)) (|four| (|PositiveInteger|))
          (|i| (|Integer|)) (#2=#:G177 NIL) (|j| NIL) (|newest| (F))
          (|newsum| (F)) (#3=#:G176 NIL) (|n| NIL) (|table| (|Vector| F))
          (#4=#:G159 NIL) (|length| (F)))
         (SEQ
          (EXIT
        ...
        ((|func| (|Mapping| F F)) (|a| (F)) (|b| (F)) (|epsrel| (F))
         ...
         ($
          (|Record| (|:| |value| F) (|:| |error| F)
                    (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|)))))
        (SPROG
         ((|pts| (|Integer|)) (|delta| (F)) (|oldsum| (F)) (#1=#:G191 NIL)
          (|change| (F)) (|newest| (F)) (|newsum| (F)) (#2=#:G192 NIL)
...
(SDEFUN |NUMQUAD;rombergo;M4F2IR;7|
        ...
        (SPROG
         ((|qx1| (F)) (|pts| (|Integer|)) (|delta| (F)) (|oldsum| (F))
          (#1=#:G220 NIL) (|change| (F)) (|nine| (|PositiveInteger|))
          (|i| (|Integer|)) (#2=#:G222 NIL) (|j| NIL) (|newest| (F))
          (|newsum| (F)) (#3=#:G221 NIL) (|n| NIL) (|table| (|Vector| F))
          (#4=#:G209 NIL) (|length| (F)))
         (SEQ
          (EXIT
           (SEQ (LETT |length| (SPADCALL |b| |a| (QREFELT $ 8)))
