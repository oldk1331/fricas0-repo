        ...
        (SPROG
         ((#2=#:G127 NIL) (|x2| (|Float|)) (|x1| #1#) (|done| (|Boolean|))
          ...
          (|ans|
           (|Record| (|:| |value| (|Float|)) (|:| |error| (|Float|))
                     (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
          (#4=#:G128 NIL) (|i| NIL) (|io| (|List| (|OutputForm|)))
          (|hh| (|Float|)))
         (SEQ
          (EXIT
           (SEQ
            ...
            (SEQ (LETT |i| 1 . #5#) (LETT #4# |nint| . #5#) G190
                 ...
                 (SEQ
                  ...
                  (LETT |err|
                        (SPADCALL |err|
                                  (SPADCALL (QVELT |ans| 1) (QREFELT $ 28))
                                  (QREFELT $ 13))
                        . #5#)
...
(SDEFUN |NUMQUAD;asimpson;M4F3IR;2|
        ((|func| |Mapping| (|Float|) (|Float|)) (|a| . #1=(|Float|))
         ...
         ($ |Record| (|:| |value| (|Float|)) (|:| |error| (|Float|))
          (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
        (SPROG
         ((#2=#:G137 NIL) (|x2| (|Float|)) (|x1| #1#) (|done| (|Boolean|))
          (|pts| (|Integer|)) (|err| #3=(|Float|)) (|sum| #3#)
          (|ans|
           (|Record| (|:| |value| (|Float|)) (|:| |error| (|Float|))
                     (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
          (#4=#:G138 NIL) (|i| NIL) (|io| (|List| (|OutputForm|)))
          (|hh| (|Float|)))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |NUMQUAD;atrapezoidal;M4F3IR;3|
        ((|func| |Mapping| (|Float|) (|Float|)) (|a| . #1=(|Float|))
         ...
         ($ |Record| (|:| |value| (|Float|)) (|:| |error| (|Float|))
          (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
        (SPROG
         ((#2=#:G147 NIL) (|x2| (|Float|)) (|x1| #1#) (|done| (|Boolean|))
          (|pts| (|Integer|)) (|err| #3=(|Float|)) (|sum| #3#)
          (|ans|
           (|Record| (|:| |value| (|Float|)) (|:| |error| (|Float|))
                     (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
          (#4=#:G148 NIL) (|i| NIL) (|io| (|List| (|OutputForm|)))
          (|hh| (|Float|)))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |NUMQUAD;romberg;M4F2IR;4|
        ((|func| |Mapping| (|Float|) (|Float|)) (|a| |Float|) (|b| |Float|)
         ...
         ($ |Record| (|:| |value| (|Float|)) (|:| |error| (|Float|))
          (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
        (SPROG
         ((#1=#:G167 NIL) (|qx1| #2=(|Float|)) (|pts| (|Integer|))
          (|delta| #3=(|Float|)) (|oldest| #4=(|Float|)) (|oldsum| #4#)
          (|change| #4#) (|four| (|Integer|)) (|i| (|Integer|)) (#5=#:G169 NIL)
          (|j| NIL) (|newest| #4#) (|newsum| #2#) (#6=#:G168 NIL)
          (|n| (|Integer|)) (|table| (|Vector| (|Float|))) (#7=#:G150 NIL)
          (|length| #3#))
         (SEQ
          (EXIT
           (SEQ
             ...
             ((< |nmin| 2)
              (SEQ
               (SPADCALL "romberg: nmin to small (nmin > 1) nmin = "
                         (SPADCALL |nmin| (QREFELT $ 35)) (QREFELT $ 37))
               (EXIT
                (PROGN
                 (LETT #1#
             ...
             ((< |nmax| |nmin|)
              (SEQ
               (SPADCALL "romberg: nmax < nmin : nmax = "
                         (SPADCALL |nmax| (QREFELT $ 35)) (QREFELT $ 37))
               (SPADCALL "                       nmin = "
                         (SPADCALL |nmin| (QREFELT $ 35)) (QREFELT $ 37))
               (EXIT
                (PROGN
                 ...
                 (GO #9#))))))
            (COND
             ((SPADCALL |a| |b| (QREFELT $ 39))
              (SEQ
               (SPADCALL "romberg: integration limits are equal  = "
                         (SPADCALL |a| (QREFELT $ 15)) (QREFELT $ 37))
               (EXIT
                (PROGN
                 (LETT #1#
                       (VECTOR (SPADCALL 0 0 10 (QREFELT $ 10))
             ...
             ((SPADCALL |epsrel| (SPADCALL 0 0 10 (QREFELT $ 10))
              ...
              (SEQ
               (SPADCALL "romberg: eps_r < 0.0            eps_r  = "
                         (SPADCALL |epsrel| (QREFELT $ 15)) (QREFELT $ 37))
               (EXIT
                (PROGN
                 (LETT #1#
                       (VECTOR (SPADCALL 0 0 10 (QREFELT $ 10))
             ...
             ((SPADCALL |epsabs| (SPADCALL 0 0 10 (QREFELT $ 10))
              ...
              (SEQ
               (SPADCALL "romberg: eps_a < 0.0            eps_a  = "
                         (SPADCALL |epsabs| (QREFELT $ 15)) (QREFELT $ 37))
               (EXIT
                (PROGN
                 (LETT #1#
                       (VECTOR (SPADCALL 0 0 10 (QREFELT $ 10))
                 ...
                 (SEQ (LETT |oldsum| |newsum| . #8#)
                            ...
                            (SPADCALL
                             (SPADCALL
                              (SPADCALL (SPADCALL 4 0 10 (QREFELT $ 10))
                                        |newsum| (QREFELT $ 34))
                              |oldsum| (QREFELT $ 11))
                             (SPADCALL 3 0 10 (QREFELT $ 10)) (QREFELT $ 41))
                            . #8#)
                      (LETT |four| 4 . #8#)
                      (SPADCALL |table| |n| |newest| (QREFELT $ 43))
                      (SEQ (LETT |j| 2 . #8#) (LETT #5# |n| . #8#) G190
                           (COND ((|greater_SI| |j| #5#) (GO G191)))
                           (SEQ (LETT |i| (- (+ |n| 1) |j|) . #8#)
                                (LETT |four| (SPADCALL |four| 4 (QREFELT $ 45))
                                      . #8#)
                                (EXIT
                                 (SPADCALL |table| |i|
                                           (SPADCALL
                           ...
                           (EXIT NIL))
                      (COND
                       ((SPADCALL |n| |nmin| (QREFELT $ 47))
                        (SEQ
                         (LETT |change|
                               (SPADCALL
                                (SPADCALL (SPADCALL |table| 1 (QREFELT $ 46))
                                          |qx1| (QREFELT $ 11))
                                (QREFELT $ 28))
                               . #8#)
                         (COND
                          ((SPADCALL |change|
                                     (SPADCALL
                                      (SPADCALL |epsrel| |qx1| (QREFELT $ 34))
                                      (QREFELT $ 28))
                                     (QREFELT $ 40))
                           (PROGN
                            (LETT #1#
                                  (VECTOR (SPADCALL |table| 1 (QREFELT $ 46))
                                          |change|
                                          (+ (SPADCALL 2 |pts| (QREFELT $ 48))
                                             1)
                                          'T)
                                  . #8#)
                            (GO #9#))))
                         (EXIT
                          (COND
                           ((SPADCALL |change| |epsabs| (QREFELT $ 40))
                            (PROGN
                             (LETT #1#
                                   (VECTOR (SPADCALL |table| 1 (QREFELT $ 46))
                                           |change|
                      ...
                      (LETT |delta|
                            (SPADCALL (SPADCALL 5 -1 10 (QREFELT $ 10)) |delta|
                                      (QREFELT $ 34))
                            . #8#)
                      (LETT |pts| (SPADCALL 2 |pts| (QREFELT $ 48)) . #8#)
                      (EXIT
                       (LETT |qx1| (SPADCALL |table| 1 (QREFELT $ 46)) . #8#)))
...
(SDEFUN |NUMQUAD;simpson;M4F2IR;5|
        ((|func| |Mapping| (|Float|) (|Float|)) (|a| |Float|) (|b| |Float|)
         ...
         ($ |Record| (|:| |value| (|Float|)) (|:| |error| (|Float|))
          (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
        (SPROG
         ((#1=#:G185 NIL) (|pts| (|Integer|)) (|delta| #2=(|Float|))
          (|oldest| #3=(|Float|)) (|oldsum| #3#) (|change| #3#) (|newest| #3#)
          (|newsum| (|Float|)) (#4=#:G186 NIL) (|n| (|Integer|))
          (|length| #2#))
         (SEQ
          (EXIT
           (SEQ
            ...
            (LETT |newsum|
                  (SPADCALL
                   (SPADCALL (SPADCALL 5 -1 10 (QREFELT $ 10))
                             (SPADCALL |b| |a| (QREFELT $ 11)) (QREFELT $ 34))
                   (SPADCALL (SPADCALL |a| |func|) (SPADCALL |b| |func|)
                             (QREFELT $ 13))
                   (QREFELT $ 34))
                  . #5#)
            ...
            (SEQ (LETT |n| 1 . #5#) (LETT #4# |nmax| . #5#) G190
                 ...
                 (SEQ (LETT |oldsum| |newsum| . #5#)
                      ...
                      (LETT |delta|
                            ...
                            . #5#)
                      (EXIT
                       (LETT |pts| (SPADCALL 2 |pts| (QREFELT $ 48)) . #5#)))
...
(SDEFUN |NUMQUAD;trapezoidal;M4F2IR;6|
        ((|func| |Mapping| (|Float|) (|Float|)) (|a| |Float|) (|b| |Float|)
         ...
         ($ |Record| (|:| |value| (|Float|)) (|:| |error| (|Float|))
          (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
        (SPROG
         ((#1=#:G202 NIL) (|pts| (|Integer|)) (|delta| #2=(|Float|))
          (|change| (|Float|)) (|newsum| #3=(|Float|)) (|oldsum| #3#)
          (#4=#:G203 NIL) (|n| (|Integer|)) (|length| #2#))
         (SEQ
          (EXIT
           (SEQ
            (LETT |length| (SPADCALL |b| |a| (QREFELT $ 11))
...
(SDEFUN |NUMQUAD;rombergo;M4F2IR;7|
        ((|func| |Mapping| (|Float|) (|Float|)) (|a| |Float|) (|b| |Float|)
         ...
         ($ |Record| (|:| |value| (|Float|)) (|:| |error| (|Float|))
          (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
        (SPROG
         ((#1=#:G215 NIL) (|qx1| #2=(|Float|)) (|pts| (|Integer|))
          (|delta| (|Float|)) (|oldest| #3=(|Float|)) (|oldsum| #3#)
          (|change| #3#) (|nine| (|PositiveInteger|)) (|i| (|Integer|))
          (#4=#:G217 NIL) (|j| NIL) (|newest| #3#) (|newsum| #2#)
          (#5=#:G216 NIL) (|n| (|Integer|)) (|table| (|Vector| (|Float|)))
          (#6=#:G205 NIL) (|length| (|Float|)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |length| (SPADCALL |b| |a| (QREFELT $ 11))
                 ...
                 (SEQ (LETT |oldsum| |newsum| . #7#)
                            ...
                            (SPADCALL
                             (SPADCALL
                              (SPADCALL (SPADCALL 9 0 10 (QREFELT $ 10))
                                        |newsum| (QREFELT $ 34))
                              |oldsum| (QREFELT $ 11))
                             (SPADCALL 8 0 10 (QREFELT $ 10)) (QREFELT $ 41))
                            . #7#)
                      (SPADCALL |table| |n| |newest| (QREFELT $ 43))
                      (LETT |nine| 9 . #7#)
                      ...
                      (LETT |delta|
                            (SPADCALL |delta| (SPADCALL 3 0 10 (QREFELT $ 10))
                                      (QREFELT $ 41))
                            . #7#)
                      (LETT |pts| (SPADCALL 3 |pts| (QREFELT $ 48)) . #7#)
                      (EXIT
                       (LETT |qx1| (SPADCALL |table| 1 (QREFELT $ 46)) . #7#)))
...
(SDEFUN |NUMQUAD;simpsono;M4F2IR;8|
        ...
        (SPROG
         ((#1=#:G226 NIL) (|pts| (|Integer|)) (|delta| (|Float|))
          ...
          (|newsum| (|Float|)) (#3=#:G227 NIL) (|n| (|Integer|))
          (|length| (|Float|)))
         (SEQ
          (EXIT
           (SEQ
            ...
            (SEQ (LETT |n| 1 . #4#) (LETT #3# |nmax| . #4#) G190
                 ...
                 (SEQ (LETT |oldsum| |newsum| . #4#)
                      ...
                      (LETT |delta|
                            ...
                            . #4#)
                      (EXIT
                       (LETT |pts| (SPADCALL 3 |pts| (QREFELT $ 48)) . #4#)))
...
(SDEFUN |NUMQUAD;trapezoidalo;M4F2IR;9|
        ((|func| |Mapping| (|Float|) (|Float|)) (|a| |Float|) (|b| |Float|)
         ...
         ($ |Record| (|:| |value| (|Float|)) (|:| |error| (|Float|))
          (|:| |totalpts| (|Integer|)) (|:| |success| (|Boolean|))))
        (SPROG
         ((#1=#:G236 NIL) (|pts| (|Integer|)) (|delta| (|Float|))
          (|change| (|Float|)) (|newsum| #2=(|Float|)) (|oldsum| #2#)
          (#3=#:G237 NIL) (|n| NIL) (|length| (|Float|)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |length| (SPADCALL |b| |a| (QREFELT $ 11))
...
(SDEFUN |NUMQUAD;trapclosed|
        ...
        (SPROG
         ((#1=#:G242 NIL) (|x| (|Float|)) (|sum| (|Float|)) (#2=#:G243 NIL)
          (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |NUMQUAD;trapopen|
        ((|func| |Mapping| (|Float|) (|Float|)) (|start| |Float|)
         ...
         ($ |Float|))
        (SPROG
         ((#1=#:G248 NIL) (|x| (|Float|)) (|sum| (|Float|)) (#2=#:G249 NIL)
          (|i| NIL) (|ddel| (|Float|)))
         (SEQ
          (EXIT
           (SEQ
              ...
              (LETT #1#
                    (SPADCALL
                     (SPADCALL |oldsum| (SPADCALL 3 0 10 (QREFELT $ 10))
                               (QREFELT $ 41))
                     (SPADCALL |sum| |del| (QREFELT $ 34)) (QREFELT $ 13))
                    . #3#)
              (GO #4=#:G247)))))
          #4# (EXIT #1#)))) 
...
(MAKEPROP '|NumericalQuadrature| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|Float|) (0 . |Zero|) (|Integer|)
              ...
              (|List| 14) (38 . |setelt!|) (|String|) (45 . |message|)
              (|List| $) (50 . |blankSeparate|) (|Void|) (55 . |print|)
              (60 . |abs|) |NUMQUAD;aromberg;M4F3IR;1|
              |NUMQUAD;simpson;M4F2IR;5| |NUMQUAD;asimpson;M4F3IR;2|
              |NUMQUAD;trapezoidal;M4F2IR;6| |NUMQUAD;atrapezoidal;M4F3IR;3|
              (65 . *) (71 . |coerce|) (|OutputPackage|) (76 . |output|)
              (|Boolean|) (82 . =) (88 . <) (94 . /) (|Vector| 6)
              (100 . |setelt!|) (|SingleInteger|) (107 . *) (113 . |elt|)
              (119 . >) (125 . *) (131 . |output|) (136 . |coerce|)
              |NUMQUAD;rombergo;M4F2IR;7| |NUMQUAD;simpsono;M4F2IR;8|
              |NUMQUAD;trapezoidalo;M4F2IR;9|)
           '#(|trapezoidalo| 141 |trapezoidal| 152 |simpsono| 163 |simpson| 174
              |rombergo| 185 |romberg| 196 |atrapezoidal| 207 |asimpson| 219
              |aromberg| 231)
           'NIL
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 53
                                                 '(0 6 0 7 3 6 0 8 8 9 10 2 6 0
                                                   ...
                                                   1 14 0 24 25 1 14 26 0 27 1
                                                   6 0 0 28 2 6 0 0 0 34 1 8 14
                                                   0 35 2 36 26 22 14 37 2 6 38
                                                   0 0 39 2 6 38 0 0 40 2 6 0 0
                                                   0 41 3 42 6 0 8 6 43 2 44 0
                                                   8 0 45 2 42 6 0 8 46 2 8 38
                                                   0 0 47 2 8 0 9 0 48 1 36 26
                                                   14 49 1 42 14 0 50 7 0 16 17
                                                   6 6 6 6 8 8 53 7 0 16 17 6 6
                                                   6 6 8 8 32 7 0 16 17 6 6 6 6
                                                   8 8 52 7 0 16 17 6 6 6 6 8 8
                                                   30 7 0 16 17 6 6 6 6 8 8 51
                                                   7 0 16 17 6 6 6 6 8 8 18 8 0
                                                   16 17 6 6 6 6 8 8 8 33 8 0
                                                   16 17 6 6 6 6 8 8 8 31 8 0
                                                   16 17 6 6 6 6 8 8 8 29)))))
           '|lookupComplete|)) 
