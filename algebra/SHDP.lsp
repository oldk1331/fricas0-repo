...
(SDEFUN |SHDP;lessThanRlex|
        ...
        (SPROG
         ((#1=#:G15 NIL) (|n1| (S)) (|n2| (S)) (|i| NIL) (#2=#:G16 NIL)
          (#3=#:G14 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |n1| (|spadConstant| % 10))
                (LETT |n2| (|spadConstant| % 10))
                (SEQ (LETT |i| |low|) (LETT #1# |high|) G190
                     (COND ((> |i| #1#) (GO G191)))
                     (SEQ
                      (LETT |n1|
...
(SDEFUN |SHDP;<;2%B;2| ((|v1| (%)) (|v2| (%)) (% (|Boolean|)))
        (SPROG ((|i| NIL) (#1=#:G24 NIL) (#2=#:G23 NIL))
               (SEQ
                (EXIT
...
(DEFUN |SplitHomogeneousDirectProduct;| (|#1| |#2| |#3|)
  (SPROG
   ((DV$1 NIL) (DV$2 NIL) (DV$3 NIL) (|dv$| NIL) (% NIL) (#1=#:G51 NIL)
    (#2=#:G50 NIL) (#3=#:G49 NIL) (#4=#:G47 NIL) (#5=#:G48 NIL) (#6=#:G46 NIL)
    (#7=#:G45 NIL) (#8=#:G44 NIL) (#9=#:G43 NIL) (#10=#:G42 NIL) (|pv$| NIL))
   (PROGN
    (LETT DV$1 |#1|)
    (LETT DV$2 |#2|)
...
(MAKEPROP '|SplitHomogeneousDirectProduct| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|DirectProduct| (NRTEVAL (QREFELT % 6)) 8)
              (|local| |#1|) (|local| |#2|) (|local| |#3|) '|Rep| (0 . |0|)
           ...
           '#(~= 28 |zero?| 34 |unitVector| 39 |swap!| 44 |sup| 51
              ...
              545 |any?| 552 |antiCommutator| 558 |annihilate?| 564 ^ 570 D 582
              >= 632 > 638 = 644 <= 650 < 656 |1| 662 |0| 666 - 670 + 681 * 687
              |#| 729)
           'NIL
           (CONS
            (|makeByteWordVec2| 50
             ...
             (CONS
              ...
              (|makeByteWordVec2| 58
                                  '(0 8 0 10 2 0 8 0 11 12 2 8 0 0 0 13 2 8 14
                                    ...
                                    0 0 1 2 10 0 0 18 1 2 38 0 0 23 1 1 24 0 0
                                    1 2 24 0 0 18 1 2 25 0 0 30 1 2 25 0 0 31 1
                                    3 25 0 0 30 32 1 3 25 0 0 31 18 1 2 9 0 0
                                    19 1 3 9 0 0 19 18 1 2 3 14 0 0 1 2 3 14 0
                                    0 1 2 58 14 0 0 1 2 3 14 0 0 1 2 3 14 0 0
                                    17 0 10 0 1 0 55 0 1 2 57 0 0 0 1 1 57 0 0
                                    1 2 43 0 0 0 1 2 27 0 0 11 1 2 57 0 11 0 1
                                    2 55 0 18 0 1 2 43 0 23 0 1 2 38 0 8 0 1 2
                                    38 0 0 8 1 2 38 0 0 0 1 1 51 18 0 1)))))
           '|lookupComplete|)) 
