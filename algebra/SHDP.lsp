...
(SDEFUN |SHDP;lessThanRlex|
        ...
        (SPROG
         ((#1=#:G131 NIL) (#2=#:G133 NIL) (|i| NIL) (|n2| (S)) (|n1| (S))
          (#3=#:G132 NIL))
         (SEQ
          (EXIT
...
(DEFUN |SplitHomogeneousDirectProduct| (&REST #1=#:G166)
  (SPROG NIL
         (PROG (#2=#:G167)
           (RETURN
            (COND
...
(DEFUN |SplitHomogeneousDirectProduct;| (|#1| |#2| |#3|)
  (SPROG
   ((|pv$| NIL) (#1=#:G158 NIL) (#2=#:G159 NIL) (#3=#:G160 NIL) (#4=#:G161 NIL)
