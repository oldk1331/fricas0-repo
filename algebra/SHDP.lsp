...
(SDEFUN |SHDP;lessThanRlex|
        ...
        (SPROG
         ((#1=#:G133 NIL) (#2=#:G135 NIL) (|i| NIL) (|n2| (S)) (|n1| (S))
          (#3=#:G134 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |SHDP;<;2$B;2| ((|v1| ($)) (|v2| ($)) ($ (|Boolean|)))
        (SPROG ((#1=#:G142 NIL) (#2=#:G143 NIL) (|i| NIL))
               (SEQ
                (EXIT
...
(DEFUN |SplitHomogeneousDirectProduct| (&REST #1=#:G171)
  (SPROG NIL
         (PROG (#2=#:G172)
           (RETURN
            (COND
...
(DEFUN |SplitHomogeneousDirectProduct;| (|#1| |#2| |#3|)
  (SPROG
   ((|pv$| NIL) (#1=#:G161 NIL) (#2=#:G162 NIL) (#3=#:G163 NIL) (#4=#:G164 NIL)
    (#5=#:G165 NIL) (#6=#:G167 NIL) (#7=#:G166 NIL) (#8=#:G168 NIL)
    (#9=#:G169 NIL) (#10=#:G170 NIL) ($ NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL)
    (DV$1 NIL))
   (PROGN
    (LETT DV$1 |#1|)
    (LETT DV$2 |#2|)
