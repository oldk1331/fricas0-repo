...
(SDEFUN |SCACHE;expandCache| ((|x| (S)) (% (|Void|)))
        (SPROG ((|ocache| (|PrimitiveArray| S)) (|k| NIL) (#1=#:G17 NIL))
               (SEQ
                (COND
...
(SDEFUN |SCACHE;insertBefore|
        ...
        (SPROG ((|vscan| (|PrimitiveArray| S)) (|k| NIL) (#1=#:G22 NIL))
...
(SDEFUN |SCACHE;shiftCache|
        ((|l| (|NonNegativeInteger|)) (|n| (|NonNegativeInteger|))
         (% (|Void|)))
        (SPROG
         ((|vscan| (|PrimitiveArray| S)) (|k| NIL) (#1=#:G28 NIL) (|x| (S)))
...
(SDEFUN |SCACHE;clearCache;V;4| ((% (|Void|)))
        (SPROG
         ((|vscan| (|PrimitiveArray| S)) (|k| NIL) (#1=#:G34 NIL) (|x| (S)))
         (SEQ (LETT |vscan| (QREFELT % 7))
              (SEQ (LETT |k| 0) (LETT #1# (- (QREFELT % 9) 1)) G190
                   (COND ((|greater_SI| |k| #1#) (GO G191)))
                   (SEQ (LETT |x| (QAREF1 |vscan| |k|))
...
(SDEFUN |SCACHE;linearSearch;MU;6|
        ...
        (SPROG
         ((|y| (S)) (|vscan| (|PrimitiveArray| S)) (|k| (|Integer|))
          (#1=#:G53 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |k| 0)
...
(SDEFUN |SCACHE;binarySearch;SMU;8|
        ((|x| (S)) (|triage| (|Mapping| (|Integer|) S S))
         (% (|Union| S "failed")))
        (SPROG
         ((|m0| #1=(|Integer|)) (|vl| (S)) (|vm| (S)) (|has_vm| (|Boolean|))
          (|y| (S)) (|cp| (|Integer|)) (#2=#:G88 NIL)
          (|vscan| (|PrimitiveArray| S)) (|l0| #3=(|Integer|))
          (|i0| #4=(|Integer|)) (|i| #4#) (|m| #1#) (|l| #3#))
         (SEQ
          (EXIT
...
(SDEFUN |SCACHE;enterInCache;SMS;9|
        ...
        (SPROG
         ((|m0| #1=(|Integer|)) (|vl| (S)) (|vm| (S)) (|has_vm| (|Boolean|))
          (|y| (S)) (|cp| (|Integer|)) (|vscan| (|PrimitiveArray| S))
          (|l0| #2=(|Integer|)) (|i0| #3=(|Integer|)) (|i| #3#) (|m| #1#)
          (|l| #2#) (#4=#:G116 NIL) (|pos| (|NonNegativeInteger|))
          (#5=#:G111 NIL))
         (SEQ
          (EXIT
           (COND
