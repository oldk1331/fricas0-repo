...
(SDEFUN |SCACHE;expandCache| ((|x| (S)) (% (|Void|)))
        (SPROG ((#1=#:G121 NIL) (|k| NIL) (|ocache| (|PrimitiveArray| S)))
               (SEQ
                (COND
...
(SDEFUN |SCACHE;insertBefore|
        ...
        (SPROG ((#1=#:G126 NIL) (|k| NIL) (|vscan| (|PrimitiveArray| S)))
...
(SDEFUN |SCACHE;clearCache;V;4| ((% (|Void|)))
        (SPROG
         ((|x| (S)) (#1=#:G138 NIL) (|k| NIL) (|vscan| (|PrimitiveArray| S)))
         (SEQ (LETT |vscan| (QREFELT % 7))
              (SEQ (LETT |k| 0) (LETT #1# (- (QREFELT % 9) 1)) G190
                   (COND ((|greater_SI| |k| #1#) (GO G191)))
                   (SEQ (LETT |x| (QAREF1 |vscan| |k|))
...
(SDEFUN |SCACHE;linearSearch;SMU;6|
        ((|x| (S)) (|equal?| (|Mapping| (|Boolean|) S))
         (% (|Union| S "failed")))
        (SPROG
         ((#1=#:G157 NIL) (|k| (|Integer|)) (|vscan| (|PrimitiveArray| S))
          (|y| (S)))
         (SEQ
          (EXIT
           (SEQ (LETT |k| 0)
                (SEQ G190 (COND ((NULL (< |k| (QREFELT % 9))) (GO G191)))
                     (SEQ (LETT |vscan| (QREFELT % 7))
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |y| |equal?|)
                             (PROGN (LETT #1# (CONS 0 |y|)) (GO #2=#:G156)))
                            ('T
                             (SEQ (LETT |vscan| (QREFELT % 7))
                                  (SEQ G190
                                       (COND
...
(SDEFUN |SCACHE;binarySearch;SMU;8|
        ...
        (SPROG
         ((|l| #1=(|Integer|)) (|m| #2=(|Integer|)) (|i| #3=(|Integer|))
          (|i0| #3#) (|l0| #1#) (|vscan| (|PrimitiveArray| S)) (#4=#:G192 NIL)
...
(SDEFUN |SCACHE;enterInCache;SMS;9|
        ...
        (SPROG
         ((#1=#:G215 NIL) (|pos| (|NonNegativeInteger|)) (#2=#:G220 NIL)
