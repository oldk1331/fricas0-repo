...
(SDEFUN |SCACHE;expandCache| ((|x| S) ($ |Void|))
        (SPROG ((#1=#:G134 NIL) (|k| NIL) (|ocache| (|PrimitiveArray| S)))
               (SEQ
                (COND
...
(SDEFUN |SCACHE;insertBefore| ((|l| |NonNegativeInteger|) (|x| S) ($ |Void|))
        (SPROG ((#1=#:G138 NIL) (|k| NIL) (|vscan| (|PrimitiveArray| S)))
...
(SDEFUN |SCACHE;shiftCache|
        ...
        (SPROG
         ((|x| (S)) (#1=#:G143 NIL) (|k| NIL) (|vscan| (|PrimitiveArray| S)))
...
(SDEFUN |SCACHE;clearCache;V;4| (($ |Void|))
        (SPROG
         ((|x| (S)) (#1=#:G148 NIL) (|k| NIL) (|vscan| (|PrimitiveArray| S)))
         (SEQ (LETT |vscan| (QREFELT $ 7))
              (SEQ (LETT |k| 0) (LETT #1# (- (QREFELT $ 9) 1)) G190
                   (COND ((|greater_SI| |k| #1#) (GO G191)))
                   (SEQ (LETT |x| (QAREF1 |vscan| |k|))
...
(SDEFUN |SCACHE;linearSearch;SMU;6|
        ...
        (SPROG
         ((#1=#:G165 NIL) (|k| (|Integer|)) (|vscan| (|PrimitiveArray| S))
          (|y| (S)))
         (SEQ
          (EXIT
           (SEQ (LETT |k| 0)
                (SEQ G190 (COND ((NULL (< |k| (QREFELT $ 9))) (GO G191)))
                     (SEQ (LETT |vscan| (QREFELT $ 7))
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |y| |equal?|)
                             (PROGN (LETT #1# (CONS 0 |y|)) (GO #2=#:G164)))
                            ('T
                             (SEQ (LETT |vscan| (QREFELT $ 7))
                                  (SEQ G190
                                       (COND
...
(SDEFUN |SCACHE;enterInCache;SMS;8|
        ...
        (SPROG
         ((#1=#:G190 NIL) (|pos| (|NonNegativeInteger|)) (#2=#:G196 NIL)
