...
(DEFUN |DifferentialSparseMultivariatePolynomial| (&REST #1=#:G167)
  (SPROG NIL
         (PROG (#2=#:G168)
           (RETURN
            (COND
...
(DEFUN |DifferentialSparseMultivariatePolynomial;| (|#1| |#2| |#3|)
  (SPROG
   ((#1=#:G166 NIL) (|pv$| NIL) (#2=#:G159 NIL) (#3=#:G160 NIL) (#4=#:G161 NIL)
    (#5=#:G162 NIL) (#6=#:G163 NIL) (#7=#:G164 NIL) (#8=#:G165 NIL) ($ NIL)
...
(MAKEPROP '|DifferentialSparseMultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|SparseMultivariatePolynomial| 6 8)
              ...
              (|Mapping| 44 44) (|Union| 6 '#2#) (|List| 44)
            ...
            (CONS
             ...
             (CONS
              '#((|DifferentialPolynomialCategory| 6 7 8
                 ...
                 (|RightModule| 36) (|AbelianGroup|) (|Monoid|)
                 ...
                 (|RetractableTo| 43) (|RetractableTo| 36) (|CommutativeStar|)
                 ...
                 (|CoercibleTo| 82) (|CoercibleFrom| 43) (|CoercibleFrom| 36)
              ...
              (|makeByteWordVec2| 28
                                  '(1 0 9 0 10 1 8 7 0 11 1 12 0 7 13 1 12 0 6
                                    ...
                                    0 9 0 10 1 17 0 8 22 1 0 0 12 28 1 0 0 6
                                    23)))))
           '|lookupIncomplete|)) 
