            ...
            (CONS
             ...
             (CONS
              '#((|DifferentialPolynomialCategory| 6 7 8
                 ...
                 (|CoercibleTo| 78) (|CommutativeStar|) (|noZeroDivisors|)
                 (|ConvertibleTo| 32) (|ConvertibleTo| 33) (|ConvertibleTo| 31)
                 (|RetractableTo| 37) (|RetractableTo| 58)
