...
(SDEFUN |PADE;pade;2Nni2PSU;5|
        ...
        (SPROG
         ((|approx| (|Fraction| UP)) (#1=#:G141 NIL) (|d| NIL) (#2=#:G142 NIL)
...
(SDEFUN |PADE;padecf;2Nni2PSU;6|
        ...
        (SPROG
         ((|blist| (|List| UP)) (#1=#:G155 NIL) (|d| NIL) (#2=#:G154 NIL)
          (|alist| (|List| UP))
          (|ad|
           (|Union|
            (|Record| (|:| |ais| (|List| UP))
        ...
        ((|l| #1=(|NonNegativeInteger|)) (|m| #2=(|NonNegativeInteger|))
         ...
         ($
          (|Union|
           ...
           "failed")))
        (SPROG
         ((|#G44| (|NonNegativeInteger|)) (#3=#:G178 NIL) (|#G43| #2#)
          (|d| (UP)) (|g| (UP)) (|degbd| (|NonNegativeInteger|))
          (#4=#:G177 NIL) (|h| (UP)) (#5=#:G173 NIL)
          (|alist| (|List| (|NonNegativeInteger|))) (#6=#:G185 NIL)
          (|alpha| (|NonNegativeInteger|)) (|plist| (|List| UP)) (|s| (UP))
          (|p| (UP)) (#7=#:G171 NIL) (|pk| (R)) (#8=#:G186 NIL) (|k| NIL)
          (#9=#:G169 NIL) (|d0| (R)) (|j| NIL) (|#G40| (PS)) (|#G39| (PS))
          (|#G38| (|NonNegativeInteger|)) (#10=#:G165 NIL) (|#G37| #2#)
            ...
            (COND
             ((< |l| |m|)
              (SEQ (LETT |alpha| (SPADCALL |gps| (QREFELT $ 34)))
                   (COND
                    ((> |alpha| |l|)
                     (PROGN (LETT #6# (CONS 1 "failed")) (GO #11=#:G184))))
...
(DEFUN |PadeApproximants| (&REST #1=#:G187)
  (SPROG NIL
         (PROG (#2=#:G188)
           (RETURN
            (COND
