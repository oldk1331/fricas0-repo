...
(SDEFUN |URAGG-;cycleEntry;2A;19| ((|x| A) ($ A))
        (SPROG ((|y| (A)) (#1=#:G229 NIL) (|k| NIL) (|z| (A)) (|l| NIL))
               (SEQ
...
(SDEFUN |URAGG-;last;ANniA;22| ((|x| A) (|n| |NonNegativeInteger|) ($ A))
        (SPROG ((#1=#:G241 NIL) (|m| (|NonNegativeInteger|)))
               (SEQ
