...
(SDEFUN |URAGG-;first;ANniA;8| ((|x| (A)) (|n| (|NonNegativeInteger|)) ($ (A)))
        (SPROG ((|l| (|List| S)) (|res| (A)) (#1=#:G198 NIL) (|i| NIL))
               (SEQ (LETT |l| NIL)
...
(SDEFUN |URAGG-;cycleEntry;2A;20| ((|x| (A)) ($ (A)))
        (SPROG ((|y| (A)) (#1=#:G261 NIL) (|k| NIL) (|z| (A)) (|l| NIL))
               (SEQ
...
(SDEFUN |URAGG-;concat!;LA;31| ((|lu| (|List| A)) ($ (A)))
        (SPROG ((|t| (A)) (#1=#:G317 NIL) (|u| NIL) (|res| (A)))
               (SEQ
                (SEQ G190
                     (COND
                      ((NULL
