...
(SDEFUN |URAGG-;first;ANniA;8| ((|x| A) (|n| |NonNegativeInteger|) ($ A))
        (SPROG ((|l| (|List| S)) (|res| (A)) (#1=#:G183 NIL) (|i| NIL))
               (SEQ (LETT |l| NIL)
...
(SDEFUN |URAGG-;cycleEntry;2A;20| ((|x| A) ($ A))
        (SPROG ((|y| (A)) (#1=#:G246 NIL) (|k| NIL) (|z| (A)) (|l| NIL))
               (SEQ
