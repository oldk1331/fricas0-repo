...
(SDEFUN |GROUPP;toPermutationIfCan;$LBU;49|
        ...
        (SPROG
         ((#1=#:G680 NIL) (#2=#:G681 NIL) (#3=#:G682 NIL)
          ...
          (|sgens_lens| (|List| #4=(|NonNegativeInteger|))) (#5=#:G687 NIL)
          (|word| NIL) (#6=#:G686 NIL) (|nrsgens| NIL)
          ...
          (|rel_lens| (|List| (|NonNegativeInteger|))) (#8=#:G685 NIL)
          (|rel| NIL) (#9=#:G684 NIL) (|nrrels| NIL) (|#G186| #7#)
          (|nrels| NIL) (|#G185| #7#) (#10=#:G683 NIL) (|i| NIL)
                          ...
                          (EXIT
                           (COND
                            ((>= (QVELT |state| 5) |loopLimit|)
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 1) (GO #13=#:G677)))
                              (GO #14=#:G676)))))))
                        #14# (EXIT #1#))
                       NIL (GO G190) G191 (EXIT NIL)))
                 #13# (EXIT #2#))
