...
(SDEFUN |GROUPP;mapGen|
        ((|a| |Integer|)
         ...
         ($ |Integer|))
        (SPROG ((#1=#:G190 NIL) (#2=#:G191 NIL) (|m| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |GROUPP;refactor;2$;5| ((|a| $) ($ $))
        (SPROG
         ((|gens1| (|List| (|NonNegativeInteger|))) (#1=#:G208 NIL) (|gn| NIL)
          (#2=#:G207 NIL) (|rels1| (|List| (|List| (|Integer|))))
          (|newRel| (|List| (|Integer|))) (|newEle| (|Integer|))
          (#3=#:G206 NIL) (|ele| NIL) (#4=#:G205 NIL) (|rel| NIL)
          (|gms|
           (|List|
            (|Record| (|:| |OldGen| (|NonNegativeInteger|))
                      (|:| |NewGen| (|NonNegativeInteger|)))))
...
(SDEFUN |GROUPP;=;2$B;6| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((|brs| #1=(|List| (|List| (|Integer|)))) (|ars| #1#) (#2=#:G213 NIL)
...
(SDEFUN |GROUPP;outputGen| ((|i2| |Integer|) ($ |OutputForm|))
        (SPROG
         ((#1=#:G217 NIL) (|n| (|OutputForm|)) (|letters| (|String|))
...
(SDEFUN |GROUPP;outputRel| ((|r| |List| (|Integer|)) ($ |OutputForm|))
        (SPROG
         ((|seperator| #1=(|OutputForm|)) (|eleout| #1#)
          (|newterm| (|OutputForm|)) (#2=#:G222 NIL) (|ele| NIL))
...
(SDEFUN |GROUPP;outputRelList|
        ...
        (SPROG
         ((#1=#:G227 NIL) (|rels1| (|List| (|OutputForm|))) (#2=#:G228 NIL)
          (|r| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |rels1| NIL)
...
(SDEFUN |GROUPP;outputGenList|
        ...
        (SPROG
         ((#1=#:G233 NIL) (|gens1| (|List| (|OutputForm|))) (#2=#:G234 NIL)
          (|p| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |gens1| NIL)
...
(SDEFUN |GROUPP;indexesOfRelUsingGen|
        ...
        (SPROG
         ((|res| (|List| (|NonNegativeInteger|))) (#1=#:G241 NIL) (|rel| NIL)
          (#2=#:G242 NIL) (|reln| NIL) (|r| (|List| (|List| (|Integer|)))))
...
(SDEFUN |GROUPP;removeGen2|
        ((|rels1| |List| (|List| (|Integer|))) (|val| |NonNegativeInteger|)
         ($ |List| (|List| (|Integer|))))
        (SPROG ((#1=#:G247 NIL) (|rel| NIL) (#2=#:G246 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GROUPP;replaceGen|
        ...
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (|rel2| (|List| (|Integer|)))
          (|e| (|Integer|)) (#1=#:G256 NIL) (|ele| NIL) (#2=#:G255 NIL)
          (|rel| NIL))
         (SEQ (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;TTRemoveGeneratorIfIdentity|
        ...
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G262 NIL)
          (|toBeRemoved| (|NonNegativeInteger|)) (#2=#:G263 NIL) (|rel| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
                ...
                (SEQ (LETT |rel| NIL) (LETT #2# |rels1|) G190
                     ...
                     (LETT #2# (CDR #2#)) (GO G190) G191 (EXIT NIL))
                (COND
                 ((EQL |toBeRemoved| 0) (PROGN (LETT #1# |s|) (GO #3=#:G261))))
                (COND
                 (|trace|
                  (SPADCALL
                   (SPADCALL
...
(SDEFUN |GROUPP;TTRenameGenerator| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G271 NIL)
          ...
          (EXIT
           (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
                ...
                (SEQ (LETT |rel| NIL) (LETT #2# |rels1|) G190
                     ...
                     (LETT #2# (CDR #2#)) (GO G190) G191 (EXIT NIL))
                (COND
                 ((EQL |replaceFrom| 0) (PROGN (LETT #1# |s|) (GO #3=#:G270))))
                (COND
                 (|trace|
                  (SPADCALL
                   (SPADCALL
...
(SDEFUN |GROUPP;TTRemoveEmpty| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (#1=#:G277 NIL) (|rel| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
              (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;TTRemoveEleTimesInverse| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (|rel2| (|List| (|Integer|)))
          (|lastele| (|Integer|)) (|changed| (|Boolean|)) (#1=#:G295 NIL)
          (|ele| NIL) (#2=#:G294 NIL) (|rel| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
...
(SDEFUN |GROUPP;invertRelation|
        ...
        (SPROG
         ((|relationOut| (|List| (|Integer|))) (#1=#:G299 NIL) (|ele| NIL))
...
(SDEFUN |GROUPP;relationEquivalent|
        ...
        (SPROG
         ((#1=#:G309 NIL) (|relBCycle| (|List| (|Integer|))) (#2=#:G310 NIL)
          (|n| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GROUPP;TTRemoveDuplicateRelation| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (|include| (|Boolean|))
          (#1=#:G321 NIL) (|relb| NIL) (#2=#:G322 NIL) (|nrelb| NIL)
          (#3=#:G319 NIL) (|rela| NIL) (#4=#:G320 NIL) (|nrela| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
              (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;TTMinimiseInverses| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|))))
          ...
          (#2=#:G329 NIL) (|ele| NIL) (#3=#:G328 NIL) (|rel| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
              (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;generatorOccurrences|
        ((|rel| |List| (|Integer|)) (|gen| |NonNegativeInteger|)
         ($ |NonNegativeInteger|))
        (SPROG ((|res| (|NonNegativeInteger|)) (#1=#:G336 NIL) (|g| NIL))
               (SEQ (LETT |res| 0)
...
(SDEFUN |GROUPP;removeRelations|
        ((|rels1| |List| (|List| (|Integer|))) (|val| |NonNegativeInteger|)
         ($ |List| (|List| (|Integer|))))
        (SPROG
         ((|res| (|List| (|List| (|Integer|)))) (#1=#:G342 NIL) (|rel| NIL))
         (SEQ (LETT |res| NIL)
              (SEQ (LETT |rel| NIL) (LETT #1# |rels1|) G190
                   (COND
                    ((OR (ATOM #1#) (PROGN (LETT |rel| (CAR #1#)) NIL))
...
(SDEFUN |GROUPP;isSimpler?| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G373 NIL) (|relationCompleityB| #2=(|NonNegativeInteger|))
          (#3=#:G375 NIL) (|rel| NIL) (|relationCompleityA| #2#)
          (#4=#:G374 NIL) (|relsb| #5=(|List| (|List| (|Integer|))))
...
(SDEFUN |GROUPP;simplify;$B$;30| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|lastpass| ($)) (|level| #1=(|NonNegativeInteger|)) (#2=#:G383 NIL)
          (|res| ($)) (|loopBreaker| #1#))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GROUPP;offsetIndexes| ((|a| $) (|offset| |NonNegativeInteger|) ($ $))
        (SPROG
         ((|rb| (|List| (|List| (|Integer|)))) (#1=#:G394 NIL) (|y| NIL)
          (#2=#:G393 NIL) (#3=#:G392 NIL) (|z| NIL) (#4=#:G391 NIL)
          (|gb| (|List| (|NonNegativeInteger|))) (#5=#:G390 NIL) (|x| NIL)
          (#6=#:G389 NIL) (|ra| (|List| (|List| (|Integer|))))
...
(SDEFUN |GROUPP;quotient;$L$;32|
        ...
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G399 NIL)
          (|toBeRemoved| NIL))
...
(SDEFUN |GROUPP;directProduct;3$;34| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((|rc| (|List| (|List| (|Integer|)))) (|gcx| (|List| (|Integer|)))
          (#1=#:G408 NIL) (|gbx| NIL) (#2=#:G407 NIL) (|gax| NIL)
...
(SDEFUN |GROUPP;cyclicGroup;Pi$;35| ((|n| |PositiveInteger|) ($ $))
        (SPROG
         ((|ra| (|List| (|List| (|Integer|)))) (#1=#:G413 NIL) (|x| NIL)
          (#2=#:G412 NIL) (|ga| (|List| (|NonNegativeInteger|))))
         (SEQ (LETT |ga| (LIST 1))
              (LETT |ra|
                    (LIST
                     (PROGN
...
(SDEFUN |GROUPP;symmetricGroup;Pi$;37| ((|n| |PositiveInteger|) ($ $))
        (SPROG
         ((|r| (|List| (|List| (|Integer|)))) (|y| (|List| (|Integer|)))
          (#1=#:G432 NIL) (|b| NIL) (#2=#:G431 NIL) (|a| NIL)
          (|ga| (|List| (|NonNegativeInteger|))) (#3=#:G430 NIL) (|x| NIL)
          (#4=#:G429 NIL) (|m| (|PositiveInteger|)) (#5=#:G416 NIL)
          (#6=#:G428 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((< |n| 2)
              (PROGN (LETT #6# (SPADCALL NIL (QREFELT $ 12))) (GO #7=#:G427))))
            (LETT |m|
                  (PROG1 (LETT #5# (- |n| 1))
...
(SDEFUN |GROUPP;outCosetTable|
        ...
        (SPROG
         ((|cts| (|List| (|TwoDimensionalArray| (|NonNegativeInteger|))))
          (|part2| (|NonNegativeInteger|)) (#2=#:G434 NIL) (|part1| #1#)
          (#3=#:G440 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GROUPP;infer_coincidencies|
        ((|ct| |TwoDimensionalArray| (|NonNegativeInteger|))
         ...
         (|trace| |Boolean|) ($ |Void|))
        (SPROG
         ((|i2| #3=(|NonNegativeInteger|)) (|i1| #3#) (#4=#:G461 NIL) (|i| NIL)
          (#5=#:G460 NIL) (|nn| (|Integer|)) (|#G135| #1#) (|#G134| #2#))
         (SEQ
          (COND
           (|trace|
            (SPADCALL
...
(SDEFUN |GROUPP;inferFromRelations|
        ...
        (SPROG
         ((#6=#:G504 NIL) (|npb| #7=(|NonNegativeInteger|)) (|npe| #7#)
          ...
          (#13=#:G508 NIL) (|prel| #5#) (|add_to| #9#) (#14=#:G517 NIL)
          (#15=#:G516 NIL) (#16=#:G515 NIL) (#17=#:G514 NIL) (|pe| #8#)
          (|ge| #9#) (#18=#:G505 NIL) (|genInv| (|Integer|)) (#19=#:G513 NIL)
          (|genIndex| NIL) (#20=#:G506 NIL) (#21=#:G512 NIL) (#22=#:G509 NIL)
          (|rel| NIL) (#23=#:G510 NIL) (|rrel| NIL) (#24=#:G511 NIL)
          (|r_len| NIL) (#25=#:G507 NIL) (|closed| (|Boolean|)) (|pn| #8#)
...
(SDEFUN |GROUPP;invertMap|
        ...
        (SPROG
         ((|i| (|NonNegativeInteger|)) (#1=#:G525 NIL) (|x| NIL)
...
(SDEFUN |GROUPP;generators2Permutation|
        ...
        (SPROG
         ((|pl| (|List| (|Permutation| (|Integer|))))
          ...
          (#5=#:G566 NIL) (|j| (|SingleInteger|)) (|kk| (|NonNegativeInteger|))
          (#6=#:G565 NIL) (#7=#:G564 NIL) (|i| NIL)
          (|perm_lists| (|Vector| (|List| (|Integer|)))) (#8=#:G563 NIL)
...
(SDEFUN |GROUPP;convert_words|
        ...
        (SPROG
         ((|nrwords| (|List| (|List| (|NonNegativeInteger|))))
          (|nwords| (|List| (|List| (|NonNegativeInteger|)))) (#2=#:G585 NIL)
          (|i| NIL) (#3=#:G584 NIL) (|nword| (|List| (|NonNegativeInteger|)))
          (|gen| #1#) (#4=#:G583 NIL) (#5=#:G582 NIL) (|word| NIL))
...
(SDEFUN |GROUPP;toPermutationIfCan;$LBU;49|
        ((|a| $) (|sg| |List| (|List| (|Integer|))) (|trace| |Boolean|)
         ($ |Union| (|PermutationGroup| (|Integer|)) "failed"))
        (SPROG
         ((#1=#:G605 NIL) (#2=#:G606 NIL) (#3=#:G607 NIL)
          (|changedByDeduction| #4=(|Boolean|)) (|dummy| #4#)
          (|sgens_lens| (|List| #5=(|NonNegativeInteger|))) (#6=#:G612 NIL)
          (|word| NIL) (#7=#:G611 NIL) (|nrsgens| NIL)
          ...
          (|rel_lens| (|List| (|NonNegativeInteger|))) (#9=#:G610 NIL)
          (|rel| NIL) (#10=#:G609 NIL) (|nrrels| NIL) (|#G186| #8#)
          (|nrels| NIL) (|#G185| #8#) (#11=#:G608 NIL) (|i| NIL)
                          ...
                          (EXIT
                           (COND
                            ((>= (QVELT |state| 5) |loopLimit|)
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 1) (GO #14=#:G602)))
                              (GO #15=#:G601)))))))
                        #15# (EXIT #1#))
                       NIL (GO G190) G191 (EXIT NIL)))
                 #14# (EXIT #2#))
