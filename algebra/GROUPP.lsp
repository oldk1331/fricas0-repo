...
(SDEFUN |GROUPP;mapGen|
        ((|a| (|Integer|))
         ...
         ($ (|Integer|)))
        (SPROG ((#1=#:G177 NIL) (#2=#:G178 NIL) (|m| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |GROUPP;refactor;2$;5| ((|a| ($)) ($ ($)))
        (SPROG
         ((|gens1| (|List| (|NonNegativeInteger|))) (#1=#:G199 NIL) (|gn| NIL)
          (#2=#:G198 NIL) (|rels1| (|List| (|List| (|Integer|))))
          (|newRel| (|List| (|Integer|))) (|newEle| (|Integer|))
          (#3=#:G197 NIL) (|ele| NIL) (#4=#:G196 NIL) (|rel| NIL)
          (|gms|
           (|List|
            (|Record| (|:| |OldGen| (|NonNegativeInteger|))
                      (|:| |NewGen| (|NonNegativeInteger|)))))
...
(SDEFUN |GROUPP;=;2$B;6| ((|a| ($)) (|b| ($)) ($ (|Boolean|)))
        (SPROG
         ((|brs| #1=(|List| (|List| (|Integer|)))) (|ars| #1#) (#2=#:G204 NIL)
...
(SDEFUN |GROUPP;outputGen| ((|i2| (|Integer|)) ($ (|OutputForm|)))
        (SPROG
         ((#1=#:G208 NIL) (|n| (|OutputForm|)) (|letters| (|String|))
...
(SDEFUN |GROUPP;outputRel| ((|r| (|List| (|Integer|))) ($ (|OutputForm|)))
        (SPROG
         ((|seperator| #1=(|OutputForm|)) (|eleout| #1#)
          (|newterm| (|OutputForm|)) (#2=#:G214 NIL) (|ele| NIL))
...
(SDEFUN |GROUPP;outputRelList|
        ...
        (SPROG
         ((#1=#:G220 NIL) (|rels1| (|List| (|OutputForm|))) (#2=#:G221 NIL)
          (|r| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |rels1| NIL)
...
(SDEFUN |GROUPP;outputGenList|
        ...
        (SPROG
         ((#1=#:G227 NIL) (|gens1| (|List| (|OutputForm|))) (#2=#:G228 NIL)
          (|p| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |gens1| NIL)
...
(SDEFUN |GROUPP;indexesOfRelUsingGen|
        ...
        (SPROG
         ((|res| (|List| (|NonNegativeInteger|))) (#1=#:G236 NIL) (|rel| NIL)
          (#2=#:G237 NIL) (|reln| NIL) (|r| (|List| (|List| (|Integer|)))))
...
(SDEFUN |GROUPP;removeGen2|
        ((|rels1| (|List| (|List| (|Integer|)))) (|val| (|NonNegativeInteger|))
         ($ (|List| (|List| (|Integer|)))))
        (SPROG ((#1=#:G243 NIL) (|rel| NIL) (#2=#:G242 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GROUPP;replaceGen|
        ...
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (|rel2| (|List| (|Integer|)))
          (|e| (|Integer|)) (#1=#:G254 NIL) (|ele| NIL) (#2=#:G253 NIL)
          (|rel| NIL))
         (SEQ (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;TTRemoveGeneratorIfIdentity|
        ...
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G261 NIL)
          (|toBeRemoved| (|NonNegativeInteger|)) (#2=#:G262 NIL) (|rel| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
                ...
                (SEQ (LETT |rel| NIL) (LETT #2# |rels1|) G190
                     ...
                     (LETT #2# (CDR #2#)) (GO G190) G191 (EXIT NIL))
                (COND
                 ((EQL |toBeRemoved| 0) (PROGN (LETT #1# |s|) (GO #3=#:G260))))
                (COND
                 (|trace|
                  (SPADCALL
                   (SPADCALL
...
(SDEFUN |GROUPP;TTRemoveEmpty| ((|s| ($)) (|trace| (|Boolean|)) ($ ($)))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (#1=#:G278 NIL) (|rel| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
              (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;TTRemoveEleTimesInverse|
        ...
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (|rel2| (|List| (|Integer|)))
          (|lastele| (|Integer|)) (|changed| (|Boolean|)) (#1=#:G298 NIL)
          (|ele| NIL) (#2=#:G297 NIL) (|rel| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
...
(SDEFUN |GROUPP;invertRelation|
        ...
        (SPROG
         ((|relationOut| (|List| (|Integer|))) (#1=#:G303 NIL) (|ele| NIL))
...
(SDEFUN |GROUPP;relationEquivalent|
        ((|relA| (|List| (|Integer|))) (|relB| (|List| (|Integer|)))
         ($ (|Boolean|)))
        (SPROG
         ((#1=#:G314 NIL) (|relBCycle| (|List| (|Integer|))) (#2=#:G315 NIL)
          (|n| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GROUPP;TTRemoveDuplicateRelation|
        ...
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (|include| (|Boolean|))
          (#1=#:G328 NIL) (|relb| NIL) (#2=#:G329 NIL) (|nrelb| NIL)
          (#3=#:G326 NIL) (|rela| NIL) (#4=#:G327 NIL) (|nrela| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
              (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;TTMinimiseInverses| ((|s| ($)) (|trace| (|Boolean|)) ($ ($)))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|))))
          ...
          (#2=#:G338 NIL) (|ele| NIL) (#3=#:G337 NIL) (|rel| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
              (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;generatorOccurrences|
        ((|rel| (|List| (|Integer|))) (|gen| (|NonNegativeInteger|))
         ($ (|NonNegativeInteger|)))
        (SPROG ((|res| (|NonNegativeInteger|)) (#1=#:G346 NIL) (|g| NIL))
               (SEQ (LETT |res| 0)
...
(SDEFUN |GROUPP;removeRelations|
        ((|rels1| (|List| (|List| (|Integer|)))) (|val| (|NonNegativeInteger|))
         ($ (|List| (|List| (|Integer|)))))
        (SPROG
         ((|res| (|List| (|List| (|Integer|)))) (#1=#:G353 NIL) (|rel| NIL))
         (SEQ (LETT |res| NIL)
              (SEQ (LETT |rel| NIL) (LETT #1# |rels1|) G190
                   (COND
                    ((OR (ATOM #1#) (PROGN (LETT |rel| (CAR #1#)) NIL))
...
(SDEFUN |GROUPP;TTSubstitute| ((|s| ($)) (|trace| (|Boolean|)) ($ ($)))
        (SPROG
         ((|rels1| #1=(|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|)))
          (|newRel| (|List| (|Integer|))) (#2=#:G381 NIL)
          ...
          (|indexes| (|List| (|NonNegativeInteger|))) (#7=#:G380 NIL) (|g| NIL)
...
(SDEFUN |GROUPP;isSimpler?| ((|a| ($)) (|b| ($)) ($ (|Boolean|)))
        (SPROG
         ((#1=#:G390 NIL) (|relationCompleityB| #2=(|NonNegativeInteger|))
          (#3=#:G392 NIL) (|rel| NIL) (|relationCompleityA| #2#)
          (#4=#:G391 NIL) (|relsb| #5=(|List| (|List| (|Integer|))))
...
(SDEFUN |GROUPP;simplify;$B$;30| ((|s| ($)) (|trace| (|Boolean|)) ($ ($)))
        (SPROG
         ((|lastpass| ($)) (|level| #1=(|NonNegativeInteger|)) (#2=#:G401 NIL)
          (|res| ($)) (|loopBreaker| #1#))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GROUPP;offsetIndexes|
        ...
        (SPROG
         ((|rb| (|List| (|List| (|Integer|)))) (#1=#:G415 NIL) (|y| NIL)
          (#2=#:G414 NIL) (#3=#:G413 NIL) (|z| NIL) (#4=#:G412 NIL)
          (|gb| (|List| (|NonNegativeInteger|))) (#5=#:G411 NIL) (|x| NIL)
          (#6=#:G410 NIL) (|ra| (|List| (|List| (|Integer|))))
...
(SDEFUN |GROUPP;quotient;$L$;32|
        ...
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G421 NIL)
          (|toBeRemoved| NIL))
...
(SDEFUN |GROUPP;directProduct;3$;34| ((|a| ($)) (|b| ($)) ($ ($)))
        (SPROG
         ((|rc| (|List| (|List| (|Integer|)))) (|gcx| (|List| (|Integer|)))
          (#1=#:G432 NIL) (|gbx| NIL) (#2=#:G431 NIL) (|gax| NIL)
...
(SDEFUN |GROUPP;cyclicGroup;Pi$;35| ((|n| (|PositiveInteger|)) ($ ($)))
        (SPROG
         ((|ra| (|List| (|List| (|Integer|)))) (#1=#:G438 NIL) (|x| NIL)
          (#2=#:G437 NIL) (|ga| (|List| (|NonNegativeInteger|))))
         (SEQ (LETT |ga| (LIST 1))
              (LETT |ra|
                    (LIST
                     (PROGN
...
(SDEFUN |GROUPP;symmetricGroup;Pi$;37| ((|n| (|PositiveInteger|)) ($ ($)))
        (SPROG
         ((|r| (|List| (|List| (|Integer|)))) (|y| (|List| (|Integer|)))
          (#1=#:G460 NIL) (|b| NIL) (#2=#:G459 NIL) (|a| NIL)
          (|ga| (|List| (|NonNegativeInteger|))) (#3=#:G458 NIL) (|x| NIL)
          (#4=#:G457 NIL) (|m| (|PositiveInteger|)) (#5=#:G441 NIL)
          (#6=#:G456 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((< |n| 2)
              (PROGN (LETT #6# (SPADCALL NIL (QREFELT $ 12))) (GO #7=#:G455))))
            (LETT |m|
                  (PROG1 (LETT #5# (- |n| 1))
...
(SDEFUN |GROUPP;outCosetTable|
        ...
        (SPROG
         ((|cts| (|List| (|TwoDimensionalArray| (|NonNegativeInteger|))))
          (|part2| (|NonNegativeInteger|)) (#2=#:G462 NIL) (|part1| #1#)
          (#3=#:G468 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GROUPP;infer_coincidencies|
        ((|ct| (|TwoDimensionalArray| (|NonNegativeInteger|)))
         ...
         (|trace| (|Boolean|)) ($ (|Void|)))
        (SPROG
         ((|i2| #3=(|NonNegativeInteger|)) (|i1| #3#) (#4=#:G493 NIL) (|i| NIL)
          (#5=#:G492 NIL) (|nn| (|Integer|)) (|#G135| #1#) (|#G134| #2#))
         (SEQ
          (COND
           (|trace|
            (SPADCALL
...
(SDEFUN |GROUPP;inferFromRelations|
        ...
        (SPROG
         ((#6=#:G548 NIL) (|npb| #7=(|NonNegativeInteger|)) (|npe| #7#)
          ...
          (#13=#:G552 NIL) (|prel| #5#) (|add_to| #9#) (#14=#:G561 NIL)
          (#15=#:G560 NIL) (#16=#:G559 NIL) (#17=#:G558 NIL) (|pe| #8#)
          (|ge| #9#) (#18=#:G549 NIL) (|genInv| (|Integer|)) (#19=#:G557 NIL)
          (|genIndex| NIL) (#20=#:G550 NIL) (#21=#:G556 NIL) (#22=#:G553 NIL)
          (|rel| NIL) (#23=#:G554 NIL) (|rrel| NIL) (#24=#:G555 NIL)
          (|r_len| NIL) (#25=#:G551 NIL) (|closed| (|Boolean|)) (|pn| #8#)
          (|inv_tab| #3#))
         (SEQ
          (EXIT
...
(SDEFUN |GROUPP;invertMap|
        ...
        (SPROG
         ((|i| (|NonNegativeInteger|)) (#1=#:G570 NIL) (|x| NIL)
...
(SDEFUN |GROUPP;generators2Permutation|
        ...
        (SPROG
         ((|pl| (|List| (|Permutation| (|Integer|))))
          ...
          (#5=#:G618 NIL) (|j| (|SingleInteger|)) (|kk| (|NonNegativeInteger|))
          (#6=#:G617 NIL) (#7=#:G616 NIL) (|i| NIL)
          (|perm_lists| (|Vector| (|List| (|Integer|)))) (#8=#:G615 NIL)
...
(SDEFUN |GROUPP;convert_words|
        ...
        (SPROG
         ((|nrwords| (|List| (|List| (|NonNegativeInteger|))))
          (|nwords| (|List| (|List| (|NonNegativeInteger|)))) (#2=#:G640 NIL)
          (|i| NIL) (#3=#:G639 NIL) (|nword| (|List| (|NonNegativeInteger|)))
          (|gen| #1#) (#4=#:G638 NIL) (#5=#:G637 NIL) (|word| NIL))
...
(SDEFUN |GROUPP;toPermutationIfCan;$LBU;49|
        ((|a| ($)) (|sg| (|List| (|List| (|Integer|)))) (|trace| (|Boolean|))
         ($ (|Union| (|PermutationGroup| (|Integer|)) "failed")))
        (SPROG
         ((#1=#:G665 NIL) (#2=#:G666 NIL) (#3=#:G667 NIL)
          (|changedByDeduction| (|Boolean|))
          (|sgens_lens| (|List| #4=(|NonNegativeInteger|))) (#5=#:G672 NIL)
          (|word| NIL) (#6=#:G671 NIL) (|nrsgens| NIL)
          ...
          (|rel_lens| (|List| (|NonNegativeInteger|))) (#8=#:G670 NIL)
          (|rel| NIL) (#9=#:G669 NIL) (|nrrels| NIL) (|#G186| #7#)
          (|nrels| NIL) (|#G185| #7#) (#10=#:G668 NIL) (|i| NIL)
                          ...
                          (EXIT
                           (COND
                            ((>= (QVELT |state| 5) |loopLimit|)
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 1) (GO #13=#:G662)))
                              (GO #14=#:G661)))))))
                        #14# (EXIT #1#))
                       NIL (GO G190) G191 (EXIT NIL)))
                 #13# (EXIT #2#))
