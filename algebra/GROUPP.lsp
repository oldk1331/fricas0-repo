...
(SDEFUN |GROUPP;mapGen|
        ((|a| (|Integer|))
         ...
         ($ (|Integer|)))
        (SPROG ((#1=#:G192 NIL) (#2=#:G193 NIL) (|m| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |GROUPP;refactor;2$;5| ((|a| ($)) ($ ($)))
        (SPROG
         ((|gens1| (|List| (|NonNegativeInteger|))) (#1=#:G214 NIL) (|gn| NIL)
          (#2=#:G213 NIL) (|rels1| (|List| (|List| (|Integer|))))
          (|newRel| (|List| (|Integer|))) (|newEle| (|Integer|))
          (#3=#:G212 NIL) (|ele| NIL) (#4=#:G211 NIL) (|rel| NIL)
          (|gms|
           (|List|
            (|Record| (|:| |OldGen| (|NonNegativeInteger|))
                      (|:| |NewGen| (|NonNegativeInteger|)))))
...
(SDEFUN |GROUPP;=;2$B;6| ((|a| ($)) (|b| ($)) ($ (|Boolean|)))
        (SPROG
         ((|brs| #1=(|List| (|List| (|Integer|)))) (|ars| #1#) (#2=#:G219 NIL)
...
(SDEFUN |GROUPP;outputGen| ((|i2| (|Integer|)) ($ (|OutputForm|)))
        (SPROG
         ((#1=#:G223 NIL) (|n| (|OutputForm|)) (|letters| (|String|))
...
(SDEFUN |GROUPP;outputRel| ((|r| (|List| (|Integer|))) ($ (|OutputForm|)))
        (SPROG
         ((|seperator| #1=(|OutputForm|)) (|eleout| #1#)
          (|newterm| (|OutputForm|)) (#2=#:G229 NIL) (|ele| NIL))
...
(SDEFUN |GROUPP;outputRelList|
        ...
        (SPROG
         ((#1=#:G235 NIL) (|rels1| (|List| (|OutputForm|))) (#2=#:G236 NIL)
          (|r| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |rels1| NIL)
...
(SDEFUN |GROUPP;outputGenList|
        ...
        (SPROG
         ((#1=#:G242 NIL) (|gens1| (|List| (|OutputForm|))) (#2=#:G243 NIL)
          (|p| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |gens1| NIL)
...
(SDEFUN |GROUPP;indexesOfRelUsingGen|
        ...
        (SPROG
         ((|res| (|List| (|NonNegativeInteger|))) (#1=#:G251 NIL) (|rel| NIL)
          (#2=#:G252 NIL) (|reln| NIL) (|r| (|List| (|List| (|Integer|)))))
...
(SDEFUN |GROUPP;removeGen2|
        ((|rels1| (|List| (|List| (|Integer|)))) (|val| (|NonNegativeInteger|))
         ($ (|List| (|List| (|Integer|)))))
        (SPROG ((#1=#:G258 NIL) (|rel| NIL) (#2=#:G257 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |GROUPP;replaceGen|
        ...
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (|rel2| (|List| (|Integer|)))
          (|e| (|Integer|)) (#1=#:G269 NIL) (|ele| NIL) (#2=#:G268 NIL)
          (|rel| NIL))
         (SEQ (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;TTRemoveGeneratorIfIdentity|
        ...
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G276 NIL)
          (|toBeRemoved| (|NonNegativeInteger|)) (#2=#:G277 NIL) (|rel| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
                ...
                (SEQ (LETT |rel| NIL) (LETT #2# |rels1|) G190
                     ...
                     (LETT #2# (CDR #2#)) (GO G190) G191 (EXIT NIL))
                (COND
                 ((EQL |toBeRemoved| 0) (PROGN (LETT #1# |s|) (GO #3=#:G275))))
                (COND
                 (|trace|
                  (SPADCALL
                   (SPADCALL
...
(SDEFUN |GROUPP;TTRenameGenerator| ((|s| ($)) (|trace| (|Boolean|)) ($ ($)))
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G286 NIL)
          ...
          (EXIT
           (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
                ...
                (SEQ (LETT |rel| NIL) (LETT #2# |rels1|) G190
                     ...
                     (LETT #2# (CDR #2#)) (GO G190) G191 (EXIT NIL))
                (COND
                 ((EQL |replaceFrom| 0) (PROGN (LETT #1# |s|) (GO #3=#:G285))))
                (COND
                 (|trace|
                  (SPADCALL
                   (SPADCALL
...
(SDEFUN |GROUPP;TTRemoveEmpty| ((|s| ($)) (|trace| (|Boolean|)) ($ ($)))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (#1=#:G293 NIL) (|rel| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
              (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;TTRemoveEleTimesInverse|
        ...
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (|rel2| (|List| (|Integer|)))
          (|lastele| (|Integer|)) (|changed| (|Boolean|)) (#1=#:G313 NIL)
          (|ele| NIL) (#2=#:G312 NIL) (|rel| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
...
(SDEFUN |GROUPP;invertRelation|
        ...
        (SPROG
         ((|relationOut| (|List| (|Integer|))) (#1=#:G318 NIL) (|ele| NIL))
...
(SDEFUN |GROUPP;relationEquivalent|
        ((|relA| (|List| (|Integer|))) (|relB| (|List| (|Integer|)))
         ($ (|Boolean|)))
        (SPROG
         ((#1=#:G329 NIL) (|relBCycle| (|List| (|Integer|))) (#2=#:G330 NIL)
          (|n| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GROUPP;TTRemoveDuplicateRelation|
        ...
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (|include| (|Boolean|))
          (#1=#:G343 NIL) (|relb| NIL) (#2=#:G344 NIL) (|nrelb| NIL)
          (#3=#:G341 NIL) (|rela| NIL) (#4=#:G342 NIL) (|nrela| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
              (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;TTMinimiseInverses| ((|s| ($)) (|trace| (|Boolean|)) ($ ($)))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|))))
          ...
          (#2=#:G353 NIL) (|ele| NIL) (#3=#:G352 NIL) (|rel| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
         (SEQ (LETT |gens1| (QCAR |s|)) (LETT |rels1| (QCDR |s|))
              (LETT |rels2| NIL)
...
(SDEFUN |GROUPP;generatorOccurrences|
        ((|rel| (|List| (|Integer|))) (|gen| (|NonNegativeInteger|))
         ($ (|NonNegativeInteger|)))
        (SPROG ((|res| (|NonNegativeInteger|)) (#1=#:G361 NIL) (|g| NIL))
               (SEQ (LETT |res| 0)
...
(SDEFUN |GROUPP;removeRelations|
        ((|rels1| (|List| (|List| (|Integer|)))) (|val| (|NonNegativeInteger|))
         ($ (|List| (|List| (|Integer|)))))
        (SPROG
         ((|res| (|List| (|List| (|Integer|)))) (#1=#:G368 NIL) (|rel| NIL))
         (SEQ (LETT |res| NIL)
              (SEQ (LETT |rel| NIL) (LETT #1# |rels1|) G190
                   (COND
                    ((OR (ATOM #1#) (PROGN (LETT |rel| (CAR #1#)) NIL))
...
(SDEFUN |GROUPP;TTSubstitute| ((|s| ($)) (|trace| (|Boolean|)) ($ ($)))
        (SPROG
         ((|rels1| #1=(|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|)))
          (|newRel| (|List| (|Integer|))) (#2=#:G396 NIL)
          ...
          (|indexes| (|List| (|NonNegativeInteger|))) (#7=#:G395 NIL) (|g| NIL)
...
(SDEFUN |GROUPP;isSimpler?| ((|a| ($)) (|b| ($)) ($ (|Boolean|)))
        (SPROG
         ((#1=#:G405 NIL) (|relationCompleityB| #2=(|NonNegativeInteger|))
          (#3=#:G407 NIL) (|rel| NIL) (|relationCompleityA| #2#)
          (#4=#:G406 NIL) (|relsb| #5=(|List| (|List| (|Integer|))))
...
(SDEFUN |GROUPP;simplify;$B$;30| ((|s| ($)) (|trace| (|Boolean|)) ($ ($)))
        (SPROG
         ((|lastpass| ($)) (|level| #1=(|NonNegativeInteger|)) (#2=#:G416 NIL)
          (|res| ($)) (|loopBreaker| #1#))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GROUPP;offsetIndexes|
        ...
        (SPROG
         ((|rb| (|List| (|List| (|Integer|)))) (#1=#:G430 NIL) (|y| NIL)
          (#2=#:G429 NIL) (#3=#:G428 NIL) (|z| NIL) (#4=#:G427 NIL)
          (|gb| (|List| (|NonNegativeInteger|))) (#5=#:G426 NIL) (|x| NIL)
          (#6=#:G425 NIL) (|ra| (|List| (|List| (|Integer|))))
...
(SDEFUN |GROUPP;quotient;$L$;32|
        ...
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G436 NIL)
          (|toBeRemoved| NIL))
...
(SDEFUN |GROUPP;directProduct;3$;34| ((|a| ($)) (|b| ($)) ($ ($)))
        (SPROG
         ((|rc| (|List| (|List| (|Integer|)))) (|gcx| (|List| (|Integer|)))
          (#1=#:G447 NIL) (|gbx| NIL) (#2=#:G446 NIL) (|gax| NIL)
...
(SDEFUN |GROUPP;cyclicGroup;Pi$;35| ((|n| (|PositiveInteger|)) ($ ($)))
        (SPROG
         ((|ra| (|List| (|List| (|Integer|)))) (#1=#:G453 NIL) (|x| NIL)
          (#2=#:G452 NIL) (|ga| (|List| (|NonNegativeInteger|))))
         (SEQ (LETT |ga| (LIST 1))
              (LETT |ra|
                    (LIST
                     (PROGN
...
(SDEFUN |GROUPP;symmetricGroup;Pi$;37| ((|n| (|PositiveInteger|)) ($ ($)))
        (SPROG
         ((|r| (|List| (|List| (|Integer|)))) (|y| (|List| (|Integer|)))
          (#1=#:G475 NIL) (|b| NIL) (#2=#:G474 NIL) (|a| NIL)
          (|ga| (|List| (|NonNegativeInteger|))) (#3=#:G473 NIL) (|x| NIL)
          (#4=#:G472 NIL) (|m| (|PositiveInteger|)) (#5=#:G456 NIL)
          (#6=#:G471 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((< |n| 2)
              (PROGN (LETT #6# (SPADCALL NIL (QREFELT $ 12))) (GO #7=#:G470))))
            (LETT |m|
                  (PROG1 (LETT #5# (- |n| 1))
...
(SDEFUN |GROUPP;outCosetTable|
        ...
        (SPROG
         ((|cts| (|List| (|TwoDimensionalArray| (|NonNegativeInteger|))))
          (|part2| (|NonNegativeInteger|)) (#2=#:G477 NIL) (|part1| #1#)
          (#3=#:G483 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |GROUPP;infer_coincidencies|
        ((|ct| (|TwoDimensionalArray| (|NonNegativeInteger|)))
         ...
         (|trace| (|Boolean|)) ($ (|Void|)))
        (SPROG
         ((|i2| #3=(|NonNegativeInteger|)) (|i1| #3#) (#4=#:G508 NIL) (|i| NIL)
          (#5=#:G507 NIL) (|nn| (|Integer|)) (|#G135| #1#) (|#G134| #2#))
         (SEQ
          (COND
           (|trace|
            (SPADCALL
...
(SDEFUN |GROUPP;inferFromRelations|
        ...
        (SPROG
         ((#6=#:G563 NIL) (|npb| #7=(|NonNegativeInteger|)) (|npe| #7#)
          ...
          (#13=#:G567 NIL) (|prel| #5#) (|add_to| #9#) (#14=#:G576 NIL)
          (#15=#:G575 NIL) (#16=#:G574 NIL) (#17=#:G573 NIL) (|pe| #8#)
          (|ge| #9#) (#18=#:G564 NIL) (|genInv| (|Integer|)) (#19=#:G572 NIL)
          (|genIndex| NIL) (#20=#:G565 NIL) (#21=#:G571 NIL) (#22=#:G568 NIL)
          (|rel| NIL) (#23=#:G569 NIL) (|rrel| NIL) (#24=#:G570 NIL)
          (|r_len| NIL) (#25=#:G566 NIL) (|closed| (|Boolean|)) (|pn| #8#)
...
(SDEFUN |GROUPP;invertMap|
        ...
        (SPROG
         ((|i| (|NonNegativeInteger|)) (#1=#:G585 NIL) (|x| NIL)
...
(SDEFUN |GROUPP;generators2Permutation|
        ...
        (SPROG
         ((|pl| (|List| (|Permutation| (|Integer|))))
          ...
          (#5=#:G633 NIL) (|j| (|SingleInteger|)) (|kk| (|NonNegativeInteger|))
          (#6=#:G632 NIL) (#7=#:G631 NIL) (|i| NIL)
          (|perm_lists| (|Vector| (|List| (|Integer|)))) (#8=#:G630 NIL)
...
(SDEFUN |GROUPP;convert_words|
        ...
        (SPROG
         ((|nrwords| (|List| (|List| (|NonNegativeInteger|))))
          (|nwords| (|List| (|List| (|NonNegativeInteger|)))) (#2=#:G655 NIL)
          (|i| NIL) (#3=#:G654 NIL) (|nword| (|List| (|NonNegativeInteger|)))
          (|gen| #1#) (#4=#:G653 NIL) (#5=#:G652 NIL) (|word| NIL))
...
(SDEFUN |GROUPP;toPermutationIfCan;$LBU;49|
        ((|a| ($)) (|sg| (|List| (|List| (|Integer|)))) (|trace| (|Boolean|))
         ($ (|Union| (|PermutationGroup| (|Integer|)) "failed")))
        (SPROG
         ((#1=#:G680 NIL) (#2=#:G681 NIL) (#3=#:G682 NIL)
          (|changedByDeduction| #4=(|Boolean|)) (|dummy| #4#)
          (|sgens_lens| (|List| #5=(|NonNegativeInteger|))) (#6=#:G687 NIL)
          (|word| NIL) (#7=#:G686 NIL) (|nrsgens| NIL)
          ...
          (|rel_lens| (|List| (|NonNegativeInteger|))) (#9=#:G685 NIL)
          (|rel| NIL) (#10=#:G684 NIL) (|nrrels| NIL) (|#G186| #8#)
          (|nrels| NIL) (|#G185| #8#) (#11=#:G683 NIL) (|i| NIL)
                          ...
                          (EXIT
                           (COND
                            ((>= (QVELT |state| 5) |loopLimit|)
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# 1) (GO #14=#:G677)))
                              (GO #15=#:G676)))))))
                        #15# (EXIT #1#))
                       NIL (GO G190) G191 (EXIT NIL)))
                 #14# (EXIT #2#))
