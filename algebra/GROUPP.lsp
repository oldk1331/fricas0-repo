...
(SDEFUN |GROUPP;groupPresentation;LL$;1|
        ...
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (#1=#:G128 NIL) (|r| NIL)
...
(SDEFUN |GROUPP;mapGen|
        ((|a| |Integer|)
         ...
         ($ |Integer|))
        (SPROG ((#1=#:G140 NIL) (#2=#:G141 NIL) (|m| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |m| NIL . #3=(|GROUPP;mapGen|))
                       ...
                       (SEQ
                        (COND
                         ((EQL (ABS |a|) (QCAR |m|))
                          (PROGN (LETT #1# (QCDR |m|) . #3#) (GO #4=#:G139))))
                        (EXIT
                         (COND
                          ((EQL (ABS |a|) (- (QCAR |m|)))
...
(SDEFUN |GROUPP;refactor;2$;5| ((|a| $) ($ $))
        (SPROG
         ((|gens1| (|List| (|NonNegativeInteger|))) (#1=#:G158 NIL) (|gn| NIL)
          (#2=#:G157 NIL) (|rels1| (|List| (|List| (|Integer|))))
          (|newRule| (|List| (|Integer|))) (|newEle| (|Integer|))
          (#3=#:G156 NIL) (|ele| NIL) (#4=#:G155 NIL) (|rule| NIL)
          (|gms|
           (|List|
            (|Record| (|:| |OldGen| (|NonNegativeInteger|))
                      (|:| |NewGen| (|NonNegativeInteger|)))))
...
(SDEFUN |GROUPP;=;2$B;6| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((|brs| #1=(|List| (|List| (|Integer|)))) (|ars| #1#) (#2=#:G163 NIL)
...
(SDEFUN |GROUPP;genName| ((|i2| |Integer|) ($ |OutputForm|))
        (SPROG
         ((#1=#:G167 NIL) (|n| (|OutputForm|)) (|letters| (|String|))
...
(SDEFUN |GROUPP;genName2| ((|i2| |List| (|List| (|Integer|))) ($ |OutputForm|))
        (SPROG
         ((|rels1| (|List| (|OutputForm|))) (|seperator| #1=(|OutputForm|))
          (|eleout| #1#) (|newterm| (|OutputForm|)) (#2=#:G175 NIL) (|ele| NIL)
          (#3=#:G174 NIL) (|r| NIL))
...
(SDEFUN |GROUPP;removeGen2|
        ((|rels1| |List| (|List| (|Integer|))) (|val| |NonNegativeInteger|)
         ($ |List| (|List| (|Integer|))))
        (SPROG ((#1=#:G180 NIL) (|rule| NIL) (#2=#:G179 NIL))
               (SEQ
                (PROGN
...
(SDEFUN |GROUPP;replaceGen|
        ...
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|))))
          (|rule2| (|List| (|Integer|))) (|e| (|Integer|)) (#1=#:G189 NIL)
          (|ele| NIL) (#2=#:G188 NIL) (|rule| NIL))
...
(SDEFUN |GROUPP;TTRemoveGeneratorIfIdentity|
        ...
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G195 NIL)
          (|toBeRemoved| (|NonNegativeInteger|)) (#2=#:G196 NIL) (|rule| NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |gens1| (QCAR |s|)
...
(SDEFUN |GROUPP;TTRenameGenerator| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))) (#1=#:G204 NIL)
...
(SDEFUN |GROUPP;TTRemoveEmpty| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|)))) (#1=#:G210 NIL) (|rule| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
...
(SDEFUN |GROUPP;TTRemoveEleTimesInverse| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|))))
          ...
          (|changed| (|Boolean|)) (#1=#:G228 NIL) (|ele| NIL) (#2=#:G227 NIL)
...
(SDEFUN |GROUPP;TTMinimiseInverses| ((|s| $) (|trace| |Boolean|) ($ $))
        (SPROG
         ((|rels2| (|List| (|List| (|Integer|))))
          (|rule2| (|List| (|Integer|))) (#1=#:G238 NIL) (|ele| NIL)
          (|numNonInverts| #2=(|NonNegativeInteger|)) (|numInverts| #2#)
          (#3=#:G237 NIL) (#4=#:G236 NIL) (|rule| NIL)
          (|rels1| (|List| (|List| (|Integer|))))
          (|gens1| (|PrimitiveArray| (|NonNegativeInteger|))))
...
(SDEFUN |GROUPP;isSimpler?| ((|a| $) (|b| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G245 NIL) (|ruleCompleityB| #2=(|NonNegativeInteger|))
          (#3=#:G247 NIL) (|rule| NIL) (|ruleCompleityA| #2#) (#4=#:G246 NIL)
...
(SDEFUN |GROUPP;coerce;$Of;21| ((|s| $) ($ |OutputForm|))
        (SPROG
         ((|r| #1=(|OutputForm|)) (|g| #1#)
          ...
          (|newterm| (|OutputForm|)) (#3=#:G268 NIL) (|ele| NIL)
