...
(SDEFUN |FSAGG-;coerce;AOf;9| ((|s| (A)) ($ (|OutputForm|)))
        (SPROG ((#1=#:G137 NIL) (|x| NIL) (#2=#:G136 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |FSAGG-;universe;A;14| (($ (A)))
        (SPROG ((#1=#:G156 NIL) (#2=#:G160 NIL) (|i| NIL) (#3=#:G159 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #3# NIL)
...
(SDEFUN |FSAGG-;index;PiA;17| ((|i| (|PositiveInteger|)) ($ (A)))
        (SPROG
         ((#1=#:G164 NIL) (#2=#:G169 NIL) (|j| NIL) (#3=#:G168 NIL)
          (|l| (|Integer|)))
