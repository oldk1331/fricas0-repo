...
(SDEFUN |FSAGG-;universe;A;14| (($ (A)))
        (SPROG ((#1=#:G163 NIL) (#2=#:G167 NIL) (|i| NIL) (#3=#:G166 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #3# NIL)
...
(SDEFUN |FSAGG-;index;PiA;17| ((|i| (|PositiveInteger|)) ($ (A)))
        (SPROG
         ((#1=#:G172 NIL) (#2=#:G177 NIL) (|j| NIL) (#3=#:G176 NIL)
          (|l| (|Integer|)))
...
(SDEFUN |FSAGG-;lookup;APi;18| ((|s| (A)) ($ (|PositiveInteger|)))
        (SPROG
         ((|n| (|PositiveInteger|)) (#1=#:G180 NIL) (#2=#:G184 NIL) (|x| NIL))
         (SEQ (LETT |n| 1)
