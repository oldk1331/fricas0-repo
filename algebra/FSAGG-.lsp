...
(SDEFUN |FSAGG-;universe;A;14| ((% (A)))
        (SPROG ((#1=#:G164 NIL) (#2=#:G168 NIL) (|i| NIL) (#3=#:G167 NIL))
               (SEQ
                (SPADCALL
                 (PROGN
                  (LETT #3# NIL)
...
(SDEFUN |FSAGG-;index;PiA;17| ((|i| (|PositiveInteger|)) (% (A)))
        (SPROG
         ((#1=#:G173 NIL) (#2=#:G178 NIL) (|j| NIL) (#3=#:G177 NIL)
          (|l| (|Integer|)))
...
(SDEFUN |FSAGG-;lookup;APi;18| ((|s| (A)) (% (|PositiveInteger|)))
        (SPROG
         ((|n| (|PositiveInteger|)) (#1=#:G181 NIL) (#2=#:G185 NIL) (|x| NIL))
         (SEQ (LETT |n| 1)
