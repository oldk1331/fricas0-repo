           ...
           (SEQ (LETT |indexLst| NIL . #6=(|OFACET;orientedFacetIfCan;LU;5|))
                ...
                (COND
                 ((< (SPADCALL |boundary| (QREFELT $ 24)) 1)
                  (PROGN (LETT #1# (CONS 1 "failed") . #6#) (GO #7=#:G173))))
                 ...
                 (SEQ
                  (COND
                   ((SPADCALL (QCAR |a|) (QCAR |b|) (QREFELT $ 88))
                    (PROGN (LETT #1# NIL |OFACET;=;2$B;32|) (GO #2=#:G315))))
