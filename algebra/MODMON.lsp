...
(SDEFUN |MODMON;setPoly;2Rep;1| ((|mon| (|Rep|)) ($ (|Rep|)))
        (SPROG
         ((#1=#:G139 NIL) (|i| NIL) (#2=#:G128 NIL) (|copymon| (|Rep|))
          (|oldm| (|Rep|)))
         (SEQ
...
(SDEFUN |MODMON;Vectorise;$V;22| ((|x| ($)) ($ (|Vector| R)))
        (SPROG ((#1=#:G170 NIL) (|i| NIL) (#2=#:G169 NIL))
               (SEQ
                (PROGN
                 (LETT #2# (GETREFV (|inc_SI| #3=(QREFELT $ 15))))
                 (SEQ (LETT |i| 0) (LETT #1# #3#) G190
...
(SDEFUN |MODMON;UnVectorise;V$;23| ((|vect| (|Vector| R)) ($ ($)))
        (SPROG
         ((#1=#:G172 NIL) (#2=#:G171 (|Rep|)) (#3=#:G173 (|Rep|))
          (#4=#:G175 NIL) (|i| NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |MODMON;computePowers;Pa;24| (($ (|PrimitiveArray| $)))
        (SPROG
         ((#1=#:G180 NIL) (|i| NIL) (|w| ($)) (|mat| (|PrimitiveArray| $)))
         (SEQ
          (LETT |mat|
...
(SDEFUN |MODMON;computeFrobeniusPowers| (($ (|PrimitiveArray| $)))
        (SPROG
         ((#1=#:G184 NIL) (|i| NIL) (|mult| ($)) (|mat| (|PrimitiveArray| $)))
         (SEQ
          (LETT |mat|
...
(SDEFUN |MODMON;monomial;RNni$;28|
        ...
        (SPROG
         ((|k2| (|NonNegativeInteger|)) (#1=#:G190 NIL)
...
(DEFUN |ModMonic| (|#1| |#2|)
  (SPROG
   ((#1=#:G124 NIL) (#2=#:G258 NIL) (|pv$| NIL) (#3=#:G254 NIL) (#4=#:G255 NIL)
    (#5=#:G256 NIL) (#6=#:G257 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
