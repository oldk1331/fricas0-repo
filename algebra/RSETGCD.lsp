...
(SDEFUN |RSETGCD;toseInvertible?;PTSB;5|
        ((|p| (P)) (|ts| (TS)) ($ (|Boolean|)))
        (SPROG
         ((#1=#:G185 NIL) (#2=#:G187 NIL) (|g| (P)) (#3=#:G189 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v-| (TS)) (|ts_v| (P)) (#4=#:G174 NIL) (#5=#:G186 NIL)
          (#6=#:G188 NIL) (|bwt| NIL)
          (|toCheck|
...
(SDEFUN |RSETGCD;toseInvertible?;PTSL;6|
        ...
        (SPROG
         ((|lbwt| (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (#1=#:G225 NIL) (|bwt| NIL) (#2=#:G224 NIL)
          (|inv|
           #3=(|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (|ts_h| (TS)) (|h| (P)) (|ts_g| (TS)) (|g| (P)) (#4=#:G223 NIL)
          (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v+| (TS)) (|ts_v-| (TS)) (|ts_v| (P)) (#5=#:G198 NIL)
          (#6=#:G221 NIL) (|newq| (P)) (#7=#:G222 NIL) (|toCheck| #3#)
          (|v| (V)) (|q| (P)))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |RSETGCD;toseInvertibleSet;PTSL;7|
        ...
        (SPROG
         ((|toSave| (|List| TS)) (|inv| (|List| TS)) (|ts_h| (TS)) (|h| (P))
          (|g| (P)) (#1=#:G257 NIL) (|gwt| NIL)
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|ts_v+| (TS)) (|ts_v-| (TS)) (|ts_v| (P)) (#2=#:G238 NIL)
          (#3=#:G255 NIL) (|newq| (P)) (#4=#:G256 NIL) (|bwt| NIL)
          (|toCheck|
           (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
...
(SDEFUN |RSETGCD;toseSquareFreePart_wip|
        ...
        (SPROG
         ((|lpwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|sfp| (P)) (|g| (P)) (|us| (TS)) (#1=#:G267 NIL) (|gwt| NIL)
...
(SDEFUN |RSETGCD;prepareSubResAlgo;2PTSL;11|
        ...
        (SPROG
         ((|toSee| (|List| #1#))
          ...
          (|newp2| (P)) (|s| (P)) (#2=#:G276 NIL) (|p3| (P)) (#3=#:G289 NIL)
          (|bwt| NIL)
          (|lbwt| (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
...
(SDEFUN |RSETGCD;internalLastSubResultant;2PTS2BL;13|
        ...
        (SPROG
         ((|toSave| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          ...
          (|s| (P)) (#1=#:G304 NIL) (|p3| (P)) (#2=#:G310 NIL)
          (|e|
                 ...
                 (COND ((QEQCAR |e| 0) (QCDR |e|))
                       ((SPADCALL |ts| (QREFELT $ 102))
                        (SEQ
                         ...
                         (EXIT (PROGN (LETT #2# |toSave|) (GO #3=#:G309)))))
                       (#4='T
                        (SEQ
                         (COND
                          (|b1|
...
(SDEFUN |RSETGCD;internalLastSubResultant;LVBL;14|
        ((|llpwt| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
         ...
         ($ (|List| (|Record| (|:| |val| P) (|:| |tower| TS)))))
        (SPROG
         ((#1=#:G339 NIL) (|s| (P)) (|p2| (P)) (|p1| (P)) (|#G80| (P))
          (|#G79| (P))
          (|toReturn| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (#2=#:G338 NIL) (|p3| (P)) (|delta| (|NonNegativeInteger|))
          (#3=#:G323 NIL)
          (|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS)))
          (#4=#:G335 NIL) (#5=#:G337 NIL) (|bwt| NIL)
          (|lbwt| (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (|ts| (TS)) (#6=#:G336 NIL))
         (SEQ
          (EXIT
...
(DEFUN |RegularTriangularSetGcdPackage| (&REST #1=#:G353)
  (SPROG NIL
         (PROG (#2=#:G354)
           (RETURN
            (COND
