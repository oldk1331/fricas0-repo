...
(SDEFUN |RSETGCD;toseInvertible?;PTSB;5|
        ...
        (SPROG
         ((|q| (P)) (|v| (V))
          ...
          (|bwt| NIL) (#1=#:G85 NIL) (#2=#:G83 NIL) (#3=#:G71 NIL) (|ts_v| (P))
          (|ts_v-| (TS))
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|gwt| NIL) (#4=#:G86 NIL) (|g| (P)) (#5=#:G84 NIL) (#6=#:G82 NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |q|
...
(SDEFUN |RSETGCD;toseInvertible?;PTSL;6|
        ...
        (SPROG
         ((|q| (P)) (|v| (V))
          ...
          (#2=#:G119 NIL) (|newq| (P)) (#3=#:G118 NIL) (#4=#:G95 NIL)
          (|ts_v| (P)) (|ts_v-| (TS)) (|ts_v+| (TS))
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|gwt| NIL) (#5=#:G120 NIL) (|g| (P)) (|ts_g| (TS)) (|h| (P))
          (|ts_h| (TS)) (|inv| #1#) (#6=#:G121 NIL) (|bwt| NIL) (#7=#:G122 NIL)
          (|lbwt|
           (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS)))))
         (SEQ
          (EXIT
...
(SDEFUN |RSETGCD;toseInvertibleSet;PTSL;7|
        ...
        (SPROG
         ((|k| (|Record| (|:| |arg1| P) (|:| |arg3| TS)))
          ...
          (|toCheck|
           (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (|bwt| NIL) (#1=#:G153 NIL) (|newq| (P)) (#2=#:G152 NIL)
          (#3=#:G135 NIL) (|ts_v| (P)) (|ts_v-| (TS)) (|ts_v+| (TS))
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|gwt| NIL) (#4=#:G154 NIL) (|g| (P)) (|h| (P)) (|ts_h| (TS))
...
(SDEFUN |RSETGCD;toseSquareFreePart_wip|
        ...
        (SPROG
         ((|v| (V)) (|q| (P))
          (|lgwt| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|gwt| NIL) (#1=#:G164 NIL) (|us| (TS)) (|g| (P)) (|sfp| (P))
...
(SDEFUN |RSETGCD;prepareSubResAlgo;2PTSL;11|
        ...
        (SPROG
         ((|v| (V)) (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS)))
          ...
          (|bwt| NIL) (#2=#:G186 NIL) (|p3| (P)) (#3=#:G173 NIL) (|s| (P))
          (|newp2| (P))
          (|toSave|
         ...
         ((|k|
          ...
          (|e|
           (|Union| (|List| (|Record| (|:| |val| P) (|:| |tower| TS)))
                    "failed"))
          (#1=#:G207 NIL) (|p3| (P)) (#2=#:G201 NIL) (|s| (P))
                 ...
                 (COND ((QEQCAR |e| 0) (QCDR |e|))
                       ((SPADCALL |ts| (QREFELT % 102))
                        (SEQ
                         ...
                         (EXIT (PROGN (LETT #1# |toSave|) (GO #3=#:G206)))))
                       (#4='T
                        (SEQ
                         (COND
                          (|b1|
...
(SDEFUN |RSETGCD;internalLastSubResultant;LVBL;14|
        ...
        (SPROG
         ((#1=#:G233 NIL) (|ts| (TS))
          (|lbwt| (|List| (|Record| (|:| |val| (|Boolean|)) (|:| |tower| TS))))
          (|bwt| NIL) (#2=#:G234 NIL) (#3=#:G232 NIL)
          (|lpwt| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS)))
          (|toSee| (|List| (|Record| (|:| |val| (|List| P)) (|:| |tower| TS))))
          (#4=#:G220 NIL) (|delta| (|NonNegativeInteger|)) (|p3| (P))
          (#5=#:G235 NIL)
          (|toReturn| (|List| (|Record| (|:| |val| P) (|:| |tower| TS))))
          (|#G79| (P)) (|#G80| (P)) (|p1| (P)) (|p2| (P)) (|s| (P))
          (#6=#:G236 NIL))
         (SEQ
          (EXIT
