...
(DEFUN |RealRootCharacterizationCategory| (&REST #1=#:G108)
  (LET (#2=#:G109)
    (COND
     ((SETQ #2#
    ...
    (RETURN
     (PROG1
         (LETT #1#
                       ...
                       (LETT |RealRootCharacterizationCategory;CAT|
                             (|Join| (|SetCategory|)
                                     (|mkCategory|
                                      '(((|sign| ((|Integer|) |t#2| $)) T)
                                        ((|zero?| ((|Boolean|) |t#2| $)) T)
                                        ((|negative?| ((|Boolean|) |t#2| $)) T)
                                        ((|positive?| ((|Boolean|) |t#2| $)) T)
                                        ((|recip|
                                          ((|Union| |t#2| "failed") |t#2| $))
                                         T)
                                        ((|definingPolynomial| (|t#2| $)) T)
                                        ((|allRootsOf| ((|List| $) |t#2|)) T)
                                        ((|rootOf|
                                          ((|Union| $ "failed") |t#2|
                                           (|PositiveInteger|)))
                                         T)
                                        ((|approximate| (|t#1| |t#2| $ |t#1|))
                                         T)
                                        ((|relativeApprox|
                                          (|t#1| |t#2| $ |t#1|))
                                         T))
               ...
               . #2#)
       (SETELT #1# 0
               (LIST '|RealRootCharacterizationCategory| (|devaluate| |t#1|)
                     (|devaluate| |t#2|))))))) 
