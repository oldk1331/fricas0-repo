...
(SDEFUN |LWORD;lyndon?;FmB;1| ((|w| (|FreeMonoid| |VarSet|)) (% (|Boolean|)))
        (SPROG ((|f| (|FreeMonoid| |VarSet|)) (#1=#:G123 NIL))
               (SEQ
                (EXIT
...
(SDEFUN |LWORD;factor;FmL;6| ((|w| (|FreeMonoid| |VarSet|)) (% (|List| %)))
        (SPROG ((|l| (|List| %)) (#1=#:G150 NIL) (|u| NIL) (#2=#:G149 NIL))
               (SEQ
                (COND ((SPADCALL |w| (|spadConstant| % 9) (QREFELT % 11)) NIL)
                      ('T
                       (SEQ
...
(SDEFUN |LWORD;LyndonWordsList1;LPiOda;10|
        ...
        (SPROG
         ((#1=#:G181 NIL) (|lbase1| (|List| %)) (#2=#:G189 NIL) (|b| NIL)
          (#3=#:G188 NIL) (|a| NIL) (#4=#:G187 NIL) (|i| NIL) (#5=#:G186 NIL)
          (#6=#:G185 NIL) (#7=#:G184 NIL) (|ll| NIL) (#8=#:G183 NIL) (|w| NIL)
          (#9=#:G182 NIL) (|base| (|OneDimensionalArray| (|List| %)))
          (#10=#:G156 NIL))
         (SEQ
          (EXIT
           (COND ((NULL |vl|) (|error| "empty list"))
                 ('T
                  (SEQ
                   ...
                   (EXIT (PROGN (LETT #1# |base|) (GO #11=#:G180)))))))
          #11# (EXIT #1#)))) 

(SDEFUN |LWORD;LyndonWordsList;LPiL;11|
        ((|vl| (|List| |VarSet|)) (|n| (|PositiveInteger|)) (% (|List| %)))
        (SPROG
         ((#1=#:G191 NIL) (#2=#:G190 #3=(|List| %)) (#4=#:G192 #3#)
          (#5=#:G195 NIL) (|i| NIL) (|v| (|OneDimensionalArray| (|List| %))))
