                    ...
                    (|:| |factors|
                         (|List|
                          (|Record|
                           ...
                           (|:| |pow| (|NonNegativeInteger|))))))))
        (SPROG ((#1=#:G157 NIL) (|lff| NIL) (#2=#:G156 NIL))
               (SEQ
                (CONS (QCAR |lfg|)
                      (PROGN
                       (LETT #2# NIL)
                    ...
                    (|:| |factors|
                         (|List|
                          (|Record|
                           ...
                           (|:| |pow| (|NonNegativeInteger|))))))))
        (SPROG
         ((#2=#:G203 NIL) (|uum1| (R)) (|lcfacs| (R)) (#3=#:G200 NIL)
          (#4=#:G199 (R)) (#5=#:G201 (R)) (#6=#:G221 NIL) (|f| NIL)
          (|factorlist|
           (|List|
          ...
          (|auxfl|
           (|List|
            #7=(|Record| (|:| |irr| (|SparseUnivariatePolynomial| P))
                         (|:| |pow| (|NonNegativeInteger|)))))
          (#8=#:G220 NIL) (|lfp| NIL) (#9=#:G219 NIL)
          (|lf| (|List| (|SparseUnivariatePolynomial| P)))
          (|ldeg| (|List| #10=(|NonNegativeInteger|))) (#11=#:G188 NIL)
          (#12=#:G187 #10#) (#13=#:G189 #10#) (#14=#:G218 NIL) (|fc| NIL)
          (#15=#:G217 NIL) (|xx| NIL) (#16=#:G216 NIL) (|coefs| (|List| P))
          (#17=#:G215 NIL) (|lff| NIL) (#18=#:G214 NIL) (|lcont| (P))
          (|lfg|
           (|Record| (|:| |contp| R)
                     (|:| |factors|
                          (|List|
          ...
          (|ffactor| #20=(|SparseUnivariatePolynomial| P)) (#21=#:G213 NIL)
          (|fact| NIL)
          (|sqqfact|
           (|List|
          ...
          (#22=#:G209 NIL) (#23=#:G171 NIL)
          (|f1| (|SparseUnivariatePolynomial| P))
          (|mdeg| (|NonNegativeInteger|)) (#24=#:G212 NIL) (|ff| NIL)
          (#25=#:G211 NIL) (|lfact| #1#)
          (|umv| (|SparseUnivariatePolynomial| R)) (|lvar| #26=(|List| OV))
          (#27=#:G161 NIL) (#28=#:G160 #26#) (#29=#:G162 #26#) (#30=#:G210 NIL)
          (|cf| NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |INNMFACT;factor;SupMF;3|
        ...
        (SPROG
         ((#1=#:G225 NIL)
          (#2=#:G224 #3=(|Factored| (|SparseUnivariatePolynomial| P)))
          (#4=#:G226 #3#) (#5=#:G230 NIL) (|u| NIL)
          (|flist|
           (|Record| (|:| |contp| R)
                     (|:| |factors|
                          (|List|
...
(SDEFUN |INNMFACT;varChoose|
        ...
        (SPROG
         ((|x| (OV)) (|i| (|Integer|)) (|k| #1#) (#2=#:G233 NIL)
          (#3=#:G232 #1#) (#4=#:G234 #1#) (#5=#:G238 NIL) (|d| NIL))
         (SEQ
          (LETT |k|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |INNMFACT;localNorm|
        ...
        (SPROG
         ((#2=#:G243 NIL) (#3=#:G242 #1#) (#4=#:G244 #1#) (#5=#:G246 NIL)
          (#6=#:G245 #1#) (#7=#:G247 #1#) (|cc| (R)) (#8=#:G251 NIL) (|i| NIL)
          (#9=#:G250 NIL) (|ff| NIL) (#10=#:G240 NIL) (#11=#:G239 #1#)
          (#12=#:G241 #1#) (#13=#:G249 NIL))
         (SEQ
          (COND
...
(SDEFUN |INNMFACT;intChoose|
        ...
        (SPROG
         ((|nfatt| (|NonNegativeInteger|)) (|int| #2=(|List| R))
          (|leadcomp| #2#) (|lffc| (R))
          (|unifact| (|List| (|SparseUnivariatePolynomial| R))) (#3=#:G322 NIL)
          (|uf| NIL) (#4=#:G321 NIL) (|leadtest| (|Boolean|)) (#5=#:G320 NIL)
          (#6=#:G319 NIL) (#7=#:G304 NIL) (#8=#:G318 NIL) (#9=#:G317 NIL)
          (#10=#:G316 NIL) (#11=#:G315 NIL) (#12=#:G314 NIL) (|ff| NIL)
          (#13=#:G313 NIL) (#14=#:G312 NIL) (#15=#:G311 NIL)
          ...
          (|newm| (|SparseUnivariatePolynomial| R)) (#16=#:G270 NIL)
          (#17=#:G264 NIL) (#18=#:G263 #19=(|Boolean|)) (#20=#:G265 #19#)
          (#21=#:G310 NIL) (|epl| NIL) (|leadcomp1| #2#) (#22=#:G309 NIL)
          (|pol| NIL) (#23=#:G308 NIL) (|lval| (|List| R)) (#24=#:G307 NIL)
          (|i| NIL) (#25=#:G306 NIL) (#26=#:G305 NIL) (|testp| (|Boolean|))
...
(SDEFUN |INNMFACT;simplify|
        ...
        (SPROG
         ((|flead|
          ...
          (|pol1| (P)) (|i| (|NonNegativeInteger|)) (#2=#:G337 NIL) (|x| NIL))
...
(SDEFUN |INNMFACT;intfact1|
        ...
        (SPROG
         ((|factfin| (|List| (|SparseUnivariatePolynomial| P))) (#1=#:G506 NIL)
          (|ff| NIL) (#2=#:G505 NIL)
          (|ffin| (|Union| (|List| (|SparseUnivariatePolynomial| P)) "failed"))
          (|umd| (|SparseUnivariatePolynomial| P)) (#3=#:G486 NIL)
          (|unifact| (|List| (|SparseUnivariatePolynomial| R))) (#4=#:G504 NIL)
          (|unif| NIL) (#5=#:G503 NIL) (|dd| (R)) (|lpol| (|List| P))
          (|dist|
          ...
          (|check|
           (|Union|
            (|Record| (|:| |inval| (|List| (|List| R)))
                      ...
                      (|:| |lu| R) (|:| |complead| (|List| R)))
            #8="failed"))
          (|leadpol| (|List| P)) (#9=#:G502 NIL) (#10=#:G501 NIL)
          (|polcase| (|Boolean|)))
         (SEQ
          (EXIT
...
(SDEFUN |INNMFACT;monicize|
        ...
        (SPROG
         ((|ans| (|SparseUnivariatePolynomial| P)) (|prod| (P)) (#1=#:G525 NIL)
          (|n| #2=(|NonNegativeInteger|)) (|lc| (P)) (|i| #2#) (#3=#:G522 NIL))
                    ...
                    (|:| |factors|
                         (|List|
                          (|Record| (|:| |irr| P)
                                    (|:| |pow| (|NonNegativeInteger|))))))))
        (SPROG
         ((#1=#:G590 NIL) (|lcfacs| (R)) (#2=#:G587 NIL) (#3=#:G586 (R))
          (#4=#:G588 (R)) (#5=#:G602 NIL) (|f| NIL)
          (|factorlist|
           (|List|
            (|Record| (|:| |irr| P) (|:| |pow| (|NonNegativeInteger|)))))
          (|auxfl|
          ...
          (#7=#:G601 NIL) (|lfp| NIL) (#8=#:G600 NIL)
          (|lf| (|List| (|SparseUnivariatePolynomial| P)))
          (|um| (|SparseUnivariatePolynomial| P))
          (|ldeg| (|List| (|NonNegativeInteger|))) (#9=#:G599 NIL)
          (|lcterm| NIL) (|ffactor| (P)) (#10=#:G567 NIL) (|pc| (P))
          (|lvar| (|List| OV)) (|x| (OV))
          (|varch|
           (|Record| (|:| |npol| (|SparseUnivariatePolynomial| P))
                     (|:| |nvar| (|List| OV))
                     (|:| |newdeg| (|List| (|NonNegativeInteger|)))))
          (#11=#:G598 NIL) (#12=#:G554 NIL) (|lcont| (P))
          (|ffexp| #13=(|NonNegativeInteger|)) (#14=#:G597 NIL) (|fact| NIL)
          (|sqqfact|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| P) (|:| |exponent| #13#))))
          (|flead| (|Record| (|:| |contp| R) (|:| |factors| (|List| #6#))))
          (|sqfacs| (|Factored| P)) (#15=#:G542 NIL)
          (#16=#:G541 #17=(|Boolean|)) (#18=#:G543 #17#) (#19=#:G596 NIL)
...
(SDEFUN |INNMFACT;factor;PMF;17|
        ((|m| (P))
         ...
         ($ (|Factored| P)))
        (SPROG
         ((#1=#:G606 NIL) (#2=#:G605 #3=(|Factored| P)) (#4=#:G607 #3#)
          (#5=#:G610 NIL) (|u| NIL)
          (|flist|
           (|Record| (|:| |contp| R)
                     (|:| |factors|
...
(DEFUN |InnerMultFact| (&REST #1=#:G611)
  (SPROG NIL
         (PROG (#2=#:G612)
           (RETURN
            (COND
