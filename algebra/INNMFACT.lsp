...
(SDEFUN |INNMFACT;supFactor|
        ...
        (SPROG
         ((#2=#:G197 NIL) (|uum1| (R)) (|lcfacs| (R)) (#3=#:G194 NIL)
          ...
          (|auxfl|
           (|List|
            #7=(|Record| (|:| |irr| (|SparseUnivariatePolynomial| P))
                         (|:| |pow| (|NonNegativeInteger|)))))
          (#8=#:G214 NIL) (|lfp| NIL) (#9=#:G213 NIL)
          (|lf| (|List| (|SparseUnivariatePolynomial| P)))
          (|ldeg| (|List| #10=(|NonNegativeInteger|))) (#11=#:G183 NIL)
          (#12=#:G182 #10#) (#13=#:G184 #10#) (#14=#:G212 NIL) (|fc| NIL)
          (#15=#:G211 NIL) (|xx| NIL) (#16=#:G210 NIL) (|coefs| (|List| P))
          (#17=#:G209 NIL) (|lff| NIL) (#18=#:G208 NIL) (|lcont| (P))
          (|lfg|
           (|Record| (|:| |contp| R)
                     (|:| |factors|
                          (|List|
          ...
          (|ffactor| #20=(|SparseUnivariatePolynomial| P)) (#21=#:G207 NIL)
          (|fact| NIL)
          (|sqqfact|
           (|List|
          ...
          (#22=#:G203 NIL) (#23=#:G169 NIL)
          (|f1| (|SparseUnivariatePolynomial| P))
          (|mdeg| (|NonNegativeInteger|)) (#24=#:G206 NIL) (|ff| NIL)
          (#25=#:G205 NIL) (|lfact| #1#)
          (|umv| (|SparseUnivariatePolynomial| R)) (|lvar| #26=(|List| OV))
          (#27=#:G160 NIL) (#28=#:G159 #26#) (#29=#:G161 #26#) (#30=#:G204 NIL)
          (|cf| NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |INNMFACT;localNorm|
        ...
        (SPROG
         ((#2=#:G237 NIL) (#3=#:G236 #1#) (#4=#:G238 #1#) (#5=#:G240 NIL)
          ...
          (#9=#:G244 NIL) (|ff| NIL) (#10=#:G234 NIL) (#11=#:G233 #1#)
          (#12=#:G235 #1#) (#13=#:G243 NIL))
         (SEQ
          (COND
...
(SDEFUN |INNMFACT;intChoose|
        ...
        (SPROG
         ((|nfatt| (|NonNegativeInteger|)) (|int| #2=(|List| R))
          ...
          (|newm| (|SparseUnivariatePolynomial| R)) (#16=#:G261 NIL)
          (#17=#:G255 NIL) (#18=#:G254 #19=(|Boolean|)) (#20=#:G256 #19#)
          (#21=#:G295 NIL) (|epl| NIL) (|leadcomp1| #2#) (#22=#:G294 NIL)
          (|pol| NIL) (#23=#:G293 NIL) (|lval| (|List| R)) (#24=#:G292 NIL)
          (|i| NIL) (#25=#:G291 NIL) (#26=#:G290 NIL)
...
(SDEFUN |INNMFACT;intfact1|
        ...
        (SPROG
         ((|factfin| (|List| (|SparseUnivariatePolynomial| P))) (#1=#:G474 NIL)
          ...
          (|umd| (|SparseUnivariatePolynomial| P)) (#3=#:G455 NIL)
          (|unifact| (|List| (|SparseUnivariatePolynomial| R))) (#4=#:G472 NIL)
          (|unif| NIL) (#5=#:G471 NIL) (|dd| (R)) (|lpol| (|List| P))
          (|dist|
          ...
          (|check|
           (|Union|
            (|Record| (|:| |inval| (|List| (|List| R)))
                      ...
                      (|:| |lu| R) (|:| |complead| (|List| R)))
            #8="failed"))
          (|leadpol| (|List| P)) (#9=#:G470 NIL) (#10=#:G469 NIL)
          (|polcase| (|Boolean|)))
         (SEQ
          (EXIT
...
(SDEFUN |INNMFACT;mFactor|
        ...
        (SPROG
         ((#1=#:G552 NIL) (|lcfacs| (R)) (#2=#:G549 NIL) (#3=#:G548 (R))
          ...
          (#7=#:G563 NIL) (|lfp| NIL) (#8=#:G562 NIL)
          (|lf| (|List| (|SparseUnivariatePolynomial| P)))
          (|um| (|SparseUnivariatePolynomial| P))
          (|ldeg| (|List| (|NonNegativeInteger|))) (#9=#:G561 NIL)
          (|lcterm| NIL) (|ffactor| (P)) (#10=#:G531 NIL) (|pc| (P))
          (|lvar| (|List| OV)) (|x| (OV))
          (|varch|
           (|Record| (|:| |npol| (|SparseUnivariatePolynomial| P))
                     (|:| |nvar| (|List| OV))
                     (|:| |newdeg| (|List| (|NonNegativeInteger|)))))
          (#11=#:G560 NIL) (#12=#:G519 NIL) (|lcont| (P))
          (|ffexp| #13=(|NonNegativeInteger|)) (#14=#:G559 NIL) (|fact| NIL)
          (|sqqfact|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| P) (|:| |exponent| #13#))))
          (|flead| (|Record| (|:| |contp| R) (|:| |factors| (|List| #6#))))
          (|sqfacs| (|Factored| P)) (#15=#:G508 NIL)
          (#16=#:G507 #17=(|Boolean|)) (#18=#:G509 #17#) (#19=#:G558 NIL)
...
(DEFUN |InnerMultFact| (&REST #1=#:G573)
  (SPROG NIL
         (PROG (#2=#:G574)
           (RETURN
            (COND
