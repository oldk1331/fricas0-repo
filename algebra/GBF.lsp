...
(SDEFUN |GBF;createGroebnerBases|
        ((|basis|
         ...
         (% (|List| (|List| |Dpol|))))
        (SPROG
         ((|p| (|Dpol|)) (|h| (|Dpol|)) (|q| NIL) (#1=#:G58 NIL) (#2=#:G59 NIL)
          (|nPq| (|Union| |Dpol| #3="failed")) (#4=#:G21 NIL)
          (|stopDividing| #5=(|Boolean|)) (|terminateWithBasis| #5#)
          (|irreducibleFactors| (|List| |Dpol|)) (|doSplitting?| #5#)
          (#6=#:G60 NIL) (|fnP| (|Dpol|)) (|allReducedFactors| (|List| |Dpol|))
          (|nP| (|Dpol|)) (#7=#:G57 NIL) (#8=#:G61 NIL)
          (|newInputPolys| (|List| |Dpol|)) (#9=#:G62 NIL) (#10=#:G63 NIL)
          (|newBasis| (|List| |Dpol|)))
         (SEQ (LETT |doSplitting?| NIL) (LETT |terminateWithBasis| NIL)
              ...
              (EXIT
               (COND
                (|doSplitting?|
                 (SEQ
                  (SEQ (LETT #8# |allReducedFactors|) G190
                       (COND
                        ((OR (ATOM #8#) (PROGN (LETT |fnP| (CAR #8#)) NIL))
                         (GO G191)))
                       (SEQ
                        (EXIT
                         (COND
...
(SDEFUN |GBF;createAllFactors| ((|p| (|Dpol|)) (% (|List| |Dpol|)))
        (SPROG
         ((#1=#:G70 NIL) (|el| NIL) (#2=#:G71 NIL) (|loF| (|List| |Dpol|)))
         (SEQ
          (LETT |loF|
                (PROGN
                 (LETT #1# NIL)
         ...
         (%
          (|List|
           (|Record| (|:| |lcmfij| |Expon|)
                     ...
                     (|:| |polj| |Dpol|)))))
        (SPROG
         ((|totdegreeOfp| (|NonNegativeInteger|)) (#1=#:G82 NIL) (|q| NIL)
          (#2=#:G83 NIL)
          (|lcP|
           (|List|
            (|Record| (|:| |lcmfij| |Expon|)
...
(SDEFUN |GBF;factorGroebnerBasis;LBL;7|
        ((|basis| (|List| |Dpol|)) (|info| (|Boolean|))
         (% (|List| (|List| |Dpol|))))
        (SPROG
         ((|p| NIL) (#1=#:G100 NIL) (#2=#:G101 NIL) (|el| NIL) (#3=#:G102 NIL)
          (|foundAReducible| (|Boolean|)))
...
(SDEFUN |GBF;groebnerFactorize;2LBL;9|
        ...
        (SPROG ((#1=#:G113 NIL) (|p| NIL) (#2=#:G114 NIL))
               (SEQ
                          ...
                          (#3#
                           (SEQ
                            (LETT |basis|
                                  (PROGN
                                   (LETT #1# NIL)
                                   (SEQ (LETT |p| NIL) (LETT #2# |basis|) G190
                                        (COND
                                         ((OR (ATOM #2#)
