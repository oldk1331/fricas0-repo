...
(DEFUN |DoubleFloatMatrix;| ()
  (SPROG
   ((|dv$| NIL) ($ NIL) (#1=#:G2438 NIL) (#2=#:G2439 NIL) (#3=#:G2437 NIL)
    (|pv$| NIL))
   (PROGN
...
(MAKEPROP '|DoubleFloatMatrix| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|Integer|) |DFMAT;minRowIndex;$I;1|
              ...
              (|SingleInteger|) (|String|) (|HashState|) (|Mapping| 25 14)
              (|Void|) (|List| 44) (|List| $) (|Union| 14 '"one")
              (|DoubleFloatVector|) (|List| 22) (|Mapping| 14 6 6)
