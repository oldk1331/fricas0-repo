...
(DEFUN |LinearOrdinaryDifferentialOperator2| (&REST #1=#:G132)
  (SPROG NIL
         (PROG (#2=#:G133)
           (RETURN
            (COND
...
(DEFUN |LinearOrdinaryDifferentialOperator2;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G130 NIL) (#2=#:G131 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL)
    (DV$1 NIL))
   (PROGN
           ...
           (CONS
            (|makeByteWordVec2| 22
                                '(0 0 0 0 0 9 1 2 3 4 9 10 11 12 12 14 0 1 11 0
                                  ...
                                  0 0 8 0 0 5 6 0 0 0 0 0 4 5 6 7 9))
            (CONS
             ...
             (CONS
              '#((|LinearOrdinaryDifferentialOperatorCategory| 6)
                 ...
                 (|CoercibleFrom| 6) (|BasicType|) (|CoercibleTo| 43)
