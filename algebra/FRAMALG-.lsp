  ...
  (PROG (#1=#:G124 |i| |j| |b| |m| |n|)
    (RETURN
     (SEQ
      ...
      (SEQ (LETT |j| 1 . #2#) (LETT |i| (SPADCALL |b| (QREFELT $ 32)) . #2#)
...
(DEFUN |FRAMALG-;minimalPolynomial;SUP;11| (|x| $)
  (PROG (#1=#:G130 #2=#:G129 #3=#:G131 #4=#:G135 |i| |v| |y| #5=#:G134 |m| |n|)
    (RETURN
     (SEQ
      ...
      (SEQ (LETT |i| 1 . #6#) (LETT #5# (+ |n| 1) . #6#) G190
           ...
           (SEQ (SPADCALL |m| |i| (SPADCALL |y| (QREFELT $ 10)) (QREFELT $ 51))
               ...
               (PROGN
                (LETT #3#
                      (SPADCALL (SPADCALL |v| (+ |i| 1) (QREFELT $ 54)) |i|
                                (QREFELT $ 45))
                      . #6#)
                (COND (#1# (LETT #2# (SPADCALL #2# #3# (QREFELT $ 55)) . #6#))
