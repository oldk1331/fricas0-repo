...
(SDEFUN |FMTMJAX;altsupersub;IM;27!0| ((|prec| NIL) (|args| NIL) ($$ NIL))
        (PROG (% |p|)
          ...
          (RETURN
           (PROGN
            (SPROG
             ((|bx| NIL) (|tu| NIL) (|tl| NIL) (#1=#:G234 NIL) (|l| NIL)
              (#2=#:G235 NIL) (|u| NIL) (|bu| NIL) (|lu| NIL) (|bl| NIL)
              (|ll| NIL) (|b| NIL) (#3=#:G233 NIL) (|a| NIL) (|i| NIL)
              (|ba| NIL))
             (SEQ
              (LETT |ba|
                    (SPADCALL (SPADCALL |args| (QREFELT % 72)) |p|
...
(SDEFUN |FMTMJAX;prime;IM;28!0| ((|prec| NIL) (|args| NIL) ($$ NIL))
        (PROG (% |p|)
          ...
          (RETURN
           (PROGN
            (SPROG
             ((|b2| NIL) (|r| NIL) (#1=#:G240 NIL) (#2=#:G238 NIL) (|n| NIL)
              (|b1| NIL))
             (SEQ
              (LETT |b1|
                    (SPADCALL
               ...
               (SEQ
                (EXIT
                 (SEQ
                  ...
                  (EXIT (PROGN (LETT #1# |oh|) (GO #6=#:G660)))))
                #6# (EXIT #1#)))) 
