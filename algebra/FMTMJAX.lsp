...
(SDEFUN |FMTMJAX;altsupersub;IM;27!0| ((|prec| NIL) (|args| NIL) ($$ NIL))
        (PROG ($ |p|)
          ...
          (RETURN
           (PROGN
            (SPROG
             ((|bx| NIL) (|tu| NIL) (|tl| NIL) (#1=#:G233 NIL) (|l| NIL)
              (#2=#:G234 NIL) (|u| NIL) (|bu| NIL) (|lu| NIL) (|bl| NIL)
              (|ll| NIL) (|b| NIL) (#3=#:G232 NIL) (|a| NIL) (|i| NIL)
              (|ba| NIL))
             (SEQ
              (LETT |ba|
                    (SPADCALL (SPADCALL |args| (QREFELT $ 72)) |p|
...
(SDEFUN |FMTMJAX;prime;IM;28!0| ((|prec| NIL) (|args| NIL) ($$ NIL))
        (PROG ($ |p|)
          ...
          (RETURN
           (PROGN
            (SPROG
             ((|b2| NIL) (|r| NIL) (#1=#:G239 NIL) (#2=#:G237 NIL) (|n| NIL)
              (|b1| NIL))
             (SEQ
              (LETT |b1|
                    (SPADCALL
               ...
               (SEQ
                (EXIT
                 (SEQ
                  ...
                  (EXIT (PROGN (LETT #1# |oh|) (GO #6=#:G659)))))
                #6# (EXIT #1#)))) 
