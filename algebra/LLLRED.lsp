...
(SDEFUN |LLLRED;extendedLLL!;MNniM;2|
        ...
        (SPROG
         ((|k| (|NonNegativeInteger|)) (|tmp| (|Float|)) (#1=#:G169 NIL)
          (|i| NIL) (#2=#:G168 NIL) (|v2i| #3=(|Float|)) (|v1i| #4=(|Float|))
          (#5=#:G167 NIL) (|m| #6=(|Float|)) (|nv2| #6#) (|nv1| #4#)
          (|k1| (|Integer|)) (|del1| #3#) (#7=#:G166 NIL) (#8=#:G165 NIL)
          (|q| (|Integer|)) (|j| NIL) (|kmax| (|Integer|))
          (|iters| (|Integer|)) (#9=#:G164 NIL) (|v1| #10=(|Vector| (|Float|)))
