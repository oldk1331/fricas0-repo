...
(SDEFUN |CYCLOT2;filter_prods|
        ...
        (SPROG
         ((|res| (|List| #1#)) (#2=#:G149 NIL) (|c| (|Integer|))
          (#3=#:G150 NIL) (|pr| NIL))
                    ...
                    (EXIT
                     (SEQ (LETT |c| (- (* |p| |pr|)))
                          (EXIT
                           (COND
                            ((> (ABS |c|) |mp|)
                             (PROGN (LETT #2# |$NoValue|) (GO #4=#:G144)))
...
(SDEFUN |CYCLOT2;recursive_check2|
        ...
        (SPROG
         ((#1=#:G170 NIL) (|i| NIL) (#2=#:G169 NIL) (#3=#:G168 NIL)
...
(SDEFUN |CYCLOT2;maybe_cyclotomic2?|
        ...
        (SPROG
         ((#1=#:G199 NIL) (|i| NIL) (|res| (|PositiveInteger|))
          (|two_fac| (|Boolean|)))
         (SEQ
          (LETT |two_fac|
                (COND
...
(SDEFUN |CYCLOT2;maybe_cyclotomic?|
        ...
        (SPROG
         ((|m| (|Integer|)) (#1=#:G208 NIL) (#2=#:G209 NIL) (|i| NIL)
          (|pa| (|PrimitiveArray| (|Integer|))) (#3=#:G200 NIL)
          (|mp| (|Integer|)))
         (SEQ
          (EXIT
                      ...
                      (EXIT
                       (COND
                        ((< (SPADCALL |p| (QREFELT $ 17)) |m|)
                         (LETT |m| (- |m| |m1|)))
                        ((> (SPADCALL |p| (QREFELT $ 17)) |m|)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #4=#:G207)))
                        ('T
                         (SEQ
...
(SDEFUN |CYCLOT2;cyclotomic?;SupU;7|
        ...
        (SPROG
         ((|m| (|Integer|)) (|tcf| (|Integer|)) (#2=#:G247 NIL) (#3=#:G249 NIL)
          (|i| NIL) (#4=#:G248 NIL) (|two_fac| (|Integer|))
          (|pa| (|PrimitiveArray| (|Integer|))) (#5=#:G220 NIL)
          (|mm| #6=(|Integer|)) (#7=#:G211 NIL) (|mm1| (|Integer|))
...
(SDEFUN |CYCLOT2;expand_prods|
        ((|fl| (|List| (|Integer|))) (|k| (|Integer|))
         ($ #1=(|List| (|Integer|))))
        (SPROG
         ((|res| (|List| (|Integer|))) (#2=#:G255 NIL) (|pr1| NIL) (|plk| #1#)
          (|pk| (|Integer|)))
         (SEQ
...
(SDEFUN |CYCLOT2;cyclotomic_SPS2|
        ((|m| (|Integer|)) (|k| (|Integer|))
         ...
         (|do_inv| (|Integer|)) ($ (|Void|)))
        (SPROG
         ((#1=#:G278 NIL) (|i| NIL) (#2=#:G277 NIL) (|p| (|Integer|))
          (#3=#:G276 NIL) (|pl| (|List| (|Integer|))) (|mk| (|Integer|))
          (|pk| (|Integer|)) (#4=#:G275 NIL) (#5=#:G274 NIL))
         (SEQ
          (COND
           ((EQL |k| 1)
            (COND
...
(SDEFUN |CYCLOT2;gen_poly|
        ...
        (SPROG
         ((|tcf| (|Integer|))
          (|res| (|SparseUnivariatePolynomial| (|Integer|))) (#1=#:G283 NIL)
          (#2=#:G289 NIL) (|i| NIL) (#3=#:G288 NIL))
...
(SDEFUN |CYCLOT2;cyclotomic_SPS1|
        ((|m| (|Integer|)) (|fl| (|List| (|Integer|))) (|two_fac| (|Integer|))
         ($ (|SparseUnivariatePolynomial| (|Integer|))))
        (SPROG
         ((|pa| (|PrimitiveArray| (|Integer|))) (#1=#:G290 NIL)
          (|m2| (|Integer|)))
...
(SDEFUN |CYCLOT2;cyclotomic_array;IPa;12|
        ...
        (SPROG
         ((|fl1| (|List| (|Integer|))) (|pa| (|PrimitiveArray| (|Integer|)))
          (#1=#:G298 NIL) (|m2| (|Integer|)) (|m| (|Integer|))
          (|f1| #2=(|Integer|)) (#3=#:G301 NIL) (|fac| NIL)
          (|fl|
           (|List|
...
(SDEFUN |CYCLOT2;inverse_cyclotomic_SPS1|
        ((|m| (|Integer|)) (|fl| (|List| (|Integer|)))
         ($ (|SparseUnivariatePolynomial| (|Integer|))))
        (SPROG
         ((|res| (|SparseUnivariatePolynomial| (|Integer|))) (#1=#:G320 NIL)
          (#2=#:G325 NIL) (|i| NIL) (#3=#:G324 NIL)
          (|pa| (|PrimitiveArray| (|Integer|))) (#4=#:G316 NIL)
          (|m2| (|Integer|)))
         (SEQ (LETT |m2| (QUOTIENT2 |m| 2))
              (LETT |pa|
                    (MAKEARR1
...
(SDEFUN |CYCLOT2;inverse_cyclotomic;ISup;15|
        ((|n| (|Integer|)) ($ (|SparseUnivariatePolynomial| (|Integer|))))
        (SPROG
         ((#1=#:G334 NIL) (|n2| (|Integer|)) (#2=#:G331 NIL)
          (|r1| (|SparseUnivariatePolynomial| (|Integer|))) (|m1| (|Integer|))
...
(SDEFUN |CYCLOT2;mult_lst1|
        ...
        (SPROG
         ((|fp| (|Integer|)) (#1=#:G347 NIL) (|i| NIL) (#2=#:G346 NIL)
          (|m| NIL))
         (SEQ
...
(SDEFUN |CYCLOT2;mult_lst|
        ...
        (SPROG
         ((|res| (|List| (|Integer|))) (#3=#:G358 NIL) (#4=#:G359 NIL)
          (|f1| #1#) (|e| #2#) (#5=#:G360 NIL) (|fac| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |res| (LIST 1))
                            ...
                            (EXIT
                             (COND
                              ((OR (NULL |fli|) (< (|SPADfirst| |fli|) |f1|))
                               (PROGN (LETT #3# |$NoValue|) (GO #7=#:G349)))
                              ((< |f1| (|SPADfirst| |fli|))
...
(SDEFUN |CYCLOT2;gen_lists|
        ...
        (SPROG
         ((|res| #1=(|List| (|List| (|Integer|)))) (|nres| #1#) (#2=#:G369 NIL)
          (|l1| NIL) (#3=#:G368 NIL) (|f1| NIL))
...
(SDEFUN |CYCLOT2;add_mults|
        ...
        (SPROG
         ((|pi| (|SparseUnivariatePolynomial| (|Integer|))) (#1=#:G373 NIL)
          (#2=#:G378 NIL) (|mi| NIL) (|ml| (|List| (|Integer|))))
...
(SDEFUN |CYCLOT2;add_factors|
        ((|fl| (|List| (|Integer|)))
         ...
         ($ (|List| (|SparseUnivariatePolynomial| (|Integer|)))))
        (SPROG
         ((|p1| (|SparseUnivariatePolynomial| (|Integer|))) (#1=#:G401 NIL)
          (|i| NIL) (|k| (|NonNegativeInteger|)) (|m2| (|Integer|))
          (|m| (|Integer|)) (#2=#:G400 NIL) (|f1| NIL) (#3=#:G399 NIL)
          (|fac|
           (|Record| (|:| |factor| (|Integer|))
                     (|:| |exponent| (|NonNegativeInteger|))))
...
(SDEFUN |CYCLOT2;cyclo_decomposition1|
        ...
        (SPROG
         ((|res| (|List| (|SparseUnivariatePolynomial| (|Integer|))))
          (#1=#:G408 NIL) (|fl1| NIL) (|ll| (|List| (|List| (|Integer|))))
          (|pa| (|PrimitiveArray| (|Integer|))) (#2=#:G403 NIL)
          (|m2| (|Integer|)))
         (SEQ (LETT |m2| (QUOTIENT2 |m| 2))
              (LETT |pa|
                    (MAKEARR1
...
(SDEFUN |CYCLOT2;cyclo_decomposition|
        ...
        (SPROG
         ((|m1| #1=(|Integer|)) (|fl1| (|List| (|Integer|))) (|two_fac| #1#)
          (|f1| #2=(|Integer|)) (#3=#:G417 NIL) (|fac| NIL)
          (|fl|
           (|List|
            (|Record| (|:| |factor| #2#)
                      (|:| |exponent| (|NonNegativeInteger|))))))
