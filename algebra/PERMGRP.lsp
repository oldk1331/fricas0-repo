...
(SDEFUN |PERMGRP;shortenWord|
        ...
        (SPROG
         ((|do_res| (|Boolean|)) (|flag1| #1=(|Boolean|))
          (|newlw| (|List| (|NonNegativeInteger|))) (#2=#:G171 NIL)
          (|anzahl| (|NonNegativeInteger|)) (|flag2| #1#)
          (|res| (|List| #3=(|NonNegativeInteger|))) (|test| #3#)
          (#4=#:G175 NIL) (|el| NIL) (|pos| (|Integer|)) (#5=#:G174 NIL)
          (|i| NIL) (|orderList| (|List| (|NonNegativeInteger|)))
          (#6=#:G173 NIL) (|gen| NIL) (#7=#:G172 NIL)
...
(SDEFUN |PERMGRP;times!|
        ...
        (SPROG ((#1=#:G179 NIL) (|i| NIL) (|degree| (|NonNegativeInteger|)))
               (SEQ
...
(SDEFUN |PERMGRP;inv|
        ((|p| |Vector| (|NonNegativeInteger|))
         ($ |Vector| (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G185 NIL) (|i| NIL) (|q| (|Vector| (|NonNegativeInteger|)))
          (|degree| (|NonNegativeInteger|)))
         (SEQ
                    ...
                    (EXIT
                     (COND
                      ((SPADCALL (QAREF1O |p| |i| 1) |i| (QREFELT $ 24))
                       (PROGN
                        (LETT #1# (PROGN (LETT #2# 'NIL . #4#) (GO #5=#:G190))
                              . #4#)
                        (GO #6=#:G188))))))
...
(SDEFUN |PERMGRP;cosetRep1|
        ...
        (SPROG
         ((#3=#:G204 NIL) (|p| (|Integer|))
          ...
          (|oorb| #1#) (#6=#:G205 NIL) (#7=#:G207 NIL) (|n| NIL)
          (#8=#:G206 NIL) (|degree| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |PERMGRP;strip|
        ...
        (SPROG
         ((|word| (|List| (|NonNegativeInteger|)))
          ...
          (|noresult| (|Boolean|)) (#4=#:G222 NIL) (|entry| (|Integer|))
...
(SDEFUN |PERMGRP;orbitInternal|
        ...
        (SPROG
         ((|pos| (|Integer|)) (|orbitList| (|List| #1#)) (|newList| (|List| S))
          (|j| NIL) (|workList| (|List| S)) (#2=#:G232 NIL) (|gen| NIL)
...
(SDEFUN |PERMGRP;ranelt|
        ...
        (SPROG
         ((|numberOfLoops| #1=(|Integer|))
          (|words| (|List| (|NonNegativeInteger|))) (#2=#:G237 NIL)
          (|randomElement| (|Vector| (|NonNegativeInteger|)))
          (|randomInteger| #1#) (#3=#:G235 NIL) (|do_words| (|Boolean|))
...
(SDEFUN |PERMGRP;pointList;$L;11| ((|group| $) ($ |List| S))
        (SPROG
         ((|res| (|List| S)) (|p0| (S)) (#1=#:G252 NIL) (|p| NIL)
          (|support| (|List| S)) (#2=#:G251 NIL) (|perm| NIL))
         (SEQ
          (COND
...
(SDEFUN |PERMGRP;pointList;$L;12| ((|group| $) ($ |List| S))
        (SPROG ((|support| (|Set| S)) (#1=#:G258 NIL) (|perm| NIL))
               (SEQ
                (COND
...
(SDEFUN |PERMGRP;ls_to_lnni|
        ...
        (SPROG
         ((#1=#:G276 NIL) (|pp| NIL) (#2=#:G275 NIL)
          ...
          (|flag| (|Boolean|)) (#3=#:G274 NIL) (|p2| NIL) (|i| NIL)
          (#4=#:G273 NIL) (|p| NIL) (#5=#:G272 NIL))
         (SEQ
          (COND ((NULL |ls|) NIL)
                ('T
                 (SEQ
...
(SDEFUN |PERMGRP;perm_to_vec;LPNniV;14|
        ...
        (SPROG
         ((#1=#:G284 NIL) (|pp| NIL) (#2=#:G285 NIL) (|ip| NIL)
          (|il| #3=(|List| (|NonNegativeInteger|))) (|pl| #3#) (#4=#:G283 NIL)
...
(SDEFUN |PERMGRP;perm_to_vec;LPNniV;15|
        ((|supp| |List| S) (|p| |Permutation| S)
         (|degree| |NonNegativeInteger|) ($ |Vector| (|NonNegativeInteger|)))
        (SPROG
         ((|pos2| (|Integer|)) (|newEl| (S)) (#1=#:G291 NIL) (|i| NIL)
          (|q| (|Vector| (|NonNegativeInteger|))))
         (SEQ
               ...
               (SEQ
                (LETT |newEl|
                      (SPADCALL |p| (SPADCALL |supp| |i| (QREFELT $ 41))
                                (QREFELT $ 42))
                      . #2#)
                (LETT |pos2| (SPADCALL |newEl| |supp| (QREFELT $ 70)) . #2#)
...
(SDEFUN |PERMGRP;orbitWithSvc1|
        ...
        (SPROG
         ((|position| (|Integer|)) (|orbit_size| (|NonNegativeInteger|))
          ...
          (#2=#:G302 NIL) (|i| NIL) (#3=#:G303 NIL) (|grv| NIL)
...
(SDEFUN |PERMGRP;orbitWithSvc|
        ((|group| |List| (|Vector| (|NonNegativeInteger|)))
         ...
         ($ |Record| (|:| |orb| (|List| (|NonNegativeInteger|)))
          (|:| |svc| (|Vector| (|Integer|)))))
        (SPROG
         ((|grpinv| (|List| (|Vector| (|NonNegativeInteger|)))) (#1=#:G307 NIL)
          (|el| NIL))
...
(SDEFUN |PERMGRP;bsgs1|
        ...
        (SPROG
         ((|sizeOfGroup| (|NonNegativeInteger|)) (|k2| #1#) (#2=#:G331 NIL)
          (|j| (|Integer|))
          ...
          (|ran|
           (|Record| (|:| |elt| (|Vector| (|NonNegativeInteger|)))
                     (|:| |lst| (|List| (|NonNegativeInteger|)))))
          (|words2| #3#) (|gpsgs| #4#) (#5=#:G334 NIL)
          (|k| (|List| (|NonNegativeInteger|))) (#6=#:G329 NIL) (#7=#:G333 NIL)
          (|jj| NIL) (|gplength| (|NonNegativeInteger|)) (#8=#:G330 NIL)
          (|k1| (|NonNegativeInteger|))
          (|ort|
           (|Record| (|:| |orb| (|List| (|NonNegativeInteger|)))
                     (|:| |svc| (|Vector| (|Integer|)))))
          (#9=#:G332 NIL) (|i| NIL) (|wordProblem| (|Boolean|))
          (|gp_info|
         ...
         (SEQ
          (EXIT
           (SEQ
            ...
            (LETT |wordProblem| (COND ((NULL |words|) 'NIL) ('T 'T)) . #10#)
            (SEQ
             (EXIT
                    ...
                    (EXIT
                     (COND
                      ((SPADCALL |k1| 1 (QREFELT $ 24))
                       (PROGN (LETT #8# |$NoValue| . #10#) (GO #11=#:G311))))))
            ...
            (COND
             ((OR (NULL |group2|) (< |maxLoops| 0))
              (SEQ (QSETVELT |gp_info| 2 (LIST |i|))
                   ...
                   (EXIT (PROGN (LETT #2# |k1| . #10#) (GO #13=#:G328))))))
            (LETT |k2|
...
(SDEFUN |PERMGRP;reduceGenerators|
        ...
        (SPROG
         ((|i| (|NonNegativeInteger|))
          ...
          (|baseLength| #6#) (#7=#:G355 NIL) (|orbv| #2#) (|base_lst| #1#))
         (SEQ
          ...
          (LETT |i| 1 . #8#)
          (LETT |outlk| (SPADCALL |outl| |kkk| (QREFELT $ 83)) . #8#)
          (SEQ G190
               (COND
                ((NULL
               ...
               (SEQ
                (LETT |pos|
                      (SPADCALL (SPADCALL |outlk| |i| (QREFELT $ 44)) |sgs|
                                (QREFELT $ 91))
                      . #8#)
                (LETT |sgs2| (SPADCALL |sgs| |pos| (QREFELT $ 92)) . #8#)
                (LETT |grpinv2| (SPADCALL |grpinv| |pos| (QREFELT $ 92)) . #8#)
                (LETT |obs2|
                 ...
                 (COND
                  ((EQL (SPADCALL (QCAR |obs2|) (QREFELT $ 22)) |obs_len|)
                   (SEQ
                    ...
                    (LETT |outlk| (SPADCALL |outlk| |i| (QREFELT $ 92)) . #8#)
...
(SDEFUN |PERMGRP;bsgs|
        ...
        (SPROG
         ((|sizeOfGroup| (|NonNegativeInteger|)) (#1=#:G412 NIL) (|j| NIL)
          (|kkk| (|Integer|))
          (|outword| (|List| (|List| (|List| (|NonNegativeInteger|)))))
          ...
          (|orbv|
           (|Vector|
            (|Record| (|:| |orb| (|List| (|NonNegativeInteger|)))
                      (|:| |svc| (|Vector| (|Integer|))))))
          (#2=#:G399 NIL) (|baseOfGroup| (|List| (|NonNegativeInteger|)))
          (#3=#:G411 NIL) (|i| NIL) (|word| #4=(|List| (|NonNegativeInteger|)))
          (|ttt| (|Vector| (|NonNegativeInteger|)))
          (|word2| (|List| (|NonNegativeInteger|))) (#5=#:G410 NIL) (|wdi| NIL)
          (|add_cnt| (|Integer|)) (|noAnswer| #6=(|Boolean|)) (#7=#:G400 NIL)
          (|basePoint| (|NonNegativeInteger|)) (#8=#:G375 NIL)
          (|newBasePoint| (|Boolean|)) (#9=#:G409 NIL) (|p| NIL) (|ii| NIL)
          (|z| #10=(|Vector| (|NonNegativeInteger|)))
          (|ppp|
           (|Record| (|:| |elt| (|Vector| (|NonNegativeInteger|)))
                     (|:| |lst| (|List| (|NonNegativeInteger|)))))
          (|noresult| #6#) (#11=#:G408 NIL) (|jjj| NIL) (|word3| #4#)
          (|y1| (|Vector| (|NonNegativeInteger|))) (#12=#:G407 NIL) (|pt| NIL)
          (#13=#:G406 NIL) (|z0| NIL)
          (|gporbi|
           (|Record| (|:| |orb| (|List| (|NonNegativeInteger|)))
                     (|:| |svc| (|Vector| (|Integer|)))))
          ...
          (#16=#:G405 NIL) (#17=#:G404 NIL)
          (|dummy_rec|
           (|Record| (|:| |orb| (|List| (|NonNegativeInteger|)))
                     (|:| |svc| (|Vector| (|Integer|)))))
          (|newGroup| #15#) (|k| (|NonNegativeInteger|)) (|words| #14#)
          (|q| (|Vector| (|NonNegativeInteger|))) (#18=#:G402 NIL) (|ggg| NIL)
          (#19=#:G403 NIL) (|ggp| NIL) (|gp| (|List| (|Permutation| S)))
          (|tmpv| #10#) (#20=#:G401 NIL)
          (|gp_info|
           (|Record| (|:| |order| (|NonNegativeInteger|))
                     (|:| |sgset| (|List| (|Vector| (|NonNegativeInteger|))))
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |basePoint| 0 . #21=(|PERMGRP;bsgs|))
                ...
                (LETT |outword| NIL . #21#)
                (LETT |outr| (SPADCALL NIL (QREFELT $ 96)) . #21#)
                (LETT |outwordr| (SPADCALL NIL (QREFELT $ 97)) . #21#)
                (LETT |supp| (SPADCALL |group| (QREFELT $ 52)) . #21#)
                (LETT |degree| (LENGTH |supp|) . #21#)
                (LETT |gp_info| (VECTOR 1 NIL NIL #() NIL NIL) . #21#)
                (COND
                 ((EQL |degree| 0)
                  (SEQ (PROGN (RPLACD |group| |gp_info|) (QCDR |group|))
                       (EXIT (PROGN (LETT #20# 1 . #21#) (GO #22=#:G398))))))
                ...
                (LETT |k|
                      (|PERMGRP;bsgs1| |newGroup| 1 |words| |maxLoops| |group|
                       |diff| |outr| |outwordr| $)
                      . #21#)
                (LETT |out| (SPADCALL |outr| (QREFELT $ 81)) . #21#)
                (LETT |outword| (SPADCALL |outwordr| (QREFELT $ 82)) . #21#)
                (LETT |kkk| 1 . #21#)
...
(SDEFUN |PERMGRP;initialize| ((|group| $) ($ |Set| (|Permutation| S)))
        (SPROG
         ((#1=#:G417 NIL) (|gen| NIL) (|gp| (|List| (|Permutation| S)))
...
(SDEFUN |PERMGRP;subgroup| ((|gp1| $) (|gp2| $) ($ |Boolean|))
        (SPROG
         ((#1=#:G428 NIL) (#2=#:G429 NIL) (#3=#:G430 NIL) (|el| NIL)
...
(SDEFUN |PERMGRP;memberInternal|
        ...
        (SPROG
         ((|str|
           (|Record| (|:| |elt| (|Vector| (|NonNegativeInteger|)))
                     (|:| |lst| (|List| (|NonNegativeInteger|)))))
          (|grpv| (|Vector| (|Vector| (|NonNegativeInteger|)))) (#1=#:G444 NIL)
          ...
          (|gp_info|
           (|Record| (|:| |order| (|NonNegativeInteger|))
                     ...
                     (|:| |mp| (|List| S))
                     (|:| |wd| (|List| (|List| (|NonNegativeInteger|))))))
          (#2=#:G442 NIL) (#3=#:G441 NIL) (#4=#:G443 NIL) (|x| NIL)
...
(SDEFUN |PERMGRP;strongGenerators;$L;27|
        ...
        (SPROG
         ((|strongGens| (|List| (|Permutation| S)))
          (|pairs| (|List| (|List| S))) (#1=#:G454 NIL) (|j| NIL)
          (#2=#:G453 NIL) (|i| NIL) (|degree| (|NonNegativeInteger|))
...
(SDEFUN |PERMGRP;base;$L;34| ((|group| $) ($ |List| S))
        (SPROG
         ((|groupBase| (|List| S)) (#1=#:G471 NIL) (|i| NIL)
...
(SDEFUN |PERMGRP;wordInGenerators;P$L;43|
        ((|p| |Permutation| S) (|gp| $) ($ |List| (|NonNegativeInteger|)))
        (SPROG
         ((|outlist| (|List| (|NonNegativeInteger|))) (#1=#:G505 NIL) (|n| NIL)
