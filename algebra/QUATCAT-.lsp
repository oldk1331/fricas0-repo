...
(DEFUN |QUATCAT-;differentiate;SMS;11| (|x| |d| $)
...
(DEFUN |QUATCAT-;retractIfCan;SU;17| (|x| $)
  (SEQ
   (COND
    ((SPADCALL (SPADCALL |x| (QREFELT $ 12)) (QREFELT $ 43))
     (COND
    ...
    (RETURN
     (SEQ
      (COND
       ...
       ((NULL (SPADCALL (SPADCALL |x| (QREFELT $ 11)) (QREFELT $ 43)))
        (SEQ
         (LETT |y|
               (SPADCALL (|spadConstant| $ 38) (SPADCALL |x| (QREFELT $ 12))
                         (SPADCALL |x| (QREFELT $ 14))
                         (SPADCALL |x| (QREFELT $ 15)) (QREFELT $ 16))
         ...
         (EXIT
          (COND
           ...
           (#2='T
            (SPADCALL (SPADCALL (SPADCALL |x| (QREFELT $ 11)) (QREFELT $ 51))
                      (SPADCALL |y| (QREFELT $ 52)) (QREFELT $ 53)))))))
       ((NULL (SPADCALL (SPADCALL |x| (QREFELT $ 12)) (QREFELT $ 43)))
        (SEQ
         (LETT |y|
               ...
               . #1#)
         (LETT |z|
               (SEQ (LETT |part| (SPADCALL '|i| (QREFELT $ 55)) . #1#)
                    (EXIT
                     (COND
                      ...
                      (#2#
                       (SPADCALL
                        (SPADCALL (SPADCALL |x| (QREFELT $ 12)) (QREFELT $ 51))
                        |part| (QREFELT $ 56))))))
               . #1#)
         (EXIT
          (COND ((SPADCALL |y| (QREFELT $ 49)) |z|)
                (#2#
                 (SPADCALL |z| (SPADCALL |y| (QREFELT $ 52))
                           (QREFELT $ 53)))))))
       ((NULL (SPADCALL (SPADCALL |x| (QREFELT $ 14)) (QREFELT $ 43)))
        (SEQ
         (LETT |y|
               (SPADCALL (|spadConstant| $ 38) (|spadConstant| $ 38)
                         (|spadConstant| $ 38) (SPADCALL |x| (QREFELT $ 15))
                         (QREFELT $ 16))
               . #1#)
         (LETT |z|
               (SEQ (LETT |part| (SPADCALL '|j| (QREFELT $ 55)) . #1#)
                    (EXIT
                     (COND
                      ...
                      (#2#
                       (SPADCALL
                        (SPADCALL (SPADCALL |x| (QREFELT $ 14)) (QREFELT $ 51))
                        |part| (QREFELT $ 56))))))
               . #1#)
         (EXIT
          (COND ((SPADCALL |y| (QREFELT $ 49)) |z|)
       ...
       ('T
        (SEQ (LETT |part| (SPADCALL '|k| (QREFELT $ 55)) . #1#)
             (EXIT
              (COND
               ((SPADCALL (SPADCALL |x| (QREFELT $ 15)) (|spadConstant| $ 42)
                          (QREFELT $ 25))
                |part|)
               (#2#
                (SPADCALL
                 (SPADCALL (SPADCALL |x| (QREFELT $ 15)) (QREFELT $ 51)) |part|
                 (QREFELT $ 56)))))))))))) 

(DEFUN |QUATCAT-;inv;2S;19| (|x| $)
  (COND
...
(DEFUN |QUATCAT-;convert;SIf;20| (|x| $)
  (PROG (|l|)
    (RETURN
     (SEQ
      (LETT |l|
            (LIST (SPADCALL '|quatern| (QREFELT $ 63))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 11)) (QREFELT $ 64))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 12)) (QREFELT $ 64))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 14)) (QREFELT $ 64))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 15)) (QREFELT $ 64)))
            |QUATCAT-;convert;SIf;20|)
      (EXIT (SPADCALL |l| (QREFELT $ 66))))))) 

(DEFUN |QUATCAT-;<;2SB;21| (|x| |y| $)
  (COND
   ((SPADCALL (SPADCALL |x| (QREFELT $ 11)) (SPADCALL |y| (QREFELT $ 11))
              (QREFELT $ 25))
    (COND
...
(DEFUN |QUATCAT-;abs;SR;22| (|x| $)
  (SPADCALL (SPADCALL |x| (QREFELT $ 58)) (QREFELT $ 70))) 

(DEFUN |QUATCAT-;rational?;SB;23| (|x| $)
  (COND
   ((SPADCALL (SPADCALL |x| (QREFELT $ 12)) (QREFELT $ 43))
    (COND
     ((SPADCALL (SPADCALL |x| (QREFELT $ 14)) (QREFELT $ 43))
  ...
  (PROG (|pv$| $ |dv$| DV$2 DV$1)
    (RETURN
     (PROGN
      ...
      (COND
       ((|testBitVector| |pv$| 6)
        (QSETREFV $ 61 (CONS (|dispatchFunction| |QUATCAT-;inv;2S;19|) $))))
      (COND
       ((|testBitVector| |pv$| 5)
        (QSETREFV $ 67
      ...
      (COND
       ((|testBitVector| |pv$| 2)
        (QSETREFV $ 71 (CONS (|dispatchFunction| |QUATCAT-;abs;SR;22|) $))))
      (COND
       ((|testBitVector| |pv$| 1)
        (PROGN
         (QSETREFV $ 72
         ...
         (QSETREFV $ 78
                   (CONS (|dispatchFunction| |QUATCAT-;rationalIfCan;SU;25|)
                         $)))))
      $)))) 
