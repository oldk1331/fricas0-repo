...
(SDEFUN |INTTOOLS;kmax;LK;5| ((|l| |List| (|Kernel| F)) ($ |Kernel| F))
        (SPROG ((|ans| (|Kernel| F)) (#1=#:G153 NIL) (|k| NIL))
...
(SDEFUN |INTTOOLS;mkPrim;FSF;11| ((|f| F) (|x| |Symbol|) ($ F))
        (SPROG
         ((#1=#:G195 NIL) (|k| NIL) (#2=#:G194 NIL)
          (|lg| (|List| (|Kernel| F))) (#3=#:G193 NIL) (#4=#:G192 NIL))
         (SEQ
          (LETT |lg|
                (PROGN
                 (LETT #4# NIL)
...
(DEFUN |IntegrationTools| (&REST #1=#:G224)
  (SPROG NIL
         (PROG (#2=#:G225)
           (RETURN
            (COND
...
(MAKEPROP '|IntegrationTools| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'ALGOP
              ...
              (|Union| 86 '#1#) (254 . |isExpt|) (259 . |One|) '#:G135
