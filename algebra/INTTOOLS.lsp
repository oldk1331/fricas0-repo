...
(SDEFUN |INTTOOLS;varselect;LSL;2|
        ((|l| (|List| (|Kernel| F))) (|x| (|Symbol|))
         (% (|List| (|Kernel| F))))
        (SPROG ((#1=#:G123 NIL) (|k| NIL) (#2=#:G122 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |INTTOOLS;kmax;LK;5| ((|l| (|List| (|Kernel| F))) (% (|Kernel| F)))
        (SPROG ((|ans| (|Kernel| F)) (#1=#:G139 NIL) (|k| NIL))
...
(SDEFUN |INTTOOLS;mkPrim;FSF;11| ((|f| (F)) (|x| (|Symbol|)) (% (F)))
        (SPROG
         ((#1=#:G184 NIL) (|k| NIL) (#2=#:G183 NIL)
          (|lg| (|List| (|Kernel| F))) (#3=#:G182 NIL) (#4=#:G181 NIL))
         (SEQ
          (LETT |lg|
                (PROGN
                 (LETT #4# NIL)
...
(DEFUN |IntegrationTools| (&REST #1=#:G195)
  (SPROG NIL
         (PROG (#2=#:G196)
           (RETURN
            (COND
