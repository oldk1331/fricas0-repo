        ...
        ((|sp1|
         ...
         (%
          (|Record| (|:| |lcmfij| |Expon|)
                    ...
                    (|:| |polj| |Dpol|))))
        (SPROG
         ((|p1| (|Dpol|)) (|deg| (|Expon|)) (|e1| (|Expon|)) (#1=#:G31 NIL)
...
(SDEFUN |GBINTERN;gbasisExtend;2L2IL;6|
        ...
        (SPROG
         ((#1=#:G86 NIL) (#2=#:G87 NIL)
          ...
          (#3=#:G88 NIL) (#4=#:G89 NIL) (#5=#:G90 NIL) (#6=#:G91 NIL)
          (D0
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))
          (|s| (|Dpol|)) (|h| (|Dpol|)) (#7=#:G85 NIL) (#8=#:G92 NIL)
          (#9=#:G93 NIL)
          (D1
           (|List|
            #10=(|Record| (|:| |lcmfij| |Expon|)
          ...
          (|basPols|
           (|List|
            (|Record| (|:| |totdeg| (|NonNegativeInteger|))
                      (|:| |pol| |Dpol|))))
          (|redPols| (|List| |Dpol|)) (|xx| (|Integer|)) (#11=#:G94 NIL)
          (|x| NIL) (#12=#:G95 NIL))
         (SEQ
          (LETT |sgb|
                (PROGN
                 (LETT #1# NIL)
                 (SEQ (LETT |x| NIL) (LETT #2# |gb|) G190
                      (COND
          ...
          (LETT |redPols|
                (PROGN
                 (LETT #5# NIL)
                 (SEQ (LETT |x| NIL) (LETT #6# |basPols|) G190
                      (COND
          ...
          (LETT |Pol|
                (PROGN
                 (LETT #11# NIL)
                 (SEQ (LETT |x| NIL) (LETT #12# |basPols|) G190
                      (COND
                       ((OR (ATOM #12#) (PROGN (LETT |x| (CAR #12#)) NIL))
                        (GO G191)))
                      (SEQ (EXIT (LETT #11# (CONS (QCDR |x|) #11#))))
         ...
         (%
          (|List|
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))))
        (SPROG ((#1=#:G101 NIL) (|x| NIL) (#2=#:G102 NIL))
               (SEQ
                (PROGN
                 (LETT #1# NIL)
                 (SEQ (LETT |x| NIL) (LETT #2# D2) G190
                      (COND
                       ((OR (ATOM #2#) (PROGN (LETT |x| (CAR #2#)) NIL))
                        (GO G191)))
                      (SEQ
         ...
         (%
          (|List|
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))))
        (SPROG ((|d| (|Expon|)) (#1=#:G116 NIL) (|x| NIL) (#2=#:G117 NIL))
               (SEQ (LETT |d| (SPADCALL |h| (QREFELT % 16)))
                    (EXIT
                     (PROGN
                      (LETT #1# NIL)
                      (SEQ (LETT |x| NIL) (LETT #2# D) G190
                           (COND
                            ((OR (ATOM #2#) (PROGN (LETT |x| (CAR #2#)) NIL))
                             (GO G191)))
                           (SEQ
        ...
        ((|h| (|Dpol|)) (|deg| (|NonNegativeInteger|))
         ...
         (%
          (|List|
           (|Record| (|:| |totdeg| (|NonNegativeInteger|))
                     (|:| |pol| |Dpol|)))))
        (SPROG ((|d| (|Expon|)) (#1=#:G124 NIL) (|f| NIL) (#2=#:G125 NIL))
               (SEQ (LETT |d| (SPADCALL |h| (QREFELT % 16)))
                    (EXIT
                     (SPADCALL
                      (PROGN
                       (LETT #1# NIL)
                       (SEQ (LETT |f| NIL) (LETT #2# F) G190
                            (COND
        ...
        (SPROG
         ((|dl1|
           #1=(|Record| (|:| |lcmfij| |Expon|)
                        (|:| |totdeg| (|NonNegativeInteger|))
                        (|:| |poli| |Dpol|) (|:| |polj| |Dpol|)))
          (|dl2| #1#) (#2=#:G144 NIL) (|e| NIL) (#3=#:G145 NIL)
          (|res|
           (|List|
            (|Record| (|:| |lcmfij| |Expon|)
                      (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
