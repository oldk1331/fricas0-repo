...
(SDEFUN |GBINTERN;gbasisExtend;2L2IL;6|
        ...
        (SPROG
         ((#1=#:G199 NIL) (|x| NIL) (#2=#:G198 NIL) (|xx| (|Integer|))
          (|redPols| (|List| |Dpol|))
          (|basPols|
           (|List|
          ...
          (D
           (|List|
            #3=(|Record| (|:| |lcmfij| |Expon|)
                         ...
                         (|:| |poli| |Dpol|) (|:| |polj| |Dpol|))))
          (D1 (|List| #3#)) (#4=#:G197 NIL) (#5=#:G196 NIL) (#6=#:G189 NIL)
          (|h| (|Dpol|)) (|s| (|Dpol|))
          (D0
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))
          (#7=#:G195 NIL) (#8=#:G194 NIL) (#9=#:G193 NIL) (#10=#:G192 NIL)
          (|toth| (|NonNegativeInteger|)) (|Pol1| (|List| |Dpol|))
          (|sgb|
           (|List|
            (|Record| (|:| |totdeg| (|NonNegativeInteger|))
                      (|:| |pol| |Dpol|))))
          (#11=#:G191 NIL) (#12=#:G190 NIL))
         (SEQ
          (LETT |sgb|
                (PROGN
                 (LETT #12# NIL)
                       ...
                       (COND
                        ...
                        ((SPADCALL (SPADCALL |h| (QREFELT % 16))
                         ...
                         (SEQ (LETT D NIL)
                              ...
                              (EXIT (PROGN (LETT #6# 1) (GO #13=#:G182)))))
                        ('T
                         (SEQ
                          (LETT D1
                                (PROGN
         ...
         (%
          (|List|
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))))
        (SPROG ((#1=#:G206 NIL) (|x| NIL) (#2=#:G205 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
         ...
         (%
          (|List|
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))))
        (SPROG ((#1=#:G221 NIL) (|x| NIL) (#2=#:G220 NIL) (|d| (|Expon|)))
        ...
        ((|h| (|Dpol|)) (|deg| (|NonNegativeInteger|))
         ...
         (%
          (|List|
           (|Record| (|:| |totdeg| (|NonNegativeInteger|))
                     (|:| |pol| |Dpol|)))))
        (SPROG ((#1=#:G229 NIL) (|f| NIL) (#2=#:G228 NIL) (|d| (|Expon|)))
               (SEQ (LETT |d| (SPADCALL |h| (QREFELT % 16)))
                    (EXIT
                     (SPADCALL
                      (PROGN
...
(SDEFUN |GBINTERN;sPol;RDpol;13|
        ((|p|
         ...
         (% (|Dpol|)))
        (SPROG
         ((#1=#:G258 NIL) (|cc| (|Record| (|:| |co1| |Dom|) (|:| |co2| |Dom|)))
...
(DEFUN |GroebnerInternalPackage| (&REST #1=#:G332)
  (SPROG NIL
         (PROG (#2=#:G333)
           (RETURN
            (COND
