...
(SDEFUN |GBINTERN;makeCrit;RDpolNniR;4|
        ((|sp1| |Record| (|:| |totdeg| (|NonNegativeInteger|))
         ...
         ($ |Record| (|:| |lcmfij| |Expon|)
          ...
          (|:| |polj| |Dpol|)))
        (SPROG
         ((|tdeg| (|NonNegativeInteger|)) (|e2| (|Expon|)) (#1=#:G125 NIL)
...
(SDEFUN |GBINTERN;gbasis;L2IL;5|
        ((|Pol| |List| |Dpol|) (|xx1| |Integer|) (|xx2| |Integer|)
         ($ |List| |Dpol|))
        (SPROG
         ((#1=#:G176 NIL) (|x| NIL) (#2=#:G175 NIL) (|xx| (|Integer|))
          (|redPols| (|List| |Dpol|))
          (|basPols|
           (|List|
          ...
          (D1
           (|List|
            (|Record| (|:| |lcmfij| |Expon|)
                      (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                      (|:| |polj| |Dpol|))))
          (#3=#:G174 NIL) (#4=#:G173 NIL) (#5=#:G168 NIL) (|h| (|Dpol|))
          (|s| (|Dpol|))
          (D0
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))
          (#6=#:G172 NIL) (#7=#:G171 NIL) (#8=#:G170 NIL) (#9=#:G169 NIL)
...
(SDEFUN |GBINTERN;sPol;RDpol;12|
        ((|p| |Record| (|:| |lcmfij| |Expon|)
         ...
         ($ |Dpol|))
        (SPROG
         ((#1=#:G203 NIL) (|cc| (|Record| (|:| |co1| |Dom|) (|:| |co2| |Dom|)))
...
(DEFUN |GroebnerInternalPackage| (&REST #1=#:G270)
  (SPROG NIL
         (PROG (#2=#:G271)
           (RETURN
            (COND
