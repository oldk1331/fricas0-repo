        ...
        ((|sp1|
         ...
         ($
          (|Record| (|:| |lcmfij| |Expon|)
                    ...
                    (|:| |polj| |Dpol|))))
        (SPROG
         ((|tdeg| (|NonNegativeInteger|)) (|e2| (|Expon|)) (#1=#:G150 NIL)
...
(SDEFUN |GBINTERN;gbasisExtend;2L2IL;6|
        ...
        (SPROG
         ((#1=#:G214 NIL) (|x| NIL) (#2=#:G213 NIL) (|xx| (|Integer|))
          (|redPols| (|List| |Dpol|))
          (|basPols|
           (|List|
          ...
          (D
           (|List|
            #3=(|Record| (|:| |lcmfij| |Expon|)
                         ...
                         (|:| |poli| |Dpol|) (|:| |polj| |Dpol|))))
          (D1 (|List| #3#)) (#4=#:G212 NIL) (#5=#:G211 NIL) (#6=#:G204 NIL)
          (|h| (|Dpol|)) (|s| (|Dpol|))
          (D0
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))
          (#7=#:G210 NIL) (#8=#:G209 NIL) (#9=#:G208 NIL) (#10=#:G207 NIL)
          (|toth| (|NonNegativeInteger|)) (|Pol1| (|List| |Dpol|))
          (|sgb|
           (|List|
            (|Record| (|:| |totdeg| (|NonNegativeInteger|))
                      (|:| |pol| |Dpol|))))
          (#11=#:G206 NIL) (#12=#:G205 NIL))
         (SEQ
          (LETT |sgb|
                (PROGN
                 (LETT #12# NIL)
                       ...
                       (COND
                        ...
                        ((SPADCALL (SPADCALL |h| (QREFELT $ 16))
                         ...
                         (SEQ (LETT D NIL)
                              ...
                              (EXIT (PROGN (LETT #6# 1) (GO #13=#:G197)))))
                        ('T
                         (SEQ
                          (LETT D1
                                (PROGN
         ...
         ($
          (|List|
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))))
        (SPROG ((#1=#:G221 NIL) (|x| NIL) (#2=#:G220 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
         ...
         ($
          (|List|
           (|Record| (|:| |lcmfij| |Expon|)
                     (|:| |totdeg| (|NonNegativeInteger|)) (|:| |poli| |Dpol|)
                     (|:| |polj| |Dpol|)))))
        (SPROG ((#1=#:G236 NIL) (|x| NIL) (#2=#:G235 NIL) (|d| (|Expon|)))
        ...
        ((|h| (|Dpol|)) (|deg| (|NonNegativeInteger|))
         ...
         ($
          (|List|
           (|Record| (|:| |totdeg| (|NonNegativeInteger|))
                     (|:| |pol| |Dpol|)))))
        (SPROG ((#1=#:G244 NIL) (|f| NIL) (#2=#:G243 NIL) (|d| (|Expon|)))
               (SEQ (LETT |d| (SPADCALL |h| (QREFELT $ 16)))
                    (EXIT
                     (SPADCALL
                      (PROGN
...
(SDEFUN |GBINTERN;sPol;RDpol;13|
        ((|p|
         ...
         ($ (|Dpol|)))
        (SPROG
         ((#1=#:G273 NIL) (|cc| (|Record| (|:| |co1| |Dom|) (|:| |co2| |Dom|)))
...
(DEFUN |GroebnerInternalPackage| (&REST #1=#:G347)
  (SPROG NIL
         (PROG (#2=#:G348)
           (RETURN
            (COND
