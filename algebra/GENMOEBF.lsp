...
(SDEFUN |GENMOEBF;generalizedMoebiusFunction;LM$;4|
        ...
        (SPROG
         ((#1=#:G123 NIL) (|mf| (|Union| (|Matrix| R) "failed"))
          (|zf| (|Matrix| R)) (#2=#:G127 NIL) (|x| NIL) (#3=#:G126 NIL)
          (#4=#:G125 NIL) (|y| NIL) (#5=#:G124 NIL) (|xxo| (|List| P)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |xxo|
                 ...
                 (SEQ
                  (COND
                   ((SPADCALL |pi| |si| (QREFELT $ 12))
                    (PROGN (LETT #1# (|spadConstant| $ 25)) (GO #2=#:G129))))
                  (EXIT (|spadConstant| $ 17))))
                #2# (EXIT #1#)))) 

(SDEFUN |GENMOEBF;apply;$2PR;6| ((|mf| ($)) (|x| (P)) (|y| (P)) ($ (R)))
        (SPROG
         ((#1=#:G136 NIL) (|ky| #2=(|Integer|)) (|kx| #2#)
          (|mfn| (|Matrix| R)))
         (SEQ
          (EXIT
...
(DEFUN |GeneralizedFiniteMoebiusFunction| (&REST #1=#:G142)
  (SPROG NIL
         (PROG (#2=#:G143)
           (RETURN
            (COND
