...
(DEFUN |UnivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((DV$1 NIL) (DV$2 NIL) (|dv$| NIL) (% NIL) (#1=#:G61 NIL) (#2=#:G60 NIL)
    (#3=#:G59 NIL) (#4=#:G58 NIL) (#5=#:G57 NIL) (#6=#:G56 NIL) (#7=#:G54 NIL)
    (#8=#:G55 NIL) (#9=#:G53 NIL) (|pv$| NIL))
   (PROGN
    (LETT DV$1 |#1|)
