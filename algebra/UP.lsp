...
(DEFUN |UnivariatePolynomial| (&REST #1=#:G180)
  (SPROG NIL
         (PROG (#2=#:G181)
           (RETURN
            (COND
...
(DEFUN |UnivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G179 NIL) (|pv$| NIL) (#2=#:G170 NIL) (#3=#:G172 NIL) (#4=#:G171 NIL)
    (#5=#:G173 NIL) (#6=#:G174 NIL) (#7=#:G175 NIL) (#8=#:G176 NIL)
    (#9=#:G177 NIL) (#10=#:G178 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
    (LETT DV$1 |#1|)
