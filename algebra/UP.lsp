...
(DEFUN |UnivariatePolynomial| (&REST #1=#:G160)
  (SPROG NIL
         (PROG (#2=#:G161)
           (RETURN
            (COND
...
(DEFUN |UnivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G159 NIL) (|pv$| NIL) (#2=#:G151 NIL) (#3=#:G152 NIL) (#4=#:G153 NIL)
    (#5=#:G154 NIL) (#6=#:G155 NIL) (#7=#:G156 NIL) (#8=#:G157 NIL)
    (#9=#:G158 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
            ...
            (CONS
             ...
             (CONS
              '#((|UnivariatePolynomialCategory| 7)
                 ...
                 (|RetractableTo| 37) (|CommutativeStar|) (|Eltable| $$ $$)
                 (|Eltable| 7 7) (|VariablesCommuteWithCoefficients|)
                 (|InnerEvalable| 37 $$) (|InnerEvalable| 37 7)
                 ...
                 (|InnerEvalable| $$ $$) (|CoercibleFrom| 37)
