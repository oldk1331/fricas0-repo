...
(DEFUN |SequentialDifferentialPolynomial| (#1=#:G168)
  (PROG ()
    (RETURN
     (PROG (#2=#:G169)
       (RETURN
...
(DEFUN |SequentialDifferentialPolynomial;| (|#1|)
  (PROG (#1=#:G167 |pv$| #2=#:G166 $ |dv$| DV$1)
    (RETURN
     (PROGN
      (LETT DV$1 (|devaluate| |#1|) . #3=(|SequentialDifferentialPolynomial|))
      (LETT |dv$| (LIST '|SequentialDifferentialPolynomial| DV$1) . #3#)
      (LETT $ (GETREFV 59) . #3#)
      (QSETREFV $ 0 |dv$|)
      (QSETREFV $ 3
                (LETT |pv$|
...
(MAKEPROP '|SequentialDifferentialPolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL
              ...
              (|Union| $ '#1#) (|Fraction| 35)
              (|SequentialDifferentialVariable| 19) (|NonNegativeInteger|)
