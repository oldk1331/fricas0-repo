...
(SDEFUN |TRIGMNIP;complexKernels|
        ...
        (SPROG
         ((|lv| (|List| F)) (|lk| (|List| (|Kernel| F)))
          (|u| (|Union| F "failed")) (#1=#:G147 NIL) (|k| NIL))
...
(SDEFUN |TRIGMNIP;kcomplex| ((|k| (|Kernel| F)) ($ (|Union| F "failed")))
        (SPROG
         ((#1=#:G165 NIL) (|u| (|Union| (|Integer|) "failed")) (|a| (F))
          (#2=#:G164 NIL) (|n| (F)) (|arg| (|List| F))
          (|op| (|BasicOperator|)))
...
(SDEFUN |TRIGMNIP;complexNormalize;FSF;9| ((|f| (F)) (|x| (|Symbol|)) ($ (F)))
        (SPROG ((#1=#:G180 NIL) (|g| (F)) (|k| NIL) (#2=#:G179 NIL))
               (SEQ
                (COND
                 ((SPADCALL
...
(SDEFUN |TRIGMNIP;complexElementary;FSF;11|
        ((|f| (F)) (|x| (|Symbol|)) ($ (F)))
        (SPROG ((#1=#:G194 NIL) (|g| (F)) (|k| NIL) (#2=#:G193 NIL))
               (SEQ
                (COND
                 ((SPADCALL
...
(SDEFUN |TRIGMNIP;localexplogs|
        ...
        (SPROG ((#1=#:G203 NIL) (|k| NIL) (#2=#:G202 NIL))
               (SEQ
...
(DEFUN |TrigonometricManipulations| (&REST #1=#:G207)
  (SPROG NIL
         (PROG (#2=#:G208)
           (RETURN
            (COND
