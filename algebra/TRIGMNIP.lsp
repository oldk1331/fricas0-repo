...
(SDEFUN |TRIGMNIP;complexKernels|
        ...
        (SPROG
         ((|lv| (|List| F)) (|lk| (|List| (|Kernel| F)))
          (|u| (|Union| F "failed")) (#1=#:G144 NIL) (|k| NIL))
...
(SDEFUN |TRIGMNIP;kcomplex| ((|k| |Kernel| F) ($ |Union| F "failed"))
        (SPROG
         ((#1=#:G160 NIL) (|u| (|Union| (|Integer|) "failed")) (|a| (F))
          (#2=#:G159 NIL) (|n| (F)) (|arg| (|List| F))
          (|op| (|BasicOperator|)))
...
(SDEFUN |TRIGMNIP;complexNormalize;FSF;9| ((|f| F) (|x| |Symbol|) ($ F))
        (SPROG ((#1=#:G174 NIL) (|g| (F)) (|k| NIL) (#2=#:G173 NIL))
               (SEQ
                (COND
                 ((SPADCALL
...
(SDEFUN |TRIGMNIP;complexElementary;FSF;11| ((|f| F) (|x| |Symbol|) ($ F))
        (SPROG ((#1=#:G187 NIL) (|g| (F)) (|k| NIL) (#2=#:G186 NIL))
               (SEQ
                (COND
                 ((SPADCALL
...
(DEFUN |TrigonometricManipulations| (&REST #1=#:G199)
  (SPROG NIL
         (PROG (#2=#:G200)
           (RETURN
            (COND
