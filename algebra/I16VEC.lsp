...
(MAKEPROP '|I16VEC;#;%Nni;1| '|SPADreplace| 'QV_LEN_I16) 

(SDEFUN |I16VEC;#;%Nni;1| ((|x| (%)) (% (|NonNegativeInteger|)))
        (QV_LEN_I16 |x|)) 

(MAKEPROP '|I16VEC;minIndex;%I;2| '|SPADreplace| '(XLAM (|x|) 0)) 

(SDEFUN |I16VEC;minIndex;%I;2| ((|x| (%)) (% (|Integer|))) 0) 

(MAKEPROP '|I16VEC;empty;%;3| '|SPADreplace| '(XLAM NIL (GETREFV_I16 0 0))) 

(SDEFUN |I16VEC;empty;%;3| ((% (%))) (GETREFV_I16 0 0)) 

(MAKEPROP '|I16VEC;new;NniI%;4| '|SPADreplace| 'GETREFV_I16) 

(SDEFUN |I16VEC;new;NniI%;4|
        ((|n| (|NonNegativeInteger|)) (|x| (|Integer|)) (% (%)))
        (GETREFV_I16 |n| |x|)) 

(MAKEPROP '|I16VEC;qelt;%2I;5| '|SPADreplace| 'ELT_I16) 

(SDEFUN |I16VEC;qelt;%2I;5| ((|x| (%)) (|i| (|Integer|)) (% (|Integer|)))
        (ELT_I16 |x| |i|)) 

(MAKEPROP '|I16VEC;elt;%2I;6| '|SPADreplace| 'ELT_I16) 

(SDEFUN |I16VEC;elt;%2I;6| ((|x| (%)) (|i| (|Integer|)) (% (|Integer|)))
        (ELT_I16 |x| |i|)) 

(MAKEPROP '|I16VEC;qsetelt!;%3I;7| '|SPADreplace| 'SETELT_I16) 

(SDEFUN |I16VEC;qsetelt!;%3I;7|
        ((|x| (%)) (|i| (|Integer|)) (|s| #1=(|Integer|)) (% #1#))
        (SETELT_I16 |x| |i| |s|)) 

(MAKEPROP '|I16VEC;setelt!;%3I;8| '|SPADreplace| 'SETELT_I16) 
...
(DEFUN |I16Vector;| ()
  (SPROG
   ((|dv$| NIL) (% NIL) (#1=#:G2469 NIL) (#2=#:G2468 NIL) (#3=#:G2467 NIL)
    (|pv$| NIL))
   (PROGN
    (LETT |dv$| '(|I16Vector|))
    (LETT % (GETREFV 34))
