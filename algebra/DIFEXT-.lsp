    ...
    (RETURN
     (SEQ
      (SEQ (LETT |i| 1 . #1=(|DIFEXT-;differentiate;SMNniS;1|)) G190
           ...
           (SEQ
            (EXIT (LETT |x| (SPADCALL |x| |derivation| (QREFELT $ 9)) . #1#)))
           (LETT |i| (|inc_SI| |i|) . #1#) (GO G190) G191 (EXIT NIL))
      (EXIT |x|))))) 

(DEFUN |DIFEXT-;D;SMS;2| (|x| |derivation| $)
  (SPADCALL |x| |derivation| (QREFELT $ 9))) 

(DEFUN |DIFEXT-;D;SMNniS;3| (|x| |derivation| |n| $)
  (SPADCALL |x| |derivation| |n| (QREFELT $ 13))) 

(DEFUN |DIFEXT-;differentiate;2S;4| (|x| $)
  (SPADCALL |x| (ELT $ 15) (QREFELT $ 9))) 

(DEFUN |DIFEXT-;differentiate;SSS;5| (|x| |v| $)
  (PROG ()
    (RETURN
     (SPADCALL |x| (CONS #'|DIFEXT-;differentiate;SSS;5!0| (VECTOR $ |v|))
               (QREFELT $ 9))))) 

(DEFUN |DIFEXT-;differentiate;SSS;5!0| (|s| $$)
  (PROG (|v| $)
