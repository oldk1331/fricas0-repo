...
(SDEFUN |ILIST;mergeSort|
        ...
        (SPROG ((|q| ($)) (|l| (|NonNegativeInteger|)) (#1=#:G1094 NIL))
               (SEQ
                (COND
                 ((EQL |n| 2)
                  (COND
...
(DEFUN |IndexedList| (&REST #1=#:G1117)
  (SPROG NIL
         (PROG (#2=#:G1118)
           (RETURN
            (COND
...
(DEFUN |IndexedList;| (|#1| |#2|)
  (SPROG
   ((#1=#:G1113 NIL) (#2=#:G1114 NIL) (#3=#:G1116 NIL) (#4=#:G1115 NIL)
    (|pv$| NIL) (#5=#:G1110 NIL) (#6=#:G1111 NIL) (#7=#:G1112 NIL) ($ NIL)
