...
(SDEFUN |ILIST;rest;$Nni$;21| ((|x| $) (|n| |NonNegativeInteger|) ($ $))
        (SPROG ((|i| NIL))
               (SEQ
                (SEQ (LETT |i| 1 . #1=(|ILIST;rest;$Nni$;21|)) G190
...
(SDEFUN |ILIST;mergeSort|
        ...
        (SPROG ((|q| ($)) (|l| (|NonNegativeInteger|)) (#1=#:G1097 NIL))
               (SEQ
                (COND
                 ((EQL |n| 2)
                  (COND
...
(DEFUN |IndexedList| (&REST #1=#:G1118)
  (SPROG NIL
         (PROG (#2=#:G1119)
           (RETURN
            (COND
...
(DEFUN |IndexedList;| (|#1| |#2|)
  (SPROG
   ((#1=#:G1116 NIL) (#2=#:G1117 NIL) (|pv$| NIL) (#3=#:G1113 NIL)
    (#4=#:G1114 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
