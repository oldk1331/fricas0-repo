...
(SDEFUN |ILIST;mergeSort|
        ...
        (SPROG ((|q| ($)) (|l| (|NonNegativeInteger|)) (#1=#:G1098 NIL))
               (SEQ
                (COND
                 ((EQL |n| 2)
                  (COND
...
(DEFUN |IndexedList;| (|#1| |#2|)
  (SPROG
   ((#1=#:G1117 NIL) (#2=#:G1118 NIL) (#3=#:G1120 NIL) (#4=#:G1119 NIL)
    (|pv$| NIL) (#5=#:G1114 NIL) (#6=#:G1115 NIL) (#7=#:G1116 NIL) ($ NIL)
