...
(SDEFUN |SMP;multivariate;SupVarSet$;17|
        ((|u| |SparseUnivariatePolynomial| $) (|mvar| |VarSet|) ($ $))
        (SPROG
         ((#1=#:G253 NIL) (|uu| (|SparseUnivariatePolynomial| $)) (|cc| ($)))
         (SEQ
          (EXIT
           (COND
            ...
            (SEQ
             (PROGN
              (LETT |#G65|
                    ...
                    . #3#)
              (LETT |u| (QVELT |#G65| 0) . #3#)
              (LETT |c| (QVELT |#G65| 1) . #3#)
              (LETT |a| (QVELT |#G65| 2) . #3#)
              |#G65|)
             (EXIT
...
(SDEFUN |SMP;gcdPolynomial;3Sup;47|
        ...
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| $)) (#2=#:G411 NIL)
...
(SDEFUN |SMP;gcdPolynomial;3Sup;54|
        ((|a| . #1=(|SparseUnivariatePolynomial| $)) (|b| . #1#)
         ($ |SparseUnivariatePolynomial| $))
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| $)) (#2=#:G443 NIL)
          (|monb| (|SparseUnivariatePolynomial| $)) (|contb| ($))
          (|mona| (|SparseUnivariatePolynomial| $)) (|conta| ($)))
         (SEQ
          (COND
...
(SDEFUN |SMP;gcdPolynomial;3Sup;57|
        ((|a| . #1=(|SparseUnivariatePolynomial| $)) (|b| . #1#)
         ($ |SparseUnivariatePolynomial| $))
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| $)) (#2=#:G471 NIL)
          (|monb| (|SparseUnivariatePolynomial| $)) (|contb| ($))
          (|mona| (|SparseUnivariatePolynomial| $)) (|conta| ($)))
         (SEQ
          (COND
...
(SDEFUN |SMP;coefficients;$L;59| ((|p| $) ($ |List| R))
        (SPROG
         ((#1=#:G488 NIL) (#2=#:G487 #3=(|List| R)) (#4=#:G489 #3#)
          (#5=#:G491 NIL) (|p1| NIL))
         (SEQ
...
(SDEFUN |SMP;eval;$LL$;69|
        ...
        (SPROG ((#1=#:G552 NIL) (|val| NIL) (#2=#:G551 NIL))
               (SEQ
                (SPADCALL |p| |Lvar|
                          (PROGN
...
(SDEFUN |SMP;degree;$LL;71|
        ...
        (SPROG ((#1=#:G562 NIL) (|mvar| NIL) (#2=#:G561 NIL))
               (SEQ
                (PROGN
...
(SDEFUN |SMP;minimumDegree;$LL;75|
        ((|p| $) (|Lvar| |List| |VarSet|) ($ |List| (|NonNegativeInteger|)))
        (SPROG ((#1=#:G581 NIL) (|mvar| NIL) (#2=#:G580 NIL))
               (SEQ
                (PROGN
...
(SDEFUN |SMP;monomials1|
        ...
        (SPROG
         ((|degs1| #2#) (|vars1| #1#) (|mon| ($))
          ...
          (#5=#:G614 NIL) (|var| NIL) (#6=#:G615 NIL) (|deg| NIL) (|k1| #4#)
          (|p1| ($)) (#7=#:G613 NIL) (|t| NIL) (|v1| (|VarSet|))
          (|tl| (|List| #3#)))
...
(DEFUN |SparseMultivariatePolynomial| (&REST #1=#:G650)
  (SPROG NIL
         (PROG (#2=#:G651)
           (RETURN
            (COND
...
(DEFUN |SparseMultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G649 NIL) (|pv$| NIL) (#2=#:G641 NIL) (#3=#:G642 NIL) (#4=#:G643 NIL)
    (#5=#:G644 NIL) (#6=#:G645 NIL) (#7=#:G646 NIL) (#8=#:G647 NIL)
    (#9=#:G648 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 6 (|IndexedExponents| 7) 7)
                 ...
                 (|LeftOreRing|) (|Algebra| 217) (|CharacteristicNonZero|)
                 ...
                 (|SemiRng|) (|Module| 217) (|Module| 6) (|Module| $$)
                 (|BiModule| 6 6) (|BiModule| $$ $$) (|BiModule| 217 217)
                 (|NonAssociativeRing|) (|LeftModule| 6) (|RightModule| 6)
                 (|RightModule| $$) (|LeftModule| $$) (|LeftModule| 217)
                 (|RightModule| 217) (|NonAssociativeRng|) (|AbelianGroup|)
              ...
              (|makeByteWordVec2| 235
                                  '(0 6 0 11 0 6 0 13 0 0 0 14 1 6 16 0 17 0 8
                                    ...
                                    0 16 0 0 1 1 49 16 0 18 1 0 166 0 168 1 0
                                    38 0 46 2 0 55 0 7 56 1 44 117 0 119 1 44 0
                                    0 121 1 44 16 0 123 2 0 27 0 166 1 2 0 27 0
                                    166 1 1 0 27 0 1 2 50 85 0 0 1 1 10 220 55
                                    1 1 14 0 0 1 1 14 219 0 1 2 10 221 222 55 1
                                    2 8 16 0 0 1 0 49 0 1 1 47 85 0 1 2 47 0 0
                                    ...
                                    214 1 2 4 226 208 214 1 1 4 227 208 1 1 47
                                    85 0 87 2 14 0 0 7 1 1 14 0 0 1 1 12 151 0
                                    1 1 10 16 0 1 4 0 0 0 6 71 0 1 3 29 215 0
                                    210 215 1 3 31 216 0 211 216 1 2 49 16 0 0
                                    1 1 47 16 0 21 1 0 27 0 28 2 0 0 38 7 51 2
                                    ...
                                    131 1 0 169 0 170 1 47 85 0 1 2 47 0 0 27 1
                                    ...
                                    10 220 55 1 1 10 219 0 1 2 44 85 0 0 129 2
                                    ...
                                    71 0 191 1 17 209 0 1 1 33 210 0 1 1 35 211
                                    0 1 2 14 0 0 7 138 1 14 6 0 135 1 42 207
                                    208 1 2 48 0 0 0 1 1 46 0 79 81 1 45 0 0 1
                                    1 19 0 217 1 1 12 0 7 30 1 0 0 6 84 1 0 154
                                    0 158 1 0 159 0 161 3 0 0 0 166 188 1 3 0 0
                                    0 7 27 1 2 0 6 0 71 78 1 43 85 0 1 0 48 27
                                    83 3 41 0 0 0 27 1 3 48 0 0 0 0 1 2 44 16 0
                                    0 126 2 0 0 0 0 1 2 48 16 0 0 1 2 47 0 0 27
                                    108 2 0 0 0 106 107 0 49 0 12 0 47 0 14 2 4
                                    0 0 7 1 3 4 0 0 7 27 1 2 4 0 0 166 1 3 4 0
                                    0 166 188 1 2 0 16 0 0 32 2 18 0 0 6 133 2
                                    51 0 0 0 101 1 51 0 0 90 2 0 0 0 0 52 2 51
                                    0 79 0 93 2 49 0 27 0 1 2 1 0 217 0 1 2 1 0
