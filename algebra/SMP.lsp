...
(DEFUN |SMP;numberOfMonomials;$Nni;6| (|p| $)
  (PROG (#1=#:G207 #2=#:G206 #3=#:G208 #4=#:G210 |q|)
    (RETURN
     (SEQ
      (COND
       ((QEQCAR |p| 0)
...
(DEFUN |SMP;gcdPolynomial;3Sup;45| (|a| |b| $)
  (PROG (|mong| #1=#:G402 |monb| |contb| |mona| |conta|)
    (RETURN
     (SEQ
      (COND
...
(DEFUN |SMP;gcdPolynomial;3Sup;52| (|a| |b| $)
  (PROG (|mong| #1=#:G434 |monb| |contb| |mona| |conta|)
    (RETURN
     (SEQ
      (COND
       ((SPADCALL |a| (QREFELT $ 66))
...
(DEFUN |SMP;gcdPolynomial;3Sup;55| (|a| |b| $)
  (PROG (|mong| #1=#:G462 |monb| |contb| |mona| |conta|)
    (RETURN
     (SEQ
      (COND
       ((SPADCALL |a| (QREFELT $ 66))
...
(DEFUN |SMP;coefficients;$L;57| (|p| $)
  (PROG (#1=#:G479 #2=#:G478 #3=#:G480 #4=#:G482 |p1|)
    (RETURN
     (SEQ
...
(DEFUN |SMP;eval;$LL$;66| (|p| |Lvar| |Lpval| $)
  (PROG (|nlpval| #1=#:G539 |mvar| #2=#:G538 |nlvar|)
    (RETURN
     (SEQ
      (COND
...
(DEFUN |SMP;monomials1| (|p| |vars| |degs| |res| $)
  (PROG (|degs1| |vars1| |mon| |mon1| #1=#:G600 |var| #2=#:G601 |deg| |k1| |p1|
         #3=#:G599 |t| |v1| |tl|)
    (RETURN
...
(DEFUN |SparseMultivariatePolynomial;| (|#1| |#2|)
  (PROG (#1=#:G630 |pv$| #2=#:G627 #3=#:G628 #4=#:G629 $ |dv$| DV$2 DV$1)
    (RETURN
     (PROGN
             ...
             (CONS
              ...
              (|makeByteWordVec2| 235
                                  '(0 6 0 11 0 6 0 13 1 6 15 0 16 2 6 15 0 0 18
                                    ...
                                    0 39 0 47 1 33 116 0 118 1 33 0 0 120 1 33
                                    ...
                                    57 1 1 1 216 0 1 2 33 85 0 0 128 2 2 85 0 6
                                    ...
                                    1 2 21 0 0 7 1 3 0 0 0 7 25 1 3 0 0 0 167
                                    189 1 2 0 0 0 7 200 2 0 0 0 167 1 1 0 71 0
                                    192 2 0 25 0 7 188 2 0 189 0 167 190 1 9
                                    209 0 1 1 7 210 0 1 1 8 211 0 1 2 3 0 0 7
                                    139 1 3 6 0 136 1 31 207 208 1 1 34 0 0 1 1
                                    19 0 214 1 1 0 0 7 28 1 0 0 6 82 1 0 0 79
                                    81 1 0 155 0 159 1 0 160 0 162 2 0 6 0 71
                                    78 3 0 0 0 7 25 1 3 0 0 0 167 189 1 1 32 85
                                    0 1 0 0 25 84 3 30 0 0 0 25 1 2 33 15 0 0
                                    125 2 0 0 0 25 105 2 0 0 0 106 107 0 0 0 12
                                    0 0 0 14 3 0 0 0 7 25 1 3 0 0 0 167 189 1 2
                                    0 0 0 7 1 2 0 0 0 167 1 2 0 15 0 0 102 2 20
                                    0 0 6 134 1 0 0 0 90 2 0 0 0 0 100 2 0 0 0
                                    0 53 2 10 0 214 0 1 2 10 0 0 214 1 2 0 0 6
