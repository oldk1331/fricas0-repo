...
(SDEFUN |SMP;numberOfMonomials;$Nni;6| ((|p| ($)) ($ (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G228 NIL) (#2=#:G227 #3=(|NonNegativeInteger|)) (#4=#:G229 #3#)
          (#5=#:G231 NIL) (|q| NIL))
         (SEQ
          (COND
           ((QEQCAR |p| 0)
...
(SDEFUN |SMP;gcdPolynomial;3Sup;55|
        ...
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| $)) (#2=#:G468 NIL)
...
(SDEFUN |SMP;gcdPolynomial;3Sup;62|
        ((|a| #1=(|SparseUnivariatePolynomial| $)) (|b| #1#)
         ($ (|SparseUnivariatePolynomial| $)))
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| $)) (#2=#:G500 NIL)
          (|monb| (|SparseUnivariatePolynomial| $)) (|contb| ($))
          (|mona| (|SparseUnivariatePolynomial| $)) (|conta| ($)))
         (SEQ
          (COND
...
(SDEFUN |SMP;gcdPolynomial;3Sup;65|
        ((|a| #1=(|SparseUnivariatePolynomial| $)) (|b| #1#)
         ($ (|SparseUnivariatePolynomial| $)))
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| $)) (#2=#:G528 NIL)
          (|monb| (|SparseUnivariatePolynomial| $)) (|contb| ($))
          (|mona| (|SparseUnivariatePolynomial| $)) (|conta| ($)))
         (SEQ
          (COND
...
(SDEFUN |SMP;coefficients;$L;67| ((|p| ($)) ($ (|List| R)))
        (SPROG
         ((#1=#:G545 NIL) (#2=#:G544 #3=(|List| R)) (#4=#:G546 #3#)
          (#5=#:G548 NIL) (|p1| NIL))
         (SEQ
...
(SDEFUN |SMP;eval;$LL$;76|
        ((|p| ($)) (|Lvar| (|List| |VarSet|)) (|Lpval| (|List| $)) ($ ($)))
        (SPROG
         ((|nlpval| (|List| $)) (#1=#:G607 NIL) (|mvar| NIL) (#2=#:G606 NIL)
          (|nlvar| (|List| |VarSet|)))
         (SEQ
          (COND
           ((OR (NULL (CDR |Lvar|))
...
(SDEFUN |SMP;eval;$LL$;77|
        ...
        (SPROG ((#1=#:G612 NIL) (|val| NIL) (#2=#:G611 NIL))
               (SEQ
                (SPADCALL |p| |Lvar|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |SMP;degree;$LL;79|
        ...
        (SPROG ((#1=#:G623 NIL) (|mvar| NIL) (#2=#:G622 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SMP;minimumDegree;$LL;83|
        ((|p| ($)) (|Lvar| (|List| |VarSet|))
         ($ (|List| (|NonNegativeInteger|))))
        (SPROG ((#1=#:G643 NIL) (|mvar| NIL) (#2=#:G642 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |mvar| NIL) (LETT #1# |Lvar|) G190
...
(SDEFUN |SMP;monomials1|
        ...
        (SPROG
         ((|degs1| #2#) (|vars1| #1#) (|mon| ($))
          ...
          (#5=#:G680 NIL) (|var| NIL) (#6=#:G681 NIL) (|deg| NIL) (|k1| #4#)
          (|p1| ($)) (#7=#:G679 NIL) (|t| NIL) (|v1| (|VarSet|))
          (|tl| (|List| #3#)))
...
(DEFUN |SparseMultivariatePolynomial| (&REST #1=#:G717)
  (SPROG NIL
         (PROG (#2=#:G718)
           (RETURN
            (COND
...
(DEFUN |SparseMultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G716 NIL) (|pv$| NIL) (#2=#:G707 NIL) (#3=#:G709 NIL) (#4=#:G708 NIL)
    (#5=#:G710 NIL) (#6=#:G711 NIL) (#7=#:G712 NIL) (#8=#:G713 NIL)
    (#9=#:G714 NIL) (#10=#:G715 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
