...
(SDEFUN |SMP;numberOfMonomials;$Nni;6| ((|p| ($)) ($ (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G212 NIL) (#2=#:G211 #3=(|NonNegativeInteger|)) (#4=#:G213 #3#)
          (#5=#:G215 NIL) (|q| NIL))
         (SEQ
          (COND
           ((QEQCAR |p| 0)
...
(SDEFUN |SMP;multivariate;SupVarSet$;17|
        ((|u| (|SparseUnivariatePolynomial| $)) (|mvar| (|VarSet|)) ($ ($)))
        (SPROG
         ((#1=#:G256 NIL) (|uu| (|SparseUnivariatePolynomial| $)) (|cc| ($)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |SMP;gcdPolynomial;3Sup;55|
        ...
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| $)) (#2=#:G452 NIL)
...
(SDEFUN |SMP;gcdPolynomial;3Sup;62|
        ((|a| #1=(|SparseUnivariatePolynomial| $)) (|b| #1#)
         ($ (|SparseUnivariatePolynomial| $)))
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| $)) (#2=#:G484 NIL)
          (|monb| (|SparseUnivariatePolynomial| $)) (|contb| ($))
          (|mona| (|SparseUnivariatePolynomial| $)) (|conta| ($)))
         (SEQ
          (COND
...
(SDEFUN |SMP;gcdPolynomial;3Sup;65|
        ((|a| #1=(|SparseUnivariatePolynomial| $)) (|b| #1#)
         ($ (|SparseUnivariatePolynomial| $)))
        (SPROG
         ((|mong| (|SparseUnivariatePolynomial| $)) (#2=#:G512 NIL)
          (|monb| (|SparseUnivariatePolynomial| $)) (|contb| ($))
          (|mona| (|SparseUnivariatePolynomial| $)) (|conta| ($)))
         (SEQ
          (COND
...
(SDEFUN |SMP;coefficients;$L;67| ((|p| ($)) ($ (|List| R)))
        (SPROG
         ((#1=#:G529 NIL) (#2=#:G528 #3=(|List| R)) (#4=#:G530 #3#)
          (#5=#:G532 NIL) (|p1| NIL))
         (SEQ
...
(SDEFUN |SMP;eval;$LL$;76|
        ((|p| ($)) (|Lvar| (|List| |VarSet|)) (|Lpval| (|List| $)) ($ ($)))
        (SPROG
         ((|nlpval| (|List| $)) (#1=#:G591 NIL) (|mvar| NIL) (#2=#:G590 NIL)
          (|nlvar| (|List| |VarSet|)))
         (SEQ
          (COND
           ((OR (NULL (CDR |Lvar|))
...
(SDEFUN |SMP;eval;$LL$;77|
        ...
        (SPROG ((#1=#:G596 NIL) (|val| NIL) (#2=#:G595 NIL))
               (SEQ
                (SPADCALL |p| |Lvar|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |SMP;degree;$LL;79|
        ...
        (SPROG ((#1=#:G607 NIL) (|mvar| NIL) (#2=#:G606 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |SMP;minimumDegree;$LL;83|
        ((|p| ($)) (|Lvar| (|List| |VarSet|))
         ($ (|List| (|NonNegativeInteger|))))
        (SPROG ((#1=#:G627 NIL) (|mvar| NIL) (#2=#:G626 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |mvar| NIL) (LETT #1# |Lvar|) G190
...
(SDEFUN |SMP;monomials1|
        ...
        (SPROG
         ((|degs1| #2#) (|vars1| #1#) (|mon| ($))
          ...
          (#5=#:G664 NIL) (|var| NIL) (#6=#:G665 NIL) (|deg| NIL) (|k1| #4#)
          (|p1| ($)) (#7=#:G663 NIL) (|t| NIL) (|v1| (|VarSet|))
          (|tl| (|List| #3#)))
...
(DEFUN |SparseMultivariatePolynomial| (&REST #1=#:G701)
  (SPROG NIL
         (PROG (#2=#:G702)
           (RETURN
            (COND
...
(DEFUN |SparseMultivariatePolynomial;| (|#1| |#2|)
  (SPROG
   ((#1=#:G700 NIL) (|pv$| NIL) (#2=#:G691 NIL) (#3=#:G693 NIL) (#4=#:G692 NIL)
    (#5=#:G694 NIL) (#6=#:G695 NIL) (#7=#:G696 NIL) (#8=#:G697 NIL)
    (#9=#:G698 NIL) (#10=#:G699 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|SparseMultivariatePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'D '|VPoly|
              ...
              (|Pattern| (|Float|)) (|Pattern| 93) (|Matrix| 93)
              (|Record| (|:| |mat| 222) (|:| |vec| (|Vector| 93))) (|Vector| $)
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 6 (|IndexedExponents| 7) 7)
                 ...
                 (|Algebra| 227) (|CharacteristicNonZero|)
                 ...
                 (|Module| 227) (|Module| 6) (|FullyLinearlyExplicitOver| 6)
                 (|Module| $$)
              ...
              (|makeByteWordVec2| 245
                                  '(0 6 0 11 0 6 0 13 0 0 0 14 1 6 16 0 17 0 8
                                    ...
                                    0 1 1 52 16 0 18 1 0 179 0 181 1 0 38 0 46
                                    2 0 55 0 7 56 1 47 130 0 132 1 47 0 0 134 1
                                    47 16 0 136 2 0 27 0 179 1 1 0 27 0 1 2 0
                                    27 0 179 1 1 0 84 0 85 2 53 99 0 0 1 1 10
                                    230 55 1 1 14 0 0 1 1 14 229 0 1 2 10 231
                                    232 55 1 2 9 16 0 0 1 0 52 0 1 1 50 99 0 1
                                    2 50 0 0 27 1 2 0 0 0 123 1 1 6 233 0 1 1 7
                                    234 0 1 1 12 182 0 1 1 0 177 0 178 1 6 227
                                    0 1 1 7 93 0 1 1 12 7 0 1 1 0 6 0 176 3 5 0
