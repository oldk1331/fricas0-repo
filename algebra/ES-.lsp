...
(SDEFUN |ES-;eval;SLLS;31|
        ((|x| S) (|ls| |List| (|BasicOperator|)) (|lf| |List| (|Mapping| S S))
         ($ S))
        (SPROG ((#1=#:G237 NIL) (|f| NIL) (#2=#:G236 NIL))
               (SEQ
                (SPADCALL |x| |ls|
                          (PROGN
...
(SDEFUN |ES-;eval;SLLS;32|
        ...
        (SPROG ((#1=#:G242 NIL) (|f| NIL) (#2=#:G241 NIL))
               (SEQ
                (SPADCALL |x| |ls|
                          (PROGN
...
(SDEFUN |ES-;eval;SLLS;33|
        ...
        (SPROG ((#1=#:G247 NIL) (|s| NIL) (#2=#:G246 NIL))
               (SEQ
                (SPADCALL |x|
                          (PROGN
...
(SDEFUN |ES-;map;MKS;34| ((|fn| |Mapping| S S) (|k| |Kernel| S) ($ S))
        (SPROG ((|l| (|List| S)) (#1=#:G280 NIL) (|x| NIL) (#2=#:G279 NIL))
               (SEQ
                (COND
                 ((SPADCALL
                   (LETT |l|
...
(SDEFUN |ES-;mainKernel;SU;36| ((|x| S) ($ |Union| (|Kernel| S) "failed"))
        (SPROG
         ((|k| (|Kernel| S)) (|n| (|NonNegativeInteger|)) (#1=#:G296 NIL)
...
(SDEFUN |ES-;allKernels| ((|f| S) ($ |Set| (|Kernel| S)))
        (SPROG
         ((|s| (|Set| (|Kernel| S))) (|t| (|Set| (|Kernel| S)))
          ...
          (#1=#:G309 NIL) (|k| NIL) (|l| (|List| (|Kernel| S))))
         (SEQ
          (LETT |s|
                (SPADCALL
...
(SDEFUN |ES-;okkernel| ((|op| |BasicOperator|) (|l| |List| S) ($ S))
        (SPROG ((#1=#:G324 NIL) (|f| NIL) (#2=#:G323 NIL))
               (SEQ
                (SPADCALL
                 (SPADCALL |op| |l|
                           (+ 1
...
(SDEFUN |ES-;distribute;3S;46| ((|x| S) (|y| S) ($ S))
        (SPROG ((#1=#:G375 NIL) (|k| NIL) (#2=#:G374 NIL) (|ky| (|Kernel| S)))
               (SEQ
...
(SDEFUN |ES-;mkKerLists|
        ...
        (SPROG
         ((|lv| (|List| S)) (|lk| (|List| (|Kernel| S)))
          (|k| (|Union| (|Kernel| S) "failed")) (#1=#:G394 NIL) (|eq| NIL))
