...
(SDEFUN |ES-;kernels;LL;8| ((|lf| (|List| S)) (% (|List| (|Kernel| S))))
        (SPROG ((#1=#:G60 NIL) (|f| NIL) (#2=#:G59 NIL))
               (SEQ
                (SPADCALL (ELT % 34)
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |ES-;operators;SL;9| ((|f| (S)) (% (|List| (|BasicOperator|))))
        (SPROG ((#1=#:G66 NIL) (|k| NIL) (#2=#:G65 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |ES-;freeOf?;SSB;11| ((|x| (S)) (|s| (|Symbol|)) (% (|Boolean|)))
        (SPROG ((#1=#:G79 NIL) (|k| NIL) (#2=#:G78 NIL))
               (SEQ
                (NULL
                 (SPADCALL |s|
                           (PROGN
...
(SDEFUN |ES-;distribute;2S;12| ((|x| (S)) (% (S)))
        (SPROG ((#1=#:G85 NIL) (|k| NIL) (#2=#:G84 NIL))
               (SEQ
                (|ES-;unwrap|
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |ES-;eval;SLLS;29|
        ...
        (SPROG ((#1=#:G157 NIL) (|f| NIL) (#2=#:G156 NIL))
               (SEQ
                (SPADCALL |x| |ls|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |ES-;map;MKS;32| ((|fn| (|Mapping| S S)) (|k| (|Kernel| S)) (% (S)))
        (SPROG ((|l| (|List| S)) (#1=#:G231 NIL) (|x| NIL) (#2=#:G230 NIL))
               (SEQ
                (COND
                 ((SPADCALL
                   (LETT |l|
...
(SDEFUN |ES-;mainKernel;SU;34| ((|x| (S)) (% (|Union| (|Kernel| S) "failed")))
        (SPROG
         ((|k| (|Kernel| S)) (|n| (|NonNegativeInteger|)) (#1=#:G248 NIL)
...
(SDEFUN |ES-;allKernels| ((|f| (S)) (% (|Set| (|Kernel| S))))
        (SPROG
         ((|s| (|Set| (|Kernel| S))) (|t| (|Set| (|Kernel| S)))
          ...
          (#1=#:G262 NIL) (|k| NIL) (|l| (|List| (|Kernel| S))))
         (SEQ
          (LETT |s|
...
(SDEFUN |ES-;okkernel| ((|op| (|BasicOperator|)) (|l| (|List| S)) (% (S)))
        (SPROG ((#1=#:G280 NIL) (|f| NIL) (#2=#:G279 NIL))
               (SEQ
                (SPADCALL
                 (SPADCALL |op| |l|
                           (+ 1
...
(SDEFUN |ES-;distribute;3S;44| ((|x| (S)) (|y| (S)) (% (S)))
        (SPROG ((#1=#:G333 NIL) (|k| NIL) (#2=#:G332 NIL) (|ky| (|Kernel| S)))
...
(SDEFUN |ES-;mkKerLists|
        ...
        (SPROG
         ((|lv| (|List| S)) (|lk| (|List| (|Kernel| S)))
          (|k| (|Union| (|Kernel| S) "failed")) (#1=#:G353 NIL) (|eq| NIL))
