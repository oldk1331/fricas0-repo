...
(SDEFUN |CFACET;cubicalFacet;IL$;1|
        ...
        (SPROG
         ((|mul2| (|Integer|)) (|fac2| (|List| (|Segment| (|Integer|))))
          ...
          (|hi| (|Integer|)) (|lo| (|Integer|)) (#1=#:G134 NIL) (|x| NIL))
...
(SDEFUN |CFACET;cubicalFacet;IL$;2|
        ...
        (SPROG
         ((|fac2| (|List| (|Segment| (|Integer|))))
          (|interv| (|Segment| (|Integer|))) (#1=#:G142 NIL) (|x| NIL))
         (SEQ (LETT |fac2| NIL)
              (SEQ (LETT |x| NIL) (LETT #1# |fac1|) G190
                   (COND
                    ((OR (ATOM #1#) (PROGN (LETT |x| (CAR #1#)) NIL))
...
(SDEFUN |CFACET;order;$Nni;5| ((|f| ($)) ($ (|NonNegativeInteger|)))
        (SPROG
         ((|value| (|NonNegativeInteger|)) (#1=#:G147 NIL) (|hi| (|Integer|))
          (|lo| (|Integer|)) (#2=#:G152 NIL) (|seg| NIL)
...
(SDEFUN |CFACET;position;$LI;8| ((|e| ($)) (|lst| (|List| $)) ($ (|Integer|)))
        (SPROG ((#1=#:G165 NIL) (|res| (|Integer|)) (#2=#:G166 NIL) (|x| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |res| 1)
...
(SDEFUN |CFACET;boundaryOneDimension|
        ...
        (SPROG
         ((|res| (|List| $)) (|r2| ($)) (|r1| ($)) (|mult| (|Integer|))
          ...
          (|lo| (|Integer|)) (#1=#:G176 NIL) (|seg| NIL) (#2=#:G177 NIL)
...
(SDEFUN |CFACET;boundary;$L;11| ((|orf| ($)) ($ (|List| $)))
        (SPROG
         ((|invert| (|Boolean|)) (|res| (|List| $)) (#1=#:G189 NIL) (|dim| NIL)
          (|dims| (|List| (|NonNegativeInteger|))) (|hi| (|Integer|))
          (|lo| (|Integer|)) (#2=#:G187 NIL) (|seg| NIL) (#3=#:G188 NIL)
          (|segn| NIL) (|facet| (|List| (|Segment| (|Integer|)))))
...
(SDEFUN |CFACET;allSubsets;$NniL;14|
        ...
        (SPROG
         ((|res| (|List| $)) (|sub| (|List| $)) (|rHi1| ($))
          ...
          (|lo| (|Integer|)) (#3=#:G216 NIL) (|x| NIL) (#4=#:G217 NIL)
          (|xn| NIL) (#5=#:G215 NIL)
          (|facet| (|List| (|Segment| (|Integer|)))))
         (SEQ
          (EXIT
...
(SDEFUN |CFACET;allSubsets;$2NniL;15|
        ...
        (SPROG
         ((|res2| (|List| $)) (#1=#:G224 NIL) (|y| NIL) (|res| (|List| $)))
...
(SDEFUN |CFACET;ltLocal|
        ...
        (SPROG
         ((#1=#:G235 NIL) (|hib| #2=(|Integer|)) (|lob| #3=(|Integer|))
          (|hia| #2#) (|loa| #3#) (#4=#:G236 NIL) (|a1| NIL) (#5=#:G237 NIL)
          (|b1| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |CFACET;<=;2$B;19| ((|ain| ($)) (|bin| ($)) ($ (|Boolean|)))
        (SPROG
         ((#1=#:G242 NIL) (|b| #2=(|List| (|Segment| (|Integer|)))) (|a| #2#))
         (SEQ
          (EXIT
           (SEQ (LETT |a| (QCDR |ain|)) (LETT |b| (QCDR |bin|))
                (COND
...
(SDEFUN |CFACET;coerce;$Of;21| ((|s| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|body| (|OutputForm|)) (|elements| (|List| (|OutputForm|)))
          (#1=#:G256 NIL) (|x| NIL) (#2=#:G255 NIL) (|prefix| (|OutputForm|))
          (|m| (|Integer|)))
