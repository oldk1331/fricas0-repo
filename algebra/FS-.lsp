...
(SDEFUN |FS-;elt;BoLS;29| ((|op| |BasicOperator|) (|args| |List| S) ($ S))
        (SPROG ((#1=#:G250 NIL) (|x| (S)) (|od?| (|Boolean|)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
...
(SDEFUN |FS-;eval;SLLLS;30|
        ...
        (SPROG ((#1=#:G255 NIL) (|f| NIL) (#2=#:G254 NIL))
               (SEQ
                (SPADCALL |x| |s| |n|
                          (PROGN
...
(SDEFUN |FS-;smprep|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| S)) (|a| (S)) (|t2| (S))
          ...
          (|n| (|Integer|)) (|g| (S)) (|arg| (|List| S)) (#1=#:G284 NIL)
          (#2=#:G283 NIL) (|op| (|BasicOperator|)) (|k| (|Kernel| S))
...
(SDEFUN |FS-;dispdiff|
        ...
        (SPROG
         ((|m| (|List| (|OutputForm|))) (#1=#:G297 NIL) (|x| NIL)
          (#2=#:G296 NIL) (|i| (|Integer|))
          (|rec|
           (|Record| (|:| |name| (|OutputForm|)) (|:| |sub| (|OutputForm|))
                     (|:| |arg| (|List| (|OutputForm|)))
...
(SDEFUN |FS-;encode_diff|
        ((|ker| |Kernel| S) (|nsub| |List| (|Integer|)) (|args| |List| S)
         (|nd| |List| S) ($ S))
        (SPROG
         ((|res| (S)) (#1=#:G323 NIL) (|kk| NIL) (#2=#:G319 NIL)
          (|i| #3=(|Integer|)) (#4=#:G320 NIL) (|k| (|Integer|))
          (#5=#:G321 NIL) (|pt| NIL) (#6=#:G322 NIL) (|dm| NIL)
          (|pts| (|List| S)) (#7=#:G317 NIL) (#8=#:G318 NIL)
...
(SDEFUN |FS-;pos_diff|
        ...
        (SPROG
         ((|nd| #1#) (|dm| (S)) (|nd2| (|List| S)) (|nd1| (|List| S))
          (|k| (|NonNegativeInteger|)) (#2=#:G336 NIL) (#3=#:G337 NIL)
                   ...
                   (SEQ (LETT |j| NIL . #4#) (LETT #3# |nsub| . #4#) G190
                        ...
                        (SEQ
                         (EXIT
                          (COND
                           ((EQL |i| |j|)
                            (PROGN (LETT #2# |$NoValue| . #4#) (GO #5=#:G331)))
                           ((NULL (EQL |ii| |j|))
                            (LETT |k| (+ |k| 1) . #4#)))))
...
(SDEFUN |FS-;diffdiff| ((|l| |List| S) (|x| |Symbol|) ($ S))
        (SPROG
         ((|res| (S)) (|db| (S)) (#1=#:G343 NIL) (|i| NIL) (#2=#:G344 NIL)
          (|b| NIL) (|args| #3=(|List| S))
          (|r1|
...
(SDEFUN |FS-;diffEval| ((|l| |List| S) ($ S))
        (SPROG
         ((|d| (|List| (|Mapping| S (|List| S)))) (|n| (|Integer|))
          ...
          (|op| (|BasicOperator|)) (#1=#:G379 NIL) (|k| (|Kernel| S))
...
(SDEFUN |FS-;opderiv|
        ...
        (SPROG ((#1=#:G390 NIL) (|i| NIL) (#2=#:G389 NIL) (|g| (S)))
               (SEQ
                (COND
                 ((EQL |n| 1)
                  (SEQ
...
(SDEFUN |FS-;kerderiv| ((|k| |Kernel| S) (|x| |Symbol|) ($ S))
        (SPROG
         ((#1=#:G408 NIL) (#2=#:G407 (S)) (#3=#:G409 (S)) (|dyx| (S))
          (#4=#:G413 NIL) (|g| NIL) (#5=#:G414 NIL) (|y| NIL)
...
(SDEFUN |FS-;smpderiv|
        ((|p| |SparseMultivariatePolynomial| R (|Kernel| S)) (|x| |Symbol|)
         ($ S))
        (SPROG
         ((#1=#:G441 NIL) (#2=#:G440 (S)) (#3=#:G442 (S)) (#4=#:G444 NIL)
          (|k| NIL))
         (SEQ
          (SPADCALL
           (SPADCALL
...
(SDEFUN |FS-;smp2O|
        ...
        (SPROG ((|a| (|Kernel| S)) (#1=#:G458 NIL) (|r| (|Union| R "failed")))
               (SEQ
...
(SDEFUN |FS-;pushunq| ((|l| |List| (|Symbol|)) (|arg| |List| S) ($ |List| S))
        (SPROG
         ((#1=#:G515 NIL) (|a| NIL) (#2=#:G514 NIL) (#3=#:G513 NIL)
          (#4=#:G512 NIL))
         (SEQ
          (COND
           ((NULL |l|)
...
(SDEFUN |FS-;kunq|
        ((|k| |Kernel| S) (|l| |List| (|Symbol|)) (|givenlist?| |Boolean|)
         ($ S))
        (SPROG ((#1=#:G567 NIL) (|a| NIL) (#2=#:G566 NIL) (|s| (|Symbol|)))
               (SEQ
                (COND
                 (|givenlist?|
...
(SDEFUN |FS-;smpIsMult|
        ((|p| |SparseMultivariatePolynomial| R (|Kernel| S))
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((#1=#:G623 NIL) (|n| (|Union| (|Integer|) "failed"))
          (|r| (|Union| R "failed"))
          (|q|
...
(SDEFUN |FS-;equaldiff| ((|k1| |Kernel| S) (|k2| |Kernel| S) ($ |Boolean|))
        (SPROG
         ((|sk1| (S)) (|ok1| (S)) (|od| (|List| (|Kernel| S))) (#1=#:G643 NIL)
          (|dk| NIL) (#2=#:G642 NIL)
          (|r2|
...
(SDEFUN |FS-;alg_ker_set| ((|lx| |List| S) ($ |List| (|Kernel| S)))
        (SPROG
         ((|ak1| (|List| #1=(|Kernel| S))) (#2=#:G803 NIL) (|k1| NIL)
          (|arg| (|List| S)) (|resl| (|List| (|Kernel| S)))
          (|needed| (|Boolean|)) (#3=#:G802 NIL) (#4=#:G801 NIL)
          (#5=#:G800 NIL) (|k| NIL) (|ak| (|List| #1#)) (#6=#:G799 NIL)
          (#7=#:G798 NIL) (|x| NIL))
           ...
           (SEQ
            (SEQ
             ...
             (EXIT
              (COND
               ((QEQCAR |n| 1)
                (PROGN (LETT #1# (CONS 1 #4="failed") . #3#) (GO #5=#:G814)))
               (#6='T
                (SEQ
                 (LETT |d|
                       (SPADCALL (SPADCALL |x| (QREFELT $ 293))
...
(SDEFUN |FS-;convert;FS;109| ((|x| |Factored| S) ($ S))
        (SPROG
         ((#1=#:G839 NIL) (#2=#:G838 (S)) (#3=#:G840 (S)) (#4=#:G842 NIL)
          (|f| NIL))
         (SEQ
          (SPADCALL (|FS-;par| (SPADCALL |x| (QREFELT $ 331)) $)
                    (PROGN
                     ...
                     (SEQ (LETT |f| NIL . #5#)
                          (LETT #4# (SPADCALL |x| (QREFELT $ 335)) . #5#) G190
                          (COND
                           ((OR (ATOM #4#)
...
(SDEFUN |FS-;retractIfCan;SU;110|
        ...
        (SPROG ((|u| (|Union| (|Fraction| (|Polynomial| R)) "failed")))
               (SEQ
                (LETT |u| (SPADCALL |x| (QREFELT $ 339))
                      |FS-;retractIfCan;SU;110|)
                (EXIT
                 (COND ((QEQCAR |u| 1) (CONS 1 "failed"))
                       ('T (SPADCALL (QCDR |u|) (QREFELT $ 340)))))))) 
...
(SDEFUN |FS-;coerce;PS;112| ((|p| |Polynomial| (|Fraction| R)) ($ S))
        (SPADCALL (ELT $ 38) (ELT $ 342) |p| (QREFELT $ 345))) 

(SDEFUN |FS-;coerce;FS;113| ((|x| |Fraction| (|Integer|)) ($ S))
        (SPADCALL (SPADCALL (SPADCALL |x| (QREFELT $ 348)) (QREFELT $ 349))
                  (SPADCALL (SPADCALL |x| (QREFELT $ 350)) (QREFELT $ 349))
                  (QREFELT $ 298))) 
...
(SDEFUN |FS-;isMult;SU;114|
        ...
        (SPROG
         ((|q| (|Union| (|Integer|) "failed"))
          ...
          (#1=#:G877 NIL) (|w| (|Union| (|Integer|) "failed"))
          (|v| (|Union| R "failed"))
          (|u|
           (|Union|
            (|Record| (|:| |coef| (|Integer|)) (|:| |var| (|Kernel| S)))
           ...
           (SEQ
            (SEQ
             ...
             (EXIT
              (COND
               ((QEQCAR |u| 1)
                (PROGN (LETT #1# (CONS 1 #3="failed") . #2#) (GO #4=#:G875)))
               (#5='T
                (SEQ
                 (LETT |v|
                       (SPADCALL (SPADCALL |x| (QREFELT $ 293))
                          ...
                          (COND
                           ((QEQCAR |w| 1)
                            (PROGN
                             ...
                             (GO #4#))))))))))))))
            (LETT |r| (QCDR |u|) . #2#)
            (LETT |q| (SPADCALL (QCAR |r|) (QCDR |w|) (QREFELT $ 352)) . #2#)
            (EXIT
          ...
          (COND
           ((|testBitVector| |pv$| 2)
            (PROGN
             ...
             (QSETREFV $ 346 (CONS (|dispatchFunction| |FS-;coerce;PS;112|) $))
             (COND
              ((|testBitVector| |pv$| 1)
               (PROGN
                (QSETREFV $ 351
...
(MAKEPROP '|FunctionSpace&| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'ODD 'EVEN
              ...
              (|Record| (|:| |flag| 332) (|:| |factor| 6) (|:| |exponent| 83))
              (|List| 333) (1203 . |factorList|) (|Factored| $)
              (1208 . |convert|) (|Union| 300 '#1#) (1213 . |retractIfCan|)
              ...
              (|PositiveInteger|) (|Union| 347 '#1#) (|List| 173))
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 354
                                                 '(1 13 11 12 14 1 6 17 0 18 1
                                                   ...
                                                   6 0 331 1 330 334 0 335 1 0
                                                   0 336 337 1 6 338 0 339 1
                                                   300 245 0 340 1 0 338 0 341
                                                   1 6 0 295 342 3 344 6 188
                                                   343 306 345 1 0 0 306 346 1
                                                   347 122 0 348 1 86 0 122 349
                                                   1 347 122 0 350 1 0 0 347
                                                   351 2 122 316 0 0 352 2 266
                                                   0 0 0 353 2 269 0 0 0 354 1
                                                   0 59 32 76 1 0 59 0 78 2 0
                                                   282 0 25 283 3 0 0 0 74 32
                                                   248 1 0 245 0 246 1 0 338 0
                                                   341 1 0 17 0 244 1 0 29 0 81
                                                   ...
                                                   336 337 1 0 269 0 271 1 0
                                                   266 0 268 1 0 0 178 192 1 0
                                                   0 347 351 1 0 0 300 305 1 0
                                                   0 307 311 1 0 0 295 299 1 0
                                                   0 306 346 1 0 0 12 27 1 0
