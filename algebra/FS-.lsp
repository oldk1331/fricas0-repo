...
(SDEFUN |FS-;eval;SLLSS;16|
        ((|f| (S)) (|ls| (|List| (|BasicOperator|))) (|lg| (|List| S))
         (|x| (|Symbol|)) (% (S)))
        (SPROG ((#1=#:G198 NIL) (|g| NIL) (#2=#:G197 NIL))
               (SEQ
                (SPADCALL |f| |ls|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FS-;elt;BoLS;27|
        ...
        (SPROG ((#1=#:G254 NIL) (|x| (S)) (|od?| (|Boolean|)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
...
(SDEFUN |FS-;eval;SLLLS;28|
        ((|x| (S)) (|s| (|List| (|Symbol|)))
         ...
         (% (S)))
        (SPROG ((#1=#:G260 NIL) (|f| NIL) (#2=#:G259 NIL))
               (SEQ
                (SPADCALL |x| |s| |n|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FS-;smprep|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| S)) (|a| (S)) (|t2| (S))
          ...
          (|n| (|Integer|)) (|g| (S)) (|arg| (|List| S)) (#1=#:G293 NIL)
          (#2=#:G292 NIL) (|op| (|BasicOperator|)) (|k| (|Kernel| S))
...
(SDEFUN |FS-;dispdiff|
        ...
        (SPROG
         ((|d_name| (|OutputForm|)) (|dnu| (|Union| (|None|) "failed"))
          (|m| (|List| (|OutputForm|))) (#1=#:G311 NIL) (|x| NIL)
          (#2=#:G310 NIL) (|i| (|Integer|))
          (|rec|
           (|Record| (|:| |name| (|OutputForm|)) (|:| |sub| (|OutputForm|))
                     (|:| |arg| (|List| (|OutputForm|)))
                     (|:| |orig_op| (|BasicOperator|))
...
(SDEFUN |FS-;encode_diff|
        ((|ker| (|Kernel| S)) (|nsub| (|List| (|Integer|))) (|args| (|List| S))
         (|nd| (|List| S)) (% (S)))
        (SPROG
         ((|res| (S)) (#1=#:G341 NIL) (|kk| NIL) (#2=#:G337 NIL)
          (#3=#:G338 NIL) (#4=#:G339 NIL) (|pt| NIL) (#5=#:G340 NIL) (|dm| NIL)
          (|pts| (|List| S)) (#6=#:G335 NIL) (#7=#:G336 NIL)
...
(SDEFUN |FS-;pos_diff|
        ...
        (SPROG
         ((|nd| #1#) (|dm| (S)) (|nd2| (|List| S)) (|nd1| (|List| S))
          (|k| (|NonNegativeInteger|)) (#2=#:G356 NIL) (#3=#:G357 NIL)
                       ...
                       (SEQ (LETT |j| NIL) (LETT #3# |nsub|) G190
                            ...
                            (SEQ
                             (EXIT
                              (COND
                               ((EQL |i| |j|)
                                (PROGN (LETT #2# |$NoValue|) (GO #4=#:G351)))
...
(SDEFUN |FS-;diffdiff| ((|l| (|List| S)) (|x| (|Symbol|)) (% (S)))
        (SPROG
         ((|res| (S)) (#1=#:G364 NIL) (|db| (S)) (#2=#:G365 NIL) (|i| NIL)
          (#3=#:G366 NIL) (|b| NIL) (|args| #4=(|List| S))
          (|r1|
           (|Record| (|:| |orig_k| (|Kernel| S))
                     (|:| |sub| (|List| (|Integer|))) (|:| |oarg| (|List| S))
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |db| (|spadConstant| % 125)
                                       (QREFELT % 60))
                             (PROGN (LETT #1# |$NoValue|) (GO #5=#:G359)))
                            ('T
                             (LETT |res|
                                   (SPADCALL |res|
                                             (SPADCALL |db|
...
(SDEFUN |FS-;diffEval| ((|l| (|List| S)) (% (S)))
        (SPROG
         ((|d| (|List| (|Mapping| S (|List| S)))) (|n| (|Integer|))
          ...
          (|op| (|BasicOperator|)) (#1=#:G401 NIL) (|k| (|Kernel| S))
           ...
           (SEQ
            ...
            (SEQ (LETT |u| (SPADCALL (|SPADfirst| |l|) (QREFELT % 81)))
                 (EXIT
                  (COND
                   ((QEQCAR |u| 1)
                    (PROGN (LETT #1# (|FS-;dfeval| |l| |g| %)) (GO #2=#:G399)))
                   ((QEQCAR |u| 0)
                    (COND
...
(SDEFUN |FS-;opderiv|
        ...
        (SPROG ((#1=#:G413 NIL) (|i| NIL) (#2=#:G412 NIL) (|g| (S)))
               (SEQ
                (COND
                 ((EQL |n| 1)
                  (SEQ
...
(SDEFUN |FS-;kerderiv| ((|k| (|Kernel| S)) (|x| (|Symbol|)) (% (S)))
        (SPROG
         ((#1=#:G432 NIL) (#2=#:G431 (S)) (#3=#:G433 (S)) (|dyx| (S))
          (#4=#:G437 NIL) (|g| NIL) (#5=#:G438 NIL) (|y| NIL)
...
(SDEFUN |FS-;smpderiv|
        ((|p| (|SparseMultivariatePolynomial| R (|Kernel| S))) (|x| (|Symbol|))
         (% (S)))
        (SPROG
         ((#1=#:G465 NIL) (#2=#:G464 (S)) (#3=#:G466 (S)) (#4=#:G468 NIL)
          (|k| NIL))
         (SEQ
          (SPADCALL
           (SPADCALL
...
(SDEFUN |FS-;smp2O|
        ((|p| (|SparseMultivariatePolynomial| R (|Kernel| S)))
         (% (|OutputForm|)))
        (SPROG ((|a| (|Kernel| S)) (#1=#:G482 NIL) (|r| (|Union| R "failed")))
...
(SDEFUN |FS-;smpret|
        ...
        (SPROG
         ((#1=#:G536 NIL) (#2=#:G535 #3=(|Boolean|)) (#4=#:G537 #3#)
          (#5=#:G544 NIL) (|k| NIL))
         (SEQ
          (COND
           ((PROGN
        ...
        ((|p| (|SparseMultivariatePolynomial| R (|Kernel| S)))
         (%
          (|Union| (|Record| (|:| |coef| (|Integer|)) (|:| |var| (|Kernel| S)))
                   "failed")))
        (SPROG
         ((#1=#:G583 NIL) (|n| (|Union| (|Integer|) "failed"))
          (|r| (|Union| R "failed"))
          (|q|
...
(SDEFUN |FS-;equaldiff|
        ...
        (SPROG
         ((|sk1| (S)) (|ok1| (S)) (|od| (|List| (|Kernel| S))) (#1=#:G604 NIL)
          (|dk| NIL) (#2=#:G603 NIL)
          (|r2|
...
(SDEFUN |FS-;alg_ker_set| ((|lx| (|List| S)) (% (|List| (|Kernel| S))))
        (SPROG
         ((#1=#:G766 NIL) (|ak1| (|List| #2=(|Kernel| S))) (#3=#:G773 NIL)
          (|k1| NIL) (|arg| (|List| S)) (|resl| (|List| (|Kernel| S)))
          (|needed| (|Boolean|)) (#4=#:G772 NIL) (#5=#:G771 NIL)
          (#6=#:G770 NIL) (|k| NIL) (|ak| (|List| #2#)) (#7=#:G767 NIL)
          (#8=#:G769 NIL) (#9=#:G768 NIL) (|x| NIL))
           ...
           (SEQ
            (SEQ
             ...
             (EXIT
              (COND
               ((QEQCAR |n| 1)
                (PROGN (LETT #1# (CONS 1 #3="failed")) (GO #4=#:G784)))
               (#5='T
                (SEQ
                 (LETT |d|
                       (SPADCALL (SPADCALL |x| (QREFELT % 281))
...
(SDEFUN |FS-;convert;FS;100| ((|x| (|Factored| S)) (% (S)))
        (SPROG
         ((#1=#:G810 NIL) (#2=#:G809 (S)) (#3=#:G811 (S)) (#4=#:G813 NIL)
          (|f| NIL))
         (SEQ
...
(SDEFUN |FS-;isMult;SU;105|
        ...
        (SPROG
         ((|q| (|Union| (|Integer|) "failed"))
          ...
          (#1=#:G848 NIL) (|w| (|Union| (|Integer|) "failed"))
          (|v| (|Union| R "failed"))
          (|u|
           (|Union|
           ...
           (SEQ
            (SEQ (LETT |u| (|FS-;smpIsMult| (SPADCALL |x| (QREFELT % 92)) %))
                 (EXIT
                  (COND
                   ((QEQCAR |u| 1)
                    (PROGN (LETT #1# (CONS 1 #2="failed")) (GO #3=#:G846)))
                   (#4='T
                    (SEQ
                     (LETT |v|
                           (SPADCALL (SPADCALL |x| (QREFELT % 281))
