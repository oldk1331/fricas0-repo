...
(SDEFUN |FS-;smprep|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| S)) (|a| (S)) (|t2| (S))
          ...
          (|n| (|Integer|)) (|g| (S)) (|arg| (|List| S)) (#1=#:G189 NIL)
          (#2=#:G188 NIL) (|op| (|BasicOperator|)) (|k| (|Kernel| S))
...
(SDEFUN |FS-;dispdiff|
        ...
        (SPROG
         ((|d_name| (|OutputForm|)) (|dnu| (|Union| (|None|) "failed"))
          (|m| (|List| (|OutputForm|))) (#1=#:G207 NIL) (|x| NIL)
          (#2=#:G206 NIL) (|i| (|Integer|))
          (|rec|
           (|Record| (|:| |name| (|OutputForm|)) (|:| |sub| (|OutputForm|))
                     (|:| |arg| (|List| (|OutputForm|)))
                     (|:| |orig_op| (|BasicOperator|))
...
(SDEFUN |FS-;encode_diff|
        ((|ker| (|Kernel| S)) (|nsub| (|List| (|Integer|))) (|args| (|List| S))
         (|nd| (|List| S)) (% (S)))
        (SPROG
         ((|res| (S)) (#1=#:G237 NIL) (|kk| NIL) (#2=#:G233 NIL)
          (#3=#:G234 NIL) (#4=#:G235 NIL) (|pt| NIL) (#5=#:G236 NIL) (|dm| NIL)
          (|pts| (|List| S)) (#6=#:G231 NIL) (#7=#:G232 NIL)
...
(SDEFUN |FS-;pos_diff|
        ...
        (SPROG
         ((|nd| #1#) (|dm| (S)) (|nd2| (|List| S)) (|nd1| (|List| S))
          (|k| (|NonNegativeInteger|)) (#2=#:G252 NIL) (#3=#:G253 NIL)
                       ...
                       (SEQ (LETT |j| NIL) (LETT #3# |nsub|) G190
                            ...
                            (SEQ
                             (EXIT
                              (COND
                               ((EQL |i| |j|)
                                (PROGN (LETT #2# |$NoValue|) (GO #4=#:G247)))
...
(SDEFUN |FS-;diffdiff| ((|l| (|List| S)) (|x| (|Symbol|)) (% (S)))
        (SPROG
         ((|res| (S)) (#1=#:G260 NIL) (|db| (S)) (#2=#:G261 NIL) (|i| NIL)
          (#3=#:G262 NIL) (|b| NIL) (|args| #4=(|List| S))
          (|r1|
           (|Record| (|:| |orig_k| (|Kernel| S))
                     (|:| |sub| (|List| (|Integer|))) (|:| |oarg| (|List| S))
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |db| (|spadConstant| % 125)
                                       (QREFELT % 60))
                             (PROGN (LETT #1# |$NoValue|) (GO #5=#:G255)))
                            ('T
                             (LETT |res|
                                   (SPADCALL |res|
                                             (SPADCALL |db|
...
(SDEFUN |FS-;diffEval| ((|l| (|List| S)) (% (S)))
        (SPROG
         ((|d| (|List| (|Mapping| S (|List| S)))) (|n| (|Integer|))
          ...
          (|op| (|BasicOperator|)) (#1=#:G297 NIL) (|k| (|Kernel| S))
           ...
           (SEQ
            ...
            (SEQ (LETT |u| (SPADCALL (|SPADfirst| |l|) (QREFELT % 81)))
                 (EXIT
                  (COND
                   ((QEQCAR |u| 1)
                    (PROGN (LETT #1# (|FS-;dfeval| |l| |g| %)) (GO #2=#:G295)))
                   ((QEQCAR |u| 0)
                    (COND
...
(SDEFUN |FS-;opderiv|
        ...
        (SPROG ((#1=#:G309 NIL) (|i| NIL) (#2=#:G308 NIL) (|g| (S)))
               (SEQ
                (COND
                 ((EQL |n| 1)
                  (SEQ
...
(SDEFUN |FS-;kerderiv| ((|k| (|Kernel| S)) (|x| (|Symbol|)) (% (S)))
        (SPROG
         ((#1=#:G328 NIL) (#2=#:G327 (S)) (#3=#:G329 (S)) (|dyx| (S))
          (#4=#:G333 NIL) (|g| NIL) (#5=#:G334 NIL) (|y| NIL)
...
(SDEFUN |FS-;smpderiv|
        ((|p| (|SparseMultivariatePolynomial| R (|Kernel| S))) (|x| (|Symbol|))
         (% (S)))
        (SPROG
         ((#1=#:G361 NIL) (#2=#:G360 (S)) (#3=#:G362 (S)) (#4=#:G364 NIL)
          (|k| NIL))
         (SEQ
          (SPADCALL
           (SPADCALL
...
(SDEFUN |FS-;smp2O|
        ((|p| (|SparseMultivariatePolynomial| R (|Kernel| S)))
         (% (|OutputForm|)))
        (SPROG ((|a| (|Kernel| S)) (#1=#:G378 NIL) (|r| (|Union| R "failed")))
...
(SDEFUN |FS-;smpret|
        ...
        (SPROG
         ((#1=#:G432 NIL) (#2=#:G431 #3=(|Boolean|)) (#4=#:G433 #3#)
          (#5=#:G440 NIL) (|k| NIL))
         (SEQ
          (COND
           ((PROGN
        ...
        ((|p| (|SparseMultivariatePolynomial| R (|Kernel| S)))
         (%
          (|Union| (|Record| (|:| |coef| (|Integer|)) (|:| |var| (|Kernel| S)))
                   "failed")))
        (SPROG
         ((#1=#:G479 NIL) (|n| (|Union| (|Integer|) "failed"))
          (|r| (|Union| R "failed"))
          (|q|
...
(SDEFUN |FS-;equaldiff|
        ...
        (SPROG
         ((|sk1| (S)) (|ok1| (S)) (|od| (|List| (|Kernel| S))) (#1=#:G500 NIL)
          (|dk| NIL) (#2=#:G499 NIL)
          (|r2|
...
(SDEFUN |FS-;alg_ker_set| ((|lx| (|List| S)) (% (|List| (|Kernel| S))))
        (SPROG
         ((#1=#:G662 NIL) (|ak1| (|List| #2=(|Kernel| S))) (#3=#:G669 NIL)
          (|k1| NIL) (|arg| (|List| S)) (|resl| (|List| (|Kernel| S)))
          (|needed| (|Boolean|)) (#4=#:G668 NIL) (#5=#:G667 NIL)
          (#6=#:G666 NIL) (|k| NIL) (|ak| (|List| #2#)) (#7=#:G663 NIL)
          (#8=#:G665 NIL) (#9=#:G664 NIL) (|x| NIL))
           ...
           (SEQ
            (SEQ
             ...
             (EXIT
              (COND
               ((QEQCAR |n| 1)
                (PROGN (LETT #1# (CONS 1 #3="failed")) (GO #4=#:G680)))
               (#5='T
                (SEQ
                 (LETT |d|
                       (SPADCALL (SPADCALL |x| (QREFELT % 281))
...
(SDEFUN |FS-;convert;FS;100| ((|x| (|Factored| S)) (% (S)))
        (SPROG
         ((#1=#:G706 NIL) (#2=#:G705 (S)) (#3=#:G707 (S)) (#4=#:G709 NIL)
          (|f| NIL))
         (SEQ
...
(SDEFUN |FS-;isMult;SU;105|
        ...
        (SPROG
         ((|q| (|Union| (|Integer|) "failed"))
          ...
          (#1=#:G744 NIL) (|w| (|Union| (|Integer|) "failed"))
          (|v| (|Union| R "failed"))
          (|u|
           (|Union|
           ...
           (SEQ
            (SEQ (LETT |u| (|FS-;smpIsMult| (SPADCALL |x| (QREFELT % 92)) %))
                 (EXIT
                  (COND
                   ((QEQCAR |u| 1)
                    (PROGN (LETT #1# (CONS 1 #2="failed")) (GO #3=#:G742)))
                   (#4='T
                    (SEQ
                     (LETT |v|
                           (SPADCALL (SPADCALL |x| (QREFELT % 281))
