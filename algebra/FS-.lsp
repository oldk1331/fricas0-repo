...
(SDEFUN |FS-;subs| ((|fn| |Mapping| S S) (|k| |Kernel| S) ($ S))
        (SPROG ((#1=#:G191 NIL) (|x| NIL) (#2=#:G190 NIL))
               (SEQ
...
(SDEFUN |FS-;eval;SLLSS;16|
        ((|f| S) (|ls| |List| (|BasicOperator|)) (|lg| |List| S) (|x| |Symbol|)
         ($ S))
        (SPROG ((#1=#:G210 NIL) (|g| NIL) (#2=#:G209 NIL))
               (SEQ
                (SPADCALL |f| |ls|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FS-;elt;BoLS;27| ((|op| |BasicOperator|) (|args| |List| S) ($ S))
        (SPROG ((#1=#:G265 NIL) (|x| (S)) (|od?| (|Boolean|)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
...
(SDEFUN |FS-;eval;SLLLS;28|
        ...
        (SPROG ((#1=#:G270 NIL) (|f| NIL) (#2=#:G269 NIL))
               (SEQ
                (SPADCALL |x| |s| |n|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FS-;smprep|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| S)) (|a| (S)) (|t2| (S))
          ...
          (|n| (|Integer|)) (|g| (S)) (|arg| (|List| S)) (#1=#:G299 NIL)
          (#2=#:G298 NIL) (|op| (|BasicOperator|)) (|k| (|Kernel| S))
...
(SDEFUN |FS-;dispdiff|
        ...
        (SPROG
         ((|d_name| (|OutputForm|)) (|dnu| (|Union| (|None|) "failed"))
          (|m| (|List| (|OutputForm|))) (#1=#:G316 NIL) (|x| NIL)
          (#2=#:G315 NIL) (|i| (|Integer|))
          (|rec|
           (|Record| (|:| |name| (|OutputForm|)) (|:| |sub| (|OutputForm|))
                     (|:| |arg| (|List| (|OutputForm|)))
...
(SDEFUN |FS-;encode_diff|
        ((|ker| |Kernel| S) (|nsub| |List| (|Integer|)) (|args| |List| S)
         (|nd| |List| S) ($ S))
        (SPROG
         ((|res| (S)) (#1=#:G342 NIL) (|kk| NIL) (#2=#:G338 NIL)
          (|i| #3=(|Integer|)) (#4=#:G339 NIL) (|k| (|Integer|))
          (#5=#:G340 NIL) (|pt| NIL) (#6=#:G341 NIL) (|dm| NIL)
          (|pts| (|List| S)) (#7=#:G336 NIL) (#8=#:G337 NIL)
...
(SDEFUN |FS-;diffdiff| ((|l| |List| S) (|x| |Symbol|) ($ S))
        (SPROG
         ((|res| (S)) (|db| (S)) (#1=#:G362 NIL) (|i| NIL) (#2=#:G363 NIL)
          (|b| NIL) (|args| #3=(|List| S))
          (|r1|
...
(SDEFUN |FS-;diffEval| ((|l| |List| S) ($ S))
        (SPROG
         ((|d| (|List| (|Mapping| S (|List| S)))) (|n| (|Integer|))
          ...
          (|op| (|BasicOperator|)) (#1=#:G398 NIL) (|k| (|Kernel| S))
           ...
           (SEQ
            ...
            (SEQ (LETT |u| (SPADCALL (|SPADfirst| |l|) (QREFELT $ 81)))
                 (EXIT
                  (COND
                   ((QEQCAR |u| 1)
                    (PROGN (LETT #1# (|FS-;dfeval| |l| |g| $)) (GO #2=#:G396)))
                   ((QEQCAR |u| 0)
                    (COND
...
(SDEFUN |FS-;opderiv|
        ...
        (SPROG ((#1=#:G409 NIL) (|i| NIL) (#2=#:G408 NIL) (|g| (S)))
               (SEQ
                (COND
                 ((EQL |n| 1)
                  (SEQ
...
(SDEFUN |FS-;kerderiv| ((|k| |Kernel| S) (|x| |Symbol|) ($ S))
        (SPROG
         ((#1=#:G427 NIL) (#2=#:G426 (S)) (#3=#:G428 (S)) (|dyx| (S))
          (#4=#:G432 NIL) (|g| NIL) (#5=#:G433 NIL) (|y| NIL)
...
(SDEFUN |FS-;smpderiv|
        ((|p| |SparseMultivariatePolynomial| R (|Kernel| S)) (|x| |Symbol|)
         ($ S))
        (SPROG
         ((#1=#:G460 NIL) (#2=#:G459 (S)) (#3=#:G461 (S)) (#4=#:G463 NIL)
          (|k| NIL))
         (SEQ
          (SPADCALL
           (SPADCALL
...
(SDEFUN |FS-;smp2O|
        ...
        (SPROG ((|a| (|Kernel| S)) (#1=#:G477 NIL) (|r| (|Union| R "failed")))
...
(SDEFUN |FS-;smpret|
        ...
        (SPROG
         ((#1=#:G531 NIL) (#2=#:G530 #3=(|Boolean|)) (#4=#:G532 #3#)
          (#5=#:G539 NIL) (|k| NIL))
         (SEQ
          (COND
           ((PROGN
...
(SDEFUN |FS-;smpIsMult|
        ((|p| |SparseMultivariatePolynomial| R (|Kernel| S))
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((#1=#:G578 NIL) (|n| (|Union| (|Integer|) "failed"))
          (|r| (|Union| R "failed"))
          (|q|
...
(SDEFUN |FS-;equaldiff| ((|k1| |Kernel| S) (|k2| |Kernel| S) ($ |Boolean|))
        (SPROG
         ((|sk1| (S)) (|ok1| (S)) (|od| (|List| (|Kernel| S))) (#1=#:G598 NIL)
          (|dk| NIL) (#2=#:G597 NIL)
          (|r2|
...
(SDEFUN |FS-;alg_ker_set| ((|lx| |List| S) ($ |List| (|Kernel| S)))
        (SPROG
         ((|ak1| (|List| #1=(|Kernel| S))) (#2=#:G756 NIL) (|k1| NIL)
          (|arg| (|List| S)) (|resl| (|List| (|Kernel| S)))
          (|needed| (|Boolean|)) (#3=#:G755 NIL) (#4=#:G754 NIL)
          (#5=#:G753 NIL) (|k| NIL) (|ak| (|List| #1#)) (#6=#:G752 NIL)
          (#7=#:G751 NIL) (|x| NIL))
           ...
           (SEQ
            (SEQ
             ...
             (EXIT
              (COND
               ((QEQCAR |n| 1)
                (PROGN (LETT #1# (CONS 1 #3="failed")) (GO #4=#:G767)))
               (#5='T
                (SEQ
                 (LETT |d|
                       (SPADCALL (SPADCALL |x| (QREFELT $ 281))
...
(SDEFUN |FS-;convert;FS;100| ((|x| |Factored| S) ($ S))
        (SPROG
         ((#1=#:G790 NIL) (#2=#:G789 (S)) (#3=#:G791 (S)) (#4=#:G793 NIL)
          (|f| NIL))
         (SEQ
...
(SDEFUN |FS-;isMult;SU;105|
        ...
        (SPROG
         ((|q| (|Union| (|Integer|) "failed"))
          ...
          (#1=#:G828 NIL) (|w| (|Union| (|Integer|) "failed"))
          (|v| (|Union| R "failed"))
          (|u|
           (|Union|
            (|Record| (|:| |coef| (|Integer|)) (|:| |var| (|Kernel| S)))
           ...
           (SEQ
            (SEQ (LETT |u| (|FS-;smpIsMult| (SPADCALL |x| (QREFELT $ 92)) $))
                 (EXIT
                  (COND
                   ((QEQCAR |u| 1)
                    (PROGN (LETT #1# (CONS 1 #2="failed")) (GO #3=#:G826)))
                   (#4='T
                    (SEQ
                     (LETT |v|
                           (SPADCALL (SPADCALL |x| (QREFELT $ 281))
