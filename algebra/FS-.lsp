...
(SDEFUN |FS-;eval;SLLSS;16|
        ((|f| (S)) (|ls| (|List| (|BasicOperator|))) (|lg| (|List| S))
         (|x| (|Symbol|)) ($ (S)))
        (SPROG ((#1=#:G197 NIL) (|g| NIL) (#2=#:G196 NIL))
               (SEQ
                (SPADCALL |f| |ls|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FS-;elt;BoLS;27|
        ...
        (SPROG ((#1=#:G253 NIL) (|x| (S)) (|od?| (|Boolean|)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
...
(SDEFUN |FS-;eval;SLLLS;28|
        ((|x| (S)) (|s| (|List| (|Symbol|)))
         ...
         ($ (S)))
        (SPROG ((#1=#:G259 NIL) (|f| NIL) (#2=#:G258 NIL))
               (SEQ
                (SPADCALL |x| |s| |n|
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FS-;smprep|
        ...
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| S)) (|a| (S)) (|t2| (S))
          ...
          (|n| (|Integer|)) (|g| (S)) (|arg| (|List| S)) (#1=#:G292 NIL)
          (#2=#:G291 NIL) (|op| (|BasicOperator|)) (|k| (|Kernel| S))
...
(SDEFUN |FS-;dispdiff|
        ...
        (SPROG
         ((|d_name| (|OutputForm|)) (|dnu| (|Union| (|None|) "failed"))
          (|m| (|List| (|OutputForm|))) (#1=#:G310 NIL) (|x| NIL)
          (#2=#:G309 NIL) (|i| (|Integer|))
          (|rec|
           (|Record| (|:| |name| (|OutputForm|)) (|:| |sub| (|OutputForm|))
                     (|:| |arg| (|List| (|OutputForm|)))
                     (|:| |orig_op| (|BasicOperator|))
...
(SDEFUN |FS-;encode_diff|
        ((|ker| (|Kernel| S)) (|nsub| (|List| (|Integer|))) (|args| (|List| S))
         (|nd| (|List| S)) ($ (S)))
        (SPROG
         ((|res| (S)) (#1=#:G340 NIL) (|kk| NIL) (#2=#:G336 NIL)
          (#3=#:G337 NIL) (#4=#:G338 NIL) (|pt| NIL) (#5=#:G339 NIL) (|dm| NIL)
          (|pts| (|List| S)) (#6=#:G334 NIL) (#7=#:G335 NIL)
...
(SDEFUN |FS-;pos_diff|
        ...
        (SPROG
         ((|nd| #1#) (|dm| (S)) (|nd2| (|List| S)) (|nd1| (|List| S))
          (|k| (|NonNegativeInteger|)) (#2=#:G355 NIL) (#3=#:G356 NIL)
                       ...
                       (SEQ (LETT |j| NIL) (LETT #3# |nsub|) G190
                            ...
                            (SEQ
                             (EXIT
                              (COND
                               ((EQL |i| |j|)
                                (PROGN (LETT #2# |$NoValue|) (GO #4=#:G350)))
...
(SDEFUN |FS-;diffdiff| ((|l| (|List| S)) (|x| (|Symbol|)) ($ (S)))
        (SPROG
         ((|res| (S)) (#1=#:G363 NIL) (|db| (S)) (#2=#:G364 NIL) (|i| NIL)
          (#3=#:G365 NIL) (|b| NIL) (|args| #4=(|List| S))
          (|r1|
           (|Record| (|:| |orig_k| (|Kernel| S))
                     (|:| |sub| (|List| (|Integer|))) (|:| |oarg| (|List| S))
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL |db| (|spadConstant| $ 125)
                                       (QREFELT $ 60))
                             (PROGN (LETT #1# |$NoValue|) (GO #5=#:G358)))
                            ('T
                             (LETT |res|
                                   (SPADCALL |res|
                                             (SPADCALL |db|
...
(SDEFUN |FS-;diffEval| ((|l| (|List| S)) ($ (S)))
        (SPROG
         ((|d| (|List| (|Mapping| S (|List| S)))) (|n| (|Integer|))
          ...
          (|op| (|BasicOperator|)) (#1=#:G400 NIL) (|k| (|Kernel| S))
           ...
           (SEQ
            ...
            (SEQ (LETT |u| (SPADCALL (|SPADfirst| |l|) (QREFELT $ 81)))
                 (EXIT
                  (COND
                   ((QEQCAR |u| 1)
                    (PROGN (LETT #1# (|FS-;dfeval| |l| |g| $)) (GO #2=#:G398)))
                   ((QEQCAR |u| 0)
                    (COND
...
(SDEFUN |FS-;opderiv|
        ...
        (SPROG ((#1=#:G412 NIL) (|i| NIL) (#2=#:G411 NIL) (|g| (S)))
               (SEQ
                (COND
                 ((EQL |n| 1)
                  (SEQ
...
(SDEFUN |FS-;kerderiv| ((|k| (|Kernel| S)) (|x| (|Symbol|)) ($ (S)))
        (SPROG
         ((#1=#:G431 NIL) (#2=#:G430 (S)) (#3=#:G432 (S)) (|dyx| (S))
          (#4=#:G436 NIL) (|g| NIL) (#5=#:G437 NIL) (|y| NIL)
...
(SDEFUN |FS-;smpderiv|
        ((|p| (|SparseMultivariatePolynomial| R (|Kernel| S))) (|x| (|Symbol|))
         ($ (S)))
        (SPROG
         ((#1=#:G464 NIL) (#2=#:G463 (S)) (#3=#:G465 (S)) (#4=#:G467 NIL)
          (|k| NIL))
         (SEQ
          (SPADCALL
           (SPADCALL
...
(SDEFUN |FS-;smp2O|
        ((|p| (|SparseMultivariatePolynomial| R (|Kernel| S)))
         ($ (|OutputForm|)))
        (SPROG ((|a| (|Kernel| S)) (#1=#:G481 NIL) (|r| (|Union| R "failed")))
...
(SDEFUN |FS-;smpret|
        ...
        (SPROG
         ((#1=#:G535 NIL) (#2=#:G534 #3=(|Boolean|)) (#4=#:G536 #3#)
          (#5=#:G543 NIL) (|k| NIL))
         (SEQ
          (COND
           ((PROGN
...
(SDEFUN |FS-;equaldiff|
        ...
        (SPROG
         ((|sk1| (S)) (|ok1| (S)) (|od| (|List| (|Kernel| S))) (#1=#:G603 NIL)
          (|dk| NIL) (#2=#:G602 NIL)
          (|r2|
...
(SDEFUN |FS-;alg_ker_set| ((|lx| (|List| S)) ($ (|List| (|Kernel| S))))
        (SPROG
         ((#1=#:G765 NIL) (|ak1| (|List| #2=(|Kernel| S))) (#3=#:G772 NIL)
          (|k1| NIL) (|arg| (|List| S)) (|resl| (|List| (|Kernel| S)))
          (|needed| (|Boolean|)) (#4=#:G771 NIL) (#5=#:G770 NIL)
          (#6=#:G769 NIL) (|k| NIL) (|ak| (|List| #2#)) (#7=#:G766 NIL)
          (#8=#:G768 NIL) (#9=#:G767 NIL) (|x| NIL))
           ...
           (SEQ
            (SEQ
             ...
             (EXIT
              (COND
               ((QEQCAR |n| 1)
                (PROGN (LETT #1# (CONS 1 #3="failed")) (GO #4=#:G783)))
               (#5='T
                (SEQ
                 (LETT |d|
                       (SPADCALL (SPADCALL |x| (QREFELT $ 281))
...
(SDEFUN |FS-;isMult;SU;105|
        ...
        (SPROG
         ((|q| (|Union| (|Integer|) "failed"))
          ...
          (#1=#:G847 NIL) (|w| (|Union| (|Integer|) "failed"))
          (|v| (|Union| R "failed"))
          (|u|
           (|Union|
           ...
           (SEQ
            (SEQ (LETT |u| (|FS-;smpIsMult| (SPADCALL |x| (QREFELT $ 92)) $))
                 (EXIT
                  (COND
                   ((QEQCAR |u| 1)
                    (PROGN (LETT #1# (CONS 1 #2="failed")) (GO #3=#:G845)))
                   (#4='T
                    (SEQ
                     (LETT |v|
                           (SPADCALL (SPADCALL |x| (QREFELT $ 281))
