               ...
               ((QEQCAR |f0| 0)
                (SEQ (LETT |f1| (QCDR |f0|))
                     ...
                     (EXIT
                      (COND
                       ((QEQCAR |res| 0)
                        (PROGN (LETT #1# (QCDR |res|)) (GO #2=#:G178))))))))))
            (EXIT
...
(SDEFUN |KERNEL;kernel;BoLNni$;18|
        ((|fn| |BasicOperator|) (|x| |List| S) (|n| |NonNegativeInteger|)
         ($ $))
        (SPROG
         ((#1=#:G195 NIL) (|u| (|Union| (|NonNegativeInteger|) "failed")))
         (SEQ
          (EXIT
           (SEQ
        ...
        (SPROG
         ((|u|
           (|Union| (|Mapping| (|OutputForm|) (|List| (|OutputForm|)))
                    "failed"))
          (|l| (|List| (|OutputForm|))) (#1=#:G213 NIL) (|x| NIL)
          (#2=#:G212 NIL) (|f| (|Union| (|None|) "failed"))
...
(SDEFUN |KERNEL;triage| ((|k1| $) (|k2| $) ($ |Integer|))
        (SPROG
         ((#1=#:G221 NIL) (#2=#:G222 NIL) (#3=#:G223 NIL) (|x1| NIL)
          (#4=#:G224 NIL) (|x2| NIL) (|n2| (|Integer|)) (|n1| (|Integer|)))
         (SEQ
          (EXIT
           (COND
            ((SPADCALL (SPADCALL |k1| (QREFELT $ 12))
...
(SDEFUN |KERNEL;convert;$If;21| ((|k| $) ($ |InputForm|))
        (SPROG
         ((|u|
          ...
          (|l| (|List| (|InputForm|))) (#1=#:G242 NIL) (|x| NIL)
          (#2=#:G241 NIL) (|f| (|Union| (|None|) "failed"))
          (|o| (|BasicOperator|)) (|v| (|Union| (|Symbol|) "failed")))
         (SEQ (LETT |v| (SPADCALL |k| (QREFELT $ 42)))
              (EXIT
...
(SDEFUN |KERNEL;convert;$P;23| ((|k| $) ($ |Pattern| (|Float|)))
        (SPROG
         ((#1=#:G260 NIL) (|x| NIL) (#2=#:G259 NIL) (|l| (|List| (|Any|)))
