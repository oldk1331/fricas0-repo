...
(MAKEPROP '|OrderlyDifferentialPolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL
              ...
              (|Union| $ '#1#) (|Fraction| 37) (|NonNegativeInteger|)
              ...
              (|Matrix| 37) (|List| 16) (|Factored| 25) (|Union| 34 '#1#)
              (|List| 25) (|Union| 15 '#2="failed") (|Union| 37 '#2#)
              (|Integer|) (|Union| 39 '#2#)
              (|SparseMultivariatePolynomial| 6 19) (|Union| 19 '#2#)
              (|Mapping| 6 6) (|Record| (|:| |var| 17) (|:| |exponent| 16))
              (|Union| 42 '#3="failed") (|Union| 22 '#3#)
              (|Record| (|:| |quotient| $) (|:| |remainder| $))
              (|SparseUnivariatePolynomial| 6) (|List| 17) (|Union| 17 '#2#)
              (|Equation| $) (|List| 49) (|IndexedExponents| 17)
            ...
            (CONS
             ...
             (CONS
              '#((|DifferentialPolynomialCategory| 6 19 17 51)
                 ...
                 (|RetractableTo| 15) (|RetractableTo| 37)
