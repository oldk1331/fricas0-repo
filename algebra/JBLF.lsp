...
(SDEFUN |JBLF;jacobiMatrix;LSem;29|
        ...
        (SPROG
         ((|rowC| (|List| $)) (|rowJ| #1=(|List| JB)) (|dCo| (|List| D))
          (|dJV| #1#) (|dco| (D)) (#2=#:G366 NIL) (|co| NIL) (#3=#:G367 NIL)
          (|jv| NIL) (#4=#:G365 NIL) (|cjv| NIL) (|ents| (|List| $))
          (#5=#:G364 NIL) (#6=#:G363 NIL) (#7=#:G362 NIL) (|eq| NIL) (|i| NIL)
          (|res| (|SparseEchelonMatrix| JB $)) (#8=#:G361 NIL) (#9=#:G360 NIL)
          (#10=#:G359 NIL) (|cinds| #1#) (#11=#:G358 NIL) (|inds| #1#)
          (#12=#:G357 NIL))
...
(SDEFUN |JBLF;jacobiMatrix;LLSem;30|
        ...
        (SPROG
         ((|rowC| (|List| $)) (|rowJ| #1=(|List| JB)) (|dCo| (|List| D))
          (|dJV| #1#) (|dco| (D)) (#2=#:G393 NIL) (|co| NIL) (#3=#:G394 NIL)
          (|jv| NIL) (#4=#:G392 NIL) (|ijv| NIL) (|ivars| (|List| JB))
          (|ents| (|List| $)) (#5=#:G391 NIL) (#6=#:G390 NIL) (#7=#:G388 NIL)
          (|eq| NIL) (#8=#:G389 NIL) (|vars| NIL) (|i| NIL)
...
(SDEFUN |JBLF;simplify;LSemR;35|
        ...
        (SPROG
         ((|dep| (|List| (|List| (|NonNegativeInteger|))))
          ...
          (#4=#:G468 NIL) (|co| NIL) (#5=#:G469 NIL) (|jv| NIL) (#6=#:G467 NIL)
          (|cjv| NIL) (|ents| (|List| $)) (#7=#:G466 NIL) (#8=#:G465 NIL)
          (#9=#:G464 NIL) (#10=#:G463 NIL) (#11=#:G462 NIL) (|eq| NIL)
