...
(SDEFUN |JBLF;retractIfCan;JbeU;12|
        ...
        (SPROG
         ((|resC| (|List| D)) (#1=#:G213 NIL) (|cd| #2=(|Union| D "failed"))
          (#3=#:G214 NIL) (|jv| NIL) (|resJ| (|List| JB)) (|pd| #2#))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |JBLF;-;2$;18| ((|l| $) ($ $))
        (SPROG ((#1=#:G227 NIL) (|c| NIL) (#2=#:G226 NIL))
               (SEQ
                (CONS
                 (PROGN
...
(SDEFUN |JBLF;+;3$;19| ((|l1| $) (|l2| $) ($ $))
        (SPROG
         ((|lj2| (|List| JB)) (|lc2| (|List| D)) (|resJ| (|List| JB))
          (|resC| (|List| D)) (|sum| (D)) (#1=#:G244 NIL) (|c1| NIL)
          (#2=#:G245 NIL) (|j1| NIL))
         (SEQ
...
(SDEFUN |JBLF;*;I2$;20| ((|i| |Integer|) (|l| $) ($ $))
        (SPROG ((#1=#:G251 NIL) (|c| NIL) (#2=#:G250 NIL))
               (SEQ
...
(SDEFUN |JBLF;*;D2$;21| ((|ex| D) (|l| $) ($ $))
        (SPROG ((#1=#:G257 NIL) (|c| NIL) (#2=#:G256 NIL))
               (SEQ
                (COND ((SPADCALL |ex| (QREFELT $ 31)) (|spadConstant| $ 32))
...
(SDEFUN |JBLF;exquo;2$U;24| ((|l1| $) (|l2| $) ($ |Union| $ #1="failed"))
        (SPROG
         ((|newC| (|List| D)) (#2=#:G285 NIL) (|e| (|Union| D #1#))
          (#3=#:G286 NIL) (|c| NIL) (|d| (D)))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |JBLF;jetVariables;$L;26| ((|l| $) ($ |List| JB))
        (SPROG ((|res| (|List| JB)) (#1=#:G299 NIL) (|c| NIL))
               (SEQ
...
(SDEFUN |JBLF;differentiate;$S$;27| ((|l| $) (|s| |Symbol|) ($ $))
        (SPROG
         ((|resJ| (|List| JB)) (|resC| (|List| D)) (|dc| (D)) (#1=#:G305 NIL)
          (|c| NIL) (#2=#:G306 NIL) (|j| NIL))
...
(SDEFUN |JBLF;differentiate;$JB$;28| ((|l| $) (|jv| JB) ($ $))
        (SPROG
         ((|pos| (|Integer|)) (|resJ| (|List| JB)) (|resC| (|List| D))
          (|dc| (D)) (#1=#:G314 NIL) (|c| NIL) (#2=#:G315 NIL) (|j| NIL)
          (|jt| (|Symbol|)))
         (SEQ
...
(SDEFUN |JBLF;jacobiMatrix;LSem;29|
        ...
        (SPROG
         ((|rowC| (|List| $)) (|rowJ| #1=(|List| JB)) (|dCo| (|List| D))
          (|dJV| #1#) (|dco| (D)) (#2=#:G348 NIL) (|co| NIL) (#3=#:G349 NIL)
          (|jv| NIL) (#4=#:G347 NIL) (|cjv| NIL) (|ents| (|List| $))
          (#5=#:G346 NIL) (#6=#:G345 NIL) (#7=#:G344 NIL) (|eq| NIL) (|i| NIL)
          (|res| (|SparseEchelonMatrix| JB $)) (#8=#:G343 NIL) (#9=#:G342 NIL)
          (#10=#:G341 NIL) (|cinds| #1#) (#11=#:G340 NIL) (|inds| #1#)
          (#12=#:G339 NIL))
...
(SDEFUN |JBLF;jacobiMatrix;LLSem;30|
        ...
        (SPROG
         ((|rowC| (|List| $)) (|rowJ| #1=(|List| JB)) (|dCo| (|List| D))
          (|dJV| #1#) (|dco| (D)) (#2=#:G375 NIL) (|co| NIL) (#3=#:G376 NIL)
          (|jv| NIL) (#4=#:G374 NIL) (|ijv| NIL) (|ivars| (|List| JB))
          (|ents| (|List| $)) (#5=#:G373 NIL) (#6=#:G372 NIL) (#7=#:G370 NIL)
          (|eq| NIL) (#8=#:G371 NIL) (|vars| NIL) (|i| NIL)
...
(SDEFUN |JBLF;freeOf?;$JBB;32| ((|l| $) (|jv| JB) ($ |Boolean|))
        (SPROG ((#1=#:G388 NIL) (|c| NIL) (#2=#:G387 NIL))
               (SEQ
                (COND
...
(SDEFUN |JBLF;solveFor;$JBU;33| ((|l| $) (|jv| JB) ($ |Union| $ "failed"))
        (SPROG
         ((#1=#:G402 NIL) (|c| NIL) (#2=#:G401 NIL) (|rc| (|Union| D "failed"))
...
(SDEFUN |JBLF;subst;$JB2$;34| ((|l| $) (|jv| JB) (|exp| $) ($ $))
        (SPROG
         ((|nl| ($)) (|c| (D)) (|pos| (|Integer|)) (|resJ| (|List| JB))
          (|resC| (|List| D)) (|nc| (D)) (#1=#:G411 NIL) (#2=#:G412 NIL)
...
(SDEFUN |JBLF;simplify;LSemR;35|
        ...
        (SPROG
         ((|dep| (|List| (|List| (|NonNegativeInteger|))))
          (|depj| (|List| (|NonNegativeInteger|))) (#2=#:G432 NIL)
          (|kb| (|Integer|)) (|k| NIL) (|rowC| (|List| $))
          (|rowJ| #3=(|List| JB)) (|dCo| (|List| D)) (|dJV| #3#) (|dco| (D))
          (#4=#:G450 NIL) (|co| NIL) (#5=#:G451 NIL) (|jv| NIL) (#6=#:G449 NIL)
          (|cjv| NIL) (|ents| (|List| $)) (#7=#:G448 NIL) (#8=#:G447 NIL)
          (#9=#:G446 NIL) (#10=#:G445 NIL) (#11=#:G444 NIL) (|eq| NIL)
