...
(SDEFUN |SIMPC;simplicialComplexIfCan;DcBU;5|
        ...
        (SPROG
         ((|res| (|List| (|OrientedFacet|))) (#1=#:G174 NIL) (|r| NIL)
          ...
          (#3=#:G155 NIL) (#4=#:G173 NIL) (|i| NIL) (#5=#:G172 NIL)
          (|facet| NIL) (|thisPoint| #6=(|NonNegativeInteger|)) (#7=#:G171 NIL)
          (|NumPoints| #6#) (|lastMap| (|List| (|List| (|OrientedFacet|))))
          (#8=#:G169 NIL) (|map| NIL) (#9=#:G170 NIL) (|grade| NIL)
...
(SDEFUN |SIMPC;addSimplex;$Of$;6| ((|a| ($)) (|f| (|OrientedFacet|)) ($ ($)))
        (SPROG
         ((|numPoints| (|NonNegativeInteger|)) (|max| (|NonNegativeInteger|))
          ...
          (#2=#:G186 NIL) (|orf| NIL) (|res| (|List| (|OrientedFacet|)))
          (|found| (|Boolean|)) (|m| (|Integer|)) (#3=#:G185 NIL))
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |res| 10000) (LETT |facs| (QVELT |s| 2))
                (COND
                 ((EQL (LENGTH |facs|) 0) (PROGN (LETT #2# 0) (GO #3=#:G198))))
                (SEQ (LETT |fac| NIL) (LETT #1# |facs|) G190
                     (COND
                      ((OR (ATOM #1#) (PROGN (LETT |fac| (CAR #1#)) NIL))
                       (GO G191)))
...
(SDEFUN |SIMPC;grade;$L;9| ((|s| ($)) ($ (|List| (|List| (|OrientedFacet|)))))
        (SPROG
         ((|gr| (|Integer|)) (#1=#:G211 NIL) (|face| NIL)
          ...
          (#3=#:G208 NIL) (|maxGrade| (|NonNegativeInteger|)) (#4=#:G209 NIL)
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |simp| (QVELT |s| 2)) (LETT |maxGrade| 0)
                ...
                (LETT |res| NIL)
                (COND
                 ((< |maxGrade| 1) (PROGN (LETT #3# |res|) (GO #5=#:G207))))
...
(SDEFUN |SIMPC;orderedPermutation|
        ...
        (SPROG
         ((|reslt| (|List| (|List| (|Integer|)))) (|r1| (|List| (|Integer|)))
          ...
          (|rst| (|List| (|Integer|))) (|fst| (|Integer|)) (#3=#:G225 NIL)
          (#4=#:G226 NIL) (|y| NIL))
         (SEQ
          (EXIT
           (SEQ (COND ((< |len| 1) (PROGN (LETT #3# NIL) (GO #5=#:G224))))
                (COND
...
(SDEFUN |SIMPC;addImpliedFaces;$L;14|
        ...
        (SPROG
         ((|newFaces| (|List| (|OrientedFacet|)))
          ...
          (|all_faces| (|List| (|OrientedFacet|))) (#2=#:G247 NIL) (|gr| NIL)
          (#3=#:G246 NIL) (|maxGrade| (|NonNegativeInteger|))
                 ...
                 ((< |maxGrade| 1)
                  (SEQ
                   (SPADCALL
                    ...
                    (QREFELT $ 33))
                   (EXIT (PROGN (LETT #3# |res|) (GO #4=#:G245))))))
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |mina| (SPADCALL |a| (QREFELT $ 61)))
                ...
                (COND
                 ((< |maxa| |minb|) (PROGN (LETT #1# |b|) (GO #4=#:G278))))
...
(SDEFUN |SIMPC;simplicialJoin;2$B$;21|
        ...
        (SPROG
         ((|numPoints| (|NonNegativeInteger|)) (|verts| (|List| VS))
          ...
          (#1=#:G289 NIL) (|y| NIL) (#2=#:G288 NIL) (|x| NIL) (|b2| ($))
          (#3=#:G287 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND ((NULL (QVELT |a| 2)) (PROGN (LETT #3# |b|) (GO #4=#:G286))))
...
(SDEFUN |SIMPC;oneSkeleton;$Dg;25|
        ...
        (SPROG
         ((|edges|
          ...
          (|n| (|NonNegativeInteger|)) (#3=#:G322 NIL) (|x| NIL)
          (GS
...
(SDEFUN |SIMPC;product;3$;32| ((|a| ($)) (|b| ($)) ($ ($)))
        (SPROG
         ((|numPoints| (|NonNegativeInteger|))
          ...
          (#1=#:G346 NIL) (|l| (|NonNegativeInteger|)) (#2=#:G361 NIL)
          (|y| NIL) (|mul| (|Integer|))
          (|inds|
           (|List|
            (|Record| (|:| |left| (|NonNegativeInteger|))
                      (|:| |right| (|NonNegativeInteger|)))))
          (#3=#:G360 NIL) (|x| NIL) (|dimb| #4=(|NonNegativeInteger|))
          (|bz| (|NonNegativeInteger|)) (|dima| #4#)
          (|az| (|NonNegativeInteger|)) (#5=#:G359 NIL) (|z| NIL)
          (|res2| (|List| (|ProductFacet|))) (#6=#:G358 NIL) (|e| NIL)
          (|res| (|List| (|ProductFacet|))) (#7=#:G357 NIL) (|simpb| NIL)
          (#8=#:G356 NIL) (|simpa| NIL) (|vs| (|List| VS)) (|pp| (VS))
          (#9=#:G355 NIL) (|pb| NIL) (#10=#:G354 NIL) (|pa| NIL)
...
(SDEFUN |SIMPC;=;2$B;34| ((|a| ($)) (|b| ($)) ($ (|Boolean|)))
        (SPROG
         ((#1=#:G382 NIL) (#2=#:G386 NIL) (|f| NIL)
          ...
          (|flags| (|List| (|Boolean|))) (#4=#:G384 NIL) (#5=#:G383 NIL)
...
(DEFUN |FiniteSimplicialComplex| (#1=#:G394)
  (SPROG NIL
         (PROG (#2=#:G395)
           (RETURN
            (COND
