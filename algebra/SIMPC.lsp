             ...
             ((< |maxGrade| 1)
              (SEQ
               (SPADCALL
                ...
                (QREFELT $ 34))
               (EXIT (PROGN (LETT #3# |res| . #4#) (GO #5=#:G246))))))
         ...
         (SEQ
          (EXIT
           (SEQ
            ...
            (COND
             ((< |maxa| |minb|) (PROGN (LETT #1# |b| . #4#) (GO #5=#:G279))))
                 ...
                 (SEQ
                  (COND
                   ((SPADCALL (VECTOR |b| 0 0) |a| (QREFELT $ 91))
                    (PROGN (LETT #1# |a| |SIMPC;concatIfNew|) (GO #2=#:G301))))
