...
(SDEFUN |HDP;<;2%B;1| ((|v1| (%)) (|v2| (%)) (% (|Boolean|)))
        (SPROG ((#1=#:G13 NIL) (|n1| (S)) (|n2| (S)) (|i| NIL) (#2=#:G12 NIL))
               (SEQ
                (EXIT
...
(DEFUN |HomogeneousDirectProduct;| (|#1| |#2|)
  (SPROG
   ((DV$1 NIL) (DV$2 NIL) (|dv$| NIL) (% NIL) (#1=#:G40 NIL) (#2=#:G39 NIL)
    (#3=#:G38 NIL) (#4=#:G36 NIL) (#5=#:G37 NIL) (#6=#:G35 NIL) (#7=#:G34 NIL)
    (#8=#:G33 NIL) (#9=#:G32 NIL) (#10=#:G31 NIL) (|pv$| NIL))
   (PROGN
    (LETT DV$1 |#1|)
...
(MAKEPROP '|HomogeneousDirectProduct| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|DirectProduct| (NRTEVAL (QREFELT % 6)) 7)
              (|local| |#1|) (|local| |#2|) '|Rep| (0 . |0|) (|Integer|)
           ...
           '#(~= 22 |zero?| 28 |unitVector| 33 |swap!| 38 |sup| 45
              ...
              539 |any?| 546 |antiCommutator| 552 |annihilate?| 558 ^ 564 D 576
              >= 626 > 632 = 638 <= 644 < 650 |1| 656 |0| 660 - 664 + 675 * 681
              |#| 723)
           'NIL
           (CONS
            (|makeByteWordVec2| 50
             ...
             (CONS
              ...
              (|makeByteWordVec2| 58
                                  '(0 7 0 9 2 0 7 0 10 11 2 7 0 0 0 12 2 7 13 0
                                    ...
                                    1 2 38 0 0 21 1 1 24 0 0 1 2 24 0 0 16 1 2
                                    25 0 0 28 1 2 25 0 0 29 1 3 25 0 0 28 30 1
                                    3 25 0 0 29 16 1 2 9 0 0 17 1 3 9 0 0 17 16
                                    1 2 3 13 0 0 1 2 3 13 0 0 1 2 58 13 0 0 1 2
                                    3 13 0 0 1 2 3 13 0 0 15 0 10 0 1 0 55 0 1
                                    2 57 0 0 0 1 1 57 0 0 1 2 43 0 0 0 1 2 27 0
                                    0 10 1 2 57 0 10 0 1 2 55 0 16 0 1 2 43 0
                                    21 0 1 2 38 0 7 0 1 2 38 0 0 7 1 2 38 0 0 0
                                    1 1 51 16 0 1)))))
           '|lookupComplete|)) 
