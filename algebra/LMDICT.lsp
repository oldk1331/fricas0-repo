...
(DEFUN |ListMultiDictionary| (#1=#:G222)
  (SPROG NIL
         (PROG (#2=#:G223)
           (RETURN
            (COND
...
(DEFUN |ListMultiDictionary;| (|#1|)
  (SPROG
   ((#1=#:G221 NIL) (#2=#:G220 NIL) (|pv$| NIL) (#3=#:G217 NIL) (#4=#:G218 NIL)
    (#5=#:G219 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
