...
(SDEFUN |PFR;padicFraction;2$;8| ((|a| $) ($ $))
        (SPROG
         ((|d| #1=(|Integer|)) (|sp| (|SparseUnivariatePolynomial| R))
          ...
          (#2=#:G181 NIL) (|f| (R)) (|e| #1#) (#3=#:G193 NIL) (|s| NIL)
          (|b| ($)))
...
(SDEFUN |PFR;compactFraction;2$;9| ((|a| $) ($ $))
        (SPROG
         ((|b| ($)) (|e| (|Integer|)) (|f| (R))
          ...
          (|bw| (R)) (#1=#:G198 NIL) (#2=#:G206 NIL) (|t| NIL)
...
(SDEFUN |PFR;coerce;$F;15| ((|a| $) ($ |Fraction| R))
        (SPROG ((|q| (|Fraction| R)) (#1=#:G220 NIL) (|s| NIL))
...
(SDEFUN |PFR;*;R2$;26| ((|r| R) (|a| $) ($ $))
        (SPROG ((#1=#:G276 NIL) (|c| ($)) (#2=#:G277 NIL) (|s| NIL) (|b| ($)))
               (SEQ
                (COND
...
(SDEFUN |PFR;*;3$;29| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((|c| ($)) (#1=#:G293 NIL) (|t| NIL) (#2=#:G292 NIL) (|s| NIL)
          (|af| ($)))
         (SEQ
...
(SDEFUN |PFR;coerce;$Of;30| ((|a| $) ($ |OutputForm|))
        (SPROG ((|l| (|List| (|OutputForm|))) (#1=#:G306 NIL) (|s| NIL))
               (SEQ
