...
(SDEFUN |PFR;*;R2$;27| ((|r| R) (|a| $) ($ $))
        (SPROG ((#1=#:G289 NIL) (|c| ($)) (#2=#:G290 NIL) (|s| NIL) (|b| ($)))
               (SEQ
                (COND
...
(SDEFUN |PFR;*;3$;30| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((|c| ($)) (#1=#:G306 NIL) (|t| NIL) (#2=#:G305 NIL) (|s| NIL)
          (|af| ($)))
         (SEQ
...
(SDEFUN |PFR;coerce;$Of;31| ((|a| $) ($ |OutputForm|))
        (SPROG ((|l| (|List| (|OutputForm|))) (#1=#:G319 NIL) (|s| NIL))
               (SEQ
