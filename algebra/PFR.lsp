...
(SDEFUN |PFR;padicFraction;2$;8| ((|a| ($)) ($ ($)))
        (SPROG
         ((|d| #1=(|Integer|)) (|sp| (|SparseUnivariatePolynomial| R))
          ...
          (#2=#:G201 NIL) (|f| (R)) (|e| #1#) (#3=#:G213 NIL) (|s| NIL)
          (|b| ($)))
...
(SDEFUN |PFR;compactFraction;2$;9| ((|a| ($)) ($ ($)))
        (SPROG
         ((|b| ($)) (|e| (|Integer|)) (|f| (R))
          ...
          (|bw| (R)) (#1=#:G219 NIL) (#2=#:G227 NIL) (|t| NIL)
...
(SDEFUN |PFR;coerce;$F;15| ((|a| ($)) ($ (|Fraction| R)))
        (SPROG ((|q| (|Fraction| R)) (#1=#:G242 NIL) (|s| NIL))
...
(SDEFUN |PFR;*;R2$;26| ((|r| (R)) (|a| ($)) ($ ($)))
        (SPROG ((#1=#:G300 NIL) (|c| ($)) (#2=#:G301 NIL) (|s| NIL) (|b| ($)))
               (SEQ
                (COND
...
(SDEFUN |PFR;*;3$;29| ((|a| ($)) (|b| ($)) ($ ($)))
        (SPROG
         ((|c| ($)) (#1=#:G319 NIL) (|t| NIL) (#2=#:G318 NIL) (|s| NIL)
          (|af| ($)))
         (SEQ
...
(SDEFUN |PFR;coerce;$Of;30| ((|a| ($)) ($ (|OutputForm|)))
        (SPROG ((|l| (|List| (|OutputForm|))) (#1=#:G333 NIL) (|s| NIL))
               (SEQ
