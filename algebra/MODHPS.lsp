          ...
          (EXIT
           (SEQ
            ...
            (EXIT
             (COND
              ((QEQCAR |pp| 0)
               (PROGN (LETT #4# (CONS 0 (QCDR |pp|)) . #5#) (GO #6=#:G941)))
          ...
          (EXIT
           (SEQ
            ...
            (EXIT
             (COND
              ((QEQCAR |pp| 0)
               (PROGN (LETT #4# (CONS 0 (QCDR |pp|)) . #5#) (GO #6=#:G984)))
              ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|)) . #5#) (GO #6#)))))))
          #6# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ
            ...
            (EXIT
             (COND
              ((QEQCAR |pp| 0)
               (PROGN (LETT #4# (CONS 0 (QCDR |pp|)) . #5#) (GO #6=#:G1045)))
              ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|)) . #5#) (GO #6#)))))))
          #6# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ
            ...
            (EXIT
             (COND
              ((QEQCAR |pp| 0)
               (PROGN (LETT #4# (CONS 0 (QCDR |pp|)) . #5#) (GO #6=#:G1088)))
              ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|)) . #5#) (GO #6#)))))))
          #6# (EXIT #4#)))) 
...
(SDEFUN |MODHPS;check_sol_mod_diff|
        ...
        (SPROG
         ((#1=#:G1144 NIL) (|min_ord| #2=(|NonNegativeInteger|))
          (#3=#:G1142 NIL) (|delta| (|Integer|)) (|sigma0| #2#)
          (|pa| (|U32Vector|)) (#4=#:G1147 NIL) (|j| NIL) (|c0| (|Integer|))
          (#5=#:G1143 NIL) (|ord| #2#) (#6=#:G1146 NIL) (|i| NIL)
          (|nres| (|Vector| (|U32Vector|))) (|gv0| (|U32Vector|))
          (|gvl| (|List| (|U32Vector|)))
          (|gv0p| (|Union| (|List| (|U32Vector|)) "failed"))
          (|lpt| (|List| (|Integer|))) (|qval| (|Integer|)) (#7=#:G1145 NIL)
...
(DEFUN |ModularHermitePadeSolver| (&REST #1=#:G1148)
  (SPROG NIL
         (PROG (#2=#:G1149)
           (RETURN
            (COND
...
(DEFUN |ModularHermitePadeSolver;| (|#1| |#2|)
  (SPROG
   ((#1=#:G1071 NIL) (#2=#:G1069 NIL) (#3=#:G1028 NIL) (#4=#:G1026 NIL)
    (#5=#:G967 NIL) (#6=#:G965 NIL) (#7=#:G924 NIL) (#8=#:G922 NIL)
    (#9=#:G845 NIL) (#10=#:G843 NIL) (#11=#:G802 NIL) (#12=#:G800 NIL)
    (#13=#:G741 NIL) (#14=#:G739 NIL) (#15=#:G698 NIL) (#16=#:G696 NIL)
    (#17=#:G588 NIL) (#18=#:G586 NIL) (#19=#:G545 NIL) (#20=#:G543 NIL)
...
(MAKEPROP '|ModularHermitePadeSolver| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|NonNegativeInteger|) (|Mapping| 27 70 23 23)
              (|Union| '"good" '"reject" '"no_solution")
              ...
              (|Union| 70 '"failed") (|Integer|) (21 . |LLFI_to_LPA|)
              (|List| 11) (28 . |LLF_to_LPA|) (|Vector| 69)
              ...
              (174 . |random|) (178 . |random|) (|IntegerPrimesPackage| 23)
              (182 . |nextPrime|) (187 . ~=) (|U32Vector|) (|List| 69)
              (193 . |check_sol1a|) (203 . |One|) (207 . |One|))
           '#(|gen_Monte_Carlo_check| 211 |VSUPS_to_VPA| 221 |LLF_to_LPA| 229
              |HP_solve| 238)
           'NIL
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 73
                                                 '(6 16 8 9 10 11 12 13 15 17 7
                                                   ...
                                                   0 64 0 32 0 65 1 66 23 23 67
                                                   2 12 32 0 0 68 6 16 69 27 70
                                                   13 23 23 23 71 0 6 0 72 0 7
                                                   0 73 6 0 20 20 19 11 11 12
                                                   13 36 4 0 27 30 25 10 23 31
                                                   5 0 22 19 23 25 10 23 26 7 0
                                                   18 19 10 11 11 12 13 20
                                                   21)))))
           '|lookupComplete|)) 
