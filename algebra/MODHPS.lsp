          ...
          (EXIT
           (SEQ
            ...
            (EXIT
             (COND
              ((QEQCAR |pp| 0)
               (PROGN (LETT #4# (CONS 0 (QCDR |pp|)) . #5#) (GO #6=#:G940)))
          ...
          (EXIT
           (SEQ
            ...
            (EXIT
             (COND
              ((QEQCAR |pp| 0)
               (PROGN (LETT #4# (CONS 0 (QCDR |pp|)) . #5#) (GO #6=#:G983)))
              ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|)) . #5#) (GO #6#)))))))
          #6# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ
            ...
            (EXIT
             (COND
              ((QEQCAR |pp| 0)
               (PROGN (LETT #4# (CONS 0 (QCDR |pp|)) . #5#) (GO #6=#:G1044)))
              ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|)) . #5#) (GO #6#)))))))
          #6# (EXIT #4#)))) 
          ...
          (EXIT
           (SEQ
            ...
            (EXIT
             (COND
              ((QEQCAR |pp| 0)
               (PROGN (LETT #4# (CONS 0 (QCDR |pp|)) . #5#) (GO #6=#:G1087)))
              ('T (PROGN (LETT #4# (CONS 1 (QCDR |pp|)) . #5#) (GO #6#)))))))
          #6# (EXIT #4#)))) 
