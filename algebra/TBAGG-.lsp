               ...
               (SEQ
                (SPADCALL (SPADCALL "table" (QREFELT % 22))
                          (PROGN
                           (LETT #1# NIL)
                           (SEQ (LETT |k| NIL)
                                (LETT #2# (SPADCALL |t| (QREFELT % 18))) G190
                                (COND
                                 ((OR (ATOM #2#)
...
(SDEFUN |TBAGG-;parts;SL;10|
        ...
        (SPROG ((#1=#:G52 NIL) (|k| NIL) (#2=#:G53 NIL))
               (SEQ
                (PROGN
                 (LETT #1# NIL)
                ...
                (PROGN
                 ...
                 (SEQ (LETT |k| NIL) (LETT #2# (SPADCALL |t| (QREFELT % 18)))
                      ...
                      (SEQ
                       (EXIT
                        (LETT #1#
                              (CONS (SPADCALL |t| |k| (QREFELT % 24)) #1#))))
                      (LETT #2# (CDR #2#)) (GO G190) G191
                      (EXIT (NREVERSE #1#))))))) 
...
(SDEFUN |TBAGG-;=;2SB;13| ((|s| (S)) (|t| (S)) (% (|Boolean|)))
        (SPROG
         ((|k| NIL) (#1=#:G73 NIL) (|e| (|Union| |Entry| "failed"))
          (#2=#:G72 NIL) (#3=#:G71 NIL))
         (SEQ
          (EXIT
                    ...
                    (EXIT
                     (LETT |lke|
                           (CONS
                            ...
                            |lke|))))
                   (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
              (SEQ (LETT |ke| NIL) (LETT #3# |lke|) G190
                   (COND
                    ((OR (ATOM #3#) (PROGN (LETT |ke| (CAR #3#)) NIL))
                     (GO G191)))
                   (SEQ
                    (EXIT
        ...
        ((|f|
         ...
         (%
          (|Union| (|Record| (|:| |key| |Key|) (|:| |entry| |Entry|))
                   "failed")))
        (SPROG ((|ke| NIL) (#1=#:G111 NIL) (#2=#:G110 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |ke| NIL) (LETT #1# (SPADCALL |t| (QREFELT % 58)))
                       G190
                       (COND
                       ...
                       (SEQ
                        (EXIT
                         (COND
                          ((SPADCALL |ke| |f|)
                           (PROGN (LETT #2# (CONS 0 |ke|)) (GO #3=#:G109))))))
                       (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
                  (EXIT (CONS 1 "failed"))))
                #3# (EXIT #2#)))) 
...
(SDEFUN |TBAGG-;any?;MSB;21|
        ...
        (SPROG ((|k| NIL) (#1=#:G132 NIL) (#2=#:G131 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |k| NIL) (LETT #1# (SPADCALL |t| (QREFELT % 18)))
...
(SDEFUN |TBAGG-;every?;MSB;22|
        ((|f| (|Mapping| (|Boolean|) |Entry|)) (|t| (S)) (% (|Boolean|)))
        (SPROG ((|k| NIL) (#1=#:G139 NIL) (#2=#:G138 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |k| NIL) (LETT #1# (SPADCALL |t| (QREFELT % 18)))
...
(SDEFUN |TBAGG-;count;MSNni;23|
        ((|f| (|Mapping| (|Boolean|) |Entry|)) (|t| (S))
         (% (|NonNegativeInteger|)))
        (SPROG ((|k| NIL) (#1=#:G144 NIL) (|tally| (|NonNegativeInteger|)))
               (SEQ (LETT |tally| 0)
                    (SEQ (LETT |k| NIL)
