...
(SDEFUN |TBAGG-;parts;SL;11| ((|t| (S)) ($ (|List| |Entry|)))
        (SPROG ((#1=#:G161 NIL) (|k| NIL) (#2=#:G160 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |k| NIL) (LETT #1# (SPADCALL |t| (QREFELT $ 18)))
...
(SDEFUN |TBAGG-;=;2SB;13| ((|s| (S)) (|t| (S)) ($ (|Boolean|)))
        (SPROG
         ((#1=#:G174 NIL) (#2=#:G175 NIL) (|e| (|Union| |Entry| "failed"))
          (#3=#:G176 NIL) (|k| NIL))
         (SEQ
          (EXIT
        ...
        ((|f|
         ...
         ($
          (|Union| (|Record| (|:| |key| |Key|) (|:| |entry| |Entry|))
                   "failed")))
        (SPROG ((#1=#:G213 NIL) (#2=#:G214 NIL) (|ke| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |ke| NIL) (LETT #2# (SPADCALL |t| (QREFELT $ 58)))
                       ...
                       (SEQ
                        (EXIT
                         (COND
                          ((SPADCALL |ke| |f|)
                           (PROGN (LETT #1# (CONS 0 |ke|)) (GO #3=#:G212))))))
...
(SDEFUN |TBAGG-;any?;MSB;21|
        ...
        (SPROG ((#1=#:G234 NIL) (#2=#:G235 NIL) (|k| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |TBAGG-;every?;MSB;22|
        ((|f| (|Mapping| (|Boolean|) |Entry|)) (|t| (S)) ($ (|Boolean|)))
        (SPROG ((#1=#:G241 NIL) (#2=#:G242 NIL) (|k| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |k| NIL) (LETT #2# (SPADCALL |t| (QREFELT $ 18)))
...
(SDEFUN |TBAGG-;count;MSNni;23|
        ((|f| (|Mapping| (|Boolean|) |Entry|)) (|t| (S))
         ($ (|NonNegativeInteger|)))
        (SPROG ((|tally| (|NonNegativeInteger|)) (#1=#:G247 NIL) (|k| NIL))
               (SEQ (LETT |tally| 0)
                    (SEQ (LETT |k| NIL)
                         (LETT #1# (SPADCALL |t| (QREFELT $ 18))) G190
                         (COND
