...
(DEFUN |POLYLIFT;map;MMPS;1| (|fv| |fc| |p| $)
  (PROG (|up| |ans| |t| |x1|)
    (RETURN
     (SEQ
      (LETT |x1| (SPADCALL |p| (QREFELT $ 12)) . #1=(|POLYLIFT;map;MMPS;1|))
      (EXIT
       (COND ((QEQCAR |x1| 1) (SPADCALL (SPADCALL |p| (QREFELT $ 13)) |fc|))
             ('T
              (SEQ (LETT |up| (SPADCALL |p| (QCDR |x1|) (QREFELT $ 15)) . #1#)
                   ...
                   (SEQ G190
                        (COND
                         ((NULL
                           (COND ((SPADCALL |up| (QREFELT $ 27)) 'NIL)
                                 ('T 'T)))
                          (GO G191)))
                        (SEQ
                         (LETT |ans|
        ...
        (COND
         ...
         ('T
          (UNWIND-PROTECT
            ...
            (COND
             ((NOT #2#)
              (HREM |$ConstructorCache| '|PolynomialCategoryLifting|))))))))))) 
