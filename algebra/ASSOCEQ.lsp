...
(SDEFUN |ASSOCEQ;associatedSystem;LPiR;2|
        ...
        (SPROG
         ((|u| (|Union| S #1="failed")) (#2=#:G136 NIL) (#3=#:G131 NIL)
          (#4=#:G151 NIL) (|j| NIL) (#5=#:G123 NIL) (#6=#:G150 NIL) (|k| NIL)
          (|wi| (S)) (|eq| (|Vector| R)) (#7=#:G149 NIL) (|i| NIL)
          (|a| (|Vector| R)) (#8=#:G117 NIL) (#9=#:G148 NIL) (#10=#:G147 NIL)
          (|an| (R)) (|m1| (|PositiveInteger|)) (#11=#:G114 NIL)
...
(SDEFUN |ASSOCEQ;uncouplingMatrices;MV;3|
        ...
        (SPROG
         ((#2=#:G160 NIL) (#3=#:G162 NIL) (|i| NIL) (#4=#:G161 NIL) (|mi| #1#)
          (#5=#:G159 NIL) (|v| (|Vector| (|Matrix| R)))
        ...
        ((|v| (|Vector| (|List| (|PositiveInteger|)))) (|m| (|Matrix| R))
         ...
         (%
          (|Record| (|:| |minor| (|List| (|PositiveInteger|))) (|:| |eq| L)
                    ...
                    (|:| |ops| (|List| L)))))
        (SPROG
         ((#1=#:G172 NIL) (|j| NIL) (#2=#:G171 NIL) (#3=#:G170 NIL)
          (#4=#:G169 NIL))
         (SEQ
           ...
           (|Join| (|Finite|)
                   (CATEGORY |domain|
                    ...
                    (SIGNATURE |delta|
                     ((|NonNegativeInteger|) % (|PositiveInteger|)
                      (|PositiveInteger|))))))
          (#3=#:G177 NIL) (|v| (|Union| (|Matrix| R) "failed"))
        ...
        ((|op| (L)) (|m| (|PositiveInteger|)) (|k| (|NonNegativeInteger|))
         (%
          (|Record| (|:| |minor| (|List| (|PositiveInteger|))) (|:| |eq| L)
                    ...
                    (|:| |ops| (|List| L)))))
        (SPROG
         ((#1=#:G196 NIL) (#2=#:G197 NIL) (|u| (|Union| (|Matrix| R) "failed"))
          (#3=#:G198 NIL) (|i| NIL) (|n| (|NonNegativeInteger|))
          (|a| (|Vector| (|Matrix| R)))
          (|rec|
           (|Record| (|:| |mat| (|Matrix| R))
                     (|:| |vec| (|Vector| (|List| (|PositiveInteger|)))))))
