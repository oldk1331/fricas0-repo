         ...
         (|l|
          (|List|
           (|Record| (|:| |ij| (|List| (|Integer|)))
                     (|:| |deg| (|NonNegativeInteger|)))))
         ($ (|List| (|Integer|))))
        (SPROG ((#1=#:G158 NIL) (|r| NIL) (#2=#:G157 NIL))
               (SEQ
                (SPADCALL
                 (SPADCALL
                  (PROGN
...
(SDEFUN |ODEPRRIC;denomRicDE;LUP;8| ((|l| (L)) ($ (UP)))
        (SPROG
         ((#1=#:G160 NIL) (#2=#:G159 (UP)) (#3=#:G161 (UP)) (#4=#:G163 NIL)
          (|c| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
...
(SDEFUN |ODEPRRIC;refine|
        ((|l| (|List| UP)) (|ezfactor| (|Mapping| (|Factored| UP) UP))
         ($ (|List| UP)))
        (SPROG
         ((#1=#:G179 NIL) (|r| NIL) (#2=#:G178 NIL) (#3=#:G177 NIL) (|p| NIL)
          (#4=#:G176 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |ODEPRRIC;padicsol|
        ...
        (SPROG
         ((|ans| (|List| (|Record| (|:| |frac| (|Fraction| UP)) (|:| |eq| L))))
          (#1=#:G204 NIL) (|sol| NIL) (#2=#:G203 NIL)
          (|sols|
           (|List| (|Record| (|:| |frac| (|Fraction| UP)) (|:| |eq| L))))
          (#3=#:G187 NIL) (|neweq| (L)) (|rcn| (|Fraction| UP)) (#4=#:G202 NIL)
          (|r| NIL) (#5=#:G201 NIL) (|rec| NIL)
          (|lc|
           (|List|
         ...
         ((|done| (|List| (|NonNegativeInteger|)))
          (|ans|
           (|List|
            (|Record| (|:| |deg| (|NonNegativeInteger|))
                      (|:| |eq| (|SparseUnivariatePolynomial| UP)))))
          (|ind| (|List| (|Integer|))) (#1=#:G217 NIL) (|rec| NIL)
          (|lb|
           (|List|
            (|Record| (|:| |ij| (|List| (|Integer|)))
                      (|:| |deg| (|NonNegativeInteger|))))))
...
(SDEFUN |ODEPRRIC;getPol|
        ((|rec|
         ...
         ($ (|SparseUnivariatePolynomial| UP)))
        (SPROG
         ((#1=#:G220 NIL) (#2=#:G219 #3=(|SparseUnivariatePolynomial| UP))
          (#4=#:G221 #3#) (#5=#:G224 NIL) (#6=#:G223 NIL) (#7=#:G227 NIL)
          (|i| NIL))
         (SEQ
...
(SDEFUN |ODEPRRIC;getPol1|
        ((|ind| (|List| (|Integer|))) (|c| (UP)) (|l| (L))
         ($ (|SparseUnivariatePolynomial| UP)))
        (SPROG
         ((#1=#:G229 NIL) (#2=#:G228 #3=(|SparseUnivariatePolynomial| UP))
          (#4=#:G230 #3#) (#5=#:G272 NIL) (#6=#:G275 NIL) (|i| NIL)
          (|cp| (UP)))
...
(SDEFUN |ODEPRRIC;constantCoefficientRicDE;LML;15|
        ...
        (SPROG
         ((#1=#:G288 NIL) (|a| NIL) (#2=#:G287 NIL)
          (|m| #3=(|NonNegativeInteger|)) (#4=#:G278 NIL) (#5=#:G277 #3#)
          (#6=#:G279 #3#) (#7=#:G286 NIL) (|p| NIL))
         (SEQ
          (LETT |m|
                (PROGN
                 (LETT #4# NIL)
...
(SDEFUN |ODEPRRIC;getPoly|
        ...
        (SPROG
         ((#1=#:G297 NIL) (#2=#:G296 (UP)) (#3=#:G298 (UP)) (#4=#:G301 NIL)
          (#5=#:G300 NIL) (#6=#:G303 NIL) (|i| NIL))
         (SEQ
          (PROGN
           (LETT #1# NIL)
           (SEQ (LETT |i| NIL) (LETT #6# |ind|) G190
...
(SDEFUN |ODEPRRIC;innermax|
        ...
        (SPROG
         ((|ans| (|List| (|Integer|))) (#1=#:G312 NIL) (|k| #2=(|Integer|))
          (|f| (UP)) (#3=#:G313 NIL) (|j| NIL) (|m| #2#) (#4=#:G306 NIL)
        ...
        (SPROG
         ((|done| (|List| (|NonNegativeInteger|)))
          (|ans|
           (|List|
            (|Record| (|:| |deg| (|NonNegativeInteger|)) (|:| |eq| UP))))
          (|ind| (|List| (|Integer|))) (#1=#:G327 NIL) (|rec| NIL)
          (|lb|
           (|List|
            (|Record| (|:| |ij| (|List| (|Integer|)))
                      (|:| |deg| (|NonNegativeInteger|))))))
...
(SDEFUN |ODEPRRIC;changeVar;LUPL;21| ((|l| (L)) (|a| (UP)) ($ (L)))
        (SPROG ((|dpan| (L)) (|op| (L)) (#1=#:G340 NIL) (|i| NIL) (|dpa| (L)))
               (SEQ
                (LETT |dpa|
...
(SDEFUN |ODEPRRIC;changeVar;LFL;22| ((|l| (L)) (|a| (|Fraction| UP)) ($ (L)))
        (SPROG
         ((|dpan| (LQ)) (|op| (LQ)) (#1=#:G347 NIL) (|i| NIL) (|dpa| (LQ)))
         (SEQ
          (LETT |dpa|
...
(SDEFUN |ODEPRRIC;bound| ((|c| (UP)) (|l| (L)) ($ (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G350 NIL) (#2=#:G349 #3=(|NonNegativeInteger|)) (#4=#:G351 #3#)
          (#5=#:G354 NIL) (|rec| NIL)
          (|lb|
           (|List|
        ...
        (SPROG
         ((|lb|
           (|List|
            (|Record| (|:| |ij| (|List| (|Integer|)))
                      (|:| |deg| (|NonNegativeInteger|)))))
          (#1=#:G362 NIL) (|b| (|Integer|))
          (|u| (|Union| (|Integer|) "failed")) (|lj| (UP)) (#2=#:G370 NIL)
          (|j| NIL) (|li| (UP)) (#3=#:G369 NIL) (|i| NIL)
          (|n| (|NonNegativeInteger|)))
...
(SDEFUN |ODEPRRIC;fracsol|
        ...
        (SPROG
         ((|ans| (|List| (|Record| (|:| |frac| (|Fraction| UP)) (|:| |eq| L))))
          (#1=#:G399 NIL) (|sol| NIL) (#2=#:G398 NIL)
          (|sols|
           (|List| (|Record| (|:| |frac| (|Fraction| UP)) (|:| |eq| L))))
          (|neweq| (L)) (#3=#:G397 NIL) (|rec| NIL))
         (SEQ (LETT |ans| NIL)
              (EXIT
               (COND ((NULL |lc|) |ans|)
                     ((NULL
...
(SDEFUN |ODEPRRIC;polysol|
        ...
        (SPROG
         ((|ans| (|List| (|Record| (|:| |poly| UP) (|:| |eq| L))))
          (#1=#:G421 NIL) (|sol| NIL) (#2=#:G420 NIL)
          (|sols| (|List| (|Record| (|:| |poly| UP) (|:| |eq| L))))
          (#3=#:G406 NIL) (|neweq| (L)) (|atn| (UP)) (#4=#:G419 NIL) (|a| NIL)
          (#5=#:G418 NIL) (|rec| NIL)
          (|lc|
           (|List|
            (|Record| (|:| |deg| (|NonNegativeInteger|)) (|:| |eq| UP)))))
...
(DEFUN |PrimitiveRatRicDE| (&REST #1=#:G422)
  (SPROG NIL
         (PROG (#2=#:G423)
           (RETURN
            (COND
