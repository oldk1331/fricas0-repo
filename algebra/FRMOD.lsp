...
(DEFUN |FRMOD;getinvintmat| ($)
  (PROG (#1=#:G145 |j| #2=#:G144 |i| |m| #3=#:G138)
    (RETURN
     (SEQ
      (LETT |m|
            (PROG2
...
(DEFUN |FramedModule| (&REST #1=#:G172)
  (PROG ()
    (RETURN
     (PROG (#2=#:G173)
       (RETURN
