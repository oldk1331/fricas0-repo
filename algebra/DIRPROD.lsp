...
(SDEFUN |DIRPROD;=;2%B;6| ((|x| (%)) (|y| (%)) (% (|Boolean|)))
        (SPROG ((#1=#:G122 NIL) (#2=#:G123 NIL) (#3=#:G124 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((NULL (EQL (QREFELT |x| |i|) (QREFELT |y| |i|)))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# NIL) (GO #4=#:G121)))
                              (GO #5=#:G119))))))
                         ...
                         (SEQ
                          (EXIT
                           (COND
                            ((NULL (EQL (QREFELT |x| |i|) (QREFELT |y| |i|)))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# NIL) (GO #4=#:G129)))
                              (GO #5=#:G127))))))
                         (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #1#))
                  (EXIT 'T)))
                         ...
                         (SEQ
                          (EXIT
                           (COND
                            ((NULL (EQL (QREFELT |x| |i|) (QREFELT |y| |i|)))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# NIL) (GO #4=#:G137)))
                              (GO #5=#:G135))))))
                         (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #1#))
                  (EXIT 'T)))
...
(SDEFUN |DIRPROD;=;2%B;9| ((|x| (%)) (|y| (%)) (% (|Boolean|)))
        (SPROG ((#1=#:G146 NIL) (#2=#:G147 NIL) (#3=#:G148 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                           ...
                           (COND
                            ((NULL
                              (SPADCALL (QAREF1O |x| |i| 1) (QAREF1O |y| |i| 1)
                                        (QREFELT % 21)))
                             (PROGN
                              (LETT #1# (PROGN (LETT #2# NIL) (GO #4=#:G145)))
                              (GO #5=#:G143))))))
                         (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL)))
                   #5# (EXIT #1#))
                  (EXIT 'T)))
...
(SDEFUN |DIRPROD;index;Pi%;12| ((|n| (|PositiveInteger|)) (% (%)))
        (SPROG
         ((L (|List| R)) (#1=#:G163 NIL) (|p| (|Integer|)) (#2=#:G168 NIL)
          (|i| NIL) (#3=#:G161 NIL) (N (|Integer|)))
...
(SDEFUN |DIRPROD;random;%;13| ((% (%)))
        (SPROG ((#1=#:G172 NIL) (#2=#:G174 NIL) (|i| NIL) (#3=#:G173 NIL))
               (SEQ
                (PROGN
...
(SDEFUN |DIRPROD;lookup;%Pi;14| ((|x| (%)) (% (|PositiveInteger|)))
        (SPROG
         ((#1=#:G177 NIL) (L (|Integer|)) (#2=#:G180 NIL) (|i| NIL)
          (N (|Integer|)))
...
(SDEFUN |DIRPROD;subtractIfCan;2%U;17|
        ((|u| (%)) (|v| (%)) (% (|Union| % "failed")))
        (SPROG
         ((#1=#:G196 NIL) (|c| (|Union| R "failed")) (#2=#:G197 NIL) (|i| NIL)
          (|w| (%)))
         (SEQ
          (EXIT
                ...
                (SEQ (LETT |i| 1) (LETT #2# (QREFELT % 6)) G190
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |c| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #3=#:G195)))
...
(SDEFUN |DIRPROD;recip;%U;19| ((|z| (%)) (% (|Union| % #1="failed")))
        (SPROG
         ((#2=#:G210 NIL) (|u| (|Union| R #1#)) (#3=#:G211 NIL) (|i| NIL)
          (|w| (%)))
         (SEQ
          (EXIT
                ...
                (SEQ (LETT |i| 1) (LETT #3# (QREFELT % 6)) G190
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |u| 1)
                         (PROGN (LETT #2# (CONS 1 "failed")) (GO #4=#:G209)))
...
(SDEFUN |DIRPROD;<;2%B;21| ((|x| (%)) (|y| (%)) (% (|Boolean|)))
        (SPROG ((#1=#:G219 NIL) (|b| (R)) (|a| (R)) (#2=#:G220 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |DIRPROD;<;2%B;23| ((|x| (%)) (|y| (%)) (% (|Boolean|)))
        (SPROG ((#1=#:G233 NIL) (|b| (R)) (|a| (R)) (#2=#:G234 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |i| 0) (LETT #2# (- (QREFELT % 6) 1)) G190
...
(SDEFUN |DIRPROD;<;2%B;24| ((|x| (%)) (|y| (%)) (% (|Boolean|)))
        (SPROG ((#1=#:G240 NIL) (|b| (R)) (|a| (R)) (#2=#:G241 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ (LETT |i| 0) (LETT #2# (- (QREFELT % 6) 1)) G190
...
(DEFUN |DirectProduct| (&REST #1=#:G265)
  (SPROG NIL
         (PROG (#2=#:G266)
           (RETURN
            (COND
...
(DEFUN |DirectProduct;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G255 NIL) (#2=#:G256 NIL) (#3=#:G257 NIL) (#4=#:G258 NIL)
    (#5=#:G259 NIL) (#6=#:G261 NIL) (#7=#:G260 NIL) (#8=#:G262 NIL)
    (#9=#:G263 NIL) (#10=#:G264 NIL) (% NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
    (LETT DV$1 |#1|)
           ...
           (CONS
            (|makeByteWordVec2| 51
                                '(0 6 9 6 6 15 16 18 9 18 8 6 6 9 1 9 11 11 9
                                  29 0 1 8 11 11 14 29 18 2 7 2 37 9 10 0 4 36
                                  10 12 41 17 0 13 41 38 19 0 0 40 6 42 19 51
                                  47 20 0 0 0 0 40 50 3 5 6 12 19 51 47 43))
            (CONS
             ...
             (CONS
              ...
              (|makeByteWordVec2| 83
                                  '(1 8 0 0 9 2 0 14 0 15 16 1 0 18 0 19 2 0 7
                                    ...
                                    3 55 7 0 18 7 1 2 0 7 0 18 51 1 52 12 0 13
                                    2 56 14 0 0 1 1 10 14 0 1 2 0 14 0 15 1 1
                                    23 18 0 19 1 53 7 0 1 2 3 0 0 0 1 1 52 12 0
                                    1 2 54 14 7 0 1 1 23 18 0 1 1 53 7 0 1 2 52
                                    7 72 0 1 2 3 0 0 0 1 2 55 0 74 0 1 2 0 0 74
                                    0 1 1 12 29 0 36 2 0 14 0 15 1 1 10 45 0 1
                                    2 10 0 0 15 1 2 39 0 0 29 1 1 19 82 0 1 2 1
                                    0 0 0 1 1 0 83 0 1 2 0 14 18 0 1 1 12 0 29
                                    32 2 20 78 78 0 1 1 20 79 0 1 1 23 7 0 1 2
                                    55 0 0 7 1 2 52 14 22 0 23 3 21 0 0 12 12 1
                                    2 21 0 0 60 1 3 21 0 0 7 7 1 2 21 0 0 61 1
                                    2 0 14 0 0 1 0 12 77 1 2 54 14 7 0 1 1 0 12
                                    0 1 1 0 14 0 1 0 0 0 1 3 0 7 0 18 7 1 2 0 7
                                    0 18 20 2 33 7 0 0 1 1 0 0 5 17 2 25 0 0 15
                                    1 1 25 0 0 1 3 26 0 0 66 15 1 3 26 0 0 67
                                    68 1 2 26 0 0 66 1 2 26 0 0 67 1 3 9 0 0 74
                                    15 1 2 9 0 0 74 1 2 54 15 7 0 1 2 52 15 22
                                    0 1 1 0 0 0 1 1 12 76 0 1 2 9 0 0 0 1 1 49
                                    0 70 1 1 48 0 18 1 1 45 75 0 1 1 6 0 0 1 1
                                    19 0 7 11 1 0 5 0 10 0 9 15 1 3 9 0 0 0 0 1
                                    2 52 14 22 0 1 2 8 0 0 0 1 2 9 14 0 0 1 2
                                    10 0 0 15 1 2 39 0 0 29 1 0 56 0 38 0 10 0
                                    49 2 25 0 0 15 1 1 25 0 0 1 3 26 0 0 66 15
                                    1 3 26 0 0 67 68 1 2 26 0 0 66 1 2 26 0 0
                                    67 1 3 9 0 0 74 15 1 2 9 0 0 74 1 2 3 14 0
                                    0 1 2 3 14 0 0 1 2 59 14 0 0 24 2 3 14 0 0
                                    1 2 3 14 0 0 56 1 58 0 0 1 2 58 0 0 0 1 2
                                    44 0 0 0 1 2 28 0 0 18 1 2 58 0 18 0 1 2 56
                                    0 15 0 1 2 44 0 29 0 1 2 39 0 0 0 42 2 39 0
                                    0 7 1 2 39 0 7 0 1 1 52 15 0 1)))))
           '|lookupComplete|)) 
