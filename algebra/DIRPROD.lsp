...
(DEFUN |DirectProduct| (&REST #1=#:G250)
  (SPROG NIL
         (PROG (#2=#:G251)
           (RETURN
            (COND
...
(DEFUN |DirectProduct;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G241 NIL) (#2=#:G242 NIL) (#3=#:G243 NIL) (#4=#:G244 NIL)
    (#5=#:G245 NIL) (#6=#:G246 NIL) (#7=#:G247 NIL) (#8=#:G248 NIL)
    (#9=#:G249 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
