...
(SDEFUN |TREE;count;M$Nni;7|
        ...
        (SPROG
         ((|i| #1=(|NonNegativeInteger|)) (#2=#:G174 NIL) (#3=#:G173 #1#)
...
(SDEFUN |TREE;map;M2$;8| ((|fn| |Mapping| S S) (|t| $) ($ $))
        (SPROG ((#1=#:G184 NIL) (|c| NIL) (#2=#:G183 NIL))
               (SEQ
                (COND ((QEQCAR |t| 1) |t|)
                      ('T
...
(SDEFUN |TREE;tree;L$;12| ((|ls| |List| S) ($ $))
        (SPROG ((#1=#:G198 NIL) (|s| NIL) (#2=#:G197 NIL))
               (SEQ
...
(SDEFUN |TREE;distance1| ((|t1| $) (|t2| $) ($ . #1=(|Integer|)))
        (SPROG
         ((#2=#:G207 NIL) (#3=#:G206 #1#) (#4=#:G208 #1#) (#5=#:G213 NIL)
          (#6=#:G103 NIL) (|u| (|List| #1#)) (|n| #1#) (#7=#:G212 NIL)
          (|t| NIL) (#8=#:G211 NIL))
         (SEQ
...
(SDEFUN |TREE;leaves;$L;19| ((|t| $) ($ |List| S))
        (SPROG
         ((#1=#:G232 NIL) (#2=#:G231 #3=(|List| S)) (#4=#:G233 #3#)
          (#5=#:G236 NIL) (|c| NIL))
         (SEQ
          (COND ((QEQCAR |t| 1) NIL)
...
(SDEFUN |TREE;nodes;$L;22| ((|t| $) ($ |List| $))
        (SPROG
         ((#1=#:G241 NIL) (#2=#:G240 #3=(|List| $)) (#4=#:G242 #3#)
          (#5=#:G247 NIL) (#6=#:G104 NIL) (|nl| (|List| #3#)) (#7=#:G246 NIL)
          (|c| NIL) (#8=#:G245 NIL))
         (SEQ
...
(SDEFUN |TREE;every?;M$B;25|
        ((|fn| |Mapping| #1=(|Boolean|) S) (|t| $) ($ . #1#))
        (SPROG ((#2=#:G265 NIL) (#3=#:G266 NIL) (|c| NIL))
               (SEQ
                (EXIT
                 (COND ((QEQCAR |t| 1) 'T)
...
(SDEFUN |TREE;parts;$L;28| ((|t| $) ($ |List| S))
        (SPROG
         ((#1=#:G282 NIL) (#2=#:G281 #3=(|List| S)) (#4=#:G283 #3#)
          (#5=#:G288 NIL) (#6=#:G105 NIL) (|u| (|List| #3#)) (#7=#:G287 NIL)
          (|c| NIL) (#8=#:G286 NIL))
         (SEQ
          (COND ((QEQCAR |t| 1) NIL)
                (#9='T
...
(SDEFUN |TREE;equal?|
        ...
        (SPROG
         ((#1=#:G303 NIL) (#2=#:G304 NIL) (|x| NIL) (#3=#:G305 NIL) (|y| NIL)
          (#4=#:G302 NIL) (|c2| #5=(|List| $)) (|c1| #5#))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |TREE;treeCount|
        ((|t| $) (|origTree| $) (|k| |NonNegativeInteger|)
         ($ |NonNegativeInteger|))
        (SPROG
         ((#1=#:G315 NIL) (#2=#:G314 #3=(|NonNegativeInteger|)) (#4=#:G316 #3#)
          (#5=#:G319 NIL) (|c| NIL))
         (SEQ
          (COND
           ((EQL |k| 5)
...
(SDEFUN |TREE;copy1| ((|t| $) (|origTree| $) (|k| |Integer|) ($ $))
        (SPROG ((#1=#:G330 NIL) (|x| NIL) (#2=#:G329 NIL))
               (SEQ
                (COND
                 ((EQL |k| 5)
                  (COND
...
(SDEFUN |TREE;cyclic2?| ((|x| $) (|parents| |List| $) ($ |Boolean|))
        (SPROG ((#1=#:G356 NIL) (#2=#:G357 NIL) (#3=#:G358 NIL) (|y| NIL))
               (SEQ
                (EXIT
...
(SDEFUN |TREE;cyclicCopy2| ((|t| $) (|cycles| |List| $) ($ $))
        (SPROG ((#1=#:G365 NIL) (|c| NIL) (#2=#:G364 NIL) (#3=#:G363 NIL))
               (SEQ
                (EXIT
                 (COND
...
(SDEFUN |TREE;copyCycle2| ((|cycle| $) (|cycleList| |List| $) ($ $))
        (SPROG ((#1=#:G370 NIL) (|c| NIL) (#2=#:G369 NIL) (|newCycle| ($)))
               (SEQ
                (LETT |newCycle|
...
(SDEFUN |TREE;copyCycle4|
        ...
        (SPROG ((#1=#:G377 NIL) (|c| NIL) (#2=#:G376 NIL))
               (SEQ
                (COND
...
(SDEFUN |TREE;cyclicEqual4?|
        ...
        (SPROG
         ((#1=#:G400 NIL) (#2=#:G401 NIL) (|x| NIL) (#3=#:G402 NIL) (|y| NIL)
          (|k| (|Integer|)))
         (SEQ
          (EXIT
           (COND ((QEQCAR |t1| 1) (QEQCAR |t2| 1)) ((QEQCAR |t2| 1) 'NIL)
...
(SDEFUN |TREE;cyclicParents3|
        ...
        (SPROG
         ((#1=#:G414 NIL) (|y| NIL) (|cycleMembers| (|List| $)) (#2=#:G413 NIL)
          (#3=#:G412 NIL))
         (SEQ
...
(SDEFUN |TREE;eqMember?| ((|y| $) (|l| |List| $) ($ |Boolean|))
        (SPROG ((#1=#:G429 NIL) (#2=#:G430 NIL) (#3=#:G431 NIL) (|x| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(DEFUN |Tree;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G437 NIL) (#2=#:G438 NIL) (#3=#:G439 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|Tree| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) '|Rep| (|Boolean|)
              ...
              (110 . |coerce|) (115 . |overlabel|) |TREE;cyclicEntries;$L;44|
              |TREE;cyclicCopy;2$;40| (121 . |eq?|) (127 . ~=) (133 . |null|)
              |TREE;cyclicEqual?;2$B;46| (138 . |elt|) (144 . ~=)
                  ...
                  (CONS
                   ...
                   (|makeByteWordVec2| 90
                                       '(2 6 8 0 0 18 2 28 8 2 0 29 2 32 8 0 0
                                         ...
                                         1 71 64 0 74 2 64 0 0 0 75 2 0 8 0 0
                                         78 2 32 8 0 0 79 1 28 8 0 80 2 28 2 0
                                         32 82 2 6 8 0 0 83 1 28 0 0 84 1 28 2
                                         0 85 2 9 8 0 0 1 1 0 6 0 17 1 0 0 26
                                         27 1 0 0 6 25 2 0 0 6 11 23 2 0 8 0 15
                                         52 2 10 6 0 6 14 3 10 6 0 88 6 1 2 10
                                         0 0 11 13 0 0 0 1 1 7 26 0 56 1 0 11 0
                                         47 2 1 8 0 0 35 2 0 8 0 15 45 1 7 26 0
                                         57 2 8 8 6 0 55 2 10 0 21 0 24 2 0 0
                                         21 0 22 2 0 8 0 15 43 1 0 26 0 40 1 0
                                         8 0 39 1 1 72 0 1 2 1 90 90 0 1 1 1 89
                                         0 1 2 7 8 19 0 54 3 2 0 0 26 26 1 3 2
                                         0 0 6 6 1 2 2 0 0 86 1 2 2 0 0 87 1 2
                                         0 8 0 0 78 1 0 8 0 9 0 0 0 10 2 0 6 0
                                         88 1 2 0 32 0 0 34 1 0 11 0 63 2 0 8 0
                                         0 81 1 0 11 0 76 1 0 0 0 77 1 0 8 0 60
                                         2 8 15 6 0 16 2 7 15 19 0 20 1 0 0 0
                                         62 1 5 64 0 65 1 0 11 0 12 2 1 8 0 0
                                         30 2 7 8 19 0 53 2 9 8 0 0 31 1 7 15 0
                                         42)))))
           '|lookupComplete|)) 
