...
(DEFUN |LEXTRIPK;trueVariables| (|lp| $)
  (PROG (|truels| #1=#:G143 #2=#:G149 |s| |lv|)
    (RETURN
     (SEQ
...
(DEFUN |LEXTRIPK;zeroDimensional?;LB;2| (|lp| $)
  (PROG (|lq1| #1=#:G154 |p| #2=#:G153 |fglmpack| |truels|)
    (RETURN
     (SEQ
...
(DEFUN |LEXTRIPK;fglmIfCan;LU;3| (|lp| $)
  (PROG (#1=#:G172 |q1| #2=#:G171 #3=#:G168 |foo| |lq1| #4=#:G170 |p| #5=#:G169
         |fglmpack| |truels|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |LEXTRIPK;groebner;2L;4| (|lp| $)
  (PROG (#1=#:G180 |q1| #2=#:G179 |lq1| #3=#:G178 |p| #4=#:G177 |fglmpack|
         |truels|)
    (RETURN
     (SEQ
      (LETT |truels| (|LEXTRIPK;trueVariables| |lp| $)
...
(DEFUN |LEXTRIPK;lexTriangular;LBL;5| (|base| |norm?| $)
  (PROG (|toSee| #1=#:G208 |us| |newlp| |lus| |newp| |b| |lbwt| |bwt| |v| |lp|
         |p| |toSave| |ts| |lpwt|)
    (RETURN
     (SEQ
...
(DEFUN |LEXTRIPK;squareFreeLexTriangular;LBL;7| (|base| |norm?| $)
  (PROG (|toSee| #1=#:G240 |us| |newlp| |lus| |newp| |b| |lbwt| |bwt| |v| |lp|
         |p| |toSave| |ts| |lpwt|)
    (RETURN
     (SEQ
      (LETT |base| (SPADCALL (ELT $ 27) |base| (QREFELT $ 29))
...
(DEFUN |LexTriangularPackage| (&REST #1=#:G246)
  (PROG ()
    (RETURN
     (PROG (#2=#:G247)
       (RETURN
