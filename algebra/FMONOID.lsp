        ...
        (SPROG
         ((|lla|
          ...
          (|m|
           (|List|
            (|Record| (|:| |gen| S) (|:| |exp| (|NonNegativeInteger|)))))
          (#3=#:G159 NIL) (|ru| (|Union| $ "failed")) (#4=#:G153 NIL)
          (|lar| #1#) (|la0| #1#))
         (SEQ
          (EXIT
           (COND
        ...
        (SPROG
         ((|Nlar| (|Integer|))
          ...
          (|l|
           (|List|
            (|Record| (|:| |gen| S) (|:| |exp| (|NonNegativeInteger|)))))
          (#2=#:G196 NIL) (#3=#:G197 NIL) (#4=#:G182 NIL)
        ...
        (SPROG
         ((#1=#:G204 NIL) (#2=#:G205 NIL)
          (|h|
           (|List|
            (|Record| (|:| |gen| S) (|:| |exp| (|NonNegativeInteger|)))))
          (#3=#:G206 NIL) (|f0| NIL) (#4=#:G207 NIL) (|g0| NIL))
         (SEQ
          (EXIT
        ...
        (SPROG
         ((|na| (|Integer|))
          (|la|
           #1=(|List|
               (|Record| (|:| |gen| S) (|:| |exp| (|NonNegativeInteger|)))))
          (|lb| #1#) (#2=#:G237 NIL) (|nb| (|Integer|)) (#3=#:G234 NIL)
          (#4=#:G247 NIL))
         (SEQ
          (EXIT
           (SEQ
