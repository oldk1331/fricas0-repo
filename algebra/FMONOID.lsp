        ...
        (SPROG
         ((|Nlar| (|Integer|))
          ...
          (|l|
           (|List|
            (|Record| (|:| |gen| S) (|:| |exp| (|NonNegativeInteger|)))))
          (#2=#:G186 NIL) (#3=#:G193 NIL) (#4=#:G180 NIL)
...
(SDEFUN |FMONOID;hclf;3$;14| ((|f| $) (|g| $) ($ $))
        (SPROG
         ((#1=#:G195 NIL) (#2=#:G199 NIL)
          (|h|
           (|List|
            (|Record| (|:| |gen| S) (|:| |exp| (|NonNegativeInteger|)))))
          (#3=#:G200 NIL) (|f0| NIL) (#4=#:G201 NIL) (|g0| NIL))
         (SEQ
          (EXIT
        ...
        (SPROG
         ((|na| (|Integer|))
          (|la|
           #1=(|List|
               (|Record| (|:| |gen| S) (|:| |exp| (|NonNegativeInteger|)))))
          (|lb| #1#) (#2=#:G230 NIL) (|nb| (|Integer|)) (#3=#:G227 NIL)
          (#4=#:G239 NIL))
         (SEQ
          (EXIT
           (SEQ
