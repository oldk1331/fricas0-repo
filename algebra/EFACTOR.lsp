...
(SDEFUN |EFACTOR;fpoly_factor|
        ...
        (SPROG
         ((|res| (|Factored| (|SparseUnivariatePolynomial| F)))
          ...
          (|fru| (|SparseUnivariatePolynomial| F)) (#1=#:G130 NIL)
          (|fr1|
           (|SparseUnivariatePolynomial|
            (|SparseMultivariatePolynomial| R (|Kernel| F))))
          (#2=#:G131 NIL) (|frec| NIL)
...
(SDEFUN |EFACTOR;ifactor|
        ...
        (SPROG
         ((|res| (|Factored| (|SparseUnivariatePolynomial| F)))
          ...
          (#2=#:G158 NIL) (|frec| NIL) (|kf| (F)) (|fres1| (|Factored| |ups|))
          (|p2| (|ups|))
          (|ups|
           ...
           (|Join| (|MonogenicAlgebra| F #3=(|SparseUnivariatePolynomial| F))
                   (CATEGORY |package|
                    ...
                    (IF (|has| #3# (|Hashable|))
                        (ATTRIBUTE (|Hashable|))
                        |noBranch|))))
          (|lk2| (|List| #1#)) (#4=#:G157 NIL) (|k| NIL) (#5=#:G156 NIL)
...
(DEFUN |ExpressionFactorPolynomial| (&REST #1=#:G161)
  (SPROG NIL
         (PROG (#2=#:G162)
           (RETURN
            (COND
