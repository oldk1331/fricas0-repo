...
(SDEFUN |PR;coefficient;$ER;10| ((|p| $) (|e| E) ($ R))
        (SPROG
         ((#1=#:G180 NIL) (#2=#:G185 NIL) (#3=#:G187 NIL) (|tm| NIL)
          (|ks| (|SingleInteger|)) (#4=#:G186 NIL) (|tms| NIL)
          (|es| (|SingleInteger|))
...
(SDEFUN |PR;coefficient;$ER;11| ((|p| $) (|e| E) ($ R))
        (SPROG ((#1=#:G189 NIL) (#2=#:G193 NIL) (#3=#:G194 NIL) (|tm| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |PR;times| ((|tco| R) (|tex| E) (|rx| $) ($ $))
        (SPROG ((|r| (R)) (#1=#:G234 NIL) (|tx| NIL) (#2=#:G233 NIL))
               (SEQ
                (COND
                 ((QREFELT $ 43)
...
(SDEFUN |PR;*;3$;22| ((|p1| $) (|p2| $) ($ $))
        (SPROG
         ((|res| (|Rep|)) (#1=#:G293 NIL) (|tx| NIL) (#2=#:G292 NIL)
...
(SDEFUN |PR;*;3$;23| ((|p1| $) (|p2| $) ($ $))
        (SPROG
         ((|res| (|Rep|)) (#1=#:G301 NIL) (|tx| NIL) (|xx| (|Rep|))
          (|yy| (|Rep|)))
...
(SDEFUN |PR;unitNormal;$R;26|
        ((|p| $)
         ($ |Record| (|:| |unit| . #1=($)) (|:| |canonical| . #1#)
          (|:| |associate| . #1#)))
        (SPROG ((|a| (R)) (#2=#:G309 NIL) (|lcf| (R)) (|#G1| (R)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
...
(SDEFUN |PR;unitCanonical;2$;27| ((|p| $) ($ $))
        (SPROG ((|a| (R)) (#1=#:G313 NIL) (|lcf| (R)) (|#G2| (R)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND ((NULL |p|) (EXIT |p|))
...
(SDEFUN |PR;exquo;$RU;31| ((|p| $) (|r| R) ($ |Union| $ "failed"))
        (SPROG
         ((#1=#:G338 NIL) (|a| (|Union| R "failed")) (#2=#:G340 NIL) (|tm| NIL)
          (#3=#:G339 NIL))
         (SEQ
          (EXIT
           (CONS 0
...
(SDEFUN |PR;exquo;2$U;33| ((|p1| $) (|p2| $) ($ |Union| $ #1="failed"))
        (SPROG
         ((|rout| ($)) (#2=#:G365 NIL) (|ee| (|Union| E "failed"))
          (|a| (|Union| R #1#)))
         (SEQ
          (EXIT
...
(SDEFUN |PR;exquo;2$U;34| ((|p1| $) (|p2| $) ($ |Union| $ #1="failed"))
        (SPROG
         ((|rout| ($)) (#2=#:G380 NIL) (|ee| (|Union| E "failed"))
          (|a| (|Union| R #1#)))
         (SEQ
          (EXIT
           (COND ((NULL |p2|) (|error| "Division by 0"))
...
(DEFUN |PolynomialRing;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G390 NIL) (#2=#:G391 NIL) (#3=#:G392 NIL) (#4=#:G393 NIL)
