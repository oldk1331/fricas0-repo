...
(SDEFUN |PR;coefficient;$ER;9| ((|p| $) (|e| E) ($ R))
        (SPROG
         ((#1=#:G213 NIL) (#2=#:G214 NIL) (#3=#:G216 NIL) (|tm| NIL)
          (|ks| (|SingleInteger|)) (#4=#:G215 NIL) (|tms| NIL)
          (|es| (|SingleInteger|))
...
(SDEFUN |PR;coefficient;$ER;10| ((|p| $) (|e| E) ($ R))
        (SPROG ((#1=#:G223 NIL) (#2=#:G224 NIL) (#3=#:G225 NIL) (|tm| NIL))
               (SEQ
                (EXIT
                 (SEQ
                        ...
                        (EXIT
                         (COND
                          ((SPADCALL (QCAR |tm|) |e| (QREFELT $ 30))
                           (PROGN (LETT #2# (QCDR |tm|) . #4#) (GO #5=#:G222)))
                          ('T
                           (SEQ
                            (EXIT
                             (COND
...
(SDEFUN |PR;times| ((|tco| R) (|tex| E) (|rx| $) ($ $))
        (SPROG ((|r| (R)) (#1=#:G253 NIL) (|tx| NIL) (#2=#:G252 NIL))
               (SEQ
                (COND
                 ((QREFELT $ 42)
...
(SDEFUN |PR;*;3$;21| ((|p1| $) (|p2| $) ($ $))
        (SPROG
         ((|res| (|Rep|)) (#1=#:G320 NIL) (|tx| NIL) (|xx| (|Rep|))
          (|yy| (|Rep|)))
         (SEQ (LETT |xx| |p1| . #2=(|PR;*;3$;21|))
              (EXIT
               (COND ((NULL |xx|) |p1|)
                     (#3='T
                      (SEQ (LETT |yy| |p2| . #2#)
...
(SDEFUN |PR;unitNormal;$R;25|
        ((|p| $)
         ($ |Record| (|:| |unit| . #1=($)) (|:| |canonical| . #1#)
          (|:| |associate| . #1#)))
        (SPROG ((|a| (R)) (#2=#:G334 NIL) (|lcf| (R)) (|#G1| (R)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                       ...
                       ((SPADCALL |#G1| (|spadConstant| $ 11) (QREFELT $ 60))
                        (PROGN
                         (LETT #2#
                               ...
                               . #3#)
                         (GO #4=#:G331))))))))
                  (LETT |a| (SPADCALL |lcf| (QREFELT $ 58)) . #3#)
                  (EXIT
...
(SDEFUN |PR;unitCanonical;2$;26| ((|p| $) ($ $))
        (SPROG ((|a| (R)) (#1=#:G339 NIL) (|lcf| (R)) (|#G2| (R)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND ((NULL |p|) (EXIT |p|))
           ...
           ('T
            (SEQ
             (PROGN
              ...
              (LETT |u| (QVELT |#G81| 0) . #2#)
              (LETT |cf| (QVELT |#G81| 1) . #2#)
              (LETT |a| (QVELT |#G81| 2) . #2#)
              |#G81|)
             (EXIT
           ...
           ('T
            (SEQ
             (PROGN
              ...
              (LETT |u| (QVELT |#G83| 0) . #1#)
              (LETT |cf| (QVELT |#G83| 1) . #1#)
              (LETT |a| (QVELT |#G83| 2) . #1#)
              |#G83|)
             (EXIT
              (CONS (CONS (QCAR (|SPADfirst| |p|)) |cf|)
                    (SPADCALL |a| (CDR |p|) (QREFELT $ 49)))))))))) 
                   ...
                   (SEQ
                    ...
                    (EXIT
                     (COND
                      ...
                      ('T
                       (SEQ
                        (LETT |e2| (SPADCALL |e| (QCAR |tm|) (QREFELT $ 43))
                              . #2#)
                        (SEQ G190
                             (COND
                              ((NULL
...
(SDEFUN |PR;exquo;$RU;31| ((|p| $) (|r| R) ($ |Union| $ "failed"))
        (SPROG
         ((#1=#:G380 NIL) (|a| (|Union| R "failed")) (#2=#:G382 NIL) (|tm| NIL)
          (#3=#:G381 NIL))
         (SEQ
          (EXIT
           (CONS 0
...
(SDEFUN |PR;exquo;2$U;32| ((|p1| $) (|p2| $) ($ |Union| $ #1="failed"))
        (SPROG
         ((|rout| ($)) (#2=#:G400 NIL) (|ee| (|Union| E "failed"))
          (|a| (|Union| R #1#)))
         (SEQ
          (EXIT
...
(SDEFUN |PR;exquo;2$U;33| ((|p1| $) (|p2| $) ($ |Union| $ #1="failed"))
        (SPROG
         ((|rout| ($)) (#2=#:G418 NIL) (|ee| (|Union| E "failed"))
          (|a| (|Union| R #1#)))
         (SEQ
          (EXIT
           (COND ((NULL |p2|) (|error| "Division by 0"))
...
(DEFUN |PolynomialRing| (&REST #1=#:G430)
  (SPROG NIL
         (PROG (#2=#:G431)
           (RETURN
            (COND
