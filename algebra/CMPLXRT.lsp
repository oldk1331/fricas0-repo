...
(SDEFUN |CMPLXRT;complexZeros;UPParL;1|
        ...
        (SPROG
         ((|ris| (|List| (|Complex| |Par|))) (#1=#:G114 NIL) (|z| NIL)
         ...
         (SEQ
          ...
          (LETT |lpf| (SPADCALL (SPADCALL |np| (QREFELT $ 13)) (QREFELT $ 18))
                . #7#)
          (LETT |ris| NIL . #7#)
          (SEQ (LETT |pf| NIL . #7#) (LETT #5# |lpf| . #7#) G190
               (COND
                ((OR (ATOM #5#) (PROGN (LETT |pf| (CAR #5#) . #7#) NIL))
                 (GO G191)))
               (SEQ (LETT |pp| (QVELT |pf| 1) . #7#)
                    (LETT |q| (SPADCALL |pp| |vv| (QREFELT $ 20)) . #7#)
                    (LETT |q|
                          (SPADCALL |q| |vv|
                                    (SPADCALL (SPADCALL |x1| (QREFELT $ 21))
                                              (SPADCALL
                                    ...
                                    (QREFELT $ 30))
                          . #7#)
                    (LETT |p1| (SPADCALL (ELT $ 31) |q| (QREFELT $ 35)) . #7#)
                    (LETT |p2| (SPADCALL (ELT $ 36) |q| (QREFELT $ 35)) . #7#)
                    (LETT |lz|
...
(DEFUN |ComplexRootPackage| (&REST #1=#:G115)
  (SPROG NIL
         (PROG (#2=#:G116)
           (RETURN
            (COND
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 48
                                                 '(0 8 0 9 1 6 10 0 11 1 10 12
                                                   0 13 1 17 16 0 18 2 19 0 10
                                                   8 20 1 19 0 8 21 0 6 0 22 0
                                                   7 0 23 0 6 0 24 2 26 0 25 25
                                                   27 2 19 0 26 0 28 2 19 0 0 0
                                                   29 3 19 0 0 8 0 30 1 26 25 0
                                                   31 2 34 32 33 19 35 1 26 25
                                                   0 36 4 40 37 38 38 39 7 41 1
                                                   42 7 0 43 2 44 0 7 7 45 2 46
                                                   0 0 0 47 2 0 46 6 7 48)))))
           '|lookupComplete|)) 
