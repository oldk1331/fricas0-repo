...
(SDEFUN |JBUNDLE;CheckZeroIndex|
        ...
        (SPROG ((#1=#:G146 NIL) (#2=#:G147 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (SEQ
...
(SDEFUN |JBUNDLE;coerce;S$;10| ((|s| (|Symbol|)) ($ ($)))
        (SPROG ((#1=#:G161 NIL) (#2=#:G158 NIL) (|pos| (|Integer|)))
...
(SDEFUN |JBUNDLE;D;SL$;11|
        ...
        (SPROG
         ((#1=#:G170 NIL) (|lower| (|List| (|PositiveInteger|)))
          (#2=#:G166 NIL) (|pos| #3=(|Integer|)) (#4=#:G174 NIL) (|d| NIL)
          (|up| #3#))
...
(SDEFUN |JBUNDLE;name;$S;15| ((|jv| ($)) ($ (|Symbol|)))
        (SPROG
         ((|lower| (|List| (|OutputForm|))) (#1=#:G187 NIL) (|j| NIL)
...
(SDEFUN |JBUNDLE;coerce;$E;17| ((|jv| ($)) ($ (|Expression| (|Integer|))))
        (SPROG
         ((|arg| (|List| (|Expression| (|Integer|)))) (#1=#:G197 NIL) (|i| NIL)
          (#2=#:G196 NIL) (|jop| (|BasicOperator|)) (|tmp| (|None|))
          (|opname| (|Symbol|)))
         (SEQ
          (COND
