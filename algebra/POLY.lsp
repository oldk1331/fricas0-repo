...
(DEFUN |Polynomial;| (|#1|)
  (SPROG
   ((#1=#:G153 NIL) (|pv$| NIL) (#2=#:G143 NIL) (#3=#:G144 NIL) (#4=#:G145 NIL)
    (#5=#:G146 NIL) (#6=#:G147 NIL) (#7=#:G148 NIL) (#8=#:G149 NIL)
    (#9=#:G150 NIL) (#10=#:G151 NIL) (#11=#:G152 NIL) ($ NIL) (|dv$| NIL)
    (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|Polynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|SparseMultivariatePolynomial| 6 16)
              ...
              (|Record| (|:| |mat| 55) (|:| |vec| (|Vector| 6))) (|List| 58)
              (|Equation| $) (|Union| 46 '#3="failed")
              (|Record| (|:| |var| 16) (|:| |exponent| 42)) (|Union| 60 '#3#)
              (|SparseUnivariatePolynomial| 6) (|List| 6)
              (|IndexedExponents| 16) (|Mapping| 64 64) (|Mapping| 6 6)
