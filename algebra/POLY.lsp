...
(SDEFUN |POLY;coerce;$Of;1| ((|p| ($)) ($ (|OutputForm|)))
        (SPROG ((|a| (|Symbol|)) (#1=#:G123 NIL) (|r| (|Union| R "failed")))
...
(DEFUN |Polynomial;| (|#1|)
  (SPROG
   ((#1=#:G170 NIL) (|pv$| NIL) (#2=#:G161 NIL) (#3=#:G163 NIL) (#4=#:G162 NIL)
    (#5=#:G164 NIL) (#6=#:G165 NIL) (#7=#:G166 NIL) (#8=#:G167 NIL)
    (#9=#:G168 NIL) (#10=#:G169 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
