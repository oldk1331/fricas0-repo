...
(MAKEPROP '|Polynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|SparseMultivariatePolynomial| 6 16)
              ...
              (|Union| 45 '#2="failed") (|Matrix| $) (|InputForm|)
              (|Pattern| (|Float|)) (|Pattern| 52)
              (|PatternMatchResult| (|Float|) $) (|PatternMatchResult| 52 $)
              (|Union| $ '#2#)
              (|Record| (|:| |unit| $) (|:| |canonical| $) (|:| |associate| $))
              (|Fraction| 52) (|NonNegativeInteger|)
              (|Record| (|:| |llcm_res| $) (|:| |coeff1| $) (|:| |coeff2| $))
              (|List| $) (|Factored| $)
              (|Record| (|:| |mat| 46) (|:| |vec| (|Vector| 52))) (|Vector| $)
              (|Matrix| 52) (|Factored| 20) (|Union| 49 '#2#) (|List| 20)
              (|Union| 39 '#1#) (|Union| 52 '#1#) (|Integer|)
              (|Union| 42 '#3="failed")
              (|Record| (|:| |var| 16) (|:| |exponent| 40)) (|Union| 54 '#3#)
              (|Record| (|:| |quotient| $) (|:| |remainder| $))
              (|SparseUnivariatePolynomial| 6) (|List| 40) (|List| 6)
              (|List| 61) (|Equation| $) (|Mapping| 6 6)
              (|IndexedExponents| 16) (|Mapping| 63 63) (|Matrix| 6)
              (|Record| (|:| |mat| 65) (|:| |vec| (|Vector| 6)))
           ...
           (CONS
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 6 63 16)
                 (|MaybeSkewPolynomialCategory| 6 63 16)
                 (|PolynomialFactorizationExplicit|)
                 ...
                 (|ConvertibleTo| 32) (|RetractableTo| 39) (|RetractableTo| 52)
                 (|canonicalUnitNormal|))
              (|makeByteWordVec2| 29
