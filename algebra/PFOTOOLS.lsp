...
(SDEFUN |PFOTOOLS;mix;LI;1|
        ((|l| |List|
         ...
         ($ |Integer|))
        (SPROG
         ((#1=#:G128 NIL) (|p| NIL) (#2=#:G127 NIL) (#3=#:G126 NIL)
          (#4=#:G125 NIL))
         (SEQ
          (SPADCALL
           (SPADCALL
...
(SDEFUN |PFOTOOLS;polyred;2UPUP;3| ((|r| UPUP) ($ UPUP))
        (SPROG
         ((|ld| (|List| (|Integer|))) (#1=#:G138 NIL) (|c| NIL)
          (#2=#:G137 NIL))
         (SEQ
          (LETT |ld|
                (PROGN
...
(SDEFUN |PFOTOOLS;getGoodPrime;IPi;5| ((|n| |Integer|) ($ |PositiveInteger|))
        (SPROG ((|p| (|PositiveInteger|)) (#1=#:G146 NIL))
               (SEQ (LETT |p| 3)
...
(DEFUN |PointsOfFiniteOrderTools| (&REST #1=#:G155)
  (SPROG NIL
         (PROG (#2=#:G156)
           (RETURN
            (COND
