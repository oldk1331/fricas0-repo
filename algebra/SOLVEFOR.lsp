...
(SDEFUN |SOLVEFOR;solve;UPL;4| ((|u| (UP)) ($ (|List| F)))
        (SPROG
         ((|ls| (|List| F)) (#1=#:G126 NIL) (|i| NIL) (|lsf| (|List| F))
          (#2=#:G125 NIL) (|f| NIL))
         (SEQ (LETT |ls| NIL)
              (SEQ (LETT |f| NIL)
                   (LETT #2#
...
(SDEFUN |SOLVEFOR;cubic;4FL;18|
        ...
        (SPROG
         ((#1=#:G173 NIL) (|u| NIL) (#2=#:G172 NIL) (S (F)) (D (F)) (R (F))
          (Q (F)) (#3=#:G171 NIL) (#4=#:G170 NIL) (P (F)) (#5=#:G169 NIL)
          (#6=#:G168 NIL) (|a3| (F)) (|a2| (F)) (|a1| (F)))
...
(SDEFUN |SOLVEFOR;quartic;5FL;20|
        ...
        (SPROG
         ((#1=#:G186 NIL) (|s| NIL) (#2=#:G185 NIL) (|slist| (|List| F))
...
(DEFUN |PolynomialSolveByFormulas| (&REST #1=#:G191)
  (SPROG NIL
         (PROG (#2=#:G192)
           (RETURN
            (COND
