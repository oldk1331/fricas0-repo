...
(SDEFUN |NUMODE;rk4f;VI2FIMV;5|
        ((|y| (|Vector| (|Float|))) (|nvar| (|Integer|)) (|x1| #1=(|Float|))
         ...
         ($ (|Void|)))
        (SPROG
         ((|x| #1#) (#2=#:G237 NIL) (|i| NIL) (|h| (|Float|))
          (|dydx| #3=(|Vector| (|Float|))) (#4=#:G228 NIL) (|dym| #3#)
          (#5=#:G226 NIL) (|dyt| #3#) (#6=#:G224 NIL) (|yt| #3#)
          (#7=#:G222 NIL))
         (SEQ
          (LETT |yt|
                (MAKEARR1
...
(SDEFUN |NUMODE;rk4;VI2FMV;6|
        ((|y| (|Vector| (|Float|))) (|n| (|Integer|)) (|x| (|Float|))
         ...
         ($ (|Void|)))
        (SPROG
         ((|t4| #1=(|Vector| (|Float|))) (#2=#:G245 NIL) (|t3| #1#)
          (#3=#:G243 NIL) (|t2| #1#) (#4=#:G241 NIL) (|t1| #1#)
          (#5=#:G239 NIL))
         (SEQ
          (LETT |t1|
                (MAKEARR1
...
(SDEFUN |NUMODE;rk4local|
        ...
        (SPROG
         ((#2=#:G270 NIL) (|i| NIL) (#3=#:G269 NIL) (#4=#:G268 NIL)
          (#5=#:G267 NIL) (|m| #1#) (|xh| (|Float|)) (|h6| (|Float|))
          (|hh| (|Float|)))
         (SEQ
          (LETT |hh|
