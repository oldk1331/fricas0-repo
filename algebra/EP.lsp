          ...
          (|List|
           (|Record|
            ...
            (|:| |eigvec|
                 (|List| (|Matrix| (|Fraction| (|Polynomial| R)))))))))
        (SPROG
         ((#1=#:G176 NIL) (|v| NIL) (#2=#:G175 NIL) (#3=#:G174 NIL) (|ri| NIL)
          (#4=#:G173 NIL)
          (|res1|
           (|List|
            (|Record|
          ...
          (|List|
           (|Record|
            ...
            (|:| |geneigvec|
                 (|List| (|Matrix| (|Fraction| (|Polynomial| R)))))))))
        (SPROG
         ((#1=#:G190 NIL) (|v| NIL) (#2=#:G189 NIL) (#3=#:G188 NIL) (|ri| NIL)
          (#4=#:G187 NIL)
          (|res1|
           (|List|
            (|Record|
