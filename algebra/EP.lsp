          ...
          (|List|
           (|Record|
            ...
            (|:| |eigvec|
                 (|List| (|Matrix| (|Fraction| (|Polynomial| R)))))))))
        (SPROG
         ((#1=#:G177 NIL) (|v| NIL) (#2=#:G176 NIL) (#3=#:G175 NIL) (|ri| NIL)
          (#4=#:G174 NIL)
          (|res1|
           (|List|
            (|Record|
          ...
          (|List|
           (|Record|
            ...
            (|:| |geneigvec|
                 (|List| (|Matrix| (|Fraction| (|Polynomial| R)))))))))
        (SPROG
         ((#1=#:G191 NIL) (|v| NIL) (#2=#:G190 NIL) (#3=#:G189 NIL) (|ri| NIL)
          (#4=#:G188 NIL)
          (|res1|
           (|List|
            (|Record|
