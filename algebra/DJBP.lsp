...
(SDEFUN |DJBP;lookup| ((|jv| (JB)) ($ (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G156 NIL) (#2=#:G157 NIL) (|i| NIL) (#3=#:G158 NIL)
          (|ljv| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |DJBP;mainVariable;$U;8| ((|p| ($)) ($ (|Union| JB "failed")))
        (SPROG
         ((#1=#:G181 NIL) (#2=#:G182 NIL) (|i| NIL) (#3=#:G183 NIL) (|jv| NIL)
          (|tdeg| (E)))
         (SEQ
          (EXIT
...
(SDEFUN |DJBP;variables;$L;9| ((|p| ($)) ($ (|List| JB)))
        (SPROG
         ((#1=#:G199 NIL) (|jv| NIL) (#2=#:G200 NIL) (|i| NIL) (#3=#:G198 NIL)
          (#4=#:G197 NIL) (|tdeg| (E))
...
(SDEFUN |DJBP;coerce;$Of;10| ((|p| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|lt| (|List| (|OutputForm|))) (|l| (|List| (|OutputForm|)))
          (#1=#:G219 NIL) (|i| NIL) (#2=#:G218 NIL) (|t| NIL))
         (SEQ
          (COND
...
(SDEFUN |DJBP;univariate;$JBSup;16|
        ...
        (SPROG
         ((|nexp| (E)) (|deg| (|NonNegativeInteger|)) (#1=#:G261 NIL)
          (#2=#:G263 NIL) (|i| NIL) (#3=#:G262 NIL)
...
(SDEFUN |DJBP;totalDegree;$Nni;20| ((|p| ($)) ($ (|NonNegativeInteger|)))
        (SPROG
         ((#1=#:G280 NIL) (#2=#:G279 #3=(|NonNegativeInteger|)) (#4=#:G281 #3#)
          (#5=#:G286 NIL) (|t| NIL))
         (SEQ
...
(SDEFUN |DJBP;degree;$LL;22|
        ...
        (SPROG ((#1=#:G292 NIL) (|jv| NIL) (#2=#:G291 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |DJBP;minimumDegree;$LL;24|
        ((|p| ($)) (|ljv| (|List| JB)) ($ (|List| (|NonNegativeInteger|))))
        (SPROG ((#1=#:G298 NIL) (|jv| NIL) (#2=#:G297 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |jv| NIL) (LETT #1# |ljv|) G190
...
(SDEFUN |DJBP;eval;$LL$;29|
        ((|p| ($)) (|Ljvar| (|List| JB)) (|Lpval| (|List| $)) ($ ($)))
        (SPROG
         ((|nlpval| (|List| $)) (#1=#:G319 NIL) (|mvar| NIL) (#2=#:G318 NIL)
          (|nljvar| (|List| JB)))
         (SEQ
          (LETT |nljvar|
...
(SDEFUN |DJBP;content;$R;32| ((|p| ($)) ($ (R)))
        (SPROG
         ((#1=#:G323 NIL) (#2=#:G322 (R)) (#3=#:G324 (R)) (#4=#:G327 NIL)
          (|t| NIL))
         (SEQ
...
(DEFUN |DistributedJetBundlePolynomial| (&REST #1=#:G391)
  (SPROG NIL
         (PROG (#2=#:G392)
           (RETURN
            (COND
...
(DEFUN |DistributedJetBundlePolynomial;| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((#1=#:G390 NIL) (|jv| NIL) (#2=#:G389 NIL) (#3=#:G388 NIL) (|pv$| NIL)
    (#4=#:G379 NIL) (#5=#:G381 NIL) (#6=#:G380 NIL) (#7=#:G382 NIL)
    (#8=#:G383 NIL) (#9=#:G384 NIL) (#10=#:G385 NIL) (#11=#:G386 NIL)
    (#12=#:G387 NIL) ($ NIL) (|dv$| NIL) (DV$4 NIL) (DV$3 NIL) (DV$2 NIL)
    (DV$1 NIL))
   (SEQ
    (PROGN
...
(MAKEPROP '|DistributedJetBundlePolynomial| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|PolynomialRing| 6 9) (|local| |#1|)
              ...
              (|Record| (|:| |mat| 182) (|:| |vec| (|Vector| 6))) (|Matrix| 6)
              (|List| 184) (|Equation| $) (|Union| 135 '#3="failed")
              (|Record| (|:| |var| 7) (|:| |exponent| 18)) (|Union| 186 '#3#)
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 6 9 7)
                 ...
                 (|CommutativeRing|) (|LeftOreRing|) (|Algebra| 169)
                 ...
                 (|Module| 169) (|Module| 6) (|FullyLinearlyExplicitOver| 6)
                 ...
                 (|LeftModule| 169) (|RightModule| 169) (|RightModule| 36)
              ...
              (|makeByteWordVec2| 156
                                  '(1 7 10 0 11 2 7 16 0 0 17 1 19 0 18 20 0 7
                                    ...
                                    120 120 155 1 0 135 135 156 1 52 16 0 29 1
                                    0 45 0 46 1 0 91 0 95 2 0 63 0 7 74 1 0 18
                                    0 108 1 0 86 0 87 1 0 6 0 72 1 19 0 0 41 1
                                    0 18 0 34 2 0 0 63 7 97 2 0 0 91 7 103 1 0
                                    16 0 33 3 0 0 0 7 18 27 2 0 0 6 9 25 2 0
                                    110 0 45 114 2 0 18 0 7 113 1 0 30 0 31 1
                                    19 6 0 84 1 0 16 0 32 1 14 135 135 156 2 14
                                    0 0 0 146 3 0 0 0 45 135 136 3 0 0 0 45 118
                                    119 3 0 0 0 7 0 116 3 0 0 0 7 6 117 2 4 0 0
                                    7 138 2 0 110 0 45 111 2 0 18 0 7 109 1 0 9
                                    0 35 1 0 0 58 68 1 0 58 0 79 1 14 6 0 142 1
                                    0 6 0 85 1 12 0 7 28 1 0 0 6 61 1 0 10 0 57
                                    2 50 0 0 18 96 0 52 0 38 0 50 0 22 2 20 0 0
                                    6 140 2 0 0 0 0 70 2 0 0 6 0 101 2 0 0 0 0
                                    26)))))
           '|lookupIncomplete|)) 
