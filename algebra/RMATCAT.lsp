...
(DEFUN |RectangularMatrixCategory| (&REST #1=#:G132)
  (LET (#2=#:G133)
    (COND
     ((SETQ #2#
                             ...
                             (|Join| (|BiModule| '|t#3| '|t#3|)
                                     ...
                                     (|mkCategory|
                                      '(((|matrix| ($ (|List| (|List| |t#3|))))
                                        ...
                                        ((|nullSpace| ((|List| |t#5|) $))
                                         (|has| |t#3| (|IntegralDomain|))))
                                      '(((|Finite|) (|has| |t#3| (|Finite|)))
                                        ((|Module| |t#3|)
                                         (|has| |t#3| (|CommutativeRing|))))
                                      '((|List| |t#5|) (|NonNegativeInteger|)
                                        (|Integer|) (|List| (|List| |t#3|))
                                        (|Boolean|))
                                      NIL))
