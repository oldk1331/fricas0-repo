...
(SDEFUN |UTSODE;odeNre|
        ((|f| (|Mapping| (|Stream| |Coef|) (|List| (|Stream| |Coef|))))
         ...
         ($ (|List| (|Stream| |Coef|))))
        (SPROG
         ((|yil| (|List| (|Stream| |Coef|))) (#1=#:G209 NIL) (|c| NIL)
          (#2=#:G210 NIL) (|y| NIL) (#3=#:G208 NIL))
         (SEQ
          (LETT |yil|
                (PROGN
                 (LETT #3# NIL)
...
(SDEFUN |UTSODE;simulre|
        ...
        (SPROG
         ((#1=#:G231 NIL) (|csti| NIL) (#2=#:G232 NIL) (|lsfi| NIL)
          (#3=#:G230 NIL))
         (SEQ
          (PROGN
           (LETT #3# NIL)
...
(SDEFUN |UTSODE;mpsode;LLL;19|
        ((|cs| (|List| |Coef|)) (|lsts| (|List| (|Mapping| UTS (|List| UTS))))
         ($ (|List| UTS)))
        (SPROG
         ((|stSol| (|List| (|Stream| |Coef|))) (#1=#:G244 NIL) (|lst| NIL)
          (#2=#:G243 NIL))
         (SEQ
          (LETT |stSol|
                (|UTSODE;iMpsode| |cs|
...
(DEFUN |UnivariateTaylorSeriesODESolver| (&REST #1=#:G245)
  (SPROG NIL
         (PROG (#2=#:G246)
           (RETURN
            (COND
