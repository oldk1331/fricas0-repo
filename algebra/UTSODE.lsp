...
(SDEFUN |UTSODE;odeNre|
        ((|f| (|Mapping| (|Stream| |Coef|) (|List| (|Stream| |Coef|))))
         ...
         (% (|List| (|Stream| |Coef|))))
        (SPROG
         ((|yil| (|List| (|Stream| |Coef|))) (#1=#:G194 NIL) (|c| NIL)
          (#2=#:G195 NIL) (|y| NIL) (#3=#:G193 NIL))
         (SEQ
          (LETT |yil|
                (PROGN
                 (LETT #3# NIL)
...
(SDEFUN |UTSODE;simulre|
        ...
        (SPROG
         ((#1=#:G216 NIL) (|csti| NIL) (#2=#:G217 NIL) (|lsfi| NIL)
          (#3=#:G215 NIL))
         (SEQ
          (PROGN
           (LETT #3# NIL)
...
(SDEFUN |UTSODE;mpsode;LLL;19|
        ((|cs| (|List| |Coef|)) (|lsts| (|List| (|Mapping| UTS (|List| UTS))))
         (% (|List| UTS)))
        (SPROG
         ((|stSol| (|List| (|Stream| |Coef|))) (#1=#:G229 NIL) (|lst| NIL)
          (#2=#:G228 NIL))
         (SEQ
          (LETT |stSol|
                (|UTSODE;iMpsode| |cs|
...
(DEFUN |UnivariateTaylorSeriesODESolver| (&REST #1=#:G230)
  (SPROG NIL
         (PROG (#2=#:G231)
           (RETURN
            (COND
