...
(SDEFUN |UTSODE;odeNre|
        ((|f| |Mapping| (|Stream| |Coef|) (|List| (|Stream| |Coef|)))
         ...
         ($ |List| (|Stream| |Coef|)))
        (SPROG
         ((|yil| (|List| (|Stream| |Coef|))) (#1=#:G203 NIL) (|c| NIL)
          (#2=#:G204 NIL) (|y| NIL) (#3=#:G202 NIL))
         (SEQ
          (LETT |yil|
                (PROGN
...
(SDEFUN |UTSODE;simulre|
        ...
        (SPROG
         ((#1=#:G224 NIL) (|csti| NIL) (#2=#:G225 NIL) (|lsfi| NIL)
          (#3=#:G223 NIL))
         (SEQ
          (PROGN
...
(SDEFUN |UTSODE;mpsode;LLL;19|
        ((|cs| |List| |Coef|) (|lsts| |List| (|Mapping| UTS (|List| UTS)))
         ($ |List| UTS))
        (SPROG
         ((|stSol| (|List| (|Stream| |Coef|))) (#1=#:G236 NIL) (|lst| NIL)
          (#2=#:G235 NIL))
         (SEQ
          (LETT |stSol|
                (|UTSODE;iMpsode| |cs|
...
(DEFUN |UnivariateTaylorSeriesODESolver| (&REST #1=#:G237)
  (SPROG NIL
         (PROG (#2=#:G238)
           (RETURN
            (COND
