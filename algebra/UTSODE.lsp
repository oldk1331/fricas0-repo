...
(SDEFUN |UTSODE;odeNre|
        ((|f| |Mapping| (|Stream| |Coef|) (|List| (|Stream| |Coef|)))
         ...
         ($ |List| (|Stream| |Coef|)))
        (SPROG
         ((|yil| (|List| (|Stream| |Coef|))) (#1=#:G193 NIL) (|c| NIL)
          (#2=#:G194 NIL) (|y| NIL) (#3=#:G192 NIL))
         (SEQ
          (LETT |yil|
                (PROGN
...
(SDEFUN |UTSODE;simulre|
        ...
        (SPROG
         ((#1=#:G214 NIL) (|csti| NIL) (#2=#:G215 NIL) (|lsfi| NIL)
          (#3=#:G213 NIL))
         (SEQ
          (PROGN
...
(SDEFUN |UTSODE;mpsode;LLL;19|
        ((|cs| |List| |Coef|) (|lsts| |List| (|Mapping| UTS (|List| UTS)))
         ($ |List| UTS))
        (SPROG
         ((|stSol| (|List| (|Stream| |Coef|))) (#1=#:G226 NIL) (|lst| NIL)
          (#2=#:G225 NIL))
         (SEQ
          (LETT |stSol|
                (|UTSODE;iMpsode| |cs|
...
(DEFUN |UnivariateTaylorSeriesODESolver| (&REST #1=#:G227)
  (SPROG NIL
         (PROG (#2=#:G228)
           (RETURN
            (COND
