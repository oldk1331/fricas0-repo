...
(SDEFUN |RADIX;wholePart;$I;23| ((|a| $) ($ |Integer|))
        (SPROG ((|n0| (|Integer|)) (#1=#:G184 NIL) (|r| NIL))
...
(SDEFUN |RADIX;fractionPart;$F;24| ((|a| $) ($ |Fraction| (|Integer|)))
        (SPROG
         ((|d| (|Integer|)) (|n| (|Integer|)) (|n1| (|Integer|))
          (#1=#:G191 NIL) (|r| NIL) (|n0| (|Integer|)) (#2=#:G190 NIL))
...
(SDEFUN |RADIX;intgroup| ((|li| |List| (|Integer|)) ($ |OutputForm|))
        (SPROG
         ((#1=#:G219 NIL) (|i| NIL) (#2=#:G218 NIL) (#3=#:G217 NIL)
          (#4=#:G216 NIL) (#5=#:G215 NIL) (#6=#:G214 NIL))
         (SEQ
         ...
         ((|rits|
           (|List|
            #1=(|Record| (|:| |quotient| (|Integer|))
                         (|:| |remainder| (|Integer|)))))
          (|ritscyc| (|List| (|Integer|))) (#2=#:G260 NIL) (|i| (|Integer|))
          (|ritspfx| (|List| (|Integer|))) (#3=#:G259 NIL) (|c| (|Integer|))
          (|cfound| (|Boolean|))
          (|ritsn|
           #4=(|List|
               (|Record| (|:| |quotient| (|Integer|))
          ...
          (|rn|
           (|Record| (|:| |quotient| (|Integer|))
                     (|:| |remainder| (|Integer|))))
          (#6=#:G257 NIL) (|p| #7=(|Integer|)) (|ritsi| #4#) (#8=#:G256 NIL)
          (|n| #7#) (|qr2i| #1#) (|qrt| #1#) (|qr1i| #1#) (#9=#:G255 NIL)
          (|qr| #1#))
         (SEQ
...
(DEFUN |RadixExpansion;| (|#1|)
  (SPROG ((|pv$| NIL) (#1=#:G287 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
         (PROGN
...
(MAKEPROP '|RadixExpansion| '|infovec|
          (LIST
           ...
           '#(~= 168 |zero?| 174 |wholeRagits| 179 |wholeRadix| 184 |wholePart|
              ...
              |charthRoot| 777 |characteristic| 782 |ceiling| 786 |associator|
              791 |associates?| 798 |antiCommutator| 804 |annihilate?| 810
              |abs| 816 ^ 821 |Zero| 839 |One| 843 D 847 >= 897 > 903 = 909 <=
              915 < 921 / 927 - 939 + 950 * 956)
           'NIL
           (CONS
            (|makeByteWordVec2| 25
             ...
             (CONS
              ...
              (|makeByteWordVec2| 119
                                  '(2 16 0 0 0 18 2 16 0 0 0 21 2 16 0 23 0 24
                                    ...
                                    0 23 43 1 0 65 0 79 1 27 86 0 1 0 0 8 9 1
                                    23 23 0 51 3 0 0 0 0 0 1 2 0 13 0 0 1 2 0 0
                                    0 0 1 2 0 13 0 0 1 1 7 0 0 1 2 0 0 0 23 1 2
                                    0 0 0 8 1 2 0 0 0 117 1 0 0 0 10 0 0 0 12 2
                                    16 0 0 8 1 1 16 0 0 1 3 15 0 0 92 8 1 3 15
                                    0 0 93 97 1 2 15 0 0 92 1 2 15 0 0 93 1 3 0
                                    0 0 107 8 1 2 0 0 0 107 1 2 8 13 0 0 1 2 8
                                    13 0 0 1 2 0 13 0 0 14 2 8 13 0 0 1 2 8 13
                                    0 0 33 2 0 0 23 23 31 2 0 0 0 0 29 1 0 0 0
                                    15 2 0 0 0 0 22 2 0 0 0 0 20 2 0 0 0 23 1 2
                                    0 0 23 0 25 2 0 0 16 0 1 2 0 0 0 16 1 2 0 0
                                    8 0 1 2 0 0 23 0 25 2 0 0 0 0 27 2 0 0 117
                                    0 1)))))
           '|lookupComplete|)) 
