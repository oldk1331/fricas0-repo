...
(DEFUN |EXPR;poly_to_MP| (|p| $)
  (PROG (|vl2| #1=#:G197 |z| #2=#:G196 |vl1| |ps|)
    (RETURN
...
(DEFUN |EXPR;algreduc| (|x| |ckl| $)
  (PROG (|x1| |q| #1=#:G265 |k| |sas| #2=#:G264 |r| |akl|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |EXPR;k2an| (|k| $)
  (PROG (|arg| #1=#:G471 |a| #2=#:G472 |x| |eq| |eqa| |ccu| |cc| |a1| |s1|
...
(DEFUN |EXPR;eval;$LLS$;169| (|f| |ls| |lg| |x| $)
  (PROG (|res| #1=#:G517 |g| #2=#:G516 |nlg| #3=#:G515 #4=#:G514
         |lbackwardSubs| #5=#:G512 |i| #6=#:G513 |j| #7=#:G511 |lforwardSubs|
         #8=#:G509 #9=#:G510 #10=#:G508 |ns| #11=#:G507 #12=#:G506 #13=#:G505
         #14=#:G504 |lsd| |lsym| |llsym| #15=#:G503 #16=#:G502)
    (RETURN
     (SEQ
      (LETT |llsym|
            (PROGN
...
(DEFUN |EXPR;eval;$LL$;203| (|x| |lk| |lv| $)
  (PROG (#1=#:G609 #2=#:G608 #3=#:G610 #4=#:G612 |t|)
    (RETURN
     (SEQ
      (PROGN
...
(DEFUN |EXPR;subst;$LL$;204| (|x| |lk| |lv| $)
  (PROG (#1=#:G615 #2=#:G614 #3=#:G616 #4=#:G618 |t|)
    (RETURN
     (SEQ
      (PROGN
...
(DEFUN |Expression;| (|#1|)
  (PROG (|pv$| #1=#:G689 #2=#:G690 #3=#:G691 #4=#:G692 #5=#:G693 $ |dv$| DV$1)
    (RETURN
     (PROGN
...
(MAKEPROP '|Expression| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) 'SYMBOL 'ALGOP (|Boolean|)
              ...
              (|Union| $ '"failed") (|Factored| $) (|Polynomial| 546)
              (|Fraction| 6) (|Fraction| 124) (|Fraction| 545)
              ...
              (|Union| 559 '#2#) (|Record| (|:| |val| $) (|:| |exponent| 57))
              (|Union| 561 '#2#) (|List| 35) (|Mapping| $ 325) (|List| 564)
           ...
           '#(~= 2359 |zerosOf| 2365 |zeroOf| 2392 |zero?| 2419 |whittakerW|
              ...
              2976 |legendreQ| 2983 |legendreP| 2990 |lcmCoef| 2997 |lcm| 3003
              |latex| 3014 |lambertW| 3019 |kummerU| 3024 |kummerM| 3031
              |kernels| 3038 |kernel| 3043 |kelvinKer| 3055 |kelvinKei| 3061
              |kelvinBer| 3067 |kelvinBei| 3073 |jacobiZeta| 3079 |jacobiTheta|
              3085 |jacobiSn| 3091 |jacobiDn| 3097 |jacobiCn| 3103 |isTimes|
              3109 |isPower| 3114 |isPlus| 3119 |isMult| 3124 |isExpt| 3129
              |is?| 3146 |inv| 3158 |integral| 3163 |hypergeometricF| 3175
              |height| 3182 |hashUpdate!| 3187 |hash| 3193 |hankelH2| 3198
              |hankelH1| 3204 |ground?| 3210 |ground| 3215
              |getSimplifyDenomsFlag| 3220 |gcdPolynomial| 3224 |gcd| 3230
              |fresnelS| 3241 |fresnelC| 3246 |freeOf?| 3251 |factorials| 3263
              |factorial| 3274 |factorPolynomial| 3279 |factor| 3284
              |extendedEuclidean| 3289 |exquo| 3302 |expressIdealMember| 3308
              |exp| 3314 |even?| 3319 |eval| 3324 |euclideanSize| 3485 |erf|
              3490 |elt| 3495 |ellipticPi| 3591 |ellipticK| 3598 |ellipticF|
              3603 |ellipticE| 3609 |divide| 3620 |distribute| 3626 |dilog|
              3637 |digamma| 3642 |differentiate| 3647 |denominator| 3673
              |denom| 3678 |definingPolynomial| 3683 |csch| 3688 |csc| 3693
              |coth| 3698 |cot| 3703 |cosh| 3708 |cos| 3713 |convert| 3718
              |conjugate| 3738 |commutator| 3744 |coerce| 3750 |charthRoot|
              3820 |characteristic| 3825 |box| 3829 |binomial| 3839 |besselY|
              3845 |besselK| 3851 |besselJ| 3857 |besselI| 3863 |belong?| 3869
              |atanh| 3874 |atan| 3879 |associates?| 3884 |asinh| 3890 |asin|
              3895 |asech| 3900 |asec| 3905 |applyQuote| 3910 |angerJ| 3946
              |airyBiPrime| 3952 |airyBi| 3957 |airyAiPrime| 3962 |airyAi| 3967
              |acsch| 3972 |acsc| 3977 |acoth| 3982 |acot| 3987 |acosh| 3992
              |acos| 3997 |abs| 4002 ^ 4007 |Zero| 4037 |Si| 4041 |Shi| 4046
              |One| 4051 |Gamma| 4055 |Ei| 4066 D 4071 |Ci| 4097 |Chi| 4102
              |Beta| 4107 = 4113 / 4119 - 4131 + 4142 * 4148)
           'NIL
           (CONS
            (|makeByteWordVec2| 28
             ...
             (CONS
              ...
              (|makeByteWordVec2| 570
                                  '(1 0 12 0 13 1 16 14 15 17 1 0 18 0 19 1 20
                                    ...
                                    325 0 27 1 1 1 325 0 1 2 1 325 124 27 1 1 1
                                    325 550 1 1 1 325 124 1 2 1 0 0 27 1 1 1 0
                                    0 1 2 1 0 124 27 1 1 1 0 550 1 1 1 0 124 1
                                    1 25 9 0 54 3 1 0 0 0 0 267 3 1 0 0 0 0 265
                                    3 1 0 0 0 0 263 3 1 0 0 0 0 261 3 1 0 0 0 0
                                    259 3 1 0 0 0 0 257 2 1 0 0 0 271 1 0 38 0
                                    473 2 1 547 0 12 1 1 1 551 0 1 1 1 0 0 1 1
                                    1 9 0 1 1 0 74 0 1 1 1 0 0 204 1 1 0 0 180
                                    2 1 0 0 27 342 2 1 0 0 345 346 2 19 543 0 0
                                    1 3 0 0 0 74 325 531 2 0 0 0 488 489 2 0 0
                                    0 567 1 2 1 0 0 0 275 2 1 0 0 0 273 1 30
                                    409 124 412 1 1 0 0 1 1 1 544 0 1 1 1 0 0 1
                                    2 0 9 0 0 95 2 1 9 0 0 1 1 1 0 0 200 1 1 0
                                    0 176 2 1 0 0 57 86 1 1 9 9 134 1 1 0 0 208
                                    1 1 0 0 184 0 29 0 1 2 1 325 0 27 1 1 1 325
                                    0 1 1 1 325 124 1 2 1 325 124 27 1 1 1 325
                                    550 1 2 1 0 0 27 1 1 1 0 0 1 1 1 0 124 1 2
                                    1 0 124 27 167 1 1 0 550 1 1 1 0 0 323 1 15
                                    440 0 441 1 16 71 0 72 1 1 549 0 1 1 14 558
                                    0 1 1 5 566 0 1 1 0 14 0 540 1 0 446 0 447
                                    1 0 18 0 19 1 15 416 0 1 1 16 418 0 425 1 1
                                    107 0 1 1 14 57 0 1 1 5 105 0 1 1 0 6 0 522
                                    1 0 27 0 1 1 0 12 0 13 2 1 0 0 0 1 1 24 541
                                    150 1 2 24 542 150 158 1 1 5 152 150 154 2
                                    5 160 150 158 162 1 1 0 0 111 1 27 543 0 1
                                    2 1 0 0 0 1 2 1 0 0 27 348 2 1 0 0 345 350
                                    1 1 553 325 1 1 1 9 0 1 2 1 0 0 0 255 2 1 0
                                    0 0 235 0 1 0 170 2 1 0 0 0 336 3 12 500 0
                                    497 500 501 3 13 494 0 491 494 495 1 0 0
                                    325 1 1 0 0 0 1 1 0 470 0 1 1 0 10 10 37 1
                                    27 9 0 52 1 31 9 0 1 1 5 0 0 88 1 5 98 0 99
                                    1 1 9 0 73 2 1 0 0 57 1 2 1 534 325 0 1 1
                                    32 124 12 138 5 33 0 325 325 325 325 0 328
                                    2 0 0 481 12 527 1 0 18 0 1 3 1 0 0 0 0 283
                                    3 1 0 0 0 0 281 1 1 0 0 174 1 1 0 0 365 3 1
                                    0 0 0 0 321 3 1 0 0 0 0 291 3 1 0 0 0 0 289
                                    2 1 552 0 0 1 1 1 0 325 1 2 1 0 0 0 1 1 0
                                    568 0 1 1 1 0 0 253 3 1 0 0 0 0 287 3 1 0 0
                                    0 0 285 1 0 74 0 75 2 0 0 10 325 532 2 0 0
                                    10 0 1 2 1 0 0 0 299 2 1 0 0 0 297 2 1 0 0
                                    0 295 2 1 0 0 0 293 2 1 0 0 0 317 2 1 0 0 0
                                    319 2 1 0 0 0 311 2 1 0 0 0 315 2 1 0 0 0
                                    313 1 27 534 0 1 1 5 562 0 1 1 25 534 0 535
                                    1 25 538 0 539 2 5 560 0 10 1 2 5 560 0 27
                                    ...
                                    0 9 0 70 1 0 6 0 1 0 1 9 133 2 1 124 124
                                    124 405 1 1 0 325 1 2 1 0 0 0 1 1 1 0 0 369
                                    1 1 0 0 371 2 0 9 0 27 1 2 0 9 0 0 1 2 1 0
                                    0 27 340 1 1 0 0 338 1 1 0 0 332 1 30 409
                                    124 410 1 1 544 0 1 3 1 556 0 0 0 1 2 1 557
                                    0 0 1 2 1 543 0 0 1 2 1 534 325 0 1 1 1 0 0
                                    172 1 31 9 0 1 2 9 0 0 38 1 2 9 0 0 27 1 1
                                    9 0 0 1 4 9 0 0 470 325 27 471 4 9 0 0 10 0
                                    27 472 4 5 0 0 38 563 565 1 4 5 0 0 38 563
                                    482 1 4 5 0 0 27 35 564 1 4 5 0 0 27 35 481
                                    ...
                                    0 1 1 1 0 0 367 1 1 0 0 233 3 5 0 0 38 563
                                    ...
                                    548 1 1 1 0 107 110 1 1 0 0 1 1 5 0 98 104
                                    1 5 0 105 106 1 0 0 6 442 1 0 0 27 485 1 0
                                    0 12 142 1 0 523 0 525 1 3 543 0 1 0 5 35 1
