...
(SDEFUN |EXPR;reduc| ((|x| ($)) (|l| (|List| (|Kernel| $))) ($ ($)))
        (SPROG
         ((|p| (|SparseUnivariatePolynomial| $)) (#1=#:G397 NIL) (|k| NIL))
         (SEQ
...
(SDEFUN |EXPR;algpars| ((|lk| (|List| (|Kernel| $))) ($ (|List| (|Kernel| $))))
        (SPROG
         ((|res| (|List| (|Kernel| $))) (|arg| (|List| $)) (#1=#:G420 NIL)
          (|k| NIL))
         (SEQ (LETT |res| NIL)
        ...
        ((|k| (|Kernel| $))
         ($
          (|SparseUnivariatePolynomial|
           (|SparseMultivariatePolynomial| R (|Kernel| $)))))
        (SPROG
         ((|n| (|NonNegativeInteger|)) (#1=#:G431 NIL)
...
(SDEFUN |EXPR;varmap1|
        ...
        (SPROG
         ((#1=#:G440 NIL) (#2=#:G441 NIL) (|k| NIL) (#3=#:G442 NIL) (|s| NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |EXPR;varmap2|
        ...
        (SPROG
         ((#1=#:G447 NIL) (#2=#:G448 NIL) (|k| NIL) (#3=#:G449 NIL) (|s| NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ (LETT |s| NIL) (LETT #3# |ls|) (LETT |k| NIL) (LETT #2# |lk|)
                 ...
                 (SEQ
                  (EXIT
                   (COND
                    ((EQUAL |s| |s0|) (PROGN (LETT #1# |k|) (GO #4=#:G446))))))
                 (LETT #2# (PROG1 (CDR #2#) (LETT #3# (CDR #3#)))) (GO G190)
                 G191 (EXIT NIL))
...
(SDEFUN |EXPR;gcdPolynomial;3Sup;178|
        ...
        (SPROG
         ((|g2| (|Polynomial| (|Integer|)))
           ...
           (|List|
            (|Record| (|:| |var| (|Symbol|))
                      (|:| |coef|
                           (|SparseUnivariatePolynomial|
                            (|Fraction| (|Polynomial| (|Integer|))))))))
          (#2=#:G504 NIL) (|m| NIL) (#3=#:G505 NIL) (|k| NIL) (#4=#:G503 NIL)
          (|q2|
           #5=(|Record| (|:| |var| (|Symbol|))
                        (|:| |coef|
                             (|SparseUnivariatePolynomial|
          ...
          (#6=#:G502 NIL) (#7=#:G501 NIL)
          (|lm1| (|List| (|Polynomial| (|Integer|)))) (#8=#:G499 NIL)
          (#9=#:G500 NIL) (#10=#:G498 NIL)
          (|q1| #11=(|Polynomial| (|Integer|))) (|p1| #11#) (#12=#:G497 NIL)
          (#13=#:G496 NIL)
          (|lm|
           (|List|
            (|SparseUnivariatePolynomial|
             (|SparseMultivariatePolynomial| R (|Kernel| $)))))
          (#14=#:G495 NIL) (#15=#:G494 NIL) (|all_syms| (|List| (|Symbol|)))
          (|all_kers| (|List| (|Kernel| $))) (|xk| (|Kernel| $))
          (|x| #16=(|Symbol|)) (|all_syms0| (|List| #16#)) (#17=#:G493 NIL)
          (#18=#:G492 NIL) (|akers| (|List| (|Kernel| $)))
...
(SDEFUN |EXPR;retractIfCan;$U;190|
        ...
        (SPROG
         ((#1=#:G534 NIL) (|d| #2=(|Union| (|AlgebraicNumber|) "failed"))
          (|n| #2#))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |EXPR;k2an|
        ...
        (SPROG
         ((|arg| (|List| (|AlgebraicNumber|))) (#1=#:G568 NIL)
          (|a| #2=(|Union| (|AlgebraicNumber|) #3="failed")) (#4=#:G569 NIL)
          (|x| NIL)
          (|eq|
           (|SparseUnivariatePolynomial|
            (|SparseMultivariatePolynomial| R (|Kernel| $))))
        ...
        (SPROG
         ((|c| (|Union| (|AlgebraicNumber|) #1#))
          (|up|
           (|SparseUnivariatePolynomial|
            (|SparseMultivariatePolynomial| R (|Kernel| $))))
          (|ans| (|AlgebraicNumber|)) (#2=#:G585 NIL)
...
(SDEFUN |EXPR;eval;$LLS$;196|
        ((|f| ($)) (|ls| (|List| (|BasicOperator|))) (|lg| (|List| $))
         (|x| (|Symbol|)) ($ ($)))
        (SPROG
         ((|res| ($)) (#1=#:G623 NIL) (|g| NIL) (#2=#:G622 NIL)
          (|nlg| (|List| $)) (#3=#:G621 NIL) (#4=#:G620 NIL)
          (|lbackwardSubs| (|List| (|Equation| $))) (#5=#:G618 NIL) (|i| NIL)
          (#6=#:G619 NIL) (|j| NIL) (#7=#:G617 NIL)
          (|lforwardSubs| (|List| (|Equation| $))) (#8=#:G615 NIL)
          (#9=#:G616 NIL) (#10=#:G614 NIL) (|ns| (|List| (|Symbol|)))
          (#11=#:G613 NIL) (#12=#:G612 NIL) (#13=#:G611 NIL) (#14=#:G610 NIL)
          (|lsd| (|List| (|Symbol|))) (|lsym| (|List| (|Symbol|)))
          (|llsym| (|List| (|List| (|Symbol|)))) (#15=#:G609 NIL)
          (#16=#:G608 NIL))
         (SEQ
          (LETT |llsym|
                (PROGN
...
(SDEFUN |EXPR;kernels;$L;222| ((|x| ($)) ($ (|List| (|Kernel| $))))
        (SPROG ((#1=#:G661 NIL) (|f| NIL) (#2=#:G660 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |EXPR;subeval!0| ((|x| NIL) ($$ NIL))
        (PROG ($ |lk| |lv|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G694 NIL) (|a| NIL) (#2=#:G693 NIL))
                   (SEQ
...
(SDEFUN |EXPR;subst;$LL$;231|
        ((|x| ($)) (|lk| (|List| (|Kernel| . #1=($)))) (|lv| (|List| . #1#))
         ($ ($)))
        (SPROG
         ((#2=#:G732 NIL) (#3=#:G731 ($)) (#4=#:G733 ($)) (#5=#:G735 NIL)
          (|t| NIL))
         (SEQ
          (PROGN
           (LETT #2# NIL)
...
(SDEFUN |EXPR;subst;$LL$;243!0| ((|x1| NIL) ($$ NIL))
        (PROG ($ |lk| |lv|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G780 NIL) (|a| NIL) (#2=#:G779 NIL))
                   (SEQ
...
(DEFUN |Expression;| (|#1|)
  (SPROG
   ((#1=#:G826 NIL) (|pv$| NIL) (#2=#:G821 NIL) (#3=#:G822 NIL) (#4=#:G823 NIL)
    (#5=#:G824 NIL) (#6=#:G825 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
