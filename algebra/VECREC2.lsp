...
(DEFUN |VECREC2;chinese_update;UvI$V;3| (|vec| |p| |statearg| $)
  (PROG (|nmp| |cor| |ii| #1=#:G165 |i| |mpfact| |nbmp| |mpcor| |mpval| |bmp|
         |bintvec| #2=#:G164 #3=#:G150 #4=#:G163 |intvec| |mp| |state|)
    (RETURN
...
(DEFUN |VECREC2;rational_reconstruction2| (|statearg| |block_offsets| $)
  (PROG (#1=#:G223 |cden| |ppr| |pp| |r1| |co| |cb| |j| #2=#:G209 |ctmp| |jj|
         |dens| |nums| #3=#:G204 #4=#:G202 |mm| |n| |ok| |bound2| |bound| |j0|
...
(DEFUN |VECREC2;remove_denoms;V3Pa;10| (|block_offsets| |nums| |dens| $)
  (PROG (#1=#:G237 |i| |cfactor| |tmpp2| |cden| |hi| |li| |ib| |res| |np| |nb|)
    (RETURN
     (SEQ
