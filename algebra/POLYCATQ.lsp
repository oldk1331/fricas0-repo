...
(SDEFUN |POLYCATQ;univ_root|
        ...
        (SPROG
         ((|nd| (F)) (|cofact| (|SparseUnivariatePolynomial| F))
          (|cf2| #1=(|SparseUnivariatePolynomial| F)) (#2=#:G133 NIL)
...
(DEFUN |PolynomialCategoryQuotientFunctions| (&REST #1=#:G224)
  (SPROG NIL
         (PROG (#2=#:G225)
           (RETURN
            (COND
