...
(SDEFUN |INTPAF;split_power|
        ...
        (SPROG
         ((|p_fac| #1=(|SparseUnivariatePolynomial| F))
          ...
          (|e1| #5=(|NonNegativeInteger|)) (#6=#:G220 NIL) (|fac| NIL)
          (|facl|
           (|List|
...
(SDEFUN |INTPAF;linearInXIfCan|
        ...
        (SPROG
         ((|xx| (|Fraction| (|SparseUnivariatePolynomial| F)))
          ...
          (|d| #2=(|NonNegativeInteger|)) (#3=#:G250 NIL)
          ...
          (|#G27|
           #5=(|Record| (|:| |pfac| (|SparseUnivariatePolynomial| F))
                        (|:| |cofactor| (|SparseUnivariatePolynomial| F))))
          (|c0| #4#) (#6=#:G251 NIL) (|#G25| #5#) (|deg_p| #2#) (|lc| #4#))
         (SEQ
          (EXIT
           (SEQ
            (LETT |p|
               ...
               (EXIT
                (COND
                 ((> (SPADCALL |cofac| (QREFELT $ 61)) 1)
                  (PROGN (LETT #3# (CONS 1 "failed")) (GO #7=#:G249)))
                 (#8='T
                  (SEQ
                   (LETT |p|
...
(SDEFUN |INTPAF;candidates|
        ...
        (SPROG
         ((|l|
          ...
          (|xi| (|SparseUnivariatePolynomial| F)) (#1=#:G307 NIL) (|i| NIL))
         (SEQ (LETT |l| NIL)
              (EXIT
                ...
                (SEQ G190
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |v| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G334)))
                        ('T
                         (SEQ
                          (LETT |ans|
                                (SPADCALL |ans|
...
(SDEFUN |INTPAF;algaddx|
        ((|i| (|IntegrationResult| F)) (|dxx| (F)) (|xx| (F))
         ($ (|IntegrationResult| F)))
        (SPROG ((#1=#:G342 NIL) (|ne| NIL) (#2=#:G341 NIL))
               (SEQ
          ...
          (|curve|
           (|FunctionFieldCategory| F (|SparseUnivariatePolynomial| F)
                                    (|SparseUnivariatePolynomial|
                                     (|Fraction|
                                      (|SparseUnivariatePolynomial| F)))))
          (#5=#:G367 NIL) (|c1| (F)) (|u| #1#) (#6=#:G355 NIL)
          (|ug|
           #7=(|Union|
               (|SparseUnivariatePolynomial|
                (|Fraction| (|SparseUnivariatePolynomial| F)))
...
(SDEFUN |INTPAF;param_LODE;2L2KR;19|
        ...
        (SPROG
         ((|part1|
          ...
          (#1=#:G396 NIL) (|be| NIL) (#2=#:G395 NIL) (|bas1| (|List| F))
          (#3=#:G394 NIL) (|h| NIL) (#4=#:G393 NIL)
          (|rec|
           (|Record|
            (|:| |particular|
                 (|List|
                  (|Record| (|:| |ratpart| |curve|)
                            (|:| |coeffs| (|Vector| F)))))
            (|:| |basis| (|List| |curve|))))
          (#5=#:G392 NIL) (|g| NIL) (#6=#:G391 NIL)
          (|neq| (|LinearOrdinaryDifferentialOperator1| |curve|))
          (#7=#:G390 NIL) (|f| NIL) (|i| NIL)
          (|curve|
           (|Join|
            (|FunctionFieldCategory| F (|SparseUnivariatePolynomial| F)
                                     (|SparseUnivariatePolynomial|
        ...
        ((|eq| (|List| F)) (|g| (F)) (|kx| (|Kernel| F)) (|y| (|Kernel| F))
         ...
         ($
          (|Record| (|:| |particular| (|Union| F "failed"))
                    (|:| |basis| (|List| F)))))
        (SPROG
         ((#1=#:G421 NIL) (|h| NIL) (#2=#:G420 NIL)
          (|rec|
           (|Record| (|:| |particular| (|Union| |curve| #3="failed"))
                     (|:| |basis| (|List| |curve|))))
          (#4=#:G407 NIL) (|bas| (|List| F)) (#5=#:G419 NIL) (#6=#:G418 NIL)
          (|neq| (|LinearOrdinaryDifferentialOperator1| |curve|))
          (#7=#:G417 NIL) (|f| NIL) (|i| NIL)
          (|curve|
           (|Join|
            (|FunctionFieldCategory| F (|SparseUnivariatePolynomial| F)
                                     (|SparseUnivariatePolynomial|
...
(DEFUN |PureAlgebraicIntegration| (&REST #1=#:G488)
  (SPROG NIL
         (PROG (#2=#:G489)
           (RETURN
            (COND
