...
(SDEFUN |INTPAF;split_power|
        ...
        (SPROG
         ((|p_fac| #1=(|SparseUnivariatePolynomial| F))
          ...
          (|e1| #5=(|NonNegativeInteger|)) (#6=#:G221 NIL) (|fac| NIL)
          (|facl|
           (|List|
...
(SDEFUN |INTPAF;linearInXIfCan|
        ...
        (SPROG
         ((|xx| (|Fraction| (|SparseUnivariatePolynomial| F)))
          ...
          (|d| #2=(|NonNegativeInteger|)) (#3=#:G254 NIL)
          ...
          (|#G27|
           #5=(|Record| (|:| |pfac| (|SparseUnivariatePolynomial| F))
                        (|:| |cofactor| (|SparseUnivariatePolynomial| F))))
          (|c0| #4#) (#6=#:G255 NIL) (|#G25| #5#) (|deg_p| #2#) (|lc| #4#))
         (SEQ
          (EXIT
           (SEQ
            (LETT |p|
               ...
               (EXIT
                (COND
                 ((> (SPADCALL |cofac| (QREFELT $ 61)) 1)
                  (PROGN (LETT #3# (CONS 1 "failed")) (GO #7=#:G253)))
                 (#8='T
                  (SEQ
                   (LETT |p|
...
(SDEFUN |INTPAF;candidates|
        ...
        (SPROG
         ((|l|
          ...
          (|xi| (|SparseUnivariatePolynomial| F)) (#1=#:G316 NIL) (|i| NIL))
         (SEQ (LETT |l| NIL)
              (EXIT
                ...
                (SEQ G190
                     ...
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |v| 1)
                         (PROGN (LETT #1# (CONS 1 "failed")) (GO #2=#:G345)))
                        ('T
                         (SEQ
                          (LETT |ans|
                                (SPADCALL |ans|
...
(SDEFUN |INTPAF;algaddx|
        ((|i| (|IntegrationResult| F)) (|dxx| (F)) (|xx| (F))
         ($ (|IntegrationResult| F)))
        (SPROG ((#1=#:G354 NIL) (|ne| NIL) (#2=#:G353 NIL))
               (SEQ
          ...
          (|curve|
           (|FunctionFieldCategory| F (|SparseUnivariatePolynomial| F)
                                    (|SparseUnivariatePolynomial|
                                     (|Fraction|
                                      (|SparseUnivariatePolynomial| F)))))
          (#5=#:G379 NIL) (|c1| (F)) (|u| #1#) (#6=#:G367 NIL)
          (|ug|
           #7=(|Union|
               (|SparseUnivariatePolynomial|
                (|Fraction| (|SparseUnivariatePolynomial| F)))
...
(SDEFUN |INTPAF;param_LODE;2L2KR;20|
        ...
        (SPROG
         ((|part1|
          ...
          (#1=#:G414 NIL) (|be| NIL) (#2=#:G413 NIL) (|bas1| (|List| F))
          (#3=#:G412 NIL) (|h| NIL) (#4=#:G411 NIL)
          (|rec|
           (|Record|
            (|:| |particular|
                 (|List|
                  (|Record| (|:| |ratpart| |curve|)
                            (|:| |coeffs| (|Vector| F)))))
            (|:| |basis| (|List| |curve|))))
          (#5=#:G410 NIL) (|g| NIL) (#6=#:G409 NIL)
          (|neq| (|LinearOrdinaryDifferentialOperator1| |curve|))
          (#7=#:G408 NIL) (|f| NIL) (|i| NIL)
          (|curve|
           (|Join|
            (|FunctionFieldCategory| F (|SparseUnivariatePolynomial| F)
                                     (|SparseUnivariatePolynomial|
        ...
        ((|eq| (|List| F)) (|g| (F)) (|kx| (|Kernel| F)) (|y| (|Kernel| F))
         ...
         ($
          (|Record| (|:| |particular| (|Union| F "failed"))
                    (|:| |basis| (|List| F)))))
        (SPROG
         ((#1=#:G442 NIL) (|h| NIL) (#2=#:G441 NIL)
          (|rec|
           (|Record| (|:| |particular| (|Union| |curve| #3="failed"))
                     (|:| |basis| (|List| |curve|))))
          (#4=#:G427 NIL) (|bas| (|List| F)) (#5=#:G440 NIL) (#6=#:G439 NIL)
          (|neq| (|LinearOrdinaryDifferentialOperator1| |curve|))
          (#7=#:G438 NIL) (|f| NIL) (|i| NIL)
          (|curve|
           (|Join|
            (|FunctionFieldCategory| F (|SparseUnivariatePolynomial| F)
                                     (|SparseUnivariatePolynomial|
...
(DEFUN |PureAlgebraicIntegration| (&REST #1=#:G508)
  (SPROG NIL
         (PROG (#2=#:G509)
           (RETURN
            (COND
