...
(SDEFUN |FMOEBF;moebiusFunction;L$;4| ((|xx| (|List| P)) ($ ($)))
        (SPROG
         ((|mf| (|Matrix| (|Integer|))) (|zf| (|Matrix| (|Integer|)))
          (#1=#:G124 NIL) (|y| NIL) (#2=#:G123 NIL) (#3=#:G122 NIL) (|x| NIL)
          (#4=#:G121 NIL) (|xxo| (|List| P)))
         (SEQ
          (LETT |xxo|
...
(DEFUN |FiniteMoebiusFunction| (#1=#:G144)
  (SPROG NIL
         (PROG (#2=#:G145)
           (RETURN
            (COND
