...
(SDEFUN |ALGMANIP;innerRF| ((|x| F) (|ll| |List| (|Kernel| F)) ($ F))
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| F)) (#1=#:G181 NIL) (|kk| NIL)
          (#2=#:G180 NIL) (#3=#:G176 NIL) (#4=#:G177 NIL) (#5=#:G179 NIL)
          (#6=#:G178 NIL) (|l| (|List| (|Kernel| F)))
...
(SDEFUN |ALGMANIP;fp_root|
        ...
        (SPROG
         ((|res| (F)) (|rr| (F)) (|ce| (|NonNegativeInteger|))
          (|ne| (|NonNegativeInteger|)) (#1=#:G187 NIL) (#2=#:G185 NIL)
          (|nn| (|Integer|)) (|ng| (|NonNegativeInteger|)) (#3=#:G192 NIL)
          (|fr| NIL) (|u| (|SparseMultivariatePolynomial| R (|Kernel| F))))
         (SEQ (LETT |res| (|spadConstant| $ 68) . #4=(|ALGMANIP;fp_root|))
              (COND
               ((SPADCALL (LETT |u| (SPADCALL |fp| (QREFELT $ 70)) . #4#)
                ...
                (LETT |res|
                      ...
                      . #4#)))
              (SEQ (LETT |fr| NIL . #4#)
                   (LETT #3# (SPADCALL |fp| (QREFELT $ 81)) . #4#) G190
                   (COND
                    ((OR (ATOM #3#) (PROGN (LETT |fr| (CAR #3#) . #4#) NIL))
                     (GO G191)))
                   (SEQ (LETT |ne| (REM (QVELT |fr| 2) |n|) . #4#)
                        (LETT |ng| (GCD |ne| |n|) . #4#)
                        (LETT |nn|
                              (PROG2
                        ...
                        (LETT |ne|
                              (PROG1
                                ...
                                (|check_subtype2| (>= #1# 0)
                                                  ...
                                                  '(|Integer|) #1#))
                              . #4#)
                        (LETT |ce| (QUOTIENT2 (QVELT |fr| 2) |n|) . #4#)
                        (LETT |rr|
                              (COND
...
(SDEFUN |ALGMANIP;pol_root|
        ...
        (SPROG
         ((|pp| (|SparseMultivariatePolynomial| R (|Kernel| F)))
          (#1=#:G194 NIL) (|cp| (R)))
         (SEQ
          (LETT |cp| (SPADCALL |p| (QREFELT $ 88)) . #2=(|ALGMANIP;pol_root|))
...
(SDEFUN |ALGMANIP;root_factor_k| ((|k| |Kernel| F) ($ F))
        (SPROG
         ((|op| (|BasicOperator|)) (|n| (|NonNegativeInteger|)) (#1=#:G198 NIL)
          (|nf| (F)) (|x| (F)))
         (SEQ
          (LETT |x| (|SPADfirst| (SPADCALL |k| (QREFELT $ 48)))
          ...
          (LETT |nf| (SPADCALL (SPADCALL |k| (QREFELT $ 48)) (QREFELT $ 49))
                . #2#)
          (LETT |n|
                (PROG1 (LETT #1# (SPADCALL |nf| (QREFELT $ 99)) . #2#)
...
(SDEFUN |ALGMANIP;breakup|
        ...
        (SPROG
         ((|ll|
          ...
          (|same| #1#) (|arg| (|List| F)) (#2=#:G219 NIL) (|kk| NIL)
...
(SDEFUN |ALGMANIP;rootProduct;2F;18| ((|x| F) ($ F))
        (SPROG
         ((|lv| (|List| F)) (#1=#:G222 NIL) (#2=#:G231 NIL) (|m| NIL)
          (#3=#:G230 NIL) (|k| (|Kernel| F)) (|n| (|Integer|))
          (|k0| (|Kernel| F)) (|l| (|List| (|Kernel| F))) (#4=#:G229 NIL)
          (|rec| NIL))
         (SEQ
               ...
               (SEQ
                ...
                (EXIT
                 (COND
                  ((NULL (NULL (CDR |l|)))
                   (SEQ
                    (LETT |n| (SPADCALL (QCDR |rec|) (QREFELT $ 106)) . #5#)
                    (LETT |k|
...
(SDEFUN |ALGMANIP;radeval|
        ...
        (SPROG
         ((|q|
          ...
          (#1=#:G248 NIL) (|a| (F)) (|arg| (|List| F)) (|ka| (|Kernel| F))
          (|ka1| (|Union| (|Kernel| F) "failed")) (#2=#:G244 NIL))
         (SEQ
          (LETT |a|
                (|SPADfirst|
          ...
          (LETT |n|
                (PROG1
                  ...
                  (|check_subtype2| (>= #2# 0) '(|NonNegativeInteger|)
                                    '(|Integer|) #2#))
                . #3#)
          (LETT |ans| (|spadConstant| $ 115) . #3#)
          (LETT |q| (SPADCALL |p| |k| (QREFELT $ 116)) . #3#)
          (LETT |ka1| (SPADCALL |a| (QREFELT $ 118)) . #3#)
          (COND
           ((QEQCAR |ka1| 0)
            (COND
             ((SPADCALL (QCDR |ka1|) '|nthRoot| (QREFELT $ 119))
              (SEQ (LETT |ka| (QCDR |ka1|) . #3#)
                   (LETT |arg| (SPADCALL |ka| (QREFELT $ 48)) . #3#)
                   (LETT |a| (|SPADfirst| |arg|) . #3#)
                   (LETT |n|
                         (* |n|
                            (PROG1
                                (LETT #1#
          ...
          (SEQ G190
               (COND
                ((NULL
                  (SPADCALL (LETT |d| (SPADCALL |q| (QREFELT $ 121)) . #3#) 0
                            (QREFELT $ 122)))
                 (GO G191)))
               (SEQ
                (LETT |term|
                      (SEQ (LETT |g| (GCD |d| |n|) . #3#)
                           (EXIT
                            (COND
                             ((EQL |g| |n|)
                ...
                (LETT |ans|
                      (SPADCALL |ans|
                                ...
                                (QREFELT $ 125))
                      . #3#)
                (EXIT (LETT |q| (SPADCALL |q| (QREFELT $ 126)) . #3#)))
               NIL (GO G190) G191 (EXIT NIL))
          (EXIT
                         ...
                         ((OR
                          ...
                          (PROGN
                           (LETT #2#
                                 ...
                                 . #4#)
                           (GO #5=#:G286))))))))
                    (LETT |u| (SPADCALL |x| |op| (QREFELT $ 134)) . #4#)
                    (EXIT
                     (COND
                      ((QEQCAR |u| 1)
...
(SDEFUN |ALGMANIP;rootSimp;2F;24| ((|x| F) ($ F))
        (SPROG
         ((|nlk| (|List| F)) (|lk| (|List| (|Kernel| F))) (|nk| (F))
          (#1=#:G297 NIL) (|k| NIL) (|tk| (|List| (|Kernel| F))))
         (SEQ
...
(DEFUN |AlgebraicManipulations| (&REST #1=#:G298)
  (SPROG NIL
         (PROG (#2=#:G299)
           (RETURN
            (COND
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 144
                                                 '(0 9 0 10 1 11 0 9 12 1 7 14
                                                   ...
                                                   45 77 1 69 80 0 81 2 83 82 0
                                                   0 84 2 75 26 0 0 85 2 32 0 0
                                                   83 86 2 7 0 0 0 87 1 32 6 0
                                                   88 1 7 0 6 89 1 32 0 6 90 2
                                                   32 82 0 0 91 1 67 69 32 92 1
                                                   6 93 0 94 2 97 69 95 96 98 1
                                                   7 75 0 99 1 0 7 7 100 1 7
                                                   101 0 102 2 6 0 0 75 103 3 0
                                                   7 24 7 83 104 2 7 26 0 0 105
                                                   1 75 0 45 106 1 11 83 0 107
                                                   3 11 0 24 19 83 108 1 7 0 22
                                                   109 2 7 0 0 83 110 1 0 7 7
                                                   111 1 0 7 7 112 2 19 0 64 0
                                                   113 2 7 0 24 45 114 0 7 0
                                                   115 2 32 61 0 11 116 1 7 117
                                                   0 118 2 11 26 0 9 119 1 120
                                                   83 0 121 2 83 26 0 0 122 3
                                                   32 0 0 11 83 123 1 120 32 0
                                                   124 2 7 0 0 0 125 1 120 0 0
                                                   126 1 7 0 0 127 2 7 26 0 0
                                                   128 2 32 26 0 0 129 2 32 0 0
                                                   0 130 1 32 0 0 131 2 7 133 0
                                                   24 134 2 75 0 83 0 135 2 136
                                                   0 75 75 137 1 136 75 0 138 1
                                                   136 75 0 139 2 7 0 0 75 140
                                                   2 142 141 7 83 143 1 0 7 7
                                                   144 1 0 7 7 47 1 1 7 7 144 1
                                                   1 7 7 112 1 1 7 7 111 3 1 7
                                                   24 7 83 104 1 2 7 7 100 1 0
