...
(SDEFUN |ALGMANIP;innerRF| ((|x| (F)) (|ll| (|List| (|Kernel| F))) ($ (F)))
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| F)) (#1=#:G201 NIL) (|kk| NIL)
          (#2=#:G200 NIL) (#3=#:G196 NIL) (#4=#:G197 NIL) (#5=#:G199 NIL)
          (#6=#:G198 NIL) (|l| (|List| (|Kernel| F)))
...
(SDEFUN |ALGMANIP;fp_root|
        ...
        (SPROG
         ((|res| (F)) (|rr| (F)) (|ce| (|NonNegativeInteger|))
          (|ne| (|NonNegativeInteger|)) (#1=#:G208 NIL) (#2=#:G206 NIL)
          (|nn| (|Integer|)) (|ng| (|NonNegativeInteger|)) (#3=#:G213 NIL)
...
(SDEFUN |ALGMANIP;root_factor_k| ((|k| (|Kernel| F)) ($ (F)))
        (SPROG
         ((|op| (|BasicOperator|)) (|n| (|NonNegativeInteger|)) (#1=#:G219 NIL)
          (|nf| (F)) (|x| (F)))
         (SEQ (LETT |x| (|SPADfirst| (SPADCALL |k| (QREFELT $ 48))))
              (LETT |nf|
...
(SDEFUN |ALGMANIP;breakup|
        ...
        (SPROG
         ((|ll|
          ...
          (|same| #1#) (|arg| (|List| F)) (#2=#:G242 NIL) (|kk| NIL)
...
(SDEFUN |ALGMANIP;rootProduct;2F;18| ((|x| (F)) ($ (F)))
        (SPROG
         ((|lv| (|List| F)) (#1=#:G247 NIL) (#2=#:G256 NIL) (|m| NIL)
          (#3=#:G255 NIL) (|k| (|Kernel| F)) (|n| (|Integer|))
          (|k0| (|Kernel| F)) (|l| (|List| (|Kernel| F))) (#4=#:G254 NIL)
          (|rec| NIL))
         (SEQ
          (SEQ (LETT |rec| NIL)
               (LETT #4#
...
(SDEFUN |ALGMANIP;radeval|
        ...
        (SPROG
         ((|q|
          ...
          (#1=#:G275 NIL) (|a| (F)) (|arg| (|List| F)) (|ka| (|Kernel| F))
          (|ka1| (|Union| (|Kernel| F) "failed")) (#2=#:G271 NIL))
         (SEQ
