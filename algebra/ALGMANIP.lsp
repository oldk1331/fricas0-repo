...
(SDEFUN |ALGMANIP;innerRF| ((|x| (F)) (|ll| (|List| (|Kernel| F))) ($ (F)))
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| F)) (#1=#:G185 NIL) (|kk| NIL)
          (#2=#:G184 NIL) (#3=#:G180 NIL) (#4=#:G181 NIL) (#5=#:G183 NIL)
          (#6=#:G182 NIL) (|l| (|List| (|Kernel| F)))
...
(SDEFUN |ALGMANIP;fp_root|
        ...
        (SPROG
         ((|res| (F)) (|rr| (F)) (|ce| (|NonNegativeInteger|))
          (|ne| (|NonNegativeInteger|)) (#1=#:G192 NIL) (#2=#:G190 NIL)
          (|nn| (|Integer|)) (|ng| (|NonNegativeInteger|)) (#3=#:G197 NIL)
...
(SDEFUN |ALGMANIP;root_factor_k| ((|k| (|Kernel| F)) ($ (F)))
        (SPROG
         ((|op| (|BasicOperator|)) (|n| (|NonNegativeInteger|)) (#1=#:G203 NIL)
          (|nf| (F)) (|x| (F)))
         (SEQ (LETT |x| (|SPADfirst| (SPADCALL |k| (QREFELT $ 48))))
              (LETT |nf|
...
(SDEFUN |ALGMANIP;breakup|
        ...
        (SPROG
         ((|ll|
          ...
          (|same| #1#) (|arg| (|List| F)) (#2=#:G226 NIL) (|kk| NIL)
...
(SDEFUN |ALGMANIP;rootProduct;2F;18| ((|x| (F)) ($ (F)))
        (SPROG
         ((|lv| (|List| F)) (#1=#:G231 NIL) (#2=#:G240 NIL) (|m| NIL)
          (#3=#:G239 NIL) (|k| (|Kernel| F)) (|n| (|Integer|))
          (|k0| (|Kernel| F)) (|l| (|List| (|Kernel| F))) (#4=#:G238 NIL)
          (|rec| NIL))
         (SEQ
          (SEQ (LETT |rec| NIL)
               (LETT #4#
...
(SDEFUN |ALGMANIP;radeval|
        ...
        (SPROG
         ((|q|
          ...
          (#1=#:G259 NIL) (|a| (F)) (|arg| (|List| F)) (|ka| (|Kernel| F))
          (|ka1| (|Union| (|Kernel| F) "failed")) (#2=#:G255 NIL))
         (SEQ
...
(SDEFUN |ALGMANIP;rootSimp;2F;24| ((|x| (F)) ($ (F)))
        (SPROG
         ((|nlk| (|List| F)) (|lk| (|List| (|Kernel| F))) (|nk| (F))
          (#1=#:G310 NIL) (|k| NIL) (|tk| (|List| (|Kernel| F))))
         (SEQ
...
(DEFUN |AlgebraicManipulations| (&REST #1=#:G311)
  (SPROG NIL
         (PROG (#2=#:G312)
           (RETURN
            (COND
