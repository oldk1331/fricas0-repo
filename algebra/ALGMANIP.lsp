...
(SDEFUN |ALGMANIP;ratDenom;FLF;4| ((|x| F) (|l| |List| F) ($ F))
        (SPROG ((#1=#:G121 NIL) (|y| NIL) (#2=#:G120 NIL))
               (SEQ
                (SPADCALL |x|
                          (PROGN
...
(SDEFUN |ALGMANIP;innerRF| ((|x| F) (|ll| |List| (|Kernel| F)) ($ F))
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| F)) (#1=#:G180 NIL) (|kk| NIL)
          (#2=#:G179 NIL) (#3=#:G175 NIL) (#4=#:G176 NIL) (#5=#:G178 NIL)
          (#6=#:G177 NIL) (|l| (|List| (|Kernel| F)))
...
(SDEFUN |ALGMANIP;fp_root|
        ...
        (SPROG
         ((|res| (F)) (|rr| (F)) (|ce| (|NonNegativeInteger|)) (#1=#:G188 NIL)
          (|ne| (|NonNegativeInteger|)) (#2=#:G187 NIL) (#3=#:G185 NIL)
          (|nn| (|Integer|)) (|ng| (|NonNegativeInteger|)) (#4=#:G183 NIL)
          (#5=#:G193 NIL) (|fr| NIL)
...
(SDEFUN |ALGMANIP;root_factor_k| ((|k| |Kernel| F) ($ F))
        (SPROG
         ((|op| (|BasicOperator|)) (|n| (|NonNegativeInteger|)) (#1=#:G199 NIL)
          (|nf| (F)) (|x| (F)))
         (SEQ
          (LETT |x| (|SPADfirst| (SPADCALL |k| (QREFELT $ 47)))
...
(SDEFUN |ALGMANIP;breakup|
        ...
        (SPROG
         ((|ll|
          ...
          (|same| #1#) (|arg| (|List| F)) (#2=#:G220 NIL) (|kk| NIL)
...
(SDEFUN |ALGMANIP;rootProduct;2F;18| ((|x| F) ($ F))
        (SPROG
         ((|lv| (|List| F)) (#1=#:G223 NIL) (#2=#:G232 NIL) (|m| NIL)
          (#3=#:G231 NIL) (|k| (|Kernel| F)) (|n| (|Integer|))
          (|k0| (|Kernel| F)) (|l| (|List| (|Kernel| F))) (#4=#:G230 NIL)
          (|rec| NIL))
         (SEQ
                  ...
                  ((NULL (NULL (CDR |l|)))
                   (SEQ
                    ...
                    (LETT |lv|
                          ...
                          . #5#)
                    (EXIT
                     (LETT |x| (SPADCALL |x| |l| |lv| (QREFELT $ 45))
                           . #5#)))))))
...
(SDEFUN |ALGMANIP;rootPower1|
        ...
        (SPROG ((#1=#:G237 NIL) (|k| NIL))
               (SEQ
                (LETT |x| (SPADCALL |x| |lk| |nlk| (QREFELT $ 45))
                       ...
                       (COND
                        ((SPADCALL (SPADCALL |k| (QREFELT $ 25)) '|nthRoot|
                         ...
                         (LETT |x|
                               (SPADCALL
                                (|ALGMANIP;radeval|
                                 (SPADCALL |x| (QREFELT $ 49)) |k| $)
                                (|ALGMANIP;radeval|
                                 (SPADCALL |x| (QREFELT $ 37)) |k| $)
                                (QREFELT $ 51))
                               . #2#)))))
                    ...
                    (LETT |nargs|
                          (SPADCALL
                           (CONS #'|ALGMANIP;rootPower;2F;20!0|
                                 (VECTOR $ |nlk| |lk|))
                           (SPADCALL |k| (QREFELT $ 47)) (QREFELT $ 111))
                          . #2#)
                    (LETT |nk|
          ...
          (LETT |n|
                (PROG1
                  ...
                  (|check_subtype2| (>= #1# 0) '(|NonNegativeInteger|)
                                    '(|Integer|) #1#))
                . #2#)
          (LETT |ans| (|spadConstant| $ 113) . #2#)
          (LETT |q| (SPADCALL |p| |k| (QREFELT $ 114)) . #2#)
          (SEQ G190
               (COND
                ((NULL
                  (SPADCALL (LETT |d| (SPADCALL |q| (QREFELT $ 116)) . #2#) 0
                            (QREFELT $ 117)))
                 (GO G191)))
               (SEQ
                (LETT |term|
                              ...
                              (SPADCALL
                               (SPADCALL (|spadConstant| $ 71)
                                         (SPADCALL
                                          ...
                                          (QREFELT $ 106))
                                         (QUOTIENT2 |d| |g|) (QREFELT $ 118))
                               (QREFELT $ 73))))))
                      . #2#)
                (LETT |ans|
                      (SPADCALL |ans|
                                (SPADCALL
                                 (SPADCALL (SPADCALL |q| (QREFELT $ 119))
                                           (QREFELT $ 73))
                                 |term| (QREFELT $ 85))
                                (QREFELT $ 120))
                      . #2#)
                (EXIT (LETT |q| (SPADCALL |q| (QREFELT $ 121)) . #2#)))
               NIL (GO G190) G191 (EXIT NIL))
          (EXIT
           (SPADCALL (SPADCALL (SPADCALL |q| (QREFELT $ 119)) (QREFELT $ 73))
                     |ans| (QREFELT $ 120)))))) 
                         ...
                         ((OR
                          ...
                          (PROGN
                           (LETT #2#
                                 ...
                                 . #4#)
                           (GO #5=#:G281))))))))
                    (LETT |u| (SPADCALL |x| |op| (QREFELT $ 129)) . #4#)
                    (EXIT
                     (COND
                      ((QEQCAR |u| 1)
                      ...
                      (#3#
                       (SEQ (LETT |pr| (QCDR |u|) . #4#)
                            (LETT |q|
                                  ...
                                  . #4#)
                            (LETT |qr|
                                  (DIVIDE2 (SPADCALL |q| (QREFELT $ 133))
                                           (SPADCALL |q| (QREFELT $ 134)))
                                  . #4#)
                            (LETT |x|
                                  (|SPADfirst|
                            ...
                            (EXIT
                             (SPADCALL
                              (SPADCALL |x| (QCAR |qr|) (QREFELT $ 135))
                              (SPADCALL
                               (SPADCALL |op| |x|
                                         (PROG1
                                             (LETT #1#
...
(SDEFUN |ALGMANIP;rootSimp;2F;24| ((|x| F) ($ F))
        (SPROG
         ((|nlk| (|List| F)) (|lk| (|List| (|Kernel| F))) (|nk| (F))
          (#1=#:G292 NIL) (|k| NIL) (|tk| (|List| (|Kernel| F))))
         (SEQ
          ...
          (SEQ (LETT |k| NIL . #2#) (LETT #1# |tk| . #2#) G190
               ...
               (SEQ (LETT |nk| (|ALGMANIP;sroot| |k| |lk| |nlk| $) . #2#)
                    ...
                    (EXIT (LETT |nlk| (CONS |nk| |nlk|) . #2#)))
               (LETT #1# (CDR #1#) . #2#) (GO G190) G191 (EXIT NIL))
          (EXIT (SPADCALL |x| |lk| |nlk| (QREFELT $ 45)))))) 

(DECLAIM (NOTINLINE |AlgebraicManipulations;|)) 

(DEFUN |AlgebraicManipulations| (&REST #1=#:G293)
  (SPROG NIL
         (PROG (#2=#:G294)
           (RETURN
            (COND
...
(MAKEPROP '|AlgebraicManipulations| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'ALGOP
              ...
              (329 . |coerce|) (334 . ^) (340 . |rootPower|)
              (345 . |rootProduct|) (350 . |map|) (356 . |elt|) (362 . |Zero|)
              (366 . |univariate|) (|SparseUnivariatePolynomial| 31)
              (372 . |degree|) (377 . >) (383 . |monomial|)
              (390 . |leadingCoefficient|) (395 . +) (401 . |reductum|)
              (406 . -) (411 . ~=) (417 . =) (423 . *) (429 . -)
              (|Record| (|:| |var| 22) (|:| |exponent| 74))
              (|Union| 127 '"failed") (434 . |isExpt|) (440 . *)
              (|Fraction| 74) (446 . /) (452 . |numer|) (457 . |denom|)
              (462 . ^)
              (|Record| (|:| |exponent| 81) (|:| |coef| 7) (|:| |radicand| 7))
              (|PolynomialRoots| (|IndexedExponents| 11) 11 6 31 7)
              (468 . |froot|) (474 . |rootSimp|))
           '#(|rootSplit| 479 |rootSimp| 484 |rootProduct| 489 |rootPower| 494
              |rootKerSimp| 499 |rootFactor| 506 |ratPoly| 511 |ratDenom| 516)
           'NIL
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 139
                                                 '(0 9 0 10 1 11 0 9 12 1 7 14
                                                   ...
                                                   1 7 0 22 107 2 7 0 0 81 108
                                                   1 0 7 7 109 1 0 7 7 110 2 19
                                                   0 63 0 111 2 7 0 24 44 112 0
                                                   7 0 113 2 31 60 0 11 114 1
                                                   115 81 0 116 2 81 26 0 0 117
                                                   3 31 0 0 11 81 118 1 115 31
                                                   0 119 2 7 0 0 0 120 1 115 0
                                                   0 121 1 7 0 0 122 2 7 26 0 0
                                                   123 2 31 26 0 0 124 2 31 0 0
                                                   0 125 1 31 0 0 126 2 7 128 0
                                                   24 129 2 74 0 81 0 130 2 131
                                                   0 74 74 132 1 131 74 0 133 1
                                                   131 74 0 134 2 7 0 0 74 135
                                                   2 137 136 7 81 138 1 0 7 7
                                                   139 1 0 7 7 46 1 1 7 7 139 1
                                                   1 7 7 110 1 1 7 7 109 3 1 7
                                                   24 7 81 102 1 2 7 7 98 1 0
                                                   41 7 43 1 0 7 7 16 2 0 7 7 7
