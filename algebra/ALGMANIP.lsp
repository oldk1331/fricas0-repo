              ...
              (COND
               ((SPADCALL (LETT |u| (SPADCALL |fp| (QREFELT $ 70)) . #4#)
                ...
                (LETT |res|
                      ...
                      . #4#)))
              (SEQ (LETT |fr| NIL . #4#)
                   (LETT #3# (SPADCALL |fp| (QREFELT $ 80)) . #4#) G190
                   (COND
                    ((OR (ATOM #3#) (PROGN (LETT |fr| (CAR #3#) . #4#) NIL))
                     (GO G191)))
                   (SEQ (LETT |ne| (REM (QCDR |fr|) |n|) . #4#)
                        (LETT |ng| (GCD |ne| |n|) . #4#)
                        (LETT |nn|
                              (PROG2
                                  (LETT #2# (SPADCALL |n| |ng| (QREFELT $ 83))
                                        . #4#)
                                  (QCDR #2#)
        ...
        (SPROG
         ...
         (SEQ
          ...
          (LETT |n|
                (PROG1
                  ...
                  (|check_subtype2| (>= #2# 0) '(|NonNegativeInteger|)
                                    '(|Integer|) #2#))
                . #3#)
          (LETT |ans| (|spadConstant| $ 114) . #3#)
          (LETT |q| (SPADCALL |p| |k| (QREFELT $ 115)) . #3#)
          (LETT |ka1| (SPADCALL |a| (QREFELT $ 117)) . #3#)
          (COND
           ((QEQCAR |ka1| 0)
            (COND
          ...
          (SEQ G190
               (COND
                ((NULL
                  (SPADCALL (LETT |d| (SPADCALL |q| (QREFELT $ 120)) . #3#) 0
                            (QREFELT $ 121)))
                 (GO G191)))
               (SEQ
                (LETT |term|
                ...
                (LETT |ans|
                      (SPADCALL |ans|
                                ...
                                (QREFELT $ 124))
                      . #3#)
                (EXIT (LETT |q| (SPADCALL |q| (QREFELT $ 125)) . #3#)))
               NIL (GO G190) G191 (EXIT NIL))
          (EXIT
           (SPADCALL (SPADCALL (SPADCALL |q| (QREFELT $ 123)) (QREFELT $ 74))
                     |ans| (QREFELT $ 124)))))) 
                         ...
                         ((OR
                          ...
                          (PROGN
                           (LETT #2#
                                 ...
                                 . #4#)
                           (GO #5=#:G286))))))))
                    (LETT |u| (SPADCALL |x| |op| (QREFELT $ 133)) . #4#)
                    (EXIT
                     (COND
                      ((QEQCAR |u| 1)
                      ...
                      (#3#
                       (SEQ (LETT |pr| (QCDR |u|) . #4#)
                            (LETT |q|
                                  ...
                                  . #4#)
                            (LETT |qr|
                                  (DIVIDE2 (SPADCALL |q| (QREFELT $ 137))
                            ...
                            (EXIT
                             (SPADCALL
                              (SPADCALL |x| (QCAR |qr|) (QREFELT $ 139))
                              (SPADCALL
                               (SPADCALL |op| |x|
                                         (PROG1
                                             (LETT #1#
...
(MAKEPROP '|AlgebraicManipulations| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) 'ALGOP
              ...
              (|Record| (|:| |factor| 32) (|:| |exponent| 82)) (|List| 78)
              ...
              (284 . |retract|) (289 . |rootFactor|) (|Union| 6 '#1="failed")
              ...
              (|Union| 131 '"failed") (451 . |isExpt|) (457 . *)
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 143
                                                 '(0 9 0 10 1 11 0 9 12 1 7 14
                                                   ...
                                                   114 2 32 61 0 11 115 1 7 116
                                                   0 117 2 11 26 0 9 118 1 119
                                                   82 0 120 2 82 26 0 0 121 3
                                                   32 0 0 11 82 122 1 119 32 0
                                                   123 2 7 0 0 0 124 1 119 0 0
                                                   125 1 7 0 0 126 2 7 26 0 0
                                                   127 2 32 26 0 0 128 2 32 0 0
                                                   0 129 1 32 0 0 130 2 7 132 0
                                                   24 133 2 75 0 82 0 134 2 135
                                                   0 75 75 136 1 135 75 0 137 1
                                                   135 75 0 138 2 7 0 0 75 139
                                                   2 141 140 7 82 142 1 0 7 7
                                                   143 1 0 7 7 47 1 1 7 7 143 1
