...
(SDEFUN |ALGMANIP;ratDenom;FLF;4| ((|x| F) (|l| |List| F) ($ F))
        (SPROG ((#1=#:G120 NIL) (|y| NIL) (#2=#:G119 NIL))
               (SEQ
                (SPADCALL |x|
                          (PROGN
...
(SDEFUN |ALGMANIP;innerRF| ((|x| F) (|ll| |List| (|Kernel| F)) ($ F))
        (SPROG
         ((|q| (|SparseUnivariatePolynomial| F)) (#1=#:G179 NIL) (|kk| NIL)
          (#2=#:G178 NIL) (#3=#:G174 NIL) (#4=#:G175 NIL) (#5=#:G177 NIL)
          (#6=#:G176 NIL) (|l| (|List| (|Kernel| F)))
...
(SDEFUN |ALGMANIP;fp_root|
        ...
        (SPROG
         ((|res| (F)) (|rr| (F)) (|ce| (|NonNegativeInteger|)) (#1=#:G187 NIL)
          (|ne| (|NonNegativeInteger|)) (#2=#:G186 NIL) (#3=#:G184 NIL)
          (|nn| (|Integer|)) (|ng| (|NonNegativeInteger|)) (#4=#:G182 NIL)
          (#5=#:G192 NIL) (|fr| NIL)
...
(SDEFUN |ALGMANIP;radeval|
        ...
        (SPROG
         ((|q|
          ...
          (|ans| (F)) (|term| (|SparseMultivariatePolynomial| R (|Kernel| F)))
          (|g| (|NonNegativeInteger|)) (|d| (|NonNegativeInteger|))
          (|n| (|NonNegativeInteger|)) (#1=#:G235 NIL) (|a| (F))
          (|arg| (|List| F)))
         (SEQ
          (LETT |a|
                (|SPADfirst|
          ...
          (SEQ G190
               ...
               NIL (GO G190) G191 (EXIT NIL))
          (EXIT
           (SPADCALL (SPADCALL (SPADCALL |q| (QREFELT $ 116)) (QREFELT $ 73))
                     |ans| (QREFELT $ 117)))))) 
                     ...
                     (COND
                      ...
                      (#3#
                       (SEQ (LETT |pr| (QCDR |u|) . #4#)
                            ...
                            (EXIT
                             (SPADCALL
                              (SPADCALL |x| (QCAR |qr|) (QREFELT $ 132))
                              (SPADCALL
                               (SPADCALL |op| |x|
                                         (PROG1
                                             (LETT #1#
...
(DEFUN |AlgebraicManipulations| (&REST #1=#:G283)
  (SPROG NIL
         (PROG (#2=#:G284)
           (RETURN
            (COND
