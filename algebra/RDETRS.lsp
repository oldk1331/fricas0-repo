         ...
         ((#2=#:G227 NIL) (|rh| #3=(|Union| F "failed")) (|rb| #3#) (|ra| (F))
          ...
          (|u|
           (|Union|
            (|Record| (|:| |z1| UP) (|:| |z2| UP) (|:| |r1| UP) (|:| |r2| UP))
            "failed"))
          (|da| (|NonNegativeInteger|)) (#4=#:G198 NIL) (#5=#:G228 NIL)
...
(SDEFUN |RDETRS;DSPDEsys0|
        ...
        (SPROG
         ((|ans2| (UP)) (|ans1| (UP)) (|q2| (UP)) (|q1| (UP))
          (|lq| (|List| UP)) (#3=#:G254 NIL) (#4=#:G255 NIL) (|u| #1#)
          (#5=#:G248 NIL))
         (SEQ
          (EXIT
...
(SDEFUN |RDETRS;DSPDEhdom|
        ((|c1| (UP)) (|c2| (UP)) (|lb| (F)) (|lh| (F))
         ...
         ($ (|Union| (|List| UP) "failed")))
        (SPROG
         ((|q2| (UP)) (#1=#:G275 NIL) (|d2| #2=(|Integer|)) (|q1| (UP))
          (|d1| #2#))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |RDETRS;DSPDEbdom|
        ((|c1| (UP)) (|c2| (UP)) (|lb| (F)) (|lh| (F))
         ...
         ($ (|Union| (|List| UP) "failed")))
        (SPROG
         ((|q2| (UP)) (#1=#:G285 NIL) (|d1| #2=(|Integer|)) (|q1| (UP))
          (|d2| #2#))
         (SEQ
          (EXIT
           (SEQ
