...
(SDEFUN |RDETRS;monomRDEsys;3FMU;1|
        ((|f| |Fraction| UP) (|g1| |Fraction| UP) (|g2| |Fraction| UP)
         ...
         ($ |Union|
          ...
          "failed"))
        (SPROG
         ((|u| (|Union| UP "failed")) (|aa| (UP)) (|tt| (UP)) (#1=#:G132 NIL)
          (|gg| (UP)) (|e| (UP)) (|d| (UP)))
         (SEQ
          (LETT |gg|
                (SPADCALL
...
(SDEFUN |RDETRS;SPDEsys|
        ((|a| UP) (|b| UP) (|h| UP) (|c1| UP) (|c2| UP) (|n| |Integer|)
         ...
         ($ |Union| (|List| UP) #1#))
        (SPROG
         ((#2=#:G207 NIL) (|rh| #3=(|Union| F "failed")) (|rb| #3#) (|ra| (F))
          ...
          (|u|
           (|Union|
            (|Record| (|:| |z1| UP) (|:| |z2| UP) (|:| |r1| UP) (|:| |r2| UP))
            "failed"))
          (|da| (|NonNegativeInteger|)) (#4=#:G182 NIL) (#5=#:G208 NIL)
          (|u2| #6=(|Union| UP "failed")) (|u1| #6#) (|g| (UP)))
         (SEQ
          (COND
                    ...
                    (SEQ
                     (LETT |g|
                           (SPADCALL |a| (SPADCALL |b| |h| (QREFELT $ 13))
                                     (QREFELT $ 13))
                           . #8=(|RDETRS;SPDEsys|))
                     (SEQ (LETT |u1| (SPADCALL |c1| |g| (QREFELT $ 16)) . #8#)
                          (EXIT
                           (COND
                            ((QEQCAR |u1| 1)
                             (PROGN
                              (LETT #5# (CONS 1 #9="failed") . #8#)
                              (GO #5#)))
                            (#7#
                             (SEQ
                     ...
                     (LETT |c1| (QCDR |u1|) . #8#)
                     (LETT |c2| (QCDR |u2|) . #8#)
                     (LETT |da| (SPADCALL |a| (QREFELT $ 54)) . #8#)
                     (EXIT
                      (COND
                       ...
                       (#7#
                        (SEQ
                         (EXIT
                          (SEQ (LETT |ra| (SPADCALL |a| (QREFELT $ 56)) . #8#)
                               (SEQ
                                (LETT |rb| (SPADCALL |b| (QREFELT $ 58)) . #8#)
                                (EXIT
                                 (COND
                                  ((QEQCAR |rb| 1)
                                   (PROGN
...
(SDEFUN |RDETRS;DSPDEsys0|
        ...
        (SPROG
         ((|ans2| (UP)) (|ans1| (UP)) (|q2| (UP)) (|q1| (UP))
          (|lq| (|List| UP)) (#3=#:G231 NIL) (#4=#:G234 NIL) (|u| #1#)
          (#5=#:G229 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |RDETRS;DSPDEhdom|
        ...
        (SPROG
         ((|q2| (UP)) (#1=#:G252 NIL) (|d2| #2=(|Integer|)) (|q1| (UP))
          (|d1| #2#))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |RDETRS;DSPDEbdom|
        ((|c1| UP) (|c2| UP) (|lb| F) (|lh| F) (|n| |NonNegativeInteger|)
         (|d| |Integer|) ($ |Union| (|List| UP) "failed"))
        (SPROG
         ((|q2| (UP)) (#1=#:G261 NIL) (|d1| #2=(|Integer|)) (|q1| (UP))
          (|d2| #2#))
         (SEQ
          (EXIT
           (SEQ
