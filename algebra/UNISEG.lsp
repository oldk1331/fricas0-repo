                   ...
                   ((SPADCALL |s| (QREFELT $ 18))
                    (SPADCALL |e|
                              (SPADCALL (SPADCALL |s| (QREFELT $ 20))
                                        (QREFELT $ 32))
                              (QREFELT $ 33)))
                   (#2='T (SPADCALL |e| (QREFELT $ 34))))))
                . #1#)
          (LETT |inc| (SPADCALL |s| (QREFELT $ 22)) . #1#)
          (EXIT
           (COND ((EQL |inc| 1) |seg|)
                 (#2#
...
(SDEFUN |UNISEG;expand;LS;20| ((|ls| |List| $) ($ |Stream| S))
        (SPROG
         ((|st| (|Stream| S)) (|s| ($)) (|lb| (|List| (|Segment| S)))
          (|ns| (|Segment| S)))
         (SEQ
          (LETT |st| (SPADCALL (QREFELT $ 64)) . #1=(|UNISEG;expand;LS;20|))
          (EXIT
                            ...
                            (COND
                             ((NULL
                               (COND ((SPADCALL |ls| (QREFELT $ 66)) NIL)
                                     ('T
                                      (SPADCALL (SPADCALL |ls| (QREFELT $ 67))
                                                (QREFELT $ 18)))))
                              (GO G191)))
                            (SEQ
                             (LETT |s| (SPADCALL |ls| (QREFELT $ 67)) . #1#)
                             (LETT |ls| (SPADCALL |ls| (QREFELT $ 68)) . #1#)
                             (LETT |ns|
                                   (SPADCALL
                                    (QCDR
                                   ...
                                   . #1#)
                             (EXIT
                              (LETT |lb| (SPADCALL |lb| |ns| (QREFELT $ 70))
                                    . #1#)))
                            NIL (GO G190) G191 (EXIT NIL))
                       (COND
                        ((SPADCALL |ls| (QREFELT $ 66))
                         (LETT |st| (SPADCALL (QREFELT $ 64)) . #1#))
                        (#2#
                         (SEQ (LETT |s| (SPADCALL |ls| (QREFELT $ 67)) . #1#)
                              (EXIT
                               (LETT |st|
                                     (SPADCALL
...
(MAKEPROP '|UniversalSegment| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) '|Rep|
              ...
              (|SingleInteger|))
           '#(~= 236 |segment| 242 |map| 253 |low| 259 |latex| 264 |incr| 269
              |high| 274 |hashUpdate!| 279 |hash| 285 |hasHi| 290 |expand| 295
              |convert| 305 |coerce| 315 SEGMENT 325 BY 336 = 342 - 348 + 354)
           'NIL
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 78
                                            '(2 9 0 6 6 10 2 9 0 0 12 13 1 9 6
                                              ...
                                              57 61 0 63 1 0 6 0 14 1 3 35 0 1
                                              1 0 12 0 22 1 0 6 0 20 2 3 77 77
                                              0 1 1 3 78 0 1 1 0 17 0 18 1 2 57
                                              0 60 1 2 57 58 59 1 1 40 0 48 1 0
                                              0 6 27 1 3 31 0 39 1 0 0 9 25 1 0
                                              0 6 23 2 0 0 6 6 24 2 0 0 0 12 15
                                              2 3 17 0 0 30 2 5 0 0 6 56 2 4 0
                                              0 6 53 2 4 0 6 0 51)))))
           '|lookupComplete|)) 
