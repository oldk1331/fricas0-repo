     ...
     (SEQ
      ...
      (EXIT
       (SPADCALL
        (SPADCALL
         (SPADCALL
          (CONS #'|SUBRESP;primitivePart;UPRUP;1!0| (VECTOR |q| $ |rec|)) |p|
          (QREFELT $ 16))
         (QREFELT $ 17))
        (QREFELT $ 18))))))) 

(DEFUN |SUBRESP;primitivePart;UPRUP;1!0| (|x1| $$)
  (PROG (|rec| $ |q|)
...
(DEFUN |SUBRESP;subresultantVector;2UPPa;2| (|p1| |p2| $)
  (PROG (|n| |Sn| #1=#:G132 |l| F #2=#:G125 #3=#:G120 |res|)
    (RETURN
     (SEQ
      (LETT |res|
            (MAKEARR1
      ...
      (EXIT
       (COND
         ...
         (COND
          ((ZEROP (SPADCALL |p1| (QREFELT $ 21)))
           (SEQ (QSETAREF1 |res| (SPADCALL |p2| (QREFELT $ 21)) |p2|)
                (COND
                 ((SPADCALL (SPADCALL |p2| (QREFELT $ 21)) 0 (QREFELT $ 27))
                  (SEQ
                   (QSETAREF1 |res|
                              (PROG1
                                  (LETT #3#
                                        (- (SPADCALL |p2| (QREFELT $ 21)) 1)
                                        . #4#)
                                (|check_subtype| (>= #3# 0)
            ...
            (COND
             ((SPADCALL (SPADCALL |p1| (QREFELT $ 21)) 0 (QREFELT $ 27))
              (SEQ
               (QSETAREF1 |res|
                          (PROG1
                              (LETT #2# (- (SPADCALL |p1| (QREFELT $ 21)) 1)
                                    . #4#)
        ...
        (#5#
         (SEQ (LETT |Sn| (|SPADfirst| |l|) . #4#) (LETT |l| (CDR |l|) . #4#)
               ...
               (COND
                ...
                ('T
                 (SEQ
                  (SEQ G190
                       (COND
                        ((NULL (SPADCALL |l| NIL (QREFELT $ 33))) (GO G191)))
...
(DEFUN |SubResultantPackage| (&REST #1=#:G145)
  (PROG ()
    (RETURN
     (PROG (#2=#:G146)
       (RETURN
    ...
    (RETURN
     (PROGN
                      ...
                      (|buildPredVector| 0 0
                                         (LIST
                                          (|HasCategory| |#1|
                                                         '(|EuclideanDomain|))))
                      . #1#))
      (|haddProp| |$ConstructorCache| '|SubResultantPackage| (LIST DV$1 DV$2)
                  (CONS 1 $))
      (|stuffDomainSlots| $)
      (QSETREFV $ 6 |#1|)
      (QSETREFV $ 7 |#2|)
      ...
      (COND
       ((|testBitVector| |pv$| 1)
        (QSETREFV $ 19
                  (CONS (|dispatchFunction| |SUBRESP;primitivePart;UPRUP;1|)
                        $))))
      $)))) 
