...
(SDEFUN |FFPOLY2;rootOfIrreduciblePoly;SupF;1|
        ...
        (SPROG
         ((|stillToFactor| #1=(|SparseUnivariatePolynomial| F)) (|root| (F))
          ...
          (|h| (|SparseUnivariatePolynomial| F)) (#3=#:G131 NIL) (|j| NIL)
          (|trModp| (|SparseUnivariatePolynomial| F)) (|beta| (F))
          (#4=#:G130 NIL) (|i| NIL) (|basispointer| (|Integer|))
          (|basis| (|Vector| F))
          (|qexp| (|PrimitiveArray| (|SparseUnivariatePolynomial| GF)))
          (|p| #1#) (|deg| (|PositiveInteger|)) (#5=#:G108 NIL)
...
(DEFUN |FiniteFieldPolynomialPackage2| (&REST #1=#:G132)
  (SPROG NIL
         (PROG (#2=#:G133)
           (RETURN
            (COND
