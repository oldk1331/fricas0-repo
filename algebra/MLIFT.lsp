...
(SDEFUN |MLIFT;corrPoly;SupLLLLMU;1|
        ...
        (SPROG
         ((|lp| (|Union| (|List| (|SparseUnivariatePolynomial| R)) #1#))
          (#2=#:G74 NIL) (|mp| NIL) (#3=#:G75 NIL)
          (|deg1| (|NonNegativeInteger|)) (|np| (|NonNegativeInteger|))
          (|a| (P)) (|y| (OV)) (#4=#:G76 NIL) (|f1| NIL) (#5=#:G77 NIL)
          (|listpolv| (|List| (|SparseUnivariatePolynomial| P)))
          (|um| #6=(|SparseUnivariatePolynomial| P))
          (|flcoef|
           #7=(|Union| (|List| (|SparseUnivariatePolynomial| P)) "failed"))
          (#8=#:G78 NIL) (#9=#:G79 NIL) (#10=#:G80 NIL)
          (#11=#:G30 #12=(|SparseUnivariatePolynomial| P)) (#13=#:G28 #12#)
          (#14=#:G29 NIL)
          (|listcong| (|List| (|SparseUnivariatePolynomial| P)))
          (|polc| (|SparseUnivariatePolynomial| P)) (#15=#:G81 NIL)
          (#16=#:G34 #17=(|SparseUnivariatePolynomial| P)) (#18=#:G32 #17#)
          (#19=#:G33 NIL) (|l| NIL) (#20=#:G82 NIL)
          (|pol| (|SparseUnivariatePolynomial| P)) (|ddiff| #6#) (|fbeta| #7#)
          (#21=#:G73 NIL) (|beta| (|List| (|SparseUnivariatePolynomial| P)))
          (#22=#:G83 NIL) (#23=#:G84 NIL)
          (|lcoef| (|List| (|SparseUnivariatePolynomial| P))) (|i| NIL)
          (#24=#:G85 NIL) (#25=#:G66 #17#) (#26=#:G64 #17#) (#27=#:G65 NIL)
          (|diff| (|SparseUnivariatePolynomial| P)))
         (SEQ
          (EXIT
           (COND
            ((EQL (LENGTH |lvar|) 0)
             (SEQ
              ...
              (COND
               ((QEQCAR |lp| 1)
                (PROGN (LETT #21# (CONS 1 "failed")) (GO #28=#:G72))))
              (EXIT
               (LETT |lcoef|
                     (CONS 0
                           (PROGN
                            (LETT #2# NIL)
                            (SEQ (LETT |mp| NIL) (LETT #3# (QCDR |lp|)) G190
                                 (COND
                                  ((OR (ATOM #3#)
                                       (PROGN (LETT |mp| (CAR #3#)) NIL))
                                   (GO G191)))
                                 (SEQ
                                  (EXIT
                                   (LETT #2#
            ...
            (#29='T
             (SEQ (LETT |deg1| (|SPADfirst| |ld|)) (LETT |np| (LENGTH |flist|))
                  ...
                  (LETT |listpolv|
                        (PROGN
                         (LETT #4# NIL)
                         (SEQ (LETT |f1| NIL) (LETT #5# |flist|) G190
                              (COND
                               ((OR (ATOM #5#)
                  ...
                  (COND
                   ((QEQCAR |flcoef| 1)
                    (PROGN (LETT #21# (CONS 1 "failed")) (GO #28#)))
                   (#29# (LETT |lcoef| (QCDR |flcoef|))))
                  (LETT |listcong|
                        (PROGN
                         (LETT #8# NIL)
                         (SEQ (LETT |l| 1) (LETT #9# |np|) G190
                        ...
                        (SPADCALL |m|
                                  (PROGN
                                   ...
                                   (COND (#19# #18#)
                                         (#29# (|spadConstant| % 44))))
                                  (QREFELT % 45)))
                  (SEQ (LETT |l| 1) (LETT #20# |deg1|) G190
                       (COND ((|greater_SI| |l| #20#) (GO G191)))
                       (SEQ
                        (COND
                         ((SPADCALL |diff| (|spadConstant| % 44)
                                    (QREFELT % 48))
                          (PROGN (LETT #21# (CONS 0 |lcoef|)) (GO #28#))))
...
(SDEFUN |MLIFT;lifting1|
        ((|m| (|SparseUnivariatePolynomial| P)) (|lvar| #1=(|List| OV))
         ...
         (% (|Union| (|List| (|SparseUnivariatePolynomial| P)) "failed")))
        (SPROG
         ((|nvar| (|NonNegativeInteger|)) (|testp| (|Boolean|)) (|j| NIL)
          (#5=#:G128 NIL) (|x| (OV)) (|li| #1#)
          (|conglist| #6=(|List| (|SparseUnivariatePolynomial| P))) (|v| (R))
          (|degj| (|NonNegativeInteger|))
          (|ldeg| (|List| (|NonNegativeInteger|))) (|subsvar| (|List| OV))
          (|subsval| (|List| R)) (#7=#:G129 NIL) (#8=#:G130 NIL)
          (#9=#:G131 NIL) (#10=#:G132 NIL) (#11=#:G133 NIL) (#12=#:G134 NIL)
          (|#G41| #3#) (|#G42| #4#) (|tlv| (|List| P))
          (|clv|
           (|List|
            (|List|
             (|Record| (|:| |expt| (|NonNegativeInteger|)) (|:| |pcoef| P)))))
          (#13=#:G135 NIL) (|lcp| NIL) (#14=#:G137 NIL) (|p| NIL)
          (#15=#:G136 NIL) (#16=#:G138 NIL) (|clist| NIL) (#17=#:G140 NIL)
          (|tpol| NIL) (#18=#:G139 NIL) (|mj| (|SparseUnivariatePolynomial| P))
          (|polc| (P)) (|k| NIL) (#19=#:G141 NIL) (|pol| (P)) (#20=#:G142 NIL)
          (#21=#:G108 #2#) (#22=#:G106 #2#) (#23=#:G107 NIL) (#24=#:G126 NIL)
          (|mc| (|SparseUnivariatePolynomial| P))
          (|flalpha|
           (|Union| (|List| (|SparseUnivariatePolynomial| P)) "failed"))
          (|lalpha| #6#) (#25=#:G143 NIL) (|alpha| NIL) (#26=#:G145 NIL)
          (#27=#:G144 NIL) (|term| NIL) (#28=#:G146 NIL) (|idegj| (|Integer|))
          (#29=#:G127 NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |conglist| NIL) (LETT |nvar| (LENGTH |lvar|))
                ...
                (SEQ (LETT |j| 1) (LETT #5# |nvar|) G190
                     ...
                     (SEQ (LETT |x| (|SPADfirst| |li|)) (LETT |li| (CDR |li|))
                           ...
                           (|testp|
                            (SEQ
                             ...
                             (LETT |plist|
                                   (PROGN
                                    (LETT #13# NIL)
                                    (SEQ (LETT |lcp| NIL) (LETT #14# |tlv|)
                                         (LETT |p| NIL) (LETT #15# |plist|)
                                         G190
                                         (COND
                                          ((OR (ATOM #15#)
                                               (PROGN
                          ...
                          (SEQ
                           (EXIT
                            (SEQ (LETT |k| 1) (LETT #19# |degj|) G190
                                 (COND ((|greater_SI| |k| #19#) (GO G191)))
                                 (SEQ
                                  (LETT |pol|
                          ...
                          (SEQ (LETT |term| NIL) (LETT #28# |plist|) G190
                               (COND
                                ((OR (ATOM #28#)
                                     (PROGN (LETT |term| (CAR #28#)) NIL))
                                 (GO G191)))
                               (SEQ
                                (EXIT
                                 (LETT |idegj|
         ...
         ((#3=#:G189 NIL) (#4=#:G190 NIL)
          (|ldcoef|
           (|Record| (|:| |deter| (|List| (|SparseUnivariatePolynomial| P)))
                     ...
                     (|:| |nlead| (|List| P))))
          (|listdet| (|List| (|SparseUnivariatePolynomial| P))) (#5=#:G191 NIL)
          (|pp| NIL) (#6=#:G192 NIL)
          (|nplist| (|List| (|SparseUnivariatePolynomial| P))) (|pol| NIL)
          (#7=#:G193 NIL) (#8=#:G166 #9=(|SparseUnivariatePolynomial| P))
          (#10=#:G164 #9#) (#11=#:G165 NIL) (#12=#:G168 NIL)
          (|coeflist|
           (|List|
            (|List|
             (|Record| (|:| |expt| (|NonNegativeInteger|)) (|:| |pcoef| P)))))
          ...
          (EXIT
           (SEQ
            (LETT |nplist|
                  (PROGN
                   (LETT #3# NIL)
                   (SEQ (LETT |pp| NIL) (LETT #4# |plist|) G190
                        (COND
                  ...
                  (SEQ
                   (COND
                    ((EQL (LENGTH |listdet|) (LENGTH |plist|))
                     (PROGN (LETT #13# (CONS 0 |listdet|)) (GO #14=#:G187))))
                   (LETT |plist| (QVELT |ldcoef| 2))
                   (LETT |nplist|
                         (PROGN
                          (LETT #5# NIL)
                          (SEQ (LETT |pp| NIL) (LETT #6# |plist|) G190
                               (COND
                                ((OR (ATOM #6#)
             ...
             (COND ((QEQCAR |sfu| 1) (CONS 1 "failed"))
                   (#15#
                    (SEQ
                     ...
                     (COND
                      ((QEQCAR |ffl| 1)
                       (PROGN (LETT #13# (CONS 1 "failed")) (GO #14#))))
                     (EXIT
                      (CONS 0
        ...
        (SPROG
         ...
         (SEQ
          (LETT |ldeg|
                (PROGN
                 (LETT #1# NIL)
                 (SEQ (LETT |p| NIL) (LETT #2# |plist|) G190
                      (COND
                       ((OR (ATOM #2#) (PROGN (LETT |p| (CAR #2#)) NIL))
                        (GO G191)))
                      (SEQ
                       (EXIT
                        (LETT #1# (CONS (SPADCALL |p| (QREFELT % 70)) #1#))))
...
(SDEFUN |MLIFT;subscoef|
        ((|um| (|SparseUnivariatePolynomial| P))
         ...
         (% (|SparseUnivariatePolynomial| P)))
        (SPROG
         ((|dm| (|NonNegativeInteger|)) (|k| NIL) (#1=#:G236 NIL)
          (|i| (|NonNegativeInteger|))
          (|new| (|SparseUnivariatePolynomial| P)))
...
(MAKEPROP '|MultivariateLifting| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (35 . ~=) (|Integer|) (41 . |elt|) (47 . *) (53 . |1|) (57 . |1|)
              (61 . |1|) (65 . |monomial|) (72 . -) (78 . |coerce|) (83 . +)
              (89 . |0|) (93 . -) (99 . |0|) (103 . |0|) (107 . =)
              (113 . |elt|) (119 . |eval|) (126 . |coerce|) (131 . *) (137 . *)
              (143 . ~=) (149 . |leadingCoefficient|) (154 . |degree|)
              (160 . |reductum|) (|Record| (|:| |expt| 32) (|:| |pcoef| 9))
