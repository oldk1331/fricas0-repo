      ...
      (LETT |lvars|
            (PROGN
             ...
             (SEQ (LETT |p| NIL . #3#) (LETT #1# |lp| . #3#) G190
                  ...
                  (SEQ
                   (EXIT
                    (LETT #2# (CONS (SPADCALL |p| (QREFELT $ 14)) #2#) . #3#)))
      ...
      (LETT |lvars|
            (PROGN
             ...
             (SEQ (LETT |p| NIL . #3#) (LETT #1# |lp| . #3#) G190
                  ...
                  (SEQ
                   (EXIT
                    (LETT #2# (CONS (SPADCALL |p| (QREFELT $ 22)) #2#) . #3#)))
                  (LETT #1# (CDR #1#) . #3#) (GO G190) G191
                  (EXIT (NREVERSE #2#))))
            . #3#)
      (EXIT
      ...
      (SEQ G190
           (COND
            ((NULL
              (COND
               ((OR (NULL |lp|)
                    (SPADCALL (SPADCALL (|SPADfirst| |lp|) (QREFELT $ 22)) |v|
                              (QREFELT $ 28)))
                'NIL)
               ('T 'T)))
             (GO G191)))
    ...
    (RETURN
     (SEQ
      ...
      (SEQ G190 (COND ((NULL (COND ((NULL |lp|) 'NIL) ('T 'T))) (GO G191)))
           ...
           NIL (GO G190) G191 (EXIT NIL))
      (EXIT
       (VECTOR (SPADCALL |us| (QREFELT $ 31)) (SPADCALL |vs| (QREFELT $ 31))
               (SPADCALL |ws| (QREFELT $ 31)))))))) 

(DEFUN |PSETCAT-;=;2SB;11| (|ps1| |ps2| $)
  (PROG (#1=#:G208 |p| #2=#:G207 #3=#:G206 #4=#:G205)
    (RETURN
     (SEQ
      (SPADCALL
       (SPADCALL
  ...
  (PROG (|p| |q|)
    (RETURN
     (SEQ
      ...
      (EXIT
       (COND ((NULL |lp|) 'T) ((SPADCALL (ELT $ 24) |lp| (QREFELT $ 44)) 'NIL)
             ('T
              (SEQ
               (LETT |lp|
                     (SPADCALL (CONS #'|PSETCAT-;localTriangular?!0| $) |lp|
                               (QREFELT $ 46))
                     . #1#)
...
(DEFUN |PSETCAT-;localTriangular?!0| (|z1| |z2| $)
...
(DEFUN |PSETCAT-;trivialIdeal?;SB;15| (|ps| $)
  (NULL (SPADCALL (ELT $ 43) (|PSETCAT-;elements| |ps| $) (QREFELT $ 26)))) 
     ...
     (SEQ
      ...
      (EXIT
       (SPADCALL (SPADCALL |dp| |dq| (QREFELT $ 50))
                 (SPADCALL |dp| |dq| (QREFELT $ 51)) (QREFELT $ 52))))))) 
...
(DEFUN |PSETCAT-;roughSubIdeal?;2SB;19| (|ps1| |ps2| $)
  (PROG (|lp|)
    (RETURN
     (SEQ
      (LETT |lp| (SPADCALL (|PSETCAT-;elements| |ps1| $) |ps2| (QREFELT $ 54))
...
(DEFUN |PSETCAT-;exactQuo| (|r| |s| $) (SPADCALL |r| |s| (QREFELT $ 63))) 

(DEFUN |PSETCAT-;headRemainder;PSR;24| (|a| |ps| $)
  (PROG (|lp2| |r| |lcp| |lca| |#G50| |#G49| |g| |e| |p| |lp1|)
    (RETURN
     (SEQ
      (LETT |lp1|
            (SPADCALL (ELT $ 43) (|PSETCAT-;elements| |ps| $) (QREFELT $ 26))
       ...
       (COND ((NULL |lp1|) (CONS |a| (|spadConstant| $ 64)))
             ...
             ('T
              (SEQ (LETT |r| (|spadConstant| $ 64) . #1#)
                   (LETT |lp1|
                         (SPADCALL (CONS (|function| |PSETCAT-;localInf?|) $)
                   ...
                   (SEQ G190
                        (COND
                         ((NULL
                           (COND
                            ((OR (SPADCALL |a| (QREFELT $ 43)) (NULL |lp2|))
                             'NIL)
                            ('T 'T)))
                          (GO G191)))
                                ...
                                (SEQ
                                 ...
                                 (LETT |a|
                                       (SPADCALL
                                        ...
                                        (QREFELT $ 72))
                                       . #1#)
                                 (LETT |r| (SPADCALL |r| |lcp| (QREFELT $ 73))
                                       . #1#)
                                 (EXIT (LETT |lp2| |lp1| . #1#))))
  ...
  (PROG (|g|)
    (RETURN
     (SEQ
      ...
      (EXIT
       (COND ((SPADCALL |g| (|spadConstant| $ 64) (QREFELT $ 78)) |frac|)
             ('T
              (SEQ
               (PROGN
                (RPLACA |frac| (SPADCALL (QCAR |frac|) |g| (QREFELT $ 79)))
                (QCAR |frac|))
               (PROGN
...
(DEFUN |PSETCAT-;remainder;PSR;26| (|a| |ps| $)
  (PROG (|c| |b| |g| |lca| |r| |hRa|)
    (RETURN
     (SEQ
      (LETT |hRa|
      ...
      (EXIT
       (COND
        ((SPADCALL |a| (QREFELT $ 43)) (VECTOR (|spadConstant| $ 64) |a| |r|))
        ('T
         (SEQ
          (LETT |b|
                (SPADCALL (|spadConstant| $ 64) (SPADCALL |a| (QREFELT $ 41))
                          (QREFELT $ 70))
                . #1#)
          ...
          (SEQ G190
               ...
               (SEQ
                ...
                (LETT |b|
                      (SPADCALL
                       (SPADCALL
                        (SPADCALL (QCDR |hRa|) (|PSETCAT-;exactQuo| |c| |g| $)
                                  (QREFELT $ 73))
                        |b| (QREFELT $ 69))
...
(DEFUN |PSETCAT-;rewriteIdealWithHeadRemainder;LSL;27| (|ps| |cs| $)
  (PROG (|rs| |p|)
    (RETURN
     (SEQ
      (COND ((SPADCALL |cs| (QREFELT $ 84)) |ps|)
            ((SPADCALL |cs| (QREFELT $ 85)) (LIST (|spadConstant| $ 86)))
            (#1='T
             (SEQ
               ...
               (COND ((NULL |ps|) |ps|)
                     ...
                     (#1#
                      (SEQ (LETT |rs| NIL . #2#)
                           (SEQ G190
                                (COND
                                 ((NULL (COND ((NULL |ps|) 'NIL) ('T 'T)))
                                  (GO G191)))
                                (SEQ (LETT |p| (|SPADfirst| |ps|) . #2#)
                                     (LETT |ps| (CDR |ps|) . #2#)
                                     (LETT |p|
                                           (QCAR
                                            (SPADCALL |p| |cs| (QREFELT $ 80)))
                                           . #2#)
                                     (EXIT
                                      (COND
...
(DEFUN |PSETCAT-;rewriteIdealWithRemainder;LSL;28| (|ps| |cs| $)
  (PROG (|rs| |p|)
    (RETURN
     (SEQ
      (COND ((SPADCALL |cs| (QREFELT $ 84)) |ps|)
      ...
      (COND
       ((|testBitVector| |pv$| 1)
        (PROGN
         ...
         (QSETREFV $ 58
                   (CONS
                    (|dispatchFunction| |PSETCAT-;roughEqualIdeals?;2SB;20|)
                    $)))))
      (COND
