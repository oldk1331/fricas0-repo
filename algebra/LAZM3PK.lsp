...
(SDEFUN |LAZM3PK;convert| ((|st| (ST)) (% (TS)))
        (SPROG ((|lp| (|List| P)) (|p| NIL) (#1=#:G13 NIL) (|ts| (TS)))
...
(SDEFUN |LAZM3PK;squareFree| ((|ts| (TS)) (% (|List| ST)))
        (SPROG
         ((|lp| (|List| P)) (|newts| (ST)) (|p| NIL) (#1=#:G30 NIL) (|us| (ST))
          (|lpwt| (|List| (|Record| (|:| |val| P) (|:| |tower| ST))))
          (|pwt| NIL) (#2=#:G31 NIL) (|newus| (ST)) (|toSave| (|List| ST))
          (|toSee| (|List| ST)))
         (SEQ
          (COND
...
(SDEFUN |LAZM3PK;normalizeIfCan;2ST;3| ((|ts| (ST)) (% (ST)))
        (SPROG
         ((|lv| (|List| V)) (|v| NIL) (#1=#:G48 NIL) (#2=#:G47 NIL)
          (#3=#:G46 NIL) (|lp| (|List| P)) (|p| (P)) (|newts| (ST)))
         (SEQ
          (EXIT
...
(SDEFUN |LAZM3PK;zeroSetSplit;LBL;4|
        ...
        (SPROG
         ((|toSee| (|List| TS)) (#1=#:G55 NIL) (|toSave| (|List| ST))
          (#2=#:G56 NIL) (|ts| NIL) (#3=#:G57 NIL))
         (SEQ (LETT |toSee| (SPADCALL |lp| |clos?| (QREFELT % 41)))
              (LETT |toSave| NIL)
              (SEQ (LETT |ts| NIL) (LETT #1# |toSee|) G190
                   (COND
              ...
              (EXIT
               (PROGN
                (LETT #2# NIL)
                (SEQ (LETT |ts| NIL) (LETT #3# |toSave|) G190
                     (COND
