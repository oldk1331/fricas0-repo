...
(SDEFUN |PRIGCD3;alg_reduce;SmpL2LSmp;6|
        ((|p| (|SparseMultivariatePolynomial| (|Integer|) (|Symbol|)))
         ...
         ($ (|SparseMultivariatePolynomial| (|Integer|) (|Symbol|))))
        (SPROG ((#1=#:G192 NIL) (|m| NIL) (#2=#:G193 NIL) (|z| NIL))
               (SEQ
