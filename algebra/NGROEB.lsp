...
(DEFUN |NGROEB;gbasis| (|Pol| $)
  (PROG (#1=#:G178 |x| #2=#:G177 |redPols| |basPols| D D1 #3=#:G176 #4=#:G175
         #5=#:G167 |h| |s| D0 #6=#:G174 #7=#:G173 #8=#:G172 #9=#:G171 |toth|
         |Pol1|)
    (RETURN
     (SEQ
...
(DEFUN |NGroebnerPackage| (&REST #1=#:G223)
  (PROG ()
    (RETURN
     (PROG (#2=#:G224)
       (RETURN
