      ...
      (COND
       ...
       ('T
        (SEQ
         ...
         (SEQ (LETT |i| 0 . #4#) (LETT |yi| NIL . #4#) (LETT #3# |ly| . #4#)
              (LETT |xi| NIL . #4#) (LETT #2# |lx| . #4#) G190
              (COND
...
(DEFUN |PolynomialInterpolationAlgorithms| (&REST #1=#:G114)
  (PROG ()
    (RETURN
     (PROG (#2=#:G115)
       (RETURN
        (COND
         ...
         ('T
          (UNWIND-PROTECT
              (PROG1
                  (APPLY (|function| |PolynomialInterpolationAlgorithms;|) #1#)
                (LETT #2# T . #3#))
            (COND
             ((NOT #2#)
...
(DEFUN |PolynomialInterpolationAlgorithms;| (|#1| |#2|)
  (PROG (|pv$| $ |dv$| DV$2 DV$1)
    (RETURN
     (PROGN
      (LETT DV$1 (|devaluate| |#1|) . #1=(|PolynomialInterpolationAlgorithms|))
      (LETT DV$2 (|devaluate| |#2|) . #1#)
      (LETT |dv$| (LIST '|PolynomialInterpolationAlgorithms| DV$1 DV$2) . #1#)
      (LETT $ (GETREFV 25) . #1#)
      (QSETREFV $ 0 |dv$|)
