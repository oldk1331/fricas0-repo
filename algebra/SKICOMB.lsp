...
(SDEFUN |SKICOMB;parseTerm;SNniR;9|
        ((|t1| (|String|)) (|pin| (|NonNegativeInteger|))
         ($ (|Record| (|:| |rft| $) (|:| |pout| (|NonNegativeInteger|)))))
        (SPROG
         ((|res| ($)) (#1=#:G191 NIL) (|i| NIL) (|ch| (|Character|))
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |p1| |pin|)
                ...
                (COND
                 ((> |p1| (SPADCALL |t1| (QREFELT $ 15)))
                  (PROGN (LETT #2# (CONS |res| |p1|)) (GO #3=#:G189))))
...
(SDEFUN |SKICOMB;getChildren;$L;11| ((|n| ($)) ($ (|List| $)))
        (SPROG ((#1=#:G144 NIL) (#2=#:G199 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((SPADCALL |n| (QREFELT $ 31))
                    (PROGN (LETT #2# NIL) (GO #3=#:G198))))
                  (EXIT
                   (LIST
                    (QCAR
                     (PROG2 (LETT #1# |n|)
...
(SDEFUN |SKICOMB;redux1| ((|n| ($)) ($ ($)))
        (SPROG
         ((#1=#:G257 NIL) (|leftleftright| ($)) (|leftleftleft| ($))
...
(SDEFUN |SKICOMB;redux;2$;21| ((|n| ($)) ($ ($)))
        (SPROG
         ((|triesLeft| (|NonNegativeInteger|)) (#1=#:G259 NIL)
