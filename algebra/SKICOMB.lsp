         ...
         (SEQ
          (EXIT
           (SEQ (LETT |p1| |pin|)
                ...
                (COND
                 ((> |p1| (SPADCALL |t1| (QREFELT $ 15)))
                  (PROGN (LETT #2# (CONS |res| |p1|)) (GO #3=#:G205))))
