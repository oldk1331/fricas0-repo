...
(SDEFUN |ILOGIC;redux;2%;8| ((|n| (%)) (% (%)))
        (SPROG ((#1=#:G74 NIL) (#2=#:G164 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND ((QEQCAR |n| 0) (PROGN (LETT #2# |n|) (GO #3=#:G163))))
                  (COND ((QEQCAR |n| 1) (PROGN (LETT #2# |n|) (GO #3#))))
                  (COND
                   ((QEQCAR |n| 2)
                    (SEQ
                     (COND
...
(SDEFUN |ILOGIC;factor;%L;9| ((|n| (%)) (% (|List| %)))
        (SPROG ((#1=#:G74 NIL) (#2=#:G177 NIL) (|ch| (|List| %)))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((NOT (QEQCAR |n| 2))
                    (PROGN (LETT #2# (LIST |n|)) (GO #3=#:G176))))
                  (COND
                   ((NOT
                     (EQUAL
                      (QVELT
...
(SDEFUN |ILOGIC;removeDup| ((|a| (|List| %)) (|b| (|List| %)) (% (|List| %)))
        (SPROG
         ((|b1| NIL) (#1=#:G185 NIL) (|a1| NIL) (#2=#:G186 NIL)
          (|fnd| (|Boolean|)) (|res| (|List| %)))
         (SEQ (LETT |res| NIL)
...
(SDEFUN |ILOGIC;deductions1| ((|ln| (|List| %)) (% (|List| %)))
        (SPROG
         ((|n| NIL) (#1=#:G204 NIL) (|ch| (|List| %)) (|n2| NIL)
          (#2=#:G205 NIL) (|res| (|List| %)))
         (SEQ (LETT |res| NIL)
                       ...
                       (COND
                        ((EQUAL (QVELT (CDR |n|) 0) 'IMPLY)
                         (SEQ (LETT |ch| (SPADCALL |n| (QREFELT % 21)))
                              (EXIT
                               (SEQ (LETT |n2| NIL) (LETT #2# |ln|) G190
                                    (COND
                                     ((OR (ATOM #2#)
                                          (PROGN (LETT |n2| (CAR #2#)) NIL))
                                      (GO G191)))
                                    (SEQ
                                     (EXIT
                                      (COND
...
(SDEFUN |ILOGIC;deductions;2L;12| ((|ln| (|List| %)) (% (|List| %)))
        (SPROG
         ((|allres| (|List| %)) (|thisres| (|List| %)) (|res| (|List| %))
          (|emptyres| (|Boolean|)) (|loopbreaker| (|NonNegativeInteger|)))
...
(SDEFUN |ILOGIC;getChildren;%L;16| ((|n| (%)) (% (|List| %)))
        (SPROG ((#1=#:G75 NIL) (#2=#:G235 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((SPADCALL |n| (QREFELT % 31))
                    (PROGN (LETT #2# NIL) (GO #3=#:G234))))
                  (COND
                   ((QEQCAR |n| 2)
                    (PROGN
                     (LETT #2# (LIST (QVELT (CDR |n|) 1) (QVELT (CDR |n|) 2)))
                     (GO #3#))))
                  (EXIT
                   (COND
                    ((QEQCAR |n| 3)
...
(SDEFUN |ILOGIC;parseBracketTerm|
        ...
        (SPROG
         ((|r2| (|Record| (|:| |rft| %) (|:| |pout| (|NonNegativeInteger|))))
          (|trm| (%)) (|ch| (|Character|)) (#2=#:G267 NIL) (|p1| #1#))
         (SEQ
          (EXIT
...
(SDEFUN |ILOGIC;parseILName|
        ((|t1| (|String|)) (|pin| #1=(|NonNegativeInteger|))
         (% (|Record| (|:| |rft| %) (|:| |pout| (|NonNegativeInteger|)))))
        (SPROG
         ((|vnm| (|String|)) (|pt| #1#) (#2=#:G295 NIL) (|ch| (|Character|)))
         (SEQ
          (EXIT
...
(SDEFUN |ILOGIC;toString;%S;26| ((|n| (%)) (% (|String|)))
        (SPROG ((|s1| (|String|)) (#1=#:G74 NIL) (#2=#:G342 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((QEQCAR |n| 0)
                    (SEQ
                     (COND
                      ((EQUAL (QCAR (CDR |n|)) 'F)
                       (PROGN (LETT #2# "_|_") (GO #3=#:G341))))
                     (COND
                      ((EQUAL (QCAR (CDR |n|)) 'T)
                       (PROGN (LETT #2# "T") (GO #3#))))
                     (EXIT (PROGN (LETT #2# "?") (GO #3#))))))
                  (COND
                   ((QEQCAR |n| 1)
                    (PROGN (LETT #2# (QCAR (CDR |n|))) (GO #3#))))
                  (COND
                   ((QEQCAR |n| 2)
                    (SEQ (LETT |s1| "->")
                         (COND
...
(SDEFUN |ILOGIC;toStringUnwrapped;%S;27| ((|n| (%)) (% (|String|)))
        (SPROG ((|s1| (|String|)) (#1=#:G74 NIL) (#2=#:G359 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
...
(SDEFUN |ILOGIC;coerce;%Of;28| ((|n| (%)) (% (|OutputForm|)))
        (SPROG
         ((#1=#:G73 NIL) (|s1| (|OutputForm|)) (#2=#:G74 NIL) (#3=#:G75 NIL))
         (SEQ
          (COND
           ((QEQCAR |n| 0)
