  ...
  (PROG (|lv| |x| #1=#:G110 |m| #2=#:G122 |q2| #3=#:G121 |s| #4=#:G120)
    (RETURN
     (SEQ
      ...
      (EXIT
       (COND ((OR (NULL |lq2|) (< (LENGTH |lq2|) (LENGTH (QREFELT $ 7)))) 'NIL)
             ('T
              (SEQ
               (LETT |lv|
                     (PROGN
...
(DEFUN |FGLMICPK;fglmIfCan;LU;3| (|lq1| $)
  (PROG (#1=#:G142 |q3| #2=#:G141 |lq3| |lq2| #3=#:G140 |q1| #4=#:G139)
    (RETURN
     (SEQ
      (LETT |lq2|
            (PROGN
      ...
      (COND ((NULL (|FGLMICPK;zeroDim?| |lq2| $)) (EXIT (CONS 1 "failed"))))
...
(DEFUN |FGLMICPK;groebner;2L;4| (|lq1| $)
  (PROG (#1=#:G158 |q3| #2=#:G157 |lq3| #3=#:G156 #4=#:G155 #5=#:G154 |q1|
         #6=#:G153 |lq2| #7=#:G152 #8=#:G151)
    (RETURN
     (SEQ
      (LETT |lq2|
            (PROGN
          ...
          (LETT |lq3|
                (PROGN
                 ...
                 (SEQ (LETT |q1| NIL . #9#) (LETT #5# |lq1| . #9#) G190
                      (COND
                       ((OR (ATOM #5#) (PROGN (LETT |q1| (CAR #5#) . #9#) NIL))
                        (GO G191)))
                      (SEQ
                       (EXIT
          ...
          (EXIT
           (PROGN
            ...
            (SEQ (LETT |q3| NIL . #9#) (LETT #3# |lq3| . #9#) G190
                 ...
                 (SEQ
                  (EXIT
                   (LETT #4# (CONS (SPADCALL |q3| (QREFELT $ 36)) #4#) . #9#)))
...
(DEFUN |FGLMIfCanPackage| (&REST #1=#:G159)
  (PROG ()
    (RETURN
     (PROG (#2=#:G160)
       (RETURN
         ...
         ('T
          (UNWIND-PROTECT
              (PROG1 (APPLY (|function| |FGLMIfCanPackage;|) #1#)
                (LETT #2# T . #3#))
            (COND
             ((NOT #2#) (HREM |$ConstructorCache| '|FGLMIfCanPackage|))))))))))) 
