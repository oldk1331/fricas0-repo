         ...
         ((|as|
           (|List|
            (|Record| (|:| |name| (|String|))
                      ...
                      (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                      (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|revAr| #1#) (#2=#:G221 NIL) (|a| NIL) (|forwAr| #1#)
          (#3=#:G220 NIL))
         (SEQ (LETT |as| NIL)
...
(SDEFUN |UDGRPH;merge;3%;22| ((|a| (%)) (|b| (%)) (% (%)))
        (SPROG
         ((|la|
          ...
          (#3=#:G305 NIL) (|ba| NIL) (|bStart| #4=(|NonNegativeInteger|))
          (|bmap| (|List| (|NonNegativeInteger|))) (#5=#:G292 NIL)
          (|newIndex| #4#)
          (|mergedObjects|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|i| (|Integer|)) (#6=#:G304 NIL) (|bob| NIL) (#7=#:G303 NIL)
          (|x| NIL) (#8=#:G302 NIL))
         (SEQ
          (LETT |bmap|
                (PROGN
...
(SDEFUN |UDGRPH;objProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bi| (S)) (#4=#:G318 NIL) (|boi| NIL) (|ayi| #2#) (|axi| #3#)
          (|ai| (S)) (#5=#:G317 NIL) (|aoi| NIL))
...
(SDEFUN |UDGRPH;closedObjProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #1#) (|bi| (S)) (#4=#:G385 NIL) (|boi| NIL) (|ayi| #2#)
          (|axi| #1#) (|ai| (S)) (#5=#:G384 NIL) (|aoi| NIL))
         (SEQ (LETT |newObjs| NIL)
              (SEQ (LETT |aoi| NIL) (LETT #5# (QCAR |a|)) G190
                   (COND
                    ((OR (ATOM #5#) (PROGN (LETT |aoi| (CAR #5#)) NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G440 NIL) (|bv| NIL)
          (#3=#:G439 NIL) (|bu| NIL) (#4=#:G438 NIL) (|av| NIL) (#5=#:G437 NIL)
          (|au| NIL))
         (SEQ (LETT |newArrs| NIL)
              (SEQ (LETT |au| 1) (LETT #5# (LENGTH (QCAR |a|))) G190
                   (COND ((|greater_SI| |au| #5#) (GO G191)))
         ...
         ((|newArrs|
           (|List|
            #2=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|newArr| #2#) (#3=#:G460 NIL) (|oldArrow| NIL) (#4=#:G447 NIL)
          (#5=#:G446 NIL) (|i| (|NonNegativeInteger|)) (#6=#:G459 NIL)
          (|oi| NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (#7=#:G458 NIL) (|o| NIL) (#8=#:G457 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #8# NIL)
         ...
         ((|newArrs|
           (|List|
            #2=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|newArr| #2#) (#3=#:G480 NIL) (|oldArrow| NIL) (#4=#:G467 NIL)
          (#5=#:G466 NIL) (|i| (|NonNegativeInteger|)) (#6=#:G479 NIL)
          (|oi| NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (#7=#:G478 NIL) (|o| NIL) (#8=#:G477 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
                 (LETT #8# NIL)
...
(SDEFUN |UDGRPH;coerce;%Of;33| ((|n| (%)) (% (|OutputForm|)))
        (SPROG
         ((|arrows| #1=(|OutputForm|)) (|laof| (|List| (|OutputForm|)))
          (#2=#:G494 NIL) (|ar| NIL) (#3=#:G493 NIL) (#4=#:G490 NIL)
          (|la|
           (|List|
            (|Record| (|:| |name| (|String|))
                      (|:| |arrType| (|NonNegativeInteger|))
                      ...
                      (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                      (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|vertices| #1#) (|lvof| (|List| (|OutputForm|))) (#5=#:G492 NIL)
          (|v| NIL) (#6=#:G491 NIL)
          (|lv|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
         ...
         (SEQ
          (EXIT
           (SEQ (LETT |vertices| (SPADCALL "Vertices: " (QREFELT % 86)))
                ...
                (COND
                 ((NULL |la|) (PROGN (LETT #4# |vertices|) (GO #7=#:G489))))
                (LETT |laof|
                      (PROGN
                       (LETT #3# NIL)
...
(SDEFUN |UDGRPH;subdiagramSvg;S%2BV;34|
        ...
        (SPROG
         ((#2=#:G512 NIL) (|s| (|String|))
          ...
          (#9=#:G503 NIL) (#10=#:G514 NIL) (|arrow| NIL) (#11=#:G515 NIL)
          (|arrn| NIL)
          (|arrs|
           (|List|
            (|Record| (|:| |name| (|String|))
          ...
          (|indexNodes| (|List| S)) (#12=#:G513 NIL) (|i| NIL)
          (|ls|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
         ...
         (SEQ
          (EXIT
           (SEQ
            ...
            (COND
             ((NULL |arrs|)
              (PROGN (LETT #2# (SPADCALL (QREFELT % 104))) (GO #13=#:G511))))
