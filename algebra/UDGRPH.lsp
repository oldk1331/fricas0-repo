...
(SDEFUN |UDGRPH;objProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bi| (S)) (#4=#:G317 NIL) (|boi| NIL) (|ayi| #2#) (|axi| #3#)
          (|ai| (S)) (#5=#:G316 NIL) (|aoi| NIL))
...
(SDEFUN |UDGRPH;closedObjProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #1#) (|bi| (S)) (#4=#:G384 NIL) (|boi| NIL) (|ayi| #2#)
          (|axi| #1#) (|ai| (S)) (#5=#:G383 NIL) (|aoi| NIL))
         (SEQ (LETT |newObjs| NIL)
              (SEQ (LETT |aoi| NIL) (LETT #5# (QCAR |a|)) G190
                   (COND
                    ((OR (ATOM #5#) (PROGN (LETT |aoi| (CAR #5#)) NIL))
...
(SDEFUN |UDGRPH;subdiagramSvg;S$2BV;34|
        ...
        (SPROG
         ((#2=#:G511 NIL) (|s| (|String|))
          ...
          (|toY| #5=(|NonNegativeInteger|)) (#6=#:G505 NIL) (|fromY| #5#)
          (#7=#:G504 NIL) (|toX| #5#) (#8=#:G503 NIL) (|fromX| #5#)
          (#9=#:G502 NIL) (#10=#:G513 NIL) (|arrow| NIL) (#11=#:G514 NIL)
          (|arrn| NIL)
          (|arrs|
           (|List|
            (|Record| (|:| |name| (|String|))
          ...
          (|indexNodes| (|List| S)) (#12=#:G512 NIL) (|i| NIL)
          (|ls|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
         ...
         (SEQ
          (EXIT
           (SEQ
            ...
            (COND
             ((NULL |arrs|)
              (PROGN (LETT #2# (SPADCALL (QREFELT $ 104))) (GO #13=#:G510))))
