...
(SDEFUN |UDGRPH;undirectedGraph;LL%;5|
        ((|obs| (|List| S))
         ...
         (% (%)))
        (SPROG
         ((|obn| NIL) (#1=#:G54 NIL) (|ob| NIL) (#2=#:G53 NIL)
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))))
          (|nodes|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|arn| NIL) (#3=#:G56 NIL) (|ar| NIL) (#4=#:G55 NIL)
          (|edges|
           (|List|
            (|Record| (|:| |name| (|String|))
                      (|:| |arrType| (|NonNegativeInteger|))
...
(SDEFUN |UDGRPH;undirectedGraph;Fp%;6| ((|poset| (|FinitePoset| S)) (% (%)))
        (SPROG
         ((|obs| (|List| S)) (|mat| (|List| (|List| (|Boolean|)))) (|xn| NIL)
          (#1=#:G66 NIL) (|x| NIL) (#2=#:G65 NIL) (|yn| NIL) (#3=#:G68 NIL)
          (|y| NIL) (#4=#:G67 NIL)
          (|z|
...
(SDEFUN |UDGRPH;undirectedGraph;LL%;7|
        ((|objs| (|List| S)) (|am| (|List| (|List| (|NonNegativeInteger|))))
         (% (%)))
        (SPROG
         ((|obn| NIL) (#1=#:G83 NIL) (|ob| (S))
          (|o|
           #2=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                        (|:| |posY| (|NonNegativeInteger|))))
          (|obs| (|List| #2#)) (|i| NIL) (#3=#:G84 NIL) (|j| NIL)
          (#4=#:G85 NIL)
          (|a|
         ...
         (%
          (|List|
           #1=(|Record| (|:| |name| (|String|))
                        ...
                        (|:| |map| (|List| (|NonNegativeInteger|)))))))
        (SPROG
         ((#2=#:G116 NIL) (|forwAr| #1#) (|a| NIL) (#3=#:G117 NIL)
          (|revAr| #1#)
          (|as|
           (|List|
            (|Record| (|:| |name| (|String|))
...
(SDEFUN |UDGRPH;kgraph;LS%;20|
        ((|objs| (|List| S)) (|arrowName| (|String|)) (% (%)))
        (SPROG
         ((|obn| NIL) (#1=#:G167 NIL) (|ob| (S))
          (|o|
           #2=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                        (|:| |posY| (|NonNegativeInteger|))))
          (|obs| (|List| #2#)) (|obm| NIL) (#3=#:G168 NIL)
          (|a|
        ...
        (SPROG
         ((|lo|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|bStart| (|NonNegativeInteger|)) (|ba| NIL) (#1=#:G177 NIL)
          (|arr|
...
(SDEFUN |UDGRPH;merge;3%;22| ((|a| (%)) (|b| (%)) (% (%)))
        (SPROG
         ((#1=#:G198 NIL) (|x| NIL) (#2=#:G199 NIL) (|bob| NIL) (#3=#:G200 NIL)
          (|i| (|Integer|))
          (|mergedObjects|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|newIndex| #4=(|NonNegativeInteger|)) (#5=#:G188 NIL)
          (|bmap| (|List| (|NonNegativeInteger|))) (|bStart| #4#) (|ba| NIL)
          (#6=#:G201 NIL) (|toI| #7=(|NonNegativeInteger|)) (|fromI| #7#)
          (|arr|
         ...
         (%
          (|List|
           (|Record| (|:| |value| (|Product| S S))
                     ...
                     (|:| |posY| (|NonNegativeInteger|))))))
        (SPROG
         ((|aoi| NIL) (#1=#:G213 NIL) (|ai| (S))
          (|axi| #2=(|NonNegativeInteger|)) (|ayi| #3=(|NonNegativeInteger|))
          (|boi| NIL) (#4=#:G214 NIL) (|bi| (S)) (|bxi| #2#) (|byi| #3#)
...
(SDEFUN |UDGRPH;*;2%Ug;25|
        ...
        (SPROG
         ((|au| NIL) (#1=#:G238 NIL) (|av| NIL) (#2=#:G239 NIL) (|bu| NIL)
          (#3=#:G240 NIL) (|bv| NIL) (#4=#:G241 NIL) (|an| (|String|))
          (|arr|
           #5=(|Record| (|:| |name| (|String|))
                        (|:| |arrType| (|NonNegativeInteger|))
                        (|:| |fromOb| (|NonNegativeInteger|))
...
(SDEFUN |UDGRPH;cartesian;2%Ug;26|
        ((|a| (%)) (|b| (%)) (% (|UndirectedGraph| (|Product| S S))))
        (SPROG
         ((|au| NIL) (#1=#:G267 NIL) (|av| NIL) (#2=#:G268 NIL) (|bu| NIL)
          (#3=#:G269 NIL) (|bv| NIL) (#4=#:G270 NIL) (|an| (|String|))
          (|arr|
           #5=(|Record| (|:| |name| (|String|))
                        (|:| |arrType| (|NonNegativeInteger|))
                        (|:| |fromOb| (|NonNegativeInteger|))
         ...
         (%
          (|List|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))))))
        (SPROG
         ((|aoi| NIL) (#1=#:G280 NIL) (|ai| (S))
          (|axi| #2=(|NonNegativeInteger|)) (|ayi| #3=(|NonNegativeInteger|))
          (|boi| NIL) (#4=#:G281 NIL) (|bi| (S)) (|bxi| #2#) (|byi| #3#)
...
(SDEFUN |UDGRPH;closedTensor;2%M%;28|
        ((|a| (%)) (|b| (%)) (|f| (|Mapping| S S S)) (% (%)))
        (SPROG
         ((|au| NIL) (#1=#:G303 NIL) (|av| NIL) (#2=#:G304 NIL) (|bu| NIL)
          (#3=#:G305 NIL) (|bv| NIL) (#4=#:G306 NIL) (|an| (|String|))
          (|arr|
           #5=(|Record| (|:| |name| (|String|))
                        (|:| |arrType| (|NonNegativeInteger|))
                        (|:| |fromOb| (|NonNegativeInteger|))
...
(SDEFUN |UDGRPH;closedCartesian;2%M%;29|
        ((|a| (%)) (|b| (%)) (|f| (|Mapping| S S S)) (% (%)))
        (SPROG
         ((|au| NIL) (#1=#:G333 NIL) (|av| NIL) (#2=#:G334 NIL) (|bu| NIL)
          (#3=#:G335 NIL) (|bv| NIL) (#4=#:G336 NIL) (|an| (|String|))
          (|arr|
           #5=(|Record| (|:| |name| (|String|))
                        (|:| |arrType| (|NonNegativeInteger|))
                        (|:| |fromOb| (|NonNegativeInteger|))
...
(SDEFUN |UDGRPH;map;%LL2I%;30|
        ...
        (SPROG
         ((#2=#:G353 NIL) (|o| NIL) (#3=#:G354 NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|oi| NIL) (#4=#:G355 NIL) (|i| (|NonNegativeInteger|))
          (#5=#:G342 NIL) (#6=#:G343 NIL) (|oldArrow| NIL) (#7=#:G356 NIL)
          (|newArr|
           #8=(|Record| (|:| |name| (|String|))
                        (|:| |arrType| (|NonNegativeInteger|))
                        (|:| |fromOb| (|NonNegativeInteger|))
...
(SDEFUN |UDGRPH;mapContra;%LL2I%;31|
        ((|s| (%)) (|m| (|List| (|NonNegativeInteger|))) (|newOb| (|List| S))
         (|offsetX| #1=(|Integer|)) (|offsetY| #1#) (% (%)))
        (SPROG
         ((#2=#:G373 NIL) (|o| NIL) (#3=#:G374 NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|oi| NIL) (#4=#:G375 NIL) (|i| (|NonNegativeInteger|))
          (#5=#:G362 NIL) (#6=#:G363 NIL) (|oldArrow| NIL) (#7=#:G376 NIL)
          (|newArr|
           #8=(|Record| (|:| |name| (|String|))
                        (|:| |arrType| (|NonNegativeInteger|))
                        (|:| |fromOb| (|NonNegativeInteger|))
        ...
        (SPROG
         ((|lv|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (#1=#:G387 NIL) (|v| NIL) (#2=#:G388 NIL)
          (|lvof| (|List| (|OutputForm|))) (|vertices| #3=(|OutputForm|))
          (|la|
           (|List|
            (|Record| (|:| |name| (|String|))
                      (|:| |arrType| (|NonNegativeInteger|))
                      ...
                      (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                      (|:| |map| (|List| (|NonNegativeInteger|))))))
          (#4=#:G386 NIL) (#5=#:G389 NIL) (|ar| NIL) (#6=#:G390 NIL)
          (|laof| (|List| (|OutputForm|))) (|arrows| #3#))
         (SEQ
          (EXIT
           (SEQ (LETT |vertices| (SPADCALL "Vertices: " (QREFELT % 86)))
                ...
                (LETT |laof|
                      (PROGN
                       (LETT #5# NIL)
                       (SEQ (LETT |ar| NIL) (LETT #6# |la|) G190
                            (COND
                             ((OR (ATOM #6#) (PROGN (LETT |ar| (CAR #6#)) NIL))
                              (GO G191)))
                            (SEQ
                             (EXIT
                              (LETT #5#
         ...
         ((|mt| (|Scene| (|SCartesian| 2)))
          (|ls|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|i| NIL) (#2=#:G409 NIL) (|indexNodes| (|List| S))
          ...
          (|arrs|
           (|List|
            (|Record| (|:| |name| (|String|))
                      ...
                      (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                      (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arrn| NIL) (#3=#:G411 NIL) (|arrow| NIL) (#4=#:G410 NIL)
          (#5=#:G399 NIL) (|fromX| #6=(|NonNegativeInteger|)) (#7=#:G400 NIL)
          (|toX| #6#) (#8=#:G401 NIL) (|fromY| #6#) (#9=#:G402 NIL) (|toY| #6#)
          (|midX| #10=(|NonNegativeInteger|)) (|midY| #10#)
          (|fnode| #11=(|Scene| (|SCartesian| 2))) (|tnode| #11#)
          (|s| (|String|)) (#12=#:G408 NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |mt|
            ...
            (COND
             ((NULL |arrs|)
              (PROGN (LETT #12# (SPADCALL (QREFELT % 104))) (GO #13=#:G407))))
            (SEQ (LETT |arrn| 1) (LETT #3# (LENGTH |arrs|)) (LETT |arrow| NIL)
                 (LETT #4# |arrs|) G190
                 (COND
                  ((OR (ATOM #4#) (PROGN (LETT |arrow| (CAR #4#)) NIL)
                       (|greater_SI| |arrn| #3#))
                   (GO G191)))
                 (SEQ
                  (LETT |fromX|
                  ...
                  (LETT |toY|
                        (SPADCALL |indexPointy| (QVELT |arrow| 3)
                                  (QREFELT % 38)))
                  (LETT |fromX|
                        (PROG1 (LETT #5# (+ |fromX| (QVELT |arrow| 4)))
                          (|check_subtype2| (>= #5# 0) '(|NonNegativeInteger|)
                                            '(|Integer|) #5#)))
                  (LETT |toX|
                        (PROG1 (LETT #7# (+ |toX| (QVELT |arrow| 4)))
                          (|check_subtype2| (>= #7# 0) '(|NonNegativeInteger|)
                                            '(|Integer|) #7#)))
                  (LETT |fromY|
                        (PROG1 (LETT #8# (+ |fromY| (QVELT |arrow| 5)))
                          (|check_subtype2| (>= #8# 0) '(|NonNegativeInteger|)
                                            '(|Integer|) #8#)))
                  (LETT |toY|
                        (PROG1 (LETT #9# (+ |toY| (QVELT |arrow| 5)))
                     ...
                     (SEQ (LETT |s| (QVELT |arrow| 0))
                          (EXIT
                           (SPADCALL |mt| |s| 32
                                     ...
                                     (QREFELT % 100))))))))
                 (LETT #4# (PROG1 (CDR #4#) (LETT |arrn| (|inc_SI| |arrn|))))
                 (GO G190) G191 (EXIT NIL))
            (EXIT (PROGN (LETT #12# (SPADCALL (QREFELT % 104))) (GO #13#)))))
          #13# (EXIT #12#)))) 
