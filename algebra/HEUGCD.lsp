...
(SDEFUN |HEUGCD;lintgcd;LI;7| ((|lval| |List| (|Integer|)) ($ |Integer|))
        (SPROG ((|val| (|Integer|)) (#1=#:G146 NIL) (|val1| NIL))
               (SEQ
...
(SDEFUN |HEUGCD;contprim|
        ...
        (SPROG
         ((#1=#:G153 NIL) (|c| (|Integer|)) (#2=#:G158 NIL) (|f| NIL)
          (#3=#:G157 NIL))
         (SEQ
          (PROGN
...
(SDEFUN |HEUGCD;constcase|
        ((|listdeg| |List| (|NonNegativeInteger|)) (|listf| |List| BP)
         ($ |List| BP))
        (SPROG
         ((#1=#:G174 NIL) (|lcf| NIL) (#2=#:G173 NIL) (|d| (|Integer|))
          (|lclistf| (|List| (|Integer|))) (#3=#:G172 NIL) (|f| NIL)
          (#4=#:G171 NIL) (#5=#:G162 NIL) (#6=#:G161 #7=(|Boolean|))
          (#8=#:G163 #7#) (#9=#:G170 NIL) (|n| NIL) (|lind| (|List| BP)))
         (SEQ
          (LETT |lind|
...
(SDEFUN |HEUGCD;testDivide|
        ...
        (SPROG
         ((|result| (|List| BP)) (#1=#:G186 NIL) (|f1| (|Union| BP "failed"))
          (#2=#:G187 NIL) (|f| NIL))
         (SEQ
          (EXIT
