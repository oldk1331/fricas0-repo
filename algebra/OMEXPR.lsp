   ...
   (COND
    ...
    ('T
     (SEQ (SPADCALL |dev| (QREFELT $ 16))
          ...
          (|OMEXPR;outputOMInterval| |dev| (SPADCALL |args| 4 (QREFELT $ 31))
           (SPADCALL |args| 5 (QREFELT $ 31)) $)
          (|OMEXPR;outputOMLambda| |dev|
           (SPADCALL (SPADCALL |args| 1 (QREFELT $ 31))
                     (SPADCALL |args| 2 (QREFELT $ 31))
     ...
     (SEQ (LETT |nargs| (LENGTH |args|) . #2=(|OMEXPR;outputOMFunction|))
          (EXIT
           (COND
            ((ZEROP |nargs|)
             (SEQ
              (LETT |omOp| (SPADCALL |op| (QREFELT $ 12) (QREFELT $ 37)) . #2#)
              (EXIT
               (COND
                ((QEQCAR |omOp| 1)
                 (|error|
            ...
            ((EQL |nargs| 1)
             (SEQ
              (LETT |omOp| (SPADCALL |op| (QREFELT $ 13) (QREFELT $ 37)) . #2#)
              (EXIT
               (COND
                ((QEQCAR |omOp| 1)
                 (|error|
...
(DEFUN |OMEXPR;outputOMExpr| (|dev| |ex| $)
  (PROG (|k| #1=#:G213 |z| |s| |x| |w| |v|)
    (RETURN
     (SEQ
      (COND
       ((SPADCALL |ex| (QREFELT $ 44))
        (SPADCALL |dev| (SPADCALL |ex| (QREFELT $ 45)) 'NIL (QREFELT $ 46)))
       ('T
        (SEQ
         (EXIT
          (SEQ
                    ...
                    ((NULL (EQL (QCDR (QCDR |x|)) 1))
                     (PROGN
                      (LETT #1#
                            (SEQ
                             (LETT |s|
                                   (SPADCALL (QCAR (QCDR |x|)) (QREFELT $ 57))
                                   . #2#)
                             (EXIT
                              (COND
                               ((NULL (QEQCAR |s| 1))
                     ...
                     (PROGN
                      (LETT #1#
                            (|OMEXPR;outputOMPower| |dev|
                             (LIST (QCAR (QCDR |z|))
                                   (SPADCALL (QCDR (QCDR |z|)) (QREFELT $ 62)))
                             $)
                            . #2#)
                      (GO #1#))))))))
  ...
  (PROG (|s| |dev| |sp|)
    (RETURN
     (SEQ (LETT |s| "" . #1=(|OMEXPR;OMwrite;ES;13|))
          ...
          (LETT |dev| (SPADCALL |sp| (SPADCALL (QREFELT $ 70)) (QREFELT $ 71))
                . #1#)
          (SPADCALL |dev| (QREFELT $ 72)) (|OMEXPR;outputOMExpr| |dev| |ex| $)
          (SPADCALL |dev| (QREFELT $ 73)) (SPADCALL |dev| (QREFELT $ 74))
...
(DEFUN |OMEXPR;OMwrite;OmdEV;15| (|dev| |ex| $)
  (SEQ (SPADCALL |dev| (QREFELT $ 72)) (|OMEXPR;outputOMExpr| |dev| |ex| $)
...
(DEFUN |ExpressionToOpenMath| (#1=#:G224)
  (PROG ()
    (RETURN
     (PROG (#2=#:G225)
       (RETURN
