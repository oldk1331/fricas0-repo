...
(SDEFUN |FELFUN;landen2;FLFL;4|
        ((|m| (|Float|)) (|res| (|List| (|Float|))) (|eps| (|Float|))
         ($ (|List| (|Float|))))
        (SPROG
         ((|kn| (|Float|)) (|kp| (|Float|)) (#1=#:G166 NIL) (|am| (|Float|)))
         (SEQ
          (SEQ
           (EXIT
            (SEQ G190 NIL
                       ...
                       (COND
                        ((SPADCALL |am| |eps| (QREFELT $ 17))
                         (SEQ
                          ...
                          (EXIT (PROGN (LETT #1# |$NoValue|) (GO #2=#:G163)))))
                        ('T
                         (SEQ
                          (LETT |kp|
                                (SPADCALL
...
(SDEFUN |FELFUN;sn2;FLF;7|
        ...
        (SPROG ((|res| (|Float|)) (#1=#:G182 NIL) (|k| NIL))
                         ...
                         (SEQ
                          (LETT |kn|
                                (SPADCALL (SPADCALL 1 4 (QREFELT $ 29)) |m|
                                          (QREFELT $ 49)))
                          (LETT |res| (CONS |kn| |res|))
                          (EXIT (PROGN (LETT #1# |$NoValue|) (GO #2=#:G192)))))
                        ('T
                         (SEQ
                          (LETT |kp|
                                (SPADCALL
...
(SDEFUN |FELFUN;kprod;LC;11|
        ...
        (SPROG ((#1=#:G206 NIL) (|k| NIL) (#2=#:G205 NIL))
               (SEQ
                (SPADCALL (ELT $ 52)
                          (PROGN
                           (LETT #2# NIL)
...
(SDEFUN |FELFUN;sn2;CLC;12|
        ((|z| (|Complex| (|Float|))) (|ll| (|List| (|Complex| (|Float|))))
         ($ (|Complex| (|Float|))))
        (SPROG ((|res| (|Complex| (|Float|))) (#1=#:G211 NIL) (|k| NIL))
...
(SDEFUN |FELFUN;zeta2|
        ...
        (SPROG
         ((|snz| (|Float|)) (|res| (|Float|)) (|r| (|Float|))
          ...
          (|p| #2#) (|k1inv| #1#) (|k1| (|Float|)) (#3=#:G300 NIL) (|k| NIL)
...
(SDEFUN |FELFUN;theta0|
        ...
        (SPROG
         ((|t3| #2=(|Complex| (|Float|))) (|t2| (|Complex| (|Float|)))
          (|pp| #3=(|Complex| (|Float|))) (|nt3| #2#) (#4=#:G320 NIL) (|i| NIL)
          (#5=#:G321 NIL) (|iq2| #6=(|Complex| (|Float|)))
          (|liq2| (|List| (|Complex| (|Float|)))) (#7=#:G319 NIL)
...
(SDEFUN |FELFUN;reduce_periods|
        ((|w1| #1=(|Complex| (|Float|))) (|w2| #2=(|Complex| (|Float|)))
         ($ (|List| (|Complex| (|Float|)))))
        (SPROG
         ((|aw1| #3=(|Float|)) (#4=#:G333 NIL) (|rit| (|Float|))
                       ...
                       (EXIT
                        (COND
                         ((SPADCALL |rit| (|spadConstant| $ 65) (QREFELT $ 95))
                          (PROGN (LETT #4# (LIST |w1| |w2|)) (GO #5=#:G332)))
                         ('T
                          (SEQ
                           (LETT |w1|
                                 (SPADCALL |w1|
...
(SDEFUN |FELFUN;ellipticF_aux|
        ((|z| (|Complex| (|Float|))) (|m| (|Complex| (|Float|)))
         ($ (|Complex| (|Float|))))
        (SPROG
         ((|delta| (|Complex| (|Float|))) (#1=#:G366 NIL) (|k| NIL)
          (|sf| (|Float|)) (|nz| (|Float|))
...
(SDEFUN |FELFUN;ellipticE;2F;41| ((|m| (|Float|)) ($ (|Float|)))
        (SPROG
         ((|e_val| #1=(|Float|)) (|p| (|Float|)) (|k1inv| (|Float|))
          (|f_val| #1#) (|k1| (|Float|)) (#2=#:G374 NIL) (|k| NIL)
          (|ll| (|List| (|Float|))) (|eps| (|Float|))
          (|prec| (|PositiveInteger|)) (|obits| (|PositiveInteger|)))
         (SEQ
          (COND
...
(SDEFUN |FELFUN;ellipticE;2C;42|
        ...
        (SPROG
         ((|e_val| #1=(|Complex| (|Float|))) (|p| (|Complex| (|Float|)))
          ...
          (|k1| (|Complex| (|Float|))) (#2=#:G382 NIL) (|k| NIL)
          (|ll| (|List| (|Complex| (|Float|)))) (|eps| (|Float|))
          (|prec| (|PositiveInteger|)) (|obits| (|PositiveInteger|)))
         (SEQ
          (COND
...
(SDEFUN |FELFUN;ellipticE;3F;43|
        ...
        (SPROG
         ((|e_val| #1=(|Float|)) (|r| #2=(|Float|)) (|k_z2| #3=(|Float|))
          ...
          (|k1| (|Float|)) (#4=#:G398 NIL) (|k| NIL) (#5=#:G399 NIL)
          (|lz| (|List| (|Float|))) (|delta| #6=(|Float|)) (#7=#:G397 NIL)
...
(SDEFUN |FELFUN;ellipticE_aux|
        ...
        (SPROG
         ((|e_val| #2=(|Complex| (|Float|))) (|r| #3=(|Complex| (|Float|)))
          ...
          (|k1| (|Complex| (|Float|))) (#5=#:G414 NIL) (|k| NIL)
          (#6=#:G415 NIL) (|lz| (|List| (|Complex| (|Float|))))
          (|delta| (|Complex| (|Float|))) (#7=#:G413 NIL)
...
(SDEFUN |FELFUN;ellipticPi_r|
        ...
        (SPROG
         ((|pi_val| (|Float|)) (|p_inv| (|Float|)) (|f_val| (|Float|))
          (|k1| (|Float|)) (#3=#:G448 NIL) (|k| NIL) (#4=#:G449 NIL)
          (#5=#:G450 NIL) (#6=#:G451 NIL) (|p| #7=(|Float|))
          (|lnk| (|List| (|Float|))) (|nk| #2#) (|cc| #8=(|Float|))
          (|lp| (|List| (|Float|))) (#9=#:G447 NIL) (|lz| (|List| (|Float|)))
          (|delta| (|Float|)) (#10=#:G446 NIL) (|z0| #1#)
          (|llr| (|List| (|Float|))) (|ll| (|List| (|Float|)))
...
(SDEFUN |FELFUN;ellipticPi_aux|
        ...
        (SPROG
         ((|pi_val| (|Complex| (|Float|))) (|p_inv| #3=(|Complex| (|Float|)))
          ...
          (#4=#:G476 NIL) (|k| NIL) (#5=#:G477 NIL) (#6=#:G478 NIL)
          (#7=#:G479 NIL) (|p| #8=(|Complex| (|Float|)))
          (|lnk| (|List| (|Complex| (|Float|)))) (|nk| #2#)
          (|cc| #9=(|Complex| (|Float|))) (|lp| (|List| (|Complex| (|Float|))))
          (#10=#:G475 NIL) (|lz| (|List| (|Complex| (|Float|))))
          (|delta| (|Complex| (|Float|))) (#11=#:G474 NIL) (|z0| #1#)
