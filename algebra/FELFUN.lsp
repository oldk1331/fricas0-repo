...
(SDEFUN |FELFUN;landen2;FLFL;4|
        ((|m| |Float|) (|res| |List| (|Float|)) (|eps| |Float|)
         ($ |List| (|Float|)))
        (SPROG
         ((|kn| (|Float|)) (|kp| (|Float|)) (#1=#:G154 NIL) (|am| (|Float|)))
         (SEQ
          (SEQ
           (EXIT
            (SEQ G190 NIL
...
(SDEFUN |FELFUN;kprod;LF;6| ((|ll| |List| (|Float|)) ($ |Float|))
        (SPROG ((#1=#:G166 NIL) (|k| NIL) (#2=#:G165 NIL))
               (SEQ
                (SPADCALL (ELT $ 34)
                          (PROGN
...
(SDEFUN |FELFUN;sn2;FLF;7| ((|z| |Float|) (|ll| |List| (|Float|)) ($ |Float|))
        (SPROG ((|res| (|Float|)) (#1=#:G170 NIL) (|k| NIL))
               (SEQ
...
(SDEFUN |FELFUN;kprod;LC;11|
        ...
        (SPROG ((#1=#:G190 NIL) (|k| NIL) (#2=#:G189 NIL))
               (SEQ
                (SPADCALL (ELT $ 52)
                          (PROGN
...
(SDEFUN |FELFUN;sn2;CLC;12|
        ((|z| |Complex| (|Float|)) (|ll| |List| (|Complex| (|Float|)))
         ($ |Complex| (|Float|)))
        (SPROG ((|res| (|Complex| (|Float|))) (#1=#:G194 NIL) (|k| NIL))
               (SEQ
...
(SDEFUN |FELFUN;theta0|
        ...
        (SPROG
         ((|t3| #2=(|Complex| (|Float|))) (|t2| (|Complex| (|Float|)))
          (|pp| #3=(|Complex| (|Float|))) (|nt3| #2#) (|i| NIL) (#4=#:G288 NIL)
          (|iq2| #5=(|Complex| (|Float|)))
...
(SDEFUN |FELFUN;reduce_periods|
        ((|w1| . #1=(|Complex| (|Float|))) (|w2| . #2=(|Complex| (|Float|)))
         ($ |List| (|Complex| (|Float|))))
        (SPROG
         ((|aw1| #3=(|Float|)) (#4=#:G298 NIL) (|rit| (|Float|))
                   ...
                   (EXIT
                    (COND
                     ((SPADCALL |rit| (|spadConstant| $ 65) (QREFELT $ 95))
                      (PROGN (LETT #4# (LIST |w1| |w2|) . #5#) (GO #4#)))
                     ('T
                      (SEQ
                       (LETT |w1|
                             (SPADCALL |w1|
...
(SDEFUN |FELFUN;ellipticF;3F;35| ((|z| |Float|) (|m| |Float|) ($ |Float|))
        (SPROG
         ((|res| (|Float|)) (|delta| (|Float|)) (#1=#:G316 NIL) (|k| NIL)
          (|ll| (|List| (|Float|))) (|eps| (|Float|))
...
(SDEFUN |FELFUN;ellipticF_aux|
        ((|z| . #1=(|Complex| (|Float|))) (|m| |Complex| (|Float|))
         ($ |Complex| (|Float|)))
        (SPROG
         ((|delta| (|Complex| (|Float|))) (#2=#:G325 NIL) (|k| NIL)
...
(SDEFUN |FELFUN;ellipticE;2F;38| ((|m| |Float|) ($ |Float|))
        (SPROG
         ((|e_val| #1=(|Float|)) (|p| (|Float|)) (|k1inv| (|Float|))
          (|f_val| #1#) (|k1| (|Float|)) (#2=#:G332 NIL) (|k| NIL)
...
(SDEFUN |FELFUN;ellipticE;2C;39|
        ...
        (SPROG
         ((|e_val| #1=(|Complex| (|Float|))) (|p| (|Complex| (|Float|)))
          ...
          (|k1| (|Complex| (|Float|))) (#2=#:G339 NIL) (|k| NIL)
...
(SDEFUN |FELFUN;ellipticE;3F;40| ((|z| |Float|) (|m| |Float|) ($ |Float|))
        (SPROG
         ((|e_val| #1=(|Float|)) (|r| #2=(|Float|)) (|k_z2| #3=(|Float|))
          ...
          (|k1| (|Float|)) (#4=#:G353 NIL) (|k| NIL) (#5=#:G354 NIL)
          (|lz| (|List| (|Float|))) (|delta| #6=(|Float|)) (#7=#:G352 NIL)
          (|llr| (|List| (|Float|))) (|ll| (|List| (|Float|)))
...
(SDEFUN |FELFUN;ellipticE_aux|
        ...
        (SPROG
         ((|e_val| #2=(|Complex| (|Float|))) (|r| #3=(|Complex| (|Float|)))
          ...
          (|k1| (|Complex| (|Float|))) (#6=#:G366 NIL) (|k| NIL)
          (#7=#:G367 NIL) (|lz| (|List| (|Complex| (|Float|))))
          (|delta| (|Complex| (|Float|))) (#8=#:G365 NIL) (|zz| #4#)
