...
(SDEFUN |RPOLCAT-;coerce;SOf;1| ((|p| (S)) (% (|OutputForm|)))
        (SPROG
         ((|ip| (S)) (|tp| (S)) (|dp| (|NonNegativeInteger|)) (#1=#:G146 NIL))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |RPOLCAT-;head;2S;6| ((|p| (S)) (% (S)))
        (SPROG ((#1=#:G166 NIL) (|v| (V)) (|d| (|NonNegativeInteger|)))
               (SEQ
...
(SDEFUN |RPOLCAT-;mainMonomials;SL;18| ((|p| (S)) (% (|List| S)))
        (SPROG
         ((#1=#:G215 NIL) (|v| (V))
          (|lm| (|List| (|SparseUnivariatePolynomial| S))) (#2=#:G223 NIL)
          (|m| NIL) (#3=#:G224 NIL))
         (SEQ
          (COND
           ((SPADCALL |p| (QREFELT % 20))
...
(SDEFUN |RPOLCAT-;lazyPrem;2SVS;28| ((|a| (S)) (|b| (S)) (|v| (V)) (% (S)))
        (SPROG
         ((|dbv| #1=(|NonNegativeInteger|)) (|dav| #1#) (|lcbv| (S))
          (|lcav| (S)) (#2=#:G267 NIL) (|term| (S)) (|test| (|Integer|)))
         (SEQ
          (COND
...
(SDEFUN |RPOLCAT-;lazyPremWithDefault;2SR;32|
        ...
        (SPROG
         ((|xa| (V)) (|xb| (V)) (|lcb| (S)) (|db| (|NonNegativeInteger|))
          (#1=#:G309 NIL) (#2=#:G316 NIL) (|term| (S)) (|delta| (|Integer|))
          (|test| (|Integer|)) (#3=#:G320 NIL))
         (SEQ
          (COND
           ((SPADCALL |b| (QREFELT % 11))
            (|error|
...
(SDEFUN |RPOLCAT-;lazyPremWithDefault;2SVR;33|
        ...
        (SPROG
         ((|dbv| #1=(|NonNegativeInteger|)) (|dav| #1#) (|lcbv| (S))
          (|lcav| (S)) (#2=#:G331 NIL) (|term| (S)) (|delta| (|Integer|))
          (|test| (|Integer|)) (#3=#:G335 NIL))
         (SEQ
          (COND
           ((SPADCALL |b| (QREFELT % 20))
            (|error|
...
(SDEFUN |RPOLCAT-;lazyPseudoDivide;2SR;35|
        ...
        (SPROG
         ((|xa| (V)) (|xb| (V)) (|lcb| (S)) (|db| (|NonNegativeInteger|))
          (#1=#:G352 NIL) (#2=#:G359 NIL) (|term| (S)) (|q| (S))
          (|delta| (|Integer|)) (|test| (|Integer|)) (#3=#:G363 NIL))
         (SEQ
          (COND
           ((SPADCALL |b| (QREFELT % 11))
            (|error|
...
(SDEFUN |RPOLCAT-;lazyPseudoDivide;2SVR;36|
        ...
        (SPROG
         ((|dbv| #1=(|NonNegativeInteger|)) (|dav| #1#) (|lcbv| (S))
          (|lcav| (S)) (#2=#:G374 NIL) (|term| (S)) (|q| (S))
          (|delta| (|Integer|)) (|test| (|Integer|)) (#3=#:G378 NIL))
         (SEQ
          (COND
           ((SPADCALL |b| (QREFELT % 20))
            (|error|
...
(SDEFUN |RPOLCAT-;mainContent;2S;61| ((|p| (S)) (% (S)))
        (SPROG
         ((#1=#:G0 NIL) (#2=#:G484 NIL) (#3=#:G481 (S)) (#4=#:G479 (S))
          (#5=#:G480 NIL))
         (SEQ
          (COND ((SPADCALL |p| (QREFELT % 20)) |p|)
                (#6='T
...
(SDEFUN |RPOLCAT-;mainSquareFreePart;2S;63| ((|p| (S)) (% (S)))
        (SPROG
         ((#1=#:G492 NIL) (|v| (V)) (|sfp| (|SparseUnivariatePolynomial| S)))
         (SEQ
          (COND ((SPADCALL |p| (QREFELT % 11)) |p|)
                ('T
                 (SEQ
...
(SDEFUN |RPOLCAT-;localRetract| ((|p| (|Polynomial| R)) (% (S)))
        (SPROG
         ((#1=#:G509 NIL) (|mvp| (|Symbol|)) (#2=#:G511 NIL)
...
(SDEFUN |RPOLCAT-;localRetractPQ|
        ...
        (SPROG
         ((#1=#:G520 NIL) (|mvp| (|Symbol|)) (#2=#:G522 NIL)
          (|imvp| (|PositiveInteger|)) (|vimvp| (V))
          (|d| (|NonNegativeInteger|)) (|c| (S)) (|xvimvp| (S)) (|newp| (S)))
         (SEQ
          (COND
...
(SDEFUN |RPOLCAT-;localRetractPZ| ((|pz| (|Polynomial| (|Integer|))) (% (S)))
        (SPROG
         ((#1=#:G531 NIL) (|mvp| (|Symbol|)) (#2=#:G533 NIL)
          (|imvp| (|PositiveInteger|)) (|vimvp| (V))
          (|d| (|NonNegativeInteger|)) (|c| (S)) (|xvimvp| (S)) (|newp| (S)))
         (SEQ
          (COND
...
(DEFUN |RecursivePolynomialCategory&| (|#1| |#2| |#3| |#4|)
  (SPROG
   ((DV$1 NIL) (DV$2 NIL) (DV$3 NIL) (DV$4 NIL) (|dv$| NIL) (% NIL) (|pv$| NIL)
    (#1=#:G787 NIL) (|i| NIL) (#2=#:G788 NIL) (#3=#:G506 NIL))
   (SEQ
    (PROGN
