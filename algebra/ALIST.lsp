...
(DEFUN |AssociationList| (&REST #1=#:G266)
  (PROG ()
    (RETURN
     (PROG (#2=#:G267)
       (RETURN
...
(DEFUN |AssociationList;| (|#1| |#2|)
  (PROG (#1=#:G263 #2=#:G265 #3=#:G264 |pv$| #4=#:G261 #5=#:G262 $ |dv$| DV$2
         DV$1)
    (RETURN
     (PROGN
