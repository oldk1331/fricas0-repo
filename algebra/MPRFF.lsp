         ...
         (SEQ
          ...
          (LETT |ffact|
                (PROGN
                 (LETT #10# NIL . #12#)
                 (SEQ (LETT |u| NIL . #12#)
                      (LETT #9# (SPADCALL |flist| (QREFELT $ 28)) . #12#) G190
                      (COND
          ...
          (LETT |fcont|
                (SPADCALL
                 (SPADCALL (SPADCALL |flist| (QREFELT $ 30)) (QREFELT $ 16))
                 (QREFELT $ 29))
                . #12#)
          (SEQ (LETT |x| NIL . #12#) (LETT #8# |truelist| . #12#) G190
               (COND
                ((OR (ATOM #8#) (PROGN (LETT |x| (CAR #8#) . #12#) NIL))
                 (GO G191)))
               (SEQ (LETT |fcont| (SPADCALL |fcont| |x| (QREFELT $ 31)) . #12#)
                    (EXIT
                     (LETT |ffact|
                           (PROGN
                            (LETT #7# NIL . #12#)
        ...
        (SPROG ((|ug| (|SparseUnivariatePolynomial| PRF)) (|rf| (PRF)))
               (SEQ
                (COND ((SPADCALL |g| (QREFELT $ 41)) |g|)
                      ('T
                       (SEQ
                        (LETT |rf| (|spadConstant| $ 42)
                              . #1=(|MPRFF;pushdown;PRFOVPRF;2|))
                        (LETT |ug| (SPADCALL |g| |x| (QREFELT $ 44)) . #1#)
                        (SEQ G190
                             (COND
                              ((NULL
         ...
         (SEQ
          ...
          (LETT |cf|
                (SPADCALL
                 ...
                 (QREFELT $ 16))
                . #1#)
          (EXIT (SPADCALL |cf| (SPADCALL |t| (QREFELT $ 61)) (QREFELT $ 32)))))) 
           ...
           ('T
            (SEQ
             (LETT |v|
                   ...
                   . #2#)
             (LETT |g| (SPADCALL |f| |v| (QREFELT $ 44)) . #2#)
             (EXIT
              (SPADCALL
                 ...
                 ('T
                  (SEQ
                   (SEQ (LETT |x| NIL . #2=(|MPRFF;totalfract;PRFR;7|))
                        ...
                        (SEQ
                         (EXIT
                          (LETT |p| (SPADCALL |p| |x| (QREFELT $ 53)) . #2#)))
                       ...
                       (CONS '#()
                             (|makeByteWordVec2| 83
                                                 '(1 9 10 0 11 1 15 0 14 16 1
                                                   ...
                                                   27 0 28 1 9 0 15 29 1 18 14
                                                   0 30 2 9 0 15 0 32 2 34 0 9
                                                   33 35 2 34 0 0 0 36 0 34 0
                                                   37 2 34 0 9 0 38 1 9 40 0 41
                                                   0 9 0 42 2 9 43 0 7 44 0 6 0
                                                   45 0 8 0 46 0 47 0 48 2 47
                                                   40 0 0 49 2 9 0 0 0 51 1 47
                                                   0 0 52 1 47 33 0 54 0 8 0 55
                                                   0 9 0 56 1 7 57 0 58 0 14 0
                                                   59 3 14 0 0 57 33 60 1 47 9
                                                   0 61 1 9 15 0 62 1 9 64 0 65
                                                   2 47 0 66 0 67 2 9 0 43 7 68
                                                   1 15 14 0 69 2 14 33 0 57 70
                                                   2 33 40 0 0 71 1 15 14 0 72
                                                   2 14 43 0 57 73 0 74 0 76 2
                                                   74 40 0 0 77 1 74 14 0 78 1
                                                   74 33 0 79 3 9 0 0 7 33 80 1
                                                   74 0 0 81 2 9 40 0 0 82 0 14
                                                   0 83 1 0 12 9 13 2 0 9 9 7
                                                   31 2 0 9 15 7 63 2 0 9 74 7
                                                   75 2 0 9 47 7 50 2 0 9 9 7
                                                   53 1 0 34 9 39)))))
           '|lookupComplete|)) 
