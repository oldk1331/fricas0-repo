         ...
         ((|ll| (|List| (|SparseUnivariatePolynomial| F)))
          (|bc|
           (|Union|
            ...
            "failed"))
          (#1=#:G190 NIL) (#2=#:G191 NIL)
          (|p| (|SparseUnivariatePolynomial| (|Polynomial| F)))
          (|u| (|Union| (|Polynomial| F) "failed")) (#3=#:G192 NIL) (|v| NIL)
