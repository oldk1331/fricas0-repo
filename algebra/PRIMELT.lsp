         ...
         ((|ll| (|List| (|SparseUnivariatePolynomial| F)))
          (|bc|
           (|Union|
            ...
            "failed"))
          (#1=#:G175 NIL) (#2=#:G176 NIL)
          (|p| (|SparseUnivariatePolynomial| (|Polynomial| F)))
          (|u| (|Union| (|Polynomial| F) "failed")) (#3=#:G177 NIL) (|v| NIL)
