...
(SDEFUN |NCODIV;leftDivide;2PR;1|
        ...
        (SPROG ((|q| (P)) (|r| (P)) (|h| (P)) (#1=#:G108 NIL) (|iv| (F)))
               (SEQ
                ...
                (LETT |r| |a| . #2#)
                (LETT |iv|
                      (SPADCALL (SPADCALL |b| (QREFELT $ 9)) (QREFELT $ 10))
                      . #2#)
                (SEQ G190
                     (COND
                      ((NULL
                     ...
                     (SEQ
                      ...
                      (LETT |r|
                            ...
                            . #2#)
                      (EXIT
                       (LETT |q| (SPADCALL |q| |h| (QREFELT $ 20)) . #2#)))
                     NIL (GO G190) G191 (EXIT NIL))
                (EXIT (CONS |q| |r|))))) 

(SDEFUN |NCODIV;leftQuotient;3P;2| ((|a| P) (|b| P) ($ P))
        (QCAR (SPADCALL |a| |b| (QREFELT $ 22)))) 

(SDEFUN |NCODIV;leftRemainder;3P;3| ((|a| P) (|b| P) ($ P))
        (QCDR (SPADCALL |a| |b| (QREFELT $ 22)))) 

(SDEFUN |NCODIV;leftExactQuotient;2PU;4|
        ((|a| P) (|b| P) ($ |Union| P "failed"))
        (SPROG ((|qr| (|Record| (|:| |quotient| P) (|:| |remainder| P))))
               (SEQ
...
(SDEFUN |NCODIV;leftGcd;3P;5| ((|a| P) (|b| P) ($ P))
        (SPROG ((|#G15| (P)) (|#G14| (P)))
               (SEQ
                (COND ((SPADCALL |a| (|spadConstant| $ 8) (QREFELT $ 25)) |b|)
                      ...
                      (#1='T
                       (SEQ
                             ...
                             (SEQ
                              (EXIT
                               (PROGN
                                ...
                                (LETT |#G15| (SPADCALL |a| |b| (QREFELT $ 24))
                                      . #2#)
                                (LETT |a| |#G14| . #2#)
                                (LETT |b| |#G15| . #2#))))
                             NIL (GO G190) G191 (EXIT NIL))
                        (EXIT
                         (COND
                          ((SPADCALL |b| (|spadConstant| $ 8) (QREFELT $ 25))
                           |a|)
                          (#1# |b|))))))))) 

(SDEFUN |NCODIV;leftLcm;3P;6| ((|a| P) (|b| P) ($ P))
        (SPROG
         ((|v| (P)) (|u| (P)) (|#G21| (P)) (|#G20| (P)) (|#G19| (P))
          (|#G18| (P)) (|qr| (|Record| (|:| |quotient| P) (|:| |remainder| P)))
          (|b0| (P)))
         (SEQ
          (COND ((SPADCALL |a| (|spadConstant| $ 8) (QREFELT $ 25)) |b|)
                ((SPADCALL |b| (|spadConstant| $ 8) (QREFELT $ 25)) |a|)
                ('T
                 (SEQ (LETT |b0| |b| . #1=(|NCODIV;leftLcm;3P;6|))
                      (LETT |u|
                            (SPADCALL (|spadConstant| $ 31) 0 (QREFELT $ 17))
                            . #1#)
                      ...
                      (SEQ G190
                           (COND
                            ((NULL
                             ...
                             (GO G191)))
                           (SEQ
                            (LETT |qr| (SPADCALL |a| |b| (QREFELT $ 22)) . #1#)
                            (PROGN
                             (LETT |#G18| |b| . #1#)
                             (LETT |#G19| (QCDR |qr|) . #1#)
                             (LETT |a| |#G18| . #1#)
           ...
           (RETURN
            (COND
             ...
             ('T
              (UNWIND-PROTECT
                  (PROG1
                      (APPLY (|function| |NonCommutativeOperatorDivision;|)
                             #1#)
                    (LETT #2# T . #3#))
                (COND
                 ((NOT #2#)
  ...
  (SPROG ((|pv$| NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
         (PROGN
          (LETT DV$1 (|devaluate| |#1|)
                . #1=(|NonCommutativeOperatorDivision|))
