...
(SDEFUN |CHARPOL3;char_pol_via_interpolation0|
        ...
        (SPROG
         ((#1=#:G113 NIL) (|j| NIL) (#2=#:G114 NIL) (|di| NIL)
          ...
          (|d1| (R)) (#3=#:G112 NIL) (|i| NIL) (|v| (|SingletonAsOrderedSet|))
...
(SDEFUN |CHARPOL3;char_pol_via_interpolation;MSup;2|
        ...
        (SPROG
         ((|p1| (|SparseUnivariatePolynomial| (|Fraction| R)))
          (|ld| (|List| R)) (#1=#:G121 NIL) (|i| NIL) (#2=#:G120 NIL))
         (SEQ
          (LETT |ld|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |CHARPOL3;to_common_denominator|
        ...
        (SPROG
         ((|g1| (R)) (#1=#:G128 NIL) (|a| (|Fraction| R)) (#2=#:G138 NIL)
          (|j| NIL) (|lg| (|List| R)) (|g| (R)) (|lr| (|List| R))
          (#3=#:G137 NIL) (#4=#:G136 NIL) (|i| NIL) (B (|Matrix| R))
...
(DEFUN |CharacteristicPolynomial3| (#1=#:G148)
  (SPROG NIL
         (PROG (#2=#:G149)
           (RETURN
            (COND
