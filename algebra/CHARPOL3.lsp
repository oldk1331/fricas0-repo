...
(SDEFUN |CHARPOL3;char_pol_via_interpolation0|
        ...
        (SPROG
         ((#1=#:G127 NIL) (|j| NIL) (#2=#:G128 NIL) (|di| NIL)
          ...
          (|d1| (R)) (#3=#:G126 NIL) (|i| NIL) (|v| (|SingletonAsOrderedSet|))
...
(SDEFUN |CHARPOL3;char_pol_via_interpolation;MSup;2|
        ...
        (SPROG
         ((|p1| (|SparseUnivariatePolynomial| (|Fraction| R)))
          (|ld| (|List| R)) (#1=#:G134 NIL) (|i| NIL) (#2=#:G133 NIL))
         (SEQ
          (LETT |ld|
                (PROGN
                 (LETT #2# NIL)
...
(SDEFUN |CHARPOL3;to_common_denominator|
        ...
        (SPROG
         ((|g1| (R)) (#1=#:G138 NIL) (|a| (|Fraction| R)) (#2=#:G148 NIL)
          (|j| NIL) (|lg| (|List| R)) (|g| (R)) (|lr| (|List| R))
          (#3=#:G147 NIL) (#4=#:G146 NIL) (|i| NIL) (B (|Matrix| R))
...
(DEFUN |CharacteristicPolynomial3| (#1=#:G158)
  (SPROG NIL
         (PROG (#2=#:G159)
           (RETURN
            (COND
