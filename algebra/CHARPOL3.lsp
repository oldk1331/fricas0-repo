...
(MAKEPROP '|CharacteristicPolynomial3| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|Boolean|)
              ...
              (137 . |0|) (141 . |0|) (145 . |denom|) (|List| %) (150 . |lcm|)
              (|Union| % '"failed") (155 . |exquo|) (161 . |numer|) (166 . *)
              (|Mapping| 6 6 6) (|List| 6) (172 . |reduce|) (179 . /)
              (|Matrix| 20) (185 . |det_via_common_denominator|)
              (|Mapping| 20 20) (190 . |map|)
              (196 . |char_pol_via_den_interpolation|))
