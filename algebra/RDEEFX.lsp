...
(SDEFUN |RDEEFX;ei_args2|
        ...
        (SPROG
         ((|res|
          ...
          (|f1| #1=(|SparseUnivariatePolynomial| F)) (#2=#:G584 NIL)
          (|fac| NIL)
          (|rfac|
           (|List|
...
(SDEFUN |RDEEFX;gen_irr_log_cands|
        ...
        (SPROG
         ((|uu| (F)) (|ai| (F)) (#1=#:G774 NIL) (|i| NIL) (|tt| (F))
          ...
          (|a1| (F)) (|coeffs| #7#) (|dvvec| (|Vector| F)) (#13=#:G764 NIL)
          (#14=#:G763 NIL) (|v'| (F)) (|lw2'| (F)) (|w2| (F))
          (|lw2| (|List| F)))
...
(SDEFUN |RDEEFX;irrational_gamma_candidates|
        ...
        (SPROG
         ((|w1| (F)) (|a| (F)) (|km| #1=(|Integer|)) (|s| #1#) (|kmq| NIL)
          ...
          (|#G211| #2#) (#3=#:G813 NIL) (|sk| NIL) (|lsk| (|List| #2#))
          (|tk| (|Kernel| F)) (|w0| (F)) (|ak| (F)) (#4=#:G811 NIL) (|li| NIL)
          (#5=#:G812 NIL) (|kk| NIL) (|rl| (|List| (|Integer|)))
          (|cl| (|List| F)) (#6=#:G807 NIL) (|f2| (F)) (|ck| (F))
          (|nf1| (|SparseUnivariatePolynomial| F))
          (|nfr| (|Fraction| (|SparseUnivariatePolynomial| F))) (#7=#:G810 NIL)
          (|f| (F)) (|nlk| (|List| (|Kernel| F))) (#8=#:G809 NIL)
          (#9=#:G808 NIL) (|n1| (|NonNegativeInteger|)))
         (SEQ
          (EXIT
           (SEQ
            (COND
...
(SDEFUN |RDEEFX;gammas1|
        ...
        (SPROG
         ((|fnf| (|Factored| (|SparseUnivariatePolynomial| F)))
          ...
          (|deg1| (|NonNegativeInteger|))
          (|f1| #1=(|SparseUnivariatePolynomial| F)) (#2=#:G831 NIL)
          (|fac| NIL) (|e_tt| (|List| F))
          (|rfacs|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
...
(SDEFUN |RDEEFX;special_candidates|
        ...
        (SPROG
         ((|res1|
          ...
          (|ru| (|Union| (|Integer|) "failed")) (#2=#:G857 NIL) (|sol| NIL)
          (|lsol|
           (|List|
            (|Record| (|:| |ratpart| (|Fraction| (|Integer|)))
                      (|:| |alg_part| (|SparseUnivariatePolynomial| F)))))
          (|f_res1| (F)) (|tx_plus_b| #1#) (|bk| #3=(|Kernel| F))
          (|bs| #4=(|Symbol|)) (#5=#:G856 NIL) (|r0| NIL)
          ...
          (|n1| #8=(|NonNegativeInteger|)) (|a| (|Integer|)) (#9=#:G855 NIL)
        ...
        ((|rr1f| (F)) (|csol| (|Vector| F)) (|a1p| (F)) (|as| (|Vector| F))
         ...
         ($
          (|Record| (|:| |ans| F) (|:| |right| F) (|:| |primpart| F)
                    (|:| |sol?| (|Boolean|)))))
        (SPROG
         ((|cand_prims| (|List| F)) (|ansp| (F)) (#1=#:G865 NIL) (|i| NIL))
...
(SDEFUN |RDEEFX;exp_lower_bound|
        ...
        (SPROG
         ((|min_deg| (|Integer|)) (|max_deg| (|Integer|))
          (|c_degs| (|List| (|NonNegativeInteger|))) (#1=#:G886 NIL)
          (|scoeff| NIL) (#2=#:G885 NIL)
         ...
         ((|as| (|Vector| F))
          ...
          (|partu|
           (|Union| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F)))
                    "failed"))
          (|g1| (F)) (|lg1| (|List| F)) (#1=#:G897 NIL) (|scoeff| NIL)
          (#2=#:G896 NIL))
         (SEQ
          (LETT |lg1|
                (PROGN
...
(SDEFUN |RDEEFX;special_integrate1|
        ...
        (SPROG
         ((|res3|
          ...
          (|res2|
           (|Record| (|:| |ans| F) (|:| |defect| F) (|:| |sol?| (|Boolean|))))
          (#2=#:G927 NIL) (|scoeff| NIL) (#3=#:G928 NIL) (|i| NIL)
          (|as| #4=(|Vector| F)) (|vs| #4#) (|rr1f| (F)) (|a1p| (F))
          (|inv_den1| (F)) (|nfp1| #1#) (|ak| (F)) (#5=#:G926 NIL)
          (#6=#:G925 NIL) (|mm| (|SparseUnivariatePolynomial| F))
          (#7=#:G912 NIL) (|neg_deg| (|Integer|)) (|eta| (F)) (#8=#:G908 NIL))
         (SEQ
          (LETT |neg_deg|
                (COND
                 ((SPADCALL |k| '|exp| (QREFELT $ 22))
...
(SDEFUN |RDEEFX;mk_pow|
        ...
        (SPROG
         ((|res2| (F)) (|lp| (|List| F)) (#1=#:G951 NIL) (|ui| NIL) (|i| NIL)
          (#2=#:G950 NIL) (|res| (F)))
         (SEQ
          (LETT |res|
        ...
        ((|denf| #1=(|SparseUnivariatePolynomial| F)) (|k| (|Kernel| F))
         ($
          (|Record| (|:| |radicand| (|SparseUnivariatePolynomial| F))
                    (|:| |exponent| (|Integer|)))))
        (SPROG
         ((|gden1| (|SparseUnivariatePolynomial| F)) (#2=#:G1305 NIL)
          (#3=#:G1300 NIL) (#4=#:G1313 NIL) (|fac1| NIL) (#5=#:G1312 NIL)
          (|l1| (|Integer|)) (|lexp| (|List| (|Integer|))) (#6=#:G1311 NIL)
          (#7=#:G1310 NIL)
          (|nffacs|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
...
(SDEFUN |RDEEFX;special_Hermite|
        ...
        (SPROG
         ((|mult| (|SparseUnivariatePolynomial| F))
          (|denr| #1=(|SparseUnivariatePolynomial| F)) (#2=#:G1321 NIL)
...
(SDEFUN |RDEEFX;ei_int_log|
        ...
        (SPROG
         ((|is_sol| (|Boolean|)) (|rh| (F)) (|r1| (F))
          ...
          (#1=#:G1339 NIL) (|k1| NIL) (#2=#:G1338 NIL) (|ngu| (F)))
         (SEQ
          (LETT |ngu|
...
(SDEFUN |RDEEFX;get_scoeff|
        ...
        (SPROG
         ((|gt| #2=(|Fraction| (|SparseUnivariatePolynomial| F)))
          ...
          (|l1| (|NonNegativeInteger|)) (#4=#:G1353 NIL) (|rf1k| (|Kernel| F))
          (|rfc| (F)) (|coeff1_r| #2#)
...
(SDEFUN |RDEEFX;get_prims|
        ((|scand|
         ...
         (|k| (|Kernel| F)) ($ (|List| F)))
        (SPROG
         ((|res| (|List| F)) (|f1| (F)) (#1=#:G1436 NIL) (|zz| NIL) (|f11| (F))
          (|ff| (F)) (|c1s| (F)) (|j1| (F)) (#2=#:G1435 NIL) (|j| NIL)
          (|nf2| (|Fraction| (|SparseUnivariatePolynomial| F))) (|lf| (F))
          (|l1| (|NonNegativeInteger|)) (#3=#:G1422 NIL) (|zzl| (|List| F))
...
(SDEFUN |RDEEFX;ei_int;I2FSR;58|
        ...
        (SPROG
         ((|res3|
          ...
          (|rr1f| (F)) (#4=#:G1530 NIL) (|aa| (F)) (|res7| #1#)
          (#5=#:G1531 NIL) (|ff| (F))
          ...
          (|ar1|
           (|Record| (|:| |primpart| F)
                     ...
                     (|:| |specpart|
                          (|Fraction| (|SparseUnivariatePolynomial| F)))))
          (|ulst| (|List| F)) (#10=#:G1540 NIL) (|kk| NIL) (#11=#:G1539 NIL)
          (|vlst| (|List| F)) (#12=#:G1538 NIL) (#13=#:G1537 NIL)
          (|lk1| (|List| (|Kernel| F))) (#14=#:G1536 NIL) (#15=#:G1535 NIL)
          ...
          (|fpu| #18#) (|lk| (|List| (|Kernel| F))) (#19=#:G1534 NIL)
          (#20=#:G1533 NIL) (|k| (|Kernel| F)) (|fp| (F)))
         (SEQ
          (EXIT
           (SEQ
            (LETT |lk|
...
(DEFUN |ElementaryRischDEX| (&REST #1=#:G1541)
  (SPROG NIL
         (PROG (#2=#:G1542)
           (RETURN
            (COND
