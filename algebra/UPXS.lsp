...
(SDEFUN |UPXS;approximateLaurent|
        ((|x| |UnivariateLaurentSeries| |Coef| |var| |cen|) (|term| |Coef|)
         (|n| |Integer|) ($ |Coef|))
        (SPROG
         ((|app| (|Coef|)) (#1=#:G162 NIL) (|m| (|Integer|)) (|e| (|Integer|)))
...
(SDEFUN |UPXS;termsToOutputForm|
        ...
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|uu1| (|Stream| |Coef|)) (|n| NIL)
          (#1=#:G194 NIL) (|count| (|NonNegativeInteger|)))
         (SEQ (LETT |l| NIL)
              (EXIT
               (COND
...
(DEFUN |UnivariatePuiseuxSeries| (&REST #1=#:G225)
  (SPROG NIL
         (PROG (#2=#:G226)
           (RETURN
            (COND
...
(DEFUN |UnivariatePuiseuxSeries;| (|#1| |#2| |#3|)
  (SPROG
   ((|pv$| NIL) (#1=#:G218 NIL) (#2=#:G219 NIL) (#3=#:G220 NIL) (#4=#:G221 NIL)
    (#5=#:G223 NIL) ($ NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
           ...
           (CONS
            (|makeByteWordVec2| 27
                                '(0 0 6 0 6 0 6 6 0 6 16 6 15 6 1 2 10 4 3 15
                                  ...
                                  21 7 7 27 26 18 18 0 0 25 18 0 0 0 0 0 15 7 0
                                  0 0 0 0 5 20 15 16 6 6 7 7 7 7 7 7))
            (CONS
