...
(SDEFUN |UPOLYC-;factor;SF;20| ((|p| (S)) ($ (|Factored| S)))
        (SPROG
         ((#1=#:G223 NIL) (|w| NIL) (#2=#:G222 NIL) (|ansR| (|Factored| R)))
         (SEQ
          (COND
           ((ZEROP (SPADCALL |p| (QREFELT $ 11)))
            (SEQ
...
(SDEFUN |UPOLYC-;vectorise;SNniV;21|
        ...
        (SPROG
         ((#1=#:G225 NIL) (#2=#:G229 NIL) (|i| NIL) (|m| (|Integer|))
          (|v| (|Vector| R)))
         (SEQ
          (LETT |m|
...
(SDEFUN |UPOLYC-;unvectorise;VS;22| ((|v| (|Vector| R)) ($ (S)))
        (SPROG ((|p| (S)) (#1=#:G231 NIL) (#2=#:G235 NIL) (|i| NIL))
...
(SDEFUN |UPOLYC-;nextItemInner| ((|n| (S)) ($ (|Union| S #1="failed")))
        (SPROG
         ((|n3| #2=(|Union| R #3="failed")) (#4=#:G253 NIL)
...
(SDEFUN |UPOLYC-;nextItem;SU;27| ((|n| (S)) ($ (|Union| S #1="failed")))
        (SPROG ((#2=#:G266 NIL) (|n1| (|Union| S "failed")))
...
(SDEFUN |UPOLYC-;differentiate;SM2S;31|
        ...
        (SPROG
         ((|d| (S)) (#1=#:G284 NIL) (|lc| (R)) (|dg| (|NonNegativeInteger|)))
...
(SDEFUN |UPOLYC-;ncdiff| ((|n| (|NonNegativeInteger|)) (|x'| (S)) ($ (S)))
        (SPROG ((|n1| (|NonNegativeInteger|)) (#1=#:G300 NIL))
...
(SDEFUN |UPOLYC-;differentiate;2S;35| ((|x| (S)) ($ (S)))
        (SPROG ((|d| (S)) (#1=#:G312 NIL) (|dg| (|NonNegativeInteger|)))
               (SEQ (LETT |d| (|spadConstant| $ 60))
                    (SEQ G190
                         (COND
                          ((NULL
...
(SDEFUN |UPOLYC-;pseudoRemainder;3S;37| ((|p| (S)) (|q| (S)) ($ (S)))
        (SPROG
         ((|n| (|NonNegativeInteger|)) (#1=#:G325 NIL) (#2=#:G332 NIL)
          (|u| (|Union| (|NonNegativeInteger|) "failed")) (#3=#:G318 NIL)
...
(SDEFUN |UPOLYC-;pseudoQuotient;3S;39| ((|p| (S)) (|q| (S)) ($ (S)))
        (SPROG
         ((|quot| (S)) (|mon| (S)) (#1=#:G337 NIL) (|i| (|NonNegativeInteger|))
          (#2=#:G336 NIL) (|delta| (|Integer|)) (#3=#:G334 NIL) (|lcQ| (R))
...
(SDEFUN |UPOLYC-;pseudoDivide;2SR;40|
        ...
        (SPROG
         ((|quot| (S)) (|mon| (S)) (#1=#:G349 NIL) (|i| (|NonNegativeInteger|))
          (#2=#:G348 NIL) (|delta| (|Integer|)) (|co| (R)) (#3=#:G346 NIL)
...
(SDEFUN |UPOLYC-;composite;2SU;42|
        ...
        (SPROG
         ((#2=#:G381 NIL) (|w| #3=(|Union| S "failed")) (|u| (|Union| S #1#))
          (|v| #3#)
          (|cqr|
           (|Record| (|:| |coef| R) (|:| |quotient| S) (|:| |remainder| S))))
         (SEQ
...
(SDEFUN |UPOLYC-;elt;S2F;43|
        ...
        (SPROG
         ((|ans| (|Fraction| S)) (#1=#:G388 NIL) (|n| (|NonNegativeInteger|)))
         (SEQ
...
(SDEFUN |UPOLYC-;order;2SNni;44|
        ...
        (SPROG
         ((|ans| (|NonNegativeInteger|)) (#1=#:G404 NIL)
          (|u| (|Union| S "failed")))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |UPOLYC-;divide;2SR;51|
        ...
        (SPROG
         ((|quot| (S)) (|n| (|NonNegativeInteger|)) (#1=#:G419 NIL) (|f| (R))
          (|lc| (R)))
         (SEQ
          (COND
