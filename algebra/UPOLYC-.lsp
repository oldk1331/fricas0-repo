...
(SDEFUN |UPOLYC-;factor;SF;20| ((|p| S) ($ |Factored| S))
        (SPROG
         ((#1=#:G222 NIL) (|w| NIL) (#2=#:G221 NIL) (|ansR| (|Factored| R)))
         (SEQ
          (COND
           ((ZEROP (SPADCALL |p| (QREFELT $ 11)))
            (SEQ
...
(SDEFUN |UPOLYC-;vectorise;SNniV;21|
        ...
        (SPROG
         ((#1=#:G223 NIL) (#2=#:G227 NIL) (|i| NIL) (|m| (|Integer|))
          (|v| (|Vector| R)))
         (SEQ
          (LETT |m|
                (SPADCALL
...
(SDEFUN |UPOLYC-;unvectorise;VS;22| ((|v| |Vector| R) ($ S))
        (SPROG ((|p| (S)) (#1=#:G228 NIL) (#2=#:G232 NIL) (|i| NIL))
               (SEQ
...
(SDEFUN |UPOLYC-;nextItemInner| ((|n| S) ($ |Union| S #1="failed"))
        (SPROG
         ((|n3| #2=(|Union| R #3="failed")) (#4=#:G250 NIL)
...
(SDEFUN |UPOLYC-;nextItem;SU;27| ((|n| S) ($ |Union| S #1="failed"))
        (SPROG ((#2=#:G263 NIL) (|n1| (|Union| S "failed")))
               (SEQ
...
(SDEFUN |UPOLYC-;differentiate;SM2S;31|
        ...
        (SPROG
         ((|d| (S)) (#1=#:G280 NIL) (|lc| (R)) (|dg| (|NonNegativeInteger|)))
         (SEQ
...
(SDEFUN |UPOLYC-;ncdiff| ((|n| |NonNegativeInteger|) (|x'| S) ($ S))
        (SPROG ((|n1| (|NonNegativeInteger|)) (#1=#:G296 NIL))
...
(SDEFUN |UPOLYC-;differentiate;2S;35| ((|x| S) ($ S))
        (SPROG ((|d| (S)) (#1=#:G306 NIL) (|dg| (|NonNegativeInteger|)))
               (SEQ
                (LETT |d| (|spadConstant| $ 60)
...
(SDEFUN |UPOLYC-;pseudoRemainder;3S;37| ((|p| S) (|q| S) ($ S))
        (SPROG
         ((|n| (|NonNegativeInteger|)) (#1=#:G318 NIL) (#2=#:G325 NIL)
          (|u| (|Union| (|NonNegativeInteger|) "failed")) (#3=#:G312 NIL)
                    ...
                    (SEQ
                     (SEQ
                      ...
                      (EXIT
                       (COND
                        ((QEQCAR |u| 1)
                         (PROGN (LETT #2# |$NoValue| . #5#) (GO #6=#:G320))))))
                     (LETT |p|
                           (SPADCALL
...
(SDEFUN |UPOLYC-;pseudoQuotient;3S;39| ((|p| S) (|q| S) ($ S))
        (SPROG
         ((|quot| (S)) (|mon| (S)) (#1=#:G329 NIL) (|i| (|NonNegativeInteger|))
          (#2=#:G328 NIL) (|delta| (|Integer|)) (#3=#:G327 NIL) (|lcQ| (R))
...
(SDEFUN |UPOLYC-;pseudoDivide;2SR;40|
        ...
        (SPROG
         ((|quot| (S)) (|mon| (S)) (#1=#:G340 NIL) (|i| (|NonNegativeInteger|))
          (#2=#:G339 NIL) (|delta| (|Integer|)) (|co| (R)) (#3=#:G338 NIL)
...
(SDEFUN |UPOLYC-;composite;2SU;42| ((|p| S) (|q| S) ($ |Union| S #1="failed"))
        (SPROG
         ((#2=#:G372 NIL) (|w| #3=(|Union| S "failed")) (|u| (|Union| S #1#))
          (|v| #3#)
          (|cqr|
           (|Record| (|:| |coef| R) (|:| |quotient| S) (|:| |remainder| S))))
         (SEQ
...
(SDEFUN |UPOLYC-;elt;S2F;43| ((|p| S) (|f| |Fraction| S) ($ |Fraction| S))
        (SPROG
         ((|ans| (|Fraction| S)) (#1=#:G377 NIL) (|n| (|NonNegativeInteger|)))
         (SEQ
...
(SDEFUN |UPOLYC-;order;2SNni;44| ((|p| S) (|q| S) ($ |NonNegativeInteger|))
        (SPROG
         ((|ans| (|NonNegativeInteger|)) (#1=#:G392 NIL)
          (|u| (|Union| S "failed")))
         (SEQ
          (EXIT
           (COND
...
(SDEFUN |UPOLYC-;divide;2SR;51|
        ...
        (SPROG
         ((|quot| (S)) (|n| (|NonNegativeInteger|)) (#1=#:G406 NIL) (|f| (R))
          (|lc| (R)))
         (SEQ
          (COND
...
(MAKEPROP '|UnivariatePolynomialCategory&| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) (|Boolean|)
              ...
              (|Record| (|:| |flag| 86) (|:| |factor| 7) (|:| |exponent| 101))
              (|List| 87) (209 . |factorList|)
              (|Record| (|:| |flag| 86) (|:| |factor| 6) (|:| |exponent| 101))
