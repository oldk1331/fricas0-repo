...
(DEFUN |NUMTUBE;curveTriads| (|l| $)
  (PROG (|endtriad| |n| |t| |x| |begtriad| |midtriads| #1=#:G146 |pl| #2=#:G147
         |po| #3=#:G148 |pr| #4=#:G145 |triad| |b| |k|)
    (RETURN
...
(DEFUN |NUMTUBE;curveLoops| (|pts| |r| |nn| $)
  (PROG (|loops| |b| |n| #1=#:G154 |pt| #2=#:G155 |triad| |cosSin| |triads|)
    (RETURN
     (SEQ
