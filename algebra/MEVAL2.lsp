...
(SDEFUN |MEVAL2;subst_vars;R2LFp;5|
        ...
        (SPROG
         ((|res1| (|FakePolynomial|))
          (|lm| (|List| (|Polynomial| (|Integer|)))) (#2=#:G147 NIL) (|v| NIL)
          (#3=#:G146 NIL))
         (SEQ
          (LETT |lm|
                (PROGN
...
(SDEFUN |MEVAL2;m_reduc|
        ...
        (SPROG
         ((|q|
           (|SparseUnivariatePolynomial|
            (|Fraction| (|Polynomial| (|Integer|)))))
          (#1=#:G153 NIL) (|s| NIL) (#2=#:G154 NIL) (|m| NIL))
         (SEQ
...
(SDEFUN |MEVAL2;trial_division;FpPLSLB;7|
        ...
        (SPROG
         ((#3=#:G174 NIL)
          ...
          (|lcp| #4=(|Fraction| (|Polynomial| (|Integer|)))) (#5=#:G166 NIL)
          (|dp| #6=(|NonNegativeInteger|))
          (|lmu|
           (|List|
            (|SparseUnivariatePolynomial|
             (|Fraction| (|Polynomial| (|Integer|))))))
          (#7=#:G176 NIL) (|m| NIL) (#8=#:G177 NIL) (|s| NIL) (#9=#:G175 NIL)
          (|rgu|
           (|SparseUnivariatePolynomial|
            (|Fraction| (|Polynomial| (|Integer|)))))
          (|dg| #6#) (|lcg| #4#)
