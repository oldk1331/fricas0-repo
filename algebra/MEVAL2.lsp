...
(SDEFUN |MEVAL2;subst_vars;R2LFp;5|
        ...
        (SPROG
         ((|res1| (|FakePolynomial|))
          (|lm| (|List| (|Polynomial| (|Integer|)))) (#2=#:G136 NIL) (|v| NIL)
          (#3=#:G135 NIL))
         (SEQ
          (LETT |lm|
                (PROGN
...
(SDEFUN |MEVAL2;m_reduc|
        ...
        (SPROG
         ((|q|
           (|SparseUnivariatePolynomial|
            (|Fraction| (|Polynomial| (|Integer|)))))
          (#1=#:G141 NIL) (|s| NIL) (#2=#:G142 NIL) (|m| NIL))
         (SEQ
...
(SDEFUN |MEVAL2;trial_division;FpPLSLB;7|
        ...
        (SPROG
         ((#3=#:G158 NIL)
          ...
          (|lcp| #4=(|Fraction| (|Polynomial| (|Integer|)))) (#5=#:G151 NIL)
          (|dp| #6=(|NonNegativeInteger|))
          (|lmu|
           (|List|
            (|SparseUnivariatePolynomial|
             (|Fraction| (|Polynomial| (|Integer|))))))
          (#7=#:G160 NIL) (|m| NIL) (#8=#:G161 NIL) (|s| NIL) (#9=#:G159 NIL)
          (|rgu|
           (|SparseUnivariatePolynomial|
            (|Fraction| (|Polynomial| (|Integer|)))))
          (|dg| #6#) (|lcg| #4#)
