...
(SDEFUN |IPADIC;=;2$B;15| ((|x| ($)) (|y| ($)) ($ (|Boolean|)))
        (SPROG
         ((|st| (|Stream| (|Integer|))) (#1=#:G197 NIL) (#2=#:G198 NIL)
          (|i| NIL) (|n| (|Integer|)))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |IPADIC;iRoot!0| (($$ NIL))
        (PROG (|f| |alpha| $ |pPow| |invFpx0| |p|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G347 NIL) (|num| NIL) (|digit| NIL))
                   (SEQ
                    (LETT |num|
                          (SPADCALL
                           (PROG2
...
(SDEFUN |IPADIC;coerce;$Of;43| ((|x| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|st| ($)) (|st1| ($)) (|n| NIL)
          (#1=#:G384 NIL) (|count| (|NonNegativeInteger|)))
         (SEQ
          (COND
...
(DEFUN |InnerPAdicInteger| (&REST #1=#:G396)
  (SPROG NIL
         (PROG (#2=#:G397)
           (RETURN
            (COND
