...
(SDEFUN |IPADIC;=;2%B;15| ((|x| (%)) (|y| (%)) (% (|Boolean|)))
        (SPROG
         ((|st| (|Stream| (|Integer|))) (#1=#:G182 NIL) (#2=#:G183 NIL)
          (|i| NIL) (|n| (|Integer|)))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |IPADIC;iRoot!0| (($$ NIL))
        (PROG (|f| |alpha| % |pPow| |invFpx0| |p|)
          ...
          (RETURN
           (PROGN
            (SPROG ((#1=#:G332 NIL) (|num| NIL) (|digit| NIL))
                   (SEQ
                    (LETT |num|
                          (SPADCALL
                           (PROG2
...
(SDEFUN |IPADIC;coerce;%Of;43| ((|x| (%)) (% (|OutputForm|)))
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|st| (%)) (|st1| (%)) (|n| NIL)
          (#1=#:G369 NIL) (|count| (|NonNegativeInteger|)))
         (SEQ
          (COND
...
(DEFUN |InnerPAdicInteger| (&REST #1=#:G381)
  (SPROG NIL
         (PROG (#2=#:G382)
           (RETURN
            (COND
