                   ...
                   (QSETAREF1 |resul| |op2type|
                              (SPADCALL (QAREF1 |resul| |op2type|)
                                        (SPADCALL |op1mult| |op2mult|
                                                  (QREFELT $ 38))
                                        (QREFELT $ 29)))
                   (EXIT (PROGN (LETT #1# |resul|) (GO #3=#:G338))))))
                (EXIT
                   ...
                   (QSETAREF1 |resul| |op1type|
                              (SPADCALL (QAREF1 |resul| |op1type|)
                                        (SPADCALL |op1mult| |op2mult|
                                                  (QREFELT $ 38))
                                        (QREFELT $ 29)))
                   (EXIT (PROGN (LETT #2# |resul|) (GO #4=#:G347))))))
                (EXIT
                   ...
                   (QSETAREF1 |resul| |op2type|
                              (SPADCALL (QAREF1 |resul| |op2type|)
                                        (SPADCALL |op1mult| |op2mult|
                                                  (QREFELT $ 38))
                                        (QREFELT $ 29)))
                   (EXIT (PROGN (LETT #2# |resul|) (GO #4=#:G372))))))
                (COND
                 ((EQL |grade2| 0)
                  (SEQ
                   (QSETAREF1 |resul| |op1type|
