                        ...
                        (EXIT
                         (COND
                          ((SPADCALL (QAREF1 |x| |i|) (QAREF1 |y| |i|)
                                     (QREFELT $ 26))
                           (PROGN (LETT #1# NIL) (GO #3=#:G167))))))
                       (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL))
                  (EXIT 'T)))
                #3# (EXIT #1#)))) 

(SDEFUN |CLIF;+;3$;4| ((|x| ($)) (|y| ($)) ($ ($)))
        (SPROG ((#1=#:G174 NIL) (|i| NIL) (|z| ($)))
...
(SDEFUN |CLIF;toStringTerm| ((|c| (K)) (|b| (|SingleInteger|)) ($ (|String|)))
        (SPROG ((|mult| (|String|)) (#1=#:G211 NIL) (|i| NIL))
...
(SDEFUN |CLIF;e;Pi$;15| ((|b| (|PositiveInteger|)) ($ ($)))
        (SPROG ((|z| ($)) (|iz| (|PositiveInteger|)) (#1=#:G222 NIL))
               (SEQ
...
(SDEFUN |CLIF;ee;L$;16| ((|l| (|List| (|PositiveInteger|))) ($ ($)))
        (SPROG ((|lst| (|List| $)) (#1=#:G232 NIL) (|i| NIL) (#2=#:G231 NIL))
               (SEQ
                (LETT |lst|
                      (PROGN
                       (LETT #2# NIL)
...
(SDEFUN |CLIF;ePseudoscalar;$;19| (($ ($)))
        (SPROG ((|i| (|NonNegativeInteger|)) (#1=#:G240 NIL) (|p| ($)))
...
(SDEFUN |CLIF;toTable;MM;20| ((|fn| (|Mapping| $ $ $)) ($ (|Matrix| $)))
        (SPROG
         ((#1=#:G257 NIL) (|j| NIL) (#2=#:G256 NIL) (#3=#:G255 NIL) (|k| NIL)
          (#4=#:G254 NIL) (|l| (|List| $)) (#5=#:G253 NIL) (|i| NIL)
          (#6=#:G252 NIL))
         (SEQ
          (LETT |l|
                (PROGN
...
(SDEFUN |CLIF;toTable;MM;21| ((|fn| (|Mapping| $ $)) ($ (|Matrix| $)))
        (SPROG
         ((#1=#:G272 NIL) (|k| NIL) (#2=#:G271 NIL) (#3=#:G270 NIL) (|j| NIL)
          (#4=#:G269 NIL) (|l| (|List| $)) (#5=#:G268 NIL) (|i| NIL)
          (#6=#:G267 NIL))
         (SEQ
          (LETT |l|
                (PROGN
...
(SDEFUN |CLIF;gradeTerm| ((|b| (|SingleInteger|)) ($ (|NonNegativeInteger|)))
        (SPROG ((|grade| (|NonNegativeInteger|)) (#1=#:G278 NIL) (|i| NIL))
               (SEQ (LETT |grade| 0)
...
(SDEFUN |CLIF;grade;$Nni;23| ((|x| ($)) ($ (|NonNegativeInteger|)))
        (SPROG ((|gr| (|NonNegativeInteger|)) (#1=#:G284 NIL) (|ix| NIL))
               (SEQ (LETT |gr| 0)
...
(SDEFUN |CLIF;bilinear|
        ...
        (SPROG ((#1=#:G328 NIL) (|bv2| #2=(|NonNegativeInteger|)) (|bv1| #2#))
               (SEQ
                (EXIT
...
(SDEFUN |CLIF;leftMostBase| ((|b| (|SingleInteger|)) ($ (|SingleInteger|)))
        (SPROG
         ((|mask| (|SingleInteger|)) (#1=#:G335 NIL) (#2=#:G336 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ (LETT |mask| 1)
                (SEQ (LETT |i| 0) (LETT #2# (- (QREFELT $ 6) 1)) G190
...
(SDEFUN |CLIF;rightMostBase| ((|b| (|SingleInteger|)) ($ (|SingleInteger|)))
        (SPROG
         ((|mask| (|SingleInteger|)) (#1=#:G343 NIL) (#2=#:G344 NIL) (|i| NIL))
         (SEQ
          (EXIT
           (SEQ
            (LETT |mask|
...
(SDEFUN |CLIF;exteriorProdTerm|
        ...
        (SPROG
         ((|c| (K)) (|k| (|NonNegativeInteger|)) (#1=#:G357 NIL) (|j| NIL)
          (#2=#:G356 NIL) (#3=#:G355 NIL) (|i| NIL) (|bz| (|SingleInteger|))
          (|resul| ($)))
         (SEQ (LETT |resul| (MAKEARR1 (QREFELT $ 19) (|spadConstant| $ 28)))
              (EXIT
               (COND
...
(SDEFUN |CLIF;/\\;3$;37| ((|x| ($)) (|y| ($)) ($ ($)))
        (SPROG
         ((|z| ($)) (#1=#:G369 NIL) (|iy| NIL) (#2=#:G368 NIL) (|ix| NIL))
         (SEQ (LETT |z| (MAKEARR1 (QREFELT $ 19) (|spadConstant| $ 28)))
...
(SDEFUN |CLIF;\\/;3$;38| ((|x| ($)) (|y| ($)) ($ ($)))
        (SPROG
         ((|z| ($)) (#1=#:G379 NIL) (|iy| NIL) (#2=#:G378 NIL) (|ix| NIL))
         (SEQ (LETT |z| (MAKEARR1 (QREFELT $ 19) (|spadConstant| $ 28)))
              (SEQ (LETT |ix| 0) (LETT #2# (- (QREFELT $ 19) 1)) G190
                   (COND ((|greater_SI| |ix| #2#) (GO G191)))
                   (SEQ
...
(SDEFUN |CLIF;lcProdTerm|
        ...
        (SPROG
         ((|resul| ($)) (|inner2| ($)) (|vType| (|SingleInteger|))
          (|uType| (|SingleInteger|)) (#1=#:G386 NIL) (|inner4| ($))
                   ...
                   (QSETAREF1 |resul| |op2type|
                              (SPADCALL (QAREF1 |resul| |op2type|)
                                        (SPADCALL |op1mult| |op2mult|
                                                  (QREFELT $ 38))
                                        (QREFELT $ 29)))
                   (EXIT (PROGN (LETT #1# |resul|) (GO #3=#:G385))))))
                (EXIT
...
(SDEFUN |CLIF;rcProdTerm|
        ...
        (SPROG
         ((|s4| (|String|)) (|s3| #1=(|String|)) (|s2| #1#) (|s1| #1#)
          (|resul| ($)) (|inner2| ($)) (|vType| (|SingleInteger|))
          (|uType| (|SingleInteger|)) (#2=#:G395 NIL) (|inner4| ($))
                   ...
                   (QSETAREF1 |resul| |op1type|
                              (SPADCALL (QAREF1 |resul| |op1type|)
                                        (SPADCALL |op1mult| |op2mult|
                                                  (QREFELT $ 38))
                                        (QREFELT $ 29)))
                   (EXIT (PROGN (LETT #2# |resul|) (GO #4=#:G394))))))
                (EXIT
...
(SDEFUN |CLIF;lc;3$;41| ((|x| ($)) (|y| ($)) ($ ($)))
        (SPROG
         ((|z| ($)) (#1=#:G405 NIL) (|iy| NIL) (#2=#:G404 NIL) (|ix| NIL))
         (SEQ (LETT |z| (MAKEARR1 (QREFELT $ 19) (|spadConstant| $ 28)))
              (SEQ (LETT |ix| 0) (LETT #2# (- (QREFELT $ 19) 1)) G190
                   (COND ((|greater_SI| |ix| #2#) (GO G191)))
                   (SEQ
...
(SDEFUN |CLIF;rc;3$;42| ((|x| ($)) (|y| ($)) ($ ($)))
        (SPROG
         ((|z| ($)) (#1=#:G415 NIL) (|iy| NIL) (#2=#:G414 NIL) (|ix| NIL))
         (SEQ (LETT |z| (MAKEARR1 (QREFELT $ 19) (|spadConstant| $ 28)))
              (SEQ (LETT |ix| 0) (LETT #2# (- (QREFELT $ 19) 1)) G190
                   (COND ((|greater_SI| |ix| #2#) (GO G191)))
                   (SEQ
...
(SDEFUN |CLIF;cliffordProdTerm|
        ...
        (SPROG
         ((|resul| ($)) (|s4| #1=(|String|)) (|s3| #1#) (|s2| #1#) (|s1| #1#)
          ...
          (#2=#:G424 NIL) (|xt| ($)) (|vType| (|SingleInteger|))
                   ...
                   (QSETAREF1 |resul| |op2type|
                              (SPADCALL (QAREF1 |resul| |op2type|)
                                        (SPADCALL |op1mult| |op2mult|
                                                  (QREFELT $ 38))
                                        (QREFELT $ 29)))
                   (EXIT (PROGN (LETT #2# |resul|) (GO #4=#:G423))))))
                (COND
                 ((EQL |grade2| 0)
                  (SEQ
                   (QSETAREF1 |resul| |op1type|
...
(SDEFUN |CLIF;cliffordDiagonalTerm|
        ...
        (SPROG
         ((|result| ($)) (|bz| #1#) (|c| (K)) (|k| (|NonNegativeInteger|))
          (#2=#:G438 NIL) (|j| NIL) (#3=#:G437 NIL) (#4=#:G436 NIL) (|i| NIL))
         (SEQ (LETT |c| (SPADCALL |op1mult| |op2mult| (QREFELT $ 38)))
              (LETT |bz| |op2type|)
...
(SDEFUN |CLIF;*;3$;45| ((|x| ($)) (|y| ($)) ($ ($)))
        (SPROG
         ((|z| ($)) (#1=#:G456 NIL) (|iy| NIL) (#2=#:G455 NIL) (|ix| NIL)
          (#3=#:G454 NIL) (#4=#:G453 NIL))
         (SEQ (LETT |z| (MAKEARR1 (QREFELT $ 19) (|spadConstant| $ 28)))
              (COND
               ((QREFELT $ 17)
...
(SDEFUN |CLIF;canonMonom|
        ...
        (SPROG
         ((|bz| #1=(|NonNegativeInteger|)) (#2=#:G471 NIL)
          (|bn| (|NonNegativeInteger|)) (#3=#:G470 NIL) (#4=#:G480 NIL)
          (|b| NIL) (|wasordered| (|Boolean|)) (|exchanges| #1#)
          (|t| (|PositiveInteger|)) (#5=#:G479 NIL) (|i| NIL) (#6=#:G477 NIL)
          (#7=#:G478 NIL))
         (SEQ
          (SEQ
           (EXIT
...
(SDEFUN |CLIF;coerceMonom|
        ...
        (SPROG
         ((|be| (|OutputForm|)) (|ml| (|List| (|OutputForm|))) (#1=#:G498 NIL)
          (|i| NIL) (#2=#:G497 NIL))
         (SEQ
...
(SDEFUN |CLIF;coerce;$Of;51| ((|x| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|tl| (|List| (|OutputForm|))) (#1=#:G506 NIL) (|i| NIL)
          (#2=#:G505 NIL))
         (SEQ
          (LETT |tl|
                (PROGN
...
(SDEFUN |CLIF;localPowerSets|
        ...
        (SPROG
         ((|Sn| (|List| (|List| (|PositiveInteger|)))) (#2=#:G513 NIL)
          (|x| NIL) (|Sm| #1#) (#3=#:G507 NIL)
...
(SDEFUN |CLIF;recip;$U;54| ((|x| ($)) ($ (|Union| $ "failed")))
        (SPROG
         ((|ansC| ($)) (|ansP| (|List| K)) (|cj| (K)) (#1=#:G538 NIL)
          (|pj| NIL) (|ans| (|Union| (|Vector| K) "failed"))
          (|lhsEqs| (|List| (|List| K))) (|lhsEqi| (|List| K)) (#2=#:G537 NIL)
          (|rhsEqs| (|List| K)) (#3=#:G536 NIL) (|pi| NIL) (|one| ($)))
...
(DEFUN |CliffordAlgebra| (&REST #1=#:G539)
  (SPROG NIL
         (PROG (#2=#:G540)
           (RETURN
            (COND
