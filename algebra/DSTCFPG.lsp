...
(MAKEPROP '|DistributionContinuedFractionPackage| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (99 . |0|) (103 . |1|) (107 . |cons|) (|ContinuedFraction| 34)
              (113 . |continuedFraction|) (120 . |JContinuedFraction|))
