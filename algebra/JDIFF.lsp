...
(SDEFUN |JDIFF;coerce;$Of;6| ((|om| ($)) ($ (|OutputForm|)))
        (SPROG
         ((#1=#:G154 NIL) (|c| NIL) (#2=#:G155 NIL) (|jb| NIL) (#3=#:G153 NIL))
         (SEQ
          (COND
...
(SDEFUN |JDIFF;-;2$;13| ((|om| ($)) ($ ($)))
        (SPROG ((#1=#:G167 NIL) (|c| NIL) (#2=#:G166 NIL))
               (SEQ
                (CONS
                 (PROGN
                  (LETT #2# NIL)
...
(SDEFUN |JDIFF;+;3$;14| ((|om1| ($)) (|om2| ($)) ($ ($)))
        (SPROG
         ((|lj2| (|List| JB)) (|lc2| (|List| D)) (|resJ| (|List| JB))
          (|resC| (|List| D)) (|sum| (D)) (#1=#:G186 NIL) (|c1| NIL)
          (#2=#:G187 NIL) (|j1| NIL))
         (SEQ
...
(SDEFUN |JDIFF;*;D2$;15| ((|f| (D)) (|om| ($)) ($ ($)))
        (SPROG ((#1=#:G193 NIL) (|c| NIL) (#2=#:G192 NIL))
               (SEQ
...
(SDEFUN |JDIFF;d;D$;16| ((|f| (D)) ($ ($)))
        (SPROG
         ((|Co| (|List| D)) (#1=#:G200 NIL) (|jv| NIL) (#2=#:G199 NIL)
          (JV (|List| JB)))
...
(SDEFUN |JDIFF;eval;$JvfD;17|
        ...
        (SPROG
         ((|lj2| (|List| JB)) (|lc2| (|List| D)) (|res| (D)) (#1=#:G215 NIL)
          (|c1| NIL) (#2=#:G216 NIL) (|j1| NIL))
         (SEQ
          (COND
...
(DEFUN |JetDifferential| (&REST #1=#:G222)
  (SPROG NIL
         (PROG (#2=#:G223)
           (RETURN
            (COND
...
(DEFUN |JetDifferential;| (|#1| |#2|)
  (SPROG
   ((|pv$| NIL) (#1=#:G221 NIL) ($ NIL) (|dv$| NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
