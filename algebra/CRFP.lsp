...
(SDEFUN |CRFP;complexZeros;UPRL;1|
        ...
        (SPROG
         ((#1=#:G128 NIL) (|linfac| NIL) (#2=#:G127 NIL)
...
(SDEFUN |CRFP;pleskenSplit;UPRBF;4|
        ...
        (SPROG
         ((|fp| (|Factored| UP)) (#1=#:G153 NIL) (|fac| NIL)
...
(SDEFUN |CRFP;startPolynomial;UPR;5|
        ...
        (SPROG
         ((|po| (|Integer|)) (|maxq| (R)) (#1=#:G175 NIL) (|qq| (R)) (|rd| (R))
          (|r1| (R)) (#2=#:G179 NIL) (|q| NIL) (|j| NIL)
          (|sP| (|Record| (|:| |start| UP) (|:| |factors| (|Factored| UP))))
          (|fp| (|Factored| UP)) (|centerIsRoot| (|Boolean|)) (|pp| (UP))
          (|mD| (|NonNegativeInteger|)) (#3=#:G178 NIL) (|i| NIL)
          (|lp| (|List| UP)) (#4=#:G177 NIL) (|v| NIL) (#5=#:G176 NIL)
...
(SDEFUN |CRFP;graeffe;2UP;8| ((|p| (UP)) (% (UP)))
        (SPROG
         ((|aBack| #1=(|List| (|Complex| R))) (|gp| (UP)) (#2=#:G192 NIL)
          (|const| (|Integer|)) (|aBackCopy| #1#)
          (|aForthCopy| (|List| (|Complex| R))) (|sum| (|Complex| R))
          (#3=#:G199 NIL) (|aminus| NIL) (#4=#:G200 NIL) (|aplus| NIL)
          (|aForth| (|List| (|Complex| R))) (|ak| (|Complex| R))
          (#5=#:G198 NIL) (|k| NIL) (#6=#:G197 NIL)
...
(SDEFUN |CRFP;reciprocalPolynomial;2UP;12| ((|p| (UP)) (% (UP)))
        (SPROG
         ((|sol| (UP)) (|lm| (|List| UP)) (#1=#:G216 NIL) (#2=#:G224 NIL)
          (|i| NIL) (#3=#:G223 NIL) (|md| (|NonNegativeInteger|))
...
(SDEFUN |CRFP;factor;UPRBF;17|
        ...
        (SPROG
         ((|listOfFactors|
          ...
          (|newFactor| (UP)) (#1=#:G255 NIL) (|rec| NIL)
...
(SDEFUN |CRFP;calculateScale| ((|p| (UP)) (% (R)))
        (SPROG
         ((|rho| (R)) (|maxi| (R)) (|locmax| (R)) (|ic| (R)) (|rc| (R))
          (|cof| (|Complex| R)) (|j| (|NonNegativeInteger|)) (#1=#:G273 NIL)
...
(DEFUN |ComplexRootFindingPackage| (&REST #1=#:G281)
  (SPROG NIL
         (PROG (#2=#:G282)
           (RETURN
            (COND
