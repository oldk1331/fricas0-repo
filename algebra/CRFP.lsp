...
(SDEFUN |CRFP;pleskenSplit;UPRBF;4|
        ...
        (SPROG
         ((|fp| (|Factored| UP)) (#1=#:G152 NIL) (|fac| NIL)
...
(SDEFUN |CRFP;startPolynomial;UPR;5|
        ...
        (SPROG
         ((|po| (|Integer|)) (|maxq| (R)) (#1=#:G174 NIL) (|qq| (R)) (|rd| (R))
          (|r1| (R)) (#2=#:G178 NIL) (|q| NIL) (|j| NIL)
          (|sP| (|Record| (|:| |start| UP) (|:| |factors| (|Factored| UP))))
          (|fp| (|Factored| UP)) (|centerIsRoot| (|Boolean|)) (|pp| (UP))
          (|mD| (|NonNegativeInteger|)) (#3=#:G177 NIL) (|i| NIL)
          (|lp| (|List| UP)) (#4=#:G176 NIL) (|v| NIL) (#5=#:G175 NIL)
...
(SDEFUN |CRFP;graeffe;2UP;8| ((|p| (UP)) ($ (UP)))
        (SPROG
         ((|aBack| #1=(|List| (|Complex| R))) (|gp| (UP)) (#2=#:G191 NIL)
          (|const| (|Integer|)) (|aBackCopy| #1#)
          (|aForthCopy| (|List| (|Complex| R))) (|sum| (|Complex| R))
          (#3=#:G198 NIL) (|aminus| NIL) (#4=#:G199 NIL) (|aplus| NIL)
          (|aForth| (|List| (|Complex| R))) (|ak| (|Complex| R))
          (#5=#:G197 NIL) (|k| NIL) (#6=#:G196 NIL)
...
(SDEFUN |CRFP;reciprocalPolynomial;2UP;12| ((|p| (UP)) ($ (UP)))
        (SPROG
         ((|sol| (UP)) (|lm| (|List| UP)) (#1=#:G215 NIL) (#2=#:G223 NIL)
          (|i| NIL) (#3=#:G222 NIL) (|md| (|NonNegativeInteger|))
...
(SDEFUN |CRFP;factor;UPRBF;17|
        ...
        (SPROG
         ((|listOfFactors|
          ...
          (|newFactor| (UP)) (#1=#:G254 NIL) (|rec| NIL)
...
(SDEFUN |CRFP;calculateScale| ((|p| (UP)) ($ (R)))
        (SPROG
         ((|rho| (R)) (|maxi| (R)) (|locmax| (R)) (|ic| (R)) (|rc| (R))
          (|cof| (|Complex| R)) (|j| (|NonNegativeInteger|)) (#1=#:G272 NIL)
...
(DEFUN |ComplexRootFindingPackage| (&REST #1=#:G280)
  (SPROG NIL
         (PROG (#2=#:G281)
           (RETURN
            (COND
