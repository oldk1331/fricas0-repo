...
(SDEFUN |ISTRING;replace;$Us2$;15|
        ...
        (SPROG
         ((|k| NIL) (#1=#:G1144 NIL) (|i| NIL) (#2=#:G1143 NIL)
          (#3=#:G1142 NIL) (|r| ($)) (#4=#:G1133 NIL) (|h| (|Integer|))
...
(SDEFUN |ISTRING;substring?;2$IB;18|
        ...
        (SPROG
         ((#1=#:G1156 NIL) (#2=#:G1157 NIL) (#3=#:G1158 NIL) (|ip| NIL)
...
(SDEFUN |ISTRING;position;Cc$2I;21|
        ((|cc| (|CharacterClass|)) (|t| ($)) (|startpos| #1=(|Integer|))
         ($ #1#))
        (SPROG ((#2=#:G1179 NIL) (#3=#:G1180 NIL) (|r| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |startpos| (- |startpos| (QREFELT $ 6)))
                      (EXIT
...
(SDEFUN |ISTRING;split;$CL;23| ((|s| ($)) (|c| (|Character|)) ($ (|List| $)))
        (SPROG
         ((|l| (|List| $)) (#1=#:G1193 NIL) (|i| NIL) (|j| (|Integer|))
          (#2=#:G1192 NIL) (|n| (|Integer|)))
...
(SDEFUN |ISTRING;split;$CcL;24|
        ...
        (SPROG
         ((|l| (|List| $)) (#1=#:G1204 NIL) (|i| NIL) (|j| (|Integer|))
          (#2=#:G1203 NIL) (|n| (|Integer|)))
         (SEQ (LETT |n| (SPADCALL |s| (QREFELT $ 42)))
              (SEQ (LETT |i| (QREFELT $ 6)) (LETT #2# |n|) G190
                   (COND
                    ((OR (> |i| #2#)
...
(SDEFUN |ISTRING;leftTrim;$Cc$;25|
        ((|s| ($)) (|cc| (|CharacterClass|)) ($ ($)))
        (SPROG ((#1=#:G1209 NIL) (|i| NIL) (|n| (|Integer|)))
               (SEQ (LETT |n| (SPADCALL |s| (QREFELT $ 42)))
...
(SDEFUN |ISTRING;concat;L$;27| ((|l| (|List| $)) ($ ($)))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G1224 NIL) (|s| NIL) (|t| ($))
          (#2=#:G1216 NIL) (#3=#:G1215 #4=(|NonNegativeInteger|))
          (#5=#:G1217 #4#) (#6=#:G1223 NIL))
         (SEQ
          (LETT |t|
                (SPADCALL
                 (PROGN
...
(SDEFUN |ISTRING;match?;2$CB;33|
        ((|pattern| ($)) (|target| ($)) (|dontcare| (|Character|))
         ($ (|Boolean|)))
        (SPROG
         ((|q| (|NonNegativeInteger|)) (#1=#:G1243 NIL)
          (|p| #2=(|NonNegativeInteger|)) (|i| #2#) (#3=#:G1252 NIL)
          (#4=#:G1242 NIL) (|s| ($)) (#5=#:G1240 NIL) (#6=#:G1237 NIL)
          (|m| (|Integer|)) (|n| (|Integer|)))
         (SEQ
          (EXIT
