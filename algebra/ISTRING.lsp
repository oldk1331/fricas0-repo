...
(SDEFUN |ISTRING;replace;$Us2$;15|
        ...
        (SPROG
         ((|k| NIL) (#1=#:G1146 NIL) (|i| NIL) (#2=#:G1145 NIL)
          (#3=#:G1144 NIL) (|r| ($)) (#4=#:G1135 NIL) (|h| (|Integer|))
...
(SDEFUN |ISTRING;substring?;2$IB;18|
        ...
        (SPROG
         ((#1=#:G1158 NIL) (#2=#:G1159 NIL) (#3=#:G1160 NIL) (|ip| NIL)
...
(SDEFUN |ISTRING;position;C$2I;20|
        ...
        (SPROG ((#2=#:G1172 NIL) (#3=#:G1173 NIL) (|r| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |startpos| (- |startpos| (QREFELT $ 6)))
                      (EXIT
...
(SDEFUN |ISTRING;position;Cc$2I;21|
        ((|cc| (|CharacterClass|)) (|t| ($)) (|startpos| #1=(|Integer|))
         ($ #1#))
        (SPROG ((#2=#:G1181 NIL) (#3=#:G1182 NIL) (|r| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |startpos| (- |startpos| (QREFELT $ 6)))
                      (EXIT
...
(SDEFUN |ISTRING;split;$CL;23| ((|s| ($)) (|c| (|Character|)) ($ (|List| $)))
        (SPROG
         ((|l| (|List| $)) (#1=#:G1195 NIL) (|i| NIL) (|j| (|Integer|))
          (#2=#:G1194 NIL) (|n| (|Integer|)))
...
(SDEFUN |ISTRING;split;$CcL;24|
        ...
        (SPROG
         ((|l| (|List| $)) (#1=#:G1206 NIL) (|i| NIL) (|j| (|Integer|))
          (#2=#:G1205 NIL) (|n| (|Integer|)))
         (SEQ (LETT |n| (SPADCALL |s| (QREFELT $ 42)))
              (SEQ (LETT |i| (QREFELT $ 6)) (LETT #2# |n|) G190
                   (COND
                    ((OR (> |i| #2#)
...
(SDEFUN |ISTRING;leftTrim;$Cc$;25|
        ((|s| ($)) (|cc| (|CharacterClass|)) ($ ($)))
        (SPROG ((#1=#:G1211 NIL) (|i| NIL) (|n| (|Integer|)))
               (SEQ (LETT |n| (SPADCALL |s| (QREFELT $ 42)))
...
(SDEFUN |ISTRING;concat;L$;27| ((|l| (|List| $)) ($ ($)))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G1226 NIL) (|s| NIL) (|t| ($))
          (#2=#:G1218 NIL) (#3=#:G1217 #4=(|NonNegativeInteger|))
          (#5=#:G1219 #4#) (#6=#:G1225 NIL))
         (SEQ
          (LETT |t|
                (SPADCALL
                 (PROGN
...
(SDEFUN |ISTRING;match?;2$CB;33|
        ((|pattern| ($)) (|target| ($)) (|dontcare| (|Character|))
         ($ (|Boolean|)))
        (SPROG
         ((|q| (|NonNegativeInteger|)) (#1=#:G1245 NIL)
          (|p| #2=(|NonNegativeInteger|)) (|i| #2#) (#3=#:G1254 NIL)
          (#4=#:G1244 NIL) (|s| ($)) (#5=#:G1242 NIL) (#6=#:G1239 NIL)
          (|m| (|Integer|)) (|n| (|Integer|)))
         (SEQ
          (EXIT
...
(DEFUN |IndexedString;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G1261 NIL) (#2=#:G1262 NIL) (#3=#:G1263 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
    (LETT DV$1 |#1|)
