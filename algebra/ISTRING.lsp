...
(SDEFUN |ISTRING;replace;$Us2$;15|
        ...
        (SPROG
         ((|k| NIL) (#1=#:G1083 NIL) (|i| NIL) (#2=#:G1082 NIL)
          (#3=#:G1081 NIL) (|r| ($)) (#4=#:G1075 NIL) (|h| (|Integer|))
...
(SDEFUN |ISTRING;substring?;2$IB;18|
        ...
        (SPROG
         ((#1=#:G1094 NIL) (#2=#:G1095 NIL) (#3=#:G1096 NIL) (|ip| NIL)
...
(SDEFUN |ISTRING;position;C$2I;20|
        ...
        (SPROG ((#2=#:G1107 NIL) (#3=#:G1108 NIL) (|r| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |startpos| (- |startpos| (QREFELT $ 6)))
                      (EXIT
...
(SDEFUN |ISTRING;position;Cc$2I;21|
        ((|cc| |CharacterClass|) (|t| $) (|startpos| . #1=(|Integer|))
         ($ . #1#))
        (SPROG ((#2=#:G1115 NIL) (#3=#:G1116 NIL) (|r| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |startpos| (- |startpos| (QREFELT $ 6)))
                      (EXIT
...
(SDEFUN |ISTRING;split;$CcL;24| ((|s| $) (|cc| |CharacterClass|) ($ |List| $))
        (SPROG
         ((|l| (|List| $)) (#1=#:G1134 NIL) (|i| NIL) (|j| (|Integer|))
          (#2=#:G1133 NIL) (|n| (|Integer|)))
         (SEQ (LETT |n| (SPADCALL |s| (QREFELT $ 42)))
              (SEQ (LETT |i| (QREFELT $ 6)) (LETT #2# |n|) G190
                   (COND
                    ((OR (> |i| #2#)
...
(SDEFUN |ISTRING;concat;L$;27| ((|l| |List| $) ($ $))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G1151 NIL) (|s| NIL) (|t| ($))
          (#2=#:G1144 NIL) (#3=#:G1143 #4=(|NonNegativeInteger|))
          (#5=#:G1145 #4#) (#6=#:G1150 NIL))
         (SEQ
          (LETT |t|
                (SPADCALL
                 (PROGN
...
(SDEFUN |ISTRING;match?;2$CB;33|
        ...
        (SPROG
         ((|q| (|NonNegativeInteger|)) (#1=#:G1169 NIL)
          (|p| #2=(|NonNegativeInteger|)) (|i| #2#) (#3=#:G1178 NIL)
          (#4=#:G1168 NIL) (|s| ($)) (#5=#:G1167 NIL) (#6=#:G1164 NIL)
          (|m| (|Integer|)) (|n| (|Integer|)))
         (SEQ
          (EXIT
...
(DEFUN |IndexedString;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G1185 NIL) (#2=#:G1186 NIL) (#3=#:G1187 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
