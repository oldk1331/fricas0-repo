...
(SDEFUN |ISTRING;replace;$Us2$;15|
        ...
        (SPROG
         ((|k| NIL) (#1=#:G1128 NIL) (|i| NIL) (#2=#:G1127 NIL)
          (#3=#:G1126 NIL) (|r| ($)) (#4=#:G1117 NIL) (|h| (|Integer|))
...
(SDEFUN |ISTRING;substring?;2$IB;18|
        ...
        (SPROG
         ((#1=#:G1140 NIL) (#2=#:G1141 NIL) (#3=#:G1142 NIL) (|ip| NIL)
...
(SDEFUN |ISTRING;position;C$2I;20|
        ...
        (SPROG ((#2=#:G1154 NIL) (#3=#:G1155 NIL) (|r| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |startpos| (- |startpos| (QREFELT $ 6)))
                      (EXIT
...
(SDEFUN |ISTRING;position;Cc$2I;21|
        ((|cc| (|CharacterClass|)) (|t| ($)) (|startpos| #1=(|Integer|))
         ($ #1#))
        (SPROG ((#2=#:G1163 NIL) (#3=#:G1164 NIL) (|r| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |startpos| (- |startpos| (QREFELT $ 6)))
                      (EXIT
...
(SDEFUN |ISTRING;split;$CL;23| ((|s| ($)) (|c| (|Character|)) ($ (|List| $)))
        (SPROG
         ((|l| (|List| $)) (#1=#:G1177 NIL) (|i| NIL) (|j| (|Integer|))
          (#2=#:G1176 NIL) (|n| (|Integer|)))
...
(SDEFUN |ISTRING;split;$CcL;24|
        ...
        (SPROG
         ((|l| (|List| $)) (#1=#:G1188 NIL) (|i| NIL) (|j| (|Integer|))
          (#2=#:G1187 NIL) (|n| (|Integer|)))
         (SEQ (LETT |n| (SPADCALL |s| (QREFELT $ 42)))
              (SEQ (LETT |i| (QREFELT $ 6)) (LETT #2# |n|) G190
                   (COND
                    ((OR (> |i| #2#)
...
(SDEFUN |ISTRING;leftTrim;$Cc$;25|
        ((|s| ($)) (|cc| (|CharacterClass|)) ($ ($)))
        (SPROG ((#1=#:G1193 NIL) (|i| NIL) (|n| (|Integer|)))
               (SEQ (LETT |n| (SPADCALL |s| (QREFELT $ 42)))
...
(SDEFUN |ISTRING;concat;L$;27| ((|l| (|List| $)) ($ ($)))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G1208 NIL) (|s| NIL) (|t| ($))
          (#2=#:G1200 NIL) (#3=#:G1199 #4=(|NonNegativeInteger|))
          (#5=#:G1201 #4#) (#6=#:G1207 NIL))
         (SEQ
          (LETT |t|
                (SPADCALL
                 (PROGN
...
(SDEFUN |ISTRING;match?;2$CB;33|
        ((|pattern| ($)) (|target| ($)) (|dontcare| (|Character|))
         ($ (|Boolean|)))
        (SPROG
         ((|q| (|NonNegativeInteger|)) (#1=#:G1227 NIL)
          (|p| #2=(|NonNegativeInteger|)) (|i| #2#) (#3=#:G1236 NIL)
          (#4=#:G1226 NIL) (|s| ($)) (#5=#:G1224 NIL) (#6=#:G1221 NIL)
          (|m| (|Integer|)) (|n| (|Integer|)))
         (SEQ
          (EXIT
...
(DEFUN |IndexedString;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G1243 NIL) (#2=#:G1244 NIL) (#3=#:G1245 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
    (LETT DV$1 |#1|)
