...
(SDEFUN |ISTRING;replace;%Us2%;14|
        ...
        (SPROG
         ((|k| NIL) (#1=#:G1000 NIL) (|i| NIL) (#2=#:G999 NIL) (#3=#:G998 NIL)
          (|r| (%)) (#4=#:G989 NIL) (|h| (|Integer|))
...
(SDEFUN |ISTRING;substring?;2%IB;17|
        ...
        (SPROG
         ((#1=#:G1012 NIL) (#2=#:G1013 NIL) (#3=#:G1014 NIL) (|ip| NIL)
...
(SDEFUN |ISTRING;position;C%2I;19|
        ...
        (SPROG ((#2=#:G1026 NIL) (#3=#:G1027 NIL) (|r| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |startpos| (- |startpos| (QREFELT % 6)))
                      (EXIT
...
(SDEFUN |ISTRING;position;Cc%2I;20|
        ((|cc| (|CharacterClass|)) (|t| (%)) (|startpos| #1=(|Integer|))
         (% #1#))
        (SPROG ((#2=#:G1035 NIL) (#3=#:G1036 NIL) (|r| NIL))
               (SEQ
                (EXIT
                 (SEQ (LETT |startpos| (- |startpos| (QREFELT % 6)))
                      (EXIT
...
(SDEFUN |ISTRING;split;%CL;22| ((|s| (%)) (|c| (|Character|)) (% (|List| %)))
        (SPROG
         ((|l| (|List| %)) (#1=#:G1049 NIL) (|i| NIL) (|j| (|Integer|))
          (#2=#:G1048 NIL) (|n| (|Integer|)))
...
(SDEFUN |ISTRING;split;%CcL;23|
        ...
        (SPROG
         ((|l| (|List| %)) (#1=#:G1060 NIL) (|i| NIL) (|j| (|Integer|))
          (#2=#:G1059 NIL) (|n| (|Integer|)))
         (SEQ (LETT |n| (SPADCALL |s| (QREFELT % 41)))
              (SEQ (LETT |i| (QREFELT % 6)) (LETT #2# |n|) G190
                   (COND
                    ((OR (> |i| #2#)
...
(SDEFUN |ISTRING;leftTrim;%Cc%;24|
        ((|s| (%)) (|cc| (|CharacterClass|)) (% (%)))
        (SPROG ((#1=#:G1065 NIL) (|i| NIL) (|n| (|Integer|)))
               (SEQ (LETT |n| (SPADCALL |s| (QREFELT % 41)))
...
(SDEFUN |ISTRING;concat;L%;26| ((|l| (|List| %)) (% (%)))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G1080 NIL) (|s| NIL) (|t| (%))
          (#2=#:G1072 NIL) (#3=#:G1071 #4=(|NonNegativeInteger|))
          (#5=#:G1073 #4#) (#6=#:G1079 NIL))
         (SEQ
          (LETT |t|
                (SPADCALL
                 (PROGN
...
(SDEFUN |ISTRING;match?;2%CB;32|
        ((|pattern| (%)) (|target| (%)) (|dontcare| (|Character|))
         (% (|Boolean|)))
        (SPROG
         ((|q| (|NonNegativeInteger|)) (#1=#:G1099 NIL)
          (|p| #2=(|NonNegativeInteger|)) (|i| #2#) (#3=#:G1108 NIL)
          (#4=#:G1098 NIL) (|s| (%)) (#5=#:G1096 NIL) (#6=#:G1093 NIL)
          (|m| (|Integer|)) (|n| (|Integer|)))
         (SEQ
          (EXIT
...
(DEFUN |IndexedString;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G1115 NIL) (#2=#:G1116 NIL) (#3=#:G1117 NIL) (% NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
    (LETT DV$1 |#1|)
