...
(SDEFUN |ISTRING;replace;$Us2$;15|
        ...
        (SPROG
         ((|k| NIL) (#1=#:G1245 NIL) (|i| NIL) (#2=#:G1244 NIL)
          (#3=#:G1243 NIL) (|r| ($)) (#4=#:G1237 NIL) (|h| (|Integer|))
...
(SDEFUN |ISTRING;substring?;2$IB;18|
        ...
        (SPROG
         ((#1=#:G1256 NIL) (#2=#:G1257 NIL) (#3=#:G1258 NIL) (|ip| NIL)
...
(SDEFUN |ISTRING;position;C$2I;20|
        ...
        (SPROG ((#2=#:G1269 NIL) (#3=#:G1270 NIL) (|r| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (LETT |startpos| (- |startpos| (QREFELT $ 6))
...
(SDEFUN |ISTRING;position;Cc$2I;21|
        ((|cc| |CharacterClass|) (|t| $) (|startpos| . #1=(|Integer|))
         ($ . #1#))
        (SPROG ((#2=#:G1277 NIL) (#3=#:G1278 NIL) (|r| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (LETT |startpos| (- |startpos| (QREFELT $ 6))
...
(SDEFUN |ISTRING;split;$CL;23| ((|s| $) (|c| |Character|) ($ |List| $))
        (SPROG
         ((|l| (|List| $)) (#1=#:G1289 NIL) (|i| NIL) (|j| (|Integer|))
          (#2=#:G1288 NIL) (|n| (|Integer|)))
         (SEQ
...
(SDEFUN |ISTRING;split;$CcL;24| ((|s| $) (|cc| |CharacterClass|) ($ |List| $))
        (SPROG
         ((|l| (|List| $)) (#1=#:G1297 NIL) (|i| NIL) (|j| (|Integer|))
          (#2=#:G1296 NIL) (|n| (|Integer|)))
         (SEQ
          (LETT |n| (SPADCALL |s| (QREFELT $ 42))
...
(SDEFUN |ISTRING;leftTrim;$Cc$;25| ((|s| $) (|cc| |CharacterClass|) ($ $))
        (SPROG ((#1=#:G1301 NIL) (|i| NIL) (|n| (|Integer|)))
               (SEQ
                (LETT |n| (SPADCALL |s| (QREFELT $ 42))
...
(SDEFUN |ISTRING;concat;L$;27| ((|l| |List| $) ($ $))
        (SPROG
         ((|i| (|Integer|)) (#1=#:G1314 NIL) (|s| NIL) (|t| ($))
          (#2=#:G1307 NIL) (#3=#:G1306 #4=(|NonNegativeInteger|))
          (#5=#:G1308 #4#) (#6=#:G1313 NIL))
         (SEQ
          (LETT |t|
                (SPADCALL
                 (PROGN
...
(SDEFUN |ISTRING;match?;2$CB;33|
        ...
        (SPROG
         ((|q| (|NonNegativeInteger|)) (#1=#:G1332 NIL)
          (|p| #2=(|NonNegativeInteger|)) (|i| #2#) (#3=#:G1341 NIL)
          (#4=#:G1331 NIL) (|s| ($)) (#5=#:G1330 NIL) (#6=#:G1327 NIL)
          (|m| (|Integer|)) (|n| (|Integer|)))
         (SEQ
          (EXIT
           (SEQ
...
(DEFUN |IndexedString;| (|#1|)
  (SPROG
   ((|pv$| NIL) (#1=#:G1348 NIL) (#2=#:G1349 NIL) (#3=#:G1350 NIL) ($ NIL)
    (|dv$| NIL) (DV$1 NIL))
   (PROGN
