...
(SDEFUN |QFCAT-;reducedSystem;MM;6| ((|m| (|Matrix| A)) (% (|Matrix| S)))
        (SPROG
         ((|nrm| (|NonNegativeInteger|)) (|ncm| (|NonNegativeInteger|))
          (|ans| (|Matrix| S)) (|i| NIL) (#1=#:G31 NIL) (|d| (S)) (|j| NIL)
          (#2=#:G32 NIL) (|ell| (A)) (#3=#:G23 NIL))
         (SEQ (LETT |nrm| (ANROWS |m|)) (LETT |ncm| (ANCOLS |m|))
              (LETT |ans| (MAKE_MATRIX1 |nrm| |ncm| (|spadConstant| % 24)))
              (SEQ (LETT |i| 1) (LETT #1# |nrm|) G190
...
(MAKEPROP '|QuotientFieldCategory&| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|List| 36) (|Record| (|:| |mat| 117) (|:| |vec| (|Vector| 26)))
              (|Matrix| 26) (|Union| 91 '#2#))
                       ...
                       (CONS
                        ...
                        (|makeByteWordVec2| 112
                                            '(1 6 7 0 8 1 6 0 7 9 1 6 7 0 11 0
                                              ...
                                              67 1 0 26 0 98 2 0 110 34 111 112
                                              1 0 33 34 35 3 0 80 0 73 80 81 3
                                              0 89 0 82 89 90 1 0 0 0 10 1 0 17
                                              0 20 2 0 0 21 0 22 0 0 0 16 1 0 0
                                              0 61 2 0 0 0 21 42 1 0 0 0 12 1 0
                                              73 0 76 1 0 82 0 85 1 0 47 0 50 1
                                              0 43 0 46 1 0 51 0 53 1 0 0 62 64
