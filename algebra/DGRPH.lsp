                 ...
                 (COND
                  ((SPADCALL |arrss| NIL (QREFELT $ 51))
                   (SEQ (PROGN (RPLACD |s| (LIST |a|)) (QCDR |s|))
                        (EXIT (PROGN (LETT #2# |s| . #3#) (GO #4=#:G376)))))
                  ('T
                   (SEQ
           ...
           (SEQ (LETT |arrss| (QCDR |s|) . #3=(|DGRPH;addArrow!;$S2NniL$;11|))
                ...
                (EXIT
                 (COND
                  ((SPADCALL |arrss| NIL (QREFELT $ 51))
                   (SEQ (PROGN (RPLACD |s| (LIST |a|)) (QCDR |s|))
                        (EXIT (PROGN (LETT #2# |s| . #3#) (GO #4=#:G384)))))
                  ('T
                   (SEQ
                    (LETT |arrs| (SPADCALL |arrss| |a| (QREFELT $ 20)) . #3#)
                    (PROGN (RPLACD |s| |arrs|) (QCDR |s|))
...
(SDEFUN |DGRPH;flatten;Dg$;14| ((|n| |DirectedGraph| $) ($ $))
        (SPROG
         ((|a|
          ...
          (|toOb3| #7=(|NonNegativeInteger|)) (|fromOb3| #7#) (#8=#:G415 NIL)
          (|endi| NIL) (#9=#:G416 NIL) (|starti| NIL) (|map3| #6#)
          ...
          (|fromOb2| #7#) (|arrType2| #3#) (|name2| #2#) (#11=#:G413 NIL)
          (|a3| NIL) (#12=#:G411 NIL) (|a2| NIL) (#13=#:G412 NIL) (|a2n| NIL)
          (|iv|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          ...
          (|obs2|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|ob2| #14#) (|py| #7#) (|px| #7#) (#15=#:G410 NIL) (|ob| NIL)
          (|obs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|v3| ($)) (#16=#:G409 NIL) (|v2| NIL)
          (|v|
           (|List|
          ...
          (|obs|
           (|List|
            #2=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #2#) (#3=#:G433 NIL) (|ob| NIL) (#4=#:G434 NIL) (|obn| NIL))
          ...
          (|ars|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|a| #1#) (#2=#:G465 NIL) (|obm| NIL)
          (|obs|
           (|List|
            #3=(|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                         (|:| |posY| (|NonNegativeInteger|)))))
          (|o| #3#) (#4=#:G463 NIL) (|ob| NIL) (#5=#:G464 NIL) (|obn| NIL))
...
(SDEFUN |DGRPH;merge;3$;22| ((|a| $) (|b| $) ($ $))
        (SPROG
         ((|la|
          ...
          (#3=#:G494 NIL) (|ba| NIL) (|bStart| #4=(|NonNegativeInteger|))
          (|bmap| (|List| (|NonNegativeInteger|))) (#5=#:G482 NIL)
          (|newIndex| #4#)
          (|mergedObjects|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (|i| (|Integer|)) (#6=#:G493 NIL) (|bob| NIL) (#7=#:G492 NIL)
          (|x| NIL) (#8=#:G491 NIL))
         (SEQ
          (LETT |bmap|
                (PROGN
...
(SDEFUN |DGRPH;objProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|bxi| #3=(|NonNegativeInteger|)) (|bi| (S)) (#4=#:G505 NIL)
          (|boi| NIL) (|ayi| #2#) (|axi| #3#) (|ai| (S)) (#5=#:G504 NIL)
          (|aoi| NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G553 NIL) (|bv| NIL)
          (#3=#:G552 NIL) (|bu| NIL) (#4=#:G551 NIL) (|av| NIL) (#5=#:G550 NIL)
          (|au| NIL))
...
(SDEFUN |DGRPH;closedObjProd|
        ...
        (SPROG
         ((|newObjs|
          ...
          (|x| #3#) (|byi| #2#) (|bxi| #1#) (|bi| (S)) (#4=#:G562 NIL)
          (|boi| NIL) (|ayi| #2#) (|axi| #1#) (|ai| (S)) (#5=#:G561 NIL)
          (|aoi| NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G583 NIL) (|bv| NIL)
          (#3=#:G582 NIL) (|bu| NIL) (#4=#:G581 NIL) (|av| NIL) (#5=#:G580 NIL)
          (|au| NIL))
         ...
         ((|newArrs|
           (|List|
            #1=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|arr| #1#) (|an| (|String|)) (#2=#:G609 NIL) (|bv| NIL)
          (#3=#:G608 NIL) (|bu| NIL) (#4=#:G607 NIL) (|av| NIL) (#5=#:G606 NIL)
          (|au| NIL))
         ...
         ((|newArrs|
          ...
          (|newArr|
           (|Record| (|:| |name| (|String|))
                     ...
                     (|:| |xOffset| (|Integer|)) (|:| |yOffset| (|Integer|))
                     (|:| |map| (|List| (|NonNegativeInteger|)))))
          (#1=#:G620 NIL) (|j| NIL) (#2=#:G619 NIL) (|i| NIL)
          (|ars|
           (|List|
            (|Record| (|:| |name| (|String|))
                      (|:| |arrType| (|NonNegativeInteger|))
         ...
         ((|newArrs|
           (|List|
            #2=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|newArr| #2#) (#3=#:G637 NIL) (|oldArrow| NIL) (#4=#:G625 NIL)
          (#5=#:G624 NIL) (|i| (|NonNegativeInteger|)) (#6=#:G636 NIL)
          (|oi| NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (#7=#:G635 NIL) (|o| NIL) (#8=#:G634 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
         ...
         ((|newArrs|
           (|List|
            #2=(|Record| (|:| |name| (|String|))
                         ...
                         (|:| |yOffset| (|Integer|))
                         (|:| |map| (|List| (|NonNegativeInteger|))))))
          (|newArr| #2#) (#3=#:G654 NIL) (|oldArrow| NIL) (#4=#:G642 NIL)
          (#5=#:G641 NIL) (|i| (|NonNegativeInteger|)) (#6=#:G653 NIL)
          (|oi| NIL)
          (|newObjs|
           (|List|
            (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                      (|:| |posY| (|NonNegativeInteger|)))))
          (#7=#:G652 NIL) (|o| NIL) (#8=#:G651 NIL))
         (SEQ
          (LETT |newObjs|
                (PROGN
        ...
        (SPROG
         ((|arn| (|Integer|))
          ...
          (|o|
           (|Record| (|:| |value| S) (|:| |posX| (|NonNegativeInteger|))
                     (|:| |posY| (|NonNegativeInteger|))))
          (#2=#:G663 NIL) (|ob| NIL) (#3=#:G664 NIL) (|obn| NIL))
