...
(SDEFUN |REP2;blockMultiply|
        ((|a| |Matrix| R) (|b| |Matrix| R) (|li| |List| (|Integer|))
         (|n| |Integer|) ($ |Matrix| R))
        (SPROG
         ((#1=#:G123 NIL) (#2=#:G122 (R)) (#3=#:G124 (R)) (|s| NIL)
          (#4=#:G131 NIL) (|j| NIL) (#5=#:G130 NIL) (#6=#:G129 NIL) (|i| NIL)
          (#7=#:G128 NIL))
         (SEQ
          (SPADCALL
           (PROGN
...
(SDEFUN |REP2;fingerPrint|
        ((|i| |NonNegativeInteger|) (|a| |Matrix| R) (|b| |Matrix| R)
         (|x| |Matrix| R) ($ |Matrix| R))
        (SPROG
         ((#1=#:G147 NIL) (#2=#:G145 NIL) (#3=#:G143 NIL) (#4=#:G141 NIL)
          (#5=#:G139 NIL) (#6=#:G137 NIL))
         (SEQ
          (COND
           ((EQL
...
(SDEFUN |REP2;cyclicSubmodule;LVV;5|
        ...
        (SPROG
         ((#1=#:G175 NIL) (|i| NIL) (#2=#:G174 NIL)
          (|furtherElts| (|List| (|Vector| R)))
          (|updateFurtherElts| (|List| (|Vector| R))) (#3=#:G173 NIL)
          (#4=#:G172 NIL) (|basis| (|Matrix| R)) (|addedToBasis| (|Matrix| R))
          (|nextVector| (|Matrix| R)) (|w| (|Vector| R)) (#5=#:G171 NIL)
          (#6=#:G170 NIL))
         (SEQ
          (LETT |basis|
                (SPADCALL
...
(SDEFUN |REP2;standardBasisOfCyclicSubmodule;LVM;6|
        ...
        (SPROG
         ((|furtherElts| (|List| (|Vector| R)))
          (|updateFurtherElts| (|List| (|Vector| R))) (#1=#:G186 NIL) (|i| NIL)
          (#2=#:G185 NIL) (|basis| (|Matrix| R))
          (|standardBasis| (|List| (|List| R))) (|addedToBasis| (|Matrix| R))
          (|nextVector| (|Matrix| R)) (|w| (|Vector| R)) (#3=#:G184 NIL)
          (#4=#:G183 NIL) (|dim| (|NonNegativeInteger|)))
         (SEQ
          (LETT |dim| (QVSIZE |v|)
...
(SDEFUN |REP2;splitInternal|
        ...
        (SPROG
         ((|factormoduleRepresentation| #1=(|List| (|Matrix| R)))
          ...
          (#2=#:G201 NIL) (|i| NIL) (|inverseTransitionMatrix| (|Matrix| R))
          (|transitionMatrix| (|Matrix| R))
          (|factormoduleIndices| (|List| (|Integer|))) (#3=#:G200 NIL)
          (|submoduleIndices| (|List| (|Integer|))) (#4=#:G199 NIL)
          (|rankOfSubmodule| (|Integer|)) (|submodule| (|Vector| (|Vector| R)))
          (|n| (|Integer|)))
         (SEQ (LETT |n| (QVSIZE |vector|) . #5=(|REP2;splitInternal|))
              (LETT |submodule|
                    (SPADCALL |algebraGenerators| |vector| (QREFELT $ 47))
                    . #5#)
              (LETT |rankOfSubmodule| (QVSIZE |submodule|) . #5#)
              (LETT |submoduleRepresentation| NIL . #5#)
              (LETT |factormoduleRepresentation| NIL . #5#)
              (EXIT
               (COND
                   ...
                   (|doSplitting?|
                    (SEQ
                     ...
                     (LETT |factormoduleIndices|
                           (PROGN
                            (LETT #3# NIL . #5#)
                            (SEQ (LETT |i| (+ 1 |rankOfSubmodule|) . #5#) G190
                                 (COND ((> |i| |n|) (GO G191)))
                                 (SEQ (EXIT (LETT #3# (CONS |i| #3#) . #5#)))
...
(SDEFUN |REP2;irreducibilityTestInternal|
        ((|algebraGenerators| |List| (|Matrix| R))
         ...
         ($ |List| (|List| (|Matrix| R))))
        (SPROG
         ((|mat| (|Matrix| R)) (#1=#:G218 NIL) (|j| NIL) (#2=#:G217 NIL)
          (|i| NIL) (|result| (|List| (|List| (|Matrix| R))))
          (|kernel| (|List| (|Vector| R))) (|xt| (|Matrix| R))
          (|algebraGeneratorsTranspose| (|List| (|Matrix| R))) (#3=#:G216 NIL)
          (#4=#:G215 NIL))
         (SEQ
...
(SDEFUN |REP2;areEquivalent?;2LBIM;11|
        ...
        (SPROG
         ((|transitionM| (|Matrix| R)) (|result| #1=(|Boolean|)) (|j| NIL)
          (|foundResult| #1#) (|baseChange1| #2=(|Matrix| R))
          (|baseChange0| #2#) (|kernel1| #3=(|List| (|Vector| R)))
          (|kernel0| #3#) (|rk1| #4=(|NonNegativeInteger|)) (|rk0| #4#)
          (|x1| #5=(|Matrix| R)) (|x0| #5#) (|randomIndex| (|Integer|))
          (|i| NIL) (#6=#:G248 NIL) (|n| (|NonNegativeInteger|))
          (|numberOfGenerators| (|NonNegativeInteger|)))
         (SEQ (LETT |result| 'NIL . #7=(|REP2;areEquivalent?;2LBIM;11|))
              (LETT |transitionM| (SPADCALL 1 1 (QREFELT $ 23)) . #7#)
              (LETT |numberOfGenerators| (LENGTH |aG0|) . #7#)
              (COND
               (|randomelements|
                (SEQ
                 (LETT |randomIndex| (+ 1 (RANDOM |numberOfGenerators|)) . #7#)
                 (LETT |x0| (SPADCALL |aG0| |randomIndex| (QREFELT $ 32))
                       . #7#)
                 (EXIT
                  (LETT |x1| (SPADCALL |aG1| |randomIndex| (QREFELT $ 32))
                        . #7#)))))
              (LETT |n| (QVSIZE (SPADCALL |x0| 1 (QREFELT $ 44))) . #7#)
              (LETT |foundResult| 'NIL . #7#)
              (SEQ (LETT #6# NIL . #7#) (LETT |i| 1 . #7#) G190
                   (COND
                    ((OR (|greater_SI| |i| |numberOfTries|) #6#) (GO G191)))
                   (SEQ (COND ((EQL |i| 7) (LETT |randomelements| 'T . #7#)))
                        (COND
                         (|randomelements|
                          (SEQ
                           (LETT |randomIndex|
                                 (+ 1 (RANDOM |numberOfGenerators|)) . #7#)
                           (LETT |x0|
                                 (SPADCALL |x0|
                          ...
                          (SEQ
                           ...
                           (EXIT
                            (LETT |x1|
                                  ...
                                  . #7#)))))
                        (LETT |rk0| (SPADCALL |x0| (QREFELT $ 41)) . #7#)
                        (LETT |rk1| (SPADCALL |x1| (QREFELT $ 41)) . #7#)
                        (EXIT
                         (COND
                          ((SPADCALL |rk0| |rk1| (QREFELT $ 42))
                           (SEQ
                            (SPADCALL "Dimensions of kernels differ"
                                      (QREFELT $ 54))
                            (LETT |foundResult| 'T . #7#)
                            (EXIT (LETT |result| 'NIL . #7#))))
                               ...
                               (SEQ
                                ...
                                (EXIT
                                 (SPADCALL
                                  ...
                                  (QREFELT $ 54))))))))))))
                   (LETT |i|
                         (PROG1 (|inc_SI| |i|) (LETT #6# |foundResult| . #7#))
                         . #7#)
                   (GO G190) G191 (EXIT NIL))
              (COND
               (|foundResult|
...
(SDEFUN |REP2;isAbsolutelyIrreducible?;LIB;13|
        ...
        (SPROG
         ((|result| #1=(|Boolean|)) (|kernel| (|List| (|Vector| R)))
          ...
          (|randomIndex| (|Integer|)) (|i| NIL) (#2=#:G257 NIL)
...
(SDEFUN |REP2;split;LVL;15|
        ...
        (SPROG
         ((|factormoduleRepresentation| #1=(|List| (|Matrix| R)))
          (|submoduleRepresentation| #1#) (|helpMatrix| (|Matrix| R))
          (#2=#:G270 NIL) (|i| NIL) (|inverseTransitionMatrix| (|Matrix| R))
          (|transitionMatrix| (|Matrix| R))
          (|factormoduleIndices| (|List| (|Integer|))) (#3=#:G269 NIL)
          (|submoduleIndices| (|List| (|Integer|))) (#4=#:G268 NIL)
         ...
         (SEQ
          ...
          (SPADCALL "  Transition matrix computed" (QREFELT $ 54))
          (LETT |inverseTransitionMatrix|
                (QCDR (SPADCALL |transitionMatrix| (QREFELT $ 56))) . #5#)
          (SPADCALL "  The inverse of the transition matrix computed"
                    (QREFELT $ 54))
          (SPADCALL "  Now transform the matrices" (QREFELT $ 54))
          (SEQ (LETT |i| 1 . #5#)
               (LETT #2# (SPADCALL |algebraGenerators| (QREFELT $ 38)) . #5#)
               G190 (COND ((|greater_SI| |i| #2#) (GO G191)))
               (SEQ
                (LETT |helpMatrix|
                      (SPADCALL |inverseTransitionMatrix|
...
(SDEFUN |REP2;my_min| ((|m| |Matrix| R) (|n| |Integer|) ($ |Smp|))
        (SPROG
         ((|xi| (|Smp|)) (|res| (|Smp|)) (#1=#:G287 NIL) (|i| NIL)
          (|x| (|Smp|)) (|j| (|Integer|)) (|depe| (|Matrix| R))
          (|depm| (|Matrix| R)) (#2=#:G286 NIL) (|v| #3=(|Vector| R))
          (#4=#:G285 NIL) (|depl| (|List| (|Vector| R))) (#5=#:G284 NIL)
          (|zz| #3#) (#6=#:G272 NIL))
         (SEQ
          (LETT |zz|
                (SPADCALL
...
(SDEFUN |REP2;m_eval|
        ...
        (SPROG
         ((|old_deg| #1=(|NonNegativeInteger|)) (|res| (|Matrix| R))
          (#2=#:G297 NIL) (|i| NIL) (|ndeg| #1#) (|c0| (R)) (|id| (|Matrix| R))
          (#3=#:G295 NIL) (#4=#:G296 NIL) (|nn| (|NonNegativeInteger|))
          (#5=#:G288 NIL))
         (SEQ
          (LETT |nn|
