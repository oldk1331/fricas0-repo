...
(SDEFUN |LATJOFM;/\\;3%;8| ((|a| (%)) (|b| (%)) (% (%)))
        (SPROG
         ((#1=#:G78 NIL) (|innera| NIL) (#2=#:G79 NIL) (|innerb| NIL)
          (#3=#:G80 NIL)
          (|termLeft|
           #4=(|List|
               (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
           ...
           (SEQ
            (COND
             ((SPADCALL |a| (QREFELT % 17))
              (PROGN (LETT #1# |b|) (GO #5=#:G77))))
            (COND
             ((SPADCALL |b| (QREFELT % 17)) (PROGN (LETT #1# |a|) (GO #5#))))
            (LETT |r| NIL)
            (SEQ (LETT |innera| NIL) (LETT #2# |a|) G190
                 (COND
                  ((OR (ATOM #2#) (PROGN (LETT |innera| (CAR #2#)) NIL))
                   (GO G191)))
                 (SEQ
                  (EXIT
                   (SEQ (LETT |innerb| NIL) (LETT #3# |b|) G190
                        (COND
                         ((OR (ATOM #3#) (PROGN (LETT |innerb| (CAR #3#)) NIL))
                          (GO G191)))
        ...
        ((|a|
         ...
         (|b|
          (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                   (|:| |var| (|Record| (|:| |str| (|String|))))))
         (% (|Boolean|)))
        (SPROG ((#1=#:G103 NIL) (#2=#:G102 NIL) (#3=#:G106 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
         ...
         (%
          (|List|
           (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                    (|:| |var| (|Record| (|:| |str| (|String|))))))))
        (SPROG
         ((|ne1| NIL) (#1=#:G123 NIL) (|e1| NIL) (#2=#:G122 NIL) (|ne2| NIL)
          (#3=#:G125 NIL) (|e2| NIL) (#4=#:G124 NIL) (|match| (|Boolean|))
          (|r|
           (|List|
            (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                     (|:| |var| (|Record| (|:| |str| (|String|))))))))
         (SEQ (LETT |r| NIL)
              (SEQ (LETT |ne1| 1) (LETT #1# (LENGTH |n|)) (LETT |e1| NIL)
                   (LETT #2# |n|) G190
                   (COND
                    ((OR (ATOM #2#) (PROGN (LETT |e1| (CAR #2#)) NIL)
                         (|greater_SI| |ne1| #1#))
                     (GO G191)))
                   (SEQ (LETT |match| NIL)
                        (SEQ (LETT |ne2| 1) (LETT #3# (LENGTH |n|))
                             (LETT |e2| NIL) (LETT #4# |n|) G190
                             (COND
                              ((OR (ATOM #4#) (PROGN (LETT |e2| (CAR #4#)) NIL)
                                   (|greater_SI| |ne2| #3#))
                               (GO G191)))
                             (SEQ
                              (EXIT
                   ...
                   (LETT #2# (PROG1 (CDR #2#) (LETT |ne1| (|inc_SI| |ne1|))))
                   (GO G190) G191 (EXIT NIL))
              (EXIT |r|)))) 
...
(SDEFUN |LATJOFM;equalTerms|
        ((|a|
         ...
         (% (|Boolean|)))
        (SPROG
         ((|a1| NIL) (#1=#:G144 NIL) (|b1| NIL) (#2=#:G145 NIL)
          (|found| (|Boolean|)) (#3=#:G143 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((SPADCALL (LENGTH |a|) (LENGTH |b|) (QREFELT % 32))
              (PROGN (LETT #3# NIL) (GO #4=#:G142))))
            (SEQ (LETT |a1| NIL) (LETT #1# |a|) G190
                 ...
                 (SEQ (LETT |found| NIL)
                      ...
                      (EXIT
                       (COND
                        ((NULL |found|) (PROGN (LETT #3# NIL) (GO #4#))))))
                 (LETT #1# (CDR #1#)) (GO G190) G191 (EXIT NIL))
            (EXIT 'T)))
          #4# (EXIT #3#)))) 
...
(SDEFUN |LATJOFM;subTerm|
        ((|a|
         ...
         (% (|Boolean|)))
        (SPROG
         ((|a1| NIL) (#1=#:G164 NIL) (|b1| NIL) (#2=#:G165 NIL)
          (|found| (|Boolean|)) (#3=#:G163 NIL))
         (SEQ
          (EXIT
           (SEQ
            (COND
             ((>= (LENGTH |a|) (LENGTH |b|))
              (PROGN (LETT #3# NIL) (GO #4=#:G162))))
            (SEQ (LETT |a1| NIL) (LETT #1# |a|) G190
                 (COND
                  ((OR (ATOM #1#) (PROGN (LETT |a1| (CAR #1#)) NIL))
                   (GO G191)))
...
(SDEFUN |LATJOFM;redux;2%;16| ((|n| (%)) (% (%)))
        (SPROG
         ((|outern| NIL) (#1=#:G179 NIL) (|outer| NIL) (#2=#:G178 NIL)
          (|newinnerList|
           (|List|
            (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                     (|:| |var| (|Record| (|:| |str| (|String|)))))))
          (|innern| NIL) (#3=#:G181 NIL) (#4=#:G180 NIL)
          (|match| #5=(|Boolean|)) (|inner| NIL) (#6=#:G182 NIL)
          (|isSubTerm| #5#) (|modified| #5#)
          (|r|
           (|List|
            (|List|
             (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
         ...
         (SEQ (LETT |r| NIL) (LETT |modified| NIL)
              (SEQ (LETT |outern| 1) (LETT #1# (LENGTH |n|)) (LETT |outer| NIL)
                   (LETT #2# |n|) G190
                   (COND
                    ((OR (ATOM #2#) (PROGN (LETT |outer| (CAR #2#)) NIL)
                         (|greater_SI| |outern| #1#))
                     (GO G191)))
                   (SEQ
                    (LETT |newinnerList|
                    ...
                    (COND
                     ((NULL (|LATJOFM;equalTerms| |newinnerList| |outer| %))
                      (LETT |modified| 'T)))
                    (LETT |match| NIL)
                    (SEQ (LETT |innern| 1) (LETT #3# (LENGTH |n|))
                         (LETT |inner| NIL) (LETT #4# |n|) G190
                         (COND
                          ((OR (ATOM #4#) (PROGN (LETT |inner| (CAR #4#)) NIL)
                               (|greater_SI| |innern| #3#))
                           (GO G191)))
                         (SEQ
                          (EXIT
                         ...
                         (GO G190) G191 (EXIT NIL))
                    (LETT |isSubTerm| NIL)
                    (SEQ (LETT |inner| NIL) (LETT #6# |n|) G190
                         (COND
                          ((OR (ATOM #6#) (PROGN (LETT |inner| (CAR #6#)) NIL))
                           (GO G191)))
                         (SEQ
                          (EXIT
                           (COND
                           ...
                           ('T
                            (LETT |r|
                                  (SPADCALL |r| |newinnerList|
                                            (QREFELT % 21)))))))
                   (LETT #2#
                         (PROG1 (CDR #2#) (LETT |outern| (|inc_SI| |outern|))))
                   (GO G190) G191 (EXIT NIL))
              (EXIT
...
(SDEFUN |LATJOFM;stringVarOrLit|
        ((|a|
          (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                   (|:| |var| (|Record| (|:| |str| (|String|))))))
         (% (|String|)))
        (SPROG ((#1=#:G109 NIL) (#2=#:G196 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (COND
                   ((QEQCAR |a| 1)
                    (PROGN (LETT #2# (QCAR (CDR |a|))) (GO #3=#:G195))))
                  (COND
                   ((QEQCAR |a| 0)
                    (SEQ
                     (COND
                      ((EQUAL
                        ...
                        'T)
                       (PROGN (LETT #2# "T") (GO #3#))))
                     (EXIT (PROGN (LETT #2# "F") (GO #3#))))))
                  (EXIT "error")))
                #3# (EXIT #2#)))) 

(SDEFUN |LATJOFM;toStringUnwrapped;%S;27| ((|n| (%)) (% (|String|)))
        (SPROG
         ((|outern| NIL) (#1=#:G210 NIL) (|outer| NIL) (#2=#:G209 NIL)
          (|innern| NIL) (#3=#:G212 NIL) (|inner| NIL) (#4=#:G211 NIL)
          (|r| (|String|)))
         (SEQ (LETT |r| "")
              (SEQ (LETT |outern| 1) (LETT #1# (LENGTH |n|)) (LETT |outer| NIL)
                   (LETT #2# |n|) G190
                   ...
                   (SEQ
                    (SEQ (LETT |innern| 1) (LETT #3# (LENGTH |outer|))
                         (LETT |inner| NIL) (LETT #4# |outer|) G190
                         (COND
                          ((OR (ATOM #4#) (PROGN (LETT |inner| (CAR #4#)) NIL)
                               (|greater_SI| |innern| #3#))
                           (GO G191)))
                ...
                (EXIT
                 (SEQ
                  (COND
                   ((QEQCAR |a| 1)
                    (PROGN
                     (LETT #2# (SPADCALL (QCAR (CDR |a|)) (QREFELT % 45)))
                     (GO #3=#:G214))))
                  (COND
                   ((QEQCAR |a| 0)
                    (PROGN
...
(SDEFUN |LATJOFM;coerce;%Of;29| ((|n| (%)) (% (|OutputForm|)))
        (SPROG
         ((|outern| NIL) (#1=#:G229 NIL) (|outer| NIL) (#2=#:G228 NIL)
          (|innern| NIL) (#3=#:G231 NIL) (|inner| NIL) (#4=#:G230 NIL)
          (|r| (|OutputForm|)))
...
(SDEFUN |LATJOFM;coerce;%Lmoj;30| ((|n| (%)) (% (|LatticeMeetOfJoins|)))
        (SPROG
         ((|outern| NIL) (#1=#:G243 NIL) (|outer| NIL) (#2=#:G242 NIL)
          (|innern| NIL) (#3=#:G245 NIL) (|inner| NIL) (#4=#:G244 NIL)
          (|ele| (|LatticeMeetOfJoins|)) (|term| #5=(|LatticeMeetOfJoins|))
          (|r| #5#))
         ...
         ((|n|
           (|List|
            (|List|
             (|Union| (|:| |const| (|Record| (|:| |val| (|Symbol|))))
                      (|:| |var| (|Record| (|:| |str| (|String|))))))))
          (|outern| NIL) (#1=#:G257 NIL) (|outer| NIL) (#2=#:G256 NIL)
          (|innern| NIL) (#3=#:G259 NIL) (|inner| NIL) (#4=#:G258 NIL)
          (|ele| (%)) (|term| (%)) (|r| (%)))
