...
(DEFUN |SBOUND;sunion;3$;6| (|x| |y| $)
  (PROG (|ymax| #1=#:G146 |ymin| |xmax| |xmin| #2=#:G177 |res| #3=#:G179 |ptr|
         |p| #4=#:G147 #5=#:G178)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |SBOUND;extendToPoint;$PT$;7| (|n| |p| $)
  (PROG (|xmax| |xmin| #1=#:G190 |res| #2=#:G191 |ptr| |pa| #3=#:G147)
    (RETURN
     (SEQ
      (EXIT
       (SEQ
...
(DEFUN |SBOUND;containsPoint?;$PTB;8| (|n| |p| $)
  (PROG (#1=#:G146 #2=#:G200 |rDist| |pDist| |pRel| #3=#:G201 |sub| |pa|
         #4=#:G147)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |SBOUND;lineIntersect;$2PT;9| (|n| |p| $)
  (PROG (|y| |x| |yp| |xp| |b| |a| |rad| #1=#:G146 |pRel| |cent| #2=#:G213
         |divisor| |ab| |centre|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |SBOUND;coerce;$Of;17| (|n| $)
  (PROG (|sub| #1=#:G252 #2=#:G147 |x| #3=#:G251 #4=#:G250 #5=#:G146 |s| |ty|)
    (RETURN
     (SEQ
      (EXIT
       (SEQ
