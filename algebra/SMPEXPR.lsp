...
(DEFUN |SparseMultivariatePolynomialExpressions| (#1=#:G174)
  (SPROG NIL
         (PROG (#2=#:G175)
           (RETURN
            (COND
...
(DEFUN |SparseMultivariatePolynomialExpressions;| (|#1|)
  (SPROG
   ((#1=#:G173 NIL) (|pv$| NIL) (#2=#:G163 NIL) (#3=#:G164 NIL) (#4=#:G165 NIL)
    (#5=#:G166 NIL) (#6=#:G167 NIL) (#7=#:G168 NIL) (#8=#:G169 NIL)
    (#9=#:G170 NIL) (#10=#:G171 NIL) (#11=#:G172 NIL) ($ NIL) (|dv$| NIL)
    (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|SparseMultivariatePolynomialExpressions| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL (|SparseMultivariatePolynomial| 6 41)
              ...
              (|Union| 41 '#2#) (|List| 59) (|Equation| $)
              (|Union| 45 '#3="failed")
              (|Record| (|:| |var| 41) (|:| |exponent| 41)) (|Union| 61 '#3#)
              (|SparseUnivariatePolynomial| 6) (|List| 6) (|Mapping| 66 66)
              (|IndexedExponents| 41) (|Union| 6 '#2#) (|Mapping| 6 6)
           ...
           (CONS
            ...
            (CONS
             ...
             (CONS
              '#((|PolynomialCategory| 6 66 41)
                 (|MaybeSkewPolynomialCategory| 6 66 41)
                 (|PolynomialFactorizationExplicit|)
                 (|FiniteAbelianMonoidRing| 6 66) (|UniqueFactorizationDomain|)
                 (|AbelianMonoidRing| 6 66) (|GcdDomain|) (|IntegralDomain|)
                 (|Algebra| 43) (|Algebra| 6)
                 (|FullyLinearlyExplicitRingOver| 6) (|Algebra| $$)
                 (|LeftOreRing|) (|Module| 43) (|CharacteristicNonZero|)
                 (|CharacteristicZero|) (|Module| 6)
                 (|LinearlyExplicitRingOver| 6) (|LinearlyExplicitRingOver| 40)
