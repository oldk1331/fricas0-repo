...
(DEFUN |SparseMultivariatePolynomialExpressions| (#1=#:G193)
  (SPROG NIL
         (PROG (#2=#:G194)
           (RETURN
            (COND
...
(DEFUN |SparseMultivariatePolynomialExpressions;| (|#1|)
  (SPROG
   ((#1=#:G192 NIL) (|pv$| NIL) (#2=#:G183 NIL) (#3=#:G185 NIL) (#4=#:G184 NIL)
    (#5=#:G186 NIL) (#6=#:G187 NIL) (#7=#:G188 NIL) (#8=#:G189 NIL)
    (#9=#:G190 NIL) (#10=#:G191 NIL) ($ NIL) (|dv$| NIL) (DV$1 NIL))
   (PROGN
