...
(DEFUN |ACFS-;rootOf;2S;1| (|p| $)
  (PROG (|l|)
    (RETURN
     (COND
      ((NULL (LETT |l| (SPADCALL |p| (QREFELT $ 9)) |ACFS-;rootOf;2S;1|))
       (|error| "rootOf: constant expression"))
      ('T (SPADCALL |p| (|SPADfirst| |l|) (QREFELT $ 11))))))) 

(DEFUN |ACFS-;rootsOf;SL;2| (|p| $)
  (PROG (|l|)
    (RETURN
     (COND
      ((NULL (LETT |l| (SPADCALL |p| (QREFELT $ 9)) |ACFS-;rootsOf;SL;2|))
       (|error| "rootsOf: constant expression"))
      ('T (SPADCALL |p| (|SPADfirst| |l|) (QREFELT $ 14))))))) 

(DEFUN |ACFS-;zeroOf;2S;3| (|p| $)
  (PROG (|l|)
    (RETURN
     (COND
      ((NULL (LETT |l| (SPADCALL |p| (QREFELT $ 9)) |ACFS-;zeroOf;2S;3|))
       (|error| "zeroOf: constant expression"))
      ('T (SPADCALL |p| (|SPADfirst| |l|) (QREFELT $ 16))))))) 

(DEFUN |ACFS-;zerosOf;SL;4| (|p| $)
  (PROG (|l|)
    (RETURN
     (COND
      ((NULL (LETT |l| (SPADCALL |p| (QREFELT $ 9)) |ACFS-;zerosOf;SL;4|))
       (|error| "zerosOf: constant expression"))
      ('T (SPADCALL |p| (|SPADfirst| |l|) (QREFELT $ 18))))))) 

(DEFUN |ACFS-;zeroOf;SSS;5| (|p| |x| $)
  (PROG (|n| |f|)
    (RETURN
     (SEQ
      (LETT |n|
            (SPADCALL
             (LETT |f|
                   (SPADCALL |p| (SPADCALL |x| (QREFELT $ 21)) (QREFELT $ 24))
                   . #1=(|ACFS-;zeroOf;SSS;5|))
             (QREFELT $ 27))
            . #1#)
      (EXIT
       (COND
        ((SPADCALL (SPADCALL (SPADCALL |f| (QREFELT $ 28)) (QREFELT $ 30)) 0
                   (QREFELT $ 33))
...
(DEFUN |ACFS-;rootsOf;SupSL;9| (|p| |y| $)
  (PROG (|r|)
    (RETURN
     (SEQ (LETT |r| (SPADCALL |p| (QREFELT $ 44)) |ACFS-;rootsOf;SupSL;9|)
          (EXIT
           (COND ((QEQCAR |r| 0) (SPADCALL (QCDR |r|) |y| (QREFELT $ 14)))
                 ('T (SPADCALL |p| |y| (QREFELT $ 46))))))))) 

(DEFUN |ACFS-;zerosOf;SupSL;10| (|p| |y| $)
  (PROG (|r|)
    (RETURN
     (SEQ (LETT |r| (SPADCALL |p| (QREFELT $ 44)) |ACFS-;zerosOf;SupSL;10|)
          (EXIT
           (COND ((QEQCAR |r| 0) (SPADCALL (QCDR |r|) |y| (QREFELT $ 18)))
                 ('T (SPADCALL |p| |y| (QREFELT $ 48))))))))) 

(DEFUN |ACFS-;zeroOf;SupSS;11| (|p| |y| $)
  (PROG (|r|)
    (RETURN
     (SEQ (LETT |r| (SPADCALL |p| (QREFELT $ 44)) |ACFS-;zeroOf;SupSS;11|)
          (EXIT
...
(DEFUN |AlgebraicallyClosedFunctionSpace&| (|#1| |#2|)
  (PROG (|pv$| $ |dv$| DV$2 DV$1)
    (RETURN
     (PROGN
      (LETT DV$1 (|devaluate| |#1|) . #1=(|AlgebraicallyClosedFunctionSpace&|))
      (LETT DV$2 (|devaluate| |#2|) . #1#)
      (LETT |dv$| (LIST '|AlgebraicallyClosedFunctionSpace&| DV$1 DV$2) . #1#)
      (LETT $ (GETREFV 53) . #1#)
      (QSETREFV $ 0 |dv$|)
