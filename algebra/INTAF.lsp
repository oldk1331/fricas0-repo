          ...
          (LETT |lf1|
                (PROGN
                 ...
                 (SEQ (LETT |f| NIL) (LETT #2# |lf|) G190
                      ...
                      (EXIT (NREVERSE #1#)))))
          (LETT |r|
                (PROG2 (LETT #3# (SPADCALL (QCDR |r1|) (QREFELT % 34)))
                    (QCDR #3#)
         ...
         ((|c_rec|
          ...
          (|red|
           (|Mapping| |curve|
                      (|SparseUnivariatePolynomial|
                       (|Fraction| (|SparseUnivariatePolynomial| F)))))
          (|cc| (|Fraction| (|SparseUnivariatePolynomial| F))) (#1=#:G76 NIL)
          (|f| NIL) (#2=#:G77 NIL)
          (|res1|
           (|List|
            (|Record| (|:| |ratpart| |curve|) (|:| |coeffs| (|Vector| F)))))
          (#3=#:G78 NIL) (|be| NIL) (#4=#:G79 NIL))
         (SEQ
          (LETT |c_rec|
                (COND
          ...
          (LETT |res1|
                (SPADCALL |der| |ext| |rde| |csolve|
                          (PROGN
                           (LETT #1# NIL)
                           (SEQ (LETT |f| NIL) (LETT #2# (QVELT |c_rec| 0))
                                G190
                                (COND
                                 ((OR (ATOM #2#)
          ...
          (EXIT
           (PROGN
            (LETT #3# NIL)
            (SEQ (LETT |be| NIL) (LETT #4# |res1|) G190
                 (COND
...
(SDEFUN |INTAF;algextint_base;2KMMLL;9|
        ((|x| (|Kernel| F)) (|y| (|Kernel| F))
         ...
         (% (|List| (|Record| (|:| |ratpart| F) (|:| |coeffs| (|Vector| F))))))
        (SPROG
         ((|p| (|SparseUnivariatePolynomial| F)) (#1=#:G101 NIL) (|g| NIL)
          (#2=#:G102 NIL)
          (|lg1|
           (|List|
            (|SparseUnivariatePolynomial|
          ...
          (|red|
           (|Mapping| |curve|
                      (|SparseUnivariatePolynomial|
                       (|Fraction| (|SparseUnivariatePolynomial| F)))))
          (#4=#:G103 NIL) (|f| NIL) (#5=#:G104 NIL)
          (|res1|
           (|List|
            (|Record| (|:| |ratpart| |curve|) (|:| |coeffs| (|Vector| F)))))
          (#6=#:G105 NIL) (|be| NIL) (#7=#:G106 NIL))
         (SEQ (LETT |p| (SPADCALL |y| (QREFELT % 24)))
              ...
              (LETT |res1|
                    (SPADCALL |der| |csolve|
                              (PROGN
                               (LETT #4# NIL)
                               (SEQ (LETT |f| NIL) (LETT #5# (QVELT |cv| 0))
                                    G190
                                    (COND
                                     ((OR (ATOM #5#)
              ...
              (EXIT
               (PROGN
                (LETT #6# NIL)
                (SEQ (LETT |be| NIL) (LETT #7# |res1|) G190
                     (COND
