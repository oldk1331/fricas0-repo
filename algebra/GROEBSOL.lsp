...
(SDEFUN |GROEBSOL;genPos|
        ...
        (SPROG
         ((#1=#:G130 NIL) (|testfail| (|Boolean|))
          ...
          (#3=#:G163 NIL) (|p| NIL) (#4=#:G162 NIL)
          (|val| #5=(|HomogeneousDistributedMultivariatePolynomial| |lv| F))
          (#6=#:G149 NIL) (#7=#:G148 #5#) (#8=#:G150 #5#) (#9=#:G160 NIL)
          (|vv| NIL) (#10=#:G161 NIL) (|rv| NIL)
          (|ranvals| (|List| (|Integer|))) (#11=#:G159 NIL) (#12=#:G158 NIL)
          (|count| NIL) (|rlvar| (|List| (|OrderedVariableList| |lv|)))
          (|x| (|OrderedVariableList| |lv|))
          (|lnp|
           (|List| (|HomogeneousDistributedMultivariatePolynomial| |lv| F)))
          (#13=#:G157 NIL) (|f| NIL) (#14=#:G156 NIL))
                  ...
                  (SEQ (LETT |gp| (|GROEBSOL;genPos| |teq| |lvar| $) . #17#)
                       ...
                       (LETT |lfact|
                             (PROGN
                              (LETT #16# NIL . #17#)
                              (SEQ (LETT |ff| NIL . #17#)
                                   (LETT #15# (SPADCALL |fg| (QREFELT $ 69))
                                         . #17#)
                                   G190
                                   (COND
                                    ((OR (ATOM #15#)
...
(SDEFUN |GROEBSOL;groebSolve;LLL;8|
        ...
        (SPROG
         ...
         (SEQ
          ...
          (LETT |basis| (SPADCALL |leq1| (QREFELT $ 82)) . #11#)
            ...
            (SEQ (LETT |x| NIL . #11#) (LETT #8# |lvar| . #11#) G190
                 (COND
                  ((OR (ATOM #8#) (PROGN (LETT |x| (CAR #8#) . #11#) NIL))
                   (GO G191)))
                 (SEQ
                  (LETT |g| (SPADCALL |leq1| |basis| |x| (QREFELT $ 83))
                        . #11#)
                  (LETT |fg| (SPADCALL |g| (QREFELT $ 65)) . #11#)
                  (LETT |llfact| (CONS |fg| |llfact|) . #11#)
                  (EXIT
                   (COND
                    ((EQL (SPADCALL |g| |x| (QREFELT $ 84)) (LENGTH |basis|))
                         ...
                         (LETT #6#
                               (CONS
                                (PROGN
                                 (LETT #4# NIL . #11#)
                                 (SEQ (LETT |ff| NIL . #11#)
                                      (LETT #3# (SPADCALL |llf| (QREFELT $ 69))
                                            . #11#)
                                      G190
                                      (COND
                                       ((OR (ATOM #3#)
