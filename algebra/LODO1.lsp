...
(MAKEPROP '|LinearOrdinaryDifferentialOperator1| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL
              ...
              (|List| %) (|List| 32) (|List| 14) (|Union| 32 '"failed")
            ...
            (CONS
             ...
             (CONS
              '#((|LinearOrdinaryDifferentialOperatorCategory| 6)
                 ...
                 (|MaybeSkewPolynomialCategory| 6 14 32)
                 ...
                 (|RightModule| 12) (|NonAssociativeRng|) (|AbelianGroup|)
                 ...
                 (|RetractableTo| 12) (|Eltable| 6 6) (|CoercibleFrom| 6)
                 (|BasicType|) (|CoercibleTo| 38) (|noZeroDivisors|)
                 (|CoercibleFrom| 17) (|CoercibleFrom| 12)
