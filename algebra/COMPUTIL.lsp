...
(DEFUN |COMPUTIL;Ski2Lambda| (|s| $)
  (PROG (#1=#:G173 |s112| |s12| |s2| |c112| |c111| |subsubnodes2| |c12| |c11|
...
(DEFUN |COMPUTIL;coerce;LSkic;4| (|lam| $)
  (PROG (#1=#:G199 |c32| |c31| |ch3| |cxx| |c33| |s3| |c3| |lamUn| |c2| |c1|
         |ch|)
    (RETURN
     (SEQ
      (EXIT
...
(DEFUN |COMPUTIL;coerce;SkicIl;5| (|s| $)
  (PROG (#1=#:G217 |bc| |ac| |ab| |c| |b| |a| |c112| |c111| |subsubnodes2|
