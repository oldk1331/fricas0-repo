...
(SDEFUN |COMPUTIL;Ski2Lambda| ((|s| (|SKICombinators| UT)) ($ (|Lambda| UT)))
        (SPROG
         ((#1=#:G168 NIL) (|s112| #2=(|String|)) (|s12| #2#)
...
(SDEFUN |COMPUTIL;lambdaOverSki|
        ...
        (SPROG
         ((#1=#:G179 NIL) (|right| (|SKICombinators| UT))
...
(SDEFUN |COMPUTIL;coerce;LSkic;4|
        ...
        (SPROG
         ((#1=#:G196 NIL) (|c32| #2=(|Lambda| UT)) (|c31| #3=(|Lambda| UT))
...
(SDEFUN |COMPUTIL;coerce;SkicIl;5| ((|s| (|SKICombinators| UT)) ($ (|ILogic|)))
        (SPROG
         ((#1=#:G215 NIL) (|bc| #2=(|ILogic|)) (|ac| #2#) (|ab| #2#)
          (|c| #3=(|ILogic|)) (|b| #3#) (|a| #3#)
