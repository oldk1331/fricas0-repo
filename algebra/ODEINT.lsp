...
(SDEFUN |ODEINT;mkprod|
        ((|l|
         ...
         ($ (F)))
        (SPROG
         ((#1=#:G139 NIL) (#2=#:G138 (F)) (#3=#:G140 (F)) (#4=#:G145 NIL)
          (|r| NIL)
          (|ll|
           (|List|
            (|Record| (|:| |coef| (|Fraction| (|Integer|))) (|:| |logand| F))))
...
(SDEFUN |ODEINT;isQ|
        ...
        (SPROG
         ((|prod| (|Fraction| (|Integer|))) (#1=#:G170 NIL)
          (|u| (|Union| (|Fraction| (|Integer|)) "failed")) (#2=#:G171 NIL)
          (|x| NIL))
         (SEQ
          (EXIT
...
(DEFUN |ODEIntegration| (&REST #1=#:G194)
  (SPROG NIL
         (PROG (#2=#:G195)
           (RETURN
            (COND
