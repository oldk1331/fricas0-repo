        ...
        ((|op| (|LinearOrdinaryDifferentialOperator2| UP (|Fraction| UP)))
         ...
         (%
          (|Record| (|:| |basis| (|List| (|Fraction| UP)))
                    (|:| |mat| (|Matrix| F)))))
        (SPROG
         ((#1=#:G41 NIL) (|g| NIL) (#2=#:G42 NIL) (|d| (UP))
          (|rec|
           (|Record| (|:| |basis| (|List| (|Fraction| UP)))
                     (|:| |particular| (|List| (|Fraction| UP)))))
          (#3=#:G43 NIL) (|i| NIL) (#4=#:G44 NIL) (#5=#:G45 NIL) (|q| NIL)
          (#6=#:G46 NIL) (|l| (|List| (|Fraction| UP))) (|sys1| (|Matrix| UP)))
         (SEQ
          (COND
            ...
            (SEQ (LETT |d| (SPADCALL |op| |lg| (QREFELT % 29)))
                 ...
                 (LETT |l|
                       (SPADCALL
                        (PROGN
                         (LETT #3# NIL)
                         (SEQ (LETT |i| 1) (LETT #4# (LENGTH (QCDR |rec|)))
                        ...
                        (PROGN
                         (LETT #5# NIL)
                         (SEQ (LETT |q| NIL) (LETT #6# (QCAR |rec|)) G190
                              (COND
                               ((OR (ATOM #6#)
                                    (PROGN (LETT |q| (CAR #6#)) NIL))
                                (GO G191)))
                              (SEQ
                               (EXIT
                                (LETT #5#
...
(SDEFUN |ODERAT;ratDsolve0|
        ...
        (SPROG
         ((|f| NIL) (#2=#:G87 NIL) (|uu| (|Union| (|Fraction| UP) "failed"))
          (|b| (|List| (|Fraction| UP))) (#3=#:G49 NIL)
          (|u| (|Union| UP "failed"))
          (|rec|
           (|Record| (|:| |basis| (|List| (|Fraction| UP)))
                     (|:| |particular| (|List| (|Fraction| UP)))))
          (|q| NIL) (#4=#:G88 NIL) (|opq| (|Fraction| UP))
          (|lsol| #5=(|List| (|Fraction| UP))) (|l| #5#) (|lb| #5#)
          (|h| (|Fraction| UP))
          (|sys1|
          ...
          (|sol|
           (|Record| (|:| |particular| (|Union| (|Vector| F) #6="failed"))
                     (|:| |basis| (|List| (|Vector| F)))))
          (#7=#:G74 NIL) (|part| (|Union| (|Fraction| UP) #1#)) (#8=#:G89 NIL)
          (#9=#:G90 NIL))
         (SEQ
          (COND
           ((ZEROP (SPADCALL |op| (QREFELT % 20)))
           ...
           ((> (SPADCALL |op| (QREFELT % 43)) 0)
            (SEQ
             ...
             (SEQ (LETT |f| NIL) (LETT #2# (QCDR |sol|)) G190
                  (COND
                  ...
                  (COND ((QEQCAR |u| 1) (CONS (CONS 1 "failed") NIL))
                        (#10#
                         (SEQ
                          ...
                          (SEQ (LETT |q| NIL) (LETT #4# (QCAR |rec|)) G190
                               (COND
                                ((OR (ATOM #4#)
                                     (PROGN (LETT |q| (CAR #4#)) NIL))
                                 (GO G191)))
                               (SEQ
                                (EXIT
                                 (COND
...
(SDEFUN |ODERAT;regularPoint|
        ...
        (SPROG ((|a| (UP)) (|i| NIL) (|j| (F)) (#1=#:G104 NIL) (#2=#:G103 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (LETT |a|
...
(SDEFUN |ODERAT;candidates|
        ...
        (SPROG
         ((|n| (|NonNegativeInteger|)) (|m| (|Integer|))
          ...
          (|dd| (|uts|)) (|f| (|Mapping| |uts| (|List| |uts|)))
          (|q| (|NonNegativeInteger|)) (|e| (|List| F)) (#1=#:G119 NIL)
          (|i| NIL) (#2=#:G120 NIL) (|hom| (|List| (|Fraction| UP)))
          (|a1| (|Fraction| UP)) (#3=#:G121 NIL) (|g| NIL) (#4=#:G122 NIL)
          (|part| (|List| (|Fraction| UP))))
         (SEQ
          (LETT |n|
...
(SDEFUN |ODERAT;nzero?| ((|v| (|Vector| F)) (% (|Boolean|)))
        (SPROG ((|i| NIL) (#1=#:G130 NIL) (#2=#:G129 NIL) (#3=#:G128 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                          ...
                          (EXIT
                           (COND
                            ((NULL
                             ...
                             (PROGN
                              (LETT #3# (PROGN (LETT #2# 'T) (GO #4=#:G127)))
                              (GO #5=#:G125))))))
...
(SDEFUN |ODERAT;UPfact| ((|n| (|NonNegativeInteger|)) (% (UP)))
        (SPROG
         ((|z| (UP)) (|i| NIL) (#1=#:G132 NIL) (#2=#:G139 NIL) (#3=#:G135 (UP))
          (#4=#:G133 (UP)) (#5=#:G134 NIL))
         (SEQ
                           ...
                           (PROGN
                            (LETT #3#
                                  (SPADCALL |z|
                                            ...
                                            (QREFELT % 91)))
                            (COND
                             (#5# (LETT #4# (SPADCALL #4# #3# (QREFELT % 78))))
                             ('T (PROGN (LETT #4# #3#) (LETT #5# 'T)))))))
                         (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL))
                    (COND (#5# #4#) (#6# (|spadConstant| % 17))))))))))) 
        ...
        ((|l| (|LinearOrdinaryDifferentialOperator2| UP (|Fraction| UP)))
         (%
          (|Record| (|:| |mu| (|Integer|))
                    ...
                    (|:| |func| (|List| UP)))))
        (SPROG
         ((|a| (UP)) (|d| #1=(|NonNegativeInteger|)) (|m| #2=(|Integer|))
          (|mup| #2#) (|lamb| (|List| #1#)) (|lf| (|List| UP)))
...
(SDEFUN |ODERAT;infIndicialEquation|
        ((|lambda| (|List| (|NonNegativeInteger|))) (|lf| (|List| UP))
         (% (UP)))
        (SPROG
         ((|f| NIL) (#1=#:G153 NIL) (|i| NIL) (#2=#:G152 NIL) (|ans| (UP)))
         (SEQ (LETT |ans| (|spadConstant| % 26))
              (SEQ (LETT |f| NIL) (LETT #1# |lf|) (LETT |i| NIL)
                   (LETT #2# |lambda|) G190
                   (COND
        ...
        (SPROG
         ((|rec|
           (|Record| (|:| |mu| (|Integer|))
                     (|:| |lambda| (|List| (|NonNegativeInteger|)))
                     (|:| |func| (|List| UP))))
          (|n| (|Integer|)) (#1=#:G158 NIL) (|g| NIL) (#2=#:G167 NIL)
          (|mm| #3=(|Integer|)) (|m| #3#) (#4=#:G163 NIL))
               ...
               (COND
                ...
                ('T
                 (SEQ (LETT |m| (|ODERAT;infOrder| (|SPADfirst| |lg|) %))
                      (SEQ (LETT |g| NIL) (LETT #2# (CDR |lg|)) G190
                           (COND
                            ((OR (ATOM #2#) (PROGN (LETT |g| (CAR #2#)) NIL))
                             (GO G191)))
                           (SEQ
...
(SDEFUN |ODERAT;makeDot|
        ((|v| (|Vector| F)) (|bas| (|List| (|Fraction| UP)))
         (% (|Fraction| UP)))
        (SPROG ((|b| NIL) (#1=#:G172 NIL) (|i| NIL) (|ans| (|Fraction| UP)))
        ...
        ((|op| (|LinearOrdinaryDifferentialOperator2| UP (|Fraction| UP)))
         ...
         (%
          (|Record| (|:| |basis| (|List| (|Fraction| UP)))
                    (|:| |mat| (|Matrix| F)))))
        (SPROG
         ((|c| (UP)) (#1=#:G191 NIL) (#2=#:G197 NIL) (|g| NIL) (#3=#:G198 NIL))
         (SEQ
          (COND
           ((SPADCALL (LETT |c| (SPADCALL |op| (QREFELT % 106)))
                      (QREFELT % 107))
...
(MAKEPROP '|RationalLODE| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|) (|Symbol|)
              ...
              (|NonNegativeInteger|) (9 . |degree|) (14 . |numer|) (19 . |1|)
              (23 . |1|) (27 . -) (|LinearOrdinaryDifferentialOperator2| 7 11)
              (32 . |degree|) (37 . |leadingCoefficient|) (42 . |coerce|)
              (47 . |inv|) (52 . *) (58 . |0|) (62 . |0|) (|List| 11)
