...
(MAKEPROP '|BalancedPAdicRational| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL
              ...
              (|BalancedPAdicInteger| (NRTEVAL (QREFELT % 6))) (|Equation| 15)
              (|List| 16) (|List| 15) (|Symbol|) (|List| 19)
              ...
              (|Union| 36 '#2#) (|Fraction| 23) (|Union| 19 '#2#)
            ...
            (CONS
             ...
             (CONS
              '#((|QuotientFieldCategory| (|BalancedPAdicInteger| 6)) (|Field|)
                 ...
                 (|BasicType|) (|CoercibleTo| 55) (|CoercibleFrom| 19)
