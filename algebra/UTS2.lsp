...
(DEFUN |UnivariateTaylorSeriesFunctions2| (&REST #1=#:G127)
  (PROG ()
    (RETURN
     (PROG (#2=#:G128)
       (RETURN
        (COND
         ...
         ('T
          (UNWIND-PROTECT
              (PROG1
                  (APPLY (|function| |UnivariateTaylorSeriesFunctions2;|) #1#)
                (LETT #2# T . #3#))
            (COND
             ((NOT #2#)
  ...
  (PROG (|pv$| $ |dv$| DV$4 DV$3 DV$2 DV$1)
    (RETURN
     (PROGN
      ...
      (LETT |dv$|
            (LIST '|UnivariateTaylorSeriesFunctions2| DV$1 DV$2 DV$3 DV$4)
            . #1#)
      (LETT $ (GETREFV 18) . #1#)
      (QSETREFV $ 0 |dv$|)
