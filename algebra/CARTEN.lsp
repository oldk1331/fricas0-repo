...
(SDEFUN |CARTEN;index2int| ((|indv| (|Vector| (|Integer|))) ($ (|Integer|)))
        (SPROG ((|n| (|Integer|)) (|ix| (|Integer|)) (#1=#:G143 NIL) (|i| NIL))
               (SEQ (LETT |n| 0)
...
(SDEFUN |CARTEN;mkPerm|
        ((|n| (|NonNegativeInteger|)) (|l| (|List| (|Integer|)))
         ($ (|Vector| (|Integer|))))
        (SPROG
         ((#1=#:G160 NIL) (#2=#:G163 NIL) (|e| NIL) (#3=#:G161 NIL) (|i| NIL)
          (#4=#:G162 NIL) (|seen| (|Vector| (|Boolean|)))
          (|p| (|Vector| (|Integer|))))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;permsign!| ((|v| (|Vector| (|Integer|))) ($ (|Integer|)))
        (SPROG
         ((#1=#:G187 NIL) (#2=#:G191 NIL) (|i| NIL) (|totTrans| (|Integer|))
          (|e| (|Integer|)) (|nTrans| (|Integer|)) (#3=#:G189 NIL)
          (#4=#:G190 NIL) (|j| NIL) (|n| (|Integer|)) (#5=#:G188 NIL)
          (|psum| (|Integer|)) (#6=#:G170 NIL) (|maxix| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |CARTEN;ravel;$L;8| ((|x| ($)) ($ (|List| R)))
        (SPROG ((#1=#:G196 NIL) (|i| NIL) (#2=#:G195 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |i| 0)
...
(SDEFUN |CARTEN;unravel;L$;9| ((|l| (|List| R)) ($ ($)))
        (SPROG
         ((#1=#:G201 NIL) (|i| NIL) (#2=#:G202 NIL) (|r| NIL) (|z| ($))
...
(SDEFUN |CARTEN;kroneckerDelta;$;10| (($ ($)))
        (SPROG ((#1=#:G207 NIL) (|i| NIL) (#2=#:G208 NIL) (|zi| NIL) (|z| ($)))
               (SEQ
                (LETT |z|
...
(SDEFUN |CARTEN;leviCivitaSymbol;$;11| (($ ($)))
        (SPROG
         ((#1=#:G213 NIL) (|i| NIL) (|indv| (|Vector| (|Integer|))) (|z| ($))
          (|nz| (|NonNegativeInteger|)))
...
(SDEFUN |CARTEN;elt;$LR;19| ((|x| ($)) (|i| (|List| (|Integer|))) ($ (R)))
        (SPROG
         ((|n| (|Integer|)) (|ix| (|Integer|)) (#1=#:G233 NIL) (|ii| NIL))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;coerce;L$;21| ((|lx| (|List| $)) ($ ($)))
        (SPROG
         ((#1=#:G255 NIL) (|i| NIL) (#2=#:G253 NIL) (|x| NIL) (#3=#:G254 NIL)
          (|offz| NIL) (|z| ($)) (|nx| (|NonNegativeInteger|)) (#4=#:G251 NIL)
          (#5=#:G252 NIL) (|rx| (|NonNegativeInteger|)))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;mkOutf|
        ((|x| ($)) (|i0| (|Integer|)) (|rnk| (|NonNegativeInteger|))
         ($ (|OutputForm|)))
        (SPROG
         ((#1=#:G280 NIL) (|j| NIL) (#2=#:G279 NIL) (#3=#:G278 NIL) (|i| NIL)
          (#4=#:G277 NIL) (|nskip| (|NonNegativeInteger|))
          (|rnk1| (|NonNegativeInteger|)) (#5=#:G276 NIL) (#6=#:G275 NIL))
         (SEQ
          (COND
           ((ODDP |rnk|)
            (SEQ (LETT |rnk1| (- |rnk| 1))
...
(SDEFUN |CARTEN;coerce;Dp$;28| ((|v| (|DirectProduct| |dim| R)) ($ ($)))
        (SPROG ((#1=#:G289 NIL) (|i| NIL) (#2=#:G290 NIL) (|j| NIL) (|z| ($)))
               (SEQ
                (LETT |z|
                      (SPADCALL (QREFELT $ 7) (|spadConstant| $ 32)
                                (QREFELT $ 33)))
...
(SDEFUN |CARTEN;coerce;Sm$;29| ((|m| (|SquareMatrix| |dim| R)) ($ ($)))
        (SPROG
         ((|offz| (|NonNegativeInteger|)) (#1=#:G299 NIL) (|j| NIL)
          (#2=#:G298 NIL) (|i| NIL) (|z| ($)))
         (SEQ
          (LETT |z|
...
(SDEFUN |CARTEN;product;3$;38| ((|x| ($)) (|y| ($)) ($ ($)))
        (SPROG
         ((#1=#:G353 NIL) (|j| NIL) (#2=#:G351 NIL) (|i| NIL) (#3=#:G352 NIL)
...
(SDEFUN |CARTEN;contract;$2I$;40|
        ...
        (SPROG
         ((#3=#:G376 NIL) (|k| NIL) (#4=#:G377 NIL) (|xk| NIL) (#5=#:G373 NIL)
          (|l| NIL) (#6=#:G374 NIL) (|xl| NIL) (#7=#:G375 NIL) (|zl| NIL)
          (#8=#:G370 NIL) (|m| NIL) (#9=#:G371 NIL) (|xm| NIL) (#10=#:G372 NIL)
          (|zm| NIL) (#11=#:G367 NIL) (|h| NIL) (#12=#:G368 NIL) (|xh| NIL)
          (#13=#:G369 NIL) (|zh| NIL) (|z| ($))
...
(SDEFUN |CARTEN;contract;$I$I$;41|
        ...
        (SPROG
         ((#1=#:G403 NIL) (|k| NIL) (#2=#:G404 NIL) (|xk| NIL) (#3=#:G405 NIL)
          (|yk| NIL) (#4=#:G400 NIL) (|dyl| NIL) (#5=#:G401 NIL) (|yl| NIL)
          (#6=#:G402 NIL) (|zly| NIL) (#7=#:G397 NIL) (|dyh| NIL)
          (#8=#:G398 NIL) (|yh| NIL) (#9=#:G399 NIL) (|zhy| NIL)
          (#10=#:G394 NIL) (|dxl| NIL) (#11=#:G395 NIL) (|xl| NIL)
          (#12=#:G396 NIL) (|zlx| NIL) (#13=#:G391 NIL) (|dxh| NIL)
          (#14=#:G392 NIL) (|xh| NIL) (#15=#:G393 NIL) (|zhx| NIL) (|z| ($))
...
(SDEFUN |CARTEN;transpose;$2I$;43|
        ((|x| ($)) (|i| #1=(|Integer|)) (|j| #2=(|Integer|)) ($ ($)))
        (SPROG
         ((#3=#:G428 NIL) (|q| NIL) (#4=#:G429 NIL) (|zq| NIL) (#5=#:G430 NIL)
          (|xq| NIL) (#6=#:G425 NIL) (|p| NIL) (#7=#:G426 NIL) (|zp| NIL)
          (#8=#:G427 NIL) (|xp| NIL) (#9=#:G423 NIL) (|l| NIL) (#10=#:G424 NIL)
          (|zl| NIL) (#11=#:G421 NIL) (|m| NIL) (#12=#:G422 NIL) (|zm| NIL)
          (#13=#:G419 NIL) (|h| NIL) (#14=#:G420 NIL) (|zh| NIL) (|z| ($))
...
(DEFUN |CartesianTensor| (&REST #1=#:G437)
  (SPROG NIL
         (PROG (#2=#:G438)
           (RETURN
            (COND
