        ...
        (SPROG
         ((|qr|
           (|Record| (|:| |quotient| (|Integer|))
                     (|:| |remainder| (|Integer|))))
          (#1=#:G152 NIL) (|i| NIL) (|rnk| (|NonNegativeInteger|)))
         (SEQ
...
(SDEFUN |CARTEN;index2int| ((|indv| (|Vector| (|Integer|))) ($ (|Integer|)))
        (SPROG ((|n| (|Integer|)) (|ix| (|Integer|)) (#1=#:G159 NIL) (|i| NIL))
               (SEQ (LETT |n| 0)
...
(SDEFUN |CARTEN;mkPerm|
        ((|n| (|NonNegativeInteger|)) (|l| (|List| (|Integer|)))
         ($ (|Vector| (|Integer|))))
        (SPROG
         ((#1=#:G176 NIL) (#2=#:G179 NIL) (|e| NIL) (#3=#:G177 NIL) (|i| NIL)
          (#4=#:G178 NIL) (|seen| (|Vector| (|Boolean|)))
          (|p| (|Vector| (|Integer|))))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;permsign!| ((|v| (|Vector| (|Integer|))) ($ (|Integer|)))
        (SPROG
         ((#1=#:G203 NIL) (#2=#:G207 NIL) (|i| NIL) (|totTrans| (|Integer|))
          (|e| (|Integer|)) (|nTrans| (|Integer|)) (#3=#:G205 NIL)
          (#4=#:G206 NIL) (|j| NIL) (|n| (|Integer|)) (#5=#:G204 NIL)
          (|psum| (|Integer|)) (#6=#:G186 NIL) (|maxix| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |CARTEN;ravel;$L;8| ((|x| ($)) ($ (|List| R)))
        (SPROG ((#1=#:G212 NIL) (|i| NIL) (#2=#:G211 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |i| 0)
...
(SDEFUN |CARTEN;unravel;L$;9| ((|l| (|List| R)) ($ ($)))
        (SPROG
         ((#1=#:G217 NIL) (|i| NIL) (#2=#:G218 NIL) (|r| NIL) (|z| ($))
...
(SDEFUN |CARTEN;kroneckerDelta;$;10| (($ ($)))
        (SPROG ((#1=#:G223 NIL) (|i| NIL) (#2=#:G224 NIL) (|zi| NIL) (|z| ($)))
               (SEQ
                (LETT |z|
...
(SDEFUN |CARTEN;leviCivitaSymbol;$;11| (($ ($)))
        (SPROG
         ((#1=#:G229 NIL) (|i| NIL) (|indv| (|Vector| (|Integer|))) (|z| ($))
          (|nz| (|NonNegativeInteger|)))
...
(SDEFUN |CARTEN;elt;$LR;19| ((|x| ($)) (|i| (|List| (|Integer|))) ($ (R)))
        (SPROG
         ((|n| (|Integer|)) (|ix| (|Integer|)) (#1=#:G249 NIL) (|ii| NIL))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;coerce;L$;20| ((|lr| (|List| R)) ($ ($)))
        (SPROG ((#1=#:G255 NIL) (|r| NIL) (#2=#:G256 NIL) (|i| NIL) (|z| ($)))
               (SEQ
                (COND
...
(SDEFUN |CARTEN;coerce;L$;21| ((|lx| (|List| $)) ($ ($)))
        (SPROG
         ((#1=#:G271 NIL) (|i| NIL) (#2=#:G269 NIL) (|x| NIL) (#3=#:G270 NIL)
          (|offz| NIL) (|z| ($)) (|nx| (|NonNegativeInteger|)) (#4=#:G267 NIL)
          (#5=#:G268 NIL) (|rx| (|NonNegativeInteger|)))
         (SEQ
          (COND
...
(SDEFUN |CARTEN;mkOutf|
        ((|x| ($)) (|i0| (|Integer|)) (|rnk| (|NonNegativeInteger|))
         ($ (|OutputForm|)))
        (SPROG
         ((#1=#:G296 NIL) (|j| NIL) (#2=#:G295 NIL) (#3=#:G294 NIL) (|i| NIL)
          (#4=#:G293 NIL) (|nskip| (|NonNegativeInteger|))
          (|rnk1| (|NonNegativeInteger|)) (#5=#:G292 NIL) (#6=#:G291 NIL))
         (SEQ
          (COND
           ((ODDP |rnk|)
            (SEQ (LETT |rnk1| (- |rnk| 1))
...
(SDEFUN |CARTEN;coerce;Dp$;28| ((|v| (|DirectProduct| |dim| R)) ($ ($)))
        (SPROG ((#1=#:G305 NIL) (|i| NIL) (#2=#:G306 NIL) (|j| NIL) (|z| ($)))
               (SEQ
                (LETT |z|
                      (SPADCALL (QREFELT $ 7) (|spadConstant| $ 32)
                                (QREFELT $ 33)))
...
(SDEFUN |CARTEN;coerce;Sm$;29| ((|m| (|SquareMatrix| |dim| R)) ($ ($)))
        (SPROG
         ((|offz| (|NonNegativeInteger|)) (#1=#:G315 NIL) (|j| NIL)
          (#2=#:G314 NIL) (|i| NIL) (|z| ($)))
         (SEQ
          (LETT |z|
...
(SDEFUN |CARTEN;=;2$B;30| ((|x| ($)) (|y| ($)) ($ (|Boolean|)))
        (SPROG ((#1=#:G322 NIL) (#2=#:G323 NIL) (|i| NIL))
               (SEQ
                (EXIT
                 (COND
                          ...
                          (EXIT
                           (COND
                            ((SPADCALL (SPADCALL |x| |i| (QREFELT $ 29))
                                       ...
                                       (QREFELT $ 74))
                             (PROGN (LETT #1# NIL) (GO #3=#:G321))))))
                         (LETT |i| (|inc_SI| |i|)) (GO G190) G191 (EXIT NIL))
                    (EXIT 'T)))))
                #3# (EXIT #1#)))) 

(SDEFUN |CARTEN;+;3$;31| ((|x| ($)) (|y| ($)) ($ ($)))
        (SPROG ((#1=#:G329 NIL) (|i| NIL) (|z| ($)))
               (SEQ
                (COND
                 ((SPADCALL (SPADCALL |x| (QREFELT $ 28))
                            (SPADCALL |y| (QREFELT $ 28)) (QREFELT $ 22))
...
(SDEFUN |CARTEN;product;3$;38| ((|x| ($)) (|y| ($)) ($ ($)))
        (SPROG
         ((#1=#:G369 NIL) (|j| NIL) (#2=#:G367 NIL) (|i| NIL) (#3=#:G368 NIL)
...
(SDEFUN |CARTEN;contract;$2I$;40|
        ...
        (SPROG
         ((#3=#:G392 NIL) (|k| NIL) (#4=#:G393 NIL) (|xk| NIL) (#5=#:G389 NIL)
          (|l| NIL) (#6=#:G390 NIL) (|xl| NIL) (#7=#:G391 NIL) (|zl| NIL)
          (#8=#:G386 NIL) (|m| NIL) (#9=#:G387 NIL) (|xm| NIL) (#10=#:G388 NIL)
          (|zm| NIL) (#11=#:G383 NIL) (|h| NIL) (#12=#:G384 NIL) (|xh| NIL)
          (#13=#:G385 NIL) (|zh| NIL) (|z| ($))
...
(SDEFUN |CARTEN;contract;$I$I$;41|
        ...
        (SPROG
         ((#1=#:G419 NIL) (|k| NIL) (#2=#:G420 NIL) (|xk| NIL) (#3=#:G421 NIL)
          (|yk| NIL) (#4=#:G416 NIL) (|dyl| NIL) (#5=#:G417 NIL) (|yl| NIL)
          (#6=#:G418 NIL) (|zly| NIL) (#7=#:G413 NIL) (|dyh| NIL)
          (#8=#:G414 NIL) (|yh| NIL) (#9=#:G415 NIL) (|zhy| NIL)
          (#10=#:G410 NIL) (|dxl| NIL) (#11=#:G411 NIL) (|xl| NIL)
          (#12=#:G412 NIL) (|zlx| NIL) (#13=#:G407 NIL) (|dxh| NIL)
          (#14=#:G408 NIL) (|xh| NIL) (#15=#:G409 NIL) (|zhx| NIL) (|z| ($))
...
(SDEFUN |CARTEN;transpose;$2I$;43|
        ((|x| ($)) (|i| #1=(|Integer|)) (|j| #2=(|Integer|)) ($ ($)))
        (SPROG
         ((#3=#:G444 NIL) (|q| NIL) (#4=#:G445 NIL) (|zq| NIL) (#5=#:G446 NIL)
          (|xq| NIL) (#6=#:G441 NIL) (|p| NIL) (#7=#:G442 NIL) (|zp| NIL)
          (#8=#:G443 NIL) (|xp| NIL) (#9=#:G439 NIL) (|l| NIL) (#10=#:G440 NIL)
          (|zl| NIL) (#11=#:G437 NIL) (|m| NIL) (#12=#:G438 NIL) (|zm| NIL)
          (#13=#:G435 NIL) (|h| NIL) (#14=#:G436 NIL) (|zh| NIL) (|z| ($))
...
(DEFUN |CartesianTensor| (&REST #1=#:G453)
  (SPROG NIL
         (PROG (#2=#:G454)
           (RETURN
            (COND
