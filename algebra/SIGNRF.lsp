...
(SDEFUN |SIGNRF;listSign|
        ...
        (SPROG
         ((#2=#:G169 NIL) (#3=#:G170 NIL) (|u| (|Union| (|Integer|) #1#))
          (#4=#:G171 NIL) (|term| NIL))
         (SEQ
          (EXIT
           (SEQ
            (SEQ (LETT |term| NIL) (LETT #4# |l|) G190
                 ...
                 (SEQ (LETT |u| (|SIGNRF;termSign| |term| $))
                      (EXIT
                       (COND
                        ((QEQCAR |u| 1)
                         (PROGN (LETT #3# (CONS 1 "failed")) (GO #5=#:G168)))
                        ('T
                         (SEQ
                          (EXIT
                           (COND
...
(SDEFUN |SIGNRF;termSign|
        ...
        (SPROG ((#1=#:G179 NIL) (#2=#:G180 NIL) (#3=#:G181 NIL) (|var| NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
...
(DEFUN |RationalFunctionSign| (#1=#:G182)
  (SPROG NIL
         (PROG (#2=#:G183)
           (RETURN
            (COND
