...
(SDEFUN |SIGNRF;sign;FU;1|
        ...
        (SPROG ((|un| #2=(|Union| (|Integer|) #1#)) (|ud| #2#))
...
(SDEFUN |SIGNRF;finiteSign|
        ...
        (SPROG ((|ud| #1=(|Union| (|Integer|) "failed")) (|un| #1#))
               (SEQ
                (LETT |ud|
...
(SDEFUN |SIGNRF;sign;FSOcU;3|
        ...
        (SPROG
         ((|g|
           (|Fraction|
            (|SparseUnivariatePolynomial| (|Fraction| (|Polynomial| R)))))
          (|n| (|Integer|)) (|ud| #1=(|Union| (|Integer|) "failed"))
          (|un| #1#))
...
(SDEFUN |SIGNRF;sign;FSFSU;4|
        ...
        (SPROG
         ((|g|
           (|Fraction|
            (|SparseUnivariatePolynomial| (|Fraction| (|Polynomial| R)))))
          (|d| (|Integer|)) (|ud| #1=(|Union| (|Integer|) "failed"))
          (|un| #1#))
         (SEQ
          (LETT |ud|
                (SPADCALL
...
(SDEFUN |SIGNRF;psign|
        ...
        (SPROG
         ((|r| (|Union| R "failed")) (|s| (|Factored| (|Polynomial| R)))
          (|term| NIL) (#1=#:G52 NIL) (|u| (|Union| (|Integer|) "failed"))
          (#2=#:G51 NIL) (|ans| (|Integer|)))
         (SEQ
          (EXIT
...
(SDEFUN |SIGNRF;sqfrSign|
        ...
        (SPROG
         ((|l| (|List| (|Polynomial| R))) (|u| (|Union| (|Integer|) #1#)))
         (SEQ
          (LETT |u|
                (|SIGNRF;termSign|
...
(SDEFUN |SIGNRF;listSign|
        ((|l| (|List| (|Polynomial| R))) (|s| (|Integer|))
         (% (|Union| (|Integer|) #1="failed")))
        (SPROG
         ((|term| NIL) (#2=#:G69 NIL) (|u| (|Union| (|Integer|) #1#))
          (#3=#:G68 NIL) (#4=#:G67 NIL))
         (SEQ
          (EXIT
           (SEQ
...
(SDEFUN |SIGNRF;termSign|
        ...
        (SPROG ((|var| NIL) (#1=#:G80 NIL) (#2=#:G79 NIL) (#3=#:G78 NIL))
               (SEQ
                (EXIT
                 (SEQ
                  (SEQ
                   (EXIT
                    (SEQ (LETT |var| NIL)
                         (LETT #1# (SPADCALL |term| (QREFELT % 52))) G190
                         (COND
                          ((OR (ATOM #1#) (PROGN (LETT |var| (CAR #1#)) NIL))
                           (GO G191)))
                         (SEQ
                          (EXIT
                           (COND
