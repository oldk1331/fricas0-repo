     ...
     (SEQ
      (COND
       ((|HasSignature| (QREFELT $ 6)
                        (LIST '|factor|
                              (LIST
                               (LIST '|Factored| (|devaluate| (QREFELT $ 6)))
                               (|devaluate| (QREFELT $ 6)))))
        (SEQ
         ...
         (EXIT
          (PROGN
           ...
           (SEQ (LETT |rcf| NIL . #3#)
                (LETT #1#
                      (SPADCALL
                       (SPADCALL (SPADCALL |eq0| (QREFELT $ 9)) (QREFELT $ 11))
                       (QREFELT $ 15))
                      . #3#)
                G190
                (COND
                 ((OR (ATOM #1#) (PROGN (LETT |rcf| (CAR #1#) . #3#) NIL))
                  (GO G191)))
                (SEQ
                 (EXIT
                  (LETT #2#
...
(DEFUN |EQ;+;3$;15| (|eq1| |eq2| $)
  (SPADCALL (SPADCALL (QCAR |eq1|) (QCAR |eq2|) (QREFELT $ 46))
            (SPADCALL (QCDR |eq1|) (QCDR |eq2|) (QREFELT $ 46)) (QREFELT $ 20))) 
...
(DEFUN |EQ;-;3$;24| (|eq1| |eq2| $)
  (SPADCALL (SPADCALL (QCAR |eq1|) (QCAR |eq2|) (QREFELT $ 56))
            (SPADCALL (QCDR |eq1|) (QCDR |eq2|) (QREFELT $ 56)) (QREFELT $ 20))) 

(DEFUN |EQ;*;3$;25| (|eq1| |eq2| $)
  (SPADCALL (SPADCALL (QCAR |eq1|) (QCAR |eq2|) (QREFELT $ 58))
            (SPADCALL (QCDR |eq1|) (QCDR |eq2|) (QREFELT $ 58)) (QREFELT $ 20))) 
...
(DEFUN |EQ;recip;$U;30| (|eq| $)
  (PROG (|rh| |lh|)
    (RETURN
     (SEQ
      (LETT |lh| (SPADCALL (SPADCALL |eq| (QREFELT $ 9)) (QREFELT $ 65))
            . #1=(|EQ;recip;$U;30|))
      (EXIT
              ...
              (SEQ
               ...
               (EXIT
                (COND ((QEQCAR |rh| 1) (CONS 1 "failed"))
                      (#2# (CONS 0 (CONS (QCDR |lh|) (QCDR |rh|)))))))))))))) 

(DEFUN |EQ;leftOne;$U;31| (|eq| $)
  (PROG (|re|)
    (RETURN
     (SEQ
      (LETT |re| (SPADCALL (SPADCALL |eq| (QREFELT $ 9)) (QREFELT $ 65))
            |EQ;leftOne;$U;31|)
      (EXIT
...
(DEFUN |EQ;rightOne;$U;32| (|eq| $)
  (PROG (|re|)
    (RETURN
     (SEQ
      (LETT |re| (SPADCALL (SPADCALL |eq| (QREFELT $ 21)) (QREFELT $ 65))
            |EQ;rightOne;$U;32|)
      (EXIT
       (COND ((QEQCAR |re| 1) (CONS 1 "failed"))
             ('T
              (CONS 0
                    (SPADCALL
                     (SPADCALL (SPADCALL |eq| (QREFELT $ 9)) (QCDR |re|)
                               (QREFELT $ 58))
...
(DEFUN |EQ;factorAndSplit;$L;38| (|eq| $)
  (PROG (#1=#:G215 |rcf| #2=#:G214 |p| |eq0| #3=#:G213 #4=#:G212)
    (RETURN
     (SEQ
      (COND
       ((|HasSignature| (QREFELT $ 6)
             ...
             (EXIT
              (PROGN
               ...
               (SEQ (LETT |rcf| NIL . #5#)
                    ...
                    G190
                    (COND
                     ((OR (ATOM #1#) (PROGN (LETT |rcf| (CAR #1#) . #5#) NIL))
                      (GO G191)))
                    (SEQ
                     (EXIT
                      (LETT #2#
...
(DEFUN |EQ;/;3$;41| (|eq1| |eq2| $)
  (SPADCALL (SPADCALL (QCAR |eq1|) (QCAR |eq2|) (QREFELT $ 89))
            (SPADCALL (QCDR |eq1|) (QCDR |eq2|) (QREFELT $ 89)) (QREFELT $ 20))) 
  ...
  (PROG (|eq3|)
    (RETURN
     (SEQ (LETT |eq3| |eq2| |EQ;subst;3$;43|)
          (EXIT
           (CONS (SPADCALL (SPADCALL |eq1| (QREFELT $ 9)) |eq3| (QREFELT $ 92))
                 (SPADCALL (SPADCALL |eq1| (QREFELT $ 21)) |eq3|
                           (QREFELT $ 92)))))))) 

(DEFUN |Equation| (#1=#:G226)
  (PROG ()
    (RETURN
     (PROG (#2=#:G227)
       (RETURN
...
(DEFUN |Equation;| (|#1|)
  (PROG (|pv$| #1=#:G222 #2=#:G223 #3=#:G224 #4=#:G225 $ |dv$| DV$1)
    (RETURN
     (PROGN
...
(MAKEPROP '|Equation| '|infovec|
          (LIST
           ...
           '#(~= 312 |zero?| 318 |swap| 323 |subtractIfCan| 328 |subst| 334
              ...
              |one?| 364 |map| 369 |lhs| 375 |leftZero| 380 |leftOne| 385
              |latex| 390 |inv| 395 |hashUpdate!| 400 |hash| 406
              |factorAndSplit| 411 |eval| 416 |equation| 442 |dimension| 448
              |differentiate| 452 |conjugate| 478 |commutator| 484 |coerce| 490
              |characteristic| 505 ^ 509 |Zero| 527 |One| 531 D 535 = 561 / 573
              - 585 + 608 * 626)
           'NIL
           (CONS
            (|makeByteWordVec2| 22
            ...
            (CONS
             '#(|VectorSpace&| |Module&| |PartialDifferentialRing&| NIL |Ring&|
                NIL NIL NIL NIL |AbelianGroup&| NIL NIL |Group&|
             ...
             (CONS
              ...
              (|makeByteWordVec2| 98
                                  '(1 0 0 0 8 1 6 10 0 11 1 14 13 0 15 0 6 0 16
                                    ...
                                    1 19 64 0 66 1 19 38 0 1 2 0 0 23 0 24 1 0
                                    6 0 9 1 15 0 0 57 1 19 64 0 67 1 3 97 0 1 1
                                    11 0 0 70 2 3 96 96 0 1 1 3 98 0 1 1 24 18
                                    0 19 2 13 0 0 18 37 2 13 0 0 0 34 3 10 0 0
                                    28 29 31 3 10 0 0 25 6 27 2 0 0 6 6 17 0 1
                                    86 88 3 6 0 0 28 95 1 2 6 0 0 28 1 3 6 0 0
                                    25 71 1 2 6 0 0 25 85 2 8 0 0 0 1 2 8 0 0 0
                                    1 1 4 0 74 1 1 3 38 0 45 1 3 41 0 44 0 4 71
                                    73 2 8 0 0 74 1 2 19 0 0 71 1 2 12 0 0 94 1
                                    0 18 0 55 0 19 0 63 3 6 0 0 28 95 1 2 6 0 0
                                    28 1 3 6 0 0 25 71 1 2 6 0 0 25 1 2 3 38 0
                                    0 40 2 0 0 6 6 20 2 11 0 0 0 90 2 1 0 0 6 1
                                    2 15 0 0 6 54 2 15 0 6 0 53 1 15 0 0 51 2
                                    15 0 0 0 52 2 14 0 0 6 49 2 14 0 6 0 48 2
                                    14 0 0 0 47 2 18 0 71 0 1 2 15 0 74 0 76 2
                                    14 0 94 0 1 2 12 0 0 6 61 2 12 0 6 0 60 2
                                    12 0 0 0 59)))))
           '|lookupComplete|)) 
