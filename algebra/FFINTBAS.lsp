         ...
         (SEQ
          (EXIT
           (SEQ
            ...
            (LETT |tfm0| (SPADCALL |tfm| (QREFELT $ 24)) . #4#)
            (LETT |disc0| |disc| . #4#)
            (LETT |rb| (SPADCALL |n| (|spadConstant| $ 16) (QREFELT $ 26))
                  . #4#)
            (LETT |rbinv| (SPADCALL |n| (|spadConstant| $ 16) (QREFELT $ 26))
                  . #4#)
            (LETT |rbden| (|spadConstant| $ 16) . #4#)
            (LETT |index| (|spadConstant| $ 16) . #4#)
            (LETT |oldIndex| (|spadConstant| $ 16) . #4#)
            (COND
             ...
             (SEQ G190 NIL
                  (SEQ
                   ...
                   (LETT |rb|
                         (SPADCALL
                          (SPADCALL |rbinv|
                                    (SPADCALL |rbden| |sing| (QREFELT $ 20))
                                    (QREFELT $ 33))
                          (QREFELT $ 34))
                         . #4#)
                   ...
                   (LETT |disc|
                         (SPADCALL |disc0|
                                   (SPADCALL |index| |index| (QREFELT $ 20))
                                   (QREFELT $ 43))
                         . #4#)
                   (LETT |indexChange|
                   ...
                   (COND
                    ((NULL
                      (SPADCALL (|spadConstant| $ 16) |sing| (QREFELT $ 27)))
                     (EXIT
                      (PROGN
                              ...
                              (LETT #1#
                                    (SPADCALL
                                     (SPADCALL
                                      ...
                                      (QREFELT $ 36))
                                     (SPADCALL |rbden| |rbden| (QREFELT $ 20))
                                     (QREFELT $ 42))
                                    . #4#)
                              (QCDR #1#)
                            (|check_union2| (QEQCAR #1# 0)
