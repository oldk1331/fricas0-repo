...
(SDEFUN |INTHEORY;harmonic;IF;1| ((|n| |Integer|) ($ |Fraction| (|Integer|)))
        (SPROG
         ((|h| #1=(|Fraction| (|Integer|))) (|k| NIL) (|s| #2=(|Integer|))
          (|#G3| (|Record| (|:| |Hn| #2#) (|:| |Hv| #1#))))
         (SEQ
          (COND
           ...
           (#3='T
            (SEQ
             (COND
              ((>= |n| (QCAR (QREFELT $ 16)))
               (PROGN
                (LETT |#G3| (QREFELT $ 16) . #4=(|INTHEORY;harmonic;IF;1|))
                (LETT |s| (QCAR |#G3|) . #4#)
                (LETT |h| (QCDR |#G3|) . #4#)
                |#G3|))
              (#3#
               (SEQ (LETT |s| 0 . #4#)
                    (EXIT (LETT |h| (|spadConstant| $ 17) . #4#)))))
             (SEQ (LETT |k| (+ |s| 1) . #4#) G190
                  (COND ((> |k| |n|) (GO G191)))
                  (SEQ
                   (EXIT
                    (LETT |h|
                    ...
                    (#4#
                     (SEQ
                      ...
                      (SEQ (LETT |i| 1 . #5#) G190
                           ...
                           (EXIT NIL))
                      (SEQ (LETT |i| (+ |l| 1) . #5#) G190
                           (COND ((> |i| |n|) (GO G191)))
                           (SEQ (LETT |t| (LETT |e| 1 . #5#) . #5#)
                                (SEQ (LETT |j| 2 . #5#)
                                     (LETT #2# (- |i| 2) . #5#) G190
                                     (COND ((> |j| #2#) (GO G191)))
                                     (SEQ
