...
(SDEFUN |LEXP;ident|
        ((|l1|
         ...
         (% (|List| (|Equation| R))))
        (SPROG
         ((|r| (R)) (|c2| (R)) (|u2| #1#) (|c1| (R)) (|u1| #1#) (#2=#:G124 NIL)
          (|t| NIL) (#3=#:G123 NIL) (#4=#:G122 NIL) (#5=#:G121 NIL))
         (SEQ
          (COND
           ((NULL |l1|)
            (PROGN
...
(SDEFUN |LEXP;LyndonCoordinates;%L;5|
        ...
        (SPROG
         ((|lt|
           (|List| (|Record| (|:| |k| (|LyndonWord| |VarSet|)) (|:| |c| R))))
          (#1=#:G137 NIL) (|l| (|Union| (|LyndonWord| |VarSet|) #2="failed"))
          (#3=#:G146 NIL) (|t| NIL) (#4=#:G145 NIL))
         (SEQ
          (LETT |lt|
                (PROGN
                 (LETT #4# NIL)
...
(SDEFUN |LEXP;LyndonBasis;LL;10|
        ...
        (SPROG ((#1=#:G175 NIL) (|l| NIL) (#2=#:G174 NIL))
               (SEQ
                (PROGN
                 (LETT #2# NIL)
                 (SEQ (LETT |l| NIL)
...
(DEFUN |LieExponentials| (&REST #1=#:G188)
  (SPROG NIL
         (PROG (#2=#:G189)
           (RETURN
            (COND
