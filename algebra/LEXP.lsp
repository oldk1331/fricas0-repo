...
(SDEFUN |LEXP;ident|
        ((|l1| |List|
         ...
         ($ |List| (|Equation| R)))
        (SPROG
         ((|r| (R)) (|c2| (R)) (|u2| #1#) (|c1| (R)) (|u1| #1#) (#2=#:G119 NIL)
          (|t| NIL) (#3=#:G118 NIL) (#4=#:G117 NIL) (#5=#:G116 NIL))
         (SEQ
          (COND
           ((NULL |l1|)
            (PROGN
...
(SDEFUN |LEXP;LyndonBasis;LL;10|
        ...
        (SPROG ((#1=#:G167 NIL) (|l| NIL) (#2=#:G166 NIL))
               (SEQ
                (PROGN
...
(DEFUN |LieExponentials| (&REST #1=#:G179)
  (SPROG NIL
         (PROG (#2=#:G180)
           (RETURN
            (COND
