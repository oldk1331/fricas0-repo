...
(DEFUN |DirectProductModule;| (|#1| |#2| |#3|)
  (SPROG
   ((|pv$| NIL) (#1=#:G124 NIL) (#2=#:G125 NIL) (#3=#:G127 NIL) (#4=#:G128 NIL)
    (#5=#:G129 NIL) ($ NIL) (|dv$| NIL) (DV$3 NIL) (DV$2 NIL) (DV$1 NIL))
   (PROGN
...
(MAKEPROP '|DirectProductModule| '|infovec|
          (LIST
           ...
           (CONS
            (|makeByteWordVec2| 32
                                '(0 1 4 8 2 2 10 4 8 2 13 14 15 9 3 4 8 16 0 9
                                  2 5 11 8 16 5 19 5 2 18 0 5 2 6 20 0 0 5 6 12
                                  0 0 0 23 17 0 0 0 0 0 0 23 5 7 8 12 17 32
                                  29))
            (CONS
