...
(DEFUN |DirectProductCategory| (&REST #1=#:G130)
  (LET (#2=#:G131)
    (COND
                                      ...
                                      (|mkCategory|
                                       ...
                                       '(((|FullyRetractableTo| |t#2|)
                                         ...
                                         ((|FullyLinearlyExplicitRingOver|
                                          ...
                                          (|has| |t#2| (|Ring|)))
                                         ((|AbelianSemiGroup|)
                                          (|has| |t#2| (|AbelianSemiGroup|)))
                                         ((|CancellationAbelianMonoid|)
                                          (|has| |t#2|
                                                 (|CancellationAbelianMonoid|)))
                                         ((|Monoid|) (|has| |t#2| (|Monoid|)))
                                         ((|Finite|) (|has| |t#2| (|Finite|)))
                                         ((|Algebra| |t#2|)
