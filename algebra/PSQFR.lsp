...
(SDEFUN |PSQFR;finSqFr|
        ...
        (SPROG
         ((|pfaclist|
          ...
          (|flistfin1| (|List| #1#)) (#3=#:G162 NIL) (|uu| NIL) (#4=#:G161 NIL)
          (|listfin1| #2#) (|uexp| (|NonNegativeInteger|)) (#5=#:G160 NIL)
          (|u| NIL) (|squf| (|Factored| (|SparseUnivariatePolynomial| P)))
          (|uf| (|SparseUnivariatePolynomial| P)) (#6=#:G142 NIL)
          (|mv| (|VarSet|)))
         (SEQ
          ...
          (|pfaclist|
           (|List|
            (|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                      (|:| |factor| P)
                      (|:| |exponent| (|NonNegativeInteger|)))))
          (#1=#:G183 NIL) (|u| NIL) (#2=#:G182 NIL)
          (|squp| (|Factored| (|SparseUnivariatePolynomial| P)))
          (|up| (|SparseUnivariatePolynomial| P)) (#3=#:G168 NIL) (|cont| (P))
...
(DEFUN |PolynomialSquareFree| (&REST #1=#:G184)
  (SPROG NIL
         (PROG (#2=#:G185)
           (RETURN
            (COND
