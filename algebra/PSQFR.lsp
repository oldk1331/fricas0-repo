...
(SDEFUN |PSQFR;pPolRoot| ((|f| (P)) (% (P)))
        (SPROG
         ((|lvar| (|List| |VarSet|)) (|mv| (|VarSet|)) (#1=#:G9 NIL)
          (|uf| (|SparseUnivariatePolynomial| P)))
...
(SDEFUN |PSQFR;pthPower| ((|f| (P)) (% (|Factored| P)))
        (SPROG
         ((|g| (|Union| P "failed")) (|proot| (P)) (|isSq| (|Boolean|))
          (|psqfr| (|Factored| P)) (#1=#:G36 NIL) (#2=#:G37 NIL) (#3=#:G38 NIL)
          (|u| NIL) (#4=#:G39 NIL))
                ...
                (|isSq|
                 (SPADCALL
                  ...
                  (PROGN
                   (LETT #1# NIL)
                   (SEQ (LETT |u| NIL)
                        (LETT #2# (SPADCALL |psqfr| (QREFELT % 32))) G190
                        (COND
                ...
                (#5#
                 (SPADCALL (SPADCALL |psqfr| (QREFELT % 27))
                           (PROGN
                            (LETT #3# NIL)
                            (SEQ (LETT |u| NIL)
                                 (LETT #4# (SPADCALL |psqfr| (QREFELT % 32)))
                                 G190
                                 (COND
                                  ((OR (ATOM #4#)
...
(SDEFUN |PSQFR;finSqFr|
        ...
        (SPROG
         ((|mv| (|VarSet|)) (#1=#:G41 NIL)
          (|uf| (|SparseUnivariatePolynomial| P))
          (|squf| (|Factored| (|SparseUnivariatePolynomial| P))) (|u| NIL)
          (#2=#:G61 NIL) (|uexp| (|NonNegativeInteger|))
          (|listfin1| #3=(|Factored| P)) (#4=#:G62 NIL) (|uu| NIL)
          (#5=#:G63 NIL)
          (|flistfin1|
           (|List|
            #6=(|Record| (|:| |flag| (|Union| "nil" "sqfr" "irred" "prime"))
                         (|:| |factor| P)
                         (|:| |exponent| (|NonNegativeInteger|)))))
          (|cont1| (P)) (|cont| (P)) (|sqp| #3#) (|pfaclist| (|List| #6#)))
         (SEQ
                       ...
                       (COND
                        ...
                        (#7#
                         (SEQ (LETT |uf| (SPADCALL |f| |mv| (QREFELT % 16)))
                              ...
                              (LETT |pfaclist| NIL)
                              (SEQ (LETT |u| NIL)
                                   (LETT #2# (SPADCALL |squf| (QREFELT % 45)))
                                   G190
                                   (COND
                                    ((OR (ATOM #2#)
...
(SDEFUN |PSQFR;squareFree;PF;5| ((|p| (P)) (% (|Factored| P)))
        (SPROG
         ((|mv| (|Union| |VarSet| "failed")) (|cont| (P)) (#1=#:G69 NIL)
          (|up| (|SparseUnivariatePolynomial| P))
          (|squp| (|Factored| (|SparseUnivariatePolynomial| P))) (#2=#:G84 NIL)
          (|u| NIL) (#3=#:G85 NIL)
          (|pfaclist|
           (|List|
                      ...
                      (SEQ
                       ...
                       (LETT |pfaclist|
                             (PROGN
                              (LETT #2# NIL)
                              (SEQ (LETT |u| NIL)
                                   (LETT #3# (SPADCALL |squp| (QREFELT % 45)))
                                   G190
                                   (COND
                                    ((OR (ATOM #3#)
...
(MAKEPROP '|PolynomialSquareFree| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (27 . |multivariate|) (33 . |multiplyExponents|) (39 . |0|)
