...
(DEFUN |PADICRC;getExpon| (|x| $) (QCAR |x|)) 

(PUT '|PADICRC;getZp| '|SPADreplace| 'QCDR) 

(DEFUN |PADICRC;getZp| (|x| $) (QCDR |x|)) 

(PUT '|PADICRC;makeQp| '|SPADreplace| 'CONS) 

(DEFUN |PADICRC;makeQp| (|r| |int| $) (CONS |r| |int|)) 

(DEFUN |PADICRC;Zero;$;4| ($) (|PADICRC;makeQp| 0 (|spadConstant| $ 13) $)) 

(DEFUN |PADICRC;One;$;5| ($) (|PADICRC;makeQp| 0 (|spadConstant| $ 15) $)) 

(DEFUN |PADICRC;coerce;I$;6| (|x| $)
  (SPADCALL (SPADCALL |x| (QREFELT $ 17)) (QREFELT $ 18))) 

(DEFUN |PADICRC;coerce;F$;7| (|r| $)
  (SPADCALL (SPADCALL (SPADCALL |r| (QREFELT $ 21)) (QREFELT $ 19))
            (SPADCALL (SPADCALL |r| (QREFELT $ 22)) (QREFELT $ 19))
            (QREFELT $ 23))) 

(DEFUN |PADICRC;coerce;PADIC$;8| (|x| $) (|PADICRC;makeQp| 0 |x| $)) 

(DEFUN |PADICRC;removeZeroes;2$;9| (|x| $)
  (PROG (|xx|)
    (RETURN
     (COND
      ((SPADCALL
        (SPADCALL
         (LETT |xx| (|PADICRC;getZp| |x| $) |PADICRC;removeZeroes;2$;9|)
         (QREFELT $ 26))
        (QREFELT $ 28))
       (|spadConstant| $ 14))
...
(DEFUN |PADICRC;removeZeroes;I2$;10| (|n| |x| $)
  (PROG (|xx|)
    (RETURN
     (COND ((SPADCALL |n| 0 (QREFELT $ 32)) |x|)
           ((SPADCALL
             (SPADCALL
              (LETT |xx| (|PADICRC;getZp| |x| $) |PADICRC;removeZeroes;I2$;10|)
              (QREFELT $ 26))
             (QREFELT $ 28))
            (|spadConstant| $ 14))
           ((ZEROP (SPADCALL |xx| (QREFELT $ 29)))
...
(DEFUN |PADICRC;*;I2$;15| (|n| |x| $)
  (|PADICRC;makeQp| (|PADICRC;getExpon| |x| $)
   (SPADCALL |n| (|PADICRC;getZp| |x| $) (QREFELT $ 34)) $)) 

(DEFUN |PADICRC;*;3$;16| (|x| |y| $)
  (|PADICRC;makeQp| (+ (|PADICRC;getExpon| |x| $) (|PADICRC;getExpon| |y| $))
...
(DEFUN |PADICRC;recip;$U;18| (|x| $)
  (PROG (|inv| |xx|)
    (RETURN
     (SEQ
      (LETT |x| (SPADCALL 1000 |x| (QREFELT $ 33))
            . #1=(|PADICRC;recip;$U;18|))
      (EXIT
       (COND
        ((ZEROP
          (SPADCALL (LETT |xx| (|PADICRC;getZp| |x| $) . #1#) (QREFELT $ 29)))
         (CONS 1 "failed"))
        (#2='T
         (SEQ (LETT |inv| (SPADCALL |xx| (QREFELT $ 53)) . #1#)
              (EXIT
...
(DEFUN |PADICRC;inv;2$;19| (|x| $)
  (PROG (|inv|)
    (RETURN
     (SEQ (LETT |inv| (SPADCALL |x| (QREFELT $ 54)) |PADICRC;inv;2$;19|)
          (EXIT
           (COND ((QEQCAR |inv| 1) (|error| "inv: no inverse"))
                 ('T (QCDR |inv|)))))))) 

(DEFUN |PADICRC;/;3$;20| (|x| |y| $)
  (SPADCALL |x| (SPADCALL |y| (QREFELT $ 50)) (QREFELT $ 45))) 

(DEFUN |PADICRC;/;2PADIC$;21| (|x| |y| $)
  (SPADCALL (SPADCALL |x| (QREFELT $ 18)) (SPADCALL |y| (QREFELT $ 18))
            (QREFELT $ 23))) 

(DEFUN |PADICRC;*;PADIC2$;22| (|x| |y| $)
  (|PADICRC;makeQp| (|PADICRC;getExpon| |y| $)
   (SPADCALL |x| (|PADICRC;getZp| |y| $) (QREFELT $ 44)) $)) 

(DEFUN |PADICRC;approximate;$IF;23| (|x| |n| $)
  (PROG (|k|)
    (RETURN
     (SEQ (LETT |k| (|PADICRC;getExpon| |x| $) |PADICRC;approximate;$IF;23|)
          (EXIT
           (SPADCALL
...
(DEFUN |PADICRC;cfStream| (|x| $)
  (PROG ()
    (RETURN
     (SEQ
      (SPADCALL (CONS #'|PADICRC;cfStream!0| (VECTOR $ |x|)) (QREFELT $ 66)))))) 

(DEFUN |PADICRC;cfStream!0| ($$)
  (PROG (|x| $)
      ...
      (PROG (|invx| |x0|)
        (RETURN
         (SEQ (LETT |invx| (SPADCALL |x| (QREFELT $ 50)) NIL)
              (LETT |x0| (SPADCALL |invx| (|spadConstant| $ 62) (QREFELT $ 61))
                    NIL)
              (EXIT
               (SPADCALL |x0|
                         (|PADICRC;cfStream|
                          (SPADCALL |invx| (SPADCALL |x0| (QREFELT $ 24))
                                    (QREFELT $ 42))
                          $)
                         (QREFELT $ 64)))))))))) 

(DEFUN |PADICRC;continuedFraction;$Cf;25| (|x| $)
  (PROG (|x0|)
    (RETURN
     (SEQ
      ...
      (EXIT
       (SPADCALL |x0|
                 (|PADICRC;cfStream|
                  (SPADCALL |x| (SPADCALL |x0| (QREFELT $ 24)) (QREFELT $ 42))
                  $)
                 (QREFELT $ 68))))))) 

(DEFUN |PADICRC;termOutput| (|k| |c| $)
  (PROG (|mon|)
    (RETURN
     (SEQ
...
(PUT '|PADICRC;showAll?| '|SPADreplace| '(XLAM NIL 'T)) 

(DEFUN |PADICRC;showAll?| ($) 'T) 

(DEFUN |PADICRC;coerce;$Of;28| (|x| $)
  (PROG (|l| |uu| |n| |count| |zp| |m|)
    (RETURN
     (SEQ
      (LETT |x| (SPADCALL |$streamCount| |x| (QREFELT $ 33))
            . #1=(|PADICRC;coerce;$Of;28|))
      (LETT |m| (|PADICRC;getExpon| |x| $) . #1#)
      (LETT |zp| (|PADICRC;getZp| |x| $) . #1#)
      (LETT |uu| (SPADCALL |zp| (QREFELT $ 26)) . #1#) (LETT |l| NIL . #1#)
      (EXIT
                         ...
                         (COND
                          ((SPADCALL (SPADCALL |uu| (QREFELT $ 73)) 0
                           ...
                           (LETT |l|
                                 ...
                                 . #1#)))
                         (EXIT
                          (LETT |uu| (SPADCALL |uu| (QREFELT $ 75)) . #1#)))
                           ...
                           ((NULL
                             (COND
                              ((SPADCALL |uu| (QREFELT $ 76))
                               (COND
                                ((SPADCALL |uu| (SPADCALL |uu| (QREFELT $ 75))
                                           (QREFELT $ 77))
                                 'NIL)
                                ('T 'T)))
                              ('T 'NIL)))
...
(MAKEPROP '|PAdicRationalConstructor| '|infovec|
          (LIST
           '#(NIL NIL NIL NIL NIL NIL (|local| |#1|) (|local| |#2|)
              ...
              (|InputForm|) (|Pattern| 108) (|Pattern| 9) (|Equation| 7)
              (|List| 93) (|List| 7) (|List| 97) (|Symbol|) (|Matrix| 9)
              (|Record| (|:| |mat| 98) (|:| |vec| (|Vector| 9))) (|Vector| $)
              (|List| 81) (|PatternMatchResult| 108 $)
              (|PatternMatchResult| 9 $) (|Factored| 105)
              (|SparseUnivariatePolynomial| $) (|Union| 107 '#1#) (|List| 105)
              (|Float|) (|DoubleFloat|) (|Union| 9 '#2="failed")
              (|Union| 20 '#2#) (|Union| 97 '#2#) (|Matrix| 7)
              (|Record| (|:| |mat| 113) (|:| |vec| (|Vector| 7)))
              (|Mapping| 7 7) (|Union| 7 '#2#) (|Factored| $)
              (|Union| 79 '#3="failed")
              (|Record| (|:| |coef1| $) (|:| |coef2| $) (|:| |generator| $))
              (|Record| (|:| |coef1| $) (|:| |coef2| $)) (|Union| 120 '#3#)
           ...
           '#(~= 221 |zero?| 227 |wholePart| 232 |unitNormal| 237
              ...
              |random| 384 |quo| 388 |principalIdeal| 394 |prime?| 399
              |positive?| 404 |patternMatch| 409 |one?| 423 |numerator| 428
              |numer| 433 |nextItem| 438 |negative?| 443 |multiEuclidean| 448
              |min| 454 |max| 460 |map| 466 |lcmCoef| 472 |lcm| 478 |latex| 489
              |inv| 494 |init| 499 |hashUpdate!| 503 |hash| 509 |gcdPolynomial|
              514 |gcd| 520 |fractionPart| 531 |floor| 536
              |factorSquareFreePolynomial| 541 |factorPolynomial| 546 |factor|
              551 |extendedEuclidean| 556 |exquo| 569 |expressIdealMember| 575
              |eval| 581 |euclideanSize| 621 |elt| 626 |divide| 632
              |differentiate| 638 |denominator| 688 |denom| 693 |convert| 698
              |continuedFraction| 723 |conditionP| 728 |coerce| 733
              |charthRoot| 763 |characteristic| 768 |ceiling| 772 |associates?|
              777 |approximate| 783 |abs| 789 ^ 794 |Zero| 812 |One| 816 D 820
              >= 870 > 876 = 882 <= 888 < 894 / 900 - 912 + 923 * 929)
           'NIL
           (CONS
            (|makeByteWordVec2| 25
            ...
            (CONS
             ...
             (CONS
              '#((|QuotientFieldCategory| 7) (|Field|) (|EuclideanDomain|)
                 ...
                 (|DifferentialExtension| 7) (|Algebra| 7) (|Algebra| 20)
                 (|LeftOreRing|) (|Algebra| $$) (|LinearlyExplicitRingOver| 7)
                 (|Module| 7) (|Module| 20) (|CommutativeRing|) (|EntireRing|)
                 (|Module| $$) (|CharacteristicNonZero|) (|CharacteristicZero|)
                 (|OrderedRing|) (|PartialDifferentialRing| 97)
                 (|DifferentialRing|) (|LinearlyExplicitRingOver| 9)
                 (|BiModule| 7 7) (|BiModule| 20 20) (|BiModule| $$ $$)
                 (|Ring|) (|OrderedAbelianGroup|) (|RightModule| 7)
                 (|LeftModule| 7) (|RightModule| 20) (|LeftModule| 20)
              ...
              (|makeByteWordVec2| 128
                                  '(1 9 8 0 10 0 7 0 13 0 7 0 15 1 7 0 9 17 1
                                    ...
                                    0 116 0 1 1 10 9 0 1 1 10 20 0 1 1 2 97 0 1
                                    1 0 7 0 1 1 0 0 0 31 2 0 0 9 0 33 2 0 0 0 0
                                    1 1 17 98 89 1 2 17 99 89 100 1 1 0 113 89
                                    1 2 0 114 89 100 1 1 0 52 0 54 0 23 0 1 2 0
                                    0 0 0 1 1 0 123 79 1 1 0 27 0 1 1 7 27 0 1
                                    3 20 102 0 91 102 1 3 21 103 0 92 103 1 1 0
                                    27 0 1 1 0 0 0 1 1 0 7 0 1 1 11 52 0 1 1 7
                                    27 0 1 2 0 118 79 0 1 2 8 0 0 0 1 2 8 0 0 0
                                    1 2 0 0 115 0 1 2 0 124 0 0 1 1 0 0 79 1 2
                                    0 0 0 0 1 1 0 126 0 1 1 0 0 0 50 0 11 0 1 2
                                    0 128 128 0 1 1 0 127 0 1 2 0 105 105 105 1
                                    1 0 0 79 1 2 0 0 0 0 1 1 22 0 0 1 1 23 7 0
                                    1 1 1 104 105 1 1 1 104 105 1 1 0 117 0 1 2
                                    0 119 0 0 1 3 0 121 0 0 0 1 2 0 52 0 0 1 2
                                    0 118 79 0 1 2 13 0 0 93 1 2 13 0 0 94 1 3
                                    13 0 0 95 95 1 3 13 0 0 7 7 1 3 12 0 0 96
                                    95 1 3 12 0 0 97 7 1 1 0 81 0 1 2 14 0 0 7
                                    1 2 0 122 0 0 1 2 16 0 0 81 1 1 16 0 0 1 3
                                    15 0 0 97 81 1 3 15 0 0 96 101 1 2 15 0 0
                                    97 1 2 15 0 0 96 1 3 0 0 0 115 81 1 2 0 0 0
                                    115 1 1 0 0 0 1 1 0 7 0 1 1 5 90 0 1 1 18
                                    91 0 1 1 19 92 0 1 1 6 108 0 1 1 6 109 0 1
                                    1 0 67 0 69 1 26 88 89 1 1 2 0 97 1 1 0 0 7
                                    18 1 0 0 20 24 1 0 0 0 1 1 0 0 9 19 1 0 8 0
                                    87 1 27 52 0 1 0 0 81 1 1 23 7 0 1 2 0 27 0
                                    0 1 2 0 20 0 9 61 1 7 0 0 1 2 0 0 0 9 51 2
                                    0 0 0 81 1 2 0 0 0 47 1 0 0 0 14 0 0 0 16 2
                                    16 0 0 81 1 1 16 0 0 1 3 15 0 0 97 81 1 3
                                    15 0 0 96 101 1 2 15 0 0 97 1 2 15 0 0 96 1
                                    3 0 0 0 115 81 1 2 0 0 0 115 1 2 8 27 0 0 1
                                    2 8 27 0 0 1 2 0 27 0 0 36 2 8 27 0 0 1 2 8
                                    27 0 0 1 2 0 0 7 7 55 2 0 0 0 0 23 1 0 0 0
                                    40 2 0 0 0 0 42 2 0 0 0 0 38 2 0 0 0 7 1 2
                                    0 0 7 0 56 2 0 0 20 0 1 2 0 0 0 20 1 2 0 0
                                    9 0 43 2 0 0 0 0 45 2 0 0 81 0 1 2 0 0 47 0
                                    1)))))
           '|lookupComplete|)) 
