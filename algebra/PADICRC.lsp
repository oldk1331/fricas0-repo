...
(SDEFUN |PADICRC;=;2$B;11| ((|x| ($)) (|y| ($)) ($ (|Boolean|)))
        (SPROG ((#1=#:G357 NIL) (#2=#:G290 NIL) (|n| (|Integer|)))
               (SEQ
                (COND ((EQ |x| |y|) 'T)
                      (#3='T
                       (SEQ
...
(SDEFUN |PADICRC;+;3$;12| ((|x| ($)) (|y| ($)) ($ ($)))
        (SPROG ((#1=#:G375 NIL) (#2=#:G371 NIL) (|n| (|Integer|)))
               (SEQ
                (LETT |n|
                      (- (|PADICRC;getExpon| |x| $)
                         (|PADICRC;getExpon| |y| $)))
...
(SDEFUN |PADICRC;-;3$;14| ((|x| ($)) (|y| ($)) ($ ($)))
        (SPROG ((#1=#:G393 NIL) (#2=#:G389 NIL) (|n| (|Integer|)))
               (SEQ
                (LETT |n|
                      (- (|PADICRC;getExpon| |x| $)
                         (|PADICRC;getExpon| |y| $)))
...
(SDEFUN |PADICRC;coerce;$Of;28| ((|x| ($)) ($ (|OutputForm|)))
        (SPROG
         ((|l| (|List| (|OutputForm|))) (|uu| (|Stream| (|Integer|)))
          (|uu1| (|Stream| (|Integer|))) (|n| NIL) (#1=#:G459 NIL)
...
(DEFUN |PAdicRationalConstructor| (&REST #1=#:G494)
  (SPROG NIL
         (PROG (#2=#:G495)
           (RETURN
            (COND
