  ...
  (PROG (CUROUTSTREAM)
    (RETURN
     (PROGN
      ...
      (SETF (ELT |$algebra_out_rec| |$stream_off|) (|mkOutputConsoleStream|))
      (SETF (ELT |$fortran_out_rec| |$stream_off|) (|mkOutputConsoleStream|))
      (SETF (ELT |$mathml_out_rec| |$stream_off|) (|mkOutputConsoleStream|))
      (SETF (ELT |$texmacs_out_rec| |$stream_off|) (|mkOutputConsoleStream|))
      (SETF (ELT |$html_out_rec| |$stream_off|) (|mkOutputConsoleStream|))
      (SETF (ELT |$openmath_out_rec| |$stream_off|) (|mkOutputConsoleStream|))
      (SETF (ELT |$tex_out_rec| |$stream_off|) (|mkOutputConsoleStream|))
      (SETF (ELT |$formatted_out_rec| |$stream_off|) (|mkOutputConsoleStream|))
      (|fricas_init|)
      (|fricas_restart2|)))))
