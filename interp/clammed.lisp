  ...
  (PROG (|bfVar#2|)
    (RETURN
     (COND
      ((NOT
        (EQ
         (SETF |bfVar#2| #1=(GETHASH |bfVar#1| |canCoerceFrom;AL| #2='#:G100))
         #2#))
       |bfVar#2|)
...
(DEFUN |canCoerce| (&REST |bfVar#3|)
  (PROG (|bfVar#4|)
    (RETURN
     (COND
      ((NOT
        (EQ (SETF |bfVar#4| #1=(GETHASH |bfVar#3| |canCoerce;AL| #2='#:G101))
            #2#))
       |bfVar#4|)
  ...
  (PROG (|bfVar#21|)
    (RETURN
     (COND
      ((NOT
        (EQ
         (SETF |bfVar#21| #1=(GETHASH |bfVar#20| |isValidType;AL| #2='#:G102))
         #2#))
       |bfVar#21|)
  ...
  (PROG (|bfVar#23|)
    (RETURN
     (COND
      ((NOT
        (EQ
         (SETF |bfVar#23| #1=(GETHASH |bfVar#22| |selectMms1;AL| #2='#:G103))
         #2#))
       |bfVar#23|)
...
(DEFUN |resolveTT| (&REST |bfVar#28|)
  (PROG (|bfVar#29|)
    (RETURN
     (COND
      ((NOT
        (EQ (SETF |bfVar#29| #1=(GETHASH |bfVar#28| |resolveTT;AL| #2='#:G105))
            #2#))
       |bfVar#29|)
    ...
    (RETURN
     (COND
      ((NOT
        (EQ
         (SETF |bfVar#38|
                 #1=(GETHASH |bfVar#37| |isLegitimateMode;AL| #2='#:G106))
         #2#))
       |bfVar#38|)
    ...
    (RETURN
     (COND
      ((NOT
        (EQ
         (SETF |bfVar#40|
                 #1=(GETHASH |bfVar#39| |underDomainOf;AL| #2='#:G107))
         #2#))
       |bfVar#40|)
    ...
    (RETURN
     (COND
      ((NOT
        (EQ
         (SETF |bfVar#42|
                 #1=(GETHASH |bfVar#41| |findRetractMms;AL| #2='#:G108))
         #2#))
       |bfVar#42|)
    ...
    (RETURN
     (COND
      ((NOT
        (EQ
         (SETF |bfVar#44|
                 #1=(GETHASH |bfVar#43| |getConstantFromDomain;AL| #2='#:G109))
         #2#))
       |bfVar#44|)
  ...
  (PROG (|bfVar#46|)
    (RETURN
     (COND
      ((NOT
        (EQ
         (SETF |bfVar#46| #1=(GETHASH |bfVar#45| |interpLookup;AL| #2='#:G110))
         #2#))
       |bfVar#46|)
