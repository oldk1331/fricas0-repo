  ...
  (PROG (|xl| |yl|)
    (RETURN
     (COND ((OR (ATOM |x|) (ATOM |y|)) (EQUAL |x| |y|))
            ...
            (PROGN
             ((LAMBDA (|bfVar#166| |x1|)
                (LOOP
                 (COND
                  ((OR (ATOM |bfVar#166|)
                       (PROGN (SETQ |x1| (CAR |bfVar#166|)) NIL))
                   (RETURN NIL))
                  (#1#
                   ((LAMBDA (|bfVar#167| |y1|)
                      (LOOP
                       (COND
                        ((OR (ATOM |bfVar#167|)
                             (PROGN (SETQ |y1| (CAR |bfVar#167|)) NIL))
                         (RETURN NIL))
                        (#1#
                         (COND
                          ((|modeEqual| |x1| |y1|)
           ...
           (#1#
            ((LAMBDA (|bfVar#170| |bfVar#168| |u| |bfVar#169| |v|)
               (LOOP
                (COND
                 ((OR (ATOM |bfVar#168|)
                      (PROGN (SETQ |u| (CAR |bfVar#168|)) NIL)
                      (ATOM |bfVar#169|)
                      (PROGN (SETQ |v| (CAR |bfVar#169|)) NIL))
                  (RETURN |bfVar#170|))
                 (#1#
                  (PROGN
                   (SETQ |bfVar#170| (|modeEqual| |u| |v|))
            ...
            (PROGN
             ...
             (COND ((OR (ATOM |m1|) (ATOM |m|)) (EQUAL |m1| |m|))
                   ...
                   ((AND (CONSP |m1|)
                    ...
                    ((LAMBDA (|bfVar#173| |bfVar#171| |xm1| |bfVar#172| |xm2|)
                       (LOOP
                        (COND
                         ((OR (ATOM |bfVar#171|)
                              (PROGN (SETQ |xm1| (CAR |bfVar#171|)) NIL)
                              (ATOM |bfVar#172|)
                              (PROGN (SETQ |xm2| (CAR |bfVar#172|)) NIL))
                          (RETURN |bfVar#173|))
                         (#1#
                          (PROGN
                           (SETQ |bfVar#173|
                  ...
                  (COND
                   ...
                   (#1#
                    (PROGN
                     (SETF (ELT |fun| 0) '|c|)
                     (SETQ |constructor|
                             ((LAMBDA (|bfVar#176| |bfVar#175| |o|)
                                (LOOP
                                 (COND
                                  ((OR (ATOM |bfVar#175|)
                                       (PROGN
                                        (SETQ |o| (CAR |bfVar#175|))
                                        NIL))
             ...
             (PROGN
              ...
              ((LAMBDA (|bfVar#179| |ii|)
                 (LOOP
                  (COND
                   ((OR (ATOM |bfVar#179|)
                        (PROGN (SETQ |ii| (CAR |bfVar#179|)) NIL))
                    (RETURN NIL))
                   (#1#
                    (COND
                     ((NULL (|member| |ii| |$constructorsSeen|))
