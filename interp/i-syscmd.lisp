            ...
            (PROGN
             ...
             (QRPLACD |nob|
              (LIST 'HASHTABLE (HASHTABLE_CLASS |ob|)
                    ...
                    ((LAMBDA (|bfVar#97| |bfVar#96| |k|)
                       (LOOP
                        (COND
                         ((OR (ATOM |bfVar#96|)
                              (PROGN (SETQ |k| (CAR |bfVar#96|)) NIL))
             ...
             (COND ((EQ |type| 'SELF) 'WRITIFIED!!)
                   ...
                   ((EQ |type| 'HASHTABLE)
                    (PROGN
                     ...
                     (HPUT |$seen| |ob| |nob|)
                     (HPUT |$seen| |nob| |nob|)
                     ((LAMBDA (|bfVar#98| |k| |bfVar#99| |e|)
                        (LOOP
                         (COND
                          ((OR (ATOM |bfVar#98|)
                               (PROGN (SETQ |k| (CAR |bfVar#98|)) NIL)
                               (ATOM |bfVar#99|)
                               (PROGN (SETQ |e| (CAR |bfVar#99|)) NIL))
                           (RETURN NIL))
                          (#1#
           ...
           (LOOP
            (COND
             ...
             (#1='T
              (AND (CONSP |bfVar#101|)
                   (PROGN
                    (SETQ |a| (CAR |bfVar#101|))
                    (SETQ |b| (CDR |bfVar#101|))
                    #1#)
                   (PROGN
         ...
         (LOOP
          (COND
           ((OR (ATOM |bfVar#104|)
            ...
            (RETURN NIL))
           (#1='T
            (AND (CONSP |bfVar#103|) (PROGN (SETQ |opt| (CAR |bfVar#103|)) #1#)
                 (PROGN
                  (SETQ |fullopt|
             ...
             (PROGN
              ...
              ((LAMBDA (|bfVar#105| |op|)
                 (LOOP
                  (COND
                   ((OR (ATOM |bfVar#105|)
                        (PROGN (SETQ |op| (CAR |bfVar#105|)) NIL))
                    (RETURN NIL))
         ...
         (LOOP
          (COND
           ((OR (ATOM |bfVar#107|)
            ...
            (RETURN NIL))
           (#1#
            (AND (CONSP |bfVar#106|) (EQ (CDR |bfVar#106|) NIL)
                 (PROGN (SETQ |opt| (CAR |bfVar#106|)) #1#)
                 (PROGN
                  (SETQ |opt|
                     ...
                     (COND
                      (|isRecordOrUnion|
                       ...
                       (SETQ |sigList|
                               (REMDUP
                                (MSORT
                                 ((LAMBDA (|bfVar#110| |bfVar#109| |bfVar#108|)
                                    (LOOP
                                     (COND
                                      ((OR (ATOM |bfVar#109|)
                                           (PROGN
