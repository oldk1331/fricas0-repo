...
(DEFUN |outputTran| (|x|)
  (PROG (|c| |ISTMP#1| |var| |ISTMP#2| |mode| |vars| |ISTMP#3| |ISTMP#4| |body|
         |m| |d| |e| |l| |domain| |ISTMP#5| |y| |ISTMP#6| |z| |float| |f| |o|
         |LETTMP#1| |op| |a| |a'| |b| |b'| |targ| |fun| |targ'| |ll| |u|
         |pred|)
    (RETURN
     (COND
                    ...
                    ((LAMBDA (|bfVar#6| |bfVar#5| |i|)
                       (LOOP
                        (COND ((> |i| |bfVar#5|) (RETURN (NREVERSE |bfVar#6|)))
                              (#1='T
                               (SETQ |bfVar#6|
                                       (CONS (ELT |x| |i|) |bfVar#6|))))
                        (SETQ |i| (+ |i| 1))))
                     NIL (MAXINDEX |x|) 0)))))
      ((NUMBERP |x|) (COND ((MINUSP |x|) (LIST '- (- |x|))) (#1# |x|)))
      ((ATOM |x|)
       (COND ((EQUAL |x| |$EmptyMode|) (|specialChar| '|quad|)) (#1# |x|)))
      ((AND (CONSP |x|)
            (PROGN
             (SETQ |c| (CAR |x|))
             (SETQ |ISTMP#1| (CDR |x|))
       ...
       (PROGN
        ...
        (LIST 'CONCATB |var| |c| (|obj2String| (|prefix2String| |mode|)))))
            ...
            (PROGN
             ...
             (AND (CONSP |ISTMP#1|) (EQ (CDR |ISTMP#1|) NIL)
                  (PROGN
                   ...
                   (AND (CONSP |ISTMP#2|) (EQ (CAR |ISTMP#2|) '|construct|)
                        (PROGN
                         (SETQ |ISTMP#3| (CDR |ISTMP#2|))
      ...
      ((AND (CONSP |x|) (EQ (CAR |x|) 'LIST) (PROGN (SETQ |l| (CDR |x|)) #1#))
                   ...
                   ((LAMBDA (|bfVar#8| |bfVar#7| |y|)
                      (LOOP
                       (COND
                        ...
                        (#1#
                         (SETQ |bfVar#8| (CONS (|outputTran| |y|) |bfVar#8|))))
      ...
      (#1#
       (PROGN
        (SETQ |LETTMP#1| (|flattenOps| |x|))
        (SETQ |op| (CAR |LETTMP#1|))
        (SETQ |l| (CDR |LETTMP#1|))
        (COND
         ((STRINGP |op|) (SETQ |op| (INTERN |op|)) (SETQ |x| (CONS |op| |l|))))
        (COND ((EQ |op| 'LAMBDA-CLOSURE) '|Closure|)
              ...
              ((AND (CONSP |x|) (EQ (CAR |x|) 'SEGMENT)
               ...
               (PROGN
                (SETQ |a'| (|outputTran| |a|))
                (COND ((LISTP |a'|) (SETQ |a'| (LIST 'PAREN |a'|))))
                (LIST 'SEGMENT |a'|)))
              ((AND (CONSP |x|) (EQ (CAR |x|) 'SEGMENT)
                    (PROGN
                     (SETQ |ISTMP#1| (CDR |x|))
               ...
               (PROGN
                ...
                (SETQ |b'| (|outputTran| |b|))
                (COND ((LISTP |a'|) (SETQ |a'| (LIST 'PAREN |a'|))))
                (COND ((LISTP |b'|) (SETQ |b'| (LIST 'PAREN |b'|))))
                (LIST 'SEGMENT |a'| |b'|)))
              ((OR
               ...
               (PROGN
                ...
                (LIST 'CONCAT (|outputTran| (CONS |fun| |l|)) "$" |targ'|)))
              ((OR
              ...
              ((AND (CONSP |x|) (EQ (CAR |x|) '-)
               ...
               (PROGN
                ...
                (COND
                 ((INTEGERP |b|)
                  (COND ((MINUSP |b|) (LIST '+ |a| (- |b|)))
                        (#1# (LIST '+ |a| (LIST '- |b|)))))
                 ((AND (CONSP |b|) (EQ (CAR |b|) '-)
                       (PROGN
                        (SETQ |ISTMP#1| (CDR |b|))
                        (AND (CONSP |ISTMP#1|) (EQ (CDR |ISTMP#1|) NIL)
              ...
              ((|member| |op| '(|cons| |nconc|)) (|outputConstructTran| |x|))
              (#1#
               (PROGN
                (SETQ |l|
                ...
                (COND
                         ...
                         (PROGN
                          ...
                          (AND (CONSP |ISTMP#1|) (EQ (CAR |ISTMP#1|) '-)
                               (PROGN
                                ...
                                (AND (CONSP |ISTMP#2|) (EQ (CDR |ISTMP#2|) NIL)
                                     (PROGN (SETQ |a| (CAR |ISTMP#2|)) #1#)))))
                         (PROGN (SETQ |b| (CDR |l|)) #1#))
                    (COND
                     ((EQL |a| 1) (|outputTran| (LIST '- (CONS |op| |b|))))
                     (#1#
                      (|outputTran| (LIST '- (CONS |op| (CONS |a| |b|)))))))
                   (#1#
                    (CONS |op|
                          ((LAMBDA (|bfVar#14| |bfVar#13| |ss|)
                             (LOOP
                              (COND
                               ((OR (ATOM |bfVar#13|)
                                    (PROGN (SETQ |ss| (CAR |bfVar#13|)) NIL))
                                (RETURN |bfVar#14|))
                               (#1#
                                (SETQ |bfVar#14|
                                        (APPEND |bfVar#14|
                 ...
                 ((EQ |op| '+)
                  (COND
                   ...
                   (#1#
                    (CONS |op|
                          ((LAMBDA (|bfVar#16| |bfVar#15| |ss|)
                             (LOOP
                              (COND
                               ((OR (ATOM |bfVar#15|)
                                    (PROGN (SETQ |ss| (CAR |bfVar#15|)) NIL))
                                (RETURN |bfVar#16|))
                               (#1#
                                (SETQ |bfVar#16|
                                        (APPEND |bfVar#16|
                 ...
                 ((EQ |op| '/)
                  (COND
                   ((EQ |$fractionDisplayType| '|horizontal|)
                    (PROGN
                     (SETQ |op| 'SLASH)
                     (COND
                      ((AND (CONSP |l|)
                  ...
                  (COND
                   ...
                   ((NULL (LISTP |term|))
                    (PROGN
                     ...
                     (SETQ |tail| (CDR |tail|))))
                   ((EQUAL |op| (CAR |term|))
                    (SETQ |tail| (APPEND (CDR |term|) (CDR |tail|))))
                   (#1#
                    (PROGN
                     (SETQ |head| (CONS |term| |head|))
                     (SETQ |tail| (CDR |tail|)))))))))))
             ...
             ((LAMBDA (|bfVar#18| |bfVar#17| |x|)
                (LOOP
                 (COND
                  ...
                  (#1# (SETQ |bfVar#18| (CONS (|outputTran| |x|) |bfVar#18|))))
...
(DEFUN |outputTranIf| (|bfVar#20|)
  (PROG (|x| |y| |z| |y'| |z'|)
    (RETURN
     (PROGN
      (SETQ |x| (CADR . #1=(|bfVar#20|)))
      (SETQ |y| (CADDR . #1#))
      (SETQ |z| (CADDDR . #1#))
      (COND
       ((EQ |y| '|noBranch|)
           ...
           (#1='T
            (PROGN
             ...
             (COND
              ((CDR |l|)
               (CONS 'SC
                     ((LAMBDA (|bfVar#22| |bfVar#21| |ll|)
                        (LOOP
                         (COND
                          ((OR (ATOM |bfVar#21|)
                               (PROGN (SETQ |ll| (CAR |bfVar#21|)) NIL))
                           (RETURN (NREVERSE |bfVar#22|)))
                          (#1#
                           (SETQ |bfVar#22|
                                   (CONS (|outputMapTran0| |ll| |alias|)
                                         |bfVar#22|))))
                         (SETQ |bfVar#21| (CDR |bfVar#21|))))
                      NIL |l| NIL)))
              (#1# (|outputMapTran0| (CAR |l|) |alias|)))))))))
...
(DEFUN |outputTranReduce| (|bfVar#23|)
  (PROG (|op| |body|)
    (RETURN
     (PROGN
      (SETQ |op| (CADR . #1=(|bfVar#23|)))
      (SETQ |body| (CADDDR . #1#))
...
(DEFUN |outputTranRepeat| (|bfVar#24|)
  (PROG (|LETTMP#1| |body| |itl| |body'| |itlist|)
    (RETURN
     (PROGN
      (SETQ |LETTMP#1| (REVERSE (CDR |bfVar#24|)))
...
(DEFUN |outputTranCollect| (|bfVar#25|)
  (PROG (|LETTMP#1| |body| |itl| |itlist|)
    (RETURN
     (PROGN
      (SETQ |LETTMP#1| (REVERSE (CDR |bfVar#25|)))
      (SETQ |body| (CAR |LETTMP#1|))
      (SETQ |itl| (NREVERSE (CDR |LETTMP#1|)))
      (SETQ |itlist| (|outputTranIteration| |itl|))
...
(DEFUN |outputTranMatrix| (|x|)
  (PROG ()
    (RETURN
     (COND ((NULL (VECP |x|)) (CONS 'MATRIX |x|))
           (#1='T
            (CONS 'MATRIX
                  (CONS NIL
     ...
     (COND
      ((NULL (VECP |x|))
       (|keyedSystemError| 'S2GE0016
        (LIST "outputTranMatrix"
              "improper internal form for matrix found in output routines")))
      (#1='T
       (CONS 'ROW
             ((LAMBDA (|bfVar#29| |bfVar#28| |i|)
                (LOOP
                 (COND ((> |i| |bfVar#28|) (RETURN (NREVERSE |bfVar#29|)))
                       (#1#
                        (SETQ |bfVar#29|
                                (CONS (|outputTran| (ELT |x| |i|))
                                      |bfVar#29|))))
                 (SETQ |i| (+ |i| 1))))
              NIL (MAXINDEX |x|) 0)))))))
...
(DEFUN |mkSuperSub| (|op| |argl|)
  (PROG (|s| |maxIndex| |d| |indexList| |cleanOp| |subPart| |l| |superSubPart|
         |this| |scripts| |superSub|)
    (RETURN
     (COND (|$linearFormatScripts| (|linearFormatForm| |op| |argl|))
           (#1='T
            (PROGN
             (SETQ |s| (PNAME |op|))
             (SETQ |indexList|
                     ((LAMBDA (|bfVar#30| |i|)
                        (LOOP
                         (COND
                          ((NOT
                            (DIGITP
                             (SETQ |d| (ELT |s| (SETQ |maxIndex| |i|)))))
                           (RETURN (NREVERSE |bfVar#30|)))
                          (#1#
                           (SETQ |bfVar#30|
                                   (CONS (PARSE-INTEGER (PNAME |d|))
                                         |bfVar#30|))))
                         (SETQ |i| (+ |i| 1))))
                      NIL 1))
             (SETQ |cleanOp|
                     (INTERN
                      ((LAMBDA (|bfVar#32| |bfVar#31| |i|)
                         (LOOP
                          (COND ((> |i| |bfVar#31|) (RETURN |bfVar#32|))
                                (#1#
                                 (SETQ |bfVar#32|
                                         (STRCONC |bfVar#32|
                                          (PNAME (ELT |s| |i|))))))
             ...
             (COND
              ...
              (#1#
               (PROGN
                (SETQ |superSubPart| NIL)
                ((LAMBDA (|bfVar#33| |i|)
                   (LOOP
                    (COND
                     ((OR (ATOM |bfVar#33|)
                          (PROGN (SETQ |i| (CAR |bfVar#33|)) NIL))
                      (RETURN NIL))
                     (#1#
                      (PROGN
                       (SETQ |scripts|
                               (PROGN
                                (SETQ |this| (TAKE |i| |argl|))
                                (SETQ |argl| (DROP |i| |argl|))
                                (COND ((EQL |i| 0) (LIST 'AGGLST))
                                      ((EQL |i| 1) (CAR |this|))
                                      (#1# (CONS 'AGGLST |this|)))))
                       (SETQ |superSubPart| (CONS |scripts| |superSubPart|)))))
                    (SETQ |bfVar#33| (CDR |bfVar#33|))))
                 (CDR |indexList|) NIL)
                (SETQ |superSub|
                        (CONS 'SUPERSUB
                              (CONS |cleanOp| (REVERSE |superSubPart|))))
                (COND (|argl| (CONS |superSub| |argl|))
                      (#1# |superSub|)))))))))))
    ...
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#34| |arg|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#34|) (PROGN (SETQ |arg| (CAR |bfVar#34|)) NIL))
            (RETURN NIL))
           ('T
            (PROGN
             (SETQ |op| (|keyp| |arg|))
    ...
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#35| |arg|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#35|) (PROGN (SETQ |arg| (CAR |bfVar#35|)) NIL))
            (RETURN NIL))
           ('T
            (PROGN
             (SETQ |op| (|keyp| |arg|))
    ...
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#36| |arg|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#36|) (PROGN (SETQ |arg| (CAR |bfVar#36|)) NIL))
            (RETURN NIL))
           ('T
            (PROGN
             (SETQ |op| (|keyp| |arg|))
...
(DEFUN |inApp| (|bfVar#41| |x| |y| |d|)
  (PROG (|a| |s|)
    (RETURN
     (PROGN
      (SETQ |a| (CADR . #1=(|bfVar#41|)))
      (SETQ |s| (CADDR . #1#))
      (SETQ |d| (|appChar| "for " |x| |y| |d|))
...
(DEFUN |centerApp| (|bfVar#45| |x| |y| |d|)
  (PROG (|u|)
    (RETURN
     (PROGN (SETQ |u| (CADR |bfVar#45|)) (SETQ |d| (APP |u| |x| |y| |d|))))))
 
; concatApp([.,:l],x,y,d) == concatApp1(l,x,y,d,0)
 
(DEFUN |concatApp| (|bfVar#46| |x| |y| |d|)
  (PROG (|l|)
    (RETURN
     (PROGN (SETQ |l| (CDR |bfVar#46|)) (|concatApp1| |l| |x| |y| |d| 0)))))
 
; concatbApp([.,:l],x,y,d) == concatApp1(l,x,y,d,1)
 
(DEFUN |concatbApp| (|bfVar#47| |x| |y| |d|)
  (PROG (|l|)
    (RETURN
     (PROGN (SETQ |l| (CDR |bfVar#47|)) (|concatApp1| |l| |x| |y| |d| 1)))))
         ...
         (LOOP
          (COND
           ((OR (ATOM |bfVar#52|) (PROGN (SETQ |x| (CAR |bfVar#52|)) NIL))
            (RETURN |bfVar#53|))
           ('T (SETQ |bfVar#53| (MAX |bfVar#53| (|superspan| |x|)))))
          (SETQ |bfVar#52| (CDR |bfVar#52|))))
       -999999 |l| NIL)))))
 
; concatWidth [.,:l] == +/[WIDTH x for x in l]
 
(DEFUN |concatWidth| (|bfVar#57|)
  (PROG (|l|)
    (RETURN
     (PROGN
      (SETQ |l| (CDR |bfVar#57|))
          ...
          (LOOP
           (COND
            ((OR (ATOM |bfVar#58|) (PROGN (SETQ |x| (CAR |bfVar#58|)) NIL))
             (RETURN |bfVar#59|))
            ('T (SETQ |bfVar#59| (+ |bfVar#59| (+ 1 (WIDTH |x|))))))
...
(DEFUN |exptApp| (|bfVar#61| |x| |y| |d|)
  (PROG (|a| |b| |pren| |x'| |y'|)
    (RETURN
     (PROGN
      (SETQ |a| (CADR . #1=(|bfVar#61|)))
      (SETQ |b| (CADDR . #1#))
...
(DEFUN |exptSuper| (|bfVar#62|)
  (PROG (|a| |b|)
    (RETURN
     (PROGN
      (SETQ |a| (CADR . #1=(|bfVar#62|)))
      (SETQ |b| (CADDR . #1#))
...
(DEFUN |exptWidth| (|bfVar#63|)
  (PROG (|a| |b|)
    (RETURN
     (PROGN
      (SETQ |a| (CADR . #1=(|bfVar#63|)))
      (SETQ |b| (CADDR . #1#))
      (+ (+ (WIDTH |a|) (WIDTH |b|))
    ...
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#64| |arg|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#64|) (PROGN (SETQ |arg| (CAR |bfVar#64|)) NIL))
            (RETURN NIL))
           ('T
            (PROGN
             (SETQ |op| (|keyp| |arg|))
...
(DEFUN |plusApp| (|bfVar#65| |x| |y| |d|)
  (PROG (|frst| |rst|)
    (RETURN
     (PROGN
      (SETQ |frst| (CADR . #1=(|bfVar#65|)))
      (SETQ |rst| (CDDR . #1#))
      (|appSum| |rst| (+ |x| (WIDTH |frst|)) |y| (APP |frst| |x| |y| |d|))))))
    ...
    (RETURN
     (PROGN
      ((LAMBDA (|bfVar#66| |arg|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#66|) (PROGN (SETQ |arg| (CAR |bfVar#66|)) NIL))
            (RETURN NIL))
           (#1='T
            (PROGN
                   ...
                   (PROGN
                    ...
                    ((LAMBDA (|bfVar#67| |arg|)
                       (LOOP
                        (COND
                         ((OR (ATOM |bfVar#67|)
                              (PROGN (SETQ |arg| (CAR |bfVar#67|)) NIL))
                          (RETURN NIL))
                         (#1#
                          (PROGN
                           (SETQ |d| (|appChar| |opString| |x| |y| |d|))
             ...
             (LOOP
              (COND
               ((OR (ATOM |bfVar#68|) (PROGN (SETQ |x| (CAR |bfVar#68|)) NIL))
                (RETURN |bfVar#69|))
               (#1# (SETQ |bfVar#69| (+ |bfVar#69| (+ 1 (WIDTH |x|))))))
      ...
      (COND
       ((AND (CONSP |u|)
        ...
        ((LAMBDA (|bfVar#70| |b|)
           (LOOP
            (COND
             ((OR (ATOM |bfVar#70|) (PROGN (SETQ |b| (CAR |bfVar#70|)) NIL))
              (RETURN NIL))
             (#1#
              (PROGN
               (SETQ |d| (APP |s| |x| |y| |d|))
...
(DEFUN |deMatrix| (|m|)
  (PROG ()
    (RETURN
     (LIST 'BRACKET
           (CONS 'AGGLST
                 ((LAMBDA (|bfVar#76| |bfVar#75| |row|)
                    (LOOP
                     (COND
                      ((OR (ATOM |bfVar#75|)
                           (PROGN (SETQ |row| (CAR |bfVar#75|)) NIL))
...
(DEFUN |quoteApp| (|bfVar#81| |x| |y| |d|)
  (PROG (|a|)
    (RETURN
     (PROGN
      (SETQ |a| (CADR |bfVar#81|))
      (APP |a| (+ |x| 1) |y| (|appChar| (PNAME '|'|) |x| |y| |d|))))))
 
; quoteSub [.,a] == subspan a
 
(DEFUN |quoteSub| (|bfVar#82|)
  (PROG (|a|) (RETURN (PROGN (SETQ |a| (CADR |bfVar#82|)) (|subspan| |a|)))))
 
; quoteSuper [.,a] == superspan a
 
(DEFUN |quoteSuper| (|bfVar#83|)
  (PROG (|a|) (RETURN (PROGN (SETQ |a| (CADR |bfVar#83|)) (|superspan| |a|)))))
 
; quoteWidth [.,a] == 1 + WIDTH a
 
(DEFUN |quoteWidth| (|bfVar#84|)
  (PROG (|a|) (RETURN (PROGN (SETQ |a| (CADR |bfVar#84|)) (+ 1 (WIDTH |a|))))))
      ...
      ((AND (CONSP |u|)
       ...
       (PROGN
        ...
        ((LAMBDA (|bfVar#85| |i|)
           (LOOP
            (COND
             ((OR (ATOM |bfVar#85|) (PROGN (SETQ |i| (CAR |bfVar#85|)) NIL))
              (RETURN NIL))
             (#1#
              (PROGN
...
(DEFUN |sigmaWidth| (|bfVar#86|)
  (PROG (|bot| |arg|)
    (RETURN
     (PROGN
      (SETQ |bot| (CADR . #1=(|bfVar#86|)))
      (SETQ |arg| (CADDR . #1#))
      (|bigopWidth| |bot| NIL |arg| '|sigma|)))))
 
; sigma2Width [.,bot,top,arg] == bigopWidth(bot,top,arg,'sigma)
 
(DEFUN |sigma2Width| (|bfVar#87|)
  (PROG (|bot| |top| |arg|)
    (RETURN
     (PROGN
      (SETQ |bot| (CADR . #1=(|bfVar#87|)))
      (SETQ |top| (CADDR . #1#))
      (SETQ |arg| (CADDDR . #1#))
...
(DEFUN |piWidth| (|bfVar#88|)
  (PROG (|bot| |arg|)
    (RETURN
     (PROGN
      (SETQ |bot| (CADR . #1=(|bfVar#88|)))
      (SETQ |arg| (CADDR . #1#))
      (|bigopWidth| |bot| NIL |arg| '|pi|)))))
 
; pi2Width [.,bot,top,arg] == bigopWidth(bot,top,arg,'pi)
 
(DEFUN |pi2Width| (|bfVar#89|)
  (PROG (|bot| |top| |arg|)
    (RETURN
     (PROGN
      (SETQ |bot| (CADR . #1=(|bfVar#89|)))
      (SETQ |top| (CADDR . #1#))
      (SETQ |arg| (CADDDR . #1#))
...
(DEFUN |overlabelSuper| (|bfVar#90|)
  (PROG (|a| |b|)
    (RETURN
     (PROGN
      (SETQ |a| (CADR . #1=(|bfVar#90|)))
      (SETQ |b| (CADDR . #1#))
      (+ (+ 1 (|height| |a|)) (|superspan| |b|))))))
 
; overlabelWidth [.,a,b] == WIDTH b
 
(DEFUN |overlabelWidth| (|bfVar#91|)
  (PROG (|a| |b|)
    (RETURN
     (PROGN
      (SETQ |a| (CADR . #1=(|bfVar#91|)))
      (SETQ |b| (CADDR . #1#))
      (WIDTH |b|)))))
...
(DEFUN |overlabelApp| (|bfVar#92| |x| |y| |d|)
  (PROG (|a| |b| |underApp| |endPoint| |middle| |h|)
    (RETURN
     (PROGN
      (SETQ |a| (CADR . #1=(|bfVar#92|)))
      (SETQ |b| (CADDR . #1#))
         ...
         (LOOP
          (COND
           ...
           (#1='T
            (AND (CONSP |bfVar#93|)
                 (PROGN
                  (SETQ |ISTMP#1| (CAR |bfVar#93|))
                  (AND (CONSP |ISTMP#1|)
                       (PROGN
                        (SETQ |a| (CAR |ISTMP#1|))
                        (SETQ |b| (CDR |ISTMP#1|))
                        #1#)))
                 (PROGN (SETQ |c| (CDR |bfVar#93|)) #1#)
               ...
               ((LAMBDA (|bfVar#97| |bfVar#96| |x|)
                  (LOOP
                   (COND
                    ...
                    (#1# (SETQ |bfVar#97| (CONS (LIST |x|) |bfVar#97|))))
      ...
      (COND
       ((|isMapExpr| |expr|)
        (PROGN
         ...
         (COND (|$mathmlFormat| (|mathmlFormat| |expr|)))
         (COND (|$texmacsFormat| (|texmacsFormat| |expr|)))
         (COND (|$htmlFormat| (|htmlFormat| |expr|)))))
              ...
              ((LAMBDA (|bfVar#99| |bfVar#98| |x|)
                 (LOOP
                  (COND
                   ...
                   (#1#
                    (SETQ |bfVar#99| (CONS (|object2String| |x|) |bfVar#99|))))
        ...
        (CONS |newop|
              ((LAMBDA (|bfVar#101| |bfVar#100| |y|)
                 (LOOP
                  (COND
                   ((OR (ATOM |bfVar#100|)
                        (PROGN (SETQ |y| (CAR |bfVar#100|)) NIL))
                    (RETURN (NREVERSE |bfVar#101|)))
                   (#1#
                    (SETQ |bfVar#101| (CONS (|outputOp| |y|) |bfVar#101|))))
  ...
  (PROG (|initialFlag| |x| |l| |ISTMP#1| |n|)
    (RETURN
     (PROGN
      ...
      (COND
       ((AND (CONSP |u|)
             (PROGN (SETQ |x| (CAR |u|)) (SETQ |l| (CDR |u|)) #1='T))
        (|printMap1| |x|
        ...
        ((LAMBDA (|bfVar#102| |y|)
           (LOOP
            (COND
             ((OR (ATOM |bfVar#102|) (PROGN (SETQ |y| (CAR |bfVar#102|)) NIL))
              (RETURN NIL))
             (#1#
              (PROGN (|printBasic| '| , |) (|printMap1| |y| |initialFlag|))))
...
(DEFUN |isInitialMap| (|u|)
  (PROG (|ISTMP#1| |ISTMP#2| |n| |ISTMP#3| |l|)
    (RETURN
     (AND (CONSP |u|)
          (PROGN
           (SETQ |ISTMP#1| (CAR |u|))
           (AND (CONSP |ISTMP#1|)
                ...
                (PROGN
                 ...
                 (AND (CONSP |ISTMP#3|) (EQ (CDR |ISTMP#3|) NIL)))))
          (PROGN (SETQ |l| (CDR |u|)) #1#) (INTEGERP |n|)
          ((LAMBDA (|bfVar#104| |bfVar#103| |x| |i|)
             (LOOP
              (COND
               ((OR (ATOM |bfVar#103|)
...
(DEFUN |printMap1| (|x| |initialFlag|)
  (PROG ()
    (RETURN
     (COND (|initialFlag| (|printBasic| (CADR |x|)))
           (#1='T
            (PROGN
             (COND ((CDAR |x|) (|printBasic| (CAR |x|)))
                   (#1# (|printBasic| (CAAR |x|))))
             (|printBasic| '| E |)
             (|printBasic| (CADR |x|))))))))
...
(DEFUN |printBasic| (|x|)
  (PROG ()
    (RETURN
     (COND ((EQUAL |x| '(|One|)) (PRIN1 1 |$algebraOutputStream|))
      ...
      ((OR
       ...
       (PROGN
        ((LAMBDA (|bfVar#105| |a|)
           (LOOP
            (COND
             ((OR (ATOM |bfVar#105|) (PROGN (SETQ |a| (CAR |bfVar#105|)) NIL))
              (RETURN NIL))
       ...
       (COND ((AND (CONSP |op|) (EQ (CAR |op|) 'MATRIX) (EQUAL |u| |m|)) |m1|)
             (#1#
              (PROGN
               ...
               (SETQ |r1|
                       ((LAMBDA (|bfVar#108| |bfVar#107| |s|)
                          (LOOP
                           (COND
                            ((OR (ATOM |bfVar#107|)
                                 (PROGN (SETQ |s| (CAR |bfVar#107|)) NIL))
              ...
              (|matLSum2|
               (|matWList| |y|
                ((LAMBDA (|bfVar#110| |j|)
                   (LOOP
                    (COND
                     ((> |j| |numOfColumns|) (RETURN (NREVERSE |bfVar#110|)))
                     ('T (SETQ |bfVar#110| (CONS 0 |bfVar#110|))))
                    (SETQ |j| (+ |j| 1))))
                 NIL 1))))
     ...
     (PROGN
      (SETQ |u|
              (CONS (LIST 'CONCAT |open| (CAR |u|))
                    ((LAMBDA (|bfVar#112| |bfVar#111| |y|)
                       (LOOP
                        (COND
                         ((OR (ATOM |bfVar#111|)
                              (PROGN (SETQ |y| (CAR |bfVar#111|)) NIL))
                          (RETURN (NREVERSE |bfVar#112|)))
                         (#1='T
                          (SETQ |bfVar#112|
                                  (CONS (LIST 'CONCAT " " |y|) |bfVar#112|))))
  ...
  (PROG ()
    (RETURN
     (COND ((NULL |u|) 0)
           ('T
            (+
             (+ (COND ((|member| (|keyp| (|absym| (CAR |u|))) '(+ -)) 5) (T 3))
                (WIDTH (|absym| (CAR |u|))))
             (|sumWidthA| (CDR |u|))))))))
     ...
     (PROGN
      ...
      (SETQ |ysub|
              (- (- |y| 1)
                 (APPLY 'MAX
                        (CONS |ab|
                              ((LAMBDA (|bfVar#118| |bfVar#117| |s|)
                                 (LOOP
                                  (COND
                                   ((OR (ATOM |bfVar#117|)
                                        (PROGN
                                         (SETQ |s| (CAR |bfVar#117|))
                                         NIL))
      ...
      (SETQ |ysup|
              (+ (+ |y| 1)
                 (APPLY 'MAX
                        (CONS |ar|
                              ((LAMBDA (|bfVar#120| |bfVar#119| |s|)
                                 (LOOP
                                  (COND
                                   ((OR (ATOM |bfVar#119|)
                                        (PROGN
                                         (SETQ |s| (CAR |bfVar#119|))
                                         NIL))
                               ...
                               NIL |sublist| NIL)))))
      ((LAMBDA (|bfVar#121| |sub| |bfVar#122| |sup|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#121|) (PROGN (SETQ |sub| (CAR |bfVar#121|)) NIL)
                (ATOM |bfVar#122|) (PROGN (SETQ |sup| (CAR |bfVar#122|)) NIL))
            (RETURN NIL))
           (#1#
            (PROGN
             (SETQ |wsub| (WIDTH |sub|))
...
(DEFUN |everyNth| (|l| |n|)
  (PROG (|e|)
    (RETURN
     ((LAMBDA (|bfVar#123|)
        (LOOP
         (COND ((NOT |l|) (RETURN (NREVERSE |bfVar#123|)))
               (#1='T
                (SETQ |bfVar#123|
                        (CONS
                         (PROGN
  ...
  (PROG (|span| |sublist| |h|)
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#124| |sub|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#124|) (PROGN (SETQ |sub| (CAR |bfVar#124|)) NIL))
            (RETURN NIL))
           ('T
            (PROGN
             (SETQ |h| (|height| |sub|))
  ...
  (PROG (|span| |suplist| |h|)
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#125| |sup|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#125|) (PROGN (SETQ |sup| (CAR |bfVar#125|)) NIL))
            (RETURN NIL))
           ('T
            (PROGN
             (SETQ |h| (|height| |sup|))
  ...
  (PROG (|w| |suplist| |sublist| |wsup| |wsub|)
    (RETURN
     (PROGN
      ...
      (SETQ |suplist| (|everyNth| (IFCDR (CDDR |u|)) 2))
      (SETQ |sublist| (|everyNth| (CDDR |u|) 2))
      ((LAMBDA (|bfVar#126| |sup| |bfVar#127| |sub|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#126|) (PROGN (SETQ |sup| (CAR |bfVar#126|)) NIL)
                (ATOM |bfVar#127|) (PROGN (SETQ |sub| (CAR |bfVar#127|)) NIL))
            (RETURN NIL))
           ('T
            (PROGN
             (SETQ |wsup| (WIDTH |sup|))
    ...
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#128| |a|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#128|) (PROGN (SETQ |a| (CAR |bfVar#128|)) NIL))
            (RETURN NIL))
           ('T
            (PROGN
...
(DEFUN |vConcatSub| (|u|)
  (PROG ()
    (RETURN
     (+ (|subspan| (ELT |u| 1))
        ((LAMBDA (|bfVar#130| |bfVar#129| |a|)
           (LOOP
            (COND
             ((OR (ATOM |bfVar#129|) (PROGN (SETQ |a| (CAR |bfVar#129|)) NIL))
              (RETURN |bfVar#130|))
             ('T (SETQ |bfVar#130| (+ |bfVar#130| (|height| |a|)))))
    ...
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#131| |a|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#131|) (PROGN (SETQ |a| (CAR |bfVar#131|)) NIL))
            (RETURN NIL))
