                     ...
                     (PROGN
                      ...
                      ((LAMBDA (|bfVar#46| |anc|)
                         (LOOP
                          (COND
                           ((OR (ATOM |bfVar#46|)
                                (PROGN (SETQ |anc| (CAR |bfVar#46|)) NIL))
                            (RETURN NIL))
                           (#1#
                            (COND
    ...
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#47| |u|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#47|) (PROGN (SETQ |u| (CAR |bfVar#47|)) NIL))
            (RETURN NIL))
           (#1='T
            ((LAMBDA (|bfVar#48| |at|)
               (LOOP
                (COND
                 ((OR (ATOM |bfVar#48|)
                      (PROGN (SETQ |at| (CAR |bfVar#48|)) NIL))
                  (RETURN NIL))
                 (#1#
                  (PROGN
                   (SETQ |at2| (CAR |at|))
              ...
              (APPEND |CondList|
                      ((LAMBDA (|bfVar#50| |bfVar#49| |u|)
                         (LOOP
                          (COND
                           ((OR (ATOM |bfVar#49|)
                                (PROGN (SETQ |u| (CAR |bfVar#49|)) NIL))
                            (RETURN (NREVERSE |bfVar#50|)))
                           (#1#
                            (SETQ |bfVar#50| (CONS (LIST |u| T) |bfVar#50|))))
      ...
      ((LAMBDA (|bfVar#51| |b|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#51|) (PROGN (SETQ |b| (CAR |bfVar#51|)) NIL))
            (RETURN NIL))
           (#1#
            (PROGN
             (SETQ |sigl|
