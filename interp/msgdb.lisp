     ...
     (PROGN
      ...
      (SETQ |k|
              (OR
               ((LAMBDA (|bfVar#2| |j|)
                  (LOOP
                   (COND ((> |j| |maxIndex|) (RETURN |bfVar#2|))
                         (#1='T
     ...
     (COND ((NOT (EQUAL (CAR |msg|) "%atbeg")) (LIST |msg| NIL))
           (#1='T
            (PROGN
             ...
             ((LAMBDA (|bfVar#3|)
                (LOOP
                 (COND (|bfVar#3| (RETURN NIL))
                       (#1#
                        (PROGN
                         (SETQ |msg| (CDR |msg|))
                         (SETQ |item| (CAR |msg|))
                         (SETQ |attList| (CONS (INTERN |item|) |attList|)))))
                 (SETQ |bfVar#3| (EQUAL |item| "%atend"))))
              NIL)
             (SETQ |msg| (CDR |msg|))
                 ...
                 (PROGN
                  ...
                  ((LAMBDA (|bfVar#10| |ch|)
                     (LOOP
                      (COND
                       ((OR (ATOM |bfVar#10|)
                            (PROGN (SETQ |ch| (CAR |bfVar#10|)) NIL))
                        (RETURN NIL))
                       (#1#
                        (COND
                         ((MEMQ (|char| |ch|) |q|)
         ...
         ((CONSP |msg|)
          (PROGN
           ...
           ((LAMBDA (|bfVar#15| |f|)
              (LOOP
               (COND
                ((OR (ATOM |bfVar#15|) (PROGN (SETQ |f| (CAR |bfVar#15|)) NIL))
                 (RETURN NIL))
                (#1#
                 (COND
                  ((|member| |f| '("%l" |%l|))
    ...
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#16| |y|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#16|) (PROGN (SETQ |y| (CAR |bfVar#16|)) NIL))
            (RETURN NIL))
           ('T (|brightPrint0| |y|)))
                   ...
                   (PROGN
                    ...
                    ((LAMBDA (|bfVar#21| |zz|)
                       (LOOP
                        (COND
                         ((OR (ATOM |bfVar#21|)
                              (PROGN (SETQ |zz| (CAR |bfVar#21|)) NIL))
                          (RETURN NIL))
                         (#1# (|brightPrint0| |zz|)))
      ...
      (#1#
       (PROGN
        ...
        ((LAMBDA (|bfVar#23| |z|)
           (LOOP
            (COND
             ((OR (ATOM |bfVar#23|) (PROGN (SETQ |z| (CAR |bfVar#23|)) NIL))
              (RETURN NIL))
             (#1# (|brightPrint0| |z|)))
              ...
              ((LAMBDA (|bfVar#25| |bfVar#24| |a|)
                 (LOOP
                  (COND
                   ...
                   (#1='T
                    (SETQ |bfVar#25| (CONS (|atom2String| |a|) |bfVar#25|))))
                  (SETQ |bfVar#24| (CDR |bfVar#24|))))
               NIL |l| NIL))
      (SETQ |m|
              (+ 1
                 ((LAMBDA (|bfVar#27| |bfVar#26| |a|)
                    (LOOP
                     (COND
                      ((OR (ATOM |bfVar#26|)
                           (PROGN (SETQ |a| (CAR |bfVar#26|)) NIL))
                       (RETURN |bfVar#27|))
                      (#1# (SETQ |bfVar#27| (MAX |bfVar#27| (SIZE |a|)))))
          ...
          (LOOP
           (COND
            ((OR (ATOM |bfVar#31|) (PROGN (SETQ |y| (CAR |bfVar#31|)) NIL))
             (RETURN |bfVar#32|))
            (#1='T
             (SETQ |bfVar#32| (+ |bfVar#32| (|sayDisplayWidth,fn| |y|)))))
               ...
               (LOOP
                (COND
                 ((OR (ATOM |bfVar#33|)
                  ...
                  (RETURN |bfVar#34|))
                 (#1# (SETQ |bfVar#34| (+ |bfVar#34| (|sayWidth,fn| |y|)))))
     ...
     (COND ((SETQ |u| (LASSOC |s| |$htCharAlist|)) |u|)
           ...
           ((NULL
             ((LAMBDA (|bfVar#38| |bfVar#37| |i|)
                (LOOP
                 (COND ((> |i| |bfVar#37|) (RETURN |bfVar#38|))
                       (#1='T
                        (PROGN
                         (SETQ |bfVar#38|
