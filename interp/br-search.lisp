      ...
      (COND ((NULL |args|) |form|)
            (#1='T
             (PROGN
              ...
              (SETQ |sargl|
                      ((LAMBDA
                           (|bfVar#43| |bfVar#40| |x| |bfVar#41| |atype|
                            |bfVar#42| |pred|)
                         (LOOP
                          (COND
                           ((OR (ATOM |bfVar#40|)
                                ...
                                (ATOM |bfVar#41|)
                                (PROGN (SETQ |atype| (CAR |bfVar#41|)) NIL)
                                (ATOM |bfVar#42|)
                                (PROGN (SETQ |pred| (CAR |bfVar#42|)) NIL))
                            (RETURN (NREVERSE |bfVar#43|)))
                           (#1#
                            (SETQ |bfVar#43|
                                    (CONS
                                     (PROGN
                                      (|pp| (LIST |x| |atype| |pred|))
                                      (COND (|pred| (|conform2OutputForm| |x|))
                                            (#1#
                                             (PROGN
                                              (SETQ |typ|
                                                      (|sublisFormal| |args|
    ...
    (RETURN
     (PROGN
      ...
      (COND ((ATOM |x|) (EQL |k| 1)) ((NOT (EQL |k| (LENGTH |x|))) NIL)
            (#1='T
             ((LAMBDA (|bfVar#46| |bfVar#44| |key| |bfVar#45| |arg|)
                (LOOP
                 (COND
                  ((OR (ATOM |bfVar#44|)
                       (PROGN (SETQ |key| (CAR |bfVar#44|)) NIL)
                       (ATOM |bfVar#45|)
                       (PROGN (SETQ |arg| (CAR |bfVar#45|)) NIL))
                   (RETURN |bfVar#46|))
                  (#1#
                   (PROGN
                    (SETQ |bfVar#46|
              ...
              (SETQ |summarize?|
                      (COND (|docSearchAlist| T)
                            (#1#
                             (PROGN
                              (SETQ |nonEmpties|
                                      ((LAMBDA (|bfVar#55| |bfVar#54| |pair|)
                                         (LOOP
                                          (COND
                                           ((OR (ATOM |bfVar#54|)
                                                (PROGN
                                                 (SETQ |pair| (CAR |bfVar#54|))
                                                 NIL))
                         ...
                         (LOOP
                          (COND
                           ...
                           (#1#
                            (AND (CONSP |bfVar#56|)
                                 (PROGN
                                  (SETQ |kind| (CAR |bfVar#56|))
                                  (SETQ |pair| (CDR |bfVar#56|))
                                  #1#)
                                 (< 0 (LENGTH (CAR |pair|)))
                                 (PROGN
                                  (|bcHt| "\\newline{}")
                        ...
                        ((LAMBDA (|bfVar#59| |bfVar#58| |i|)
                           (LOOP
                            (COND
                             ((OR (ATOM |bfVar#59|)
                                  (PROGN
                                   (SETQ |bfVar#58| (CAR |bfVar#59|))
                                   NIL))
                              (RETURN NIL))
                             (#1#
                              (AND (CONSP |bfVar#58|)
                                   (PROGN
                                    (SETQ |kind| (CAR |bfVar#58|))
                                    (SETQ |pair| (CDR |bfVar#58|))
                                    #1#)
                                   (< 0 (LENGTH (CAR |pair|)))
                                   (PROGN
                                    (|bcHt| '|\\newline{}|)
           ...
           (AND (CONSP |bfVar#62|)
                ...
                (SETQ |bfVar#64|
                        (CONS
                         (CONS |op|
                               (CONS
                                ((LAMBDA (|bfVar#61| |bfVar#60| |line|)
                                   (LOOP
                                    (COND
                                     ((OR (ATOM |bfVar#60|)
                                          (PROGN
                                           (SETQ |line| (CAR |bfVar#60|))
                                           NIL))
         ...
         (COND
          ...
          (#1='T
           (AND (CONSP |bfVar#65|)
                ...
                (SETQ |bfVar#67| (+ |bfVar#67| (LENGTH |y|))))))
      ...
      (COND
       ...
       (#1='T
        (PROGN
         ...
         (SETQ |lines|
                 ((LAMBDA (|bfVar#69| |bfVar#68| |line|)
                    (LOOP
                     (COND
                      ((OR (ATOM |bfVar#68|)
                           (PROGN (SETQ |line| (CAR |bfVar#68|)) NIL)
                           (NOT (EQUAL (|dbName| |line|) |firstName|)))
                       (RETURN (NREVERSE |bfVar#69|)))
                      (#1# (SETQ |bfVar#69| (CONS |line| |bfVar#69|))))
...
(DEFUN |showNamedConstruct| (|bfVar#70|)
  (PROG (|kind| |lines|)
    (RETURN
     (PROGN
      (SETQ |kind| (CAR |bfVar#70|))
      (SETQ |lines| (CDDR |bfVar#70|))
      (|dbSearch| |lines| |kind| "")))))
      ...
      (COND (|short| '|done|)
            (#1#
             (PROGN
              ...
              (SETQ |i| 1)
              ((LAMBDA (|bfVar#71| |group|)
                 (LOOP
                  (COND
                   ((OR (ATOM |bfVar#71|)
                        (PROGN (SETQ |group| (CAR |bfVar#71|)) NIL))
                    (RETURN NIL))
                   (#1#
                    (PROGN
                     ...
                     (COND
                      (|$includeUnexposed?|
                       (SETQ |exposed?|
                               ((LAMBDA (|bfVar#73| |bfVar#72| |item|)
                                  (LOOP
                                   (COND
                                    ((OR (ATOM |bfVar#72|)
                                         (PROGN
                                          (SETQ |item| (CAR |bfVar#72|))
                                          NIL))
                                     (RETURN |bfVar#73|))
                                    (#1#
                                     (PROGN
...
(DEFUN |genSearchSayJump| (|htPage| |bfVar#76|)
  (PROG (|lines| |kind| |filter|)
    (RETURN
     (PROGN
      (SETQ |lines| (CAR |bfVar#76|))
      (SETQ |kind| (CADR |bfVar#76|))
      (SETQ |filter| (|htpProperty| |htPage| '|filter|))
      (|dbSearch| |lines| |kind| |filter|)))))
  ...
  (PROG (|count| |lastid| |id|)
    (RETURN
     (PROGN
      (SETQ |count| 0)
      (SETQ |lastid| NIL)
      ((LAMBDA (|bfVar#77| |item|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#77|) (PROGN (SETQ |item| (CAR |bfVar#77|)) NIL)
...
(DEFUN |showNamedDoc| (|bfVar#84| |index|)
  (PROG (|kind| |lines|)
    (RETURN
     (PROGN
      (SETQ |kind| (CAR |bfVar#84|))
      (SETQ |lines| (CDR |bfVar#84|))
      ...
      ((LAMBDA (|bfVar#89|)
         (LOOP
          (COND
           ...
           (#1# (SETQ |bfVar#89| (CONS |w| |bfVar#89|))))))
       NIL)))))
     ...
     (PROGN
      ...
      (SETQ |k|
              (OR
               ((LAMBDA (|bfVar#90| |j|)
                  (LOOP
                   (COND ((> |j| |maxIndex|) (RETURN |bfVar#90|))
                         (#1#
            ...
            ((LAMBDA (|bfVar#92| |bfVar#91| |y|)
               (LOOP
                (COND
                 ...
                 (#1#
                  (SETQ |bfVar#92|
                          (CONS (|conLowerCaseConTran| |y|) |bfVar#92|))))
...
(DEFUN |conLowerCaseConTranTryHarder| (|x|)
  (PROG ()
    (RETURN
     (COND
      ((IDENTP |x|) (OR (IFCAR (HGET |$lowerCaseConTb| (DOWNCASE |x|))) |x|))
      ((ATOM |x|) |x|)
      (#1='T
       ((LAMBDA (|bfVar#94| |bfVar#93| |y|)
          (LOOP
           (COND
            ...
            (#1#
             (SETQ |bfVar#94|
                     (CONS (|conLowerCaseConTranTryHarder| |y|) |bfVar#94|))))
...
(DEFUN |dbSearchAbbrev| (|bfVar#101| |kind| |filter|)
  (PROG (|conlist| |ISTMP#1| |nam| |cAlist| |htPage| |page| |abbr| |r| |s|)
    (RETURN
     (PROGN
      (SETQ |conlist| (CDR |bfVar#101|))
             ...
             (PROGN
              ...
              (COND
               ...
               (#1#
                (PROGN
                 (SETQ |cAlist|
                         ((LAMBDA (|bfVar#98| |bfVar#97| |con|)
                            (LOOP
                             (COND
                              ((OR (ATOM |bfVar#97|)
                                   (PROGN (SETQ |con| (CAR |bfVar#97|)) NIL))
                               (RETURN (NREVERSE |bfVar#98|)))
                              (#1#
                               (SETQ |bfVar#98|
                                       (CONS (CONS |con| T) |bfVar#98|))))
    ...
    (RETURN
     (PROGN
      ...
      (SETQ |lines|
              ((LAMBDA (|bfVar#103|)
                 (LOOP
                  (COND ((EOFP |instream|) (RETURN (NREVERSE |bfVar#103|)))
                        ('T
                         (SETQ |bfVar#103|
                                 (CONS (READLINE |instream|) |bfVar#103|))))))
               NIL))
      (CLOSE |instream|)
      |lines|))))
