...
(DEFUN |predicateBitIndex| (|x|)
  (PROG () (RETURN (|predicateBitIndex,pn| |x| NIL))))
    ...
    (RETURN
     (PROGN
      ...
      (COND ((EQ |u| 'T) 0) ((NULL |u|) (- 1))
            ...
            ((NULL |flag|)
             (|predicateBitIndex,pn| (|predicateBitIndexRemop| |x|) T))
            ('T (|systemError| NIL)))))))
         ...
         ((LAMBDA (|bfVar#27| |bfVar#26| |x|)
            (LOOP
             (COND
              ...
              (#1#
               (SETQ |bfVar#27|
                       (CONS (|predicateBitIndexRemop| |x|) |bfVar#27|))))
    ...
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#28| |p|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#28|) (PROGN (SETQ |p| (CAR |bfVar#28|)) NIL))
            (RETURN NIL))
           (#1='T
            (PROGN
         ...
         ((LAMBDA (|bfVar#33| |bfVar#32| |x|)
            (LOOP
             (COND
              ...
              (#1#
               (PROGN
                (SETQ |bfVar#33| (|isHasDollarPred| |x|))
       ...
       ((LAMBDA (|bfVar#35| |bfVar#34| |x|)
          (LOOP
           (COND
            ...
            (#1#
             (SETQ |bfVar#35|
                     (APPEND |bfVar#35| (|stripOutNonDollarPreds| |x|)))))
  ...
  (PROG ()
    (RETURN
     ((LAMBDA (|bfVar#37| |bfVar#36| |p|)
        (LOOP
         (COND
          ((OR (ATOM |bfVar#36|) (PROGN (SETQ |p| (CAR |bfVar#36|)) NIL))
           (RETURN (NREVERSE |bfVar#37|)))
          ('T
           (SETQ |bfVar#37|
                   (CONS (|removeAttributePredicates,fn| |p|) |bfVar#37|))))
     ...
     ((LAMBDA (|bfVar#39| |bfVar#38| |x|)
        (LOOP
         (COND
          ...
          ('T
           (SETQ |bfVar#39|
                   (CONS (|removeAttributePredicates,fn| |x|) |bfVar#39|))))
    ...
    (RETURN
     (PROGN
               ...
               ((LAMBDA (|bfVar#48| |bfVar#47| |x|)
                  (LOOP
                   (COND
                    ...
                    (#1='T (SETQ |bfVar#48| (CONS (CONS |x| 'T) |bfVar#48|))))
              ...
              ((LAMBDA (|bfVar#53| |bfVar#52| |bfVar#51| |i|)
                 (LOOP
                  (COND
                   ...
                   (#1#
                    (AND (CONSP |bfVar#51|)
                         (PROGN (SETQ |b| (CDR |bfVar#51|)) #1#)
                         (SETQ |bfVar#53|
                                 (CONS (CONS (+ 5 |i|) |b|) |bfVar#53|)))))
                  ...
                  (COND
                   ...
                   (#1#
                    (AND (CONSP |bfVar#54|)
                         ...
                         (SETQ |bfVar#56| (CONS (CONS |a| |k|) |bfVar#56|)))))
              ...
              ((LAMBDA (|bfVar#61| |bfVar#60| |i|)
                 (LOOP
                  (COND ((> |i| |bfVar#60|) (RETURN (NREVERSE |bfVar#61|)))
                        (#1# (SETQ |bfVar#61| (CONS (+ 5 |i|) |bfVar#61|))))
                  (SETQ |i| (+ |i| 1))))
      ...
      ((LAMBDA (|bfVar#62| |x|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#62|) (PROGN (SETQ |x| (CAR |bfVar#62|)) NIL))
            (RETURN NIL))
           (#1#
            (RPLACA |x|
                    (EQSUBSTLIST (CONS '$$ |sixEtc|) (CONS '$ |formals|)
                     (CAR |x|)))))
          (SETQ |bfVar#62| (CDR |bfVar#62|))))
       |slot1| NIL)
      (SETQ |predList| (ASSOCRIGHT |slot1|))
      (SETQ |maxPredList|
              ((LAMBDA (|bfVar#63| |bfVar#65| |bfVar#64|)
                 (LOOP
                  (COND
                   ((OR (ATOM |bfVar#65|)
                        (PROGN (SETQ |bfVar#64| (CAR |bfVar#65|)) NIL))
                    (RETURN |bfVar#63|))
                   (#1# (SETQ |bfVar#63| (MAX |bfVar#63| |bfVar#64|))))
...
(DEFUN |dcCats1| (|con|)
  (PROG (|u| |catvec| |catinfo| |LETTMP#1| |form| |predNumber| |suffix| |info|
         |extra|)
    (RETURN
     (PROGN
      (SETQ |$predvec| (GETDATABASE |con| 'PREDICATES))
                                 ...
                                 (APPEND (|bright| "if")
                                         (|pred2English|
                                          (ELT |$predvec|
                                               (- |predNumber| 1)))))))
                  (SETQ |extra|
                          (COND ((NULL (SETQ |info| (ELT |catinfo| |i|))) NIL)
                                ((IDENTP |info|) (|bright| "package"))
                                (#1# (|bright| "instantiated"))))
                  (|sayBrightly|
                   (|concat| (|form2String| (|formatSlotDomain| |form|))
                    |suffix| |extra|)))))
          (SETQ |i| (+ |i| 1))))
       (MAXINDEX |catvec|) 0)))))
...
(DEFUN |sum| (&REST |l|)
  (PROG ()
    (RETURN
     ((LAMBDA (|bfVar#93| |bfVar#95| |bfVar#94|)
        (LOOP
         (COND
          ((OR (ATOM |bfVar#95|)
               (PROGN (SETQ |bfVar#94| (CAR |bfVar#95|)) NIL))
           (RETURN |bfVar#93|))
          ('T (SETQ |bfVar#93| (+ |bfVar#93| |bfVar#94|))))
       ...
       ((LAMBDA (|bfVar#102| |bfVar#101| |x|)
          (LOOP
           (COND
            ...
            (#1#
             (PROGN
              (SETQ |bfVar#102| (|extendsCategory| |domform| |exCategory| |x|))
              (COND ((NOT |bfVar#102|) (RETURN NIL))))))
            ...
            ((LAMBDA (|bfVar#104| |bfVar#103| |x|)
               (LOOP
                (COND
                 ...
                 (#1#
                  (PROGN
                   (SETQ |bfVar#104| (|extendsCategory| |dom| |u| |x|))
            ...
            ((LAMBDA (|bfVar#106| |bfVar#105| |x|)
               (LOOP
                (COND
                 ...
                 (#1#
                  (PROGN
                   (SETQ |bfVar#106| (|extendsCategory| |dom| |u| |x|))
       ...
       ((LAMBDA (|bfVar#108| |bfVar#107| |x|)
          (LOOP
           (COND
            ...
            (#1#
             (PROGN
              (SETQ |bfVar#108| (|extendsCategoryBasic| |dom| |x| |v|))
        ...
        (COND ((|isCategoryForm| |v| NIL) (|catExtendsCat?| |u| |v| |uVec|))
              ((AND (CONSP |v|) (EQ (CAR |v|) 'SIGNATURE)
               ...
               ((LAMBDA (|bfVar#110| |bfVar#109| |i|)
                  (LOOP
                   (COND ((> |i| |bfVar#109|) (RETURN |bfVar#110|))
                         (#1#
                          (PROGN
                           (SETQ |bfVar#110|
                                   (PROGN
                     ...
                     ((LAMBDA (|bfVar#112| |bfVar#111| |x|)
                        (LOOP
                         (COND
                          ...
                          (#1#
                           (PROGN
                            (SETQ |bfVar#112| (|catExtendsCat?| |x| |v| NIL))
