  ...
  (PROG (|cacheName|)
    (RETURN
     ((LAMBDA (|bfVar#5| |name|)
        (LOOP
         (COND
          ((OR (ATOM |bfVar#5|) (PROGN (SETQ |name| (CAR |bfVar#5|)) NIL))
           (RETURN NIL))
          ('T
           (PROGN
            (COND
    ...
    (RETURN
     (PROGN
      (SETQ |l|
              (NREVERSE
               (SORTBY 'CAR
                ((LAMBDA (|bfVar#7| |bfVar#6| |key|)
                   (LOOP
                    (COND
                     ((OR (ATOM |bfVar#6|)
                          (PROGN (SETQ |key| (CAR |bfVar#6|)) NIL))
  ...
  (PROG (|infovec| |circList| |numberUsed|)
    (RETURN
     (PROGN
      ...
      (SETQ |numberUsed|
              ((LAMBDA (|bfVar#13| |i| |bfVar#12| |x|)
                 (LOOP
                  (COND
                   ((OR (> |i| |n|) (ATOM |bfVar#12|)
                        (PROGN (SETQ |x| (CAR |bfVar#12|)) NIL)
                        (AND (CONSP |x|) (EQUAL (CAR |x|) '|$failed|)))
                    (RETURN |bfVar#13|))
                   ('T (SETQ |bfVar#13| (+ |bfVar#13| 1))))
                  (SETQ |i| (+ |i| 1))
     ...
     (PROGN
      ((LAMBDA (|bfVar#17| |bfVar#16| |i|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#17|)
                (PROGN (SETQ |bfVar#16| (CAR |bfVar#17|)) NIL) (> |i| |len|)
                (EQ |x| '|$failed|))
            (RETURN NIL))
           (#1='T
            (AND (CONSP |bfVar#16|)
  ...
  (PROG (|infovec| |hashTable| |hashValues|)
    (RETURN
     (PROGN
      ...
      (SETQ |hashValues|
              ((LAMBDA (|bfVar#19| |bfVar#18| |key|)
                 (LOOP
                  (COND
                   ((OR (ATOM |bfVar#18|)
                        (PROGN (SETQ |key| (CAR |bfVar#18|)) NIL))
                    (RETURN (NREVERSE |bfVar#19|)))
                   ('T
                    (SETQ |bfVar#19|
                            (CONS (HGET |hashTable| |key|) |bfVar#19|))))
         ...
         (LOOP
          (COND
           ((OR (ATOM |bfVar#21|)
            ...
            (RETURN NIL))
           (#1='T
            (AND (CONSP |bfVar#20|) (PROGN (SETQ |count| (CAR |bfVar#20|)) #1#)
                 (COND
                  ((SETQ |u| (|assoc| |count| |al|))
                   (RPLACD |u| (+ 1 (CDR |u|))))
    ...
    (RETURN
     (PROGN
      ...
      (SETQ |l|
              ((LAMBDA (|bfVar#22| |i|)
                 (LOOP
                  (COND ((> |i| |n|) (RETURN (NREVERSE |bfVar#22|)))
                        ('T
                         (SETQ |bfVar#22|
                                 (CONS (CONS |$failed| |tail|) |bfVar#22|))))
                  (SETQ |i| (+ |i| 1))))
               NIL 1))
      (RPLACD (LASTNODE |l|) |l|)))))
                   ...
                   (PROGN
                    (COND
                     ((|less_SI| (SETQ |c| (CADR |y|)) |minCount|)
                      ...
                      (SETQ |newFrontPointer| |forwardPointer|)))
                    (SETQ |forwardPointer| (CDR |forwardPointer|)))))))
          (SETQ |bfVar#25| (EQ |forwardPointer| |al|))))
       NIL)
      (COND
...
(DEFUN |reportInstantiations| ()
  (PROG (|form| |ISTMP#2| |nTotal| |mTotal| |rTotal| |nForms| |conList| |m| |n|
    ...
    (RETURN
     (PROGN
      (SETQ |conList|
              ((LAMBDA (|bfVar#32| |bfVar#31| |key|)
                 (LOOP
                  (COND
                   ((OR (ATOM |bfVar#31|)
                        (PROGN (SETQ |key| (CAR |bfVar#31|)) NIL))
    ...
    (RETURN
     (PROGN
      ...
      ((LAMBDA (|bfVar#35| |key|)
         (LOOP
          (COND
           ((OR (ATOM |bfVar#35|) (PROGN (SETQ |key| (CAR |bfVar#35|)) NIL))
            (RETURN NIL))
           (#1='T
            (PROGN
             (SETQ |u| (HGET |x| |key|))
        ...
        (LOOP
         (COND
          ((OR (ATOM |bfVar#43|)
           ...
           (RETURN NIL))
          (#1='T
           (AND (CONSP |bfVar#42|) (PROGN (SETQ |fun| (CAR |bfVar#42|)) #1#)
                (PROGN
                 (|sayBrightly|
